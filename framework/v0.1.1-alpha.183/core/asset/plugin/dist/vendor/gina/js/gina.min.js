...
(b[ja]=Ga.events),rb(ja))});return ra},enable:function(E){S(g,E.id)&&Ub(E).enable()},completeLoad:function(E){var oa=S(l.shim,E)||{},ra=oa.exports;for(Db();x.length;){var ja=x.shift();if(null===ja[0]){ja[0]=E;if(ba)break;var ba=!0}else ja[0]===E&&(ba=!0);db(ja)}ea.defQueueMap={};ja=S(g,E);if(!ba&&!Q(q,E)&&ja&&!ja.inited)if(!l.enforceDefine||ra&&Ea(ra))db([E,oa.deps||[],oa.exportsFn]);else return pb(E)?void 0:jb(N('nodefine','No define call for '+E,null,[E]));Ka()},nameToUrl:function(E,oa,ra){var ja,
...
a);c=(c||'').match(Ga)||[''];for(H=c.length;H--;){var yb=sb.exec(c[H])||[];var bb=Va=yb[1];yb=(yb[2]||'').split('.').sort();bb&&(qa=b.event.special[bb]||{},bb=(n?qa.delegateType:qa.bindType)||bb,qa=b.event.special[bb]||{},sa=b.extend({type:bb,origType:Va,data:k,handler:e,guid:e.guid,selector:n,needsContext:n&&b.expr.match.needsContext.test(n),namespace:yb.join('.')},Y),(Sa=B[bb])||(Sa=B[bb]=[],Sa.delegateCount=0,qa.setup&&!1!==qa.setup.call(a,k,yb,Ba)||(a.addEventListener?a.addEventListener(bb,Ba,
!1):a.attachEvent&&a.attachEvent('on'+bb,Ba))),qa.add&&(qa.add.call(a,sa),sa.handler.guid||(sa.handler.guid=e.guid)),n?Sa.splice(Sa.delegateCount++,0,sa):Sa.push(sa),b.event.global[bb]=!0)}a=null}},remove:function(a,c,e,k,n){var B,H,Y,qa,Ba,sa,Sa,Va,yb=b.hasData(a)&&b._data(a);if(yb&&(Ba=yb.events)){c=(c||'').match(Ga)||[''];for(qa=c.length;qa--;)if(H=sb.exec(c[qa])||[],sa=Va=H[1],Sa=(H[2]||'').split('.').sort(),sa){var bb=b.event.special[sa]||{};sa=(k?bb.delegateType:bb.bindType)||sa;var Hb=Ba[sa]||
...
lb.target.getAttribute('id');if(!/true/.test(wb)){Pa[Ya]=lb.detail;var ob=l;/^form$/i.test(l.tagName)||(ob=l.form);var sb=ob.getAttribute('id');if(Aa&&0>=oa&&!wb&&(wb=!0,removeListener(gina,lb.target,hb),x._data=Pa.toData(),x._errors=Pa.getErrors(Ya),x._errors&&0<x._errors.count())){'undefined'==typeof r.$forms[sb].errors&&(r.$forms[sb].errors={});r.$forms[sb].errors[Ya]=x._errors[Ya];if(!mb&&/^true|false$/i.test(r.$forms[sb].isValidating)||''!=Pa[Ya].target.value)v(zb[Ya]),F(ob,x._errors,x._data,
Ya),Ka(ob,mb);M&&U&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&(gina.forms.errors||(gina.forms.errors={}),window.ginaToolbar.update('forms',{id:sb,errors:r.$forms[sb].errors||{}}));triggerEvent(gina,ob,'validated.'+sb,x);return}lb=!1;var mb=null;1==ka.length||ka[ka.length-1]==Ya?(mb=0<x._errors.count()?!1:!0,!mb&&/^true|false$/i.test(r.$forms[sb].isValidating)&&(r.$forms[sb].errors=Q(x._errors,r.$forms[sb].errors),v(zb[Ya]),F(ob,x._errors,x._data,Ya),Ka(ob,mb)),triggerEvent(gina,
ob,'validated.'+sb,x)):/^true$/i.test(r.$forms[sb].isValidating)&&1<ka.length&&ka[ka.length-1]!=Ya&&(lb=!0);lb&&za(ob,Cb,zb,cb,function(Kb){r.$forms[sb].isValidating=!1;mb=Kb.isValid();M&&U&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&(gina.forms.errors||(gina.forms.errors={}),window.ginaToolbar.update('forms',{id:sb,errors:Kb.error||{}}));F(ob,Kb.error,Kb.data,Ya);Ka(ob,mb)})}});Pa[Ya][Ra](cb[Ya][Ra]);continue}else Pa[Ya][Ra](cb[Ya][Ra]);delete ca[Ya]}catch(lb){if('conditions'==Ra)throw Error('[ ginaFormValidator ] could not evaluate `'+
...
'undefined'!=typeof va[hb].conditions&&Array.isArray(va[hb].conditions))if(eb=hb.replace('_case_',''),'undefined'==typeof zb[eb])console.warn('Found case `'+hb+'` but field `'+eb+'` is misssing in the dom.\n You should add `'+eb+'` element to your form in order to allow Validator to process this case.');else{'undefined'==typeof cb[eb]&&(cb[eb]=zb[eb].value);wb=cb[eb];U&&('true'==X[Oa]?wb=!0:'false'==X[Oa]&&(wb=!1));for(var ob=0,sb=va[hb].conditions.length;ob<sb;++ob)if(va[hb].conditions[ob].case==
...
gb(r.isUnfolded,r.isUnfolded.length,0)},200))})}if(!x||'el-xhr'==x&&!Q)Q=x&&'el-xhr'==x?!0:!1,ya(x)},gb=function(x,q,p){if(p==q)return!1;var R=x[p],L=null;M&&/^xhr-/.test(R)?(R=R.replace(/^xhr-/,''),L=P('.gina-toolbar-xhr-folding-state-'+R)):L=P('.gina-toolbar-folding-state-'+R);rb(L,function(){p+=1;gb(x,q,p)})},Ub=function(){La.add(Da).off('click','a').on('click','a',function(q){q.preventDefault();rb(P(this),null,!0)}).add(Na).off('click','a').on('click','a',function(q){q.preventDefault();rb(P(this),
...
ia.off('click').on('click',function(q){ma&&window.open('','JSON RAW','width=400,height=100').document.write(JSON.stringify(ma.data))});Ea.off('click').on('click',function(q){q.preventDefault();Ea.removeClass('gina-toolbar-active');D.removeClass('gina-toolbar-active');P(this).addClass('gina-toolbar-active');m=P(this).attr('href');C=P(m).addClass('gina-toolbar-active');r.panelId=m;r.save()});N.off('click').on('click',function(q){q.preventDefault();I.toggleClass('gina-toolbar-collapsed');fa=I.hasClass('gina-toolbar-collapsed');
r.isCollapsed=fa;r.save()});G.off('change').on('change',function(q){q.preventDefault();q=z.val();var p=y.val();v=q+'-'+p;Zb(v);r.position=v;r.save()});w.off('change').on('change',function(q){q.preventDefault();F=w.val();jb(F);r.width=F;r.save()});P(window).off('resize').on('resize',function(){Db()});P('body').off('keypress').on('keypress',function(q){if(!/INPUT|TEXTAREA/.test(q.target.tagName)){ta=q.keyCode?q.keyCode:q.which?q.which:q.charCode;q=new Date;if('undefined'!=typeof Fa.keynum&&Fa.keynum==
ta&&'undefined'!=typeof Fa.pressTime&&500>q.getTime()-Fa.pressTime)switch(ta){case 103:I.toggle()}Fa.pressTime=q.getTime();Fa.keynum=ta}});Ea.filter('[href="'+m+'"]').trigger('click');fa||P('#gina-toolbar-toggle').trigger('click');Zb(v);var x=v.split('-');z.val(x[0]);y.val(x[1]);jb(F);w.val(F);Db();x=W?W.text():'';/^\{\{ (.*) \}\}/.test(x)?h(x,ab):ab()},Zb=function(x){I.removeClass('gina-toolbar-top-left gina-toolbar-top-right gina-toolbar-bottom-left gina-toolbar-bottom-right').addClass('gina-toolbar-'+
x)},jb=function(x){I.removeClass('gina-toolbar-auto gina-toolbar-100 gina-toolbar-80 gina-toolbar-60 gina-toolbar-50 gina-toolbar-40 gina-toolbar-30').addClass('gina-toolbar-'+x)},Db=function(){J=window.innerHeight-32;I.find('.gina-toolbar-main').css('max-height',J+'px');var x=C.find('.gina-toolbar-main'),q=x.find('.gina-toolbar-content');T=x.height();T==J?q.addClass('gina-toolbar-content-end'):q.removeClass('gina-toolbar-content-end')},rb=function(x,q,p){'undefined'==typeof p&&(p=!1);if(void 0!=
...
(x.addClass('gina-toolbar-unfolded'),x.next('ul').slideToggle('fast'));else if(-1<r.isUnfolded.indexOf(U)&&x.hasClass('gina-toolbar-unfolded')){for(var L=new RegExp('^('+U+')'),ha=0,Aa=r.isUnfolded.length;ha<Aa;++ha)L.test(r.isUnfolded[ha])&&(!aa&&p||aa&&R||p)&&(r.isUnfolded.splice(ha,1),--ha);r.save(!0);0>r.isUnfolded.indexOf(U)&&(x.removeClass('gina-toolbar-unfolded'),x.next('ul').slideToggle('fast'))}else x.addClass('gina-toolbar-unfolded'),x.next('ul').slideToggle('fast')}'undefined'!=typeof q&&
null!=q&&q()},xb=function(x){var q={},p=null,R=[],L=0;for(p in x)x.hasOwnProperty(p)&&(R[L]=p,++L);var ha=R.length;R.sort();for(L=0;L<ha;++L)p=R[L],q[p]=x[p];return q},Ka=function(x,q){var p='';if('undefined'!=typeof x&&''!=x){var R=x;'string'==typeof x&&(R=x.replace(/(\]\[|\[)/g,'-').replace(/\]/,'').replace(/[^A-Za-z0-9_-]/g,'_'));p+=R+'-'}'undefined'!=typeof q&&''!=q?(x=q,'string'==typeof q&&(x=q.replace(/(\]\[|\[)/g,'-').replace(/\]/,'')),p+=x):p=p.substr(0,p.length-1);return p.trim()},db=function(x,
q,p,R,L){var ha='';p='undefined'!=typeof p&&null!=p?p.replace(/[^A-Za-z0-9_-]/g,'_'):'';var Aa='undefined'!=typeof L&&null!=L?L:'',da='undefined'!=typeof R&&null!=R?'-xhr':'';if(x){x=xb(x);q=xb(q);for(var ea in x)if('object'!=typeof x[ea]||Array.isArray(x[ea])||null===x[ea])if(Array.isArray(x[ea])){p+='-'+ea.replace(/[^A-Za-z0-9_-]/g,'_');var E=0<x[ea].length||'undefined'!=typeof q[ea]&&0<q[ea].length?'':' is-empty';ha+='<li class="gina-toolbar-collection">';ha+='<a href="#" class="gina-toolbar-key gina-toolbar'+
da+'-folding-state-'+Ka(Aa,ea.replace(/[^A-Za-z0-9_-]/g,'_'))+E+'">'+ea+' <span>['+x[ea].length+']</span></a>';ha+='<ul class="gina-toolbar-collection">'+Lb(x[ea],q[ea],p,R,L)+'</ul>';ha+='</li>';p=p.substr(0,p.length-ea.length)}else E=null===q[ea]?'null':typeof q[ea],'undefined'==E?(ha+='<li class="gina-toolbar-key-value">',ha+='<span class="gina-toolbar-key gina-toolbar-key-added">'+ea+':</span> <span class="gina-toolbar-value gina-toolbar-value-type-is-'+E+'">'+x[ea]+'</span>'):(x[ea]!==q[ea]&&
(ha+='<li class="gina-toolbar-key-value gina-toolbar-is-overridden">',ha+='<span class="gina-toolbar-key">'+ea+':</span> <span class="gina-toolbar-value">'+q[ea]+'</span>',ha+='</li>'),ha+='<li class="gina-toolbar-key-value">',ha+='<span class="gina-toolbar-key">'+ea+':</span> <span class="gina-toolbar-value gina-toolbar-value-type-is-'+E+'">'+x[ea]+'</span>'),ha+='</li>';else p+='-'+ea.replace(/[^A-Za-z0-9_-]/g,'_'),E=0<x[ea].count()||'undefined'!=typeof q[ea]&&0<q[ea].count()?'':' is-empty',ha+=
'<li class="gina-toolbar-object">',ha+='<a href="#" class="gina-toolbar-key gina-toolbar'+da+'-folding-state-'+Ka(Aa,ea.replace(/[^A-Za-z0-9_-]/g,'_'))+E+'">'+ea+' <span>{ }</span></a>',ha+='<ul class="gina-toolbar-object">'+db(x[ea],q[ea],p,R,L)+'</ul>',ha+='</li>',p=p.substr(0,p.length-ea.length);return ha}},Lb=function(x,q,p,R,L){var ha='';p='undefined'!=typeof p&&null!=p?p:'';var Aa='undefined'!=typeof L&&null!=L?L:'',da='undefined'!=typeof R&&null!=R?'-xhr':'';q||=[];for(var ea=0,E=x.length;ea<
E;++ea)'object'!=typeof x[ea]||Array.isArray(x[ea])?Array.isArray(x[ea])?(p+='-'+ea,''==Aa&&(Aa=p),ha+='<li class="gina-toolbar-collection">',ha+='<a href="#" class="gina-toolbar-key gina-toolbar'+da+'-folding-state-'+Ka(Aa,ea)+'">'+ea+'<span>[ ]</span></a>',ha+='<ul class="gina-toolbar-collection">'+Lb(x[ea],q[ea],p,R,L)+'</ul>',ha+='</li>',p=p.substr(0,p.length-ea.toString().length)):ha+='<li class="gina-toolbar-key-value"><span class="gina-toolbar-key">'+ea+':</span> <span class="gina-toolbar-value">'+
x[ea]+'</span></li>':(q[ea]||(q[ea]=x[ea]),p+='-'+ea,''==Aa&&(Aa=p),ha+='<li class="gina-toolbar-object">',ha+='<a href="#" class="gina-toolbar-key gina-toolbar'+da+'-folding-state-'+Ka(Aa,ea)+'">'+ea+' <span>{ }</span></a>',ha+='<ul class="gina-toolbar-object">'+db(x[ea],q[ea],p,R,L)+'</ul>',ha+='</li>',p=p.substr(0,p.length-ea.toString().length-1));return ha},Vb=function(x,q,p,R,L,ha){p=null!=p?p.replace(/[^A-Za-z0-9_-]/g,'_'):'';var Aa='undefined'!=typeof R&&null!=R?'-xhr':'';x=xb(x);q=xb(q);ha||=
L;for(var da in x){var ea=da;if('object'!=typeof x[da]||Array.isArray(x[da])||null===x[da])if(Array.isArray(x[da])){var E=P('#gina-toolbar-view-'+p.substr(0,p.length-1));var oa=E.length?!0:!1;!oa||/^html/.test(p)?(E=P('.'+p),oa=p+da.replace(/[^A-Za-z0-9_-]/g,'_')+'-',E.append('<li class="gina-toolbar-collection"><a href="#" class="gina-toolbar-key gina-toolbar'+Aa+'-folding-state-'+Ka(da.replace(/[^A-Za-z0-9_-]/g,'_'),oa.substr(0,oa.length-1))+'">'+da+' <span>['+x[da].length+']</span></a><ul> '+Lb(x[da],
q[da],oa,E.find('li ul.'+p.substr(0,p.length-1)),ea)+'</ul></li>')):(oa=p+da.replace(/[^A-Za-z0-9_-]/g,'_')+'-',E.find('li.'+p.substr(0,p.length-1)+' ul').append('<li class="gina-toolbar-collection"><a class="gina-toolbar-key gina-toolbar'+Aa+'-folding-state-'+Ka(da.replace(/[^A-Za-z0-9_-]/g,'_'),oa.substr(0,oa.length-1))+'">'+da+' <span>['+x[da].length+']</span></a><ul>'+Lb(x[da],q[da],oa,E.find('li ul.'+p.substr(0,p.length-1)),ea)+'</ul></li>'));p+=da.replace(/[^A-Za-z0-9_-]/g,'_')+'-';p=p.substr(0,
p.length-da.length-1)}else if(ea=null===q[da]?'null':typeof q[da],'undefined'==ea)/\-$/.test(p)&&(p=p.substr(0,p.length-1)),p&&L.find('ul.'+p).append('<li class="gina-toolbar-key-value"><span class="gina-toolbar-key gina-toolbar-key-added">'+da+':</span> <span class="gina-toolbar-value gina-toolbar-value-type-is-'+ea+'">'+x[da]+'</span></li>');else if(x[da]!==q[da]){p||(p+=da.replace(/[^A-Za-z0-9_-]/g,'_')+'-');try{L.find('ul.'+p).append('<li class="gina-toolbar-key-value gina-toolbar-is-overridden"><span class="gina-toolbar-key">'+
da+':</span> <span class="gina-toolbar-value">'+q[da]+'</span></li>'),L.find('ul.'+p).append('<li class="gina-toolbar-key-value"><span class="gina-toolbar-key">'+da+':</span> <span class="gina-toolbar-value gina-toolbar-value-type-is-'+ea+'">'+x[da]+'</span></li>')}catch(ra){throw Error('GinaToolbarError: `ul.'+p+'` not found');}}else!p||/^html\-properties/.test(p)?ha.find('.gina-toolbar-properties').append('<li class="gina-toolbar-key-value"><span class="gina-toolbar-key">'+da+':</span> <span class="gina-toolbar-value gina-toolbar-value-type-is-'+
ea+'">'+x[da]+'</span></li>'):ha.find('ul.'+p.substr(0,p.length-1)).append('<li class="gina-toolbar-key-value"><span class="gina-toolbar-key">'+da+':</span> <span class="gina-toolbar-value gina-toolbar-value-type-is-'+ea+'">'+x[da]+'</span></li>');else E=P('#gina-toolbar-view-'+p.substr(0,p.length-1)),(oa=E.length?!0:!1)?(oa=p+da.replace(/[^A-Za-z0-9_-]/g,'_')+'-',E.find('ul.'+p.substr(0,p.length-1)).append('<li class="gina-toolbar-object"><a href="#" class="gina-toolbar-key gina-toolbar'+Aa+'-folding-state-'+
Ka(da.replace(/[^A-Za-z0-9_-]/g,'_'),oa.substr(0,oa.length-1))+'">'+da+' <span>{ }</span></a><ul class="gina-toolbar-object '+oa.substr(0,oa.length-1)+'"></ul></li>'),Vb(x[da],q[da],oa,R,E.find('ul.'+p.substr(0,p.length-1)),ha),p+=da.replace(/[^A-Za-z0-9_-]/g,'_')+'-'):(p+=da.replace(/[^A-Za-z0-9_-]/g,'_')+'-','params'==da?(ea='<div id="gina-toolbar-view-'+p.substr(0,p.length-1)+'" class="gina-toolbar-section"><h2 class="gina-toolbar-section-title">'+p.substr(0,p.length-1)+'</h2><ul class="'+p.substr(0,
p.length-1)+'"></ul></div>',P('#gina-toolbar-view-html-properties').before(ea)):/^html/.test(p)||(ea='<div id="gina-toolbar-view-'+p.substr(0,p.length-1)+'" class="gina-toolbar-section"><h2 class="gina-toolbar-section-title">'+p.substr(0,p.length-1)+'</h2><ul class="'+p.substr(0,p.length-1)+'"></ul></div>',L.append(ea)),Vb(x[da],q[da],p,R,L.find('ul.'+p.substr(0,p.length-1)),ha)),p=p.substr(0,p.length-da.length-1)}return ha.html()},ya=function(x){x=gina.hasPopinHandler?gina.popin.getActivePopin():
null;var q,p=(gina.hasPopinHandler?P('#'+x.id):P('body')).html().match(/404:\[(.+)\](.+)@(.+)"/gm);if(p){var R=0;for(q=p.length;R<q;++R){x=p[R].replace(/"(.*)|"/g,'');var L=x.match(/\[(.*)\]/g,'')[0].replace(/\[|\]/g,'');V.getRouteByUrl(x,L)}}fLen=V.notFound.count();if(0<fLen)for(f in V.notFound)console.warn('(x'+V.notFound[f].count+') '+f+' => '+V.notFound[f].message)},za=function(x,q,p,R,L,ha,Aa){if(!ha)return!1;for(var da=L[R].attributes,ea,E=L[R].getAttribute('id')||L[R].id,oa=P('<div id="gina-toolbar-form-'+
E+'" class="gina-toolbar-section"><h2 class="gina-toolbar-section-title">'+E+'</h2><ul class="gina-toolbar-section-content gina-toolbar-code" style="display: none;"><li class="gina-toolbar-form-attributes"><h3 class="gina-toolbar-sub-section-title">'+'gina-toolbar-form-attributes'.replace(/gina-toolbar-form-/,'')+'</h3><ul class="gina-toolbar-code"></ul></li></ul></div>'),ra,ja,ba=null,Ga=0,Pa=da.length;Ga<Pa;++Ga)ra=da[Ga].name,ja=da[Ga].nodeValue,/^method$/.test(ra)&&(ja=ja.toUpperCase()),/^class$/.test(ra)&&
/\s+/.test(ja)&&(ja='<ul><li>'+ja.replace(/\s+/g,'</li><li>')+'</li></ul>'),/^action$/.test(ra)&&((ea='undefined'!=typeof da.method?da.method.nodeValue:void 0)||console.warn('[ ToolbarFormHelper::UndefinedMethod : form `'+da.id.nodeValue+'` method attribute cannot be left undefined !'),ea=V.getRouteByUrl(ja,ea),'undefined'!=typeof ea&&ea||(ea={name:'not found',namespace:'not found',param:{control:'not found',file:'not found'}}),ja='<ul><li><span class="gina-toolbar-key">url</span><span class="gina-toolbar-value">'+
(ja||'#')+'</span></li><li><span class="gina-toolbar-key">route</span><span class="gina-toolbar-value">'+ea.name+'</span></li><li><span class="gina-toolbar-key">namespace</span><span class="gina-toolbar-value">'+(ea.namespace||'root controller')+'</span></li><li><span class="gina-toolbar-key">control</span><span class="gina-toolbar-value">'+ea.param.control+'</span></li><li><span class="gina-toolbar-key">file</span><span class="gina-toolbar-value">'+ea.param.file+'</span></li><ul>',ba='<li><span class="gina-toolbar-key">'+
ra+':</span><span class="gina-toolbar-value">'+ja+'</span></li>'),/^data-gina-form-event/.test(ra)?(ea='events',ba=oa.find('.gina-toolbar-form-attributes').find('.gina-toolbar-key-events').length?!0:!1,ra=ra.replace(/^data-gina-form-event-/,''),ba||oa.find('ul.gina-toolbar-section-content').append('<li class="gina-toolbar-form-'+ea+'"><h3 class="gina-toolbar-sub-section-title">'+ea+'</h3><ul class="gina-toolbar-code"></ul></li>'),ba='<li><span class="gina-toolbar-key">'+ra+':</span><span class="gina-toolbar-value">'+
ja+'</span></li>',oa.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-'+ea+' > ul').append(ba)):(/^action$/.test(ra)||(ba='<li><span class="gina-toolbar-key">'+ra+':</span><span class="gina-toolbar-value">'+ja+'</span></li>'),oa.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-attributes > ul').append(ba));da=null;try{var $a=L[R].getAttribute('data-gina-form-rule');da='undefined'!=typeof $a&&null!=$a?eval('gina.forms.rules.'+$a.replace(/-/g,'.')):eval('gina.forms.rules.'+
E.replace(/-/g,'.'))}catch(ib){}da&&(ea='rules',oa.find('ul.gina-toolbar-section-content').append('<li class="gina-toolbar-form-'+ea+'"><h3 class="gina-toolbar-sub-section-title">'+ea+'</h3><ul class="gina-toolbar-properties">'+db(da,da,E,Aa,ea)+'</ul></li>'));p.append(oa);++R;R<ha&&za(x,q,p,R,L,ha,Aa)},l=function(x,q,p,R){var L=P('#gina-toolbar-form-'+x);$section=L.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-'+q+'> ul');if(0<$section.length){if(0==p.count())return L.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-'+
