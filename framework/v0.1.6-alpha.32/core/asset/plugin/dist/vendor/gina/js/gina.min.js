...
Ja,Ua,pb){Ja&&r(Ja,function(ab,gb){if(Ua||!Q(Ia,gb))!pb||'object'!==typeof ab||!ab||U(ab)||ma(ab)||ab instanceof RegExp?Ia[gb]=ab:(Ia[gb]||(Ia[gb]={}),G(Ia[gb],ab,Ua,pb))});return Ia}function w(Ia,Ja){return function(){return Ja.apply(Ia,arguments)}}function va(Ia){throw Ia;}function Aa(Ia){if(!Ia)return Ia;var Ja=B;N(Ia.split('.'),function(Ua){Ja=Ja[Ua]});return Ja}function O(Ia,Ja,Ua,pb){Ja=Error(Ja+'\nhttps://requirejs.org/docs/errors.html#'+Ia);Ja.requireType=Ia;Ja.requireModules=pb;Ua&&(Ja.originalError=
...
typeof arguments[r]&&null!=(w=arguments[r])){if('object'!=typeof w){Q=w;break}if(Array.isArray(w)&&Array.isArray(Q))Q=ma(w,Q,S);else for(var Aa in w){Q||={name:null};var O=Q[Aa];var M=w[Aa];if(Q!==M)if(M&&(U(M)||(va=Array.isArray(M)))){var A=!1;if(va){va=!1;if(O&&Array.isArray(O))var D=O||[];else if(U(O)){D=O||{};Q[Aa]=D;continue}else D=[];B=D;D=ma(M,D,S);Q[Aa]=D}else{D=O&&U(O)?O:null;if(!D){A=!0;D={};for(var l in M)D[l]=M[l]}if(S){for(l in M)'undefined'!=typeof M[l]?Array.isArray(M[l])&&Array.isArray(D[l])?
D[l]=ma(M[l],D[l],S):D[l]=M[l]:Array.isArray(M[l])&&Array.isArray(D[l])&&(D[l]=ma(M[l],D[l],S));Q[Aa]=D}else{for(l in M)'undefined'==typeof D[l]?Array.isArray(M[l])&&Array.isArray(D[l])?D[l]=ma(M[l],D[l],S):D[l]=M[l]:Array.isArray(M[l])&&Array.isArray(D[l])&&(D[l]=ma(M[l],D[l],S));'boolean'==typeof O||A?A&&(Q[Aa]=D):Q[Aa]=V(D,M,S)}}}else void 0!==M&&(Q[Aa]='undefined'==typeof O||null==O||O===M||S?M:O)}}B=[];P=!1;return Q},ma=function(N,ba,Q){B=[];var S=[],r=V.getKeyComparison();if(/^true$/i.test(Q)){if('object'==
typeof N[0]&&null!=N[0]&&'undefined'!=typeof N[0][r]&&'object'==typeof ba[0]&&'undefined'!=typeof ba[0][r]){B=Array.isArray(ba)?Array.from(ba):JSON.clone(ba);var G=0;for(Q=B.length;G<Q;++G)S.push(B[G][r]);Q=JSON.clone(N);var w=0;G=0;N=Q.length;for(var va=O||0,Aa=ba.length;va<Aa;++va)a:for(G=G||0;G<N;++G)if(Q[G][r]===ba[va][r]){-1<S.indexOf(Q[G][r])?(B[w]=Q[G],++w):-1==S.indexOf(Q[G][r])&&(S.push(Q[G][r]),B[w]=Q[G],++w);break a}else-1==S.indexOf(Q[G][r])&&(S.push(Q[G][r]),B.push(Q[G]));return B}return Array.isArray(N)&&
...
var O=null;G=0;for(N=B.length;G<N;++G)S.push(B[G][r]);for(G=0;G<N;++G)a:for(va=O||0,Aa=Q.length;va<Aa;++va)if(null!=Q[va]&&'undefined'!=typeof Q[va][r]&&Q[va][r]!==B[G][r]){if(-1==S.indexOf(Q[va][r])){B.push(Q[va]);S.push(Q[va][r]);O=va+1;N<Aa&&++N;break a}}else if(null!=Q[va]&&'undefined'!=typeof Q[va][r]&&Q[va][r]===B[G][r])O=va+1;else break a;return B}for(G=0;G<N.length;++G)if(S=null,'undefined'==typeof N||'object'!=typeof N[G]||Array.isArray(N[G])||null==N[G]||(S=Object.getOwnPropertyNames(N[G])),
...
var H=w?0:r.getTimezoneOffset(),J={d:Aa,dd:A(Aa),ddd:va.dayNames[l],dddd:va.dayNames[l+7],m:y+1,mm:A(y+1),mmm:va.monthNames[y],mmmm:va.monthNames[y+12],yy:String(z).slice(2),yyyy:z,h:F%12||12,hh:A(F%12||12),H:F,HH:A(F),M:u,MM:A(u),s:v,ss:A(v),l:A(D,3),L:A(D),t:12>F?'a':'p',tt:12>F?'am':'pm',T:12>F?'A':'P',TT:12>F?'AM':'PM',Z:w?'UTC':(String(r).match(O)||['']).pop().replace(M,''),o:(0<H?'-':'+')+A(100*Math.floor(Math.abs(H)/60)+Math.abs(H)%60,4),S:['th','st','nd','rd'][3<Aa%10?0:(10!=Aa%100-Aa%10)*
Aa%10]};return G.replace(/d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g,function(T){return T in J?J[T]:T.slice(1,T.length-1)})},countDaysTo:ba,getDaysTo:function(r,G,w){if(G instanceof Date){G=ba(r,G);var va=r.getMonth(),Aa=r.getFullYear();r=r.getDate()+1;r=new Date(Aa,va,r);va=[];for(Aa=0;Aa<G;++Aa)'undefined'!=typeof w?va.push((new Date(r)).format(w)):va.push(new Date(r)),r.setDate(r.getDate()+1);return va||[]}throw Error('dateTo is not instance of Date() !');},getDaysInMonth:function(r){var G=
...
va.envConf[r][G].host,w.webroot=va.envConf[r][G].server.webroot;return w};P.compareUrls=async function(r,G,w,va,Aa){'undefined'==typeof w&&(w={routing:{}});if(/,/.test(G)){var O=0;G=G.split(/,/g);for(var M=G.length,A={past:!1,request:w};O<M&&!A.past;)A=await N(r,G[O],w,va,Aa),++O;return A}return await N(r,G,w,va,Aa)};var N=async function(r,G,w,va,Aa){var O=null;try{O=r.url.split(/\//)}catch(T){console.warn(T),O=['']}G=G.split(/\//);var M=0,A=0,D=G.length,l=0,y={},z=0,F=w.method.toLowerCase(),u='get';
...
r==D.query.data[Object.keys(D.query.data)[0]]&&(D.query.data[Object.keys(D.query.data)[0]]=l[y],va.params[y]=l[y]);z[y]=D;l=new U('routing',l,null,z);if(0==D.count())return console.error('Route validation failed '+w.rule),!1;for(var v in D)Array.isArray(D[v])?await l[y][v].apply(l[y],D[v]):await l[y][v](D[v],va,Aa,O);D=l.isValid()}else D=(new RegExp(w.requirements[y])).test(G);if('undefined'!=typeof w.param[y]&&'undefined'!=typeof w.requirements&&'undefined'!=typeof w.requirements[y]&&'undefined'!=
typeof va.params&&D)return va.params[y]=G,'undefined'==typeof va[u][y]&&(va[u][y]=G),!0}else{Aa=w.url;O=va.url;u={};z='';var H=!1,J=0;v=0;for(var T=O.length;v<T;++v)if(O.charAt(v)!=Aa.charAt(J)||H){if(''==z)H=!0,z+=O.charAt(v);else if(v>Aa.indexOf(A[0])+A[0].length){M=w.requirements[A[0]];G=z.substr(0,z.length);if(/^\//.test(M))D=M.match(/\/(.*)\//).pop(),l=M.replace('/'+D+'/',''),D=(new RegExp(D,l)).test(G);else if(/^validator::/.test(M)){l={};D={};z={};F='';r.replace(new RegExp('[^'+y[0]+']','g'),
function(qa){F+=qa});l[y[0]]=G.replace(new RegExp(F,'g'),'');D=JSON.parse(M.split(/::/).splice(1)[0].replace(/([^\W+ true false])+(\w+)/g,'"$&"'));z[y[0]]=D;l=new U('routing',l,null,z);for(let qa in D)if(Array.isArray(D[qa]))l[y[0]][qa].apply(l[y[0]],D[qa]);else l[y[0]][qa](D[qa]);D=l.isValid()}else D=(new RegExp(w.requirements[y[0]])).test(G);if(D)u[A[0].substr(1)]=G;else return!1;z='';H=!1;J=Aa.indexOf(A[0])+A[0].length;--v;A.splice(0,1)}else z+=O.charAt(v),++J;if(v==T-1)if(M=w.requirements[A[0]],
G=z.substr(0,z.length),/^\//.test(M)?(D=M.match(/\/(.*)\//).pop(),l=M.replace('/'+D+'/',''),D=(new RegExp(D,l)).test(G)):D=(new RegExp(w.requirements[y])).test(G),D)u[A[0].substr(1)]=G;else return!1}else++J;if(u.count()==A.length){y=null;for(y in u)va.params[y]=u[y];return!0}}return!1},Q=function(r){return/\/$/.test(r)?Q.variable+'/':Q.variable},S=function(r,G){var w=null,va,Aa=r.url,O=null;for(O in r.param)if(('undefined'==typeof G||'undefined'!=typeof G[O])&&/^:/.test(r.param[O])){var M=r.param[O].substr(1);
...
r.param.file.replace(A,Q));if(/,/.test(r.url)){w=r.url.split(/,/g);var D=0;for(va=w.length;D<va;++D)Q.variable=G[M],w[D]=w[D].replace(A,Q);r.url=w.join(',')}else Q.variable=G[M],r.url=r.url.replace(A,Q)}}if(w){D=0;va=w.length;Aa=Aa.split(/,/g);var l=0;for(r.urlIndex=0;D<va;++D)if(w=0,A=Aa[0].match(/:[-_a-z0-9]+/ig)){O=0;for(M=A.length;O<M;O++){var y=A[O].substr(1);'undefined'!=typeof G[y]&&G[y]&&w++}w>l&&(l=w,r.urlIndex=D)}}return r};P.getRoute=function(r,G,w){var va=null,Aa=!1;B?(window.location.port||
window.location.hostname!=window.gina.config.hostname.replace(/^(https|http|wss|ws):\/\//,'').replace(/:\d+$/,'')||(Aa=!0,window.gina.config.hostname=window.gina.config.hostname.replace(/^(https|http|wss|ws):\/\//,'').replace(/:\d+$/,'')),va=window.gina.config):(va=getContext('gina').config,'undefined'!=typeof getContext('argvFilename')&&(va.getRouting=getContext('gina').Config.instance.getRouting),Aa=getContext('isProxyHost'));var O=va.env||GINA_ENV,M=null,A=va.bundle;/@/.test(r)||'undefined'==typeof A||
null==A||(r=r.toLowerCase(),r+='@'+A);if(/@/.test(r)){var D=r.replace(/(.*):\/\//,'').split(/@/);A=D[1];/\/(.*)$/.test(r)&&(M=r.replace(/(.*):\/\//,'').split(/\/(.*)$/)[1],A=A.replace(/\/(.*)$/,''),O=M||O);r=D[0].toLowerCase()+'@'+A}A=va.getRouting(A,O);if('undefined'==typeof A[r])throw Error('[ RoutingHelper::getRouting(rule, params) ] : `'+r+'` not found !');M=JSON.clone(A[r]);D=null;M=S(M,G);if(M.isProxyHost=Aa)M.hostname=B?window.location.protocol+'//'+window.gina.config.hostname:process.gina.PROXY_HOSTNAME||
va.envConf._proxyHostname,M.host=M.hostname.replace(/^(https|http):\/\//,'');/,/.test(M.url)&&('undefined'!=typeof M.urlIndex&&(w=M.urlIndex,delete M.urlIndex),w='undefined'!=typeof w?w:0,M.url=M.url.split(/,/g)[w]);/\/$/.test(M.url)&&'/'!=M.url&&(M.url=M.url.substr(0,M.url.length-1));if(/GET/i.test(M.method)&&'undefined'!=typeof G){w='?';va=A[r].url;Aa=[];A=0;for(let l in M.param)-1<P.reservedParams.indexOf(l)||(new RegExp(M.param[l])).test(va)||'undefined'==typeof G[l]||(w+=l+'='+encodeRFC5987ValueChars(G[l])+
'&',Aa[A]=G[l],++A);for(let l in G)-1<P.reservedParams.indexOf(l)||'undefined'!=typeof M.requirements[l]||-1<Aa.indexOf(l)||(w='object'==typeof G[l]?w+(l+'='+encodeRFC5987ValueChars(JSON.stringify(G[l]))+'&'):w+(l+'='+G[l]+'&'));A=Aa=va=null;1<w.length&&(w=w.substring(0,w.length-1),M.url+=w);w=null}M.toUrl=function(l){var y=null;/^redirect$/i.test(this.param.control)&&(y=P.getUrlProps(this.bundle,O||GINA_ENV));var z=this.webroot||y.webroot;y=this.hostname||y.hostname;var F=this.url;this.url='undefined'!=
typeof l&&/^true$/i.test(l)?F.replace(new RegExp('^'+z),'/'):F.replace(new RegExp('^('+z+'|/$)'),z);return y+this.url};M.request=function(l,y){var z=null,F=null;'function'==typeof arguments[arguments.length-1]&&(z=arguments[arguments.length-1]);'object'==typeof arguments[2]&&(F=arguments[2]);var u=this.webroot||F.webroot,v=this.hostname||F.hostname;F='undefined'!=typeof l&&1==l?path.replace(u,'/'):this.url||F.url;v=/^https/.test(v)?'https':'http';B?window.open(F,'undefined'!=typeof y&&'undefined'!=
typeof y.target?y.target:'_self'):('undefined'==typeof y.agent&&(y.agent=!1),v=require(''+v),u=function(H){var J='',T=!1;H.on('data',function(qa){J+=qa});H.on('error',function(qa){T='Failed to get mail content';qa&&'undefined'!=typeof qa.stack?T+=qa.stack:'string'==typeof qa&&(T+='\n'+qa)});H.on('end',function(){if(/^\{/.test(J))try{J=JSON.parse(J),'undefined'!=typeof J.error&&(T=JSON.clone(J),J=null)}catch(qa){T=qa}T?z(T):z(!1,J)})},z?v.get(F,y,u):v.get(F,y))};!/:/.test(M.url)||/:d+\//.test(M.url)||
/:\/\//.test(M.url)||(G=M.url.match(/(:(.*)\/|:(.*)$)/g).map(function(l){return l.replace(/\//g,'')}).join(', '),D='[ RoutingHelper::getRoute(rule[, bundle, method]) ] : route [ %r ] param placeholder not defined: `'+M.url+'` !\n Check your route description to compare requirements against param variables [ '+G+']',D=D.replace(/%r/,r),r=Error(D),console.warn(r),D=r=G=null);return M};P.getRouteByUrl=function(r,G,w,va,Aa){2==arguments.length&&'undefined'!=typeof arguments[1]&&arguments[1]&&-1<P.allowedMethods.indexOf(arguments[1].toLowerCase())&&
(w=arguments[1],G=void 0);var O=null,M=null,A=null,D=null,l=null,y=null;if(/#/.test(r)&&1<r.length){var z=r.split(/#/);r=z[0];l='#'+z[1];z=null}1==arguments.length&&'undefined'!=typeof arguments[0]&&(/^(https|http)/i.test(r)||/^\//.test(r)||(r='/'+r),O='/'+r.split(/\//g)[1],B&&(D=gina.config.reverseRouting,A=gina.config.routing),'undefined'!=typeof D[O]&&(z=A[D[O]],G=z.bundle,O=z.webroot,y=z.hostname,z=null));Aa='boolean'!=typeof arguments[arguments.length-1]?!1:arguments[arguments.length-1];var F=
!1,u=null,v=null,H=u=v=null;z='undefined'!=typeof w?!0:!1;B?(u=window.gina.config,G='undefined'!=typeof G?G:u.bundle,v=u.env,A=A||u.getRouting(G),D=D||u.reverseRouting,isXMLRequest='undefined'!=typeof isXMLRequest?isXMLRequest:!1,y=y||u.hostname,O=O||u.webroot,va={routing:{},method:w,params:{},url:r},G&&(va.bundle=G)):(u=getContext('gina').config,G='undefined'!=typeof G?G:u.bundle,v=u.env,A=u.getRouting(G),y=u.envConf[G][v].hostname,O=u.envConf[G][v].server.webroot,va||={routing:{},isXMLRequest:!1,
method:'undefined'!=typeof w?w.toLowerCase():'get',params:{},url:r},Aa&&(va.method=w),isXMLRequest=va.isXMLRequest||!1);v=r.replace(new RegExp('^('+y+'|'+y.replace(/:\d+/,'')+')'),'');'undefined'==typeof va.routing.path&&(va.routing.path=decodeURI(v));w='undefined'!=typeof w?w.toLowerCase():'get';z&&(va.originalMethod=va.method,va.method=w,va.routing.path=decodeURI(v));va.method||(va.method=w);u={};O=new RegExp(w,'i');D=null;var J;for(J in A){if('undefined'==typeof A[J].param)break;if(A[J].bundle==
G&&(D=A[J].method,/,/.test(D)&&O.test(D)&&(D=va.method),'undefined'==typeof A[J].method||O.test(D))){u={method:D,requirements:A[J].requirements,namespace:A[J].namespace||void 0,url:decodeURI(v),rule:A[J].originalRule||J,param:A[J].param,middleware:JSON.clone(A[J].middleware),bundle:A[J].bundle,isXMLRequest};try{if(H=P.compareUrls(u,A[J].url,va),H.past){M=JSON.clone(A[J]);M.name=J;F=!0;H={};break}}catch(T){throw Error('Route [ '+J+' ] needs your attention.\n'+T.stack);}}}if(F)return/\/$/.test(r)&&
'/'!=r&&(r=r.substr(0,r.length-1)),l&&(r+=l),M.url=r,M.toUrl=function(T){var qa=this.webroot,Fa=this.hostname,W=this.url;this.url='undefined'!=typeof T&&1==T?W.replace(qa,'/'):W;return Fa+this.url},M;if(B){l=!1;if('#'==r&&/GET/i.test(w)&&z||/^404:/.test(r))r=location.pathname,l=!0;'undefined'==typeof P.notFound&&(P.notFound={});A=null;M='[ RoutingHelper::getRouteByUrl(rule[, bundle, method]) ] : route [ %r ] is called but not found inside your view: `'+r+'` !';if((A=(A=gina.hasPopinHandler&&gina.popinIsBinded?
gina.popin.getActivePopin().target.innerHTML.match(/404:\[\w+\][a-z 0-9-_@]+/):document.body.innerHTML.match(/404:\[\w+\][a-z 0-9-_@]+/))&&0<A.length?A[0]:null)&&z&&l)return l=A.match(/\[\w+\]/)[0],A=A.replace('404:'+l,l.replace(/\[|\]/g,'')+'::'),M=M.replace(/%r/,A.replace(/404:\s+/,'')),'undefined'==typeof P.notFound[A]?P.notFound[A]={count:1,message:M}:z&&'undefined'!=typeof P.notFound[A]&&++P.notFound[A].count,!1;if((l=gina.config.reverseRouting[r]||null)&&'undefined'!=typeof l&&l.split(/@(.+)$/)[1]==
G)return A=l,'undefined'==typeof P.notFound[A]?(M=M.replace(/%r/,w.toUpperCase()+'::'+l),P.notFound[A]={count:1,message:M}):z&&'undefined'!=typeof P.notFound[A]&&++P.notFound[A].count,!1;A=P.compareUrls(u,r,va)||null;A.past&&z&&(A=w.toUpperCase()+'::'+A.request.routing.rule,'undefined'==typeof P.notFound[A]?M=M.replace(/%r/,A):++P.notFound[A].count);return!1}console.warn(Error('[ RoutingHelper::getRouteByUrl(rule[, bundle, method, request]) ] : route not found for url: `'+r+'` !').stack);return!1};
return P}'undefined'!==typeof module&&module.exports?module.exports=Routing():'function'===typeof define&&define.amd&&define('lib/routing',['require','lib/form-validator','lib/merge'],function(){return Routing()});
function StoragePlugin(B){function P(M){G=JSON.parse(S.getItem(this.bucket));'undefined'==typeof G[M]&&(G[M]=[],S.setItem(this.bucket,JSON.stringify(G)),G=JSON.parse(S.getItem(this.bucket)));r[M]={_collection:M,_bucket:this.bucket};r[M]=ma(r[M],Aa);return r[M]}function V(M){if('object'!==typeof M)throw Error('filter must be an object');var A=G[this._collection],D=M.count(),l=0,y=null;if(0==D)return null;for(var z in A)for(var F in M){var u='boolean'!=typeof M[F]?M[F].toLocaleLowerCase():M[F];M[F]&&
...
null,errors:{},initialized:!1,isReady:!1,rules:{},$forms:{},getFormById:null,validateFormById:null,setOptions:null,resetErrorsDisplay:null,resetFields:null},va={id:null,plugin:this.plugin,on:U?on:null,eventData:{},target:U?document:null,cachedErrors:{},binded:!1,unbinded:!1,withUserBindings:!1,rules:{},setOptions:null,send:null,isValidating:null,isSubmitting:null,submit:null,destroy:null,resetErrorsDisplay:null,resetFields:null},Aa={},O={},M=null,A={url:'',method:'GET',isSynchrone:!1,withCredentials:!1,
...
K.target;w.$forms[K.target.form.getAttribute('id')].isValidating=!0;za(K.target,Ba,ea,m.rules,function(da){w.$forms[K.target.form.getAttribute('id')].isValidating=!1;da.isValid()?H(K.target.form,{},da.data,K.target.name):H(K.target.form,da.error,da.data,K.target.name);var E=K.target.form,na=da=null,ra=null;na=db(E,x);da=na.fields;na=na.$fields;var ia=E.getAttribute('id');ra=w.$forms[ia].rules;w.$forms[ia].isValidating=!0;za(E,da,na,ra,function(Z){w.$forms[ia].isValidating=!1;console.debug('['+ia+
...
ha.off('click').on('click',function(q){la&&window.open('','JSON RAW','width=400,height=100').document.write(JSON.stringify(la.data))});Aa.off('click').on('click',function(q){q.preventDefault();Aa.removeClass('gina-toolbar-active');A.removeClass('gina-toolbar-active');P(this).addClass('gina-toolbar-active');l=P(this).attr('href');D=P(l).addClass('gina-toolbar-active');w.panelId=l;w.save()});O.off('click').on('click',function(q){q.preventDefault();G.toggleClass('gina-toolbar-collapsed');va=G.hasClass('gina-toolbar-collapsed');
...
function Domain(B,P){var V='undefined'!==typeof module&&module.exports?!1:!0,ma=!1;V&&(ma=!!window.MSInputMethodContext&&!!document.documentMode);'function'==typeof B&&(P=B,B=void 0);var U={filename:'../dist/public_suffix_list.dat',url:'https://publicsuffix.org/list/public_suffix_list.dat',alternativeUrl:'https://raw.githubusercontent.com/publicsuffix/list/master/public_suffix_list.dat',isCachingRequired:!1,isUpdating:!1},N=null,ba=null,Q=function(Aa,O,M){if('undefined'==typeof O)O=U;else for(let A in U)'undefined'==
typeof O[A]&&(O[A]=U[A]);V||(O.filename=__dirname+'/'+O.filename);V&&O.isCachingRequired&&(console.warn('[DOMAIN] `options.isCachingRequired` is only available for backend'),O.isCachingRequired=!1);N=O;if(M)return r(O,function(A){A?M(A):(console.debug('[DOMAIN] PSL Loaded'),M(A,Aa))});r(O);console.debug('[DOMAIN] PSL Loaded');return Aa},S=function(){},r=async function(Aa,O){var M=V||Aa.isCachingRequired?Aa.url:Aa.filename,A='undefined'!=typeof Aa.isUpdating?Aa.isUpdating:!1,D=null;if(V)if(ba&&!A)O(!1);
else if(window.fetch){D=A=null;try{A=await fetch(M),ba=D=await A.text()}catch(y){D=Error('[DOMAIN] Could not load PSL\n'+(y.stack||y.message||y));O(D);return}Aa.isUpdating=!1;O(!1)}else D=Error('[DOMAIN] Fetch API not supported'),O(D);else{M=!1;if('undefined'!=typeof fs.accessSync)try{fs.accessSync(Aa.filename,fs.constants.F_OK),M=!0}catch(y){M=!1;try{fs.lstatSync(Aa.filename).isSymbolicLink()&&(M=!0)}catch(z){}}else M=fs.existsSync(Aa.filename);M||(Aa.isCachingRequired=!0);if(Aa.isCachingRequired){M=
'curl -o '+Aa.filename+' '+Aa.url+' >/dev/null 2>&1';console.debug('[DOMAIN] Running: '+M);try{execSync(M)}catch(y){console.warn('[DOMAIN] could not fetch from `'+Aa.url+'`. Trying with `'+Aa.alternativeUrl+'`');M='curl -o '+Aa.filename+' '+Aa.alternativeUrl+' >/dev/null 2>&1';try{execSync(M)}catch(z){O(z);return}}var l=!1;nIntervId=setInterval(()=>{if('undefined'!=typeof fs.accessSync)try{fs.accessSync(Aa.filename,fs.constants.F_OK),l=!0}catch(y){l=!1;try{fs.lstatSync(Aa.filename).isSymbolicLink()&&
(l=!0)}catch(z){}}else l=fs.existsSync(Aa.filename);l&&(clearInterval(nIntervId),ba=fs.readFileSync(Aa.filename).toString(),O(!1))},200)}try{ba=fs.readFileSync(Aa.filename).toString(),O&&O(!1)}catch(y){console.warn('[DOMAIN] could not read from `'+Aa.filename+'`'),r(B,O)}}},G=function(Aa){N.isUpdating=!0;r(N,Aa)},w=async function(Aa){Aa='undefined'!=typeof Aa&&''!=Aa?Aa:os.hostname();if(/\./.test(Aa))return Aa;console.debug('[DOMAIN][getFQDN] FQDN: '+Aa);var O=null,M=null;O=await promisify(dns.lookup)(Aa,
{hints:dns.ADDRCONFIG||dns.V4MAPPED}).then(function(A){console.debug('[DOMAIN][getFQDN] IP: '+A.address);console.debug('[DOMAIN][getFQDN] FAMILY: '+A.family);return A}).catch(function(A){M=A});if(M)throw M;Aa=await promisify(dns.lookupService)(O.address,0).then(function(A){console.debug('[DOMAIN][getFQDN] FQDN: '+A.hostname);console.debug('[DOMAIN][getFQDN] Service: '+A.service);return A.hostname}).catch(function(A){});if(M)throw M;if(!/\./.test(Aa))throw Error('[DOMAIN][getFQDN] `'+Aa+'` is not a FQDN !');
return Aa},va={getRootDomain:function(Aa,O){'undefined'==typeof O&&(O=!1);Aa=Aa.trim();var M=!1,A=!1,D=Aa.replace(/^(.*):\/\/|\/(.*)/g,''),l=D.split(/\./g).reverse(),y=l.length?l.length-1:0,z=ba.replace(/\/\/\s*(.*)\n|^\s*\n/gm,'').split(/\n/).filter(function(F,u,v){/[^a-z 0-9.]+/.test(F)&&(F=F.replace(/[^a-z 0-9.]+/g,'').replace(/^\./g,''));return/\./.test(F)&&!M&&(new RegExp('.'+F+'$')).test(D)?(M=!0,y=F.split(/\./g).length,v.splice(0,v.length),!1):F});D=l[y];0<y&&(l=l.splice(0,y),A=l[0],/:(.*)$/.test(A)&&
(A=A.replace(/:(.*)$/,'')),(A=M||!M&&-1<z.indexOf(A)?!0:!1)?1<y&&!M?(l.splice(2),D=l.reverse().join('.')):D+='.'+l.reverse().join('.'):1<y?(l.splice(2),D=l.reverse().join('.')):D+='.'+l.reverse().join('.'));/:(.*)$/.test(D)&&(D=D.replace(/:(.*)$/,''));console.debug('[DOMAIN] isSLD: '+M,Aa,' -> ',D);/^true$/i.test(O);return{value:D,isSLD:M,isRegisteredTldOrSld:A}}};V?va.onReady=S:(va.updatePSL=G,va.getFQDN=w);return V&&ma&&!window.fetch?(ma=document.createElement('script'),ma.type='text/javascript',
ma.src='https://cdn.jsdelivr.net/npm/promise-polyfill@8.1.3/dist/polyfill.min.js',S=document.createElement('script'),S.type='text/javascript',S.src='https://cdn.jsdelivr.net/npm/whatwg-fetch@3.4.0/dist/fetch.umd.min.js',document.head.appendChild(ma),document.head.appendChild(S),setTimeout(()=>Q(va,B,P),500)):Q(va,B,P)}'undefined'!==typeof module&&module.exports?module.exports=Domain:'function'===typeof define&&define.amd&&define('lib/domain',[],function(){return Domain});
