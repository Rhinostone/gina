...
(function(B,P){function V(Ia,Ja){return Ja||''}function ma(Ia){return'[object Function]'===Fa.call(Ia)}function U(Ia){return'[object Array]'===Fa.call(Ia)}function M(Ia,Ja){if(Ia){var Ua;for(Ua=0;Ua<Ia.length&&(!Ia[Ua]||!Ja(Ia[Ua],Ua,Ia));Ua+=1);}}function ba(Ia,Ja){if(Ia){var Ua;for(Ua=Ia.length-1;-1<Ua&&(!Ia[Ua]||!Ja(Ia[Ua],Ua,Ia));--Ua);}}function Q(Ia,Ja){return W.call(Ia,Ja)}function S(Ia,Ja){return Q(Ia,Ja)&&Ia[Ja]}function r(Ia,Ja){for(var Ua in Ia)if(Q(Ia,Ua)&&Ja(Ia[Ua],Ua))break}function H(Ia,
Ja,Ua,pb){Ja&&r(Ja,function(ab,gb){if(Ua||!Q(Ia,gb))!pb||'object'!==typeof ab||!ab||U(ab)||ma(ab)||ab instanceof RegExp?Ia[gb]=ab:(Ia[gb]||(Ia[gb]={}),H(Ia[gb],ab,Ua,pb))});return Ia}function w(Ia,Ja){return function(){return Ja.apply(Ia,arguments)}}function oa(Ia){throw Ia;}function Aa(Ia){if(!Ia)return Ia;var Ja=B;M(Ia.split('.'),function(Ua){Ja=Ja[Ua]});return Ja}function N(Ia,Ja,Ua,pb){Ja=Error(Ja+'\nhttps://requirejs.org/docs/errors.html#'+Ia);Ja.requireType=Ia;Ja.requireModules=pb;Ua&&(Ja.originalError=
Ua);return Ja}function O(){if(y&&'interactive'===y.readyState)return y;ba(document.getElementsByTagName('script'),function(Ia){if('interactive'===Ia.readyState)return y=Ia});return y}var A,D,l,y,z,F,u,v=/\/\*[\s\S]*?\*\/|([^:"'=]|^)\/\/.*$/mg,G=/[^.]\s*require\s*\(\s*["']([^'"\s]+)["']\s*\)/g,J=/\.js$/,T=/^\.\//;var ra=Object.prototype;var Fa=ra.toString,W=ra.hasOwnProperty,ka=!('undefined'===typeof window||'undefined'===typeof navigator||!window.document),ha=!ka&&'undefined'!==typeof importScripts,
...
(ab=gb.context);(pb=S(ua,ab))||(pb=ua[ab]=Ea.s.newContext(ab));gb&&pb.configure(gb);return pb.require(Ia,Ja,Ua)};Ea.config=function(Ia){return Ea(Ia)};Ea.nextTick='undefined'!==typeof P?function(Ia){P(Ia,4)}:function(Ia){Ia()};require||=Ea;Ea.version='2.3.6';Ea.jsExtRegExp=/^\/|:|\?|\.js$/;Ea.isBrowser=ka;ra=Ea.s={contexts:ua,newContext:function(Ia){function Ja(E,na,sa){var ia;na=na&&na.split('/');var Z=m.map,Ga=Z&&Z['*'];if(E){E=E.split('/');var Pa=E.length-1;m.nodeIdCompat&&J.test(E[Pa])&&(E[Pa]=
E[Pa].replace(J,''));'.'===E[0].charAt(0)&&na&&(Pa=na.slice(0,na.length-1),E=Pa.concat(E));Pa=E;for(ia=0;ia<Pa.length;ia++){var $a=Pa[ia];'.'===$a?(Pa.splice(ia,1),--ia):'..'===$a&&0!==ia&&(1!==ia||'..'!==Pa[2])&&'..'!==Pa[ia-1]&&0<ia&&(Pa.splice(ia-1,2),ia-=2)}E=E.join('/')}if(sa&&Z&&(na||Ga)){Pa=E.split('/');ia=Pa.length;a:for(;0<ia;--ia){var ib=Pa.slice(0,ia).join('/');if(na)for($a=na.length;0<$a;--$a)if(sa=S(Z,na.slice(0,$a).join('/')))if(sa=S(sa,ib)){var Cb=sa;var zb=ia;break a}if(!qb&&Ga&&S(Ga,
ib)){var qb=S(Ga,ib);var Mb=ia}}!Cb&&qb&&(Cb=qb,zb=Mb);Cb&&(Pa.splice(0,zb,Cb),E=Pa.join('/'))}return(Cb=S(m.pkgs,E))?Cb:E}function Ua(E){ka&&M(document.getElementsByTagName('script'),function(na){if(na.getAttribute('data-requiremodule')===E&&na.getAttribute('data-requirecontext')===da.contextName)return na.parentNode.removeChild(na),!0})}function pb(E){var na=S(m.paths,E);if(na&&U(na)&&1<na.length)return na.shift(),da.require.undef(E),da.makeRequire(null,{skipMap:!0})([E]),!0}function ab(E){var na=
E?E.indexOf('!'):-1;if(-1<na){var sa=E.substring(0,na);E=E.substring(na+1,E.length)}return[sa,E]}function gb(E,na,sa,ia){var Z=null,Ga=na?na.name:null,Pa=E,$a=!0,ib='';E||($a=!1,E='_@r'+(K+=1));E=ab(E);Z=E[0];E=E[1];if(Z){Z=Ja(Z,Ga,ia);var Cb=S(q,Z)}if(E)if(Z)ib=sa?E:Cb&&Cb.normalize?Cb.normalize(E,function(qb){return Ja(qb,Ga,ia)}):-1===E.indexOf('!')?Ja(E,Ga,ia):E;else{ib=Ja(E,Ga,ia);E=ab(ib);Z=E[0];ib=E[1];sa=!0;var zb=da.nameToUrl(ib)}sa=!Z||Cb||sa?'':'_unnormalized'+(fa+=1);return{prefix:Z,name:ib,
parentMap:na,unnormalized:!!sa,url:zb,originalName:Pa,isDefine:$a,id:(Z?Z+'!'+ib:ib)+sa}}function Ub(E){var na=E.id,sa=S(g,na);sa||=g[na]=new da.Module(E);return sa}function Zb(E,na,sa){var ia=E.id,Z=S(g,ia);if(!Q(q,ia)||Z&&!Z.defineEmitComplete)if(Z=Ub(E),Z.error&&'error'===na)sa(Z.error);else Z.on(na,sa);else'defined'===na&&sa(q[ia])}function jb(E,na){var sa=E.requireModules,ia=!1;if(na)na(E);else if(M(sa,function(Z){if(Z=S(g,Z))Z.error=E,Z.events.error&&(ia=!0,Z.emit('error',E))}),!ia)Ea.onError(E)}
function Db(){Qa.length&&(M(Qa,function(E){var na=E[0];'string'===typeof na&&(da.defQueueMap[na]=!0);x.push(E)}),Qa=[])}function rb(E){delete g[E];delete h[E]}function xb(E,na,sa){var ia=E.map.id;E.error?E.emit('error',E.error):(na[ia]=!0,M(E.depMaps,function(Z,Ga){Z=Z.id;var Pa=S(g,Z);!Pa||E.depMatched[Ga]||sa[Z]||(S(na,Z)?(E.defineDep(Ga,q[Z]),E.check()):xb(Pa,na,sa))}),sa[ia]=!0)}function Ka(){var E,na,sa=(E=1E3*m.waitSeconds)&&da.startTime+E<(new Date).getTime(),ia=[],Z=[],Ga=!1,Pa=!0;if(!ya){ya=
!0;r(h,function($a){var ib=$a.map,Cb=ib.id;if($a.enabled&&(ib.isDefine||Z.push($a),!$a.error))if(!$a.inited&&sa)pb(Cb)?Ga=na=!0:(ia.push(Cb),Ua(Cb));else if(!$a.inited&&$a.fetched&&ib.isDefine&&(Ga=!0,!ib.prefix))return Pa=!1});if(sa&&ia.length)return E=N('timeout','Load timeout for modules: '+ia,null,ia),E.contextName=da.contextName,jb(E);Pa&&M(Z,function($a){xb($a,{},{})});sa&&!na||!Ga||!ka&&!ha||za||(za=P(function(){za=0;Ka()},50));ya=!1}}function db(E){Q(q,E[0])||Ub(gb(E[0],null,!0)).init(E[1],
...
S(b,E.id)||{};this.map=E;this.shim=S(m.shim,E.id);this.depExports=[];this.depMaps=[];this.depMatched=[];this.pluginMaps={};this.depCount=0};ea.prototype={init:function(E,na,sa,ia){ia=ia||{};if(!this.inited){this.factory=na;if(sa)this.on('error',sa);else this.events.error&&(sa=w(this,function(Z){this.emit('error',Z)}));this.depMaps=E&&E.slice(0);this.errback=sa;this.inited=!0;this.ignore=ia.ignore;ia.enabled||this.enabled?this.enable():this.check()}},defineDep:function(E,na){this.depMatched[E]||(this.depMatched[E]=
...
qb&&(zb=qb);cb&&(La=!1);Ub(Ya);Q(m.config,na)&&(m.config[Mb]=m.config[na]);try{Ea.exec(zb)}catch(ca){return jb(N('fromtexteval','fromText eval for '+na+' failed: '+ca,ca,[na]))}cb&&(La=!0);this.depMaps.push(Ya);da.completeLoad(Mb);$a([Mb],Cb)});ia.load(E.name,$a,Cb,m)}}));da.enable(sa,this);this.pluginMaps[sa.id]=sa},enable:function(){h[this.map.id]=this;this.enabling=this.enabled=!0;M(this.depMaps,w(this,function(E,na){var sa;if('string'===typeof E){E=gb(E,this.map.isDefine?this.map:this.map.parentMap,
!1,!this.skipMap);this.depMaps[na]=E;if(sa=S(Ba,E.id)){this.depExports[na]=sa(this);return}this.depCount+=1;Zb(E,'defined',w(this,function(Z){this.undefed||(this.defineDep(na,Z),this.check())}));this.errback?Zb(E,'error',w(this,this.errback)):this.events.error&&Zb(E,'error',w(this,function(Z){this.emit('error',Z)}))}sa=E.id;var ia=g[sa];Q(Ba,sa)||!ia||ia.enabled||da.enable(E,this)}));r(this.pluginMaps,w(this,function(E){var na=S(g,E.id);na&&!na.enabled&&da.enable(E,this)}));this.enabling=!1;this.check()},
on:function(E,na){var sa=this.events[E];sa||=this.events[E]=[];sa.push(na)},emit:function(E,na){M(this.events[E],function(sa){sa(na)});'error'===E&&delete this.events[E]}};var da={config:m,contextName:Ia,registry:g,defined:q,urlFetched:p,defQueue:x,defQueueMap:{},Module:ea,makeModuleMap:gb,nextTick:Ea.nextTick,onError:jb,configure:function(E){E.baseUrl&&'/'!==E.baseUrl.charAt(E.baseUrl.length-1)&&(E.baseUrl+='/');if('string'===typeof E.urlArgs){var na=E.urlArgs;E.urlArgs=function(Z,Ga){return(-1===
Ga.indexOf('?')?'?':'&')+na}}var sa=m.shim,ia={paths:!0,bundles:!0,config:!0,map:!0};r(E,function(Z,Ga){ia[Ga]?(m[Ga]||(m[Ga]={}),H(m[Ga],Z,!0,!0)):m[Ga]=Z});E.bundles&&r(E.bundles,function(Z,Ga){M(Z,function(Pa){Pa!==Ga&&(R[Pa]=Ga)})});E.shim&&(r(E.shim,function(Z,Ga){U(Z)&&(Z={deps:Z});!Z.exports&&!Z.init||Z.exportsFn||(Z.exportsFn=da.makeShimExports(Z));sa[Ga]=Z}),m.shim=sa);E.packages&&M(E.packages,function(Z){Z='string'===typeof Z?{name:Z}:Z;var Ga=Z.name;Z.location&&(m.paths[Ga]=Z.location);
m.pkgs[Ga]=Z.name+'/'+(Z.main||'main').replace(T,'').replace(J,'')});r(g,function(Z,Ga){Z.inited||Z.map.unnormalized||(Z.map=gb(Ga,null,!0))});(E.deps||E.callback)&&da.require(E.deps||[],E.callback)},makeShimExports:function(E){return function(){var na;E.init&&(na=E.init.apply(B,arguments));return na||E.exports&&Aa(E.exports)}},makeRequire:function(E,na){function sa(ia,Z,Ga){var Pa;na.enableBuildCallback&&Z&&ma(Z)&&(Z.__requireJsBuild=!0);if('string'===typeof ia){if(ma(Z))return jb(N('requireargs',
'Invalid require call'),Ga);if(E&&Q(Ba,ia))return Ba[ia](g[E.id]);if(Ea.get)return Ea.get(da,ia,E,sa);var $a=gb(ia,E,!1,!0);$a=$a.id;return Q(q,$a)?q[$a]:jb(N('notloaded','Module name "'+$a+'" has not been loaded yet for context: '+Ia+(E?'':'. Use require([])')))}Vb();da.nextTick(function(){Vb();Pa=Ub(gb(null,E));Pa.skipMap=na.skipMap;Pa.init(ia,Z,Ga,{enabled:!0});Ka()});return sa}na=na||{};H(sa,{isBrowser:ka,toUrl:function(ia){var Z=ia.lastIndexOf('.'),Ga=ia.split('/')[0];if(-1!==Z&&('.'!==Ga&&'..'!==
...
E.id)&&Ub(E).enable()},completeLoad:function(E){var na=S(m.shim,E)||{},sa=na.exports;for(Db();x.length;){var ia=x.shift();if(null===ia[0]){ia[0]=E;if(Z)break;var Z=!0}else ia[0]===E&&(Z=!0);db(ia)}da.defQueueMap={};ia=S(g,E);if(!Z&&!Q(q,E)&&ia&&!ia.inited)if(!m.enforceDefine||sa&&Aa(sa))db([E,na.deps||[],na.exportsFn]);else return pb(E)?void 0:jb(N('nodefine','No define call for '+E,null,[E]));Ka()},nameToUrl:function(E,na,sa){var ia,Z;(ia=S(m.pkgs,E))&&(E=ia);if(ia=S(R,E))return da.nameToUrl(ia,
na,sa);if(Ea.jsExtRegExp.test(E))ia=E+(na||'');else{ia=m.paths;var Ga=E.split('/');for(Z=Ga.length;0<Z;--Z){var Pa=Ga.slice(0,Z).join('/');if(Pa=S(ia,Pa)){U(Pa)&&(Pa=Pa[0]);Ga.splice(0,Z,Pa);break}}ia=Ga.join('/');ia+=na||(/^data:|^blob:|\?/.test(ia)||sa?'':'.js');ia=('/'===ia.charAt(0)||ia.match(/^[\w\+\.\-]+:/)?'':m.baseUrl)+ia}return m.urlArgs&&!/^blob:/.test(ia)?ia+m.urlArgs(E,ia):ia},load:function(E,na){Ea.load(da,E,na)},execCb:function(E,na,sa,ia){return na.apply(ia,sa)},onScriptLoad:function(E){if('load'===
E.type||xa.test((E.currentTarget||E.srcElement).readyState))y=null,E=Lb(E),da.completeLoad(E.id)},onScriptError:function(E){var na=Lb(E);if(!pb(na.id)){var sa=[];r(g,function(ia,Z){0!==Z.indexOf('_@r')&&M(ia.depMaps,function(Ga){if(Ga.id===na.id)return sa.push(Z),!0})});return jb(N('scripterror','Script error for "'+na.id+(sa.length?'", needed by: '+sa.join(', '):'"'),E,[na.id]))}}};da.require=da.makeRequire();return da}};Ea({});M(['toUrl','undef','defined','specified'],function(Ia){Ea[Ia]=function(){var Ja=
ua._;return Ja.require[Ia].apply(Ja,arguments)}});if(ka){var Na=ra.head=document.getElementsByTagName('head')[0];if(A=document.getElementsByTagName('base')[0])Na=ra.head=A.parentNode}Ea.onError=oa;Ea.createNode=function(Ia,Ja,Ua){Ja=Ia.xhtml?document.createElementNS('http://www.w3.org/1999/xhtml','html:script'):document.createElement('script');Ja.type=Ia.scriptType||'text/javascript';Ja.charset='utf-8';Ja.async=!0;return Ja};Ea.load=function(Ia,Ja,Ua){var pb=Ia&&Ia.config||{};if(ka){var ab=Ea.createNode(pb,
...
'string'!==typeof Ia&&(Ua=Ja,Ja=Ia,Ia=null);U(Ja)||(Ua=Ja,Ja=null);!Ja&&ma(Ua)&&(Ja=[],Ua.length&&(Ua.toString().replace(v,V).replace(G,function(gb,Ub){Ja.push(Ub)}),Ja=(1===Ua.length?['require']:['require','exports','module']).concat(Ja)));if(La&&(pb=z||O())){Ia||=pb.getAttribute('data-requiremodule');var ab=ua[pb.getAttribute('data-requirecontext')]}ab?(ab.defQueue.push([Ia,Ja,Ua]),ab.defQueueMap[Ia]=!0):Qa.push([Ia,Ja,Ua])};define.amd={jQuery:!0};Ea.exec=function(Ia){return eval(Ia)};Ea(Da)}})(this,
'undefined'===typeof setTimeout?void 0:setTimeout);define('requireLib',function(){});
!function(B,P){'object'==typeof exports&&'undefined'!=typeof module?P(exports):'function'==typeof define&&define.amd?define('vendor/uuid',['exports'],P):P((B=B||self).uuid={})}(this,function(B){function P(){if(!r)throw Error('crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported');return r(H)}function V(l,y){y=y||0;var z=Aa;return[z[l[y++]],z[l[y++]],z[l[y++]],z[l[y++]],'-',z[l[y++]],z[l[y++]],'-',z[l[y++]],z[l[y++]],'-',z[l[y++]],z[l[y++]],'-',z[l[y++]],
z[l[y++]],z[l[y++]],z[l[y++]],z[l[y++]],z[l[y++]]].join('')}function ma(l,y,z){var F=function(u,v,G,J){J=G&&J||0;if('string'==typeof u&&(u=function(T){T=unescape(encodeURIComponent(T));for(var ra=Array(T.length),Fa=0;Fa<T.length;Fa++)ra[Fa]=T.charCodeAt(Fa);return ra}(u)),'string'==typeof v&&(v=function(T){var ra=[];return T.replace(/[a-fA-F0-9]{2}/g,function(Fa){ra.push(parseInt(Fa,16))}),ra}(v)),!Array.isArray(u))throw TypeError('value must be an array of bytes');if(!Array.isArray(v)||16!==v.length)throw TypeError('namespace must be uuid string or an Array of 16 byte values');
u=z(v.concat(u));if(u[6]=15&u[6]|y,u[8]=63&u[8]|128,G)for(v=0;16>v;++v)G[J+v]=u[v];return G||V(u)};try{F.name=l}catch(u){}return F.DNS='6ba7b810-9dad-11d1-80b4-00c04fd430c8',F.URL='6ba7b811-9dad-11d1-80b4-00c04fd430c8',F}function U(l,y){var z=(65535&l)+(65535&y);return(l>>16)+(y>>16)+(z>>16)<<16|65535&z}function M(l,y,z,F,u,v){return U((G=U(U(y,l),U(F,v)))<<(J=u)|G>>>32-J,z);var G,J}function ba(l,y,z,F,u,v,G){return M(y&z|~y&F,l,y,u,v,G)}function Q(l,y,z,F,u,v,G){return M(y&F|z&~F,l,y,u,v,G)}function S(l,
y,z,F,u,v,G){return M(z^(y|~F),l,y,u,v,G)}for(var r='undefined'!=typeof crypto&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto)||'undefined'!=typeof msCrypto&&'function'==typeof msCrypto.getRandomValues&&msCrypto.getRandomValues.bind(msCrypto),H=new Uint8Array(16),w,oa,Aa=[],N=0;256>N;++N)Aa[N]=(N+256).toString(16).substr(1);var O=0,A=0;N=ma('v3',48,function(l){if('string'==typeof l){var y=unescape(encodeURIComponent(l));l=Array(y.length);for(var z=0;z<y.length;z++)l[z]=y.charCodeAt(z)}return function(F){var u,
v=[],G=32*F.length;for(u=0;u<G;u+=8){var J=F[u>>5]>>>u%32&255;J=parseInt('0123456789abcdef'.charAt(J>>>4&15)+'0123456789abcdef'.charAt(15&J),16);v.push(J)}return v}(function(F,u){F[u>>5]|=128<<u%32;F[14+(u+64>>>9<<4)]=u;var v=1732584193,G=-271733879,J=-1732584194,T=271733878;for(u=0;u<F.length;u+=16){var ra=v;var Fa=G;var W=J;var ka=T;v=ba(v,G,J,T,F[u],7,-680876936);T=ba(T,v,G,J,F[u+1],12,-389564586);J=ba(J,T,v,G,F[u+2],17,606105819);G=ba(G,J,T,v,F[u+3],22,-1044525330);v=ba(v,G,J,T,F[u+4],7,-176418897);
T=ba(T,v,G,J,F[u+5],12,1200080426);J=ba(J,T,v,G,F[u+6],17,-1473231341);G=ba(G,J,T,v,F[u+7],22,-45705983);v=ba(v,G,J,T,F[u+8],7,1770035416);T=ba(T,v,G,J,F[u+9],12,-1958414417);J=ba(J,T,v,G,F[u+10],17,-42063);G=ba(G,J,T,v,F[u+11],22,-1990404162);v=ba(v,G,J,T,F[u+12],7,1804603682);T=ba(T,v,G,J,F[u+13],12,-40341101);J=ba(J,T,v,G,F[u+14],17,-1502002290);G=ba(G,J,T,v,F[u+15],22,1236535329);v=Q(v,G,J,T,F[u+1],5,-165796510);T=Q(T,v,G,J,F[u+6],9,-1069501632);J=Q(J,T,v,G,F[u+11],14,643717713);G=Q(G,J,T,v,F[u],
20,-373897302);v=Q(v,G,J,T,F[u+5],5,-701558691);T=Q(T,v,G,J,F[u+10],9,38016083);J=Q(J,T,v,G,F[u+15],14,-660478335);G=Q(G,J,T,v,F[u+4],20,-405537848);v=Q(v,G,J,T,F[u+9],5,568446438);T=Q(T,v,G,J,F[u+14],9,-1019803690);J=Q(J,T,v,G,F[u+3],14,-187363961);G=Q(G,J,T,v,F[u+8],20,1163531501);v=Q(v,G,J,T,F[u+13],5,-1444681467);T=Q(T,v,G,J,F[u+2],9,-51403784);J=Q(J,T,v,G,F[u+7],14,1735328473);G=Q(G,J,T,v,F[u+12],20,-1926607734);v=M(G^J^T,v,G,F[u+5],4,-378558);T=M(v^G^J,T,v,F[u+8],11,-2022574463);J=M(T^v^G,J,
T,F[u+11],16,1839030562);G=M(J^T^v,G,J,F[u+14],23,-35309556);v=M(G^J^T,v,G,F[u+1],4,-1530992060);T=M(v^G^J,T,v,F[u+4],11,1272893353);J=M(T^v^G,J,T,F[u+7],16,-155497632);G=M(J^T^v,G,J,F[u+10],23,-1094730640);v=M(G^J^T,v,G,F[u+13],4,681279174);T=M(v^G^J,T,v,F[u],11,-358537222);J=M(T^v^G,J,T,F[u+3],16,-722521979);G=M(J^T^v,G,J,F[u+6],23,76029189);v=M(G^J^T,v,G,F[u+9],4,-640364487);T=M(v^G^J,T,v,F[u+12],11,-421815835);J=M(T^v^G,J,T,F[u+15],16,530742520);G=M(J^T^v,G,J,F[u+2],23,-995338651);v=S(v,G,J,T,
F[u],6,-198630844);T=S(T,v,G,J,F[u+7],10,1126891415);J=S(J,T,v,G,F[u+14],15,-1416354905);G=S(G,J,T,v,F[u+5],21,-57434055);v=S(v,G,J,T,F[u+12],6,1700485571);T=S(T,v,G,J,F[u+3],10,-1894986606);J=S(J,T,v,G,F[u+10],15,-1051523);G=S(G,J,T,v,F[u+1],21,-2054922799);v=S(v,G,J,T,F[u+8],6,1873313359);T=S(T,v,G,J,F[u+15],10,-30611744);J=S(J,T,v,G,F[u+6],15,-1560198380);G=S(G,J,T,v,F[u+13],21,1309151649);v=S(v,G,J,T,F[u+4],6,-145523070);T=S(T,v,G,J,F[u+11],10,-1120210379);J=S(J,T,v,G,F[u+2],15,718787259);G=S(G,
J,T,v,F[u+9],21,-343485551);v=U(v,ra);G=U(G,Fa);J=U(J,W);T=U(T,ka)}return[v,G,J,T]}(function(F){var u,v=[];v[(F.length>>2)-1]=void 0;for(u=0;u<v.length;u+=1)v[u]=0;var G=8*F.length;for(u=0;u<G;u+=8)v[u>>5]|=(255&F[u/8])<<u%32;return v}(l),8*l.length))});var D=ma('v5',80,function(l){var y=[1518500249,1859775393,2400959708,3395469782],z=[1732584193,4023233417,2562383102,271733878,3285377520];if('string'==typeof l){var F=unescape(encodeURIComponent(l));l=Array(F.length);for(var u=0;u<F.length;u++)l[u]=
F.charCodeAt(u)}l.push(128);F=Math.ceil((l.length/4+2)/16);var v=Array(F);for(u=0;u<F;u++){v[u]=Array(16);for(var G=0;16>G;G++)v[u][G]=l[64*u+4*G]<<24|l[64*u+4*G+1]<<16|l[64*u+4*G+2]<<8|l[64*u+4*G+3]}v[F-1][14]=8*(l.length-1)/Math.pow(2,32);v[F-1][14]=Math.floor(v[F-1][14]);v[F-1][15]=8*(l.length-1)&4294967295;for(u=0;u<F;u++){l=Array(80);for(G=0;16>G;G++)l[G]=v[u][G];for(G=16;80>G;G++){var J=l[G-3]^l[G-8]^l[G-14]^l[G-16];l[G]=J<<1|J>>>31}J=z[0];var T=z[1],ra=z[2],Fa=z[3],W=z[4];for(G=0;80>G;G++){var ka=
Math.floor(G/20),ha=J<<5|J>>>27;a:{switch(ka){case 0:var xa=T&ra^~T&Fa;break a;case 1:xa=T^ra^Fa;break a;case 2:xa=T&ra^T&Fa^ra&Fa;break a;case 3:xa=T^ra^Fa;break a}xa=void 0}ka=ha+xa+W+y[ka]+l[G]>>>0;W=Fa;Fa=ra;ra=(T<<30|T>>>2)>>>0;T=J;J=ka}z[0]=z[0]+J>>>0;z[1]=z[1]+T>>>0;z[2]=z[2]+ra>>>0;z[3]=z[3]+Fa>>>0;z[4]=z[4]+W>>>0}return[z[0]>>24&255,z[0]>>16&255,z[0]>>8&255,255&z[0],z[1]>>24&255,z[1]>>16&255,z[1]>>8&255,255&z[1],z[2]>>24&255,z[2]>>16&255,z[2]>>8&255,255&z[2],z[3]>>24&255,z[3]>>16&255,z[3]>>
8&255,255&z[3],z[4]>>24&255,z[4]>>16&255,z[4]>>8&255,255&z[4]]});B.v1=function(l,y,z){z=y&&z||0;var F=y||[],u=(l=l||{}).node||w,v=void 0!==l.clockseq?l.clockseq:oa;if(null==u||null==v){var G=l.random||(l.rng||P)();null==u&&(u=w=[1|G[0],G[1],G[2],G[3],G[4],G[5]]);null==v&&(v=oa=16383&(G[6]<<8|G[7]))}G=void 0!==l.msecs?l.msecs:(new Date).getTime();var J=void 0!==l.nsecs?l.nsecs:A+1,T=G-O+(J-A)/1E4;if(0>T&&void 0===l.clockseq&&(v=v+1&16383),(0>T||G>O)&&void 0===l.nsecs&&(J=0),1E4<=J)throw Error("uuid.v1(): Can't create more than 10M uuids/sec");
O=G;A=J;oa=v;l=(1E4*(268435455&(G+=122192928E5))+J)%4294967296;F[z++]=l>>>24&255;F[z++]=l>>>16&255;F[z++]=l>>>8&255;F[z++]=255&l;l=G/4294967296*1E4&268435455;F[z++]=l>>>8&255;F[z++]=255&l;F[z++]=l>>>24&15|16;F[z++]=l>>>16&255;F[z++]=v>>>8|128;F[z++]=255&v;for(v=0;6>v;++v)F[z+v]=u[v];return y||V(F)};B.v3=N;B.v4=function(l,y,z){z=y&&z||0;'string'==typeof l&&(y='binary'===l?Array(16):null,l=null);var F=(l=l||{}).random||(l.rng||P)();if(F[6]=15&F[6]|64,F[8]=63&F[8]|128,y)for(l=0;16>l;++l)y[z+l]=F[l];
...
typeof arguments[r]&&null!=(w=arguments[r])){if('object'!=typeof w){Q=w;break}if(Array.isArray(w)&&Array.isArray(Q))Q=ma(w,Q,S);else for(var Aa in w){Q||={name:null};var N=Q[Aa];var O=w[Aa];if(Q!==O)if(O&&(U(O)||(oa=Array.isArray(O)))){var A=!1;if(oa){oa=!1;if(N&&Array.isArray(N))var D=N||[];else if(U(N)){D=N||{};Q[Aa]=D;continue}else D=[];B=D;D=ma(O,D,S);Q[Aa]=D}else{D=N&&U(N)?N:null;if(!D){A=!0;D={};for(var l in O)D[l]=O[l]}if(S){for(l in O)'undefined'!=typeof O[l]?Array.isArray(O[l])&&Array.isArray(D[l])?
D[l]=ma(O[l],D[l],S):D[l]=O[l]:Array.isArray(O[l])&&Array.isArray(D[l])&&(D[l]=ma(O[l],D[l],S));Q[Aa]=D}else{for(l in O)'undefined'==typeof D[l]?Array.isArray(O[l])&&Array.isArray(D[l])?D[l]=ma(O[l],D[l],S):D[l]=O[l]:Array.isArray(O[l])&&Array.isArray(D[l])&&(D[l]=ma(O[l],D[l],S));'boolean'==typeof N||A?A&&(Q[Aa]=D):Q[Aa]=V(D,O,S)}}}else void 0!==O&&(Q[Aa]='undefined'==typeof N||null==N||N===O||S?O:N)}}B=[];P=!1;return Q},ma=function(M,ba,Q){B=[];var S=[],r=V.getKeyComparison();if(/^true$/i.test(Q)){if('object'==
typeof M[0]&&null!=M[0]&&'undefined'!=typeof M[0][r]&&'object'==typeof ba[0]&&'undefined'!=typeof ba[0][r]){B=Array.isArray(ba)?Array.from(ba):JSON.clone(ba);var H=0;for(Q=B.length;H<Q;++H)S.push(B[H][r]);Q=JSON.clone(M);var w=0;H=0;M=Q.length;for(var oa=N||0,Aa=ba.length;oa<Aa;++oa)a:for(H=H||0;H<M;++H)if(Q[H][r]===ba[oa][r]){-1<S.indexOf(Q[H][r])?(B[w]=Q[H],++w):-1==S.indexOf(Q[H][r])&&(S.push(Q[H][r]),B[w]=Q[H],++w);break a}else-1==S.indexOf(Q[H][r])&&(S.push(Q[H][r]),B.push(Q[H]));return B}return Array.isArray(M)&&
0==M.length||'undefined'==typeof M?/^true$/i.test(Q)?M:ba:M}if(0==M.length&&0<ba.length)return B=ba;if(0==ba.length&&0<M.length)for(H=0;H<M.length;++H)ba.push(M[H]);if(0==B.length&&0<ba.length)for(H=0;H<ba.length;++H)'object'!=typeof ba[H]&&-1==B.indexOf(ba[H])&&B.push(ba[H]);if(0<ba.length){if('undefined'!=typeof M[0]&&'object'==typeof M[0]&&null!=M[0]&&'undefined'!=typeof M[0][r]&&'object'==typeof ba[0]&&'undefined'!=typeof ba[0][r]){B=Array.isArray(ba)?Array.from(ba):JSON.clone(ba);Q=JSON.clone(M);
var N=null;H=0;for(M=B.length;H<M;++H)S.push(B[H][r]);for(H=0;H<M;++H)a:for(oa=N||0,Aa=Q.length;oa<Aa;++oa)if(null!=Q[oa]&&'undefined'!=typeof Q[oa][r]&&Q[oa][r]!==B[H][r]){if(-1==S.indexOf(Q[oa][r])){B.push(Q[oa]);S.push(Q[oa][r]);N=oa+1;M<Aa&&++M;break a}}else if(null!=Q[oa]&&'undefined'!=typeof Q[oa][r]&&Q[oa][r]===B[H][r])N=oa+1;else break a;return B}for(H=0;H<M.length;++H)if(S=null,'undefined'==typeof M||'object'!=typeof M[H]||Array.isArray(M[H])||null==M[H]||(S=Object.getOwnPropertyNames(M[H])),
'undefined'!=typeof S&&null!=S&&(S=S[0]||null),-1<ba.indexOf(M[H])&&Q)ba.splice(ba.indexOf(M[H]),1,M[H]);else if('undefined'==typeof B[H]&&'object'==typeof M[H])for(w in B=ba,'undefined'==typeof B[H]&&(B[H]={}),M[H])B[H].hasOwnProperty(w)||(B[H][w]=M[H][w]);else!Q&&-1<B.indexOf(M[H])&&/number/i.test(typeof M[H])&&M[H]!==B[H]?B.push(M[H]):'undefined'==typeof ba[H]||/null/i.test(ba[H])||'undefined'==typeof ba[H][r]||'undefined'==typeof M[H]||'undefined'==typeof M[H][r]||ba[H][r]!=M[H][r]?-1==B.indexOf(M[H])&&
'object'!=typeof M[H]?B.push(M[H]):'undefined'==typeof ba[H]||/null/i.test(ba[H])||'undefined'==typeof ba[H][S]||'undefined'==typeof M[H]||'undefined'==typeof M[H][S]||ba[H][S]!=M[H][S]||(B[H]=Q?M[H]:ba[H]):B[H]=Q?M[H]:ba[H]}if(0<B.length&&0<ba.length||0==B.length&&0==ba.length)return B};ma.prototype.setKeyComparison=function(M){this.keyComparison=M};var U=function(M){if(!M||'[object Object]'!=={}.toString.call(M)||M.nodeType||M.setInterval)return!1;var ba={}.hasOwnProperty,Q=ba.call(M,'constructor');
ba='undefined'!=typeof M.constructor?ba.call(M.constructor.prototype,'isPrototypeOf'):!1;return!M.constructor||Q||ba?!0:!1};V.setKeyComparison=function(M){ma.keyComparison=M;return V};V.getKeyComparison=function(){var M=ma.keyComparison||'id';ma.keyComparison='id';return M};return V}'undefined'!==typeof module&&module.exports?('undefined'==typeof JSON.clone&&require('../../../helpers'),module.exports=Merge()):'function'===typeof define&&define.amd&&define('lib/merge',[],function(){return Merge()});
...
P,V[M],ma);else if(Array.isArray(P))for(M=0,ba=P.length;M<ba;M++){let Q=/\.$/.test(V)?V+P[M].id:V;U(B,P[M],Q,ma)}else V=/\.$/.test(V)?V+P.id:V,U(B,P,V,ma)}
function triggerEvent(B,P,V,ma,U){if('undefined'!=typeof P&&null!=P){B=!1;if(jQuery){var M=jQuery.fn.jquery.split(/\./);M=2<M.length?M.splice(0,2).join('.'):M.join('.');M='1.7'>=M?jQuery(P).data('events'):jQuery._data(jQuery(P)[0],'events');if(M='undefined'!=typeof M&&'undefined'!=typeof M[V]?!0:!1)M=jQuery.Event(V),jQuery(P).trigger(M,ma),B=M.isDefaultPrevented()}window.CustomEvent||document.createEvent?(window.CustomEvent?M=new CustomEvent(V,{detail:ma,bubbles:!0,cancelable:!0,target:P}):(M=document.createEvent('HTMLEvents'),
M.detail=ma,M.target=P,M.initEvent(V,!0,!0),M.eventName=V),U&&(M=mergeEventProps(M,U)),'undefined'!=typeof M.defaultPrevented&&M.defaultPrevented&&(B=M.defaultPrevented),B||P.dispatchEvent(M)):document.createEventObject&&(M=document.createEventObject(),M.srcElement.id=P.id,M.detail=ma,M.target=P,U&&(M=mergeEventProps(M,U)),P.fireEvent('on'+V,M))}else B.customEvent.fire(V,ma)}
...
function handleXhr(B,P,V,ma){if(!B)throw Error('No `xhr` object initiated');var U=null,M=null,ba=null,Q=null,S=null,r=V.$link||null,H=V.$form||null,w=null;delete V.$link;delete V.$form;H||r?r?(r.target=document.getElementById(r.id),w=gina.link.target,S=gina.link.id):(w=H.target,S=w.getAttribute('id')):(w=P,S=w.getAttribute('id'));var oa=r&&P.getAttribute('data-gina-link-event-on-success')||r&&P.getAttribute('data-gina-link-event-on-error')?!0:!1,Aa=H&&w.getAttribute('data-gina-form-event-on-submit-success')||
H&&w.getAttribute('data-gina-form-event-on-submit-error')?!0:!1;Aa&&H&&listenToXhrEvents(H,'form');P=P.getAttribute('enctype')||V.headers['Content-Type'];for(var N in V.headers)'Content-Type'==N&&'undefined'!=typeof P&&null!=P&&''!=P||B.setRequestHeader(N,V.headers[N]);B.withCredentials='undefined'!=typeof V.withCredentials?V.withCredentials:!1;B.onerror=function(O,A){O={status:B.status||500,error:'Transaction error: might be due to the server CORS settings.\nPlease, check the console for more details.'};
...
(V=this.target,ma=instance.id);this.eventData&&!V.eventData&&(V.eventData=this.eventData);B=/\.(hform|hlink)$/.test(B)?/\.hform$/.test(B)?B.replace(/\.hform$/,'.'+ma+'.hform'):B.replace(/\.hlink$/,'.'+ma+'.hlink'):B+('.'+ma);gina.events[B]||(addListener(gina,V,B,function(U){cancelEvent(U);var M=null;U.detail?M=U.detail:'undefined'!=typeof this.eventData.submit?M=this.eventData.submit:'undefined'!=typeof this.eventData.error?M=this.eventData.error:'undefined'!=typeof this.eventData.success&&(M=this.eventData.success);
P&&P(U,M)}),this.initialized&&!this.isReady&&triggerEvent(gina,V,'init.'+ma));return this}}define('utils/events',function(){});
...
return{setCulture:function(r,H){/\-/.test(H)?(V=H,ma=H.split(/\-/)[0]):ma=H;return this},format:function(r,H,w){var oa=M[ma]||M.en,Aa=null;try{Aa=P(oa.masks,U)}catch(T){P=(B='undefined'!==typeof module&&module.exports?!1:!0)?require('lib/merge'):require('./../lib/merge'),Aa=P(oa.masks,U)}'undefined'!=typeof M[V]&&(oa=M[V],'undefined'!=typeof M[V].mask&&(Aa=P(oa.masks,U)));var N=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,
O=/[^-+\dA-Z]/g,A=function(T,ra){T=String(T);for(ra=ra||2;T.length<ra;)T='0'+T;return T};1!=arguments.length||'[object String]'!=Object.prototype.toString.call(r)||/\d/.test(r)||(H=r,r=void 0);r=r?new Date(r):new Date;if(isNaN(r))throw SyntaxError('invalid date');H=String(Aa[H]||H||Aa['default']);'UTC:'==H.slice(0,4)&&(H=H.slice(4),w=!0);var D=w?'getUTC':'get';Aa=r[D+'Date']();var l=r[D+'Day'](),y=r[D+'Month'](),z=r[D+'FullYear'](),F=r[D+'Hours'](),u=r[D+'Minutes'](),v=r[D+'Seconds']();D=r[D+'Milliseconds']();
var G=w?0:r.getTimezoneOffset(),J={d:Aa,dd:A(Aa),ddd:oa.dayNames[l],dddd:oa.dayNames[l+7],m:y+1,mm:A(y+1),mmm:oa.monthNames[y],mmmm:oa.monthNames[y+12],yy:String(z).slice(2),yyyy:z,h:F%12||12,hh:A(F%12||12),H:F,HH:A(F),M:u,MM:A(u),s:v,ss:A(v),l:A(D,3),L:A(D),t:12>F?'a':'p',tt:12>F?'am':'pm',T:12>F?'A':'P',TT:12>F?'AM':'PM',Z:w?'UTC':(String(r).match(N)||['']).pop().replace(O,''),o:(0<G?'-':'+')+A(100*Math.floor(Math.abs(G)/60)+Math.abs(G)%60,4),S:['th','st','nd','rd'][3<Aa%10?0:(10!=Aa%100-Aa%10)*
...
I.childNodes.length&&(I=n),n||k)){var Va=b.map(N(I,'script'),v);for(C=Va.length;qa>Y;Y++)n=I,Y!==Ca&&(n=b.clone(n,!0,!0),C&&b.merge(Va,N(n,'script'))),e.call(a[Y],n,Y);if(C)for(I=Va[Va.length-1].ownerDocument,b.map(Va,G),Y=0;C>Y;Y++)n=Va[Y],va.test(n.type||'')&&!b._data(n,'globalEval')&&b.contains(I,n)&&(n.src?b._evalUrl&&b._evalUrl(n.src):b.globalEval((n.text||n.textContent||n.innerHTML||'').replace(Xb,'')));I=n=null}return a}function ra(a,c,e){for(var k=c?b.filter(c,a):a,n=0;null!=(c=k[n]);n++)e||
...
function Collection(B,P){var V='undefined'!==typeof module&&module.exports?!1:!0,ma=V?require('vendor/uuid'):require('uuid'),U=V?require('lib/merge'):require('../../../lib/merge'),M={isCaseSensitive:{false:{re:'^%s$',modifiers:'i'},true:{re:'^%s$'}}},ba=!1,Q=!1,S=null;V={useLocalStorage:!1,locale:'en',searchOptionRules:M};P='object'==typeof P?U(P,V):V;var r=['not null'],H=function(A){try{return eval(A)}catch(D){throw Error('Could not evaluate condition `'+A+'`.\n'+D.stack);}};if('undefined'==typeof B||
''==B||null==B)B=[];if(!Array.isArray(B))throw Error('`new Collection([content] [, options] )`: `content` argument must be an Array !');B=B?JSON.clone(B):[];for(var w=[],oa=V=0,Aa=B.length;oa<Aa;++oa)B[oa]||(B[oa]={}),B[oa]._uuid=ma.v4(),w[V]=B[oa]._uuid,++V;var N=B;N.setSearchOption=function(){if(!arguments.length)throw Error('searchOption cannot be left blank');if(3<arguments.length||3>arguments.length&&1<arguments.length)throw Error('argument length mismatch');var A=0,D=arguments.length;if(1==
...
var y=JSON.clone(Array.isArray(this)?this:B);if(Array.isArray(arguments[0]))var z=arguments[0];else Q=!0,z=N.find.apply(this,arguments)||[],Q=!1;if(0<z.length){if(l&&A&&'undefined'==typeof z[0]&&'undefined'==typeof z[0][A])throw Error('[ Collection ][ notIn ] `key` not valid');l&&!A&&'undefined'!=typeof z[0]._uuid?A='_uuid':'undefined'!=typeof z[0].id&&(A='id');if(!A||'undefined'==typeof z[0][A])throw Error('No comparison key defined !');var F=0,u=z.length,v=0,G,J=D.count(),T;if(l&&'undefined'!=typeof y[v]&&
y[v].hasOwnProperty(A))for(;F<u&&y.length;++F)for(v=0,l=y.length;v<l;++v){if('undefined'!=typeof y[v]&&'undefined'!=typeof z[F]&&y[v][A]===z[F][A]){y.splice(v,1);break}}else if('undefined'==typeof y[v])y=JSON.clone(z);else for(;F<u&&y.length;++F)for(v=0,l=y.length;v<l;++v)if('undefined'!=typeof y[v]){for(G=T=0;G<J;++G){if('undefined'==typeof D[G])throw Error('filter `'+G+'` cannot be left undefined');var ra=D[G].count();var Fa=0;for(A in D[G])y[v].hasOwnProperty(A)&&y[v][A]===z[F][A]&&++Fa;Fa==ra&&
++T}if(T){y.splice(v,1);break}}}A=y;A.notIn=N.notIn;A.limit=N.limit;A.find=N.find;A.findOne=N.findOne;A.insert=N.insert;A.replace=N.replace;A.update=N.update;A.orderBy=N.orderBy;A.max=N.max;A.delete=N.delete;A.toRaw=N.toRaw;A.filter=N.filter;return A};N.insert=function(A){if('object'!==typeof A)throw Error('filter must be an object');var D=Array.isArray(this)?this:B;A._uuid=ma.v4();D.push(A);D.limit=N.limit;D.find=N.find;D.findOne=N.findOne;D.update=N.update;D.replace=N.replace;D.orderBy=N.orderBy;
...
try{var D=Object.keys(A)[0],l={};l[D]='desc';return N.find(A).orderBy(l).limit(1)[0][D]}catch(y){throw y;}};var O=function(A,D){if('object'!=typeof A)throw Error('`filter` parametter must be an object or an array');var l={},y=null,z=null,F=y=null;y=[];if(0==A.count())return null;l.asc=function(u,v){var G=v.map(function(J,T){var ra={};ra.index=T;ra[u]=J[u];return ra});G.sort(function(J,T){var ra=function(Fa,W){/^(true|false)$/i.test(Fa)&&(Fa=/true/i.test(Fa)?1:0);/^(true|false)$/i.test(W)&&(W=/true/i.test(W)?
1:0);return'string'==typeof Fa&&''!=Fa||'string'==typeof W?('number'==typeof Fa&&(Fa=''+Fa),'number'==typeof W&&(W=''+W),Fa.localeCompare(W,void 0,{sensitivity:'case',caseFirst:'upper'})):Fa>W?1:Fa<W?-1:0};return'object'==typeof J?ra(J[u],T[u]):ra(J,T)});return G.map(function(J,T,ra){return v[J.index]})};l.desc=function(u,v){return l.asc(u,v).reverse()};y=function(u,v){var G=[],J=[];if(Array.isArray(v))for(var T=0,ra=v.length;T<ra;++T)G[T]=Object.keys(v[T])[0],J[T]=v[T][G[T]];else for(ra in T=0,v)G[T]=
...
Fa.host,l.port=Fa.port[Fa.server.protocol][Fa.server.scheme],l.protocol=Fa.server.protocol,l.rejectUnauthorized=!1),v={ca:l.ca,hostname:l.hostname,port:l.port,path:l.path},'undefined'!=typeof l.protocol&&(v.protocol=l.protocol),'undefined'!=typeof l.rejectUnauthorized&&(v.rejectUnauthorized=l.rejectUnauthorized));G={method:ra.method,requirements:ra.requirements,namespace:ra.namespace||void 0,url:decodeURI(ra.url),rule:G+'@'+J,param:JSON.clone(ra.param),middleware:JSON.clone(ra.middleware),bundle:ra.bundle,
isXMLRequest:y.isXMLRequest,isWithCredentials:y.isWithCredentials};J=G.rule.replace('@'+J,'')||'_common';J={template:'undefined'!=typeof Fa.content.templates?Fa.content.templates[J]||Fa.content.templates._common:void 0,cacheless:Fa.cacheless};J=M(J,G);Fa=JSON.clone(Fa);J.conf=Fa;J.conf.content.routing[J.rule].param=G.param;J.template&&'undefined'==typeof J.template.ginaLoader&&(J.template.ginaLoader=J.conf.content.templates._common.ginaLoader);J.conf.content.routing[J.rule].param=G.param;delete J.middleware;
...
!1}(u=null!==u?!0:!1)?u&&'undefined'!=typeof v.isBoolean&&delete v.isBoolean:v.isBoolean=D(this.error||S.errorLabels.isBoolean,this);this.valid=u;0<v.count()&&(this.errors=v);return r[this.name]};r[l].isNumber=function(u,v){var G=this.value,J=!1,T=!0,ra=!0,Fa=r[this.name].errors||{};try{'string'==typeof G&&/,|\./g.test(G)?G=S.data[this.name]=this.value=parseFloat(G.replace(/,/g,'.').replace(/\s+/g,'')):'string'==typeof G&&''!=G&&(G=S.data[this.name]=this.value=parseInt(G.replace(/\s+/g,'')))}catch(ka){Fa.isNumber=
D(this.error||S.errorLabels.isNumber,this),this.valid=!1,0<Fa.count()&&(this.errors=Fa)}if(+G===+G&&(J=!0,!Fa.isRequired&&''!=G)){var W=G.toString().length;u&&'number'==typeof u&&W<u&&(T=!1,this.size=u);v&&'number'==typeof v&&W>v&&(ra=!1,this.size=v)}J&&T&&ra||(J||(Fa.isNumber=D(this.error||S.errorLabels.isNumber,this)),T&&ra||(T||(Fa.isNumberLength=D(this.error||S.errorLabels.isNumberMinLength,this)),ra||(Fa.isNumberLength=D(this.error||S.errorLabels.isNumberMaxLength,this)),u===v&&(Fa.isNumberLength=
D(this.error||S.errorLabels.isNumberLength,this))),J=!1);J&&'undefined'!=typeof Fa.isNumberLength&&delete Fa.isNumberLength;this.valid=J;this.value=S.data[this.name]=''!=G?Number(G):G;0<Fa.count()&&(this.errors=Fa);return r[this.name]};r[l].toInteger=function(){var u=this.value,v=r[this.name].errors||{};if(u)try{this.value=S.data[this.name]=Math.round(u)}catch(G){v.toInteger=D(this.error||S.errorLabels.toInteger,this),this.valid=!1,0<v.count()&&(this.errors=v)}return r[this.name]};r[l].isInteger=
function(u,v){var G=this.value,J=!1,T=!0,ra=!0,Fa=r[this.name].errors||{};+G===+G&&0===G%1&&(J=!0,Fa.isRequired||''==G||(u&&'number'==typeof u&&G.length<u&&(T=!1,this.size=u),v&&'number'==typeof v&&G.length>v&&(ra=!1,this.size=v)));J&&T&&ra||(J||(Fa.isInteger=D(this.error||S.errorLabels.isInteger,this)),T&&ra||(T||(Fa.isIntegerLength=D(this.error||S.errorLabels.isIntegerMinLength,this),J=!1),ra||(Fa.isIntegerLength=D(this.error||S.errorLabels.isIntegerMaxLength,this),J=!1),u===v&&(Fa.isIntegerLength=
D(this.error||S.errorLabels.isIntegerLength,this),J=!1)));this.valid=J;this.value=S.data[this.name]=Number(G);0<Fa.count()&&(this.errors=Fa);return r[this.name]};r[l].toFloat=function(u){'string'==typeof this.value&&(this.value=this.value.replace(/\s+/g,''),/,/.test(this.value)&&!/\./.test(this.value)?this.value=this.value.replace(/,/g,'.'):this.value=this.value.replace(/,/g,''));var v=S.data[this.name]=this.value,G=r[this.name].errors||{},J=!0;u?this.decimals=parseInt(u):'undefined'==typeof this.decimals&&
(this.decimals=2);if(v)if(this.isNumber().valid)try{Number.isFinite(v)||(v=this.value=S.data[this.name]=new Number(parseFloat(v.match(/[0-9.,]+/g).join('').replace(/,/,'.')))),U&&this.target.setAttribute('value',v)}catch(T){J=!1,G.toFloat=D(this.error||S.errorLabels.toFloat,this),this.valid=!1,0<G.count()&&(this.errors=G)}else J=!1,G.toFloat=D(this.error||S.errorLabels.toFloatNAN,this);else return r[this.name];this.decimals&&v&&!G.toFloat&&(this.value=S.data[this.name]=parseFloat(this.value.toFixed(this.decimals)));
this.valid=J;0<G.count()&&(this.errors=G);return r[this.name]};r[l].isFloat=function(u){'string'==typeof this.value&&(this.value=this.value.replace(/\s+/g,''));var v=S.data[this.name]=this.value;u=r[this.name].errors||{};'string'==typeof v&&/\./.test(v)&&Number.isFinite(Number(v));'string'==typeof v&&/,/g.test(v)&&(v=this.value=S.data[this.name]=Number(v.replace(/,/g,'.')));Number(v)===v&&0!==v%1?(this.value=S.data[this.name]=Number(v),v=!0):v=!1;u.isRequired||''!=this.value||(v=!0);v||(u.isFloat=
D(this.error||S.errorLabels.isFloat,this));this.valid=v;0<u.count()&&(this.errors=u);return r[this.name]};r[l].isRequired=function(u){if('boolean'==typeof u&&!u)return this.valid=!0,u=S.excluded.indexOf(this.name),-1<u&&S.excluded.splice(u,1),r[this.name];if(U&&this.target&&'INPUT'==this.target.tagName&&'undefined'!=typeof this.target.type&&'radio'==this.target.type){u=document.getElementsByName(this.name);for(var v=0,G=u.length;v<G;++v)if(u[v].checked){/true|false/.test(u[v].value)?this.value=S.data[this.name]=
/true/.test(u[v].value)?!0:!1:this.value=S.data[this.name]=u[v].value;this.valid=!0;break}}u='undefined'==typeof this.value||null==this.value||''==this.value||/^\s+/.test(this.value)?!1:!0;v=r[this.name].errors||{};u?u&&'undefined'!=typeof v.isRequired&&delete v.isRequired:v.isRequired=D(this.error||S.errorLabels.isRequired,this);this.valid=u;0<v.count()&&(this.errors=v);return r[this.name]};r[l].isString=function(u,v){var G=S.data[this.name]=this.value,J=!1,T=!0,ra=!0,Fa=r[this.name].errors||{};
'string'!=typeof G||Fa.isRequired||''==G||(J=!0,u&&'number'==typeof u&&G.length<u&&(T=!1,this.size=u),v&&'number'==typeof v&&G.length>v&&(ra=!1,this.size=v));J&&T&&ra||(!J&&Fa.isRequired&&''==G?(J=!1,Fa.isString=D(this.error||S.errorLabels.isString,this)):J||Fa.isRequired||(J=!0),T&&ra||(J=!1,T||(Fa.isStringLength=D(this.error||S.errorLabels.isStringMinLength,this)),ra||(Fa.isStringLength=D(this.error||S.errorLabels.isStringMaxLength,this)),u===v&&(Fa.isStringLength=D(this.error||S.errorLabels.isStringLength,
this))));this.valid=J;0<Fa.count()&&(this.errors=Fa);return r[this.name]};r[l].isDate=function(u){var v=this.value,G=!1,J=r[this.name].errors||{},T=null;if(!v||''==v||/NaN|Invalid Date/i.test(v))return/NaN|Invalid Date/i.test(v)&&(console.warn('[FormValidator::isDate] Provided value for field `'+this.name+'` is not allowed: `'+v+'`'),J.isDate=D(this.error||S.errorLabels.isDate,this)),this.valid=G,0<J.count()&&(this.errors=J),r[this.name];if('undefined'==typeof u||'undefined'!=typeof u&&/true/i.test(u))u=
...
oa.envConf[r][H].host,w.webroot=oa.envConf[r][H].server.webroot;return w};P.compareUrls=async function(r,H,w,oa,Aa){'undefined'==typeof w&&(w={routing:{}});if(/,/.test(H)){var N=0;H=H.split(/,/g);for(var O=H.length,A={past:!1,request:w};N<O&&!A.past;)A=await M(r,H[N],w,oa,Aa),++N;return A}return await M(r,H,w,oa,Aa)};var M=async function(r,H,w,oa,Aa){var N=null;try{N=r.url.split(/\//)}catch(T){console.warn(T),N=['']}H=H.split(/\//);var O=0,A=0,D=H.length,l=0,y={},z=0,F=w.method.toLowerCase(),u='get';
try{u=r.method.toLowerCase()}catch(T){}var v=!1;if('undefined'!=typeof r.requirements&&/get|delete/i.test(F)&&'undefined'!=typeof w[F]||'undefined'!=typeof r.requirements&&/get/i.test(F)&&/delete/i.test(u)){/get/i.test(F)&&/delete/i.test(u)&&(F=u);if(/^(delete)$/i.test(F)&&N.length===H.length){'undefined'==typeof w[F]&&(w[F]={});for(let T=0,ra=H.length;T<ra;T++)if(N[T]===H[T])++l;else if(u=H[T].substr(1),'undefined'!=typeof r.requirements[u]){u=r.requirements[u];if(/^\//.test(u))u=u.substr(1,u.lastIndexOf('/')-
1);else if(/^validator::/.test(u)&&await ba(H[T],N[T],r,w,oa,Aa)){++l;continue}/^:/.test(H[T])&&'undefined'!=typeof u&&(new RegExp(u)).test(N[T])&&(++l,w[F][H[T].substr(1)]=N[T])}v=!0}for(var G in w[F])'undefined'!=typeof r.requirements[G]&&0>H.indexOf(':'+G)&&(H[A]=':'+G,++A,N[O]=w[F][G],++O,v||N.length!==H.length||++D)}if(!v&&N.length===H.length)for(;z<D;++z)N[z]===H[z]?++l:l==z&&/:/.test(H[z])&&await ba(H[z],N[z],r,w,oa,Aa)&&++l;if('undefined'!=typeof r.requirements&&F==r.method.toLowerCase()&&
!v&&l>=D)for(G=Object.getOwnPropertyNames(r.requirements),O=0,H.join(',').match(/:[-_a-z0-9]+/g);O<G.length;){A=G[O];if('undefined'==typeof r.param[A]&&/^validator::/i.test(r.requirements[A])){if(H.length!=N.length)break;var J=H.join(',').match(/:[-_a-z0-9]+/g);let T=r.requirements[A];z={};u={};v={};try{u=JSON.parse(T.split(/::/).splice(1)[0].replace(/([^:"\s+](\w+)):/g,'"$1":').replace(/([^:"\s+](\w+))\s+:/g,'"$1":'))}catch(ra){throw ra;}if('undefined'!=typeof u.query&&'undefined'!=typeof u.query.data){z=
u.query.data;for(let ra in z)0>J.indexOf(z[ra])&&delete z[ra];for(let ra=0,Fa=H.length;ra<Fa;ra++)/^:/.test(H[ra])&&(J=H[ra].replace(/^:/,''),''!=J&&'undefined'!=typeof N[ra]&&(z[J]=N[ra],'undefined'==typeof w.params[J]&&(w.params[J]=N[ra])))}z=ma(z,JSON.clone(w[F])||{});'undefined'==typeof z[A]&&(z[A]=null);v[A]=u;_validator=B?new U(z):new U('routing',z,null,v);if(0==u.count()){console.error('Route validation failed '+r.rule);--l;O++;continue}for(let ra in u)if('undefined'!=typeof u[ra].data&&(u[ra].data=
z),v=Array.isArray(u[ra])?await _validator[A][ra].apply(_validator[A],u[ra]):await _validator[A][ra](u[ra],w,oa,Aa),!v.isValid&&(--l,'undefined'!=typeof v.error))throw v.error;}O++}y.past=l===D?!0:!1;y.past&&(w.routing=S(r,w[F]),y.request=w);return y},ba=async function(r,H,w,oa,Aa,N){var O=-1,A=r.match(/:\w+/g);O=new RegExp(r,'g');var D=null,l=null,y=null;D=!1;var z=D=l=l=null,F=null,u=oa.method.toLowerCase();if(!A.length)return!1;w.param.path&&O.test(w.param.path)&&(w.param.path=w.param.path.replace(O,
H));w.param.namespace&&O.test(w.param.namespace)&&(w.param.namespace=w.param.namespace.replace(O,H));'undefined'!=typeof w.param.file&&/:/.test(w.param.file)&&(D=new RegExp('(:'+r+'/|:'+r+'$)','g'),Q.variable=H,w.param.file=w.param.file.replace(D,Q),D=null);w.param.title&&O.test(w.param.title)&&(w.param.title=w.param.title.replace(O,H));if(1==A.length){D=new RegExp(A[0]);O=-1<A.indexOf(r)?A.indexOf(r):!1;!1===O&&r.match(D)&&(O=0);if(!1===O)return O;if(w.method.toLowerCase()!==u)return!1;'undefined'==
typeof oa[u]&&(oa[u]={});y=A[O].substr(1);O=w.requirements[y];if(/^\//.test(O))D=O.match(/\/(.*)\//).pop(),l=O.replace('/'+D+'/',''),D=(new RegExp(D,l)).test(H);else if(/^validator::/.test(O)&&H){l={};D={};z={};F='';r.replace(new RegExp('[^'+y+']','g'),function(ra){F+=ra});l[y]=H.replace(new RegExp(F,'g'),'');try{D=JSON.parse(O.split(/::/).splice(1)[0].replace(/([^:"\s+](\w+)):/g,'"$1":').replace(/([^:"\s+](\w+))\s+:/g,'"$1":'))}catch(ra){throw ra;}'undefined'!=typeof D.query&&'undefined'!=typeof D.query.data&&
r==D.query.data[Object.keys(D.query.data)[0]]&&(D.query.data[Object.keys(D.query.data)[0]]=l[y],oa.params[y]=l[y]);z[y]=D;l=new U('routing',l,null,z);if(0==D.count())return console.error('Route validation failed '+w.rule),!1;for(var v in D)Array.isArray(D[v])?await l[y][v].apply(l[y],D[v]):await l[y][v](D[v],oa,Aa,N);D=l.isValid()}else D=(new RegExp(w.requirements[y])).test(H);if('undefined'!=typeof w.param[y]&&'undefined'!=typeof w.requirements&&'undefined'!=typeof w.requirements[y]&&'undefined'!=
typeof oa.params&&D)return oa.params[y]=H,'undefined'==typeof oa[u][y]&&(oa[u][y]=H),!0}else{Aa=w.url;N=oa.url;u={};z='';var G=!1,J=0;v=0;for(var T=N.length;v<T;++v)if(N.charAt(v)!=Aa.charAt(J)||G){if(''==z)G=!0,z+=N.charAt(v);else if(v>Aa.indexOf(A[0])+A[0].length){O=w.requirements[A[0]];H=z.substr(0,z.length);if(/^\//.test(O))D=O.match(/\/(.*)\//).pop(),l=O.replace('/'+D+'/',''),D=(new RegExp(D,l)).test(H);else if(/^validator::/.test(O)){l={};D={};z={};F='';r.replace(new RegExp('[^'+y[0]+']','g'),
function(ra){F+=ra});l[y[0]]=H.replace(new RegExp(F,'g'),'');D=JSON.parse(O.split(/::/).splice(1)[0].replace(/([^\W+ true false])+(\w+)/g,'"$&"'));z[y[0]]=D;l=new U('routing',l,null,z);for(let ra in D)if(Array.isArray(D[ra]))l[y[0]][ra].apply(l[y[0]],D[ra]);else l[y[0]][ra](D[ra]);D=l.isValid()}else D=(new RegExp(w.requirements[y[0]])).test(H);if(D)u[A[0].substr(1)]=H;else return!1;z='';G=!1;J=Aa.indexOf(A[0])+A[0].length;--v;A.splice(0,1)}else z+=N.charAt(v),++J;if(v==T-1)if(O=w.requirements[A[0]],
H=z.substr(0,z.length),/^\//.test(O)?(D=O.match(/\/(.*)\//).pop(),l=O.replace('/'+D+'/',''),D=(new RegExp(D,l)).test(H)):D=(new RegExp(w.requirements[y])).test(H),D)u[A[0].substr(1)]=H;else return!1}else++J;if(u.count()==A.length){y=null;for(y in u)oa.params[y]=u[y];return!0}}return!1},Q=function(r){return/\/$/.test(r)?Q.variable+'/':Q.variable},S=function(r,H){var w=null,oa,Aa=r.url,N=null;for(N in r.param)if(('undefined'==typeof H||'undefined'!=typeof H[N])&&/^:/.test(r.param[N])){var O=r.param[N].substr(1);
if('undefined'!=typeof H&&'undefined'!=typeof H[O]){var A=new RegExp('(:'+O+'/|:'+O+'$)','g');'undefined'!=typeof r.param.path&&/:/.test(r.param.path)&&(r.param.path=r.param.path.replace(A,H[O]));'undefined'!=typeof r.param.title&&/:/.test(r.param.title)&&(r.param.title=r.param.title.replace(A,H[O]));'undefined'!=typeof r.param.namespace&&/:/.test(r.param.namespace)&&(r.param.namespace=r.param.namespace.replace(A,H[O]));'undefined'!=typeof r.param.file&&/:/.test(r.param.file)&&(Q.variable=H[O],r.param.file=
r.param.file.replace(A,Q));if(/,/.test(r.url)){w=r.url.split(/,/g);var D=0;for(oa=w.length;D<oa;++D)Q.variable=H[O],w[D]=w[D].replace(A,Q);r.url=w.join(',')}else Q.variable=H[O],r.url=r.url.replace(A,Q)}}if(w){D=0;oa=w.length;Aa=Aa.split(/,/g);var l=0;for(r.urlIndex=0;D<oa;++D)if(w=0,A=Aa[0].match(/:[-_a-z0-9]+/ig)){N=0;for(O=A.length;N<O;N++){var y=A[N].substr(1);'undefined'!=typeof H[y]&&H[y]&&w++}w>l&&(l=w,r.urlIndex=D)}}return r};P.getRoute=function(r,H,w){var oa=null,Aa=null;B?(window.location.port||
window.location.hostname!=window.gina.config.hostname.replace(/^(https|http|wss|ws):\/\//,'').replace(/:\d+$/,'')||(Aa=!0,window.gina.config.hostname=window.gina.config.hostname.replace(/^(https|http|wss|ws):\/\//,'').replace(/:\d+$/,'')),oa=window.gina.config):(Aa=getContext('isProxyHost'),oa=getContext('gina').config,'undefined'!=typeof getContext('argvFilename')&&(oa.getRouting=getContext('gina').Config.instance.getRouting));var N=oa.env||GINA_ENV,O=null,A=oa.bundle;/@/.test(r)||'undefined'==typeof A||
null==A||(r=r.toLowerCase(),r+='@'+A);if(/@/.test(r)){var D=r.replace(/(.*):\/\//,'').split(/@/);A=D[1];/\/(.*)$/.test(r)&&(O=r.replace(/(.*):\/\//,'').split(/\/(.*)$/)[1],A=A.replace(/\/(.*)$/,''),N=O||N);r=D[0].toLowerCase()+'@'+A}O=oa.getRouting(A,N);if('undefined'==typeof O[r])throw Error('[ RoutingHelper::getRouting(rule, params) ] : `'+r+'` not found !');oa=JSON.clone(O[r]);A=null;oa=S(oa,H);Aa&&(oa.hostname=oa.hostname.replace(/:\d+/,''));/,/.test(oa.url)&&('undefined'!=typeof oa.urlIndex&&
(w=oa.urlIndex,delete oa.urlIndex),w='undefined'!=typeof w?w:0,oa.url=oa.url.split(/,/g)[w]);/\/$/.test(oa.url)&&'/'!=oa.url&&(oa.url=oa.url.substr(0,oa.url.length-1));if(/GET/i.test(oa.method)&&'undefined'!=typeof H){w='?';Aa=O[r].url;O=[];A=0;for(let l in oa.param)-1<P.reservedParams.indexOf(l)||(new RegExp(oa.param[l])).test(Aa)||'undefined'==typeof H[l]||(w+=l+'='+encodeRFC5987ValueChars(H[l])+'&',O[A]=H[l],++A);for(let l in H)-1<P.reservedParams.indexOf(l)||'undefined'!=typeof oa.requirements[l]||
-1<O.indexOf(l)||(w='object'==typeof H[l]?w+(l+'='+encodeRFC5987ValueChars(JSON.stringify(H[l]))+'&'):w+(l+'='+H[l]+'&'));A=O=Aa=null;1<w.length&&(w=w.substring(0,w.length-1),oa.url+=w);w=null}oa.toUrl=function(l){var y=null;/^redirect$/i.test(this.param.control)&&(y=P.getUrlProps(this.bundle,N||GINA_ENV));var z=this.webroot||y.webroot;y=this.hostname||y.hostname;var F=this.url;this.url='undefined'!=typeof l&&1==l?F.replace(z,'/'):F;return y+this.url};oa.request=function(l,y){var z=null,F=null;'function'==
typeof arguments[arguments.length-1]&&(z=arguments[arguments.length-1]);'object'==typeof arguments[2]&&(F=arguments[2]);var u=this.webroot||F.webroot,v=this.hostname||F.hostname;F='undefined'!=typeof l&&1==l?path.replace(u,'/'):this.url||F.url;v=/^https/.test(v)?'https':'http';B?window.open(F,'undefined'!=typeof y&&'undefined'!=typeof y.target?y.target:'_self'):('undefined'==typeof y.agent&&(y.agent=!1),v=require(''+v),u=function(G){var J='',T=!1;G.on('data',function(ra){J+=ra});G.on('error',function(ra){T=
'Failed to get mail content';ra&&'undefined'!=typeof ra.stack?T+=ra.stack:'string'==typeof ra&&(T+='\n'+ra)});G.on('end',function(){if(/^\{/.test(J))try{J=JSON.parse(J),'undefined'!=typeof J.error&&(T=JSON.clone(J),J=null)}catch(ra){T=ra}T?z(T):z(!1,J)})},z?v.get(F,y,u):v.get(F,y))};!/:/.test(oa.url)||/:d+\//.test(oa.url)||/:\/\//.test(oa.url)||(H=oa.url.match(/(:(.*)\/|:(.*)$)/g).map(function(l){return l.replace(/\//g,'')}).join(', '),A='[ RoutingHelper::getRoute(rule[, bundle, method]) ] : route [ %r ] param placeholder not defined: `'+
oa.url+'` !\n Check your route description to compare requirements against param variables [ '+H+']',A=A.replace(/%r/,r),r=Error(A),console.warn(r),A=r=H=null);return oa};P.getRouteByUrl=function(r,H,w,oa,Aa){2==arguments.length&&'undefined'!=typeof arguments[1]&&arguments[1]&&-1<P.allowedMethods.indexOf(arguments[1].toLowerCase())&&(w=arguments[1],H=void 0);var N=null,O=null,A=null,D=null,l=null,y=null;if(/#/.test(r)&&1<r.length){var z=r.split(/#/);r=z[0];l='#'+z[1];z=null}1==arguments.length&&'undefined'!=
typeof arguments[0]&&(/^(https|http)/i.test(r)||/^\//.test(r)||(r='/'+r),N='/'+r.split(/\//g)[1],B&&(D=gina.config.reverseRouting,A=gina.config.routing),'undefined'!=typeof D[N]&&(z=A[D[N]],H=z.bundle,N=z.webroot,y=z.hostname,z=null));Aa='boolean'!=typeof arguments[arguments.length-1]?!1:arguments[arguments.length-1];var F=!1,u=null,v=null,G=u=v=null;z='undefined'!=typeof w?!0:!1;B?(u=window.gina.config,H='undefined'!=typeof H?H:u.bundle,v=u.env,A=A||u.getRouting(H),D=D||u.reverseRouting,isXMLRequest=
'undefined'!=typeof isXMLRequest?isXMLRequest:!1,y=y||u.hostname,N=N||u.webroot,oa={routing:{},method:w,params:{},url:r}):(u=getContext('gina').config,H='undefined'!=typeof H?H:u.bundle,v=u.env,A=u.getRouting(H),y=u.envConf[H][v].hostname,N=u.envConf[H][v].server.webroot,oa||={routing:{},isXMLRequest:!1,method:'undefined'!=typeof w?w.toLowerCase():'get',params:{},url:r},Aa&&(oa.method=w),isXMLRequest=oa.isXMLRequest||!1);v=r.replace(new RegExp('^('+y+'|'+y.replace(/:\d+/,'')+')'),'');'undefined'==
typeof oa.routing.path&&(oa.routing.path=decodeURI(v));w='undefined'!=typeof w?w.toLowerCase():'get';z&&(oa.originalMethod=oa.method,oa.method=w,oa.routing.path=decodeURI(v));oa.method||(oa.method=w);u={};N=new RegExp(w,'i');D=null;var J;for(J in A){if('undefined'==typeof A[J].param)break;if(A[J].bundle==H&&(D=A[J].method,/,/.test(D)&&N.test(D)&&(D=oa.method),'undefined'==typeof A[J].method||N.test(D))){u={method:D,requirements:A[J].requirements,namespace:A[J].namespace||void 0,url:decodeURI(v),rule:A[J].originalRule||
J,param:A[J].param,middleware:JSON.clone(A[J].middleware),bundle:A[J].bundle,isXMLRequest};try{if(G=P.compareUrls(u,A[J].url,oa),G.past){O=JSON.clone(A[J]);O.name=J;F=!0;G={};break}}catch(T){throw Error('Route [ '+J+' ] needs your attention.\n'+T.stack);}}}if(F)return/\/$/.test(r)&&'/'!=r&&(r=r.substr(0,r.length-1)),l&&(r+=l),O.url=r,O.toUrl=function(T){var ra=this.webroot,Fa=this.hostname,W=this.url;this.url='undefined'!=typeof T&&1==T?W.replace(ra,'/'):W;return Fa+this.url},O;if(B){l=!1;if('#'==
r&&/GET/i.test(w)&&z||/^404:/.test(r))r=location.pathname,l=!0;'undefined'==typeof P.notFound&&(P.notFound={});A=null;O='[ RoutingHelper::getRouteByUrl(rule[, bundle, method]) ] : route [ %r ] is called but not found inside your view: `'+r+'` !';if((A=(A=gina.hasPopinHandler&&gina.popinIsBinded?gina.popin.getActivePopin().target.innerHTML.match(/404:\[\w+\][a-z 0-9-_@]+/):document.body.innerHTML.match(/404:\[\w+\][a-z 0-9-_@]+/))&&0<A.length?A[0]:null)&&z&&l)return l=A.match(/\[\w+\]/)[0],A=A.replace('404:'+
l,l.replace(/\[|\]/g,'')+'::'),O=O.replace(/%r/,A.replace(/404:\s+/,'')),'undefined'==typeof P.notFound[A]?P.notFound[A]={count:1,message:O}:z&&'undefined'!=typeof P.notFound[A]&&++P.notFound[A].count,!1;if((l=gina.config.reverseRouting[r]||null)&&'undefined'!=typeof l&&l.split(/@(.+)$/)[1]==H)return A=l,'undefined'==typeof P.notFound[A]?(O=O.replace(/%r/,w.toUpperCase()+'::'+l),P.notFound[A]={count:1,message:O}):z&&'undefined'!=typeof P.notFound[A]&&++P.notFound[A].count,!1;A=P.compareUrls(u,r,oa)||
null;A.past&&z&&(A=w.toUpperCase()+'::'+A.request.routing.rule,'undefined'==typeof P.notFound[A]?O=O.replace(/%r/,A):++P.notFound[A].count);return!1}console.warn(Error('[ RoutingHelper::getRouteByUrl(rule[, bundle, method, request]) ] : route not found for url: `'+r+'` !').stack);return!1};return P}'undefined'!==typeof module&&module.exports?module.exports=Routing():'function'===typeof define&&define.amd&&define('lib/routing',['require','lib/form-validator','lib/merge'],function(){return Routing()});
function StoragePlugin(B){function P(O){H=JSON.parse(S.getItem(this.bucket));'undefined'==typeof H[O]&&(H[O]=[],S.setItem(this.bucket,JSON.stringify(H)),H=JSON.parse(S.getItem(this.bucket)));r[O]={_collection:O,_bucket:this.bucket};r[O]=ma(r[O],Aa);return r[O]}function V(O){if('object'!==typeof O)throw Error('filter must be an object');var A=H[this._collection],D=O.count(),l=0,y=null;if(0==D)return null;for(var z in A)for(var F in O){var u='boolean'!=typeof O[F]?O[F].toLocaleLowerCase():O[F];O[F]&&
-1<w.indexOf(u)&&'not null'==u&&'undefined'!=typeof A[z][F]&&'object'!==typeof A[z][F]&&A[z][F]===O[F]&&'null'!=A[z][F]&&'undefined'!=A[z][F]?0>y.indexOf(A[z][F])&&(++l,l===D&&(y=A[z],y._index=z,y._collection=this._collection,y._bucket=this._bucket)):'undefined'!=typeof A[z][F]&&'object'!==typeof A[z][F]&&A[z][F]===O[F]&&(++l,l===D&&(y=A[z],y._index=z,y._collection=this._collection,y._bucket=this._bucket,y._filter=O))}y&&(y.save=N);return y}var ma=ma||require('lib/merge');P=P||require('lib/collection');
var U=U||require('vendor/uuid'),M=M||require('helpers/dateFormat'),ba={bucket:'default'},Q={},S=null,r={},H={},w=['not null'],oa={bucket:void 0,drop:function(){S.removeItem(ba.bucket);Q=null;for(var O in this)delete this[O];return Q},Collection:P},Aa={insert:function(O){O._id=U.v1();O._createdAt=(new Date).format('isoDateTime');O._updatedAt=(new Date).format('isoDateTime');H[this._collection][H[this._collection].length]=O;S.setItem(this._bucket,JSON.stringify(H))},find:function(O,A){if(!O)return H[this._collection];
if('object'!==typeof O)throw Error('filter must be an object');A=H[this._collection];O.count();var D=0,l=[],y;for(y in A)for(var z in O){var F='boolean'!=typeof O[z]?O[z].toLocaleLowerCase():O[z];O[z]&&-1<w.indexOf(F)&&'not null'==F&&'undefined'!=typeof A[y][z]&&'object'!==typeof A[y][z]&&'null'!=A[y][z]&&'undefined'!=A[y][z]?0>l.indexOf(A[y][z])&&(l[D]=A[y][z],++D):'undefined'!=typeof A[y][z]&&'object'!==typeof A[y][z]&&A[y][z]===O[z]&&(l[D]=A[y],++D)}return l},findOne:V,update:null,'delete':function(O){if('object'!==
typeof O)throw Error('filter must be an object');var A=JSON.clone(H[this._collection]),D=0,l=[],y;for(y in A)for(var z in O)O[z]&&-1<w.indexOf(O[z].toLocaleLowerCase())&&'not null'==O[z].toLowerCase()&&'undefined'!=typeof A[y][z]&&'object'!==typeof A[y][z]&&'null'!=A[y][z]&&'undefined'!=A[y][z]?0>l.indexOf(A[y][z])&&(l[D]=A[y][z],delete H[this._collection][y][z],++D):'undefined'!=typeof A[y][z]&&'object'!==typeof A[y][z]&&A[y][z]===O[z]&&(l[D]=A[y],H[this._collection].splice(y,1),++D);return 0<l.length?
(S.setItem(this._bucket,JSON.stringify(H)),!0):!1},drop:function(O){if('undefined'==typeof H[this._collection])throw Error('Collection `'+O+'` not found');delete r[this._collection];delete H[this._collection];S.setItem(this._bucket,JSON.stringify(H))}},N=function(O){O=O||!1;try{var A=JSON.clone(H),D=this._index,l=this._collection,y=this._bucket,z=this._filter;this._updatedAt=(new Date).format('isoDateTime');A[l][D]=ma(A[l][D],this,!0);delete A[l][D]._index;delete A[l][D]._collection;delete A[l][D]._bucket;
delete A[l][D].save;delete A[l][D]._filter;if(O&&'object'==typeof A[l][D]){var F=function(v,G){for(var J=0,T=v.length;J<T;++J)'object'!=typeof G[J]||'undefined'==typeof v[J]||Array.isArray(v[J])?Array.isArray(v[J])?F(v[J],G[J]):'undefined'==typeof v[J]&&delete G[J]:u(v[J],G[J]);return G},u=function(v,G){for(var J in G)'object'!=typeof G[J]||'undefined'==typeof v[J]||Array.isArray(v[J])?Array.isArray(v[J])?F(v[J],G[J]):'undefined'==typeof v[J]&&delete G[J]:u(v[J],G[J]);return G};Array.isArray(A[l][D])?
A[l][D]=F(this,A[l][D]):'object'==typeof A[l][D]?A[l][D]=u(this,A[l][D]):'undefined'==typeof this[prop]&&delete A[l][D]}H[l][D]=A[l][D];S.setItem(y,JSON.stringify(H));return V(z)}catch(v){throw v;}};(function(O){if(!window.localStorage||window.localStorage&&'undefined'==!typeof window.localStorage.setItem)throw Error('Make sure your browser supports `window.localStorage` to use Gina Storage. See: `https://developer.mozilla.org/en-US/docs/Web/API/Web_Storage_API#Browser_compatibility`');if('object'!=
...
function getElementsByAttribute(B){for(var P=[],V=0,ma=document.getElementsByTagName('*'),U=0,M=ma.length;U<M;++U)null!==ma[U].getAttribute(B)&&(P[V]=ma[U],++V);return P}
(function(B){var P=B.prototype,V=P.parseFromString;try{if((new B).parseFromString('','text/html'))return}catch(ma){}P.parseFromString=function(ma,U){if(/^\s*text\/html\s*(?:;|$)/i.test(U)){var M=document.implementation.createHTMLDocument('');-1<ma.toLowerCase().indexOf('<!doctype')?M.documentElement.innerHTML=ma:M.body.innerHTML=ma;return M}return V.apply(this,arguments)}})(DOMParser);define('utils/dom',function(){});
...
function DataHelper(){encodeRFC5987ValueChars=function(V){return encodeURIComponent(V).replace(/['()]/g,escape).replace(/\*/g,'%2A').replace(/%(?:7C|60|5E)/g,unescape)};formatDataFromString=function(V){'object'==typeof V&&(V=JSON.stringify(V));try{V=decodeURIComponent(V)}catch(r){}/("false"|"true"|"on")/.test(V)&&(V=V.replace(/"false"/g,!1).replace(/"true"/g,!0).replace(/"on"/g,!0));/("null")/i.test(V)&&(V=V.replace(/"null"/ig,null));a:{var ma=V,U=V=null,M=null;if(/^(\{|\[|%7B|%5B)/.test(ma)){try{V=
(M=/^(\{|%7B)/.test(ma)?!1:!0)?[]:{};U=/^(%7B|%5B)/.test(ma)?JSON.parse(decodeURIComponent(ma)):JSON.parse(ma);if(Array.isArray(U)){M=0;for(var ba=U.length;M<ba;++M)V[M]=B(U[M],V);var Q=V}else Q=B(U,V);var S=Q;break a}catch(r){console.error('[365] could not parse body:\n'+ma)}S=void 0}else{V={};S=ma.split(/&/g);/("false"|"true"|"on")/.test(ma)&&ma.replace(/"false"/g,!1).replace(/"true"/g,!0).replace(/"on"/g,!0);ma={};ba=0;for(U=S.length;ba<U;++ba)if(S[ba])if(S[ba]=decodeURIComponent(S[ba]),/^\{/.test(S[ba])||
...
/^(.*)\[(.*)\]/.test(ma[0])?(Q=ma[0].replace(/\]/g,'').split(/\[/g),V=P(V,Q,0,ma[1])):V[ma[0]]=ma[1])}S=V}}return S};var B=function(V,ma){var U=[];ma||={};for(let ba in V)if(U[0]=ba,U[1]=V[ba],/^(.*)\[(.*)\]/.test(U[0])){var M=U[0].replace(/\]/g,'').split(/\[/g);ma=P(ma,M,0,U[1])}else ma[U[0]]=U[1];return ma},P=function(V,ma,U,M){for(let ba=0,Q=ma.length;ba<Q;ba++){let S=ma[U];if(ba==U){if('undefined'==typeof V[ma[U]]||'string'==typeof V[ma[U]])Array.isArray(V)?(S=~~ma[U],V[S]=/^\d+$/.test(ma[U+1])?
[]:{}):V[ma[U]]=/^\d+$/.test(ma[U+1])?[]:{};if(U==ma.length-1){M='undefined'!=typeof M?M:'';Array.isArray(V[ma[U]])?V[ma[U]].push(M):V[ma[U]]=M;break}else/^\d+$/.test(ma[U])&&!Array.isArray(V)&&(V=[]),'undefined'==typeof V[S]&&(V[S]=null),P(V[S],ma,U+1,M)}}return V}}'undefined'!==typeof module&&module.exports?module.exports=DataHelper:'function'===typeof define&&define.amd&&define('utils/data',[],function(){return DataHelper()});
function ValidatorPlugin(B,P,V){this.plugin='validator';var ma='init ready registered success error progress submit reset change changed keydown keyup focusout focusin validate validated destroy asyncCompleted'.split(' '),U='undefined'!==typeof module&&module.exports?!1:!0,M=null;if(U)require('utils/events'),registerEvents(this.plugin,ma),require('utils/dom'),require('utils/effects'),require('utils/data'),M=gina.config.envIsDev;else{if(M=/^true$/i.test(process.env.NODE_ENV_IS_DEV)?!0:!1)delete require.cache[require.resolve('./form-validator')],
...
null,errors:{},initialized:!1,isReady:!1,rules:{},$forms:{},getFormById:null,validateFormById:null,setOptions:null,resetErrorsDisplay:null,resetFields:null},oa={id:null,plugin:this.plugin,on:U?on:null,eventData:{},target:U?document:null,cachedErrors:{},binded:!1,unbinded:!1,withUserBindings:!1,rules:{},setOptions:null,send:null,isValidating:null,isSubmitting:null,submit:null,destroy:null,resetErrorsDisplay:null,resetFields:null},Aa={},N={},O=null,A={url:'',method:'GET',isSynchrone:!1,withCredentials:!1,
...
m=m.replace(/#/,'');if(null!=document.getElementById(m)&&'undefined'==typeof w.$forms[m]){var h=document.getElementById(m),b,x=typeof(0<Aa.count())?Aa:w.rules;h.getAttribute?(id=h.getAttribute('id')||'form.'+ba.v4(),id!==h.getAttribute('id')&&h.setAttribute('id',id)):(id='form.'+ba.v4(),h.setAttribute('id',id));h.id=oa.id=id;if('undefined'!=typeof h.id&&'null'!=h.id&&''!=h.id){oa.target=h;w.$forms[h.id]=Q({},oa);if(b=h.getAttribute('data-gina-form-rule')){b=b.replace(/\-|\//g,'.');if('undefined'==
...
m+'.'),x=null,q=function(R,K,fa,Ba,ea,da,E){if(K.length){var na=Object.getOwnPropertyNames(R)[0],sa=K[0];sa=''==ea?ea+=sa:ea+'['+sa+']';1==K.length&&(R[na]=Q(R[na],fa,!0));K.splice(0,1);sa==na?q(R[na],K,fa,Ba,sa,da,E):'undefined'!=typeof R[na]?q(R[na],K,fa,Ba,sa,da,E):q(R,K,fa,Ba,ea,da,E)}},p;for(p in w.rules)p!=m&&h.test(p)&&(x=p.replace(b,''),/\./.test(x)&&(x=x.split(/\./g),q(g,x,w.rules[p],g,'',0,g.count()-1)));return Aa[m]=g},Na=formatDataFromString,Ia=function(m){var g=w.$forms[m.form.getAttribute('id')],
...
/true/i.test(w.$forms[K.target.form.getAttribute('id')].isSubmitting))return!1;var fa=function(){console.debug('processing: '+K.target.name+'/'+K.target.id);if(!/^(radio|checkbox)$/i.test(K.target.type)&&K.target.value===K.target.defaultValue&&''!=K.target.value){var Ba=w.$forms[K.target.form.getAttribute('id')].errors;if(Ba&&0!=Ba.count())G(K.target.form,Ba,null,K.target.name);else return G(K.target.form,{},null,K.target.name),cancelEvent(K)}Ba={};var ea={};Ba[K.target.name]=K.target.value;ea[K.target.name]=
K.target;w.$forms[K.target.form.getAttribute('id')].isValidating=!0;za(K.target,Ba,ea,m.rules,function(da){w.$forms[K.target.form.getAttribute('id')].isValidating=!1;da.isValid()?G(K.target.form,{},da.data,K.target.name):G(K.target.form,da.error,da.data,K.target.name);var E=K.target.form,na=da=null,sa=null;na=db(E,x);da=na.fields;na=na.$fields;var ia=E.getAttribute('id');sa=w.$forms[ia].rules;w.$forms[ia].isValidating=!0;za(E,da,na,sa,function(Z){w.$forms[ia].isValidating=!1;console.debug('['+ia+
...
(console.debug('#1 you just focusin ....'+g.id,g.value),u(g)):/^focusout\./i.test(K.type)?/\-warning/.test(g.parentNode.className)&&(console.debug('#1 you just focusout ....'+g.id,g.value),u(g),G(g.form,w.$forms[g.form.getAttribute('id')].errors,null,g.name)):/^keyup\./i.test(K.type)?(g.ginaFormValidatorTestedValue=g.value,h=setTimeout(function(){-1<['91','17'].indexOf(''+K.keyCode)&&0==N.count()||(console.debug(' keyup ('+K.keyCode+') .... '+g.id,g.value,' VS ',g.ginaFormValidatorTestedValue+'(old)'),
...
w.$forms[Ra.getAttribute('id')].isValidating=!0;za(event.target,ja,va,X.rules,function(Xa){w.$forms[Ra.getAttribute('id')].isValidating=!1;Xa.isValid()?G(Ra,{},Xa.data,event.target.name):G(Ra,Xa.error,Xa.data,event.target.name);var eb=Ra,Oa=Xa=null,wb=null;Oa=db(eb,x);Xa=Oa.fields;Oa=Oa.$fields;var lb=eb.getAttribute('id');wb=w.$forms[lb].rules;w.$forms[lb].isValidating=!0;za(eb,Xa,Oa,wb,function(hb){w.$forms[lb].isValidating=!1;console.debug('[updateSelect]: onSilentGlobalLiveValidation: '+hb.isValid(),
hb);hb=hb.isValid();Ka(eb,hb);once=!1})})}};E=na=null;Z=0;for(da=K.length;Z<da;++Z)if(rb(h.rules,K[Z]),ia=K[Z].getAttribute('id'),!ia||!/^gina\-toolbar/.test(ia)){ia&&''!=ia||(ia='select.'+ba.v4(),K[Z].setAttribute('id',ia));if(E=K[Z].getAttribute('data-gina-form-element-group'))na=K[Z].getAttribute('name')||ia,na===ia&&K[Z].setAttribute('name',ia),Ba[ia]={id:ia,name:na,group:E,target:K[Z]};addListener(gina,K[Z],'change',function(ca){ca=ca.target;/select/i.test(ca.type)&&Pa(ca,h)});if(K[Z].options&&
!h.fieldsSet[ia]){na=0;if(E=K[Z].getAttribute('data-value')||null)for(sa=0,fa=K[Z].options.length;sa<fa;++sa)if(K[Z].options[sa].value==E){na=sa;K[Z].selectedIndex=na;break}'undefined'!=typeof K[Z].options[K[Z].selectedIndex]&&K[Z].options[K[Z].selectedIndex].index&&(na=K[Z].options[K[Z].selectedIndex].index);0<K[Z].options.length&&'undefined'!=typeof K[Z].options[na]&&(E=K[Z].options[na].value);h.fieldsSet[ia]={id:ia,name:K[Z].name||null,value:E||null,selectedIndex:na||0};'undefined'!=typeof K[Z].selectedIndex&&
-1<K[Z].selectedIndex&&(K[Z].options[na].selected=!0,K[Z].setAttribute('data-value',K[Z].options[na].value))}}var $a=function(ca,X,ja,va){'undefined'==typeof va&&(va=!1);if('undefined'==typeof Ba[ca])throw Error('Radio & Checkbox dependencies not met: you must use the ID attribue of the `master element` as the `data-gina-form-element-group`');var Ra=ca.replace(/\-|_|@|#|\.|\[|\]/g,'\\$&');ca=Ba[ca].target.checked;for(let Oa in Ba)if(!/radio|checkbox/i.test(Ba[Oa].target.type)){var Xa=new RegExp(Ra);
...
var ja=w.$forms[X.currentTarget.id||X.target.id];ja.target.dataset.ginaFormIsResetting=!0;T(ja);X=db(ja.target,ja.rules,!0);za(ja.target,X.fields,X.$fields,ja.rules,function(va){var Ra=va.isValid();console.debug('silent reset validation result[isValid:'+Ra+']: ',va);G(ja.target,{});Ka(ja.target,Ra);ja.target.dataset.ginaFormIsResetting=!1})});addListener(gina,m,'reset',function(X){var ja=X.target;if('undefined'!=typeof X.defaultPrevented&&X.defaultPrevented)return!1;X.preventDefault();var va=ja.id;
...
x._errors[Ya];if(!mb&&/^true|false$/i.test(w.$forms[sb].isValidating)||''!=Pa[Ya].target.value)u(zb[Ya]),G(ob,x._errors,x._data,Ya),Ka(ob,mb);M&&U&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&(gina.forms.errors||(gina.forms.errors={}),window.ginaToolbar.update('forms',{id:sb,errors:w.$forms[sb].errors||{}}));triggerEvent(gina,ob,'validated.'+sb,x);return}lb=!1;var mb=null;1==ja.length||ja[ja.length-1]==Ya?(mb=0<x._errors.count()?!1:!0,!mb&&/^true|false$/i.test(w.$forms[sb].isValidating)&&
(w.$forms[sb].errors=Q(x._errors,w.$forms[sb].errors),u(zb[Ya]),G(ob,x._errors,x._data,Ya),Ka(ob,mb)),triggerEvent(gina,ob,'validated.'+sb,x)):/^true$/i.test(w.$forms[sb].isValidating)&&1<ja.length&&ja[ja.length-1]!=Ya&&(lb=!0);lb&&za(ob,Cb,zb,cb,function(Kb){w.$forms[sb].isValidating=!1;mb=Kb.isValid();M&&U&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&(gina.forms.errors||(gina.forms.errors={}),window.ginaToolbar.update('forms',{id:sb,errors:Kb.error||{}}));G(ob,Kb.error,Kb.data,Ya);
...
(gina.forms.validated||(gina.forms.validated={}),gina.forms.validated[p]||(gina.forms.validated[p]={}),window.ginaToolbar.update('forms',{id:p,validated:R}))}catch(Ib){throw Ib;}Ba=!0;if(!K&&0>=na)if('undefined'!=typeof Ra&&'function'===typeof Ra)Ra._errors=Pa.getErrors(),Ra._data=Pa.toData(),triggerEvent(gina,Ya,'validated.'+p,Ra);else return K=!0,{isValid:Pa.isValid,error:cb,data:R}}};U&&addListener(gina,m,q,function(Ya){Ya.preventDefault();if(!K){K=!0;Ba=!1;na=0;var cb=Ya.detail,ca=cb._data||Pa.toData(),
...
define('gina/toolbar','require jquery vendor/uuid lib/collection lib/routing gina/storage gina/validator'.split(' '),function(B){var P=B('jquery');P.noConflict();var V=B('lib/routing');B('lib/collection');var ma=B('gina/storage');return function(){var U=null,M=!1,ba=!1,Q=!1,S,r=(new ma({bucket:'gina'})).Collection('plugin'),H=null,w=null,oa=!1,Aa=null,N=null,O=null,A=null,D=null,l='',y=null,z=null,F=null,u='',v=null,G=0,J=0,T=0,ra='',Fa={},W=null,ka=null,ha=null,xa=null,la=null,ua=null,Da=null,Qa=
null,La=null,Ea=null,Na=null,Ia=null,Ja=null,Ua=null,pb=function(){H=P('#gina-toolbar');if(!H.length)return!1;Aa=H.find('.gina-toolbar-tab > a');N=P('#gina-toolbar-toggle');O=P('#gina-toolbar-panels');A=O.find('.gina-toolbar-panel');y=P('#gina-toolbar-vposition');z=P('#gina-toolbar-hposition');F=y.add(z);v=P('#gina-toolbar-width');H.find('.gina-toolbar-main');W=P('#gina-toolbar-json');ka=P('#gina-toolbar-gina-json');ha=P('#gina-toolbar-toggle-code-raw');$forms=P('form:not(.gina-toolbar-options, .gina-toolbar-content)');
La=P('#gina-toolbar-data-html');Ea=P('#gina-toolbar-view-html');Na=P('#gina-toolbar-forms-html');Qa=P('#gina-toolbar-configuration-environment-html');Ia=P('#gina-toolbar-code-toggle');H.prepend('<textarea class="gina-toolbar-copy"></textarea>');Ja=H.find('.gina-toolbar-copy');w=r.findOne({_name:'toolbar'});w||(w={_name:'toolbar',_version:'1.0.3',_description:'Toolbar settings',_licence:'MIT',_author:[{name:'John Doe',company:'Acme'},{name:'Martin-Luther Etouman',company:'Rhinostone'}],
position:'top-right',width:'30',panelId:'#gina-toolbar-data',isCollapsed:!0,isUnfolded:[],debug:{forms:{active:!1,strategy:'frontend'}}},r.insert(w),w=r.findOne({_name:'toolbar'}));'1.0.3'!=w._version&&('1.0.1'>w._version&&(w.isUnfolded||(w.isUnfolded=[]),void 0!=w.codeFolding&&delete w.codeFolding),'undefined'==typeof w.isUnfolded||Array.isArray(w.isUnfolded)||(w.isUnfolded=[]),w._version='1.0.3',w.save(!0));u=w.position;G=w.width;l=w.panelId;oa=w.isCollapsed;H.removeClass('gina-toolbar-hidden');
...
ha.off('click').on('click',function(q){la&&window.open('','JSON RAW','width=400,height=100').document.write(JSON.stringify(la.data))});Aa.off('click').on('click',function(q){q.preventDefault();Aa.removeClass('gina-toolbar-active');A.removeClass('gina-toolbar-active');P(this).addClass('gina-toolbar-active');l=P(this).attr('href');D=P(l).addClass('gina-toolbar-active');w.panelId=l;w.save()});N.off('click').on('click',function(q){q.preventDefault();H.toggleClass('gina-toolbar-collapsed');oa=H.hasClass('gina-toolbar-collapsed');
w.isCollapsed=oa;w.save()});F.off('change').on('change',function(q){q.preventDefault();q=y.val();var p=z.val();u=q+'-'+p;Zb(u);w.position=u;w.save()});v.off('change').on('change',function(q){q.preventDefault();G=v.val();jb(G);w.width=G;w.save()});P(window).off('resize').on('resize',function(){Db()});P('body').off('keypress').on('keypress',function(q){if(!/INPUT|TEXTAREA/.test(q.target.tagName)){ra=q.keyCode?q.keyCode:q.which?q.which:q.charCode;q=new Date;if('undefined'!=typeof Fa.keynum&&Fa.keynum==
ra&&'undefined'!=typeof Fa.pressTime&&500>q.getTime()-Fa.pressTime)switch(ra){case 103:H.toggle()}Fa.pressTime=q.getTime();Fa.keynum=ra}});Aa.filter('[href="'+l+'"]').trigger('click');oa||P('#gina-toolbar-toggle').trigger('click');Zb(u);var x=u.split('-');y.val(x[0]);z.val(x[1]);jb(G);v.val(G);Db();x=W?W.text():'';/^\{\{ (.*) \}\}/.test(x)?h(x,ab):ab()},Zb=function(x){H.removeClass('gina-toolbar-top-left gina-toolbar-top-right gina-toolbar-bottom-left gina-toolbar-bottom-right').addClass('gina-toolbar-'+
x)},jb=function(x){H.removeClass('gina-toolbar-auto gina-toolbar-100 gina-toolbar-80 gina-toolbar-60 gina-toolbar-50 gina-toolbar-40 gina-toolbar-30').addClass('gina-toolbar-'+x)},Db=function(){J=window.innerHeight-32;H.find('.gina-toolbar-main').css('max-height',J+'px');var x=D.find('.gina-toolbar-main'),q=x.find('.gina-toolbar-content');T=x.height();T==J?q.addClass('gina-toolbar-content-end'):q.removeClass('gina-toolbar-content-end')},rb=function(x,q,p){'undefined'==typeof p&&(p=!1);if(void 0!=
...
sa+':</span><span class="gina-toolbar-value">'+ia+'</span></li>'),/^data-gina-form-event/.test(sa)?(da='events',Z=na.find('.gina-toolbar-form-attributes').find('.gina-toolbar-key-events').length?!0:!1,sa=sa.replace(/^data-gina-form-event-/,''),Z||na.find('ul.gina-toolbar-section-content').append('<li class="gina-toolbar-form-'+da+'"><h3 class="gina-toolbar-sub-section-title">'+da+'</h3><ul class="gina-toolbar-code"></ul></li>'),Z='<li><span class="gina-toolbar-key">'+sa+':</span><span class="gina-toolbar-value">'+
ia+'</span></li>',na.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-'+da+' > ul').append(Z)):(/^action$/.test(sa)||(Z='<li><span class="gina-toolbar-key">'+sa+':</span><span class="gina-toolbar-value">'+ia+'</span></li>'),na.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-attributes > ul').append(Z));ea=null;try{var $a=K[R].getAttribute('data-gina-form-rule');ea='undefined'!=typeof $a&&null!=$a?eval('gina.forms.rules.'+$a.replace(/-/g,'.')):eval('gina.forms.rules.'+
E.replace(/-/g,'.'))}catch(ib){}ea&&(da='rules',na.find('ul.gina-toolbar-section-content').append('<li class="gina-toolbar-form-'+da+'"><h3 class="gina-toolbar-sub-section-title">'+da+'</h3><ul class="gina-toolbar-properties">'+db(ea,ea,E,Ba,da)+'</ul></li>'));p.append(na);++R;R<fa&&za(x,q,p,R,K,fa,Ba)},m=function(x,q,p,R){var K=P('#gina-toolbar-form-'+x);$section=K.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-'+q+'> ul');if(0<$section.length){if(0==p.count())return K.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-'+
...
define('gina','require vendor/uuid lib/merge utils/events helpers/prototypes helpers/dateFormat gina/toolbar'.split(' '),function(B){B('utils/events');var P=B('lib/merge'),V=B('helpers/dateFormat')();B('helpers/prototypes')({dateFormat:V});var ma=B('vendor/uuid');window.process||function(U,M,ba,Q,S,r,H){for(r=U[ba]||(U[ba]={});!H&&S<Q.length;)H=U[Q[S++]+'requestAnimationFrame'];r[M]=r[M]||H&&H.bind(U)||U.setImmediate||U.setTimeout}(window,'nextTick','process',['r','webkitR','mozR','msR','oR'],0);
window.getComputedStyle||(window.getComputedStyle=function(U,M){this.el=U;this.getPropertyValue=function(ba){var Q=/(\-([a-z]){1})/g;'float'==ba&&(ba='styleFloat');Q.test(ba)&&(ba=ba.replace(Q,function(S,r,H){return H.toUpperCase()}));return U.currentStyle[ba]?U.currentStyle[ba]:null};return this});return function(U){this.plugin='gina';var M='gina-'+ma.v1(),ba=document,Q;document.id=M;M={id:M,isFrameworkLoaded:!1,hasValidator:!1,hasPopinHandler:!1,config:{},session:null,registeredEvents:{},events:{},
...
typeof Reflect||!Reflect.construct||Reflect.construct.sham)return!1;if('function'==typeof Proxy)return!0;try{return Date.prototype.toString.call(Reflect.construct(Date,[],function(){})),!0}catch(ya){return!1}}function r(ya,za,m){return r=S()?Reflect.construct:function(g,h,b){var x=[null];x.push.apply(x,h);g=new (Function.bind.apply(g,x));return b&&Q(g,b.prototype),g},r.apply(null,arguments)}function H(ya){var za='function'==typeof Map?new Map:void 0;return H=function(m){function g(){return r(m,arguments,
ba(this).constructor)}if(null===m||(h=m,-1===Function.toString.call(h).indexOf('[native code]')))return m;var h;if('function'!=typeof m)throw new TypeError('Super expression must either be null or a function');if(void 0!==za){if(za.has(m))return za.get(m);za.set(m,g)}return g.prototype=Object.create(m.prototype,{constructor:{value:g,enumerable:!1,writable:!0,configurable:!0}}),Q(g,m)},H(ya)}function w(ya){if(void 0===ya)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
return ya}function oa(ya){var za=S();return function(){var m=ba(ya);if(za){var g=ba(this).constructor;m=Reflect.construct(m,arguments,g)}else m=m.apply(this,arguments);return!m||'object'!=typeof m&&'function'!=typeof m?w(this):m}}function Aa(ya,za,m){return Aa='undefined'!=typeof Reflect&&Reflect.get?Reflect.get:function(g,h,b){for(;!Object.prototype.hasOwnProperty.call(g,h)&&null!==(g=ba(g)););if(g)return h=Object.getOwnPropertyDescriptor(g,h),h.get?h.get.call(b):h.value},Aa(ya,za,m||ya)}function N(ya){if(ya){for(var za in N.prototype)ya[za]=
...
N.prototype.emitReserved=N.prototype.emit;N.prototype.listeners=function(ya){return this._callbacks=this._callbacks||{},this._callbacks['$'+ya]||[]};N.prototype.hasListeners=function(ya){return!!this.listeners(ya).length};var Ea='undefined'!=typeof self?self:'undefined'!=typeof window?window:Function('return this')(),Na=setTimeout,Ia=clearTimeout,Ja,Ua=function(ya){function za(g,h,b){var x;return P(this,za),(x=m.call(this,g)).description=h,x.context=b,x.type='TransportError',x}M(za,ya);var m=oa(za);
return za}(H(Error));la=function(ya){function za(g){var h;return P(this,za),(h=m.call(this)).writable=!1,A(w(h),g),h.opts=g,h.query=g.query,h.readyState='',h.socket=g.socket,h}M(za,ya);var m=oa(za);return ma(za,[{key:'onError',value:function(g,h,b){return Aa(ba(za.prototype),'emitReserved',this).call(this,'error',new Ua(g,h,b)),this}},{key:'open',value:function(){return'closed'!==this.readyState&&''!==this.readyState||(this.readyState='opening',this.doOpen()),this}},{key:'close',value:function(){return'opening'!==
...
za}(la);var jb=function(ya){function za(g,h){var b;return P(this,za),A(w(b=m.call(this)),h),b.opts=h,b.method=h.method||'GET',b.uri=g,b.async=!1!==h.async,b.data=void 0!==h.data?h.data:null,b.create(),b}M(za,ya);var m=oa(za);return ma(za,[{key:'create',value:function(){var g=this,h=O(this.opts,'agent','pfx','key','passphrase','cert','ca','ciphers','rejectUnauthorized','autoUnref');h.xdomain=!!this.opts.xd;h.xscheme=!!this.opts.xs;var b=this.xhr=new F(h);try{b.open(this.method,this.uri,this.async);
...
Ea?'pagehide':'unload',v,!1);var Db='function'==typeof Promise&&'function'==typeof Promise.resolve?function(ya){return Promise.resolve().then(ya)}:function(ya,za){return za(ya,0)},rb=Ea.WebSocket||Ea.MozWebSocket,xb='undefined'!=typeof navigator&&'string'==typeof navigator.product&&'reactnative'===navigator.product.toLowerCase(),Ka={websocket:function(ya){function za(g){var h;return P(this,za),(h=m.call(this,g)).supportsBinary=!g.forceBase64,h}M(za,ya);var m=oa(za);return ma(za,[{key:'doOpen',value:function(){if(this.check()){var g=
...
!1))),h.open(),h}M(za,ya);var m=oa(za);return ma(za,[{key:'createTransport',value:function(g){var h=U({},this.opts.query);h.EIO=4;h.transport=g;this.id&&(h.sid=this.id);h=U({},this.opts.transportOptions[g],this.opts,{query:h,socket:this,hostname:this.hostname,secure:this.secure,port:this.port});return new Ka[g](h)}},{key:'open',value:function(){var g=this;if(this.opts.rememberUpgrade&&za.priorWebsocketSuccess&&-1!==this.transports.indexOf('websocket'))var h='websocket';else{if(0===this.transports.length)return void this.setTimeoutFn(function(){g.emitReserved('error',
...
(l=!0)}catch(z){}}else l=fs.existsSync(Aa.filename);l&&(clearInterval(nIntervId),ba=fs.readFileSync(Aa.filename).toString(),N(!1))},200)}try{ba=fs.readFileSync(Aa.filename).toString(),N&&N(!1)}catch(y){console.warn('[DOMAIN] could not read from `'+Aa.filename+'`'),r(B,N)}}},H=function(Aa){M.isUpdating=!0;r(M,Aa)},w=async function(Aa){Aa='undefined'!=typeof Aa&&''!=Aa?Aa:os.hostname();if(/\./.test(Aa))return Aa;console.debug('[DOMAIN][getFQDN] UQDN: '+Aa);var N=null,O=null;N=await promisify(dns.lookup)(Aa,
...
return Aa},oa={getRootDomain:function(Aa,N){'undefined'==typeof N&&(N=!1);var O=!1,A=!1,D=Aa.replace(/^(.*):\/\/|\/(.*)/g,''),l=D.split(/\./g).reverse(),y=l.length?l.length-1:0,z=ba.replace(/\/\/\s*(.*)\n|^\s*\n/gm,'').split(/\n/).filter(function(F,u,v){/[^a-z 0-9.]+/.test(F)&&(F=F.replace(/[^a-z 0-9.]+/g,'').replace(/^\./g,''));return/\./.test(F)&&!O&&(new RegExp('.'+F+'$')).test(D)?(O=!0,y=F.split(/\./g).length,v.splice(0,v.length),!1):F});D=l[y];0<y&&(l=l.splice(0,y),A=l[0],/:(.*)$/.test(A)&&(A=
A.replace(/:(.*)$/,'')),(A=O||!O&&-1<z.indexOf(A)?!0:!1)?1<y&&!O?(l.splice(2),D=l.reverse().join('.')):D+='.'+l.reverse().join('.'):1<y?(l.splice(2),D=l.reverse().join('.')):D+='.'+l.reverse().join('.'));/:(.*)$/.test(D)&&(D=D.replace(/:(.*)$/,''));console.debug('[DOMAIN] isSLD: '+O,Aa,' -> ',D);/^true$/i.test(N);return{value:D,isSLD:O,isRegisteredTldOrSld:A}}};V?oa.onReady=S:(oa.updatePSL=H,oa.getFQDN=w);return V&&ma&&!window.fetch?(ma=document.createElement('script'),ma.type='text/javascript',ma.src=
...
typeof l&&(l=r.target);var z,F=null;l=l.getElementsByTagName('a');for(var u=0,v=l.length;u<v;++u)if(((z=l[u].getAttribute('data-gina-link'))||''==z)&&!/^false$/i.test(z)){z=l[u];var G={type:'a',method:'GET'};var J=z.getAttribute('data-gina-link-url');G.url='undefined'!=typeof J&&null!=J?J:z.getAttribute('href');J=z.getAttribute('id');if('undefined'==typeof J||null==J||''==J||/popin\.link/.test(J))J='link.click.gina-link-'+r.id+'-'+P.v4();z.id=J;evt=G.id=J;z.setAttribute('id',evt);'A'==z.tagName&&
(F=z.getAttribute('onclick'));F?'undefined'==typeof F||/return false/.test(F)||(F=/;$/.test(F)?F+'return false;':F+'; return false;',z.setAttribute('onclick',F)):z.setAttribute('onclick','return false;');'undefined'==typeof r.$links[G.id]&&(G.target=z,z=U(G,H),Q(z,y))}};new V(function(l,y){if(l)throw l;ma=y});return function(l){r.bindLinks=D;r.request=ba;r.getLinkById=O;r.getLinkByUrl=A;r.on('init',function(y){if(window.XMLHttpRequest)w=new XMLHttpRequest;else if(window.ActiveXObject)try{w=new ActiveXObject('Msxml2.XMLHTTP')}catch(z){try{w=
...
La);Da<Qa;++Da){if('undefined'==typeof xa[Da].src||''==xa[Da].src)continue;let Ea=xa[Da].src.replace(/(https|http|):\/\//,'').replace(La,'');-1<ha.indexOf(Ea)||w(xa[Da].src)}Da=0;for(Qa=ua.length;Da<Qa;++Da)'undefined'!=typeof ua[Da].href&&''!=ua[Da].href&&(ha=ua[Da].href.replace(/(https|http|):\/\//,'').replace(La,''),-1<la.indexOf(ha)||oa(ua[Da].href));Q({target:W,type:'loaded.'+ka.id},ka);/gina-popin-is-active/.test(W.className)||(W.className+=' gina-popin-is-active');if(!D.options.useDialogMode||
...
'function'!==typeof Object.assign&&Object.defineProperty(Object,'assign',{value:function(B,P){if(null===B||void 0===B)throw new TypeError('Cannot convert undefined or null to object');for(var V=Object(B),ma=1;ma<arguments.length;ma++){var U=arguments[ma];if(null!==U&&void 0!==U)for(var M in U)Object.prototype.hasOwnProperty.call(U,M)&&(V[M]=U[M])}return V},writable:!0,configurable:!0});
...
function Inherits(B,P){return function(V,ma){var U='undefined'==typeof V||'undefined'==typeof ma?"inherits(a, b): neither [ a ] nor [ b ] can't be undefined or null":!1;if(U)throw Error(U);U=function(){return function(){if(this){this.prototype=V.prototype;this.name||(this.name=V.name);this.prototype.name=this.name;for(var M in ma.prototype)this[M]||(this[M]=ma.prototype[M]);ma.apply(this,arguments);V.apply(this,arguments)}}}(V,ma);void 0==V.prototype&&(V.prototype={});void 0==ma.prototype&&(ma.prototype=
