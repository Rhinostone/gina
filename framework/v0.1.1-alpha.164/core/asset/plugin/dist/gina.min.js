...
(function(E,O){function ha(Fa,Na){return Na||''}function Ca(Fa){return'[object Function]'===T.call(Fa)}function K(Fa){return'[object Array]'===T.call(Fa)}function U(Fa,Na){if(Fa){var Wa;for(Wa=0;Wa<Fa.length&&(!Fa[Wa]||!Na(Fa[Wa],Wa,Fa));Wa+=1);}}function oa(Fa,Na){if(Fa){var Wa;for(Wa=Fa.length-1;-1<Wa&&(!Fa[Wa]||!Na(Fa[Wa],Wa,Fa));--Wa);}}function X(Fa,Na){return ca.call(Fa,Na)}function V(Fa,Na){return X(Fa,Na)&&Fa[Na]}function m(Fa,Na){for(var Wa in Fa)if(X(Fa,Wa)&&Na(Fa[Wa],Wa))break}function S(Fa,
Na,Wa,rb){Na&&m(Na,function(bb,fb){if(Wa||!X(Fa,fb))!rb||'object'!==typeof bb||!bb||K(bb)||Ca(bb)||bb instanceof RegExp?Fa[fb]=bb:(Fa[fb]||(Fa[fb]={}),S(Fa[fb],bb,Wa,rb))});return Fa}function p(Fa,Na){return function(){return Na.apply(Fa,arguments)}}function da(Fa){throw Fa;}function za(Fa){if(!Fa)return Fa;var Na=E;U(Fa.split('.'),function(Wa){Na=Na[Wa]});return Na}function N(Fa,Na,Wa,rb){Na=Error(Na+'\nhttps://requirejs.org/docs/errors.html#'+Fa);Na.requireType=Fa;Na.requireModules=rb;Wa&&(Na.originalError=
Wa);return Na}function L(){if(z&&'interactive'===z.readyState)return z;oa(document.getElementsByTagName('script'),function(Fa){if('interactive'===Fa.readyState)return z=Fa});return z}var C,B,u,z,y,J,q,v=/\/\*[\s\S]*?\*\/|([^:"'=]|^)\/\/.*$/mg,F=/[^.]\s*require\s*\(\s*["']([^'"\s]+)["']\s*\)/g,H=/\.js$/,R=/^\.\//;var sa=Object.prototype;var T=sa.toString,ca=sa.hasOwnProperty,ea=!('undefined'===typeof window||'undefined'===typeof navigator||!window.document),Ja=!ea&&'undefined'!==typeof importScripts,
fa=ea&&'PLAYSTATION 3'===navigator.platform?/^complete$/:/^(complete|loaded)$/,pa='undefined'!==typeof opera&&'[object Opera]'===opera.toString(),Ea={},Ka={},Oa=[],Ia=!1;if('undefined'===typeof define){if('undefined'!==typeof requirejs){if(Ca(requirejs))return;Ka=requirejs;requirejs=void 0}'undefined'===typeof require||Ca(require)||(Ka=require,require=void 0);var Da=requirejs=function(Fa,Na,Wa,rb){var bb='_';if(!K(Fa)&&'string'!==typeof Fa){var fb=Fa;K(Na)?(Fa=Na,Na=Wa,Wa=rb):Fa=[]}fb&&fb.context&&
(bb=fb.context);(rb=V(Ea,bb))||(rb=Ea[bb]=Da.s.newContext(bb));fb&&rb.configure(fb);return rb.require(Fa,Na,Wa)};Da.config=function(Fa){return Da(Fa)};Da.nextTick='undefined'!==typeof O?function(Fa){O(Fa,4)}:function(Fa){Fa()};require||=Da;Da.version='2.3.6';Da.jsExtRegExp=/^\/|:|\?|\.js$/;Da.isBrowser=ea;sa=Da.s={contexts:Ea,newContext:function(Fa){function Na(w,ja,ua){var na;ja=ja&&ja.split('/');var la=Ha.map,Ba=la&&la['*'];if(w){w=w.split('/');var ya=w.length-1;Ha.nodeIdCompat&&H.test(w[ya])&&
(w[ya]=w[ya].replace(H,''));'.'===w[0].charAt(0)&&ja&&(ya=ja.slice(0,ja.length-1),w=ya.concat(w));ya=w;for(na=0;na<ya.length;na++){var Ya=ya[na];'.'===Ya?(ya.splice(na,1),--na):'..'===Ya&&0!==na&&(1!==na||'..'!==ya[2])&&'..'!==ya[na-1]&&0<na&&(ya.splice(na-1,2),na-=2)}w=w.join('/')}if(ua&&la&&(ja||Ba)){ya=w.split('/');na=ya.length;a:for(;0<na;--na){var Ta=ya.slice(0,na).join('/');if(ja)for(Ya=ja.length;0<Ya;--Ya)if(ua=V(la,ja.slice(0,Ya).join('/')))if(ua=V(ua,Ta)){var tb=ua;var Ab=na;break a}if(!Ib&&
Ba&&V(Ba,Ta)){var Ib=V(Ba,Ta);var eb=na}}!tb&&Ib&&(tb=Ib,Ab=eb);tb&&(ya.splice(0,Ab,tb),w=ya.join('/'))}return(tb=V(Ha.pkgs,w))?tb:w}function Wa(w){ea&&U(document.getElementsByTagName('script'),function(ja){if(ja.getAttribute('data-requiremodule')===w&&ja.getAttribute('data-requirecontext')===Q.contextName)return ja.parentNode.removeChild(ja),!0})}function rb(w){var ja=V(Ha.paths,w);if(ja&&K(ja)&&1<ja.length)return ja.shift(),Q.require.undef(w),Q.makeRequire(null,{skipMap:!0})([w]),!0}function bb(w){var ja=
w?w.indexOf('!'):-1;if(-1<ja){var ua=w.substring(0,ja);w=w.substring(ja+1,w.length)}return[ua,w]}function fb(w,ja,ua,na){var la=null,Ba=ja?ja.name:null,ya=w,Ya=!0,Ta='';w||(Ya=!1,w='_@r'+(A+=1));w=bb(w);la=w[0];w=w[1];if(la){la=Na(la,Ba,na);var tb=V(n,la)}if(w)if(la)Ta=ua?w:tb&&tb.normalize?tb.normalize(w,function(Ib){return Na(Ib,Ba,na)}):-1===w.indexOf('!')?Na(w,Ba,na):w;else{Ta=Na(w,Ba,na);w=bb(Ta);la=w[0];Ta=w[1];ua=!0;var Ab=Q.nameToUrl(Ta)}ua=!la||tb||ua?'':'_unnormalized'+(W+=1);return{prefix:la,
name:Ta,parentMap:ja,unnormalized:!!ua,url:Ab,originalName:ya,isDefine:Ya,id:(la?la+'!'+Ta:Ta)+ua}}function gc(w){var ja=w.id,ua=V(M,ja);ua||=M[ja]=new Q.Module(w);return ua}function yb(w,ja,ua){var na=w.id,la=V(M,na);if(!X(n,na)||la&&!la.defineEmitComplete)if(la=gc(w),la.error&&'error'===ja)ua(la.error);else la.on(ja,ua);else'defined'===ja&&ua(n[na])}function ib(w,ja){var ua=w.requireModules,na=!1;if(ja)ja(w);else if(U(ua,function(la){if(la=V(M,la))la.error=w,la.events.error&&(na=!0,la.emit('error',
w))}),!na)Da.onError(w)}function Gb(){Oa.length&&(U(Oa,function(w){var ja=w[0];'string'===typeof ja&&(Q.defQueueMap[ja]=!0);h.push(w)}),Oa=[])}function Ob(w){delete M[w];delete e[w]}function jb(w,ja,ua){var na=w.map.id;w.error?w.emit('error',w.error):(ja[na]=!0,U(w.depMaps,function(la,Ba){la=la.id;var ya=V(M,la);!ya||w.depMatched[Ba]||ua[la]||(V(ja,la)?(w.defineDep(Ba,n[la]),w.check()):jb(ya,ja,ua))}),ua[na]=!0)}function Ma(){var w,ja,ua=(w=1E3*Ha.waitSeconds)&&Q.startTime+w<(new Date).getTime(),
na=[],la=[],Ba=!1,ya=!0;if(!wa){wa=!0;m(e,function(Ya){var Ta=Ya.map,tb=Ta.id;if(Ya.enabled&&(Ta.isDefine||la.push(Ya),!Ya.error))if(!Ya.inited&&ua)rb(tb)?Ba=ja=!0:(na.push(tb),Wa(tb));else if(!Ya.inited&&Ya.fetched&&Ta.isDefine&&(Ba=!0,!Ta.prefix))return ya=!1});if(ua&&na.length)return w=N('timeout','Load timeout for modules: '+na,null,na),w.contextName=Q.contextName,ib(w);ya&&U(la,function(Ya){jb(Ya,{},{})});ua&&!ja||!Ba||!ea&&!Ja||xa||(xa=O(function(){xa=0;Ma()},50));wa=!1}}function nb(w){X(n,
w[0])||gc(fb(w[0],null,!0)).init(w[1],w[2])}function Pb(w){w=w.currentTarget||w.srcElement;var ja=Q.onScriptLoad;w.detachEvent&&!pa?w.detachEvent('onreadystatechange',ja):w.removeEventListener('load',ja,!1);ja=Q.onScriptError;w.detachEvent&&!pa||w.removeEventListener('error',ja,!1);return{node:w,id:w&&w.getAttribute('data-requiremodule')}}function Yb(){for(Gb();h.length;){var w=h.shift();if(null===w[0])return ib(N('mismatch','Mismatched anonymous define() module: '+w[w.length-1]));nb(w)}Q.defQueueMap=
...
this.map.id;var ja=this.depExports;var ua=this.exports,na=this.factory;if(!this.inited)X(Q.defQueueMap,w)||this.fetch();else if(this.error)this.emit('error',this.error);else if(!this.defining){this.defining=!0;if(1>this.depCount&&!this.defined){if(Ca(na)){if(this.events.error&&this.map.isDefine||Da.onError!==da)try{ua=Q.execCb(w,na,ja,ua)}catch(ya){var la=ya}else ua=Q.execCb(w,na,ja,ua);this.map.isDefine&&void 0===ua&&((ja=this.module)?ua=ja.exports:this.usingExports&&(ua=this.exports));if(la)return la.requireMap=
this.map,la.requireModules=this.map.isDefine?[this.map.id]:null,la.requireType=this.map.isDefine?'define':'require',ib(this.error=la)}else ua=na;this.exports=ua;if(this.map.isDefine&&!this.ignore&&(n[w]=ua,Da.onResourceLoad)){var Ba=[];U(this.depMaps,function(ya){Ba.push(ya.normalizedMap||ya)});Da.onResourceLoad(Q,this.map,Ba)}Ob(w);this.defined=!0}this.defining=!1;this.defined&&!this.defineEmitted&&(this.defineEmitted=!0,this.emit('defined',this.exports),this.defineEmitComplete=!0)}}},callPlugin:function(){var w=
this.map,ja=w.id,ua=fb(w.prefix);this.depMaps.push(ua);yb(ua,'defined',p(this,function(na){var la=V(r,this.map.id),Ba=this.map.name,ya=this.map.parentMap?this.map.parentMap.name:null,Ya=Q.makeRequire(w.parentMap,{enableBuildCallback:!0});if(this.map.unnormalized){na.normalize&&(Ba=na.normalize(Ba,function(Ab){return Na(Ab,ya,!0)})||'');var Ta=fb(w.prefix+'!'+Ba,this.map.parentMap,!0);yb(Ta,'defined',p(this,function(Ab){this.map.normalizedMap=Ta;this.init([],function(){return Ab},null,{enabled:!0,
ignore:!0})}));if(na=V(M,Ta.id)){this.depMaps.push(Ta);if(this.events.error)na.on('error',p(this,function(Ab){this.emit('error',Ab)}));na.enable()}}else if(la)this.map.url=Q.nameToUrl(la),this.load();else{var tb=p(this,function(Ab){this.init([],function(){return Ab},null,{enabled:!0})});tb.error=p(this,function(Ab){this.inited=!0;this.error=Ab;Ab.requireModules=[ja];m(M,function(Ib){0===Ib.map.id.indexOf(ja+'_unnormalized')&&Ob(Ib.map.id)});ib(Ab)});tb.fromText=p(this,function(Ab,Ib){var eb=w.name,
Bb=fb(eb),Vb=Ia;Ib&&(Ab=Ib);Vb&&(Ia=!1);gc(Bb);X(Ha.config,ja)&&(Ha.config[eb]=Ha.config[ja]);try{Da.exec(Ab)}catch(Xa){return ib(N('fromtexteval','fromText eval for '+ja+' failed: '+Xa,Xa,[ja]))}Vb&&(Ia=!0);this.depMaps.push(Bb);Q.completeLoad(eb);Ya([eb],tb)});na.load(w.name,Ya,tb,Ha)}}));Q.enable(ua,this);this.pluginMaps[ua.id]=ua},enable:function(){e[this.map.id]=this;this.enabling=this.enabled=!0;U(this.depMaps,p(this,function(w,ja){var ua;if('string'===typeof w){w=fb(w,this.map.isDefine?this.map:
this.map.parentMap,!1,!this.skipMap);this.depMaps[ja]=w;if(ua=V(P,w.id)){this.depExports[ja]=ua(this);return}this.depCount+=1;yb(w,'defined',p(this,function(la){this.undefed||(this.defineDep(ja,la),this.check())}));this.errback?yb(w,'error',p(this,this.errback)):this.events.error&&yb(w,'error',p(this,function(la){this.emit('error',la)}))}ua=w.id;var na=M[ua];X(P,ua)||!na||na.enabled||Q.enable(w,this)}));m(this.pluginMaps,p(this,function(w){var ja=V(M,w.id);ja&&!ja.enabled&&Q.enable(w,this)}));this.enabling=
!1;this.check()},on:function(w,ja){var ua=this.events[w];ua||=this.events[w]=[];ua.push(ja)},emit:function(w,ja){U(this.events[w],function(ua){ua(ja)});'error'===w&&delete this.events[w]}};var Q={config:Ha,contextName:Fa,registry:M,defined:n,urlFetched:x,defQueue:h,defQueueMap:{},Module:aa,makeModuleMap:fb,nextTick:Da.nextTick,onError:ib,configure:function(w){w.baseUrl&&'/'!==w.baseUrl.charAt(w.baseUrl.length-1)&&(w.baseUrl+='/');if('string'===typeof w.urlArgs){var ja=w.urlArgs;w.urlArgs=function(la,
Ba){return(-1===Ba.indexOf('?')?'?':'&')+ja}}var ua=Ha.shim,na={paths:!0,bundles:!0,config:!0,map:!0};m(w,function(la,Ba){na[Ba]?(Ha[Ba]||(Ha[Ba]={}),S(Ha[Ba],la,!0,!0)):Ha[Ba]=la});w.bundles&&m(w.bundles,function(la,Ba){U(la,function(ya){ya!==Ba&&(r[ya]=Ba)})});w.shim&&(m(w.shim,function(la,Ba){K(la)&&(la={deps:la});!la.exports&&!la.init||la.exportsFn||(la.exportsFn=Q.makeShimExports(la));ua[Ba]=la}),Ha.shim=ua);w.packages&&U(w.packages,function(la){la='string'===typeof la?{name:la}:la;var Ba=la.name;
la.location&&(Ha.paths[Ba]=la.location);Ha.pkgs[Ba]=la.name+'/'+(la.main||'main').replace(R,'').replace(H,'')});m(M,function(la,Ba){la.inited||la.map.unnormalized||(la.map=fb(Ba,null,!0))});(w.deps||w.callback)&&Q.require(w.deps||[],w.callback)},makeShimExports:function(w){return function(){var ja;w.init&&(ja=w.init.apply(E,arguments));return ja||w.exports&&za(w.exports)}},makeRequire:function(w,ja){function ua(na,la,Ba){var ya;ja.enableBuildCallback&&la&&Ca(la)&&(la.__requireJsBuild=!0);if('string'===
typeof na){if(Ca(la))return ib(N('requireargs','Invalid require call'),Ba);if(w&&X(P,na))return P[na](M[w.id]);if(Da.get)return Da.get(Q,na,w,ua);var Ya=fb(na,w,!1,!0);Ya=Ya.id;return X(n,Ya)?n[Ya]:ib(N('notloaded','Module name "'+Ya+'" has not been loaded yet for context: '+Fa+(w?'':'. Use require([])')))}Yb();Q.nextTick(function(){Yb();ya=gc(fb(null,w));ya.skipMap=ja.skipMap;ya.init(na,la,Ba,{enabled:!0});Ma()});return ua}ja=ja||{};S(ua,{isBrowser:ea,toUrl:function(na){var la=na.lastIndexOf('.'),
Ba=na.split('/')[0];if(-1!==la&&('.'!==Ba&&'..'!==Ba||1<la)){var ya=na.substring(la,na.length);na=na.substring(0,la)}return Q.nameToUrl(Na(na,w&&w.id,!0),ya,!0)},defined:function(na){return X(n,fb(na,w,!1,!0).id)},specified:function(na){na=fb(na,w,!1,!0).id;return X(n,na)||X(M,na)}});w||(ua.undef=function(na){Gb();var la=fb(na,w,!0),Ba=V(M,na);Ba.undefed=!0;Wa(na);delete n[na];delete x[la.url];delete b[na];oa(h,function(ya,Ya){ya[0]===na&&h.splice(Ya,1)});delete Q.defQueueMap[na];Ba&&(Ba.events.defined&&
(b[na]=Ba.events),Ob(na))});return ua},enable:function(w){V(M,w.id)&&gc(w).enable()},completeLoad:function(w){var ja=V(Ha.shim,w)||{},ua=ja.exports;for(Gb();h.length;){var na=h.shift();if(null===na[0]){na[0]=w;if(la)break;var la=!0}else na[0]===w&&(la=!0);nb(na)}Q.defQueueMap={};na=V(M,w);if(!la&&!X(n,w)&&na&&!na.inited)if(!Ha.enforceDefine||ua&&za(ua))nb([w,ja.deps||[],ja.exportsFn]);else return rb(w)?void 0:ib(N('nodefine','No define call for '+w,null,[w]));Ma()},nameToUrl:function(w,ja,ua){var na,
la;(na=V(Ha.pkgs,w))&&(w=na);if(na=V(r,w))return Q.nameToUrl(na,ja,ua);if(Da.jsExtRegExp.test(w))na=w+(ja||'');else{na=Ha.paths;var Ba=w.split('/');for(la=Ba.length;0<la;--la){var ya=Ba.slice(0,la).join('/');if(ya=V(na,ya)){K(ya)&&(ya=ya[0]);Ba.splice(0,la,ya);break}}na=Ba.join('/');na+=ja||(/^data:|^blob:|\?/.test(na)||ua?'':'.js');na=('/'===na.charAt(0)||na.match(/^[\w\+\.\-]+:/)?'':Ha.baseUrl)+na}return Ha.urlArgs&&!/^blob:/.test(na)?na+Ha.urlArgs(w,na):na},load:function(w,ja){Da.load(Q,w,ja)},
execCb:function(w,ja,ua,na){return ja.apply(na,ua)},onScriptLoad:function(w){if('load'===w.type||fa.test((w.currentTarget||w.srcElement).readyState))z=null,w=Pb(w),Q.completeLoad(w.id)},onScriptError:function(w){var ja=Pb(w);if(!rb(ja.id)){var ua=[];m(M,function(na,la){0!==la.indexOf('_@r')&&U(na.depMaps,function(Ba){if(Ba.id===ja.id)return ua.push(la),!0})});return ib(N('scripterror','Script error for "'+ja.id+(ua.length?'", needed by: '+ua.join(', '):'"'),w,[ja.id]))}}};Q.require=Q.makeRequire();
return Q}};Da({});U(['toUrl','undef','defined','specified'],function(Fa){Da[Fa]=function(){var Na=Ea._;return Na.require[Fa].apply(Na,arguments)}});if(ea){var cb=sa.head=document.getElementsByTagName('head')[0];if(C=document.getElementsByTagName('base')[0])cb=sa.head=C.parentNode}Da.onError=da;Da.createNode=function(Fa,Na,Wa){Na=Fa.xhtml?document.createElementNS('http://www.w3.org/1999/xhtml','html:script'):document.createElement('script');Na.type=Fa.scriptType||'text/javascript';Na.charset='utf-8';
Na.async=!0;return Na};Da.load=function(Fa,Na,Wa){var rb=Fa&&Fa.config||{};if(ea){var bb=Da.createNode(rb,Na,Wa);bb.setAttribute('data-requirecontext',Fa.contextName);bb.setAttribute('data-requiremodule',Na);!bb.attachEvent||bb.attachEvent.toString&&0>bb.attachEvent.toString().indexOf('[native code')||pa?(bb.addEventListener('load',Fa.onScriptLoad,!1),bb.addEventListener('error',Fa.onScriptError,!1)):(Ia=!0,bb.attachEvent('onreadystatechange',Fa.onScriptLoad));bb.src=Wa;if(rb.onNodeCreated)rb.onNodeCreated(bb,
rb,Na,Wa);y=bb;C?cb.insertBefore(bb,C):cb.appendChild(bb);y=null;return bb}if(Ja)try{O(function(){},0),importScripts(Wa),Fa.completeLoad(Na)}catch(fb){Fa.onError(N('importscripts','importScripts failed for '+Na+' at '+Wa,fb,[Na]))}};ea&&!Ka.skipDataMain&&oa(document.getElementsByTagName('script'),function(Fa){cb||(cb=Fa.parentNode);if(B=Fa.getAttribute('data-main'))return J=B,Ka.baseUrl||-1!==J.indexOf('!')||(u=J.split('/'),J=u.pop(),q=u.length?u.join('/')+'/':'./',Ka.baseUrl=q),J=J.replace(H,''),
Da.jsExtRegExp.test(J)&&(J=B),Ka.deps=Ka.deps?Ka.deps.concat(J):[J],!0});define=function(Fa,Na,Wa){var rb;'string'!==typeof Fa&&(Wa=Na,Na=Fa,Fa=null);K(Na)||(Wa=Na,Na=null);!Na&&Ca(Wa)&&(Na=[],Wa.length&&(Wa.toString().replace(v,ha).replace(F,function(fb,gc){Na.push(gc)}),Na=(1===Wa.length?['require']:['require','exports','module']).concat(Na)));if(Ia&&(rb=y||L())){Fa||=rb.getAttribute('data-requiremodule');var bb=Ea[rb.getAttribute('data-requirecontext')]}bb?(bb.defQueue.push([Fa,Na,Wa]),bb.defQueueMap[Fa]=
!0):Oa.push([Fa,Na,Wa])};define.amd={jQuery:!0};Da.exec=function(Fa){return eval(Fa)};Da(Ka)}})(this,'undefined'===typeof setTimeout?void 0:setTimeout);define('requireLib',function(){});
!function(E,O){'object'==typeof exports&&'undefined'!=typeof module?O(exports):'function'==typeof define&&define.amd?define('vendor/uuid',['exports'],O):O((E=E||self).uuid={})}(this,function(E){function O(){if(!m)throw Error('crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported');return m(S)}function ha(u,z){z=z||0;var y=za;return[y[u[z++]],y[u[z++]],y[u[z++]],y[u[z++]],'-',y[u[z++]],y[u[z++]],'-',y[u[z++]],y[u[z++]],'-',y[u[z++]],y[u[z++]],'-',
...
q=y(v.concat(q));if(q[6]=15&q[6]|z,q[8]=63&q[8]|128,F)for(v=0;16>v;++v)F[H+v]=q[v];return F||ha(q)};try{J.name=u}catch(q){}return J.DNS='6ba7b810-9dad-11d1-80b4-00c04fd430c8',J.URL='6ba7b811-9dad-11d1-80b4-00c04fd430c8',J}function K(u,z){var y=(65535&u)+(65535&z);return(u>>16)+(z>>16)+(y>>16)<<16|65535&y}function U(u,z,y,J,q,v){return K((F=K(K(z,u),K(J,v)))<<(H=q)|F>>>32-H,y);var F,H}function oa(u,z,y,J,q,v,F){return U(z&y|~z&J,u,z,q,v,F)}function X(u,z,y,J,q,v,F){return U(z&J|y&~J,u,z,q,v,F)}function V(u,
z,y,J,q,v,F){return U(y^(z|~J),u,z,q,v,F)}for(var m='undefined'!=typeof crypto&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto)||'undefined'!=typeof msCrypto&&'function'==typeof msCrypto.getRandomValues&&msCrypto.getRandomValues.bind(msCrypto),S=new Uint8Array(16),p,da,za=[],N=0;256>N;++N)za[N]=(N+256).toString(16).substr(1);var L=0,C=0;N=Ca('v3',48,function(u){if('string'==typeof u){var z=unescape(encodeURIComponent(u));u=Array(z.length);for(var y=0;y<z.length;y++)u[y]=z.charCodeAt(y)}return function(J){var q,
...
R=oa(R,v,F,H,J[q+5],12,1200080426);H=oa(H,R,v,F,J[q+6],17,-1473231341);F=oa(F,H,R,v,J[q+7],22,-45705983);v=oa(v,F,H,R,J[q+8],7,1770035416);R=oa(R,v,F,H,J[q+9],12,-1958414417);H=oa(H,R,v,F,J[q+10],17,-42063);F=oa(F,H,R,v,J[q+11],22,-1990404162);v=oa(v,F,H,R,J[q+12],7,1804603682);R=oa(R,v,F,H,J[q+13],12,-40341101);H=oa(H,R,v,F,J[q+14],17,-1502002290);F=oa(F,H,R,v,J[q+15],22,1236535329);v=X(v,F,H,R,J[q+1],5,-165796510);R=X(R,v,F,H,J[q+6],9,-1069501632);H=X(H,R,v,F,J[q+11],14,643717713);F=X(F,H,R,v,J[q],
20,-373897302);v=X(v,F,H,R,J[q+5],5,-701558691);R=X(R,v,F,H,J[q+10],9,38016083);H=X(H,R,v,F,J[q+15],14,-660478335);F=X(F,H,R,v,J[q+4],20,-405537848);v=X(v,F,H,R,J[q+9],5,568446438);R=X(R,v,F,H,J[q+14],9,-1019803690);H=X(H,R,v,F,J[q+3],14,-187363961);F=X(F,H,R,v,J[q+8],20,1163531501);v=X(v,F,H,R,J[q+13],5,-1444681467);R=X(R,v,F,H,J[q+2],9,-51403784);H=X(H,R,v,F,J[q+7],14,1735328473);F=X(F,H,R,v,J[q+12],20,-1926607734);v=U(F^H^R,v,F,J[q+5],4,-378558);R=U(v^F^H,R,v,J[q+8],11,-2022574463);H=U(R^v^F,H,
...
function Merge(){var E=[],O=function(K,U){'undefined'==typeof K&&(K='undefined'!=typeof U&&Array.isArray(U)?[]:{});var oa=!1;'boolean'==typeof arguments[arguments.length-1]&&(oa=arguments[arguments.length-1]);var X=1,V=arguments.length,m,S;if('object'!==typeof K&&'function'!==typeof K)K=oa?'undefined'==typeof arguments[2]?arguments[1]:arguments[2]:'undefined'==typeof arguments[0]?arguments[1]:arguments[0];else for(;X<V;++X)if('boolean'!=typeof arguments[X]&&null!=(m=arguments[X])){if('object'!=typeof m){K=
m;break}if(Array.isArray(m)&&Array.isArray(K))K=ha(m,K,oa);else for(var p in m){K||={name:null};var da=K[p];var za=m[p];if(K!==za)if(za&&(Ca(za)||(S=Array.isArray(za)))){var N=!1;if(S){S=!1;if(da&&Array.isArray(da))var L=da||[];else if(Ca(da)){L=da||{};K[p]=L;continue}else L=[];E=L;L=ha(za,L,oa);K[p]=L}else{L=da&&Ca(da)?da:null;if(!L){N=!0;L={};for(var C in za)L[C]=za[C]}if(oa){for(C in za)'undefined'!=typeof za[C]?Array.isArray(za[C])&&Array.isArray(L[C])?L[C]=ha(za[C],L[C],oa):L[C]=za[C]:Array.isArray(za[C])&&
Array.isArray(L[C])&&(L[C]=ha(za[C],L[C],oa));K[p]=L}else{for(C in za)'undefined'==typeof L[C]?Array.isArray(za[C])&&Array.isArray(L[C])?L[C]=ha(za[C],L[C],oa):L[C]=za[C]:Array.isArray(za[C])&&Array.isArray(L[C])&&(L[C]=ha(za[C],L[C],oa));'boolean'==typeof da||N?N&&(K[p]=L):K[p]=O(L,za,oa)}}}else void 0!==za&&(K[p]='undefined'==typeof da||null==da||da===za||oa?za:da)}}E=[];return K},ha=function(K,U,oa){E=[];var X=[],V=O.getKeyComparison();if(/^true$/i.test(oa)){if('object'==typeof K[0]&&'undefined'!=
typeof K[0][V]&&'object'==typeof U[0]&&'undefined'!=typeof U[0][V]){E=Array.isArray(U)?Array.from(U):JSON.clone(U);var m=0;for(oa=E.length;m<oa;++m)X.push(E[m][V]);oa=JSON.clone(K);var S=0;m=0;K=oa.length;for(var p=za||0,da=U.length;p<da;++p)a:for(m=m||0;m<K;++m)if(oa[m][V]===U[p][V]){-1<X.indexOf(oa[m][V])?(E[S]=oa[m],++S):-1==X.indexOf(oa[m][V])&&(X.push(oa[m][V]),E[S]=oa[m],++S);break a}else-1==X.indexOf(oa[m][V])&&(X.push(oa[m][V]),E.push(oa[m]));return E}return Array.isArray(K)&&0==K.length||
'undefined'==typeof K?U:K}if(0==K.length&&0<U.length)return E=U;if(0==U.length&&0<K.length)for(m=0;m<K.length;++m)U.push(K[m]);if(0==E.length&&0<U.length)for(m=0;m<U.length;++m)'object'!=typeof U[m]&&-1==E.indexOf(U[m])&&E.push(U[m]);if(0<U.length){if('undefined'!=typeof K[0]&&'object'==typeof K[0]&&null!=K[0]&&'undefined'!=typeof K[0][V]&&'object'==typeof U[0]&&'undefined'!=typeof U[0][V]){E=Array.isArray(U)?Array.from(U):JSON.clone(U);oa=JSON.clone(K);var za=null;m=0;for(K=E.length;m<K;++m)X.push(E[m][V]);
for(m=0;m<K;++m)a:for(p=za||0,da=oa.length;p<da;++p)if(null!=oa[p]&&'undefined'!=typeof oa[p][V]&&oa[p][V]!==E[m][V]){if(-1==X.indexOf(oa[p][V])){E.push(oa[p]);X.push(oa[p][V]);za=p+1;K<da&&++K;break a}}else if(null!=oa[p]&&'undefined'!=typeof oa[p][V]&&oa[p][V]===E[m][V])za=p+1;else break a;return E}for(m=0;m<K.length;++m)if(-1<U.indexOf(K[m])&&oa)U.splice(U.indexOf(K[m]),1,K[m]);else if('undefined'==typeof E[m]&&'object'==typeof K[m])for(S in E=U,'undefined'==typeof E[m]&&(E[m]={}),K[m])E[m].hasOwnProperty(S)||
...
function addListener(E,O,ha,Ca){var K=function(X,V,m,S){'undefined'!=typeof X.event&&X.event.isTouchSupported&&/^(click|mouseout|mouseover)/.test(m)&&-1==X.event[m].indexOf(V)&&(X.event[m][X.event[m].length]=V);'undefined'!=typeof V&&null!=V?V.addEventListener?V.addEventListener(m,S,!1):V.attachEvent&&V.attachEvent('on'+m,S):X.customEvent.addListener(m,S);gina.events[m]='undefined'!=typeof V.id&&'object'!=typeof V.id?V.id:V.getAttribute('id')},U=0,oa=null;if(Array.isArray(ha))for(oa=ha.length;U<oa;U++)K(E,
O,ha[U],Ca);else if(Array.isArray(O))for(U=0,oa=O.length;U<oa;U++){let X=/\.$/.test(ha)?ha+O[U].id:ha;K(E,O[U],X,Ca)}else ha=/\.$/.test(ha)?ha+O.id:ha,K(E,O,ha,Ca)}
...
function handleXhr(E,O,ha,Ca){if(!E)throw Error('No `xhr` object initiated');var K=null,U=null,oa=null,X=null,V=null,m=ha.$link||null,S=ha.$form||null,p=null;delete ha.$link;delete ha.$form;S||m?m?(m.target=document.getElementById(m.id),p=gina.link.target,V=gina.link.id):(p=S.target,V=p.getAttribute('id')):(p=O,V=p.getAttribute('id'));var da=m&&O.getAttribute('data-gina-link-event-on-success')||m&&O.getAttribute('data-gina-link-event-on-error')?!0:!1,za=S&&p.getAttribute('data-gina-form-event-on-submit-success')||
S&&p.getAttribute('data-gina-form-event-on-submit-error')?!0:!1;za&&S&&listenToXhrEvents(S,'form');O=O.getAttribute('enctype')||ha.headers['Content-Type'];for(var N in ha.headers)'Content-Type'==N&&'undefined'!=typeof O&&null!=O&&''!=O||E.setRequestHeader(N,ha.headers[N]);E.withCredentials='undefined'!=typeof ha.withCredentials?ha.withCredentials:!1;E.onerror=function(L,C){L={status:E.status||500,error:'Transaction error: might be due to the server CORS settings.\nPlease, check the console for more details.'};
S&&(S.eventData.error=L);m&&(m.eventData.error=L);window.ginaToolbar.update('data-xhr',L,!0);triggerEvent(gina,p,'error.'+V,L);za&&triggerEvent(gina,p,'error.'+V+'.hform',L);da&&triggerEvent(gina,p,'error.'+V+'.hlink',L)};E.onreadystatechange=function(L){L=/Google Inc/i.test(navigator.vendor)?50:0;2==E.readyState&&(U=/^attachment;/.test(E.getResponseHeader('Content-Disposition'))?!0:!1,!E.responseType&&U&&(E.responseType='blob'));if(4==E.readyState)if(K=null,oa=E.getResponseHeader('Content-Type'),
/^2/.test(E.status)){try{if(/blob/.test(E.responseType)||U){if('undefined'==typeof oa||null==oa)oa='application/octet-stream';K=new Blob([this.response],{type:oa});var C=document.createElement('a');C.style='display: none';document.body.appendChild(C);var B=window.URL.createObjectURL(K);C.href=B;var u=E.getResponseHeader('Content-Disposition');C.download=u.match('=(.*)')[0].substr(1);C.click();window.URL.revokeObjectURL(B);X={status:E.status,statusText:E.statusText,responseType:K.type,type:K.type,
size:K.size}}!X&&/\/json/.test(oa)&&(X=JSON.parse(E.responseText),'undefined'==typeof X.status&&(X.status=E.status||200));if(!X&&/\/html/.test(oa)&&(X={contentType:oa,content:E.responseText},'undefined'==typeof X.status&&(X.status=E.status),'undefined'!=typeof gina.popin&&gina.hasPopinHandler)){var z=gina.popin.getActivePopin();if(z){XHRData={};try{XHRData=(new DOMParser).parseFromString(X.content,'text/html').getElementById('gina-without-layout-xhr-data'),XHRData=JSON.parse(decodeURIComponent(XHRData.value)),
XHRView=(new DOMParser).parseFromString(X.content,'text/html').getElementById('gina-without-layout-xhr-view'),XHRView=JSON.parse(decodeURIComponent(XHRView.value)),gina&&typeof window.ginaToolbar&&'undefined'!=typeof XHRData&&window.ginaToolbar.update('data-xhr',XHRData),gina&&typeof window.ginaToolbar&&'undefined'!=typeof XHRView&&window.ginaToolbar.update('view-xhr',XHRView)}catch(v){throw v;}z.loadContent(X.content);X=XHRData;triggerEvent(gina,p,'success.'+V,X);return}}X||(X=E.responseText);S&&
(S.eventData.success=X);XHRData=X;if(gina&&'object'==typeof window.ginaToolbar&&XHRData)try{'undefined'!=typeof XHRData&&/\/html/.test(oa)&&window.ginaToolbar.update('data-xhr',XHRData)}catch(v){throw v;}triggerEvent(gina,p,'success.'+V,X);za&&triggerEvent(gina,p,'success.'+V+'.hform',X);da&&triggerEvent(gina,p,'success.'+V+'.hlink',X)}catch(v){X={status:422,error:v.message,stack:v.stack};S&&(S.eventData.error=X);XHRData=X;if(gina&&'object'==typeof window.ginaToolbar&&XHRData)try{'undefined'!=typeof XHRData&&
window.ginaToolbar.update('data-xhr',XHRData)}catch(F){throw F;}triggerEvent(gina,p,'error.'+V,X);za&&triggerEvent(gina,p,'error.'+V+'.hform',X);da&&triggerEvent(gina,p,'error.'+V+'.hlink',X)}if('undefined'!=typeof X&&'undefined'!=typeof X.location)return window.location.hash='',X.location=/^http/.test(X.location)||/^\//.test(X.location)?X.location:location.protocol+'//'+X.location,setTimeout(()=>{window.location.href=X.location},L)}else if(0!=E.status)if(X={status:E.status,message:''},/blob/.test(E.responseType)){K=
new Blob([this.response],{type:'text/plain'});var y=new FileReader,J='';y.addEventListener('loadend',v=>{/string/i.test(typeof v.srcElement.result)?J+=v.srcElement.result:'object'==typeof v.srcElement.result?X=merge(X,v.srcElement.result):X.message+=v.srcElement.result;if(/^2/.test(y.readyState)){if(/^(\{|\[)/.test(J))try{X=merge(X,JSON.parse(J))}catch(R){X=merge(X,R)}X.message||delete X.message;S&&(S.eventData.error=X);if('undefined'!=typeof X&&'undefined'!=typeof X.error&&X.error.fields&&'object'==
typeof X.error.fields){v={};var F=0,H;for(H in X.error.fields)++F,v[H]={isApplicationValidationError:X.error.fields[H]};0<F&&handleErrorsDisplay(S.target,v)}XHRData=X;if(gina&&'object'==typeof window.ginaToolbar&&XHRData)try{window.ginaToolbar.update('data-xhr',XHRData)}catch(R){throw R;}triggerEvent(gina,p,'error.'+V,X);za&&triggerEvent(gina,p,'error.'+V+'.hform',X);da&&triggerEvent(gina,p,'error.'+V+'.hlink',X)}});y.readAsText(K)}else{try{X=merge(X,JSON.parse(E.responseText))}catch(v){X=merge(X,
v)}S&&(S.eventData.error=X);if('undefined'!=typeof X&&'undefined'!=typeof X.error&&X.error.fields&&'object'==typeof X.error.fields){C={};B=0;for(var q in X.error.fields)++B,C[q]={isApplicationValidationError:X.error.fields[q]};0<B&&handleErrorsDisplay(S.target,C)}XHRData=X;if(gina&&'object'==typeof window.ginaToolbar&&XHRData)try{window.ginaToolbar.update('data-xhr',XHRData)}catch(v){throw v;}triggerEvent(gina,p,'error.'+V,X);za&&triggerEvent(gina,p,'error.'+V+'.hform',X);da&&triggerEvent(gina,p,
'error.'+V+'.hlink',X)}};E.onprogress=function(L){var C='0';L.lengthComputable&&(C=L.loaded/L.total,C=parseInt(100*C));L={status:100,progress:C};S&&(S.eventData.onprogress=L);triggerEvent(gina,p,'progress.'+V,L)};E.ontimeout=function(L){X={status:408,error:'Request Timeout'};S&&(S.eventData.ontimeout=X);triggerEvent(gina,p,'error.'+V,X);za&&triggerEvent(gina,p,'error.'+V+'.hform',X);da&&triggerEvent(gina,p,'error.'+V+'.hlink',X)}}
...
shortDate:'d/m/yy',shortDate2:'dd/mm/yyyy',mediumDate:'d mmm, yyyy',longDate:'d mmmm, yyyy',fullDate:'dddd, d mmmm, yyyy'}}};var oa=function(m,S){if(S instanceof Date)return m=m.getTime(),S=S.getTime(),Math.round(Math.abs(m-S)/864E5);throw Error('dateTo is not instance of Date() !');},X=['us','eu','corporate'],V=function(m){d=new Date(m.getFullYear(),m.getMonth(),m.getDate());m=d.getDay()||7;d.setDate(d.getDate()+4-m);m=new Date(Date.parse(d.getFullYear(),0,1));return Math.ceil(((d-m)/864E5+1)/7)};
return{setCulture:function(m,S){/\-/.test(S)?(ha=S,Ca=S.split(/\-/)[0]):Ca=S;return this},format:function(m,S,p){var da=U[Ca]||U.en,za=null;try{za=O(da.masks,K)}catch(R){O=(E='undefined'!==typeof module&&module.exports?!1:!0)?require('utils/merge'):require('./../lib/merge'),za=O(da.masks,K)}'undefined'!=typeof U[ha]&&(da=U[ha],'undefined'!=typeof U[ha].mask&&(za=O(da.masks,K)));var N=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,
L=/[^-+\dA-Z]/g,C=function(R,sa){R=String(R);for(sa=sa||2;R.length<sa;)R='0'+R;return R};1!=arguments.length||'[object String]'!=Object.prototype.toString.call(m)||/\d/.test(m)||(S=m,m=void 0);m=m?new Date(m):new Date;if(isNaN(m))throw SyntaxError('invalid date');S=String(za[S]||S||za['default']);'UTC:'==S.slice(0,4)&&(S=S.slice(4),p=!0);var B=p?'getUTC':'get';za=m[B+'Date']();var u=m[B+'Day'](),z=m[B+'Month'](),y=m[B+'FullYear'](),J=m[B+'Hours'](),q=m[B+'Minutes'](),v=m[B+'Seconds']();B=m[B+'Milliseconds']();
var F=p?0:m.getTimezoneOffset(),H={d:za,dd:C(za),ddd:da.dayNames[u],dddd:da.dayNames[u+7],m:z+1,mm:C(z+1),mmm:da.monthNames[z],mmmm:da.monthNames[z+12],yy:String(y).slice(2),yyyy:y,h:J%12||12,hh:C(J%12||12),H:J,HH:C(J),M:q,MM:C(q),s:v,ss:C(v),l:C(B,3),L:C(B),t:12>J?'a':'p',tt:12>J?'am':'pm',T:12>J?'A':'P',TT:12>J?'AM':'PM',Z:p?'UTC':(String(m).match(N)||['']).pop().replace(L,''),o:(0<F?'-':'+')+C(100*Math.floor(Math.abs(F)/60)+Math.abs(F)%60,4),S:['th','st','nd','rd'][3<za%10?0:(10!=za%100-za%10)*
za%10]};return S.replace(/d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g,function(R){return R in H?H[R]:R.slice(1,R.length-1)})},countDaysTo:oa,getDaysTo:function(m,S,p){if(S instanceof Date){S=oa(m,S);var da=m.getMonth(),za=m.getFullYear();m=m.getDate()+1;m=new Date(za,da,m);da=[];for(za=0;za<S;++za)'undefined'!=typeof p?da.push((new Date(m)).format(p)):da.push(new Date(m)),m.setDate(m.getDate()+1);return da||[]}throw Error('dateTo is not instance of Date() !');},getDaysInMonth:function(m){var S=
m.getMonth();m=m.getFullYear();m=new Date(m,S,1);for(var p=[];m.getMonth()===S;)p.push(new Date(m)),m.setDate(m.getDate()+1);return p},getQuarter:function(m,S){if(1==arguments.length&&'string'==typeof arguments[0]){if(0>X.indexOf(arguments[0].toLowerCase()))throw Error('Quarter '+arguments[0]+' code not supported !');m=new Date;S=arguments[0]}'undefined'==typeof m&&(m=new Date);'undefined'==typeof S&&(S='corporate');S=S.toLowerCase();switch(S){case 'us':var p=[4,1,2,3];break;case 'corportate':case 'eu':p=
[1,2,3,4];break;default:p=[1,2,3,4]}return p[Math.floor(m.getMonth()/3)]},getHalfYear:function(m,S){if(1==arguments.length&&'string'==typeof arguments[0]){if(0>X.indexOf(arguments[0].toLowerCase()))throw Error('Quarter '+arguments[0]+' code not supported !');m=new Date;S=arguments[0]}'undefined'==typeof m&&(m=new Date);'undefined'==typeof S&&(S='corporate');S=S.toLowerCase();return 2>=m.getQuarter(S)?1:2},getWeek:function(m,S){'undefined'==typeof m&&(m=new Date);'undefined'==typeof S&&(S='ISO 8601');
...
l,k)!==g});if(c.nodeType)return b.grep(a,function(k){return k===c!==g});if('string'==typeof c){if(w.test(c))return b.filter(c,a,g);c=b.filter(c,a)}return b.grep(a,function(k){return-1<b.inArray(k,c)!==g})}function K(a,c){do a=a[c];while(a&&1!==a.nodeType);return a}function U(a){var c={};return b.each(a.match(Ba)||[],function(g,k){c[k]=!0}),c}function oa(){Ma.addEventListener?(Ma.removeEventListener('DOMContentLoaded',X),E.removeEventListener('load',X)):(Ma.detachEvent('onreadystatechange',X),E.detachEvent('onload',
X))}function X(){(Ma.addEventListener||'load'===E.event.type||'complete'===Ma.readyState)&&(oa(),b.ready())}function V(a,c,g){if(void 0===g&&1===a.nodeType){var k='data-'+c.replace(Ab,'-$1').toLowerCase();if(g=a.getAttribute(k),'string'==typeof g){try{g='true'===g?!0:'false'===g?!1:'null'===g?null:+g+''===g?+g:tb.test(g)?b.parseJSON(g):g}catch(l){}b.data(a,c,g)}else g=void 0}return g}function m(a){for(var c in a)if(('data'!==c||!b.isEmptyObject(a[c]))&&'toJSON'!==c)return!1;return!0}function S(a,
c,g,k){if(Ta(a)){var l,D,G=b.expando,Z=a.nodeType,qa=Z?b.cache:a,Aa=Z?a[G]:a[G]&&G;if(Aa&&qa[Aa]&&(k||qa[Aa].data)||void 0!==g||'string'!=typeof c)return Aa||=Z?a[G]=jb.pop()||b.guid++:G,qa[Aa]||(qa[Aa]=Z?{}:{toJSON:b.noop}),'object'!=typeof c&&'function'!=typeof c||(k?qa[Aa]=b.extend(qa[Aa],c):qa[Aa].data=b.extend(qa[Aa].data,c)),D=qa[Aa],k||(D.data||(D.data={}),D=D.data),void 0!==g&&(D[b.camelCase(c)]=g),'string'==typeof c?(l=D[c],null==l&&(l=D[b.camelCase(c)])):l=D,l}}function p(a,c,g){if(Ta(a)){var k,
...
(b.cssNumber[c]?'':'px'),ta=(b.cssNumber[c]||'px'!==Aa&&+qa)&&eb.exec(b.css(a,c));if(ta&&ta[3]!==Aa){Aa=Aa||ta[3];g=g||[];ta=+qa||1;do D=D||'.5',ta/=D,b.style(a,c,ta+Aa);while(D!==(D=Z()/qa)&&1!==D&&--G)}return g&&(ta=+ta||+qa||0,l=g[1]?ta+(g[1]+1)*g[2]:+g[2],k&&(k.unit=Aa,k.start=ta,k.end=l)),l}function za(a){var c='abbr article aside audio bdi canvas data datalist details dialog figcaption figure footer header hgroup main mark meter nav output picture progress section summary template time video'.split(' ');
...
!c||b._data(c[k],'globalEval'))}function C(a){gb.test(a.type)&&(a.defaultChecked=a.checked)}function B(a,c,g,k,l){for(var D,G,Z,qa,Aa,ta,Ra,Ua=a.length,zb=za(c),ab=[],Jb=0;Ua>Jb;Jb++)if(G=a[Jb],G||0===G)if('object'===b.type(G))b.merge(ab,G.nodeType?[G]:G);else if(Qa.test(G)){qa=qa||zb.appendChild(c.createElement('div'));Aa=(ia.exec(G)||['',''])[1].toLowerCase();Ra=ra[Aa]||ra._default;qa.innerHTML=Ra[1]+b.htmlPrefilter(G)+Ra[2];for(D=Ra[0];D--;)qa=qa.lastChild;if(!e.leadingWhitespace&&ka.test(G)&&
ab.push(c.createTextNode(ka.exec(G)[0])),!e.tbody)for(D=(G='table'!==Aa||Za.test(G)?'<table>'!==Ra[1]||Za.test(G)?0:qa:qa.firstChild)&&G.childNodes.length;D--;)b.nodeName(ta=G.childNodes[D],'tbody')&&!ta.childNodes.length&&G.removeChild(ta);b.merge(ab,qa.childNodes);for(qa.textContent='';qa.firstChild;)qa.removeChild(qa.firstChild);qa=zb.lastChild}else ab.push(c.createTextNode(G));qa&&zb.removeChild(qa);e.appendChecked||b.grep(N(ab,'input'),C);for(Jb=0;G=ab[Jb++];)if(k&&-1<b.inArray(G,k))l&&l.push(G);
else if(Z=b.contains(G.ownerDocument,G),qa=N(zb.appendChild(G),'script'),Z&&L(qa),g)for(D=0;G=qa[D++];)Y.test(G.type||'')&&g.push(G);return zb}function u(){return!0}function z(){return!1}function y(){try{return Ma.activeElement}catch(a){}}function J(a,c,g,k,l,D){var G,Z;if('object'==typeof c){'string'!=typeof g&&(k=k||g,g=void 0);for(Z in c)J(a,Z,g,k,c[Z],D);return a}if(null==k&&null==l?(l=g,k=g=void 0):null==l&&('string'==typeof g?(l=k,k=void 0):(l=k,k=g,g=void 0)),!1===l)l=z;else if(!l)return a;
...
function H(a,c){if(1===c.nodeType&&b.hasData(a)){var g,k;var l=b._data(a);a=b._data(c,l);var D=l.events;if(D)for(g in delete a.handle,a.events={},D)for(l=0,k=D[g].length;k>l;l++)b.event.add(c,g,D[g][l]);a.data&&(a.data=b.extend({},a.data))}}function R(a,c,g,k){c=Pb.apply([],c);var l,D,G,Z=0,qa=a.length,Aa=qa-1,ta=c[0],Ra=b.isFunction(ta);if(Ra||1<qa&&'string'==typeof ta&&!e.checkClone&&Eb.test(ta))return a.each(function(zb){var ab=a.eq(zb);Ra&&(c[0]=ta.call(this,zb,ab.html()));R(ab,c,g,k)});if(qa&&
(G=B(c,a[0].ownerDocument,!1,a,k),l=G.firstChild,1===G.childNodes.length&&(G=l),l||k)){var Ua=b.map(N(G,'script'),v);for(D=Ua.length;qa>Z;Z++)l=G,Z!==Aa&&(l=b.clone(l,!0,!0),D&&b.merge(Ua,N(l,'script'))),g.call(a[Z],l,Z);if(D)for(G=Ua[Ua.length-1].ownerDocument,b.map(Ua,F),Z=0;D>Z;Z++)l=Ua[Z],Y.test(l.type||'')&&!b._data(l,'globalEval')&&b.contains(G,l)&&(l.src?b._evalUrl&&b._evalUrl(l.src):b.globalEval((l.text||l.textContent||l.innerHTML||'').replace(Kb,'')));G=l=null}return a}function sa(a,c,g){for(var k=
...
ca(k.nodeName)))):(l=Vb(k),(g&&'none'!==g||!l)&&b._data(k,'olddisplay',l?g:b.css(k,'display'))));for(G=0;Z>G;G++)k=a[G],k.style&&(c&&'none'!==k.style.display&&''!==k.style.display||(k.style.display=c?D[G]||'':'none'));return a}function pa(a,c,g){return(a=wd.exec(c))?Math.max(0,a[1]-(g||0))+(a[2]||'px'):c}function Ea(a,c,g,k,l){c=g===(k?'border':'content')?4:'width'===c?1:0;for(var D=0;4>c;c+=2)'margin'===g&&(D+=b.css(a,g+Bb[c],!0,l)),k?('content'===g&&(D-=b.css(a,'padding'+Bb[c],!0,l)),'margin'!==
g&&(D-=b.css(a,'border'+Bb[c]+'Width',!0,l))):(D+=b.css(a,'padding'+Bb[c],!0,l),'padding'!==g&&(D+=b.css(a,'border'+Bb[c]+'Width',!0,l)));return D}function Ka(a,c,g){var k=!0,l='width'===c?a.offsetWidth:a.offsetHeight,D=xc(a),G=e.boxSizing&&'border-box'===b.css(a,'boxSizing',!1,D);if(0>=l||null==l){if(l=sc(a,c,D),(0>l||null==l)&&(l=a.style[c]),Mb.test(l))return l;k=G&&(e.boxSizingReliable()||l===a.style[c]);l=parseFloat(l)||0}return l+Ea(a,c,g||(G?'border':'content'),k,D)+'px'}function Oa(a,c,g,k,
l){return new Oa.prototype.init(a,c,g,k,l)}function Ia(){return E.setTimeout(function(){Hc=void 0}),Hc=b.now()}function Da(a,c){var g={height:a},k=0;for(c=c?1:0;4>k;k+=2-c){var l=Bb[k];g['margin'+l]=g['padding'+l]=a}return c&&(g.opacity=g.width=a),g}function cb(a,c,g){for(var k,l=(Na.tweeners[c]||[]).concat(Na.tweeners['*']),D=0,G=l.length;G>D;D++)if(k=l[D].call(g,c,a))return k}function Fa(a,c){var g,k,l,D,G;for(g in a)if(k=b.camelCase(g),l=c[k],D=a[g],b.isArray(D)&&(l=D[1],D=a[g]=D[0]),g!==k&&(a[k]=
D,delete a[g]),G=b.cssHooks[k],G&&'expand'in G)for(g in D=G.expand(D),delete a[k],D)g in a||(a[g]=D[g],c[g]=l);else c[k]=l}function Na(a,c,g){var k,l=0,D=Na.prefilters.length,G=b.Deferred().always(function(){delete Z.elem}),Z=function(){if(k)return!1;var Aa=Hc||Ia();Aa=Math.max(0,qa.startTime+qa.duration-Aa);for(var ta=1-(Aa/qa.duration||0),Ra=0,Ua=qa.tweens.length;Ua>Ra;Ra++)qa.tweens[Ra].run(ta);return G.notifyWith(a,[qa,ta,Aa]),1>ta&&Ua?Aa:(G.resolveWith(a,[qa]),!1)},qa=G.promise({elem:a,props:b.extend({},
c),opts:b.extend(!0,{specialEasing:{},easing:b.easing._default},g),originalProperties:c,originalOptions:g,startTime:Hc||Ia(),duration:g.duration,tweens:[],createTween:function(Aa,ta){Aa=b.Tween(a,qa.opts,Aa,ta,qa.opts.specialEasing[Aa]||qa.opts.easing);return qa.tweens.push(Aa),Aa},stop:function(Aa){var ta=0,Ra=Aa?qa.tweens.length:0;if(k)return this;for(k=!0;Ra>ta;ta++)qa.tweens[ta].run(1);return Aa?(G.notifyWith(a,[qa,1,0]),G.resolveWith(a,[qa,Aa])):G.rejectWith(a,[qa,Aa]),this}});g=qa.props;for(Fa(g,
qa.opts.specialEasing);D>l;l++)if(c=Na.prefilters[l].call(qa,a,g,qa.opts))return b.isFunction(c.stop)&&(b._queueHooks(qa.elem,qa.opts.queue).stop=b.proxy(c.stop,c)),c;return b.map(g,cb,qa),b.isFunction(qa.opts.start)&&qa.opts.start.call(a,qa),b.fx.timer(b.extend(Z,{elem:a,anim:qa,queue:qa.opts.queue})),qa.progress(qa.opts.progress).done(qa.opts.done,qa.opts.complete).fail(qa.opts.fail).always(qa.opts.always)}function Wa(a){return b.attr(a,'class')||''}function rb(a){return function(c,g){'string'!=
typeof c&&(g=c,c='*');var k=0,l=c.toLowerCase().match(Ba)||[];if(b.isFunction(g))for(;c=l[k++];)'+'===c.charAt(0)?(c=c.slice(1)||'*',(a[c]=a[c]||[]).unshift(g)):(a[c]=a[c]||[]).push(g)}}function bb(a,c,g,k){function l(Z){var qa;return D[Z]=!0,b.each(a[Z]||[],function(Aa,ta){Aa=ta(c,g,k);return'string'!=typeof Aa||G||D[Aa]?G?!(qa=Aa):void 0:(c.dataTypes.unshift(Aa),l(Aa),!1)}),qa}var D={},G=a===Xc;return l(c.dataTypes[0])||!D['*']&&l('*')}function fb(a,c){var g,k,l=b.ajaxSettings.flatOptions||{};for(k in c)void 0!==
c[k]&&((l[k]?a:g||={})[k]=c[k]);return g&&b.extend(!0,a,g),a}function gc(a){if(!b.contains(a.ownerDocument||Ma,a))return!0;for(;a&&1===a.nodeType;){if('none'===(a.style&&a.style.display||b.css(a,'display'))||'hidden'===a.type)return!0;a=a.parentNode}return!1}function yb(a,c,g,k){var l;if(b.isArray(c))b.each(c,function(D,G){g||xd.test(a)?k(a,G):yb(a+'['+('object'==typeof G&&null!=G?D:'')+']',G,g,k)});else if(g||'object'!==b.type(c))k(a,c);else for(l in c)yb(a+'['+l+']',c[l],g,k)}function ib(){try{return new E.XMLHttpRequest}catch(a){}}
function Gb(){try{return new E.ActiveXObject('Microsoft.XMLHTTP')}catch(a){}}function Ob(a){return b.isWindow(a)?a:9===a.nodeType?a.defaultView||a.parentWindow:!1}var jb=[],Ma=E.document,nb=jb.slice,Pb=jb.concat,Yb=jb.push,wa=jb.indexOf,xa={},Ha=xa.toString,M=xa.hasOwnProperty,e={},b=function(a,c){return new b.fn.init(a,c)},h=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,n=/^-ms-/,x=/-([\da-z])/gi,r=function(a,c){return c.toUpperCase()};b.fn=b.prototype={jquery:'1.12.4',constructor:b,selector:'',length:0,
toArray:function(){return nb.call(this)},get:function(a){return null!=a?0>a?this[a+this.length]:this[a]:nb.call(this)},pushStack:function(a){a=b.merge(this.constructor(),a);return a.prevObject=this,a.context=this.context,a},each:function(a){return b.each(this,a)},map:function(a){return this.pushStack(b.map(this,function(c,g){return a.call(c,g,c)}))},slice:function(){return this.pushStack(nb.apply(this,arguments))},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},eq:function(a){var c=
this.length;a=+a+(0>a?c:0);return this.pushStack(0<=a&&c>a?[this[a]]:[])},end:function(){return this.prevObject||this.constructor()},push:Yb,sort:jb.sort,splice:jb.splice};b.extend=b.fn.extend=function(){var a,c,g,k,l=arguments[0]||{},D=1,G=arguments.length,Z=!1;'boolean'==typeof l&&(Z=l,l=arguments[D]||{},D++);'object'==typeof l||b.isFunction(l)||(l={});for(D===G&&(l=this,D--);G>D;D++)if(null!=(g=arguments[D]))for(c in g){var qa=l[c];var Aa=g[c];l!==Aa&&(Z&&Aa&&(b.isPlainObject(Aa)||(a=b.isArray(Aa)))?
...
g);null!=G&&D.push(G)}else for(l in a)G=c(a[l],l,g),null!=G&&D.push(G);return Pb.apply([],D)},guid:1,proxy:function(a,c){var g,k,l;return'string'==typeof c&&(l=a[c],c=a,a=l),b.isFunction(a)?(g=nb.call(arguments,2),k=function(){return a.apply(c||this,g.concat(nb.call(arguments)))},k.guid=a.guid=a.guid||b.guid++,k):void 0},now:function(){return+new Date},support:e});'function'==typeof Symbol&&(b.fn[Symbol.iterator]=jb[Symbol.iterator]);b.each('Boolean Number String Function Array Date RegExp Object Error Symbol'.split(' '),
function(a,c){xa['[object '+c+']']=c.toLowerCase()});var A=function(a){function c(I,ba,ma,va){var Ga,La,Sa,$a,Va=ba&&ba.ownerDocument,lb=ba?ba.nodeType:9;if(ma=ma||[],'string'!=typeof I||!I||1!==lb&&9!==lb&&11!==lb)return ma;if(!va&&((ba?ba.ownerDocument||ba:bc)!==ub&&Dc(ba),ba=ba||ub,hc)){if(11!==lb&&($a=yd.exec(I)))if(Ga=$a[1])if(9===lb){if(!(La=ba.getElementById(Ga)))return ma;if(La.id===Ga)return ma.push(La),ma}else{if(Va&&(La=Va.getElementById(Ga))&&oc(ba,La)&&La.id===Ga)return ma.push(La),ma}else{if($a[2])return Cc.apply(ma,
ba.getElementsByTagName(I)),ma;if((Ga=$a[3])&&Rb.getElementsByClassName&&ba.getElementsByClassName)return Cc.apply(ma,ba.getElementsByClassName(Ga)),ma}if(!(!Rb.qsa||cc[I+' ']||Xb&&Xb.test(I))){if(1!==lb){Va=ba;var ob=I}else if('object'!==ba.nodeName.toLowerCase()){(Sa=ba.getAttribute('id'))?Sa=Sa.replace(zd,'\\$&'):ba.setAttribute('id',Sa=Cb);$a=Pc(I);Ga=$a.length;for(La=ld.test(Sa)?'#'+Sa:"[id='"+Sa+"']";Ga--;)$a[Ga]=La+' '+Ua($a[Ga]);ob=$a.join(',');Va=Yc.test(I)&&ta(ba.parentNode)||ba}if(ob)try{return Cc.apply(ma,
Va.querySelectorAll(ob)),ma}catch(hb){}finally{Sa===Cb&&ba.removeAttribute('id')}}}return ic(I.replace(Qc,'$1'),ba,ma,va)}function g(){function I(ma,va){return ba.push(ma+' ')>Fb.cacheLength&&delete I[ba.shift()],I[ma+' ']=va}var ba=[];return I}function k(I){return I[Cb]=!0,I}function l(I){var ba=ub.createElement('div');try{return!!I(ba)}catch(ma){return!1}finally{ba.parentNode&&ba.parentNode.removeChild(ba)}}function D(I,ba){I=I.split('|');for(var ma=I.length;ma--;)Fb.attrHandle[I[ma]]=ba}function G(I,
...
ba),Sa=La.length;Sa--;)ma[Ga=La[Sa]]&&(ma[Ga]=!(va[Ga]=ma[Ga]))})})}function ta(I){return I&&'undefined'!=typeof I.getElementsByTagName&&I}function Ra(){}function Ua(I){for(var ba=0,ma=I.length,va='';ma>ba;ba++)va+=I[ba].value;return va}function zb(I,ba,ma){var va=ba.dir,Ga=ma&&'parentNode'===va,La=Sb++;return ba.first?function(Sa,$a,Va){for(;Sa=Sa[va];)if(1===Sa.nodeType||Ga)return I(Sa,$a,Va)}:function(Sa,$a,Va){var lb,ob,hb,Lb=[Zb,La];if(Va)for(;Sa=Sa[va];){if((1===Sa.nodeType||Ga)&&I(Sa,$a,Va))return!0}else for(;Sa=
Sa[va];)if(1===Sa.nodeType||Ga){if(hb=Sa[Cb]||(Sa[Cb]={}),ob=hb[Sa.uniqueID]||(hb[Sa.uniqueID]={}),(lb=ob[va])&&lb[0]===Zb&&lb[1]===La)return Lb[2]=lb[2];if(ob[va]=Lb,Lb[2]=I(Sa,$a,Va))return!0}}}function ab(I){return 1<I.length?function(ba,ma,va){for(var Ga=I.length;Ga--;)if(!I[Ga](ba,ma,va))return!1;return!0}:I[0]}function Jb(I,ba,ma,va,Ga){for(var La,Sa=[],$a=0,Va=I.length,lb=null!=ba;Va>$a;$a++)(La=I[$a])&&(ma&&!ma(La,va,Ga)||(Sa.push(La),lb&&ba.push($a)));return Sa}function lc(I,ba,ma,va,Ga,
La){return va&&!va[Cb]&&(va=lc(va)),Ga&&!Ga[Cb]&&(Ga=lc(Ga,La)),k(function(Sa,$a,Va,lb){var ob,hb=[],Lb=[],dc=$a.length,ac;if(!(ac=Sa)){ac=ba||'*';for(var vb=Va.nodeType?[Va]:Va,tc=[],jc=0,rc=vb.length;rc>jc;jc++)c(ac,vb[jc],tc);ac=tc}ac=!I||!Sa&&ba?ac:Jb(ac,hb,I,Va,lb);vb=ma?Ga||(Sa?I:dc||va)?[]:$a:ac;if(ma&&ma(ac,vb,Va,lb),va){var ec=Jb(vb,Lb);va(ec,[],Va,lb);for(Va=ec.length;Va--;)(ob=ec[Va])&&(vb[Lb[Va]]=!(ac[Lb[Va]]=ob))}if(Sa){if(Ga||I){if(Ga){ec=[];for(Va=vb.length;Va--;)(ob=vb[Va])&&ec.push(ac[Va]=
ob);Ga(null,vb=[],ec,lb)}for(Va=vb.length;Va--;)(ob=vb[Va])&&-1<(ec=Ga?Ec(Sa,ob):hb[Va])&&(Sa[ec]=!($a[ec]=ob))}}else vb=Jb(vb===$a?vb.splice(dc,vb.length):vb),Ga?Ga(null,$a,vb,lb):Cc.apply($a,vb)})}function Ic(I){var ba,ma,va=I.length,Ga=Fb.relative[I[0].type];var La=Ga||Fb.relative[' '];for(var Sa=Ga?1:0,$a=zb(function(ob){return ob===ba},La,!0),Va=zb(function(ob){return-1<Ec(ba,ob)},La,!0),lb=[function(ob,hb,Lb){ob=!Ga&&(Lb||hb!==Db)||((ba=hb).nodeType?$a(ob,hb,Lb):Va(ob,hb,Lb));return ba=null,
ob}];va>Sa;Sa++)if(La=Fb.relative[I[Sa].type])lb=[zb(ab(lb),La)];else{if(La=Fb.filter[I[Sa].type].apply(null,I[Sa].matches),La[Cb]){for(ma=++Sa;va>ma&&!Fb.relative[I[ma].type];ma++);return lc(1<Sa&&ab(lb),1<Sa&&Ua(I.slice(0,Sa-1).concat({value:' '===I[Sa-2].type?'*':''})).replace(Qc,'$1'),La,ma>Sa&&Ic(I.slice(Sa,ma)),va>ma&&Ic(I=I.slice(ma)),va>ma&&Ua(I))}lb.push(La)}return ab(lb)}function mc(I,ba){var ma=0<ba.length,va=0<I.length,Ga=function(La,Sa,$a,Va,lb){var ob,hb,Lb=0,dc='0',ac=La&&[],vb=[],
tc=Db,jc=La||va&&Fb.find.TAG('*',lb),rc=Zb+=null==tc?1:Math.random()||.1,ec=jc.length;for(lb&&(Db=Sa===ub||Sa||lb);dc!==ec&&null!=(ob=jc[dc]);dc++){if(va&&ob){var Zc=0;for(Sa||ob.ownerDocument===ub||(Dc(ob),$a=!hc);hb=I[Zc++];)if(hb(ob,Sa||ub,$a)){Va.push(ob);break}lb&&(Zb=rc)}ma&&((ob=!hb&&ob)&&Lb--,La&&ac.push(ob))}if(Lb+=dc,ma&&dc!==Lb){for(Zc=0;hb=ba[Zc++];)hb(ac,vb,Sa,$a);if(La){if(0<Lb)for(;dc--;)ac[dc]||vb[dc]||(vb[dc]=$c.call(Va));vb=Jb(vb)}Cc.apply(Va,vb);lb&&!La&&0<vb.length&&1<Lb+ba.length&&
c.uniqueSort(Va)}return lb&&(Zb=rc,Db=tc),ac};return ma?k(Ga):Ga}var yc,wb,ic,Db,Qb,Tb,ub,kc,hc,Xb,fc,Ub,oc,Cb='sizzle'+1*new Date,bc=a.document,Zb=0,Sb=0,Jc=g(),pc=g(),cc=g(),uc=function(I,ba){return I===ba&&(Tb=!0),0},vc={}.hasOwnProperty,nc=[],$c=nc.pop,Ad=nc.push,Cc=nc.push,md=nc.slice,Ec=function(I,ba){for(var ma=0,va=I.length;va>ma;ma++)if(I[ma]===ba)return ma;return-1},Bd=RegExp('[\\x20\\t\\r\\n\\f]+','g'),Qc=RegExp('^[\\x20\\t\\r\\n\\f]+|((?:^|[^\\\\])(?:\\\\.)*)[\\x20\\t\\r\\n\\f]+$','g'),
...
ma.attachEvent('onunload',nd)),Rb.attributes=l(function(va){return va.className='i',!va.getAttribute('className')}),Rb.getElementsByTagName=l(function(va){return va.appendChild(ub.createComment('')),!va.getElementsByTagName('*').length}),Rb.getElementsByClassName=Mc.test(ub.getElementsByClassName),Rb.getById=l(function(va){return kc.appendChild(va).id=Cb,!ub.getElementsByName||!ub.getElementsByName(Cb).length}),Rb.getById?(Fb.find.ID=function(va,Ga){if('undefined'!=typeof Ga.getElementById&&hc)return(va=
Ga.getElementById(va))?[va]:[]},Fb.filter.ID=function(va){var Ga=va.replace(zc,Ac);return function(La){return La.getAttribute('id')===Ga}}):(delete Fb.find.ID,Fb.filter.ID=function(va){var Ga=va.replace(zc,Ac);return function(La){return(La='undefined'!=typeof La.getAttributeNode&&La.getAttributeNode('id'))&&La.value===Ga}}),Fb.find.TAG=Rb.getElementsByTagName?function(va,Ga){return'undefined'!=typeof Ga.getElementsByTagName?Ga.getElementsByTagName(va):Rb.qsa?Ga.querySelectorAll(va):void 0}:function(va,
Ga){var La=[],Sa=0;Ga=Ga.getElementsByTagName(va);if('*'===va){for(;va=Ga[Sa++];)1===va.nodeType&&La.push(va);return La}return Ga},Fb.find.CLASS=Rb.getElementsByClassName&&function(va,Ga){return'undefined'!=typeof Ga.getElementsByClassName&&hc?Ga.getElementsByClassName(va):void 0},fc=[],Xb=[],(Rb.qsa=Mc.test(ub.querySelectorAll))&&(l(function(va){kc.appendChild(va).innerHTML="<a id='"+Cb+"'></a><select id='"+Cb+"-\r\\' msallowcapture=''><option selected=''></option></select>";va.querySelectorAll("[msallowcapture^='']").length&&
Xb.push('[*^$]=[\\x20\\t\\r\\n\\f]*(?:\'\'|"")');va.querySelectorAll('[selected]').length||Xb.push('\\[[\\x20\\t\\r\\n\\f]*(?:value|checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)');va.querySelectorAll('[id~='+Cb+'-]').length||Xb.push('~=');va.querySelectorAll(':checked').length||Xb.push(':checked');va.querySelectorAll('a#'+Cb+'+*').length||Xb.push('.#.+[+~]')}),l(function(va){var Ga=ub.createElement('input');Ga.setAttribute('type',
...
!Ga.compareDocumentPosition;return La?La:(La=(va.ownerDocument||va)===(Ga.ownerDocument||Ga)?va.compareDocumentPosition(Ga):1,1&La||!Rb.sortDetached&&Ga.compareDocumentPosition(va)===La?va===ub||va.ownerDocument===bc&&oc(bc,va)?-1:Ga===ub||Ga.ownerDocument===bc&&oc(bc,Ga)?1:Qb?Ec(Qb,va)-Ec(Qb,Ga):0:4&La?-1:1)}:function(va,Ga){if(va===Ga)return Tb=!0,0;var La=0,Sa=va.parentNode,$a=Ga.parentNode,Va=[va],lb=[Ga];if(!Sa||!$a)return va===ub?-1:Ga===ub?1:Sa?-1:$a?1:Qb?Ec(Qb,va)-Ec(Qb,Ga):0;if(Sa===$a)return G(va,
Ga);for(;va=va.parentNode;)Va.unshift(va);for(va=Ga;va=va.parentNode;)lb.unshift(va);for(;Va[La]===lb[La];)La++;return La?G(Va[La],lb[La]):Va[La]===bc?-1:lb[La]===bc?1:0},ub):ub};c.matches=function(I,ba){return c(I,null,null,ba)};c.matchesSelector=function(I,ba){if((I.ownerDocument||I)!==ub&&Dc(I),ba=ba.replace(Ed,"='$1']"),!(!Rb.matchesSelector||!hc||cc[ba+' ']||fc&&fc.test(ba)||Xb&&Xb.test(ba)))try{var ma=Ub.call(I,ba);if(ma||Rb.disconnectedMatch||I.document&&11!==I.document.nodeType)return ma}catch(va){}return 0<
c(ba,ub,null,[I]).length};c.contains=function(I,ba){return(I.ownerDocument||I)!==ub&&Dc(I),oc(I,ba)};c.attr=function(I,ba){(I.ownerDocument||I)!==ub&&Dc(I);var ma=Fb.attrHandle[ba.toLowerCase()];ma=ma&&vc.call(Fb.attrHandle,ba.toLowerCase())?ma(I,ba,!hc):void 0;return void 0!==ma?ma:Rb.attributes||!hc?I.getAttribute(ba):(ma=I.getAttributeNode(ba))&&ma.specified?ma.value:null};c.error=function(I){throw Error('Syntax error, unrecognized expression: '+I);};c.uniqueSort=function(I){var ba,ma=[],va=0,
Ga=0;if(Tb=!Rb.detectDuplicates,Qb=!Rb.sortStable&&I.slice(0),I.sort(uc),Tb){for(;ba=I[Ga++];)ba===I[Ga]&&(va=ma.push(Ga));for(;va--;)I.splice(ma[va],1)}return Qb=null,I};var ad=c.getText=function(I){var ba,ma='',va=0;if(ba=I.nodeType)if(1===ba||9===ba||11===ba){if('string'==typeof I.textContent)return I.textContent;for(I=I.firstChild;I;I=I.nextSibling)ma+=ad(I)}else{if(3===ba||4===ba)return I.nodeValue}else for(;ba=I[va++];)ma+=ad(ba);return ma};var Fb=c.selectors={cacheLength:50,createPseudo:k,
...
1)===ma+'-':!1):!0}},CHILD:function(I,ba,ma,va,Ga){var La='nth'!==I.slice(0,3),Sa='last'!==I.slice(-4),$a='of-type'===ba;return 1===va&&0===Ga?function(Va){return!!Va.parentNode}:function(Va,lb,ob){var hb,Lb;lb=La!==Sa?'nextSibling':'previousSibling';var dc=Va.parentNode,ac=$a&&Va.nodeName.toLowerCase();ob=!ob&&!$a;var vb=!1;if(dc){if(La){for(;lb;){for(hb=Va;hb=hb[lb];)if($a?hb.nodeName.toLowerCase()===ac:1===hb.nodeType)return!1;var tc=lb='only'===I&&!tc&&'nextSibling'}return!0}if(tc=[Sa?dc.firstChild:
dc.lastChild],Sa&&ob){hb=dc;var jc=hb[Cb]||(hb[Cb]={});var rc=jc[hb.uniqueID]||(jc[hb.uniqueID]={});var ec=rc[I]||[];vb=(Lb=ec[0]===Zb&&ec[1])&&ec[2];for(hb=Lb&&dc.childNodes[Lb];hb=++Lb&&hb&&hb[lb]||(vb=Lb=0)||tc.pop();)if(1===hb.nodeType&&++vb&&hb===Va){rc[I]=[Zb,Lb,vb];break}}else if(ob&&(hb=Va,jc=hb[Cb]||(hb[Cb]={}),rc=jc[hb.uniqueID]||(jc[hb.uniqueID]={}),ec=rc[I]||[],Lb=ec[0]===Zb&&ec[1],vb=Lb),!1===vb)for(;(hb=++Lb&&hb&&hb[lb]||(vb=Lb=0)||tc.pop())&&(($a?hb.nodeName.toLowerCase()!==ac:1!==
hb.nodeType)||!++vb||(ob&&(jc=hb[Cb]||(hb[Cb]={}),rc=jc[hb.uniqueID]||(jc[hb.uniqueID]={}),rc[I]=[Zb,vb]),hb!==Va)););return vb-=Ga,vb===va||0===vb%va&&0<=vb/va}}},PSEUDO:function(I,ba){var ma,va=Fb.pseudos[I]||Fb.setFilters[I.toLowerCase()]||c.error('unsupported pseudo: '+I);return va[Cb]?va(ba):1<va.length?(ma=[I,I,'',ba],Fb.setFilters.hasOwnProperty(I.toLowerCase())?k(function(Ga,La){for(var Sa,$a=va(Ga,ba),Va=$a.length;Va--;)Sa=Ec(Ga,$a[Va]),Ga[Sa]=!(La[Sa]=$a[Va])}):function(Ga){return va(Ga,
0,ma)}):va}},pseudos:{not:k(function(I){var ba=[],ma=[],va=wb(I.replace(Qc,'$1'));return va[Cb]?k(function(Ga,La,Sa,$a){var Va;Sa=va(Ga,null,$a,[]);for($a=Ga.length;$a--;)(Va=Sa[$a])&&(Ga[$a]=!(La[$a]=Va))}):function(Ga,La,Sa){return ba[0]=Ga,va(ba,null,Sa,ma),ba[0]=null,!ma.pop()}}),has:k(function(I){return function(ba){return 0<c(I,ba).length}}),contains:k(function(I){return I=I.replace(zc,Ac),function(ba){return-1<(ba.textContent||ba.innerText||ad(ba)).indexOf(I)}}),lang:k(function(I){return ld.test(I||
...
lt:Aa(function(I,ba,ma){for(ba=0>ma?ma+ba:ma;0<=--ba;)I.push(ba);return I}),gt:Aa(function(I,ba,ma){for(ma=0>ma?ma+ba:ma;++ma<ba;)I.push(ma);return I})}};Fb.pseudos.nth=Fb.pseudos.eq;for(yc in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})Fb.pseudos[yc]=Z(yc);for(yc in{submit:!0,reset:!0})Fb.pseudos[yc]=qa(yc);Ra.prototype=Fb.filters=Fb.pseudos;Fb.setFilters=new Ra;var Pc=c.tokenize=function(I,ba){var ma,va,Ga,La,Sa;if(La=pc[I+' '])return ba?0:La.slice(0);La=I;var $a=[];for(Sa=Fb.preFilter;La;){Va&&
!(ma=Cd.exec(La))||(ma&&(La=La.slice(ma[0].length)||La),$a.push(va=[]));var Va=!1;(ma=Dd.exec(La))&&(Va=ma.shift(),va.push({value:Va,type:ma[0].replace(Qc,' ')}),La=La.slice(Va.length));for(Ga in Fb.filter)!(ma=Rc[Ga].exec(La))||Sa[Ga]&&!(ma=Sa[Ga](ma))||(Va=ma.shift(),va.push({value:Va,type:Ga,matches:ma}),La=La.slice(Va.length));if(!Va)break}return ba?La.length:La?c.error(I):pc(I,$a).slice(0)};return wb=c.compile=function(I,ba){var ma,va=[],Ga=[],La=cc[I+' '];if(!La){ba||=Pc(I);for(ma=ba.length;ma--;)La=
Ic(ba[ma]),La[Cb]?va.push(La):Ga.push(La);La=cc(I,mc(Ga,va));La.selector=I}return La},ic=c.select=function(I,ba,ma,va){var Ga,La,Sa,$a,Va,lb='function'==typeof I&&I,ob=!va&&Pc(I=lb.selector||I);if(ma=ma||[],1===ob.length){if(La=ob[0]=ob[0].slice(0),2<La.length&&'ID'===(Sa=La[0]).type&&Rb.getById&&9===ba.nodeType&&hc&&Fb.relative[La[1].type]){if(ba=(Fb.find.ID(Sa.matches[0].replace(zc,Ac),ba)||[])[0],!ba)return ma;lb&&(ba=ba.parentNode);I=I.slice(La.shift().value.length)}for(Ga=Rc.needsContext.test(I)?
0:La.length;Ga--&&(Sa=La[Ga],!Fb.relative[$a=Sa.type]);)if((Va=Fb.find[$a])&&(va=Va(Sa.matches[0].replace(zc,Ac),Yc.test(La[0].type)&&ta(ba.parentNode)||ba))){if(La.splice(Ga,1),I=va.length&&Ua(La),!I)return Cc.apply(ma,va),ma;break}}return(lb||wb(I,ob))(va,ba,!hc,ma,!ba||Yc.test(I)&&ta(ba.parentNode)||ba),ma},Rb.sortStable=Cb.split('').sort(uc).join('')===Cb,Rb.detectDuplicates=!!Tb,Dc(),Rb.sortDetached=l(function(I){return 1&I.compareDocumentPosition(ub.createElement('div'))}),l(function(I){return I.innerHTML=
...
'string'==typeof a?U(a):b.extend({},a);var c,g,k,l,D=[],G=[],Z=-1,qa=function(){l=a.once;for(k=c=!0;G.length;Z=-1)for(g=G.shift();++Z<D.length;)!1===D[Z].apply(g[0],g[1])&&a.stopOnFalse&&(Z=D.length,g=!1);a.memory||(g=!1);c=!1;l&&(D=g?[]:'')},Aa={add:function(){return D&&(g&&!c&&(Z=D.length-1,G.push(g)),function Ua(Ra){b.each(Ra,function(zb,ab){b.isFunction(ab)?a.unique&&Aa.has(ab)||D.push(ab):ab&&ab.length&&'string'!==b.type(ab)&&Ua(ab)})}(arguments),g&&!c&&qa()),this},remove:function(){return b.each(arguments,
function(ta,Ra){for(var Ua;-1<(Ua=b.inArray(Ra,D,Ua));)D.splice(Ua,1),Z>=Ua&&Z--}),this},has:function(ta){return ta?-1<b.inArray(ta,D):0<D.length},empty:function(){return D&&=[],this},disable:function(){return l=G=[],D=g='',this},disabled:function(){return!D},lock:function(){return l=!0,g||Aa.disable(),this},locked:function(){return!!l},fireWith:function(ta,Ra){return l||(Ra=Ra||[],Ra=[ta,Ra.slice?Ra.slice():Ra],G.push(Ra),c||qa()),this},fire:function(){return Aa.fireWith(this,arguments),this},fired:function(){return!!k}};
...
nb.call(arguments),k=g.length,l=1!==k||a&&b.isFunction(a.promise)?k:0,D=1===l?a:b.Deferred(),G=function(ta,Ra,Ua){return function(zb){Ra[ta]=this;Ua[ta]=1<arguments.length?nb.call(arguments):zb;Ua===qa?D.notifyWith(Ra,Ua):--l||D.resolveWith(Ra,Ua)}},Z;if(1<k){var qa=Array(k);var Aa=Array(k);for(Z=Array(k);k>c;c++)g[c]&&b.isFunction(g[c].promise)?g[c].promise().progress(G(c,Aa,qa)).done(G(c,Z,g)).fail(D.reject):--l}return l||D.resolveWith(Z,g),D.promise()}});var ya;b.fn.ready=function(a){return b.ready.promise().done(a),
this};b.extend({isReady:!1,readyWait:1,holdReady:function(a){a?b.readyWait++:b.ready(!0)},ready:function(a){(!0===a?--b.readyWait:b.isReady)||(b.isReady=!0,!0!==a&&0<--b.readyWait||(ya.resolveWith(Ma,[b]),b.fn.triggerHandler&&(b(Ma).triggerHandler('ready'),b(Ma).off('ready'))))}});b.ready.promise=function(a){if(!ya)if(ya=b.Deferred(),'complete'===Ma.readyState||'loading'!==Ma.readyState&&!Ma.documentElement.doScroll)E.setTimeout(b.ready);else if(Ma.addEventListener)Ma.addEventListener('DOMContentLoaded',
X),E.addEventListener('load',X);else{Ma.attachEvent('onreadystatechange',X);E.attachEvent('onload',X);var c=!1;try{c=null==E.frameElement&&Ma.documentElement}catch(g){}c&&c.doScroll&&!function k(){if(!b.isReady){try{c.doScroll('left')}catch(l){return E.setTimeout(k,50)}oa();b.ready()}}()}return ya.promise(a)};b.ready.promise();for(var Ya in b(e))break;e.ownFirst='0'===Ya;e.inlineBlockNeedsLayout=!1;b(function(){var a,c,g,k;(g=Ma.getElementsByTagName('body')[0])&&g.style&&(c=Ma.createElement('div'),
k=Ma.createElement('div'),k.style.cssText='position:absolute;border:0;width:0;height:0;top:0;left:-9999px',g.appendChild(k).appendChild(c),'undefined'!=typeof c.style.zoom&&(c.style.cssText='display:inline;margin:0;border:0;padding:1px;width:1px;zoom:1',e.inlineBlockNeedsLayout=a=3===c.offsetWidth,a&&(g.style.zoom=1)),g.removeChild(k))});(function(){var a=Ma.createElement('div');e.deleteExpando=!0;try{delete a.test}catch(c){e.deleteExpando=!1}})();var Ta=function(a){var c=b.noData[(a.nodeName+' ').toLowerCase()],
g=+a.nodeType||1;return 1!==g&&9!==g?!1:!c||!0!==c&&a.getAttribute('classid')===c},tb=/^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,Ab=/([A-Z])/g;b.extend({cache:{},noData:{'applet ':!0,'embed ':!0,'object ':'clsid:D27CDB6E-AE6D-11cf-96B8-444553540000'},hasData:function(a){return a=a.nodeType?b.cache[a[b.expando]]:a[b.expando],!!a&&!m(a)},data:function(a,c,g){return S(a,c,g)},removeData:function(a,c){return p(a,c)},_data:function(a,c,g){return S(a,c,g,!0)},_removeData:function(a,c){return p(a,c,!0)}});b.fn.extend({data:function(a,
...
(c.style.cssText='-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:1px;width:1px;zoom:1',c.appendChild(Ma.createElement('div')).style.width='5px',a=3!==c.offsetWidth),g.removeChild(k),a):void 0}})();var Ib=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,eb=new RegExp('^(?:([+-])=|)('+Ib+')([a-z%]*)$','i'),Bb=['Top','Right','Bottom','Left'],Vb=function(a,c){return a=c||a,'none'===b.css(a,'display')||!b.contains(a.ownerDocument,a)},
Xa=function(a,c,g,k,l,D,G){var Z=0,qa=a.length,Aa=null==g;if('object'===b.type(g))for(Z in l=!0,g)Xa(a,c,Z,g[Z],!0,D,G);else if(void 0!==k&&(l=!0,b.isFunction(k)||(G=!0),Aa&&(G?(c.call(a,k),c=null):(Aa=c,c=function(ta,Ra,Ua){return Aa.call(b(ta),Ua)})),c))for(;qa>Z;Z++)c(a[Z],g,G?k:k.call(a[Z],Z,c(a[Z],g)));return l?a:Aa?c.call(a):qa?c(a[0],g):D},gb=/^(?:checkbox|radio)$/i,ia=/<([\w:-]+)/,Y=/^$|\/(?:java|ecma)script/i,ka=/^\s+/;!function(){var a=Ma.createElement('div'),c=Ma.createDocumentFragment(),
...
var db=/^(?:input|select|textarea)$/i,Pa=/^key/,xb=/^(?:mouse|pointer|contextmenu|drag|drop)|click/,kb=/^(?:focusinfocus|focusoutblur)$/,pb=/^([^.]*)(?:\.(.+)|)/;b.event={global:{},add:function(a,c,g,k,l){var D,G,Z,qa,Aa,ta,Ra,Ua;if(G=b._data(a)){g.handler&&(Z=g,g=Z.handler,l=Z.selector);g.guid||(g.guid=b.guid++);(D=G.events)||(D=G.events={});(Aa=G.handle)||(Aa=G.handle=function(Jb){return'undefined'==typeof b||Jb&&b.event.triggered===Jb.type?void 0:b.event.dispatch.apply(Aa.elem,arguments)},Aa.elem=
a);c=(c||'').match(Ba)||[''];for(G=c.length;G--;){var zb=pb.exec(c[G])||[];var ab=Ua=zb[1];zb=(zb[2]||'').split('.').sort();ab&&(qa=b.event.special[ab]||{},ab=(l?qa.delegateType:qa.bindType)||ab,qa=b.event.special[ab]||{},ta=b.extend({type:ab,origType:Ua,data:k,handler:g,guid:g.guid,selector:l,needsContext:l&&b.expr.match.needsContext.test(l),namespace:zb.join('.')},Z),(Ra=D[ab])||(Ra=D[ab]=[],Ra.delegateCount=0,qa.setup&&!1!==qa.setup.call(a,k,zb,Aa)||(a.addEventListener?a.addEventListener(ab,Aa,
!1):a.attachEvent&&a.attachEvent('on'+ab,Aa))),qa.add&&(qa.add.call(a,ta),ta.handler.guid||(ta.handler.guid=g.guid)),l?Ra.splice(Ra.delegateCount++,0,ta):Ra.push(ta),b.event.global[ab]=!0)}a=null}},remove:function(a,c,g,k,l){var D,G,Z,qa,Aa,ta,Ra,Ua,zb=b.hasData(a)&&b._data(a);if(zb&&(Aa=zb.events)){c=(c||'').match(Ba)||[''];for(qa=c.length;qa--;)if(G=pb.exec(c[qa])||[],ta=Ua=G[1],Ra=(G[2]||'').split('.').sort(),ta){var ab=b.event.special[ta]||{};ta=(k?ab.delegateType:ab.bindType)||ta;var Jb=Aa[ta]||
[];G=G[2]&&new RegExp('(^|\\.)'+Ra.join('\\.(?:.*\\.|)')+'(\\.|$)');for(Z=D=Jb.length;D--;){var lc=Jb[D];!l&&Ua!==lc.origType||g&&g.guid!==lc.guid||G&&!G.test(lc.namespace)||k&&k!==lc.selector&&('**'!==k||!lc.selector)||(Jb.splice(D,1),lc.selector&&Jb.delegateCount--,ab.remove&&ab.remove.call(a,lc))}Z&&!Jb.length&&(ab.teardown&&!1!==ab.teardown.call(a,Ra,zb.handle)||b.removeEvent(a,ta,zb.handle),delete Aa[ta])}else for(ta in Aa)b.event.remove(a,ta+c[qa],g,k,!0);b.isEmptyObject(Aa)&&(delete zb.handle,
b._removeData(a,'events'))}},trigger:function(a,c,g,k){var l,D,G,Z,qa=[g||Ma],Aa=M.call(a,'type')?a.type:a;var ta=M.call(a,'namespace')?a.namespace.split('.'):[];if(G=l=g=g||Ma,3!==g.nodeType&&8!==g.nodeType&&!kb.test(Aa+b.event.triggered)&&(-1<Aa.indexOf('.')&&(ta=Aa.split('.'),Aa=ta.shift(),ta.sort()),D=0>Aa.indexOf(':')&&'on'+Aa,a=a[b.expando]?a:new b.Event(Aa,'object'==typeof a&&a),a.isTrigger=k?2:3,a.namespace=ta.join('.'),a.rnamespace=a.namespace?new RegExp('(^|\\.)'+ta.join('\\.(?:.*\\.|)')+
'(\\.|$)'):null,a.result=void 0,a.target||(a.target=g),c=null==c?[a]:b.makeArray(c,[a]),Z=b.event.special[Aa]||{},k||!Z.trigger||!1!==Z.trigger.apply(g,c))){if(!k&&!Z.noBubble&&!b.isWindow(g)){var Ra=Z.delegateType||Aa;for(kb.test(Ra+Aa)||(G=G.parentNode);G;G=G.parentNode)qa.push(G),l=G;l===(g.ownerDocument||Ma)&&qa.push(l.defaultView||l.parentWindow||E)}for(ta=0;(G=qa[ta++])&&!a.isPropagationStopped();)a.type=1<ta?Ra:Z.bindType||Aa,(l=(b._data(G,'events')||{})[a.type]&&b._data(G,'handle'))&&l.apply(G,
c),(l=D&&G[D])&&l.apply&&Ta(G)&&(a.result=l.apply(G,c),!1===a.result&&a.preventDefault());if(a.type=Aa,!(k||a.isDefaultPrevented()||Z._default&&!1!==Z._default.apply(qa.pop(),c))&&Ta(g)&&D&&g[Aa]&&!b.isWindow(g)){(l=g[D])&&(g[D]=null);b.event.triggered=Aa;try{g[Aa]()}catch(Ua){}b.event.triggered=void 0;l&&(g[D]=l)}return a.result}},dispatch:function(a){a=b.event.fix(a);var c,g,k,l,D=nb.call(arguments);var G=(b._data(this,'events')||{})[a.type]||[];var Z=b.event.special[a.type]||{};if(D[0]=a,a.delegateTarget=
...
typeof a){for(l in a)this.off(l,c,a[l]);return this}return!1!==c&&'function'!=typeof c||(g=c,c=void 0),!1===g&&(g=z),this.each(function(){b.event.remove(this,a,g,c)})},trigger:function(a,c){return this.each(function(){b.event.trigger(a,c,this)})},triggerHandler:function(a,c){var g=this[0];return g?b.event.trigger(a,c,g,!0):void 0}});var qb=/ jQuery\d+="(?:null|\d+)"/g,sb=RegExp('<(?:abbr|article|aside|audio|bdi|canvas|data|datalist|details|dialog|figcaption|figure|footer|header|hgroup|main|mark|meter|nav|output|picture|progress|section|summary|template|time|video)[\\s/>]',
'i'),mb=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi,Nb=/<script|<style|<link/i,Eb=/checked\s*(?:[^=]|=\s*.checked.)/i,Hb=/^true\/(.*)/,Kb=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,$b=za(Ma).appendChild(Ma.createElement('div'));b.extend({htmlPrefilter:function(a){return a.replace(mb,'<$1></$2>')},clone:function(a,c,g){var k,l,D,G=b.contains(a.ownerDocument,a);if(e.html5Clone||b.isXMLDoc(a)||!sb.test('<'+a.nodeName+'>')?l=a.cloneNode(!0):($b.innerHTML=a.outerHTML,$b.removeChild(l=
$b.firstChild)),!(e.noCloneEvent&&e.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||b.isXMLDoc(a))){var Z=N(l);var qa=N(a);for(D=0;null!=(k=qa[D]);++D)if(Z[D]){var Aa=void 0,ta,Ra=k,Ua=Z[D];if(1===Ua.nodeType){if(ta=Ua.nodeName.toLowerCase(),!e.noCloneEvent&&Ua[b.expando]){k=b._data(Ua);for(Aa in k.events)b.removeEvent(Ua,Aa,k.handle);Ua.removeAttribute(b.expando)}'script'===ta&&Ua.text!==Ra.text?(v(Ua).text=Ra.text,F(Ua)):'object'===ta?(Ua.parentNode&&(Ua.outerHTML=Ra.outerHTML),e.html5Clone&&Ra.innerHTML&&
!b.trim(Ua.innerHTML)&&(Ua.innerHTML=Ra.innerHTML)):'input'===ta&&gb.test(Ra.type)?(Ua.defaultChecked=Ua.checked=Ra.checked,Ua.value!==Ra.value&&(Ua.value=Ra.value)):'option'===ta?Ua.defaultSelected=Ua.selected=Ra.defaultSelected:'input'!==ta&&'textarea'!==ta||(Ua.defaultValue=Ra.defaultValue)}}}if(c)if(g)for(qa=qa||N(a),Z=Z||N(l),D=0;null!=(k=qa[D]);D++)H(k,Z[D]);else H(a,l);return Z=N(l,'script'),0<Z.length&&L(Z,!G&&N(a,'script')),l},cleanData:function(a,c){for(var g,k,l,D,G=0,Z=b.expando,qa=b.cache,
Aa=e.attributes,ta=b.event.special;null!=(g=a[G]);G++)if((c||Ta(g))&&(l=g[Z],D=l&&qa[l])){if(D.events)for(k in D.events)ta[k]?b.event.remove(g,k):b.removeEvent(g,k,D.handle);qa[l]&&(delete qa[l],Aa||'undefined'==typeof g.removeAttribute?g[Z]=void 0:g.removeAttribute(Z),jb.push(l))}}});b.fn.extend({domManip:R,detach:function(a){return sa(this,a,!0)},remove:function(a){return sa(this,a)},text:function(a){return Xa(this,function(c){return void 0===c?b.text(this):this.empty().append((this[0]&&this[0].ownerDocument||
...
Z.innerHTML='';G.appendChild(Z);e.boxSizing=''===Z.style.boxSizing||''===Z.style.MozBoxSizing||''===Z.style.WebkitBoxSizing;b.extend(e,{reliableHiddenOffsets:function(){return null==a&&qa(),k},boxSizingReliable:function(){return null==a&&qa(),g},pixelMarginRight:function(){return null==a&&qa(),c},pixelPosition:function(){return null==a&&qa(),a},reliableMarginRight:function(){return null==a&&qa(),l},reliableMarginLeft:function(){return null==a&&qa(),D}});function qa(){var Aa,ta,Ra=Ma.documentElement;
Ra.appendChild(G);Z.style.cssText='-webkit-box-sizing:border-box;box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%';a=g=D=!1;c=l=!0;E.getComputedStyle&&(ta=E.getComputedStyle(Z),a='1%'!==(ta||{}).top,D='2px'===(ta||{}).marginLeft,g='4px'===(ta||{width:'4px'}).width,Z.style.marginRight='50%',c='4px'===(ta||{marginRight:'4px'}).marginRight,Aa=Z.appendChild(Ma.createElement('div')),Aa.style.cssText=Z.style.cssText='-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0',
...
c){b.cssHooks[a+c]={expand:function(g){var k=0,l={};for(g='string'==typeof g?g.split(' '):[g];4>k;k++)l[a+Bb[k]+c]=g[k]||g[k-2]||g[0];return l}};qc.test(a)||(b.cssHooks[a+c].set=pa)});b.fn.extend({css:function(a,c){return Xa(this,function(g,k,l){var D,G={},Z=0;if(b.isArray(k)){l=xc(g);for(D=k.length;D>Z;Z++)G[k[Z]]=b.css(g,k[Z],!1,l);return G}return void 0!==l?b.style(g,k,l):b.css(g,k)},a,c,1<arguments.length)},show:function(){return fa(this,!0)},hide:function(){return fa(this)},toggle:function(a){return'boolean'==
...
{tweeners:{'*':[function(a,c){var g=this.createTween(a,c);return da(g.elem,a,eb.exec(c),g),g}]},tweener:function(a,c){b.isFunction(a)?(c=a,a=['*']):a=a.match(Ba);for(var g,k=0,l=a.length;l>k;k++)g=a[k],Na.tweeners[g]=Na.tweeners[g]||[],Na.tweeners[g].unshift(c)},prefilters:[function(a,c,g){var k,l,D,G,Z,qa,Aa,ta=this,Ra={},Ua=a.style,zb=a.nodeType&&Vb(a),ab=b._data(a,'fxshow');g.queue||(G=b._queueHooks(a,'fx'),null==G.unqueued&&(G.unqueued=0,Z=G.empty.fire,G.empty.fire=function(){G.unqueued||Z()}),
G.unqueued++,ta.always(function(){ta.always(function(){G.unqueued--;b.queue(a,'fx').length||G.empty.fire()})}));1===a.nodeType&&('height'in c||'width'in c)&&(g.overflow=[Ua.overflow,Ua.overflowX,Ua.overflowY],qa=b.css(a,'display'),Aa='none'===qa?b._data(a,'olddisplay')||ca(a.nodeName):qa,'inline'===Aa&&'none'===b.css(a,'float')&&(e.inlineBlockNeedsLayout&&'inline'!==ca(a.nodeName)?Ua.zoom=1:Ua.display='inline-block'));g.overflow&&(Ua.overflow='hidden',e.shrinkWrapBlocks()||ta.always(function(){Ua.overflow=
g.overflow[0];Ua.overflowX=g.overflow[1];Ua.overflowY=g.overflow[2]}));for(k in c)if(l=c[k],Ld.exec(l)){if(delete c[k],D=D||'toggle'===l,l===(zb?'hide':'show')){if('show'!==l||!ab||void 0===ab[k])continue;zb=!0}Ra[k]=ab&&ab[k]||b.style(a,k)}else qa=void 0;if(b.isEmptyObject(Ra))'inline'===('none'===qa?ca(a.nodeName):qa)&&(Ua.display=qa);else for(k in ab?'hidden'in ab&&(zb=ab.hidden):ab=b._data(a,'fxshow',{}),D&&(ab.hidden=!zb),zb?b(a).show():ta.done(function(){b(a).hide()}),ta.done(function(){var Jb;
b._removeData(a,'fxshow');for(Jb in Ra)b.style(a,Jb,Ra[Jb])}),Ra)c=cb(zb?ab[k]:0,k,ta),k in ab||(ab[k]=c.start,zb&&(c.end=c.start,c.start='width'===k||'height'===k?1:0))}],prefilter:function(a,c){c?Na.prefilters.unshift(a):Na.prefilters.push(a)}});b.speed=function(a,c,g){var k=a&&'object'==typeof a?b.extend({},a):{complete:g||!g&&c||b.isFunction(a)&&a,duration:a,easing:g&&c||c&&!b.isFunction(c)&&c};return k.duration=b.fx.off?0:'number'==typeof k.duration?k.duration:k.duration in b.fx.speeds?b.fx.speeds[k.duration]:
...
c):void 0}};e.checkOn||(b.valHooks[this].get=function(a){return null===a.getAttribute('value')?'on':a.value})});var Kc,Bc=b.expr.attrHandle,cd=/^(?:checked|selected)$/i,Fc=e.getSetAttribute,Uc=e.input;b.fn.extend({attr:function(a,c){return Xa(this,b.attr,a,c,1<arguments.length)},removeAttr:function(a){return this.each(function(){b.removeAttr(this,a)})}});b.extend({attr:function(a,c,g){var k,l,D=a.nodeType;if(3!==D&&8!==D&&2!==D)return'undefined'==typeof a.getAttribute?b.prop(a,c,g):(1===D&&b.isXMLDoc(a)||
...
Rd=/^(?:a|area)$/i;b.fn.extend({prop:function(a,c){return Xa(this,b.prop,a,c,1<arguments.length)},removeProp:function(a){return a=b.propFix[a]||a,this.each(function(){try{this[a]=void 0,delete this[a]}catch(c){}})}});b.extend({prop:function(a,c,g){var k,l,D=a.nodeType;if(3!==D&&8!==D&&2!==D)return 1===D&&b.isXMLDoc(a)||(c=b.propFix[c]||c,l=b.propHooks[c]),void 0!==g?l&&'set'in l&&void 0!==(k=l.set(a,g,c))?k:a[c]=g:l&&'get'in l&&null!==(k=l.get(a,c))?k:a[c]},propHooks:{tabIndex:{get:function(a){var c=
...
b.each('tabIndex readOnly maxLength cellSpacing cellPadding rowSpan colSpan useMap frameBorder contentEditable'.split(' '),function(){b.propFix[this.toLowerCase()]=this});e.enctype||(b.propFix.enctype='encoding');var dd=/[\t\r\n\f]/g;b.fn.extend({addClass:function(a){var c,g,k,l,D,G,Z=0;if(b.isFunction(a))return this.each(function(qa){b(this).addClass(a.call(this,qa,Wa(this)))});if('string'==typeof a&&a)for(c=a.match(Ba)||[];g=this[Z++];)if(l=Wa(g),k=1===g.nodeType&&(' '+l+' ').replace(dd,' ')){for(G=
0;D=c[G++];)0>k.indexOf(' '+D+' ')&&(k+=D+' ');k=b.trim(k);l!==k&&b.attr(g,'class',k)}return this},removeClass:function(a){var c,g,k,l,D,G,Z=0;if(b.isFunction(a))return this.each(function(qa){b(this).removeClass(a.call(this,qa,Wa(this)))});if(!arguments.length)return this.attr('class','');if('string'==typeof a&&a)for(c=a.match(Ba)||[];g=this[Z++];)if(l=Wa(g),k=1===g.nodeType&&(' '+l+' ').replace(dd,' ')){for(G=0;D=c[G++];)for(;-1<k.indexOf(' '+D+' ');)k=k.replace(' '+D+' ',' ');k=b.trim(k);l!==k&&
b.attr(g,'class',k)}return this},toggleClass:function(a,c){var g=typeof a;return'boolean'==typeof c&&'string'===g?c?this.addClass(a):this.removeClass(a):b.isFunction(a)?this.each(function(k){b(this).toggleClass(a.call(this,k,Wa(this),c),c)}):this.each(function(){var k,l;if('string'===g){var D=0;var G=b(this);for(l=a.match(Ba)||[];k=l[D++];)G.hasClass(k)?G.removeClass(k):G.addClass(k)}else void 0!==a&&'boolean'!==g||(k=Wa(this),k&&b._data(this,'__className__',k),b.attr(this,'class',k||!1===a?'':b._data(this,
'__className__')||''))})},hasClass:function(a){var c,g=0;for(a=' '+a+' ';c=this[g++];)if(1===c.nodeType&&-1<(' '+Wa(c)+' ').replace(dd,' ').indexOf(a))return!0;return!1}});b.each('blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu'.split(' '),function(a,c){b.fn[c]=function(g,k){return 0<arguments.length?this.on(c,null,g,k):this.trigger(c)}});b.fn.extend({hover:function(a,
...
text:'responseText',json:'responseJSON'},converters:{'* text':String,'text html':!0,'text json':b.parseJSON,'text xml':b.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(a,c){return c?fb(fb(a,b.ajaxSettings),c):fb(b.ajaxSettings,a)},ajaxPrefilter:rb(rd),ajaxTransport:rb(Xc),ajax:function(a,c){function g(Db,Qb,Tb,ub){var kc,hc,Xb,fc=Qb;if(2!==mc){mc=2;G&&E.clearTimeout(G);qa=void 0;D=ub||'';wb.readyState=0<Db?4:0;ub=200<=Db&&300>Db||304===Db;if(Tb){var Ub=ta;for(var oc=wb,Cb,bc,Zb,Sb,
Jc=Ub.contents,pc=Ub.dataTypes;'*'===pc[0];)pc.shift(),void 0===bc&&(bc=Ub.mimeType||oc.getResponseHeader('Content-Type'));if(bc)for(Sb in Jc)if(Jc[Sb]&&Jc[Sb].test(bc)){pc.unshift(Sb);break}if(pc[0]in Tb)Zb=pc[0];else{for(Sb in Tb){if(!pc[0]||Ub.converters[Sb+' '+pc[0]]){Zb=Sb;break}Cb||=Sb}Zb=Zb||Cb}Ub=Zb?(Zb!==pc[0]&&pc.unshift(Zb),Tb[Zb]):void 0}a:{Tb=ta;Cb=Ub;bc=wb;Zb=ub;var cc,uc,vc;Ub={};oc=Tb.dataTypes.slice();if(oc[1])for(cc in Tb.converters)Ub[cc.toLowerCase()]=Tb.converters[cc];for(Sb=
oc.shift();Sb;)if(Tb.responseFields[Sb]&&(bc[Tb.responseFields[Sb]]=Cb),!vc&&Zb&&Tb.dataFilter&&(Cb=Tb.dataFilter(Cb,Tb.dataType)),vc=Sb,Sb=oc.shift())if('*'===Sb)Sb=vc;else if('*'!==vc&&vc!==Sb){if(cc=Ub[vc+' '+Sb]||Ub['* '+Sb],!cc)for(nc in Ub)if(uc=nc.split(' '),uc[1]===Sb&&(cc=Ub[vc+' '+uc[0]]||Ub['* '+uc[0]])){!0===cc?cc=Ub[nc]:!0!==Ub[nc]&&(Sb=uc[0],oc.unshift(uc[1]));break}if(!0!==cc)if(cc&&Tb['throws'])Cb=cc(Cb);else try{Cb=cc(Cb)}catch($c){var nc={state:'parsererror',error:cc?$c:'No conversion from '+
vc+' to '+Sb};break a}}nc={state:'success',data:Cb}}Ub=nc;ub?(ta.ifModified&&(Xb=wb.getResponseHeader('Last-Modified'),Xb&&(b.lastModified[ic]=Xb),Xb=wb.getResponseHeader('etag'),Xb&&(b.etag[ic]=Xb)),204===Db||'HEAD'===ta.type?fc='nocontent':304===Db?fc='notmodified':(fc=Ub.state,kc=Ub.data,hc=Ub.error,ub=!hc)):(hc=fc,!Db&&fc||(fc='error',0>Db&&(Db=0)));wb.status=Db;wb.statusText=(Qb||fc)+'';ub?zb.resolveWith(Ra,[kc,fc,wb]):zb.rejectWith(Ra,[wb,fc,hc]);wb.statusCode(Jb);Jb=void 0;Z&&Ua.trigger(ub?
'ajaxSuccess':'ajaxError',[wb,ta,ub?kc:hc]);ab.fireWith(Ra,[wb,fc]);Z&&(Ua.trigger('ajaxComplete',[wb,ta]),--b.active||b.event.trigger('ajaxStop'))}}'object'==typeof a&&(c=a,a=void 0);c=c||{};var k,l,D,G,Z,qa,Aa,ta=b.ajaxSetup({},c),Ra=ta.context||ta,Ua=ta.context&&(Ra.nodeType||Ra.jquery)?b(Ra):b.event,zb=b.Deferred(),ab=b.Callbacks('once memory'),Jb=ta.statusCode||{},lc={},Ic={},mc=0,yc='canceled',wb={readyState:0,getResponseHeader:function(Db){var Qb;if(2===mc){if(!Aa)for(Aa={};Qb=Vd.exec(D);)Aa[Qb[1].toLowerCase()]=
Qb[2];Qb=Aa[Db.toLowerCase()]}return null==Qb?null:Qb},getAllResponseHeaders:function(){return 2===mc?D:null},setRequestHeader:function(Db,Qb){var Tb=Db.toLowerCase();return mc||(Db=Ic[Tb]=Ic[Tb]||Db,lc[Db]=Qb),this},overrideMimeType:function(Db){return mc||(ta.mimeType=Db),this},statusCode:function(Db){var Qb;if(Db)if(2>mc)for(Qb in Db)Jb[Qb]=[Jb[Qb],Db[Qb]];else wb.always(Db[wb.status]);return this},abort:function(Db){Db=Db||yc;return qa&&qa.abort(Db),g(0,Db),this}};if(zb.promise(wb).complete=ab.add,
...
'\r\n')}}):{name:c.name,value:a.replace(td,'\r\n')}}).get()}});b.ajaxSettings.xhr=void 0!==E.ActiveXObject?function(){return this.isLocal?Gb():8<Ma.documentMode?ib():/^(get|post|head|put|delete|options)$/i.test(this.type)&&ib()||Gb()}:ib;var ae=0,Vc={},Wc=b.ajaxSettings.xhr();E.attachEvent&&E.attachEvent('onunload',function(){for(var a in Vc)Vc[a](void 0,!0)});e.cors=!!Wc&&'withCredentials'in Wc;(Wc=e.ajax=!!Wc)&&b.ajaxTransport(function(a){if(!a.crossDomain||e.cors){var c;return{send:function(g,
...
{};var ta=D.status;'string'==typeof D.responseText&&(Aa.text=D.responseText);try{var Ra=D.statusText}catch(Ua){Ra=''}ta||!a.isLocal||a.crossDomain?1223===ta&&(ta=204):ta=Aa.text?200:404}Aa&&k(ta,Ra,Aa,D.getAllResponseHeaders())};a.async?4===D.readyState?E.setTimeout(c):D.onreadystatechange=Vc[G]=c:c()},abort:function(){c&&c(void 0,!0)}}}});b.ajaxSetup({accepts:{script:'text/javascript, application/javascript, application/ecmascript, application/x-ecmascript'},contents:{script:/\b(?:java|ecma)script\b/},
...
b.offset={setOffset:function(a,c,g){var k,l,D,G=b.css(a,'position'),Z=b(a),qa={};'static'===G&&(a.style.position='relative');var Aa=Z.offset();var ta=b.css(a,'top');var Ra=b.css(a,'left');('absolute'===G||'fixed'===G)&&-1<b.inArray('auto',[ta,Ra])?(k=Z.position(),D=k.top,l=k.left):(D=parseFloat(ta)||0,l=parseFloat(Ra)||0);b.isFunction(c)&&(c=c.call(a,g,b.extend({},Aa)));null!=c.top&&(qa.top=c.top-Aa.top+D);null!=c.left&&(qa.left=c.left-Aa.left+l);'using'in c?c.using.call(a,qa):Z.css(qa)}};b.fn.extend({offset:function(a){if(arguments.length)return void 0===
...
b.fn[a]=function(k){return Xa(this,function(l,D,G){var Z=Ob(l);return void 0===G?Z?c in Z?Z[c]:Z.document.documentElement[D]:l[D]:void(Z?Z.scrollTo(g?b(Z).scrollLeft():G,g?G:b(Z).scrollTop()):l[D]=G)},a,k,arguments.length,null)}});b.each(['top','left'],function(a,c){b.cssHooks[c]=ea(e.pixelPosition,function(g,k){return k?(k=sc(g,c),Mb.test(k)?b(g).position()[c]+'px':k):void 0})});b.each({Height:'height',Width:'width'},function(a,c){b.each({padding:'inner'+a,content:c,'':'outer'+a},function(g,k){b.fn[k]=
function(l,D){var G=arguments.length&&(g||'boolean'!=typeof l),Z=g||(!0===l||!0===D?'margin':'border');return Xa(this,function(qa,Aa,ta){var Ra;return b.isWindow(qa)?qa.document.documentElement['client'+a]:9===qa.nodeType?(Ra=qa.documentElement,Math.max(qa.body['scroll'+a],Ra['scroll'+a],qa.body['offset'+a],Ra['offset'+a],Ra['client'+a])):void 0===ta?b.css(qa,Aa,Z):b.style(qa,Aa,ta,Z)},c,G?l:void 0,G,null)}})});b.fn.extend({bind:function(a,c,g){return this.on(a,null,c,g)},unbind:function(a,c){return this.off(a,
...
function Collection(E,O){var ha='undefined'!==typeof module&&module.exports?!1:!0,Ca=ha?require('vendor/uuid'):require('uuid'),K=ha?require('utils/merge'):require('../../../lib/merge'),U={isCaseSensitive:{false:{re:'^%s$',modifiers:'i'},true:{re:'^%s$'}}},oa=!1,X=!1,V=null;ha={useLocalStorage:!1,locale:'en',searchOptionRules:U};O='object'==typeof O?K(O,ha):ha;var m=['not null'],S=function(C){try{return eval(C)}catch(B){throw Error('Could not evaluate condition `'+C+'`.\n'+B.stack);}};if('undefined'==
typeof E||''==E||null==E)E=[];if(!Array.isArray(E))throw Error('`new Collection([content] [, options] )`: `content` argument must be an Array !');E=E?JSON.clone(E):[];for(var p=[],da=ha=0,za=E.length;da<za;++da)E[da]||(E[da]={}),E[da]._uuid=Ca.v4(),p[ha]=E[da]._uuid,++ha;var N=E;N.setSearchOption=function(){if(!arguments.length)throw Error('searchOption cannot be left blank');if(3<arguments.length||3>arguments.length&&1<arguments.length)throw Error('argument length mismatch');var C=0,B=arguments.length;
...
q=null===C[fa]||/(boolean|number)/.test(typeof C[fa])?C[fa]:C[fa].toLocaleLowerCase();sa=/\./.test(fa)?/\[\*\]/.test(fa)?ea(C[fa],fa,y[Ja],R,0):ca(C[fa],fa,y[Ja],R):T(C[fa],fa,y[Ja][fa],R,H);R=sa.matched}if(R==u)if(oa&&X&&0>p.indexOf(y[Ja]._uuid)||X||!oa){if(!oa||oa&&0>J.indexOf(y[Ja]._uuid)||X)J[z]=y[Ja],++z}else oa&&!X&&0>J.indexOf(y[Ja]._uuid)&&(J[z]=y[Ja],++z)}}else J=E;V=null;J.insert=N.insert;J.notIn=N.notIn;J.find=this.find;J.update=N.update;J.replace=N.replace;J.or=N.or;J.findOne=N.findOne;
...
function FormValidatorUtil(E,O,ha,Ca){var K='undefined'!==typeof module&&module.exports?!1:!0,U=K?require('utils/merge'):require('../../../../../lib/merge');K||require('../../../../../helpers');K&&require('helpers/dateFormat');var oa=K?require('utils/routing'):require('../../../../../lib/routing'),X=function(){var u=!1,z=null;K?K&&'undefined'!=typeof gina.forms&&(z=gina.forms):z=getContext('gina').forms||null;z&&'undefined'!=typeof z.validators&&(u=!0);return u},V={errors:{},keys:{'%l':'label','%n':'name',
...
''),V.data[this.name]=V.data[this.name]=this.value,m[this.name]};m[u].exclude=function(q){if('boolean'==typeof q&&!q)return/^true|false$/i.test(this.value)&&(this.value=/^true$/i.test(this.value)?!0:!1,V.data[this.name]=this.value),m[this.name];this.isExcluded=!1;0>V.excluded.indexOf(this.name)&&(V.excluded.push(this.name),this.isExcluded=!0);return m[this.name]};m[u].query=L;m[u].getValidationContext=function(){return{isGFFCtx:K,self:m,local:V,replace:B}};if(X()){y=z=null;try{for(let q in gina.forms.validators)y=
...
p.host=da.envConf[m][S].host,p.webroot=da.envConf[m][S].server.webroot;return p};O.compareUrls=async function(m,S,p,da,za){'undefined'==typeof p&&(p={routing:{}});if(/,/.test(S)){var N=0;S=S.split(/,/g);for(var L=S.length,C={past:!1,request:p};N<L&&!C.past;)C=await U(m,S[N],p,da,za),++N;return C}return await U(m,S,p,da,za)};var U=async function(m,S,p,da,za){var N=m.url.split(/\//);S=S.split(/\//);var L=0,C=0,B=S.length,u=0,z={},y=0,J=p.method.toLowerCase(),q=m.method.toLowerCase(),v=!1;if('undefined'!=
...
u,J):q.get(y,u))};/:/.test(da.url)&&(S=da.url.match(/(:(.*)\/|:(.*)$)/g).map(function(B){return B.replace(/\//g,'')}).join(', '),L='[ RoutingHelper::getRoute(rule[, bundle, method]) ] : route [ %r ] param placeholder not defined: `'+da.url+'` !\n Check your route description to compare requirements against param variables [ '+S+']',L=L.replace(/%r/,m),console.warn(Error(L)));return da};O.getRouteByUrl=function(m,S,p,da,za){2==arguments.length&&'undefined'!=typeof arguments[1]&&-1<O.allowedMethods.indexOf(arguments[1].toLowerCase())&&
...
var K=K||require('vendor/uuid'),U=U||require('helpers/dateFormat'),oa={bucket:'default'},X={},V=null,m={},S={},p=['not null'],da={bucket:void 0,drop:function(){V.removeItem(oa.bucket);X=null;for(var L in this)delete this[L];return X},Collection:O},za={insert:function(L){L._id=K.v1();L._createdAt=(new Date).format('isoDateTime');L._updatedAt=(new Date).format('isoDateTime');S[this._collection][S[this._collection].length]=L;V.setItem(this._bucket,JSON.stringify(S))},find:function(L,C){if(!L)return S[this._collection];
...
typeof L&&'undefined'!=typeof L)throw Error('`options` must be an object');'undefined'==typeof L&&(L={});oa=Ca(L,oa);V=window.localStorage;L=oa.bucket;if(!V.getItem(L)&&void 0!=L)V.setItem(L,JSON.stringify(S));else if(void 0==L)throw Error('`bucket` name cannot be undefined');X.bucket=L;X=Ca(X,da)})(E);return X}
...
var oa=K?require('vendor/uuid'):require('uuid'),X=K?require('utils/merge'):require('../../../../../lib/merge'),V=K?require('utils/inherits'):require('../../../../../lib/inherits'),m=K?require('utils/form-validator'):require('./form-validator'),S=K?require('utils/routing'):require('../../../../../lib/routing'),p={id:'validator-'+oa.v4(),plugin:this.plugin,on:K?on:null,eventData:{},target:K?document:null,errors:{},initialized:!1,isReady:!1,rules:{},$forms:{},getFormById:null,validateFormById:null,setOptions:null,
resetErrorsDisplay:null,resetFields:null},da={id:null,plugin:this.plugin,on:K?on:null,eventData:{},target:K?document:null,cachedErrors:{},binded:!1,unbinded:!1,withUserBindings:!1,rules:{},setOptions:null,send:null,isValidating:null,isSubmitting:null,submit:null,destroy:null,resetErrorsDisplay:null,resetFields:null},za={},N={},L=null,C={url:'',method:'GET',isSynchrone:!1,withCredentials:!1,headers:{'Content-Type':'application/x-www-form-urlencoded; charset=UTF-8','X-Requested-With':'XMLHttpRequest'}},
B=function(e,b,h){h='undefined'!=typeof h?{id:h}:null;var n={},x;for(x in b)n[x]=b[x];if('undefined'!=typeof e&&0<e.count()){try{Ia(e,''),Ka(e)}catch(r){throw r;}return M(h,n,null,p.rules)}return new m(n)},u=function(e){C=e=X(e,C)},z=function(e){var b=null;if(!p.$forms)throw Error('`$forms` collection not found');if('undefined'==typeof e)throw Error('[ FormValidator::getFormById(formId) ] `formId` is missing');e=e.replace(/#/,'');if(null!=document.getElementById(e)&&'undefined'==typeof p.$forms[e]){var h=
document.getElementById(e),n,x=typeof(0<za.count())?za:p.rules;h.getAttribute?(id=h.getAttribute('id')||'form.'+oa.v4(),id!==h.getAttribute('id')&&h.setAttribute('id',id)):(id='form.'+oa.v4(),h.setAttribute('id',id));h.id=da.id=id;if('undefined'!=typeof h.id&&'null'!=h.id&&''!=h.id){da.target=h;p.$forms[h.id]=X({},da);if(n=h.getAttribute('data-gina-form-rule')){n=n.replace(/\-|\//g,'.');if('undefined'==typeof x[n])throw Error('['+h.id+'] no rule found with key: `null`');n=x[n]}'string'==typeof h.id&&
'undefined'!=typeof x[h.id.replace(/\-/g,'.')]?$target=p.$forms[h.id].target:'object'==typeof h.id?(delete p.$forms[h.id],x=h.attributes.getNamedItem('id').nodeValue||'form.'+oa.v4(),h.setAttribute('id',x),h.id=x,da.target=h,p.$forms[x]=X({},da),$target=p.$forms[x].target):$target=p.$forms[h.id].target;n?nb($target,n):nb($target)}}'undefined'!=typeof p.$forms[e]&&(p.$forms[e].withUserBindings=!0,b='undefined'!=typeof this.$forms&&'undefined'==typeof this.$forms[e]?this.$forms[e]=p.$forms[e]:p.$forms[e]);
if(!b)throw Error('Validator::getFormById(...) exception: could not retrieve form `'+e+'`');b.binded||(nb(b.target),b=p.$forms[e]);U&&K&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&(gina.forms.errors||(gina.forms.errors={}),h={id:e,rules:p.$forms[e].rules},'undefined'!=typeof p.$forms[e].errors&&(h.errors=p.$forms[e].errors),window.ginaToolbar.update('forms',h));return b},y=function(){var e=!1,b=null;gina.hasPopinHandler&&gina.popinIsBinded&&(b=gina.popin.getActivePopin());b&&b.isOpen&&
(e=!0);return e},J=function(e,b){var h=typeof(0<za.count())?za:p.rules;if(!p.$forms)throw Error('`$forms` collection not found');if('undefined'!=typeof e&&'undefined'!=typeof p.$forms[e])return p.$forms[e];if('undefined'==typeof e)if('undefined'!=typeof this.id&&''!=this.id&&null!=this.id)e=this.id;else throw Error('[ FormValidator::validateFormById(formId, customRule) ] `formId` is missing');if('string'==typeof e)e=e.replace(/#/,'');else{if('object'!=typeof e||Array.isArray(e))throw Error('[ FormValidator::validateFormById(formId[, customRule]) ] `formId` should be a `string`');
...
h,'error.'+n,r);return}L.responseType='undefined'!=typeof b.responseType?b.responseType:'';L.withCredentials=!0}else b.isSynchrone?L.open(b.method,b.url,b.isSynchrone):L.open(b.method,b.url);for(var w in b.headers)'Content-Type'==w&&'undefined'!=typeof aa&&null!=aa&&''!=aa||L.setRequestHeader(w,b.headers[w]);if(L){L.onreadystatechange=function(ya){x.isSubmitting=!1;x.isSending=!1;setTimeout(function(){x.sent=!1},1E3);ya=/Google Inc/i.test(navigator.vendor)?50:0;2==L.readyState&&(W=/^attachment;/.test(L.getResponseHeader('Content-Disposition'))?
!0:!1,!L.responseType&&W&&(L.responseType='blob'));if(4==L.readyState){var Ya=null,Ta=L.getResponseHeader('Content-Type');if(/^2/.test(L.status)){try{if(/blob/.test(L.responseType)||W){if('undefined'==typeof Ta||null==Ta)Ta='application/octet-stream';Ya=new Blob([this.response],{type:Ta});var tb=document.createElement('a');tb.style='display: none';document.body.appendChild(tb);var Ab=window.URL.createObjectURL(Ya);tb.href=Ab;var Ib=L.getResponseHeader('Content-Disposition');tb.download=Ib.match('=(.*)')[0].substr(1);
tb.click();window.URL.revokeObjectURL(Ab);r={status:L.status,statusText:L.statusText,responseType:Ya.type,type:Ya.type,size:Ya.size}}else r=L.responseText;/\/json/.test(Ta)&&(r=JSON.parse(L.responseText),'undefined'==typeof r.status&&(r.status=L.status));if(/\/html/.test(Ta)&&(r={contentType:Ta,content:L.responseText},'undefined'==typeof r.status&&(r.status=L.status),'undefined'!=typeof gina.popin&&gina.hasPopinHandler)){var eb=gina.popin.getActivePopin();if(eb){A={};try{A=(new DOMParser).parseFromString(r.content,
'text/html').getElementById('gina-without-layout-xhr-data'),A=JSON.parse(decodeURIComponent(A.value)),XHRView=(new DOMParser).parseFromString(r.content,'text/html').getElementById('gina-without-layout-xhr-view'),XHRView=JSON.parse(decodeURIComponent(XHRView.value)),gina&&U&&typeof window.ginaToolbar&&'undefined'!=typeof A&&window.ginaToolbar.update('data-xhr',A),gina&&U&&typeof window.ginaToolbar&&'undefined'!=typeof XHRView&&window.ginaToolbar.update('view-xhr',XHRView)}catch(Y){throw Y;}eb.loadContent(r.content);
r=A;triggerEvent(gina,h,'success.'+n,r);return}}A=x.eventData.success=r;if(gina&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&A)try{U&&'undefined'!=typeof A&&/\/html|\/json/.test(Ta)&&window.ginaToolbar.update('data-xhr',A)}catch(Y){throw Y;}/^gina\-upload/i.test(n)&&ca(gina,h,'success',n,r);var Bb=!1;'undefined'!=typeof r.isXhrRedirect&&/^true$/i.test(r.isXhrRedirect)&&(Bb=!0);if('undefined'!=typeof gina.popin&&gina.hasPopinHandler&&'undefined'!=typeof r.popin||'undefined'!=typeof gina.popin&&
gina.hasPopinHandler&&'undefined'!=typeof r.location&&Bb){eb=gina.popin.getActivePopin();if(!eb&&'undefined'!=typeof r.popin){if('undefined'!=typeof r.popin&&'undefined'==typeof r.popin.name)throw Error('To get a `$popin` instance, you need at list a `popin.name`.');eb=gina.popin.getPopinByName(r.popin.name);if(!eb)throw Error('Popin with name: `'+r.popin.name+'` not found.');}if('undefined'!=typeof r.popin&&'undefined'!=typeof r.popin.close){eb.isRedirecting=!1;eb.close();var Vb=r.popin.reload?r.popin.reload:
!1;r.popin.location||r.popin.url||(delete r.popin,Vb&&(r.popin={reload:Vb}))}if('undefined'!=typeof r.popin&&'undefined'!=typeof r.popin.location||'undefined'!=typeof r.popin&&'undefined'!=typeof r.popin.url||'undefined'!=typeof r.location&&Bb){Bb=null;eb&&(Bb=eb.name,eb.isRedirecting=!0);'undefined'!=typeof r.popin&&'undefined'!=typeof r.popin.target&&(r.popin.target='_'+r.popin.target);var Xa=r.location||r.popin.location||r.popin.url;if('undefined'!=typeof r.popin&&'undefined'!=typeof r.popin.name&&
Bb!=r.popin.name){eb&&eb.close();Bb=r.popin.name;eb=gina.popin.getPopinByName(Bb);if(!eb)throw Error('Popin with name `'+Bb+'` not found !');eb.load(eb.name,Xa,eb.options)}else eb&&eb.load(eb.name,Xa,eb.options);if(eb)return setTimeout(function(Y){Y.isOpen||Y.open()},50,eb)}}triggerEvent(gina,h,'success.'+n,r);P&&triggerEvent(gina,h,'success.'+n+'.hform',r)}catch(Y){r={status:422,error:Y.message,stack:Y.stack};A=x.eventData.error=r;if(gina&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&
A)try{U&&'undefined'!=typeof A&&window.ginaToolbar.update('data-xhr',A)}catch(ka){throw ka;}/^gina\-upload/i.test(n)&&ca(gina,h,'error',n,r);triggerEvent(gina,h,'error.'+n,r);P&&triggerEvent(gina,h,'error.'+n+'.hform',r)}if('undefined'!=typeof r&&'undefined'!=typeof r.location)return window.location.hash='',r.location=/^http/.test(r.location)||/^\//.test(r.location)?r.location:location.protocol+'//'+r.location,setTimeout(()=>{window.location.href=r.location},ya)}else if(0!=L.status)if(r={status:L.status},
/blob/.test(L.responseType)){Ya=new Blob([this.response],{type:'text/plain'});var gb=new FileReader,ia='';gb.addEventListener('loadend',Y=>{/string/i.test(typeof Y.srcElement.result)?ia+=Y.srcElement.result:'object'==typeof Y.srcElement.result?r=X(r,Y.srcElement.result):r.message+=Y.srcElement.result;if(/2/.test(gb.readyState)){if(/^(\{|\[)/.test(ia))try{r=X(r,JSON.parse(ia))}catch(ka){r=X(r,ka)}r.message||delete r.message;A=x.eventData.error=r;if(gina&&U&&'undefined'!=typeof window.ginaToolbar&&
window.ginaToolbar&&A)try{window.ginaToolbar.update('data-xhr',A)}catch(ka){throw ka;}/^gina\-upload/i.test(n)&&ca(gina,h,'error',n,r);triggerEvent(gina,h,'error.'+n,r);P&&triggerEvent(gina,h,'error.'+n+'.hform',r)}});gb.readAsText(Ya)}else{if(/^(\{|\[)/.test(L.responseText))try{r=X(JSON.parse(L.responseText),r)}catch(Y){r=X(Y,r)}else'object'==typeof L.responseText?r=X(L.responseText,r):r.message=L.responseText;if('undefined'!=typeof r&&'undefined'!=typeof r.error&&r.fields&&'object'==typeof r.fields){eb=
'undefined'!=typeof r.message?r.message:null;Xa={};for(Bb in r.fields)ya={},ya[Bb]={},ya[Bb].isApiError=r.fields[Bb],eb&&!ya[Bb].isApiError&&(ya[Bb].isApiError=r.error),Xa[Bb]=ya[Bb],F(x.target,ya,e,Bb);r.fields=Xa}A=x.eventData.error=r;if(gina&&U&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&A)try{window.ginaToolbar.update('data-xhr',A)}catch(Y){throw Y;}/^gina\-upload/i.test(n)&&ca(gina,h,'error',n,r);triggerEvent(gina,h,'error.'+n,r);P&&triggerEvent(gina,h,'error.'+n+'.hform',r)}}};
L.onprogress=function(ya){var Ya='0';ya.lengthComputable&&(Ya=ya.loaded/ya.total,Ya=parseInt(100*Ya));ya={status:100,progress:Ya};x.eventData.onprogress=ya;triggerEvent(gina,h,'progress.'+n,ya)};L.ontimeout=function(ya){r={status:408,error:'Request Timeout'};x.eventData.ontimeout=r;/^gina\-upload/i.test(n)&&ca(gina,h,'error',n,r);triggerEvent(gina,h,'error.'+n,r);P&&triggerEvent(gina,h,'error.'+n+'.hform',r)};e||(e=event.detail.data);if(e){b=!1;if('object'==typeof e){w=[];Q=0;var ja={};try{if(e instanceof
FormData){var ua=event.currentTarget.getAttribute('data-gina-form-upload-group')||'untagged',na,la;for([na,la]of e.entries())la instanceof File?(b||=!0,w[Q]={key:na,group:ua,file:la,bin:''},++Q):ja[na]=la}else e=JSON.stringify(e);if(b&&0<w.length){var Ba='--ginaWKBoundary'+oa.v4().replace(/\-/g,'');return Ja(w,Ba,'',0,function(ya,Ya,Ta){if(ya)/^gina\-upload/i.test(n)&&ca(gina,h,'error',n,ya),triggerEvent(gina,h,'error.'+n,ya),P&&triggerEvent(gina,h,'error.'+n+'.hform',ya);else return Ta&&(L.setRequestHeader('Content-Type',
'multipart/form-data; boundary='+Ba),L.send(Ya),x.sent=!0,U&&K&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&(gina.forms.sent||(gina.forms.sent={}),window.ginaToolbar.update('forms',{id:n,sent:Ya}))),!1})}'undefined'!=typeof ja&&0<ja.count()&&(e=JSON.stringify(ja))}catch(ya){/^gina\-upload/i.test(n)&&ca(gina,h,'error',n,ya),triggerEvent(gina,h,'error.'+n,ya),P&&triggerEvent(gina,h,'error.'+n+'.hform',ya)}}b||('undefined'!=typeof aa&&null!=aa&&''!=aa&&L.setRequestHeader('Content-Type',
...
r[h][w].originalFilename);Q.setAttribute('data-upload-reset-link-id',A.id);if(aa=n.getAttribute('data-preview-max-width')||null)Q.width=aa;/ul/i.test(e.previewContainer.tagName)?(aa=document.createElement('LI'),aa.className='item',aa.appendChild(Q),n.appendChild(aa)):n.appendChild(Q);fadeIn(Q)}e.hasPreviewContainer&&(/ul/i.test(e.previewContainer.tagName)?(aa=document.createElement('LI'),aa.className='item',W&&aa.appendChild(A),n.appendChild(aa)):W&&n.appendChild(A));ib('reset',b,h);fadeIn(A)}else throw Error(W);
...
P.target;p.$forms[P.target.form.getAttribute('id')].isValidating=!0;M(P.target,Q,w,e.rules,function(ja){p.$forms[P.target.form.getAttribute('id')].isValidating=!1;ja.isValid()?F(P.target.form,{},ja.data,P.target.name):F(P.target.form,ja.error,ja.data,P.target.name);var ua=P.target.form,na=ja=null,la=null;na=Yb(ua,x);ja=na.fields;na=na.$fields;var Ba=ua.getAttribute('id');la=p.$forms[Ba].rules;p.$forms[Ba].isValidating=!0;M(ua,ja,na,la,function(ya){p.$forms[Ba].isValidating=!1;console.debug('['+Ba+
'] onSilentGlobalLiveValidation: '+ya.isValid(),ya);var Ya=ya.isValid();U&&K&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&(gina.forms.errors||(gina.forms.errors={}),window.ginaToolbar.update('forms',{id:Ba,errors:ya.error||{}}));Pb(ua,Ya);W=!1})})};if(/^changed\./i.test(P.type)||/^change\./i.test(P.type)&&'radio'==P.target.type)return function(Q,w){if(!(0<w))return++w,setTimeout(()=>{console.debug(' changed .... '+b.id);aa()},0)}(W,0);/^focusin\./i.test(P.type)?/\-error/.test(b.parentNode.className)&&
...
'undefined'==typeof gina.events['registered.'+b.id]){/^file$/i.test(b.type)||Wa(b);switch(b.tagName.toLowerCase()){case 'textarea':rb(e,b,null,!0);break;default:rb(e,b,null),e=b.getAttribute('autocomplete'),/safari/i.test(navigator.userAgent)&&e&&/^(off|false)/i.test(e)&&gc(b,null)}gina.events['registered.'+b.id]=b.id}},ib=function(e,b,h){var n=b.id+'-'+h+'-'+e+'-trigger',x=document.getElementById(n);x||(n=b.getAttribute('data-gina-form-upload--'+h+ +e+'-trigger'),x=document.getElementById(n));x&&
'undefined'==typeof x.isBinded||x&&'undefined'!=typeof x.isBinded&&!/true/i.test(x.isBinded)?(addListener(gina,x,'click',function(r){r.preventDefault();ea(b,e)}),x.isBinded=!0):console.warn('[FormValidator::bindForm][upload]['+b.id+'] : did not find `upload '+e+' trigger`.\nPlease, make sure that your delete element ID is `'+n+'-'+e+'-trigger`, or add to your file input ('+b.id+') -> `data-gina-form-upload-'+e+'-trigger="your-custom-id"` definition.')},Gb=function(e,b){var h=function(n,x,r){var A=
...
W.toUrl())):(n='`'+x+'` needs to be defined to proceed for your `input[type=file]` with ID `'+n.id+'`\n'+P+'\n',r&&(r.innerHTML+=n.replace(/(\n|\r)/g,'<br>')),console.error(n))}};h(e,'data-gina-form-upload-action',b);h(e,'data-gina-form-upload-reset-action',b);h(e,'data-gina-form-upload-delete-action',b)},Ob=function(e,b,h){e=jb(e);nb(e.target,b);return h?h(e):e},jb=function(e){var b=null,h=null;try{if(e.getAttribute&&e.getAttribute('id'))if(h=e.getAttribute('id'),'undefined'!=typeof p.$forms[h])b=
...
ja[b[ia].name]=new RegExp('^'+ua.replace(/[.*+?^${}()|[\]\\]/g,'\\$&')),r&&('undefined'==typeof h.rules[b[ia].name]&&(h.rules[b[ia].name]={}),'undefined'!=typeof h.rules[b[ia].name].isRequired&&h.rules[b[ia].name].isRequired||(h.rules[b[ia].name].exclude=!0));if(0<ja.count())for(var ya in ja)b[ia].name!=ya&&(b[ia].getAttribute('data-gina-form-element-group'),ja[ya].test(b[ia].name)&&(b[ia].disabled=!0,'undefined'==typeof na[ya]&&(na[ya]={}),na[ya][b[ia].name]=b[ia]));if(/^file$/i.test(b[ia].type)){Ba=
b[ia].getAttribute('data-gina-form-upload-trigger');Ba||(Ba=b[ia].id);ua=null;la=(new DOMParser).parseFromString(e.innerHTML,'text/html');Ba&&(ua=document.getElementById(Ba));aa=document.getElementById(b[ia].id+'-error');Gb(b[ia],aa);if((aa=la.getElementById(Ba+'-preview'))&&ua&&!/none/i.test(window.getComputedStyle(aa).display)&&!/none/i.test(aa.parentElement.style.display)){la=0;console.debug('preview is visible ...');ua.customFiles=[];ua.form=e;aa=aa.childNodes;for(let ka=0,ra=aa.length;ka<ra;ka++){var Ya=
null;if(/ul/i.test(aa[ka].tagName))for(let Qa=0,Za=aa[ka].length;Qa<Za;Qa++){let db=$$els[ka];for(let Pa=0,xb=db.length;Pa<xb;Pa++)/img/i.test(db[Pa])&&(Ya=db[Pa],Ya.setAttribute(''),la++)}else/img/i.test(aa[ka].tagName)&&(Ya=aa[ka],deleteLinkId=Ba+'-'+la+'-delete-trigger',Ya=Ya.src.substr(Ya.src.lastIndexOf('/')+1),ua.customFiles.push({name:Ya,deleteLinkId}),ib('delete',ua,la),la++)}}addListener(gina,b[ia],'change',function(ka){ka.preventDefault();var ra=ka.currentTarget;ka=ra.files;ra.customFiles=
Array.from(ka);if(!ka.length)return!1;var Qa=ra.getAttribute('data-gina-form-upload-action'),Za=ra.getAttribute('name'),db='gina-upload-'+Za.replace(/\[/g,'-').replace(/\]/g,'-'+h.id);ra.setAttribute('data-gina-form-virtual',db);var Pa=ra.getAttribute('data-gina-form-upload-on-success'),xb=ra.getAttribute('data-gina-form-upload-on-error'),kb=null;if(0<ka.length){var pb=null;if(y()){pb=gina.popin.getActivePopin();pb.$target=(new DOMParser).parseFromString(pb.target.outerHTML,'text/html');pb.$target.getElementById(pb.id).innerHTML=
document.getElementById(pb.id).innerHTML;var qb=pb.$target.getElementById(db)}else qb=document.getElementById(db);if(!qb){try{qb=z(db)||null}catch(Tc){}qb||=y()?pb.$target.createElement('form'):document.createElement('form');qb.id=db;qb.action=Qa;qb.enctype='multipart/form-data';qb.method='POST';if('undefined'!=typeof ra.form){Qa='files';var sb=ra.getAttribute('data-gina-form-upload-prefix')||ra.name||ra.getAttribute('name'),mb=ra.id||ra.getAttribute('id'),Nb=!1,Eb=ra.getAttribute('data-gina-form-upload-preview')||
mb+'-preview';Eb=y()?pb.$target.getElementById(Eb):document.getElementById(Eb);'undefined'!=typeof Eb&&(Nb=!0);sb&&(Qa=sb);sb=[];for(var Hb='name group originalFilename ext encoding size height width location mime preview'.split(' '),Kb=ra.form.getElementsByTagName('INPUT'),$b,Wb,Gc,qc,Mb=0,Nc=ka.length;Mb<Nc;++Mb){ib('reset',ra,Mb);sb[Mb]=null;$b=Qa+'['+Mb+']';qc=new RegExp('^'+$b.replace(/\[/g,'\\[').replace(/\]/g,'\\]'));for(var wc=0,xc=Kb.length;wc<xc;++wc)$b=Kb[wc].getAttribute('type'),kb=Kb[wc].getAttribute('data-gina-form-upload-error')||
mb+'-error'||null,$b&&/hidden/i.test($b)&&(Wb=Kb[wc],$b=/\[\w+\]$/i.test(Wb.name)?Wb.name.match(/\[\w+\]$/)[0].replace(/\[|\]/g,''):Wb.name,Gc=/\[\w+\]$/i.test(Wb.name)?Wb.name.match(/\[\w+\]$/)[0].replace(/\[|\]/g,''):Wb.name,Wb&&'undefiend'!=typeof $b&&-1<Hb.indexOf($b)&&qc.test(Wb.name)?(sb[Mb]||(sb[Mb]={}),/\[preview\]/i.test(Wb.name)?('undefined'==typeof sb[Mb].preview&&(sb[Mb].preview={}),sb[Mb].preview[$b]=Wb):sb[Mb][$b]=Wb):Wb&&'undefiend'!=typeof $b&&0>Hb.indexOf($b)&&qc.test(Wb.name)&&(sb[Mb]||
(sb[Mb]={}),/\[preview\]/i.test(Wb.name)?('undefined'==typeof sb[Mb].preview&&(sb[Mb].preview={}),sb[Mb].preview[Gc]=Wb):sb[Mb][Gc]=Wb));qc=0;for(wc=Hb.length;qc<wc;++qc)sb[Mb]||(sb[Mb]={}),'undefined'==typeof sb[Mb][Hb[qc]]&&($b=Qa+'['+Mb+']['+Hb[qc]+']',$newVirtualField=document.createElement('input'),$newVirtualField.type='hidden',$newVirtualField.id='input.'+oa.v4(),$newVirtualField.name=$b,$newVirtualField.value='',ra.form.appendChild($newVirtualField),sb[Mb][Hb[qc]]=ra.form[ra.form.length-1])}qb.uploadProperties=
{id:ra.form.id||ra.getAttribute('id'),uploadTriggerId:ra.id,$form:ra.form,errorField:kb,mandatoryFields:Hb,uploadFields:sb,hasPreviewContainer:Nb,isPopinContext:y()};Nb&&(qb.uploadProperties.previewContainer=Eb)}Pa?qb.setAttribute('data-gina-form-event-on-submit-success',Pa):qb.setAttribute('data-gina-form-event-on-submit-success','onGenericXhrResponse');xb?qb.setAttribute('data-gina-form-event-on-submit-error',xb):qb.setAttribute('data-gina-form-event-on-submit-error','onGenericXhrResponse');y()?
document.getElementById(pb.id).appendChild(qb):document.body.appendChild(qb)}try{var sc=z(db),Sc=new FormData;ra=null;db=0;for(var Oc=ka.length;db<Oc;++db)ra=ka[db],Sc.append(Za,ra,ra.name);sc.send(Sc,{withCredentials:!0})}catch(Tc){throw Tc;}}})}}var Ta=function(ia,Y){ia.setAttribute('data-value',ia.value);if(/^(true)$/i.test(Y.target.dataset.ginaFormLiveCheckEnabled&&0<Y.rules.count())){var ka={},ra={},Qa=null;Qa=ia.form;ka[event.target.name]=event.target.value;ra[event.target.name]=event.target;
p.$forms[Qa.getAttribute('id')].isValidating=!0;M(event.target,ka,ra,Y.rules,function(Za){p.$forms[Qa.getAttribute('id')].isValidating=!1;Za.isValid()?F(Qa,{},Za.data,event.target.name):F(Qa,Za.error,Za.data,event.target.name);var db=Qa,Pa=Za=null,xb=null;Pa=Yb(db,x);Za=Pa.fields;Pa=Pa.$fields;var kb=db.getAttribute('id');xb=p.$forms[kb].rules;p.$forms[kb].isValidating=!0;M(db,Za,Pa,xb,function(pb){p.$forms[kb].isValidating=!1;console.debug('[updateSelect]: onSilentGlobalLiveValidation: '+pb.isValid(),
pb);pb=pb.isValid();Pb(db,pb);once=!1})})}};ua=na=null;ya=0;for(ja=P.length;ya<ja;++ya)if(Ma(h.rules,P[ya]),Ba=P[ya].getAttribute('id'),!Ba||!/^gina\-toolbar/.test(Ba)){Ba&&''!=Ba||(Ba='select.'+oa.v4(),P[ya].setAttribute('id',Ba));if(ua=P[ya].getAttribute('data-gina-form-element-group'))na=P[ya].getAttribute('name')||Ba,na===Ba&&P[ya].setAttribute('name',Ba),Q[Ba]={id:Ba,name:na,group:ua,target:P[ya]};addListener(gina,P[ya],'change',function(ia){ia=ia.target;/select/i.test(ia.type)&&Ta(ia,h)});if(P[ya].options&&
!h.fieldsSet[Ba]){na=0;if(ua=P[ya].getAttribute('data-value')||null)for(la=0,aa=P[ya].options.length;la<aa;++la)if(P[ya].options[la].value==ua){na=la;P[ya].selectedIndex=na;break}'undefined'!=typeof P[ya].options[P[ya].selectedIndex]&&P[ya].options[P[ya].selectedIndex].index&&(na=P[ya].options[P[ya].selectedIndex].index);h.fieldsSet[Ba]={id:Ba,name:P[ya].name||null,value:P[ya].options[na].value||ua||null,selectedIndex:na||0};'undefined'!=typeof P[ya].selectedIndex&&(P[ya].options[na].selected=!0,
P[ya].setAttribute('data-value',P[ya].options[na].value))}}var tb=function(ia,Y,ka,ra){'undefined'==typeof ra&&(ra=!1);if('undefined'==typeof Q[ia])throw Error('Radio & Checkbox dependencies not met: you must use the ID attribue of the `master element` as the `data-gina-form-element-group`');var Qa=ia.replace(/\-|_|@|#|\.|\[|\]/g,'\\$&');ia=Q[ia].target.checked;for(let Pa in Q)if(!/radio|checkbox/i.test(Q[Pa].target.type)){var Za=new RegExp(Qa);var db=new RegExp(Y);if(Za.test(Q[Pa].group)&&db.test(Q[Pa].group)||
Za.test(Q[Pa].group))Q[Pa].target.disabled=!0,'undefined'==typeof h.rules[Q[Pa].name]&&(h.rules[Q[Pa].name]={}),h.rules[Q[Pa].name].exclude=!0,ra?(Q[Pa].target.disabled=ia?!1:!0,h.rules[Q[Pa].name].exclude=ia?!1:!0):(Q[Pa].target.disabled=ka,h.rules[Q[Pa].name].exclude=ka)}},Ab=function(ia,Y,ka,ra){'undefined'==typeof ra&&(ra=!1);if(ra&&'undefined'!=typeof Q[Y.id])return ia=/true/i.test(Y.checked)?!1:!0,tb(Y.id,Q[Y.id].group,ia,ra);ka=Y.name;r&&'undefined'==typeof ia.rules[ka]&&(ia.rules[ka]={});
/^true$/i.test(Y.checked)?r&&(ia.rules[ka].exclude=!1,'undefined'!=typeof Q[Y.id]&&tb(Y.id,Q[Y.id].group,!1,ra)):r&&(ia.rules[ka].exclude=!0,'undefined'!=typeof Q[Y.id]&&tb(Y.id,Q[Y.id].group,!0,ra))},Ib=function(ia,Y){'undefined'==typeof Y&&(Y=!1);var ka=function(Pa,xb,kb){if(xb)Ab(h,Pa,xb);else for(let pb in Q)if(db.test(Q[pb].group)||db.test(Q[pb].target.getAttribute('data-gina-form-element-group')))Q[pb].target.disabled=kb};Y&&/^(on)$/i.test(ia.value)&&!ia.checked&&(ia.value=!1);var ra=ia.getAttribute('data-value')||
ia.getAttribute('value')||ia.value;ra=/^(true|on)$/.test(ra)?!0:ra;''===ra&&(ra=!1);var Qa=/^(true|on|false)$/i.test(ra)?!0:!1;Y&&Qa&&(/^true$/i.test(ra)&&!ia.checked?ia.checked=!0:/^false$/i.test(ra)&&ia.checked&&(ia.checked=!1));ra=ia.checked;var Za=ia.getAttribute('data-gina-form-element-group')||null,db=new RegExp(ia.id.replace(/\-|_|@|#|\.|\[|\]/g,'\\$&'));ra&&'null'!=ra&&'false'!=ra&&''!=ra?(Y?eb(ia):(setTimeout(function(){ia.checked=!0;ka(ia,Za,!1);eb(ia)},0),ia.setAttribute('checked','checked')),
Qa&&(ia.value=!0,ia.setAttribute('value',!0),typeof('undefined'!=ia.getAttribute('data-value'))&&ia.setAttribute('data-value',!0))):(Y?eb(ia):setTimeout(function(){ia.checked=!1;ka(ia,Za,!0);eb(ia)},0),ia.removeAttribute('checked'),Qa&&(ia.value=!1,ia.setAttribute('value','false'),typeof('undefined'!=ia.getAttribute('data-value'))&&ia.setAttribute('data-value','false')))},eb=function(ia){ia=new RegExp(ia.id.replace(/\-|_|@|#|\.|\[|\]/g,'\\$&'));for(let Y in Q)(/checkbox/i.test(Q[Y].target.type)&&
ia.test(Q[Y].group)||/checkbox/i.test(Q[Y].target.type)&&ia.test(Q[Y].target.getAttribute('data-gina-form-element-group')))&&Ab(h,Q[Y].target,Q[Y].group,!0)},Bb=function(ia,Y){Y=ia.id.replace(/\-|_|@|#|\.|\[|\]/g,'\\$&');Y=new RegExp(Y);for(let ka in Q)if(/checkbox|radio/i.test(Q[ka].target.type)||(Q[ka].target.disabled=!0,'undefined'==typeof h.rules[Q[ka].name]&&(h.rules[Q[ka].name]={}),h.rules[Q[ka].name].exclude=!0),Y.test(Q[ka].group)||Y.test(Q[ka].target.getAttribute('data-gina-form-element-group').replace(/\-|_|@|#|\.|\[|\]/g,
'\\$&')))Q[ka].target.disabled=!0,'undefined'==typeof h.rules[Q[ka].name]&&(h.rules[Q[ka].name]={}),/^(true|on)$/i.test(ia.checked)?(Q[ka].target.disabled=!1,h.rules[Q[ka].name].exclude=!1):(Q[ka].target.disabled=!0,h.rules[Q[ka].name].exclude=!0);eb(ia)},Vb=null,Xa=function(ia,Y,ka){Y='undefined'!=typeof Y&&Y?!0:!1;ka='undefined'!=typeof ka&&ka?!0:!1;var ra=ia.checked,Qa=/^(true|false)$/i.test(ia.value);Vb=document.getElementsByName(ia.name);for(let Za=0,db=Vb.length;Za<db;++Za)Vb[Za].id!==ia.id&&
ra&&(Vb[Za].checked=!1,Vb[Za].removeAttribute('checked'),Bb(Vb[Za],!0));Y?Bb(ia):(ra&&'null'!=ra&&'false'!=ra&&''!=ra?setTimeout(function(){ka?Bb(ia):(ia.checked=!1,ia.removeAttribute('checked'))},0):setTimeout(function(){ka?Bb(ia):(ia.checked=!0,ia.setAttribute('checked','checked'))},0),Qa&&(ia.value=/^true$/.test(ia.value)?!0:!1))};ya=0;for(ja=b.length;ya<ja;++ya){P=b[ya].getAttribute('type');if('undefined'==typeof b[ya].id||''==b[ya].id)b[ya].id=P+'-'+oa.v4(),b[ya].setAttribute('id',b[ya].id);
if('undefined'!=typeof P&&/^checkbox$/i.test(P)){if(b[ya].disabled&&-1<w.indexOf(b[ya].id)||!b[ya].checked&&-1<w.indexOf(b[ya].id)){P=new RegExp(b[ya].id.replace(/\-|_|@|#|\.|\[|\]/g,'\\$&'));for(var gb in Q)P.test(Q[gb].group)&&(Q[gb].target.disabled=!0)}W='change.'+b[ya].id;P=function(ia,Y){addListener(gina,ia,Y,function(ka){Ib(ka.target);triggerEvent(gina,ka.target,'changed.'+ka.target.id)});Ib(ia,!0)};'undefined'!=typeof gina.events[W]&&gina.events[W]==b[ya].id&&removeListener(gina,b[ya],W);P(b[ya],
W)}else'undefined'!=typeof P&&/^radio$/i.test(P)&&(W=b[ya].id,P=function(ia,Y){addListener(gina,ia,Y,function(ka){Xa(ka.target);triggerEvent(gina,ka.target,'changed.'+ka.target.id)});Xa(ia,!0)},'undefined'!=typeof gina.events[W]&&gina.events[W]==b[ya].id&&removeListener(gina,b[ya],W),P(b[ya],W))}W='click';P=function(){var ia=null;ia='reset.'+e.id;'undefined'==typeof gina.events[ia]&&addListener(gina,e,ia,function(Y){Y.preventDefault();var ka=p.$forms[Y.currentTarget.id||Y.target.id];ka.target.dataset.ginaFormIsResetting=
!0;R(ka);Y=Yb(ka.target,ka.rules,!0);M(ka.target,Y.fields,Y.$fields,ka.rules,function(ra){var Qa=ra.isValid();console.debug('silent reset validation result[isValid:'+Qa+']: ',ra);F(ka.target,{});Pb(ka.target,Qa);ka.target.dataset.ginaFormIsResetting=!1})});addListener(gina,e,'reset',function(Y){var ka=Y.target;if('undefined'!=typeof Y.defaultPrevented&&Y.defaultPrevented)return!1;Y.preventDefault();var ra=ka.id;if(!ra)return!1;/^reset\./.test(ra)||(ra='reset.'+ka.id);gina.events[ra]&&triggerEvent(gina,
ka,ra,Y.detail)});addListener(gina,e,'keydown',function(Y){var ka=Y.target;if('undefined'!=typeof Y.defaultPrevented&&Y.defaultPrevented)return!1;N[Y.keyCode]='keydown'==Y.type;var ra=ka.id;if(!ra)return!1;/^keydown\./.test(ra)||(ra='keydown.'+ka.id);gina.events[ra]&&(cancelEvent(Y),triggerEvent(gina,ka,ra,Y.detail,Y))});addListener(gina,e,'keyup',function(Y){var ka=Y.target;if('undefined'!=typeof Y.defaultPrevented&&Y.defaultPrevented)return!1;N[Y.keyCode]&&delete N[Y.keyCode];var ra=ka.id;if(!ra)return!1;
/^keyup\./.test(ra)||(ra='keyup.'+ka.id);gina.events[ra]&&(cancelEvent(Y),triggerEvent(gina,ka,ra,Y.detail,Y))});addListener(gina,e,'focusin',function(Y){var ka=Y.target;if('undefined'!=typeof Y.defaultPrevented&&Y.defaultPrevented)return!1;var ra=ka.id;if(!ra)return!1;/^focusin\./.test(ra)||(ra='focusin.'+ka.id);gina.events[ra]&&(cancelEvent(Y),triggerEvent(gina,ka,ra,Y.detail))});addListener(gina,e,'focusout',function(Y){var ka=Y.target;if('undefined'!=typeof Y.defaultPrevented&&Y.defaultPrevented)return!1;
var ra=ka.id;if(!ra)return!1;/^focusout\./.test(ra)||(ra='focusout.'+ka.id);gina.events[ra]&&(cancelEvent(Y),triggerEvent(gina,ka,ra,Y.detail))});addListener(gina,e,'change',function(Y){var ka=Y.target;if('undefined'!=typeof Y.defaultPrevented&&Y.defaultPrevented)return!1;var ra=ka.id;if(!ra)return!1;/^change\./.test(ra)||(ra='change.'+ka.id);gina.events[ra]&&(cancelEvent(Y),triggerEvent(gina,ka,ra,Y.detail))});addListener(gina,e,'click',function(Y){var ka=Y.target,ra=!1,Qa=!1;if(/(label)/i.test(Y.target.tagName)&&
'undefined'!=typeof Y.target.control&&null!=Y.target.control&&/(checkbox|radio)/i.test(Y.target.control.type)||/(label)/i.test(Y.target.parentNode.tagName)&&'undefined'!=typeof Y.target.parentNode.control&&null!=Y.target.parentNode.control&&/(checkbox|radio)/i.test(Y.target.parentNode.control.type))Qa=Y.target.getAttribute('for')||Y.target.parentNode.getAttribute('for')?!0:!1,ka=Y.target.control||Y.target.parentNode.control;if(!ka.disabled&&/(checkbox|radio)/i.test(ka.type)&&!Qa){if(/checkbox/i.test(ka.type))return Ib(ka);
if(/radio/i.test(ka.type))return Xa(ka,!1,!0)}if(/(button|input)/i.test(ka.tagName)&&/(submit|checkbox|radio)/i.test(ka.type)||/a/i.test(ka.tagName)&&ka.attributes.getNamedItem('data-gina-form-submit')||/a/i.test(ka.parentNode.tagName)&&ka.parentNode.attributes.getNamedItem('data-gina-form-submit')){Qa=ka.attributes.getNamedItem('data-gina-form-submit');var Za=ka.parentNode.attributes.getNamedItem('data-gina-form-submit');if(Qa||Za)ra=!0,(Za=Qa?ka.getAttribute('data-gina-form-submit-method'):ka.parentNode.getAttribute('data-gina-form-submit-method'))&&
(Qa&&ka.form?ka.form.setAttribute('method',Za):ka.parentNode.form&&ka.parentNode.form.setAttribute('method',Za));'undefined'!=typeof ka.id&&ka.getAttribute('id')||ka.setAttribute('id','click.'+oa.v4());ka.id=ka.getAttribute('id');if(/^click\./.test(ka.id)||r){Qa=ka.id;if(!Qa)return!1;/^click\./.test(Qa)||(Qa=ka.id);if(!ka.disabled&&/(checkbox|radio)/i.test(ka.type)){if(/checkbox/i.test(ka.type))return Ib(ka);if(/radio/i.test(ka.type))return Xa(ka,!1,!0)}if('undefined'!=typeof Y.defaultPrevented&&
Y.defaultPrevented)return!1;'submit'!=ka.type||/^submit\./i.test(Qa)||(Qa='submit.'+Qa);'reset'!=ka.type||/^reset\./i.test(Qa)||(Qa='reset.'+Qa);gina.events[Qa]?(cancelEvent(Y),triggerEvent(gina,ka,Qa,Y.detail)):ra&&'undefined'!=typeof this.id&&''!=this.id&&'undefined'!=typeof gina.validator.$forms[this.id]&&(gina.validator.getFormById(this.id).submit(),cancelEvent(Y))}}})};P();W='validate.'+n;P=function(){addListener(gina,e,W,function(ia){cancelEvent(ia);var Y=h.eventData.error||h.eventData.validation||
ia.detail;F(ia.target,Y.fields||Y.error,Y.data);ia=ia.target.getAttribute('id');if('undefined'!=typeof Y.isValid&&Y.isValid()){var ka=p.$forms[ia].target.getAttribute('data-gina-form-inherits-data')||null;ka&&(Y.data=X(Y.data,JSON.parse(decodeURIComponent(ka))));p.$forms[ia]?p.$forms[ia].send(Y.data):h&&h.send(Y.data)}})};'undefined'!=typeof gina.events[W]&&gina.events[W]=='validate.'+n&&removeListener(gina,h,W,P);P();gb=function(ia,Y){/^submit\./i.test(ia)||(ia='submit.'+ia);addListener(gina,Y,ia,
function(ka){cancelEvent(ka);var ra={};ka={_length:0};var Qa=e.getAttribute('id'),Za='undefined'!=typeof p.$forms[Qa]?p.$forms[Qa].rules:null;p.$forms[Qa].sent||(ra=Yb(e,Za),ka=ra.fields,ra=ra.$fields,Za=p.$forms[Qa].rules,0==ka._length?(delete ka._length,ka={error:[],isValid:function(){return!0},data:Na(ka)},triggerEvent(gina,e,'validate.'+n,ka)):(n=e.getAttribute('id'),A=(Za=e.getAttribute('data-gina-form-rule'))?Da(Za.replace(/\-|\//g,'.')):Da(n.replace(/\-/g,'.')),p.$forms[Qa].isSubmitting=!0,
p.$forms[Qa].isSending=!1,M(e,ka,ra,A,function(db){triggerEvent(gina,e,'validate.'+n,db)})))})};w=null;b=[];w=[];P=null;w=e.getElementsByTagName('button');if(0<w.length)for(let ia=0,Y=w.length;ia<Y;++ia)'submit'==w[ia].type&&b.push(w[ia]);w=e.getElementsByTagName('a');if(0<w.length)for(let ia=0,Y=w.length;ia<Y;++ia)w[ia].attributes.getNamedItem('data-gina-form-submit')?b.push(w[ia]):w[ia].getAttribute('id')||/gina\-popin/.test(w[ia].className)||gina.popinIsBinded||/gina\-link/.test(w[ia].className)||
(P='link.'+oa.v4(),w[ia].id=P);P=null;ya=!1;for(let ia=0,Y=b.length;ia<Y;++ia){w=b[ia];if(/button/i.test(w.tagName)&&'undefined'!=typeof w.type&&/submit/i.test(w.type)||/a/i.test(w.tagName)&&'undefined'!=typeof w.dataset.ginaFormSubmit&&/^true$/i.test(w.dataset.ginaFormSubmit)||/a/i.test(w.parentNode.tagName)&&'undefined'!=typeof w.parentNode.dataset.ginaFormSubmit&&/^true$/i.test(w.parentNode.dataset.ginaFormSubmit)){/a/i.test(w.parentNode.tagName)&&(w=w.parentNode);if('undefined'==typeof w.id||
'undefined'!=typeof w.id&&''==w.id)w.id='click.'+oa.v4(),w.setAttribute('id',w.id);/a/i.test(w.tagName)&&'undefined'==typeof w.form&&(w.form={id:h.id});'undefined'==typeof w.dataset.ginaFormSubmitTriggerFor&&'undefined'!=typeof p.$forms[h.id]&&'undefined'==typeof p.$forms[h.id].submitTrigger&&'undefined'!=typeof w.form.id&&h.id==w.form.id&&(console.debug('attching submitTrigger: '+w.id,'  form id: '+h.id),p.$forms[h.id].submitTrigger=h.submitTrigger=w.id||w.getAttribute('id'),w.dataset.ginaFormSubmitTriggerFor=
h.id)}'A'==w.tagName&&(P=w.getAttribute('onclick'),ya=w.getAttribute('data-gina-form-submit'),P||ya?/return false/i.test(P)||ya||(P=/;$/.test(P)?P+'return false;':P+'; return false;'):w.setAttribute('onclick','return false;'));w.id?W=w.id:(W='click.'+oa.v4(),w.id=W,w.setAttribute('id',W));'undefined'!=typeof gina.events[W]&&gina.events[W]==w.id||gb(W,w)}W='submit';addListener(gina,e,W,function(ia){var Y=ia.target,ka=Y.getAttribute('id'),ra=p.$forms[ka],Qa=h.binded;(ra=(new DOMParser).parseFromString(Y.innerHTML,
'text/html').getElementById(ra.submitTrigger))&&ra.disabled&&cancelEvent(ia);if('undefined'!=typeof ia.defaultPrevented&&ia.defaultPrevented)return!1;(r||Qa)&&cancelEvent(ia);ia={};Qa={_length:0};ra='undefined'!=typeof gina.validator.$forms[ka]?gina.validator.$forms[ka].rules:null;for(var Za=null,db=null,Pa=0,xb=Y.length;Pa<xb;++Pa)Za=Y[Pa].getAttribute('name'),db=Y[Pa].disabled||Y[Pa].getAttribute('disabled'),db=/disabled|true/i.test(db)?!0:!1,Za&&!db&&('undefined'!=typeof Y[Pa].type&&'radio'==Y[Pa].type||
'undefined'!=typeof Y[Pa].type&&'checkbox'==Y[Pa].type?Y[Pa].checked?/^(true|false)$/.test(Y[Pa].value)?Qa[Za]=Y[Pa].value=/^true$/.test(Y[Pa].value)?!0:!1:Qa[Za]=Y[Pa].value:ra&&'undefined'!=typeof ra[Za]&&'undefined'!=typeof ra[Za].isBoolean&&'checkbox'==Y[Pa].type&&!/^(true|false)$/.test(Y[Pa].value)&&(Qa[Za]=!1):Qa[Za]=Y[Pa].value,ia[Za]=Y[Pa],ia[Za].setAttribute('data-gina-form-errors',''));Qa._length=Qa.count();0==Qa._length?(delete Qa._length,ia={error:[],isValid:function(){return!0},data:Na(Qa)},
'undefined'!=typeof gina.events['submit.'+ka]?triggerEvent(gina,Y,'submit.'+ka,ia):triggerEvent(gina,Y,'validate.'+ka,ia)):(A=(ra=Y.getAttribute('data-gina-form-rule'))?Da(ra.replace(/\-|\//g,'.')):Da(ka.replace(/\-/g,'.')),p.$forms[ka].isValidating=!0,M(Y,Qa,ia,A,function(kb){p.$forms[ka].isValidating=!1;'undefined'!=typeof gina.events['submit.'+ka]?triggerEvent(gina,Y,'submit.'+ka,kb):triggerEvent(gina,Y,'validate.'+ka,kb)}))});p.$forms[n].binded=!0;/^(true)$/i.test(h.target.dataset.ginaFormLiveCheckEnabled&&
0<h.rules.count())?(console.debug('silent validation mode on'),gb=Yb(h.target,h.rules),M(h.target,gb.fields,gb.$fields,h.rules,function(ia){console.debug('silent validation result[isValid:'+ia.isValid()+']: ',ia);U&&K&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&(gina.forms.errors||(gina.forms.errors={}),window.ginaToolbar.update('forms',{id:n,errors:ia.error}));Pb(h,ia.isValid())})):/^(true)$/i.test(h.target.dataset.ginaFormLiveCheckEnabled)||Pb(h,!0)},Pb=function(e,b){$formInstance=
null;e instanceof HTMLFormElement?(e=e.getAttribute('id'),$formInstance=p.$forms[e]):$formInstance=e;'undefined'==typeof $formInstance.submitTrigger?console.warn('This might be normal, so do not worry if this form is handled by your javascript: `'+$formInstance.id+'`\nGina could not complete `updateSubmitTriggerState()`: `submitTrigger` might not be attached to form instance `'+$formInstance.id+'`\nTo disable this warning, You just need to disable `Form Live Checking on your form by adding to your <form>: `data-gina-form-live-check-enabled=false``'):
document.getElementById($formInstance.submitTrigger)&&(/true/i.test(b)?document.getElementById($formInstance.submitTrigger).disabled=!1:document.getElementById($formInstance.submitTrigger).disabled=!0)},Yb=function(e,b,h){'undefined'==typeof h&&(h=!1);var n={},x={},r=e.id||e.getAttribute('id');'undefined'==typeof b&&(b='undefined'!=typeof p.$forms[r].rules&&0<p.$forms[r].rules.count()?p.$forms[r].rules:null,b||'undefined'==typeof gina.validator.$forms[r]||(b=gina.validator.$forms[r].rules));for(var A=
0,W=e.length;A<W;++A){if(h)switch(e[A].tagName.toLowerCase()){case 'input':/^(hidden|text)$/i.test(e[A].type)&&(e[A].value=e[A].defaultValue)}if(/button/i.test(e[A].tagName)&&'undefined'!=typeof e[A].type&&/submit/i.test(e[A].type)||/a/i.test(e[A].tagName)&&'undefined'!=typeof e[A].dataset.ginaFormSubmit&&/^true$/i.test(e[A].dataset.ginaFormSubmit))/a/i.test(e[A].tagName)&&'undefined'==typeof e[A].form&&(e[A].form={id:r}),'undefined'==typeof e[A].dataset.ginaFormSubmitTriggerFor&&'undefined'!=typeof p.$forms[r]&&
'undefined'==typeof p.$forms[r].submitTrigger&&'undefined'!=typeof e[A].form.id&&r==e[A].form.id&&(p.$forms[r].submitTrigger=e[A].id||e[A].getAttribute('id'),e[A].dataset.ginaFormSubmitTriggerFor=r);var P=e[A].getAttribute('name');var aa=e[A].disabled||e[A].getAttribute('disabled');aa=/disabled|true/i.test(aa)?!0:!1;if(P&&!aa){if('undefined'!=typeof e[A].type&&'radio'==e[A].type||'undefined'!=typeof e[A].type&&'checkbox'==e[A].type)if(e[A].checked||'undefined'==typeof b[P]&&'undefined'!=e[A].value&&
/^(true|false)$/.test(e[A].value)||!e[A].checked&&'undefined'!=typeof b[P]&&'undefined'!=typeof b[P].isBoolean&&/^(true|false)$/.test(e[A].value))if(/^(true|false)$/.test(e[A].value))if('undefined'==typeof b[P]?b[P]={isBoolean:!0}:'undefined'!=typeof b[P]&&'undefined'==typeof b[P].isBoolean&&(b[P].isBoolean=!0,b[P].isRequired=!0),'radio'==e[A].type){if('undefined'==typeof b[P])throw Error('rule '+P+' is not defined');/^true$/.test(b[P].isBoolean)&&e[A].checked&&(x[P]=/^true$/.test(e[A].value)?!0:
!1)}else x[P]=e[A].value=/^true$/.test(e[A].value)?!0:!1;else x[P]=e[A].value;else b&&'undefined'!=typeof b[P]&&'undefined'!=typeof b[P].isBoolean&&'undefined'!=typeof b[P].isRequired&&!/^(true|false)$/.test(e[A].value)&&(x[P]=!1);else x[P]=e[A].value;'undefined'==typeof n[P]&&(n[P]=e[A],n[P].setAttribute('data-gina-form-errors',''))}}x._length=x.count()||0;return{$fields:n,fields:x,rules:b}},wa=function(e,b,h,n){return'undefined'==typeof e[h]||/^(null|NaN|undefined|\s*)$/i.test(b[h])?b[h]:'undefined'!=
...
wa(e,b,h);return b},Ha=function(e,b,h,n){var x=JSON.parse(e.replace(/"(true|false)"/gi,'$1')),r=JSON.stringify(x);n&&(b=h[Object.getOwnPropertyNames(h)[0]].form,h=Yb(b,x),delete h.fields._length,b=h.fields,h=h.$fields);n=[];var A=0;for(W in b)n[A]=W,A++;n.sort().reverse();for(let aa=0,Q=n.length;aa<Q;aa++){var W=n[aa].replace(/\-|_|@|#|\.|\[|\]/g,'\\$&');W=new RegExp('\\$'+W,'g');A='\\"'+b[n[aa]]+'\\"';var P=W.test(r);P&&'undefined'!=typeof x[n[aa]]?A=wa(x,b,n[aa],!0):P&&console.warn('`'+n[aa]+'` is used in a dynamic rule without definition. This could lead to an evaluation error. Casting `'+
n[aa]+'` to `string`.');e=e.replace(W,A)}if(/\$(.*)/.test(e))for(let aa=0,Q=n.length;aa<Q;aa++)W=n[aa].replace(/\-|_|@|#|\.|\[|\]/g,'\\$&'),W=new RegExp('\\$'+W,'g'),A=''!=h[n[aa]].value?'\\"'+h[n[aa]].value+'\\"':'\\"\\"',(P=W.test(r))&&'undefined'!=typeof x[n[aa]]?A=wa(x,b,n[aa],!0):P&&console.warn('`'+n[aa]+'` is used in a dynamic rule without definition. This could lead to an evaluation error. Casting `'+n[aa]+'` to `string`.'),e=e.replace(W,A||h[n[aa]].checked);return JSON.parse(e)},M=function(e,
b,h,n,x){delete b._length;var r=JSON.stringify(n);b=xa(r,b);/\$(.*)/.test(r)&&(n=!/^form$/i.test(e.tagName)&&1==h.count()&&/true/i.test(e.form.dataset.ginaFormLiveCheckEnabled)?!0:!1,n=Ha(r,b,h,n));var A=null,W=r=null,P=!1,aa=0;b.count();var Q=!1,w=null,ja=null,ua=null,na=0,la=null,Ba=null,ya=null,Ya=function(Xa,gb,ia){if('undefined'==typeof gb[Xa]){skipTest=!1;for(var Y in gb)if(!/^_comment$/i.test(Y)&&/^\//.test(Y)&&(la=Y.match(/\/(.*)\//).pop(),Ba=Y.replace('/'+la+'/',''),la=la.replace(/\[/g,'\\[').replace(/\]/g,
'\\]'),la=new RegExp(la,Ba),la.test(Xa))){skipTest=!0;gb[Xa]=gb[Y];break}if('undefined'==typeof gb[Xa])return}var ka=Object.getOwnPropertyNames(gb)||[];Y=0;var ra=ka.length;if(0<ra)for(;Y<ra;)'undefined'!=typeof gb[ka[Y]].exclude&&/^true$/i.test(gb[ka[Y]].exclude)&&(ka.splice(Y,1),ra--,Y--),Y++;for(var Qa in gb[Xa])if('function'==typeof Ta[Xa][Qa]){/^((is)\d+|is$)/.test(Qa)&&'undefined'==typeof Ta[Xa][Qa]&&(Ta[Xa][Qa]=function(){},Ta[Xa][Qa]=V(Ta[Xa][Qa],Ta[Xa][Qa.replace(/\d+/,'')]),Ta[Xa][Qa].setAlias=
function(kb){this._currentValidatorAlias=kb}(Qa));try{if(Array.isArray(gb[Xa][Qa])){ya=JSON.clone(gb[Xa][Qa]);if(/\$[\-\w\[\]]*/.test(ya[0])){var Za=ya[0].match(/\$[\-\w\[\]]*/g);Y=0;for(var db=Za.length;Y<db;++Y)ya[0]=ya[0].replace(Za[Y],Ta[Za[Y].replace('$','')].value)}Ta[Xa][Qa].apply(Ta[Xa],ya)}else if(/^query$/.test(Qa)){w=h[Xa];ja=w.getAttribute('id');ua='asyncCompleted.'+ja;var Pa=0,xb=!1;if('undefined'!=typeof gina.events[ua]){console.debug('event `'+ua+'` already added');na=0;break}++na;
addListener(gina,w,ua,function(kb){kb.preventDefault();Pa++;--na;var pb=Object.getOwnPropertyNames(gb[Xa]);pb[pb.length-1]==Qa&&(Q=!0);pb='asyncCompleted.'+kb.target.getAttribute('id');if(!/true/.test(xb)){Ta[Xa]=kb.detail;var qb=e;/^form$/i.test(e.tagName)||(qb=e.form);var sb=qb.getAttribute('id');if(Q&&0>=na&&!xb&&(xb=!0,removeListener(gina,kb.target,pb),x._data=Ta.toData(),x._errors=Ta.getErrors(Xa),x._errors&&0<x._errors.count())){'undefined'==typeof p.$forms[sb].errors&&(p.$forms[sb].errors=
{});p.$forms[sb].errors[Xa]=x._errors[Xa];if(!mb&&/^true|false$/i.test(p.$forms[sb].isValidating)||''!=Ta[Xa].target.value)q(eb[Xa]),F(qb,x._errors,x._data,Xa),Pb(qb,mb);U&&K&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&(gina.forms.errors||(gina.forms.errors={}),window.ginaToolbar.update('forms',{id:sb,errors:p.$forms[sb].errors||{}}));triggerEvent(gina,qb,'validated.'+sb,x);return}kb=!1;var mb=null;1==ka.length||ka[ka.length-1]==Xa?(mb=0<x._errors.count()?!1:!0,!mb&&/^true|false$/i.test(p.$forms[sb].isValidating)&&
(p.$forms[sb].errors=X(x._errors,p.$forms[sb].errors),q(eb[Xa]),F(qb,x._errors,x._data,Xa),Pb(qb,mb)),triggerEvent(gina,qb,'validated.'+sb,x)):/^true$/i.test(p.$forms[sb].isValidating)&&1<ka.length&&ka[ka.length-1]!=Xa&&(kb=!0);kb&&M(qb,Ib,eb,gb,function(Nb){p.$forms[sb].isValidating=!1;mb=Nb.isValid();U&&K&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&(gina.forms.errors||(gina.forms.errors={}),window.ginaToolbar.update('forms',{id:sb,errors:Nb.error||{}}));F(qb,Nb.error,Nb.data,Xa);
Pb(qb,mb)})}});Ta[Xa][Qa](gb[Xa][Qa]);continue}else Ta[Xa][Qa](gb[Xa][Qa]);delete ia[Xa]}catch(kb){if('conditions'==Qa)throw Error('[ ginaFormValidator ] could not evaluate `'+Xa+'->'+Qa+'()` where `conditions` must be a `collection` (Array)\nStack:\n'+kb);throw Error('[ ginaFormValidator ] could not evaluate `'+Xa+'->'+Qa+'()`\nStack:\n'+kb);}}},Ta=null,tb={},Ab=!1;K?/^form$/i.test(e.tagName)?(A=e.getAttribute('id'),r='validated.'+A,p.$forms[A].fields=b,'undefined'!=typeof e.eventData&&'undefined'!=
typeof e.eventData.error&&delete e.eventData.error,Ta=new m(b,h,C)):(Ab=!0,A=e.form.getAttribute('id')||e.form.target.getAttribute('id'),r='validated.'+A,p.$forms[A].fields=b,Ta=new m(b,h,C,p.$forms[A].fieldsSet)):Ta=new m(b,null,C);var Ib=null,eb=null;if(Ab){Ab=e.form.getAttribute('id');var Bb=Yb(p.$forms[Ab].target,p.$forms[Ab].rules,!1);Ib=xa(JSON.stringify(p.$forms[Ab].rules),JSON.clone(Bb.fields));eb=Bb.$fields}else Ib=JSON.clone(b),eb=h;Ab='undefined'!=typeof n?JSON.clone(n):{};var Vb=function(Xa,
gb,ia,Y,ka,ra,Qa,Za){var db=null;if('undefined'!=typeof ra)for(var Pa in Y)if(K&&'undefined'==typeof ka[Pa])console.warn('field `'+Pa+'` found for your form rule ('+Xa.id+'), but not found in $field collection.\nPlease, check your HTML or remove `'+Pa+'` declaration from your rule if this is a mistake.');else{K&&ka[Pa].getAttribute('data-gina-form-element-group')&&'undefined'!=typeof ra[Pa]&&'undefined'!=typeof ra[Pa].exclude&&ra[Pa].exclude&&!ka[Pa].disabled&&(ra[Pa].exclude=!1);var xb='undefined'!=
typeof ra['_case_'+Pa]?!0:!1;if(K&&'input'==ka[Pa].tagName.toLowerCase()&&/(checkbox)/i.test(ka[Pa].getAttribute('type')))if(!ka[Pa].checked&&'undefined'!=typeof ra[Pa]&&'undefined'!=typeof ra[Pa].isRequired&&/^(false)$/i.test(ra[Pa].isRequired)||ka[Pa].disabled)ra[Pa]={exclude:!0};else if(!ka[Pa].checked&&'undefined'==typeof ra[Pa])continue;for(var kb in ra)if(/^_case_/.test(kb)&&'undefined'!=typeof ra[kb].conditions&&(!Array.isArray(ra[kb].conditions)||ra[kb].conditions.length)&&'undefined'!=typeof ra[kb].conditions[0].rules&&
'undefined'!=typeof ra[kb].conditions&&Array.isArray(ra[kb].conditions))if(db=kb.replace('_case_',''),'undefined'==typeof eb[db])console.warn('Found case `'+kb+'` but field `'+db+'` is misssing in the dom.\n You should add `'+db+'` element to your form in order to allow Validator to process this case.');else{'undefined'==typeof gb[db]&&(gb[db]=eb[db].value);var pb=gb[db];K&&('true'==Y[Pa]?pb=!0:'false'==Y[Pa]&&(pb=!1));for(var qb=0,sb=ra[kb].conditions.length;qb<sb;++qb)if(ra[kb].conditions[qb].case==
pb)for(var mb in ra[kb].conditions[qb].rules)if(!/^_comment$/i.test(mb)&&mb!=db&&ka[mb])if(Pa==mb||/^\//.test(mb)||'undefined'!=typeof Y[mb]||'undefined'==typeof gb[mb])if(/^\//.test(mb)){if(la=mb.match(/\/(.*)\//).pop(),Ba=mb.replace('/'+la+'/',''),la=la.replace(/\[/g,'\\[').replace(/\]/g,'\\]'),la=new RegExp(la,Ba),la.test(Pa)){if(ra[kb].conditions[qb].case==pb||/^\//.test(ra[kb].conditions[qb].case)&&(new RegExp(ra[kb].conditions[qb].case)).test(pb))Nb='undefined'!=typeof ra[mb]?ra[mb]:{},ra[mb]=
X(ra[kb].conditions[qb].rules[mb],Nb);db!=mb&&'undefined'!=typeof ra[mb]&&Ya(mb,ra,Y)}}else'undefined'!=typeof ra[kb].conditions[qb].rules[mb]&&(caseField=mb,pb=Y[caseField],'undefined'==typeof ka[caseField]?console.warn('ignoring case `'+caseField+'`: field `NaN'):(K&&/^(true|false)$/i.test(pb)&&'undefined'!=typeof ra[caseField]&&'undefined'!=typeof ra[caseField].isBoolean&&/^(true)$/i.test(ra[caseField].isBoolean)&&(pb=/^(true)$/i.test(pb)?!0:!1),'undefined'!=typeof ra[kb].conditions[qb].rules[mb]&&
(Nb='undefined'!=typeof ra[kb].conditions[qb].rules[mb]?ra[kb].conditions[qb].rules[mb]:{},ra[mb]=Nb),db!=mb&&'undefined'!=typeof ra[mb]&&'undefined'!=typeof Y[mb]&&Ya(mb,ra,Y)));else{Y[mb]=gb[mb];var Nb='undefined'!=typeof ra[mb]?ra[mb]:{};ra[mb]=X(ra[kb].conditions[qb].rules[mb],Nb);Ya(mb,ra,Y)}}if(db!=Pa&&('undefined'!=typeof ra[Pa]&&Ya(Pa,ra,gb),xb)){++Za;xb=ra['_case_'+Pa].conditions;if(!xb)throw Error('[ ginaFormValidator ] case `_case_'+Pa+'` found without `condition(s)` !\nPlease, check your delcaration for `_case_'+
Pa+'`');for(let Kb=0,$b=xb.length;Kb<$b;++Kb)if(pb=gb[Pa],K&&('true'==Y[Pa]?pb=!0:'false'==Y[Pa]&&(pb=!1)),xb[Kb]['case']===pb||Array.isArray(xb[Kb]['case'])&&-1<xb[Kb]['case'].indexOf(pb)||/^\//.test(xb[Kb]['case'])){Nb={};if('undefined'==typeof xb[Kb].rules[Pa]&&'undefined'==typeof gb[Pa]||ka[Pa].disabled)xb[Kb].rules[Pa]={exclude:!0};for(var Eb in xb[Kb].rules)if(!/^_comment$/i.test(Eb))if(/^\//.test(Eb)){la=Eb.match(/\/(.*)\//).pop();Ba=Eb.replace('/'+la+'/','');la=la.replace(/\[/g,'\\[').replace(/\]/g,
'\\]');la=new RegExp(la,Ba);for(var Hb in ka)la.test(Hb)&&(/^\//.test(xb[Kb]['case'])?(la=xb[Kb]['case'].match(/\/(.*)\//).pop(),Ba=xb[Kb]['case'].replace('/'+la+'/',''),la=new RegExp(la,Ba),la.test(pb)&&(Nb[Hb]=xb[Kb].rules[Eb])):Nb[Hb]=xb[Kb].rules[Eb],'undefined'==typeof Y[Hb]&&'undefined'!=typeof ka[Hb]&&'undefined'!=typeof ka[Hb].value&&(Y[Hb]=ka[Hb].value,K&&/(true|false)/i.test(Y[Hb])&&('true'==Y[Hb]?Y[Hb]=!0:'false'==Y[Hb]&&(Y[Hb]=!1)),Ta.addField(Hb,Y[Hb]),'undefined'!=typeof ia[Hb]&&(Nb[Hb]=
X(Nb[Hb],ia[Hb]))))}else/^\//.test(xb[Kb]['case'])?(la=xb[Kb]['case'].match(/\/(.*)\//).pop(),Ba=xb[Kb]['case'].replace('/'+la+'/',''),la=la.replace(/\[/g,'\\[').replace(/\]/g,'\\]'),la=new RegExp(la,Ba),la.test(pb)&&(Nb[Eb]=xb[Kb].rules[Eb])):Nb[Eb]=xb[Kb].rules[Eb],'undefined'==typeof Y[Eb]&&'undefined'!=typeof ka[Eb]&&'undefined'!=typeof ka[Eb].value&&(Y[Eb]=ka[Eb].value,K&&/(true|false)/i.test(Y[Eb])&&('true'==Y[Eb]?Y[Eb]=!0:'false'==Y[Eb]&&(Y[Eb]=!1)),Ta.addField(Eb,Y[Eb]),'undefined'!=typeof ia[Eb]&&
(Nb[Eb]=X(Nb[Eb],ia[Eb])));++aa;if(K)Vb(Xa,gb,ia,Y,ka,Nb,Qa,Za);else return Vb(Xa,gb,ia,Y,ka,Nb,Qa,Za)}--Za}}--aa;if(0>=Za&&0>aa){gb=Ta.getErrors();for(Pa in gb){for(rule in gb[Pa])tb[Pa]||(tb[Pa]=''),0>tb[Pa].indexOf(rule)&&(tb[Pa]+=rule+' ');K&&ka[Pa].setAttribute('data-gina-form-errors',tb[Pa].substr(0,tb[Pa].length-1))}try{W=Na(Ta.toData()),U&&K&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&(gina.forms.validated||(gina.forms.validated={}),gina.forms.validated[A]||(gina.forms.validated[A]=
{}),window.ginaToolbar.update('forms',{id:A,validated:W}))}catch(Kb){throw Kb;}Q=!0;if(!P&&0>=na)if('undefined'!=typeof Qa&&'function'===typeof Qa)Qa._errors=Ta.getErrors(),Qa._data=Ta.toData(),triggerEvent(gina,Xa,'validated.'+A,Qa);else return P=!0,{isValid:Ta.isValid,error:gb,data:W}}};K&&addListener(gina,e,r,function(Xa){Xa.preventDefault();if(!P){P=!0;Q=!1;na=0;var gb=Xa.detail,ia=gb._data||Ta.toData(),Y=gb._errors||Ta.getErrors()||null;console.debug('instance errors: ',p.$forms[A].errors,' VS cbErrors: ',
Y,Ta.isValid(),' VS d.getErrors(): ',Ta.getErrors());0<Y.count()&&Ta.isValid()&&(Ta.isValid=function(){return!1});gb({isValid:Ta.isValid,error:Y,data:Na(ia)});removeListener(gina,Xa.target,'validated.'+Xa.target.id)}});if(K)Vb(e,Ib,Ab,b,h,n,x,0);else return Vb(e,Ib,Ab,b,h,n,x,0)};return K?Oa(E):B(E,O,ha)}'undefined'!==typeof module&&module.exports?module.exports=ValidatorPlugin:'function'===typeof define&&define.amd&&define('gina/validator',['utils/events','utils/dom','utils/form-validator'],function(){return ValidatorPlugin});
define('gina/toolbar','require jquery vendor/uuid utils/collection utils/routing gina/storage gina/validator'.split(' '),function(E){var O=E('jquery');O.noConflict();var ha=E('utils/routing');E('utils/collection');var Ca=E('gina/storage');return function(){var K=null,U=!1,oa=!1,X=!1,V,m=(new Ca({bucket:'gina'})).Collection('plugin'),S=null,p=null,da=!1,za=null,N=null,L=null,C=null,B=null,u='',z=null,y=null,J=null,q='',v=null,F=0,H=0,R=0,sa='',T={},ca=null,ea=null,Ja=null,fa=null,pa=null,Ea=null,Ka=
null,Oa=null,Ia=null,Da=null,cb=null,Fa=null,Na=null,Wa=null,rb=function(){S=O('#gina-toolbar');if(!S.length)return!1;za=S.find('.gina-toolbar-tab > a');N=O('#gina-toolbar-toggle');L=O('#gina-toolbar-panels');C=L.find('.gina-toolbar-panel');z=O('#gina-toolbar-vposition');y=O('#gina-toolbar-hposition');J=z.add(y);v=O('#gina-toolbar-width');S.find('.gina-toolbar-main');ca=O('#gina-toolbar-json');ea=O('#gina-toolbar-gina-json');Ja=O('#gina-toolbar-toggle-code-raw');$forms=O('form:not(.gina-toolbar-options, .gina-toolbar-content)');
Ia=O('#gina-toolbar-data-html');Da=O('#gina-toolbar-view-html');cb=O('#gina-toolbar-forms-html');Oa=O('#gina-toolbar-configuration-environment-html');Fa=O('#gina-toolbar-code-toggle');S.prepend('<textarea class="gina-toolbar-copy"></textarea>');Na=S.find('.gina-toolbar-copy');p=m.findOne({_name:'toolbar'});p||(p={_name:'toolbar',_version:'1.0.3',_description:'Toolbar settings',_licence:'MIT',_author:[{name:'John Doe',company:'Acme'},{name:'Martin-Luther Etouman',company:'Rhinostone'}],
...
delete Ka.environment.routing;delete pa.environment.reverseRouting;delete Ka.environment.reverseRouting;delete pa.environment.forms;delete Ka.environment.forms;Oa.html(nb(pa.environment,Ka.environment));r=pa.data;var W=pa.view;x=pa.forms;var P=Ka.data,aa=Ka.view;A=Ka.forms;oa=V=!1;var Q=null,w=!1;/^(view-xhr)$/.test(h)&&(Q=!0,W=pa[h],aa=Ka[h],r=pa['data-xhr'],P=Ka['data-xhr']);if(!h||/^(data)$/.test(h))Ia.html('<ul class="gina-toolbar-code">'+nb(r,P,null,Q)+'</ul>'),Da.html('<div id="gina-toolbar-view-html-properties" class="gina-toolbar-section">\n    <h2 class="gina-toolbar-section-title">properties</h2>\n    <ul class="gina-toolbar-properties"></ul>\n</div>'),
...
/^(data-xhr)$/.test(h)?Ia.html('<ul class="gina-toolbar-code">'+nb(pa[h],Ka[h],null,Q)+'</ul>'):/^(view-xhr)$/.test(h)&&(Da.html('<div id="gina-toolbar-view-html-properties" class="gina-toolbar-section">\n    <h2 class="gina-toolbar-section-title">properties</h2>\n    <ul class="gina-toolbar-properties"></ul>\n</div>'),Da.html(Yb(pa[h],Ka[h],null,Q,Da)))}/^(el-xhr)$/.test(h)&&(Q=!0,r=O('#'+n).find('form:not(.gina-toolbar-options, .gina-toolbar-content)'),cb.html(''),cb.html(xa(x,A,cb,0,r,r.length,
...
0<n.errors.count()&&Ha(n.id,'errors',n.errors,Q),'undefined'!=typeof n.sent&&Ha(n.id,'sent',n.sent,Q));p.currentFile=pa.file;p.currentFile||(p.currentFile=pa.file);pa.file==p.currentFile&&O(document).ready(function(){oa?(U=!0,0<p.isUnfolded.length&&!V&&(V=!0,setTimeout(function(){0<p.isUnfolded.length&&fb(p.isUnfolded,p.isUnfolded.length,0)},200))):Q?(U=!0,0<p.isUnfolded.length&&!V&&(V=!0,fb(p.isUnfolded,p.isUnfolded.length,0))):(U=!1,setTimeout(function(){0<p.isUnfolded.length&&fb(p.isUnfolded,p.isUnfolded.length,
0)},200))})}if(!h||'el-xhr'==h&&!X)X=h&&'el-xhr'==h?!0:!1,wa(h)},fb=function(h,n,x){if(x==n)return!1;var r=h[x],A=null;U&&/^xhr-/.test(r)?(r=r.replace(/^xhr-/,''),A=O('.gina-toolbar-xhr-folding-state-'+r)):A=O('.gina-toolbar-folding-state-'+r);Ob(A,function(){x+=1;fb(h,n,x)})},gc=function(){Ia.add(Da).off('click','a').on('click','a',function(n){n.preventDefault();Ob(O(this),null,!0)}).add(cb).off('click','a').on('click','a',function(n){n.preventDefault();Ob(O(this),null,!0)});Fa.off('click').on('click',
function(n){n.preventDefault();Ob('all',null,!0)});Ia.add(Da,cb).off('click','.gina-toolbar-value').on('click','.gina-toolbar-value',function(n){n.preventDefault();try{Wa=O(this).text(),Na.text(Wa),Na.select(),document.execCommand('copy',!1,null),Na.blur()}catch(x){alert('Please press Ctrl/Cmd+C to copy the value')}});Ja.off('click').on('click',function(n){pa&&window.open('','JSON RAW','width=400,height=100').document.write(JSON.stringify(pa.data))});za.off('click').on('click',function(n){n.preventDefault();
za.removeClass('gina-toolbar-active');C.removeClass('gina-toolbar-active');O(this).addClass('gina-toolbar-active');u=O(this).attr('href');B=O(u).addClass('gina-toolbar-active');p.panelId=u;p.save()});N.off('click').on('click',function(n){n.preventDefault();S.toggleClass('gina-toolbar-collapsed');da=S.hasClass('gina-toolbar-collapsed');p.isCollapsed=da;p.save()});J.off('change').on('change',function(n){n.preventDefault();n=z.val();var x=y.val();q=n+'-'+x;yb(q);p.position=q;p.save()});v.off('change').on('change',
function(n){n.preventDefault();F=v.val();ib(F);p.width=F;p.save()});O(window).off('resize').on('resize',function(){Gb()});O('body').off('keypress').on('keypress',function(n){if(!/INPUT|TEXTAREA/.test(n.target.tagName)){sa=n.keyCode?n.keyCode:n.which?n.which:n.charCode;n=new Date;if('undefined'!=typeof T.keynum&&T.keynum==sa&&'undefined'!=typeof T.pressTime&&500>n.getTime()-T.pressTime)switch(sa){case 103:S.toggle()}T.pressTime=n.getTime();T.keynum=sa}});za.filter('[href="'+u+'"]').trigger('click');
da||O('#gina-toolbar-toggle').trigger('click');yb(q);var h=q.split('-');z.val(h[0]);y.val(h[1]);ib(F);v.val(F);Gb();h=ca?ca.text():'';/^\{\{ (.*) \}\}/.test(h)?e(h,bb):bb()},yb=function(h){S.removeClass('gina-toolbar-top-left gina-toolbar-top-right gina-toolbar-bottom-left gina-toolbar-bottom-right').addClass('gina-toolbar-'+h)},ib=function(h){S.removeClass('gina-toolbar-auto gina-toolbar-100 gina-toolbar-80 gina-toolbar-60 gina-toolbar-50 gina-toolbar-40 gina-toolbar-30').addClass('gina-toolbar-'+
h)},Gb=function(){H=window.innerHeight-32;S.find('.gina-toolbar-main').css('max-height',H+'px');var h=B.find('.gina-toolbar-main'),n=h.find('.gina-toolbar-content');R=h.height();R==H?n.addClass('gina-toolbar-content-end'):n.removeClass('gina-toolbar-content-end')},Ob=function(h,n,x){'undefined'==typeof x&&(x=!1);if(void 0!=h&&h.length&&'all'!=h){K=h.attr('class');var r=!1;if(/(gina-toolbar-folding-state-[a-z 0-9_-]+|gina-toolbar-xhr-folding-state-[a-z 0-9_-]+)/i.test(K))if(/gina-toolbar-folding-state-[a-z0-9_-]+/i.test(K)?
...
W+='<span class="gina-toolbar-key">'+Q+':</span> <span class="gina-toolbar-value gina-toolbar-value-type-is-'+w+'">'+h[Q]+'</span>'),W+='</li>';else x+='-'+Q.replace(/[^A-Za-z0-9_-]/g,'_'),w=0<h[Q].count()||'undefined'!=typeof n[Q]&&0<n[Q].count()?'':' is-empty',W+='<li class="gina-toolbar-object">',W+='<a href="#" class="gina-toolbar-key gina-toolbar'+aa+'-folding-state-'+Ma(P,Q.replace(/[^A-Za-z0-9_-]/g,'_'))+w+'">'+Q+' <span>{ }</span></a>',W+='<ul class="gina-toolbar-object">'+nb(h[Q],n[Q],x,
...
W+='<ul class="gina-toolbar-collection">'+Pb(h[Q],n[Q],x,r,A)+'</ul>',W+='</li>',x=x.substr(0,x.length-Q.toString().length)):W+='<li class="gina-toolbar-key-value"><span class="gina-toolbar-key">'+Q+':</span> <span class="gina-toolbar-value">'+h[Q]+'</span></li>':(n[Q]||(n[Q]=h[Q]),x+='-'+Q,''==P&&(P=x),W+='<li class="gina-toolbar-object">',W+='<a href="#" class="gina-toolbar-key gina-toolbar'+aa+'-folding-state-'+Ma(P,Q)+'">'+Q+' <span>{ }</span></a>',W+='<ul class="gina-toolbar-object">'+nb(h[Q],
n[Q],x,r,A)+'</ul>',W+='</li>',x=x.substr(0,x.length-Q.toString().length-1));return W},Yb=function(h,n,x,r,A,W){x=null!=x?x.replace(/[^A-Za-z0-9_-]/g,'_'):'';var P='undefined'!=typeof r&&null!=r?'-xhr':'';h=jb(h);n=jb(n);W||=A;for(var aa in h){var Q=aa;if('object'!=typeof h[aa]||Array.isArray(h[aa])||null===h[aa])if(Array.isArray(h[aa])){var w=O('#gina-toolbar-view-'+x.substr(0,x.length-1));var ja=w.length?!0:!1;!ja||/^html/.test(x)?(w=O('.'+x),ja=x+aa.replace(/[^A-Za-z0-9_-]/g,'_')+'-',w.append('<li class="gina-toolbar-collection"><a href="#" class="gina-toolbar-key gina-toolbar'+
...
aa=null;try{var Ya=A[r].getAttribute('data-gina-form-rule');aa='undefined'!=typeof Ya&&null!=Ya?eval('gina.forms.rules.'+Ya.replace(/-/g,'.')):eval('gina.forms.rules.'+w.replace(/-/g,'.'))}catch(Ta){}aa&&(Q='rules',ja.find('ul.gina-toolbar-section-content').append('<li class="gina-toolbar-form-'+Q+'"><h3 class="gina-toolbar-sub-section-title">'+Q+'</h3><ul class="gina-toolbar-properties">'+nb(aa,aa,w,P,Q)+'</ul></li>'));x.append(ja);++r;r<W&&xa(h,n,x,r,A,W,P)},Ha=function(h,n,x,r){var A=O('#gina-toolbar-form-'+
h);$section=A.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-'+n+'> ul');if(0<$section.length){if(0==x.count())return A.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-'+n).remove(),!1;$section.html(nb(x,x,h,r,n))}else A.find('ul.gina-toolbar-section-content').append('<li class="gina-toolbar-form-'+n+'"><h3 class="gina-toolbar-sub-section-title">'+n+'</h3><ul class="gina-toolbar-properties">'+nb(x,x,h,r,n)+'</ul></li>');h=A.find('ul.gina-toolbar-section-content');
...
n)};this.restore=function(){Ea&&'undefined'!=typeof Ea.data&&(fa.jsonObject.data=Ea.data);bb('data',fa.jsonObject,fa.ginaJsonObject);X=!1;ha.notFound={}};if('undefined'!=typeof gina.validator)gina.validator.on('initialized',function(){console.log('toolbar validator ready');rb()});else rb()}});
define('gina','require vendor/uuid utils/merge utils/events helpers/prototypes helpers/dateFormat gina/toolbar'.split(' '),function(E){E('utils/events');var O=E('utils/merge'),ha=E('helpers/dateFormat')();E('helpers/prototypes')({dateFormat:ha});var Ca=E('vendor/uuid');window.process||function(K,U,oa,X,V,m,S){for(m=K[oa]||(K[oa]={});!S&&V<X.length;)S=K[X[V++]+'requestAnimationFrame'];m[U]=m[U]||S&&S.bind(K)||K.setImmediate||K.setTimeout}(window,'nextTick','process',['r','webkitR','mozR','msR','oR'],
0);window.getComputedStyle||(window.getComputedStyle=function(K,U){this.el=K;this.getPropertyValue=function(oa){var X=/(\-([a-z]){1})/g;'float'==oa&&(oa='styleFloat');X.test(oa)&&(oa=oa.replace(X,function(V,m,S){return S.toUpperCase()}));return K.currentStyle[oa]?K.currentStyle[oa]:null};return this});return function(K){this.plugin='gina';var U='gina-'+Ca.v1(),oa=document,X;document.id=U;U={id:U,isFrameworkLoaded:!1,hasValidator:!1,hasPopinHandler:!1,config:{},registeredEvents:{},events:{},setOptions:function(V){X=
O(X,V,!0)}};'undefined'!=typeof parent.window.gina&&(window.gina=O(window.gina||{},parent.window.gina));U=O(window.gina||{},U);registerEvents(this.plugin,['ginaloaded','ready']);triggerEvent(K,oa,'ginaloaded',U)}});
...
K.apply(this,arguments)}function U(wa,xa){if('function'!=typeof xa&&null!==xa)throw new TypeError('Super expression must either be null or a function');wa.prototype=Object.create(xa&&xa.prototype,{constructor:{value:wa,writable:!0,configurable:!0}});xa&&X(wa,xa)}function oa(wa){return oa=Object.setPrototypeOf?Object.getPrototypeOf:function(xa){return xa.__proto__||Object.getPrototypeOf(xa)},oa(wa)}function X(wa,xa){return X=Object.setPrototypeOf||function(Ha,M){return Ha.__proto__=M,Ha},X(wa,xa)}
function V(){if('undefined'==typeof Reflect||!Reflect.construct||Reflect.construct.sham)return!1;if('function'==typeof Proxy)return!0;try{return Date.prototype.toString.call(Reflect.construct(Date,[],function(){})),!0}catch(wa){return!1}}function m(wa,xa,Ha){return m=V()?Reflect.construct:function(M,e,b){var h=[null];h.push.apply(h,e);M=new (Function.bind.apply(M,h));return b&&X(M,b.prototype),M},m.apply(null,arguments)}function S(wa){var xa='function'==typeof Map?new Map:void 0;return S=function(Ha){function M(){return m(Ha,
arguments,oa(this).constructor)}if(null===Ha||(e=Ha,-1===Function.toString.call(e).indexOf('[native code]')))return Ha;var e;if('function'!=typeof Ha)throw new TypeError('Super expression must either be null or a function');if(void 0!==xa){if(xa.has(Ha))return xa.get(Ha);xa.set(Ha,M)}return M.prototype=Object.create(Ha.prototype,{constructor:{value:M,enumerable:!1,writable:!0,configurable:!0}}),X(M,Ha)},S(wa)}function p(wa){if(void 0===wa)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
return wa}function da(wa){var xa=V();return function(){var Ha=oa(wa);if(xa){var M=oa(this).constructor;Ha=Reflect.construct(Ha,arguments,M)}else Ha=Ha.apply(this,arguments);return!Ha||'object'!=typeof Ha&&'function'!=typeof Ha?p(this):Ha}}function za(wa,xa,Ha){return za='undefined'!=typeof Reflect&&Reflect.get?Reflect.get:function(M,e,b){for(;!Object.prototype.hasOwnProperty.call(M,e)&&null!==(M=oa(M)););if(M)return e=Object.getOwnPropertyDescriptor(M,e),e.get?e.get.call(b):e.value},za(wa,xa,Ha||
wa)}function N(wa){if(wa){for(var xa in N.prototype)wa[xa]=N.prototype[xa];return wa}}function L(wa){for(var xa=arguments.length,Ha=Array(1<xa?xa-1:0),M=1;M<xa;M++)Ha[M-1]=arguments[M];return Ha.reduce(function(e,b){return wa.hasOwnProperty(b)&&(e[b]=wa[b]),e},{})}function C(wa,xa){xa.useNativeTimers?(wa.setTimeoutFn=cb.bind(Da),wa.clearTimeoutFn=Fa.bind(Da)):(wa.setTimeoutFn=setTimeout.bind(Da),wa.clearTimeoutFn=clearTimeout.bind(Da))}function B(wa){var xa='';do xa=rb[wa%64]+xa,wa=Math.floor(wa/
...
gc))return new XMLHttpRequest}catch(xa){}if(!wa)try{return new (Da[['Active'].concat('Object').join('X')])('Microsoft.XMLHTTP')}catch(xa){}}function q(){}function v(){for(var wa in ib.requests)ib.requests.hasOwnProperty(wa)&&ib.requests[wa].abort()}function F(wa){var xa=wa,Ha=wa.indexOf('['),M=wa.indexOf(']');-1!=Ha&&-1!=M&&(wa=wa.substring(0,Ha)+wa.substring(Ha,M).replace(/:/g,';')+wa.substring(M,wa.length));var e,b;wa=nb.exec(wa||'');for(var h={},n=14;n--;)h[Pb[n]]=wa[n]||'';return-1!=Ha&&-1!=M&&
...
e.on('error',function(b,h){M.onError('xhr poll error',b,h)});this.pollXhr=e}},{key:'name',get:function(){return'polling'}}]),xa}(pa);var ib=function(wa){function xa(M,e){var b;return O(this,xa),C(p(b=Ha.call(this)),e),b.opts=e,b.method=e.method||'GET',b.uri=M,b.async=!1!==e.async,b.data=void 0!==e.data?e.data:null,b.create(),b}U(xa,wa);var Ha=da(xa);return Ca(xa,[{key:'create',value:function(){var M=this,e=L(this.opts,'agent','pfx','key','passphrase','cert','ca','ciphers','rejectUnauthorized','autoUnref');
...
for(var b=function(n){var x=n===M.length-1;ea(M[n],e.supportsBinary,function(r){try{e.ws.send(r)}catch(A){}x&&Gb(function(){e.writable=!0;e.emitReserved('drain')},e.setTimeoutFn)})},h=0;h<M.length;h++)b(h)}},{key:'doClose',value:function(){void 0!==this.ws&&(this.ws.close(),this.ws=null)}},{key:'uri',value:function(){var M=this.query||{},e=this.opts.secure?'wss':'ws',b='';this.opts.port&&('wss'===e&&443!==Number(this.opts.port)||'ws'===e&&80!==Number(this.opts.port))&&(b=':'+this.opts.port);this.opts.timestampRequests&&
(M[this.opts.timestampParam]=u());this.supportsBinary||(M.b64=1);M=z(M);return e+'://'+(-1!==this.opts.hostname.indexOf(':')?'['+this.opts.hostname+']':this.opts.hostname)+b+this.opts.path+(M.length?'?'+M:'')}},{key:'check',value:function(){return!!Ob}},{key:'name',get:function(){return'websocket'}}]),xa}(pa),polling:fb},nb=/^(?:(?![^:@]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/,
...
U.handler+'` could not be reached. You must expose it to the `window` do object before any call.');var X=U.handler;delete U.handler;window[X].apply(this,Object.values(U));U.handler=X}else O[oa].apply(this,Object.values(U));U.call=oa}catch(V){console.error('BindingHelper encountered error while trying to execute `'+oa+'`'+V.stack||V)}O.process(ha,Ca,K+1)}};return O}define('helpers/binding',[],function(){return BindingHelper});
...
function Domain(E,O){var ha='undefined'!==typeof module&&module.exports?!1:!0,Ca=!1;ha&&(Ca=!!window.MSInputMethodContext&&!!document.documentMode);'function'==typeof E&&(O=E,E=void 0);var K={filename:'../dist/public_suffix_list.dat',url:'https://publicsuffix.org/list/public_suffix_list.dat',alternativeUrl:'https://raw.githubusercontent.com/publicsuffix/list/master/public_suffix_list.dat',isCachingRrequired:!1,isUpdating:!1},U=null,oa=null,X=function(p,da,za){if('undefined'==typeof da)da=K;else for(let N in K)'undefined'==
typeof da[N]&&(da[N]=K[N]);ha||(da.filename=__dirname+'/'+da.filename);ha&&da.isCachingRrequired&&(console.warn('[DOMAIN] `options.isCachingRrequired` is only available for backend'),da.isCachingRrequired=!1);U=da;if(za)return V(da,function(N){N?za(N):(console.debug('[DOMAIN] PSL Loaded'),za(N,p))});V(da);console.debug('[DOMAIN] PSL Loaded');return p},V=async function(p,da){var za=ha||p.isCachingRrequired?p.url:p.filename,N='undefined'!=typeof p.isUpdating?p.isUpdating:!1,L=null;if(ha)if(oa&&!N)da(!1);
else if(window.fetch){L=N=null;try{N=await fetch(za),oa=L=await N.text()}catch(B){L=Error('[DOMAIN] Could not load PSL\n'+(B.stack||B.message||B));da(L);return}p.isUpdating=!1;da(!1)}else L=Error('[DOMAIN] Fetch API not supported'),da(L);else{za=!1;if('undefined'!=typeof fs.accessSync)try{fs.accessSync(p.filename,fs.constants.F_OK),za=!0}catch(B){za=!1;try{fs.lstatSync(p.filename).isSymbolicLink()&&(za=!0)}catch(u){}}else za=fs.existsSync(p.filename);za||(p.isCachingRrequired=!0);if(p.isCachingRrequired){za=
'curl -o '+p.filename+' '+p.url+' >/dev/null 2>&1';console.debug('[DOMAIN] Running: '+za);try{execSync(za)}catch(B){console.warn('[DOMAIN] could not fetch from `'+p.url+'`. Trying with `'+p.alternativeUrl+'`');za='curl -o '+p.filename+' '+p.alternativeUrl+' >/dev/null 2>&1';try{execSync(za)}catch(u){da(u);return}}var C=!1;nIntervId=setInterval(()=>{if('undefined'!=typeof fs.accessSync)try{fs.accessSync(p.filename,fs.constants.F_OK),C=!0}catch(B){C=!1;try{fs.lstatSync(p.filename).isSymbolicLink()&&
(C=!0)}catch(u){}}else C=fs.existsSync(p.filename);C&&(clearInterval(nIntervId),oa=fs.readFileSync(p.filename).toString(),da(!1))},200)}try{oa=fs.readFileSync(p.filename).toString(),da&&da(!1)}catch(B){console.warn('[DOMAIN] could not read from `'+p.filename+'`'),V(E,da)}}},m=function(p){U.isUpdating=!0;V(U,p)},S={getRootDomain:function(p,da){'undefined'==typeof da&&(da=!1);var za=!1,N=!1,L=p.replace(/^(.*):\/\/|\/(.*)/g,''),C=L.split(/\./g).reverse(),B=C.length?C.length-1:0,u=oa.replace(/\/\/\s*(.*)\n|^\s*\n/gm,
'').split(/\n/).filter(function(z,y,J){/[^a-z 0-9.]+/.test(z)&&(z=z.replace(/[^a-z 0-9.]+/g,'').replace(/^\./g,''));return/\./.test(z)&&!za&&(new RegExp('.'+z+'$')).test(L)?(za=!0,B=z.split(/\./g).length,J.splice(0,J.length),!1):z});L=C[B];0<B&&(C=C.splice(0,B),N=C[0],/:(.*)$/.test(N)&&(N=N.replace(/:(.*)$/,'')),(N=za||!za&&-1<u.indexOf(N)?!0:!1)?1<B&&!za?(C.splice(2),L=C.reverse().join('.')):L+='.'+C.reverse().join('.'):1<B?(C.splice(2),L=C.reverse().join('.')):L+='.'+C.reverse().join('.'));/:(.*)$/.test(L)&&
(L=L.replace(/:(.*)$/,''));console.debug('[DOMAIN] isSLD: '+za,p,' -> ',L);return/^true$/i.test(da)?{value:L,isSLD:za,isRegisteredTldOrSld:N}:L}};ha?S.onReady=function(){}:S.updatePSL=m;return ha&&Ca&&!window.fetch?(Ca=document.createElement('script'),Ca.type='text/javascript',Ca.src='https://cdn.jsdelivr.net/npm/promise-polyfill@8.1.3/dist/polyfill.min.js',m=document.createElement('script'),m.type='text/javascript',m.src='https://cdn.jsdelivr.net/npm/whatwg-fetch@3.4.0/dist/fetch.umd.min.js',document.head.appendChild(Ca),
document.head.appendChild(m),setTimeout(()=>X(S,E,O),500)):X(S,E,O)}'undefined'!==typeof module&&module.exports?module.exports=Domain:'function'===typeof define&&define.amd&&define('utils/domain',[],function(){return Domain});
...
request:null,$forms:[]},p=null,da={url:'',method:'GET',isSynchrone:!1,withCredentials:!0,headers:{'X-Requested-With':'XMLHttpRequest'}},za=[],N=function(u,z,y){addListener(gina,u,'click',function(J){cancelEvent(J);triggerEvent(gina,z,y)})},L=function(u){return'undefined'!=typeof m.$links[u]?m.$links[u]:null},C=function(u){var z=null,y;for(y in gina.link.$links)if('undefined'!=typeof gina.link.$links[y].url&&gina.link.$links[y].url==u){z=gina.link.$links[y];break}return z},B=function(u,z){'undefined'==
typeof u&&(u=m.target);var y,J=null;u=u.getElementsByTagName('a');for(var q=0,v=u.length;q<v;++q)if(y=u[q].getAttribute('data-gina-link')){y=u[q];var F={type:'a',method:'GET'};var H=y.getAttribute('data-gina-link-url');F.url='undefined'!=typeof H&&null!=H?H:y.getAttribute('href');H=y.getAttribute('id');if('undefined'==typeof H||null==H||''==H||/popin\.link/.test(H))H='link.click.gina-link-'+m.id+'-'+O.v4();y.id=H;evt=F.id=H;y.setAttribute('id',evt);'A'==y.tagName&&(J=y.getAttribute('onclick'));J?
'undefined'==typeof J||/return false/.test(J)||(J=/;$/.test(J)?J+'return false;':J+'; return false;',y.setAttribute('onclick',J)):y.setAttribute('onclick','return false;');'undefined'==typeof m.$links[F.id]&&(F.target=y,y=K(F,S),X(y,z))}};new ha(function(u,z){if(u)throw u;Ca=z});return function(u){m.bindLinks=B;m.request=oa;m.getLinkById=L;m.getLinkByUrl=C;m.on('init',function(z){if(window.XMLHttpRequest)p=new XMLHttpRequest;else if(window.ActiveXObject)try{p=new ActiveXObject('Msxml2.XMLHTTP')}catch(y){try{p=
...
return T}function X(T,ca){var ea=T.target,Ja=T.type;'undefined'!=typeof T.detail&&'function'==typeof T.detail.trim&&(ea.innerHTML=T.detail.trim());T=function(yb,ib,Gb){var Ob=Gb.getAttribute('data-gina-popin-is-link');Ob=/^true$/i.test(Ob)?!0:!1;'link'!=yb||Ob||(yb='action');addListener(gina,Gb,ib,function(jb){cancelEvent(jb);if('close'!=yb){var Ma=!1,nb='loaded.'+ca.id;'undefined'==typeof gina.events[nb]&&addListener(gina,ea,nb,function(Pb){Pb.preventDefault();Ma||(Ma=!0,S(Pb.detail))});nb={isSynchrone:!1,
withCredentials:!1};nb=K(ca.options,nb);m(ca.name,Gb.href,nb)}removeListener(gina,jb.target,jb.type)});addListener(gina,Gb,'click',function(jb){cancelEvent(jb);if(null!=jb.target.getAttribute('disabled')&&'false'!=jb.target.getAttribute('disabled'))return!1;if('link'==yb){var Ma=jb.target.getAttribute('href')||null,nb=jb.target.getAttribute('target');null!=nb&&''!=nb?window.open(Ma,nb):triggerEvent(gina,jb.target,jb.currentTarget.id,ca)}else'undefined'==typeof jb.target.id&&(jb.target.setAttribute('id',
ib+'.'+O.v4()),jb.target.id=jb.target.getAttribute('id')),/^popin\.close\./.test(jb.target.id)&&(cancelEvent(jb),ca.isRedirecting=!1,N(ca.name)),/^popin\.click\./.test(jb.target.id)&&(cancelEvent(jb),Ma=jb.target.id,(new RegExp('^popin.click.gina-popin-'+B.id)).test(Ma)&&triggerEvent(gina,jb.target,Ma,jb.detail))})};gina.popinIsBinded=!0;var fa=null,pa=null,Ea=null;ca.isOpen||addListener(gina,B.target.childNodes[0],'mousedown',function(yb){if(/gina-popin-is-active/.test(yb.target.className)){removeListener(gina,
yb.target,'mousedown');yb=[];fa=0;var ib=ea.getElementsByTagName('button');pa=0;Ea=ib.length;if(0<Ea)for(;pa<Ea;++pa)/gina-popin-close/.test(ib[pa].className)&&(yb[fa]=ib[pa],++fa);ib=ea.getElementsByTagName('div');pa=0;Ea=ib.length;if(0<Ea)for(;pa<Ea;++pa)/gina-popin-close/.test(ib[pa].className)&&(yb[fa]=ib[pa],++fa);ib=ea.getElementsByTagName('a');pa=0;Ea=ib.length;if(0<Ea)for(;pa<Ea;++pa)/gina-popin-close/.test(ib[pa].className)&&(yb[fa]=ib[pa],++fa);pa=0;for(Ea=yb.length;pa<Ea;++pa){ib=yb[pa];
let Gb=ib.getAttribute('id');for(let Ob=0,jb=L.length;Ob<jb;Ob++){let Ma=L[Ob];'undefined'!=typeof gina.events[Ma]&&gina.events[Ma]==Gb&&removeListener(gina,ib,Ma);'undefined'!=typeof gina.events[Gb]&&gina.events[Gb]==Gb&&removeListener(gina,ib,Gb);'undefined'!=typeof gina.events[Ma+'.'+Gb]&&gina.events[Ma+'.'+Gb]==Gb&&removeListener(gina,ib,Ma+'.'+Gb);'undefined'!=typeof gina.events[Ma+'.'+Gb]&&gina.events[Ma+'.'+Gb]==Ma+'.'+Gb&&removeListener(gina,ib,Ma+'.'+Gb)}}ca.isRedirecting=!1;N(ca.name)}});
...
(Oa='popin.close.'+O.v4(),Ka[pa].id=Oa,Ka[pa].setAttribute('id',Oa)),'undefined'!=typeof gina.events[Oa]&&gina.events[Oa]==Ka[pa].id||T('close',Oa,Ka[pa]);fa=0;Ea=Ia.length;var cb=null,Fa=null,Na=null,Wa={},rb=null,bb=new DOMParser,fb=null,gc=null;for(Oa=Ka=Ka=null;fa<Ea;++fa)null==Ia[fa].getAttribute('disabled')&&(Ia[fa].id=/^null$/i.test(Ia[fa].getAttribute('id'))?null:Ia[fa].getAttribute('id'),Ia[fa].id&&/^popin\.link/.test(Ia[fa].id)&&/^popin\.click/.test(Ia[fa].id)?Oa=Ia[fa].id:(Oa=!0,Ka=Ia[fa].getAttribute('href'),
...
ca.isRedirecting=!0;if(ca.hasForm){cb=ca.target.getElementsByTagName('FORM');Fa=0;for(Na=cb.length;Fa<Na;++Fa)if(fb=yb.currentTarget.id,gc=bb.parseFromString(cb.item(Fa).innerHTML,'text/html').getElementById(fb)||!1)rb=cb[Fa].getAttribute('data-gina-form-inherits-data')||null,Wa=K(Wa,JSON.parse(decodeURIComponent(rb)));0<Wa.count()&&(/\?/.test(yb.currentTarget.href)?yb.currentTarget.href+='&inheritedData='+encodeURIComponent(JSON.stringify(Wa)):yb.currentTarget.href+='?inheritedData='+encodeURIComponent(JSON.stringify(Wa)))}}),
