...
Ja,Ua,pb){Ja&&u(Ja,function(ab,gb){if(Ua||!Q(Ia,gb))!pb||'object'!==typeof ab||!ab||U(ab)||na(ab)||ab instanceof RegExp?Ia[gb]=ab:(Ia[gb]||(Ia[gb]={}),G(Ia[gb],ab,Ua,pb))});return Ia}function r(Ia,Ja){return function(){return Ja.apply(Ia,arguments)}}function da(Ia){throw Ia;}function Ea(Ia){if(!Ia)return Ia;var Ja=A;M(Ia.split('.'),function(Ua){Ja=Ja[Ua]});return Ja}function N(Ia,Ja,Ua,pb){Ja=Error(Ja+'\nhttps://requirejs.org/docs/errors.html#'+Ia);Ja.requireType=Ia;Ja.requireModules=pb;Ua&&(Ja.originalError=
...
typeof M[0]&&null!=M[0]&&'undefined'!=typeof M[0][u]&&'object'==typeof ba[0]&&'undefined'!=typeof ba[0][u]){A=Array.isArray(ba)?Array.from(ba):JSON.clone(ba);var G=0;for(Q=A.length;G<Q;++G)T.push(A[G][u]);Q=JSON.clone(M);var r=0;G=0;M=Q.length;for(var da=N||0,Ea=ba.length;da<Ea;++da)a:for(G=G||0;G<M;++G)if(Q[G][u]===ba[da][u]){-1<T.indexOf(Q[G][u])?(A[r]=Q[G],++r):-1==T.indexOf(Q[G][u])&&(T.push(Q[G][u]),A[r]=Q[G],++r);break a}else-1==T.indexOf(Q[G][u])&&(T.push(Q[G][u]),A.push(Q[G]));return A}return Array.isArray(M)&&
...
for(M=A.length;G<M;++G)T.push(A[G][u]);for(G=0;G<M;++G)a:for(da=N||0,Ea=Q.length;da<Ea;++da)if(null!=Q[da]&&'undefined'!=typeof Q[da][u]&&Q[da][u]!==A[G][u]){if(-1==T.indexOf(Q[da][u])){A.push(Q[da]);T.push(Q[da][u]);N=da+1;M<Ea&&++M;break a}}else if(null!=Q[da]&&'undefined'!=typeof Q[da][u]&&Q[da][u]===A[G][u])N=da+1;else break a;return A}for(G=0;G<M.length;++G)if(T=null,'undefined'==typeof M||'object'!=typeof M[G]||Array.isArray(M[G])||null==M[G]||(T=Object.getOwnPropertyNames(M[G])),'undefined'!=
...
G&&(G.eventData.error=O);u&&(u.eventData.error=O);window.ginaToolbar.update('data-xhr',O,!0);triggerEvent(gina,r,'error.'+T,O);Ea&&triggerEvent(gina,r,'error.'+T+'.hform',O);da&&triggerEvent(gina,r,'error.'+T+'.hlink',O)};A.onreadystatechange=function(O){O=/Google Inc/i.test(navigator.vendor)?50:0;2==A.readyState&&(M=/^attachment;/.test(A.getResponseHeader('Content-Disposition'))?!0:!1,!A.responseType&&M&&(A.responseType='blob'));if(4==A.readyState)if(U=null,ba=A.getResponseHeader('Content-Type'),
...
return{setCulture:function(u,G){/\-/.test(G)?(V=G,na=G.split(/\-/)[0]):na=G;return this},format:function(u,G,r){var da=M[na]||M.en,Ea=null;try{Ea=P(da.masks,U)}catch(S){P=(A='undefined'!==typeof module&&module.exports?!1:!0)?require('lib/merge'):require('./../lib/merge'),Ea=P(da.masks,U)}'undefined'!=typeof M[V]&&(da=M[V],'undefined'!=typeof M[V].mask&&(Ea=P(da.masks,U)));var N=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,
...
var F=r?0:u.getTimezoneOffset(),J={d:Ea,dd:D(Ea),ddd:da.dayNames[m],dddd:da.dayNames[m+7],m:z+1,mm:D(z+1),mmm:da.monthNames[z],mmmm:da.monthNames[z+12],yy:String(y).slice(2),yyyy:y,h:H%12||12,hh:D(H%12||12),H,HH:D(H),M:v,MM:D(v),s:w,ss:D(w),l:D(C,3),L:D(C),t:12>H?'a':'p',tt:12>H?'am':'pm',T:12>H?'A':'P',TT:12>H?'AM':'PM',Z:r?'UTC':(String(u).match(N)||['']).pop().replace(O,''),o:(0<F?'-':'+')+D(100*Math.floor(Math.abs(F)/60)+Math.abs(F)%60,4),S:['th','st','nd','rd'][3<Ea%10?0:(10!=Ea%100-Ea%10)*Ea%
10]};return G.replace(/d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g,function(S){return S in J?J[S]:S.slice(1,S.length-1)})},countDaysTo:ba,getDaysTo:function(u,G,r){if(G instanceof Date){G=ba(u,G);var da=u.getMonth(),Ea=u.getFullYear();u=u.getDate()+1;u=new Date(Ea,da,u);da=[];for(Ea=0;Ea<G;++Ea)'undefined'!=typeof r?da.push((new Date(u)).format(r)):da.push(new Date(u)),u.setDate(u.getDate()+1);return da||[]}throw Error('dateTo is not instance of Date() !');},getDaysInMonth:function(u){var G=
...
c,e,k){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var n,B,I,Y=b.camelCase(c),qa=a.style;if(c=b.cssProps[Y]||(b.cssProps[Y]=ia(Y)||Y),I=b.cssHooks[c]||b.cssHooks[Y],void 0===e)return I&&'get'in I&&void 0!==(n=I.get(a,!1,k))?n:qa[c];if(B=typeof e,'string'===B&&(n=Mb.exec(e))&&n[1]&&(e=da(a,c,n),B='number'),null!=e&&e===e&&('number'===B&&(e+=n&&n[3]||(b.cssNumber[Y]?'':'px')),h.clearCloneStyle||''!==e||0!==c.indexOf('background')||(qa[c]='inherit'),!(I&&'set'in I&&void 0===(e=I.set(a,e,k)))))try{qa[c]=
...
''==A||null==A)A=[];if(!Array.isArray(A))throw Error('`new Collection([content] [, options] )`: `content` argument must be an Array !');A=A?JSON.clone(A):[];for(var r=[],da=V=0,Ea=A.length;da<Ea;++da)A[da]||(A[da]={}),A[da]._uuid=na.v4(),r[V]=A[da]._uuid,++V;var N=A;N.setSearchOption=function(){if(!arguments.length)throw Error('searchOption cannot be left blank');if(3<arguments.length||3>arguments.length&&1<arguments.length)throw Error('argument length mismatch');var D=0,C=arguments.length;if(1==
...
getContext('gina').plugins,U=V.Validator);P.getUrlProps=function(u,G){var r={};if(A){var da=window.gina.config;r.hostname=da.hostname;'undefined'!=typeof u&&(u=routing.getRoute('webroot@'+u),r.hostname=u.hostname,r.host=u.host,r.webroot=u.webroot)}else da=getContext('gina').config,'undefined'!=typeof getContext('argvFilename')&&(da.getRouting=getContext('gina').Config.instance.getRouting),'undefined'==typeof u&&(u=da.bundle),'undefined'==typeof G&&(G=da.env),r.hostname=da.envConf[u][G].hostname,r.host=
da.envConf[u][G].host,r.webroot=da.envConf[u][G].server.webroot;return r};P.compareUrls=async function(u,G,r,da,Ea){'undefined'==typeof r&&(r={routing:{}});if(/,/.test(G)){var N=0;G=G.split(/,/g);for(var O=G.length,D={past:!1,request:r};N<O&&!D.past;)D=await M(u,G[N],r,da,Ea),++N;return D}return await M(u,G,r,da,Ea)};var M=async function(u,G,r,da,Ea){var N=null;try{N=u.url.split(/\//)}catch(S){console.warn(S),N=['']}G=G.split(/\//);var O=0,D=0,C=G.length,m=0,z={},y=0,H=r.method.toLowerCase(),v='get';
...
1);else if(/^validator::/.test(v)&&await ba(G[S],N[S],u,r,da,Ea)){++m;continue}/^:/.test(G[S])&&'undefined'!=typeof v&&(new RegExp(v)).test(N[S])&&(++m,r[H][G[S].substr(1)]=N[S])}w=!0}for(var F in r[H])'undefined'!=typeof u.requirements[F]&&0>G.indexOf(':'+F)&&(G[D]=':'+F,++D,N[O]=r[H][F],++O,w||N.length!==G.length||++C)}if(!w&&N.length===G.length)for(;y<C;++y)N[y]===G[y]?++m:m==y&&/:/.test(G[y])&&await ba(G[y],N[y],u,r,da,Ea)&&++m;if('undefined'!=typeof u.requirements&&H==u.method.toLowerCase()&&
...
y),w=Array.isArray(v[ta])?await _validator[D][ta].apply(_validator[D],v[ta]):await _validator[D][ta](v[ta],r,da,Ea),!w.isValid&&(--m,'undefined'!=typeof w.error))throw w.error;}O++}z.past=m===C?!0:!1;z.past&&(r.routing=T(u,r[H]),z.request=r);return z},ba=async function(u,G,r,da,Ea,N){var O=-1,D=u.match(/:\w+/g);O=new RegExp(u,'g');var C=null,m=null,z=null;C=!1;var y=C=m=m=null,H=null,v=da.method.toLowerCase();if(!D.length)return!1;r.param.path&&O.test(r.param.path)&&(r.param.path=r.param.path.replace(O,
...
(da[v]={});z=D[O].substr(1);O=r.requirements[z];if(/^\//.test(O))C=O.match(/\/(.*)\//).pop(),m=O.replace('/'+C+'/',''),C=(new RegExp(C,m)).test(G);else if(/^validator::/.test(O)&&G){m={};C={};y={};H='';u.replace(new RegExp('[^'+z+']','g'),function(ta){H+=ta});m[z]=G.replace(new RegExp(H,'g'),'');try{C=JSON.parse(O.split(/::/).splice(1)[0].replace(/([^:"\s+](\w+)):/g,'"$1":').replace(/([^:"\s+](\w+))\s+:/g,'"$1":'))}catch(ta){throw ta;}'undefined'!=typeof C.query&&'undefined'!=typeof C.query.data&&
u==C.query.data[Object.keys(C.query.data)[0]]&&(C.query.data[Object.keys(C.query.data)[0]]=m[z],da.params[z]=m[z]);y[z]=C;m=new U('routing',m,null,y);if(0==C.count())return console.error('Route validation failed '+r.rule),!1;for(var w in C)Array.isArray(C[w])?await m[z][w].apply(m[z],C[w]):await m[z][w](C[w],da,Ea,N);C=m.isValid()}else C=(new RegExp(r.requirements[z])).test(G);if('undefined'!=typeof r.param[z]&&'undefined'!=typeof r.requirements&&'undefined'!=typeof r.requirements[z]&&'undefined'!=
typeof da.params&&C)return da.params[z]=G,'undefined'==typeof da[v][z]&&(da[v][z]=G),!0}else{Ea=r.url;N=da.url;v={};y='';var F=!1,J=0;w=0;for(var S=N.length;w<S;++w)if(N.charAt(w)!=Ea.charAt(J)||F){if(''==y)F=!0,y+=N.charAt(w);else if(w>Ea.indexOf(D[0])+D[0].length){O=r.requirements[D[0]];G=y.substr(0,y.length);if(/^\//.test(O))C=O.match(/\/(.*)\//).pop(),m=O.replace('/'+C+'/',''),C=(new RegExp(C,m)).test(G);else if(/^validator::/.test(O)){m={};C={};y={};H='';u.replace(new RegExp('[^'+z[0]+']','g'),
...
G=y.substr(0,y.length),/^\//.test(O)?(C=O.match(/\/(.*)\//).pop(),m=O.replace('/'+C+'/',''),C=(new RegExp(C,m)).test(G)):C=(new RegExp(r.requirements[z])).test(G),C)v[D[0].substr(1)]=G;else return!1}else++J;if(v.count()==D.length){z=null;for(z in v)da.params[z]=v[z];return!0}}return!1},Q=function(u){return/\/$/.test(u)?Q.variable+'/':Q.variable},T=function(u,G){var r=null,da,Ea=u.url,N=null;for(N in u.param)if(('undefined'==typeof G||'undefined'!=typeof G[N])&&/^:/.test(u.param[N])){var O=u.param[N].substr(1);
...
u.param.file.replace(D,Q));if(/,/.test(u.url)){r=u.url.split(/,/g);var C=0;for(da=r.length;C<da;++C)Q.variable=G[O],r[C]=r[C].replace(D,Q);u.url=r.join(',')}else Q.variable=G[O],u.url=u.url.replace(D,Q)}}if(r){C=0;da=r.length;Ea=Ea.split(/,/g);var m=0;for(u.urlIndex=0;C<da;++C)if(r=0,D=Ea[0].match(/:[-_a-z0-9]+/ig)){N=0;for(O=D.length;N<O;N++){var z=D[N].substr(1);'undefined'!=typeof G[z]&&G[z]&&r++}r>m&&(m=r,u.urlIndex=C)}}return u};P.getRoute=function(u,G,r){var da=null;A?da=window.gina.config:
(da=getContext('gina').config,'undefined'!=typeof getContext('argvFilename')&&(da.getRouting=getContext('gina').Config.instance.getRouting));var Ea=da.env||GINA_ENV,N=null,O=da.bundle;/@/.test(u)||'undefined'==typeof O||null==O||(u=u.toLowerCase(),u+='@'+O);if(/@/.test(u)){var D=u.replace(/(.*):\/\//,'').split(/@/);O=D[1];/\/(.*)$/.test(u)&&(N=u.replace(/(.*):\/\//,'').split(/\/(.*)$/)[1],O=O.replace(/\/(.*)$/,''),Ea=N||Ea);u=D[0].toLowerCase()+'@'+O}N=da.getRouting(O,Ea);if('undefined'==typeof N[u])throw Error('[ RoutingHelper::getRouting(rule, params) ] : `'+
u+'` not found !');da=JSON.clone(N[u]);O=null;da=T(da,G);/,/.test(da.url)&&('undefined'!=typeof da.urlIndex&&(r=da.urlIndex,delete da.urlIndex),r='undefined'!=typeof r?r:0,da.url=da.url.split(/,/g)[r]);/\/$/.test(da.url)&&'/'!=da.url&&(da.url=da.url.substr(0,da.url.length-1));if(/GET/i.test(da.method)&&'undefined'!=typeof G){r='?';N=N[u].url;O=[];D=0;for(let C in da.param)-1<P.reservedParams.indexOf(C)||(new RegExp(da.param[C])).test(N)||'undefined'==typeof G[C]||(r+=C+'='+encodeRFC5987ValueChars(G[C])+
'&',O[D]=G[C],++D);for(let C in G)-1<P.reservedParams.indexOf(C)||'undefined'!=typeof da.requirements[C]||-1<O.indexOf(C)||(r='object'==typeof G[C]?r+(C+'='+encodeRFC5987ValueChars(JSON.stringify(G[C]))+'&'):r+(C+'='+G[C]+'&'));D=O=N=null;1<r.length&&(r=r.substring(0,r.length-1),da.url+=r);r=null}da.toUrl=function(C){var m=null;/^redirect$/i.test(this.param.control)&&(m=P.getUrlProps(this.bundle,Ea||GINA_ENV));var z=this.webroot||m.webroot;m=this.hostname||m.hostname;var y=this.url;this.url='undefined'!=
typeof C&&1==C?y.replace(z,'/'):y;return m+this.url};da.request=function(C,m){var z=null,y=null;'function'==typeof arguments[arguments.length-1]&&(z=arguments[arguments.length-1]);'object'==typeof arguments[2]&&(y=arguments[2]);var H=this.webroot||y.webroot,v=this.hostname||y.hostname;y='undefined'!=typeof C&&1==C?path.replace(H,'/'):this.url||y.url;v=/^https/.test(v)?'https':'http';A?window.open(y,'undefined'!=typeof m&&'undefined'!=typeof m.target?m.target:'_self'):('undefined'==typeof m.agent&&
(m.agent=!1),v=require(''+v),H=function(w){var F='',J=!1;w.on('data',function(S){F+=S});w.on('error',function(S){J='Failed to get mail content';S&&'undefined'!=typeof S.stack?J+=S.stack:'string'==typeof S&&(J+='\n'+S)});w.on('end',function(){if(/^\{/.test(F))try{F=JSON.parse(F),'undefined'!=typeof F.error&&(J=JSON.clone(F),F=null)}catch(S){J=S}J?z(J):z(!1,F)})},z?v.get(y,m,H):v.get(y,m))};/:/.test(da.url)&&(G=da.url.match(/(:(.*)\/|:(.*)$)/g).map(function(C){return C.replace(/\//g,'')}).join(', '),
O='[ RoutingHelper::getRoute(rule[, bundle, method]) ] : route [ %r ] param placeholder not defined: `'+da.url+'` !\n Check your route description to compare requirements against param variables [ '+G+']',O=O.replace(/%r/,u),console.warn(Error(O)));return da};P.getRouteByUrl=function(u,G,r,da,Ea){2==arguments.length&&'undefined'!=typeof arguments[1]&&arguments[1]&&-1<P.allowedMethods.indexOf(arguments[1].toLowerCase())&&(r=arguments[1],G=void 0);var N=null,O=null,D=null,C=null,m=null,z=null;if(/#/.test(u)&&
1<u.length){var y=u.split(/#/);u=y[0];m='#'+y[1];y=null}1==arguments.length&&'undefined'!=typeof arguments[0]&&(/^(https|http)/i.test(u)||/^\//.test(u)||(u='/'+u),N='/'+u.split(/\//g)[1],A&&(C=gina.config.reverseRouting,D=gina.config.routing),'undefined'!=typeof C[N]&&(y=D[C[N]],G=y.bundle,N=y.webroot,z=y.hostname,y=null));Ea='boolean'!=typeof arguments[arguments.length-1]?!1:arguments[arguments.length-1];var H=!1,v=null,w=null,F=v=w=null;y='undefined'!=typeof r?!0:!1;A?(v=window.gina.config,G='undefined'!=
typeof G?G:v.bundle,w=v.env,D=D||v.getRouting(G),C=C||v.reverseRouting,isXMLRequest='undefined'!=typeof isXMLRequest?isXMLRequest:!1,z=z||v.hostname,N=N||v.webroot,da={routing:{},method:r,params:{},url:u}):(v=getContext('gina').config,G='undefined'!=typeof G?G:v.bundle,w=v.env,D=v.getRouting(G),z=v.envConf[G][w].hostname,N=v.envConf[G][w].server.webroot,da||={routing:{},isXMLRequest:!1,method:'undefined'!=typeof r?r.toLowerCase():'get',params:{},url:u},Ea&&(da.method=r),isXMLRequest=da.isXMLRequest||
!1);w=u.replace(new RegExp('^('+z+'|'+z.replace(/:\d+/,'')+')'),'');'undefined'==typeof da.routing.path&&(da.routing.path=decodeURI(w));r='undefined'!=typeof r?r.toLowerCase():'get';y&&(da.originalMethod=da.method,da.method=r,da.routing.path=decodeURI(w));da.method||(da.method=r);v={};N=new RegExp(r,'i');C=null;var J;for(J in D){if('undefined'==typeof D[J].param)break;if(D[J].bundle==G&&(C=D[J].method,/,/.test(C)&&N.test(C)&&(C=da.method),'undefined'==typeof D[J].method||N.test(C))){v={method:C,requirements:D[J].requirements,
namespace:D[J].namespace||void 0,url:decodeURI(w),rule:D[J].originalRule||J,param:D[J].param,middleware:JSON.clone(D[J].middleware),bundle:D[J].bundle,isXMLRequest};try{if(F=P.compareUrls(v,D[J].url,da),F.past){O=JSON.clone(D[J]);O.name=J;H=!0;F={};break}}catch(S){throw Error('Route [ '+J+' ] needs your attention.\n'+S.stack);}}}if(H)return/\/$/.test(u)&&'/'!=u&&(u=u.substr(0,u.length-1)),m&&(u+=m),O.url=u,O.toUrl=function(S){var ta=this.webroot,Fa=this.hostname,W=this.url;this.url='undefined'!=typeof S&&
1==S?W.replace(ta,'/'):W;return Fa+this.url},O;if(A){m=!1;if('#'==u&&/GET/i.test(r)&&y||/^404:/.test(u))u=location.pathname,m=!0;'undefined'==typeof P.notFound&&(P.notFound={});D=null;O='[ RoutingHelper::getRouteByUrl(rule[, bundle, method]) ] : route [ %r ] is called but not found inside your view: `'+u+'` !';if((D=(D=gina.hasPopinHandler&&gina.popinIsBinded?gina.popin.getActivePopin().target.innerHTML.match(/404:\[\w+\][a-z 0-9-_@]+/):document.body.innerHTML.match(/404:\[\w+\][a-z 0-9-_@]+/))&&
0<D.length?D[0]:null)&&y&&m)return m=D.match(/\[\w+\]/)[0],D=D.replace('404:'+m,m.replace(/\[|\]/g,'')+'::'),O=O.replace(/%r/,D.replace(/404:\s+/,'')),'undefined'==typeof P.notFound[D]?P.notFound[D]={count:1,message:O}:y&&'undefined'!=typeof P.notFound[D]&&++P.notFound[D].count,!1;if((m=gina.config.reverseRouting[u]||null)&&'undefined'!=typeof m&&m.split(/@(.+)$/)[1]==G)return D=m,'undefined'==typeof P.notFound[D]?(O=O.replace(/%r/,r.toUpperCase()+'::'+m),P.notFound[D]={count:1,message:O}):y&&'undefined'!=
typeof P.notFound[D]&&++P.notFound[D].count,!1;D=P.compareUrls(v,u,da)||null;D.past&&y&&(D=r.toUpperCase()+'::'+D.request.routing.rule,'undefined'==typeof P.notFound[D]?O=O.replace(/%r/,D):++P.notFound[D].count);return!1}console.warn(Error('[ RoutingHelper::getRouteByUrl(rule[, bundle, method, request]) ] : route not found for url: `'+u+'` !').stack);return!1};return P}
...
var U=U||require('vendor/uuid'),M=M||require('helpers/dateFormat'),ba={bucket:'default'},Q={},T=null,u={},G={},r=['not null'],da={bucket:void 0,drop:function(){T.removeItem(ba.bucket);Q=null;for(var O in this)delete this[O];return Q},Collection:P},Ea={insert:function(O){O._id=U.v1();O._createdAt=(new Date).format('isoDateTime');O._updatedAt=(new Date).format('isoDateTime');G[this._collection][G[this._collection].length]=O;T.setItem(this._bucket,JSON.stringify(G))},find:function(O,D){if(!O)return G[this._collection];
...
typeof O&&'undefined'!=typeof O)throw Error('`options` must be an object');'undefined'==typeof O&&(O={});ba=na(O,ba);T=window.localStorage;O=ba.bucket;if(!T.getItem(O)&&void 0!=O)T.setItem(O,JSON.stringify(G));else if(void 0==O)throw Error('`bucket` name cannot be undefined');Q.bucket=O;Q=na(Q,da)})(A);return Q}
...
null,errors:{},initialized:!1,isReady:!1,rules:{},$forms:{},getFormById:null,validateFormById:null,setOptions:null,resetErrorsDisplay:null,resetFields:null},da={id:null,plugin:this.plugin,on:U?on:null,eventData:{},target:U?document:null,cachedErrors:{},binded:!1,unbinded:!1,withUserBindings:!1,rules:{},setOptions:null,send:null,isValidating:null,isSubmitting:null,submit:null,destroy:null,resetErrorsDisplay:null,resetFields:null},Ea={},N={},O=null,D={url:'',method:'GET',isSynchrone:!1,withCredentials:!1,
...
l=l.replace(/#/,'');if(null!=document.getElementById(l)&&'undefined'==typeof r.$forms[l]){var h=document.getElementById(l),b,x=typeof(0<Ea.count())?Ea:r.rules;h.getAttribute?(id=h.getAttribute('id')||'form.'+ba.v4(),id!==h.getAttribute('id')&&h.setAttribute('id',id)):(id='form.'+ba.v4(),h.setAttribute('id',id));h.id=da.id=id;if('undefined'!=typeof h.id&&'null'!=h.id&&''!=h.id){da.target=h;r.$forms[h.id]=Q({},da);if(b=h.getAttribute('data-gina-form-rule')){b=b.replace(/\-|\//g,'.');if('undefined'==
typeof x[b])throw Error('['+h.id+'] no rule found with key: `null`');b=x[b]}'string'==typeof h.id&&'undefined'!=typeof x[h.id.replace(/\-/g,'.')]?$target=r.$forms[h.id].target:'object'==typeof h.id?(delete r.$forms[h.id],x=h.attributes.getNamedItem('id').nodeValue||'form.'+ba.v4(),h.setAttribute('id',x),h.id=x,da.target=h,r.$forms[x]=Q({},da),$target=r.$forms[x].target):$target=r.$forms[h.id].target;b?xb($target,b):xb($target)}}'undefined'!=typeof r.$forms[l]&&(r.$forms[l].withUserBindings=!0,g='undefined'!=
...
typeof l&&l.count())try{La(l,''),l=Ca(l),gina.forms.rules='undefined'!=typeof gina.forms.rules&&gina.forms.rules?Q(gina.forms.rules,l,!0):l,r.rules=Q(r.rules,JSON.clone(gina.forms.rules),!0)}catch(R){throw R;}Ea.count()||(Ea=JSON.clone(r.rules));da.setOptions=m;da.getFormById=z;da.validateFormById=H;da.resetErrorsDisplay=J;da.resetFields=S;da.handleErrorsDisplay=F;da.submit=ta;da.send=Fa;da.unbind=Db;da.bind=xb;da.reBind=jb;da.destroy=ma;g=0;for(var h=document.getElementsByTagName('form'),b=0,x=h.length;b<
x;++b){if(h[b].getAttribute){var q=h[b].getAttribute('id')||'form.'+ba.v4();q!==h[b].getAttribute('id')&&h[b].setAttribute('id',q)}else q='form.'+ba.v4(),h[b].setAttribute('id',q);da.id=q;da.target=h[b];r.$forms[q]=Q({},da);var p=h[b].getAttribute('data-gina-form-rule');if(p){p=p.replace(/\-|\//g,'.');'undefined'!=typeof l&&(r.$forms[q].rules[p]=r.rules[p]=Ea[p]=Q(JSON.clone(eval('gina.forms.rules.'+p)),r.rules[p]));if('undefined'==typeof Ea[p])throw Error('['+q+'] no rule found with key: `'+p+'`. Please check if json is not malformed @ /forms/rules/'+
p.replace(/\./g,'/')+'.json');p=r.rules[p]}'string'==typeof q&&'undefined'!=typeof Ea[q.replace(/\-/g,'.')]||'object'==typeof p?(q=r.$forms[q].target,p?xb(q,p):xb(q),++g):('object'==typeof h[b].id?(delete r.$forms[h[b].id],q=h[b].attributes.getNamedItem('id').nodeValue||'form.'+ba.v4(),h[b].setAttribute('id',q),h[b].id=q,da.target=h[b],r.$forms[q]=Q({},da),q=r.$forms[q].target):q=r.$forms[h[b].id].target,p?xb(q,p):xb(q))}if(window.XMLHttpRequest)O=new XMLHttpRequest;else if(window.ActiveXObject)try{O=
...
/^radio$/i.test(g[ca].type)&&(h.fieldsSet[ja].value=g[ca].value,h.fieldsSet[ja].defaultValue=g[ca].value)));/^true$/i.test(h.target.dataset.ginaFormLiveCheckEnabled)&&gb(h,g[ca]);if(E=g[ca].getAttribute('data-gina-form-element-group'))0>fa.indexOf(E)&&fa.push(E),ra=g[ca].getAttribute('name')||ja,ra===ja&&g[ca].setAttribute('name',ja),Aa[ja]={id:ja,name:ra,group:E,target:g[ca]},ea[g[ca].name]=new RegExp('^'+E.replace(/[.*+?^${}()|[\]\\]/g,'\\$&')),q&&('undefined'==typeof h.rules[g[ca].name]&&(h.rules[g[ca].name]=
{}),'undefined'!=typeof h.rules[g[ca].name].isRequired&&h.rules[g[ca].name].isRequired||(h.rules[g[ca].name].exclude=!0));if(0<ea.count())for(var Z in ea)g[ca].name!=Z&&(g[ca].getAttribute('data-gina-form-element-group'),ea[Z].test(g[ca].name)&&(g[ca].disabled=!0,'undefined'==typeof oa[Z]&&(oa[Z]={}),oa[Z][g[ca].name]=g[ca]));if(/^file$/i.test(g[ca].type)){ja=g[ca].getAttribute('data-gina-form-upload-trigger');ja||(ja=g[ca].id);E=null;ra=(new DOMParser).parseFromString(l.innerHTML,'text/html');ja&&
...
X){addListener(gina,ca,X,function(ka){Ya(ka.target);triggerEvent(gina,ka.target,'changed.'+ka.target.id)});Ya(ca,!0)},'undefined'!=typeof gina.events[R]&&gina.events[R]==g[Z].id&&removeListener(gina,g[Z],R),K(g[Z],R))}R='click';K=function(){var ca=null;ca='reset.'+l.id;'undefined'==typeof gina.events[ca]&&addListener(gina,l,ca,function(X){X.preventDefault();var ka=r.$forms[X.currentTarget.id||X.target.id];ka.target.dataset.ginaFormIsResetting=!0;S(ka);X=db(ka.target,ka.rules,!0);za(ka.target,X.fields,
...
triggerEvent(gina,l,'validate.'+b,ka)):(b=l.getAttribute('id'),p=(Xa=l.getAttribute('data-gina-form-rule'))?Da(Xa.replace(/\-|\//g,'.')):Da(b.replace(/\-/g,'.')),r.$forms[Ra].isSubmitting=!0,r.$forms[Ra].isSending=!1,za(l,ka,va,p,function(eb){triggerEvent(gina,l,'validate.'+b,eb)})))})};fa=null;g=[];fa=[];K=null;fa=l.getElementsByTagName('button');if(0<fa.length)for(let ca=0,X=fa.length;ca<X;++ca)'submit'==fa[ca].type&&g.push(fa[ca]);fa=l.getElementsByTagName('a');if(0<fa.length)for(let ca=0,X=fa.length;ca<
X;++ca)fa[ca].attributes.getNamedItem('data-gina-form-submit')?g.push(fa[ca]):fa[ca].getAttribute('id')||/gina\-popin/.test(fa[ca].className)||gina.popinIsBinded||/gina\-link/.test(fa[ca].className)||(K='link.'+ba.v4(),fa[ca].id=K);K=null;Z=!1;for(let ca=0,X=g.length;ca<X;++ca){fa=g[ca];if(/button/i.test(fa.tagName)&&'undefined'!=typeof fa.type&&/submit/i.test(fa.type)||/a/i.test(fa.tagName)&&'undefined'!=typeof fa.dataset.ginaFormSubmit&&/^true$/i.test(fa.dataset.ginaFormSubmit)||/a/i.test(fa.parentNode.tagName)&&
...
R));'undefined'!=typeof gina.events[R]&&gina.events[R]==fa.id||cb(R,fa)}R='submit';addListener(gina,l,R,function(ca){var X=ca.target,ka=X.getAttribute('id'),va=r.$forms[ka],Ra=h.binded;(va=(new DOMParser).parseFromString(X.innerHTML,'text/html').getElementById(va.submitTrigger))&&va.disabled&&cancelEvent(ca);if('undefined'!=typeof ca.defaultPrevented&&ca.defaultPrevented)return!1;(q||Ra)&&cancelEvent(ca);ca={};Ra={_length:0};va='undefined'!=typeof gina.validator.$forms[ka]?gina.validator.$forms[ka].rules:
...
return ya}function da(ya){var za=T();return function(){var l=ba(ya);if(za){var g=ba(this).constructor;l=Reflect.construct(l,arguments,g)}else l=l.apply(this,arguments);return!l||'object'!=typeof l&&'function'!=typeof l?r(this):l}}function Ea(ya,za,l){return Ea='undefined'!=typeof Reflect&&Reflect.get?Reflect.get:function(g,h,b){for(;!Object.prototype.hasOwnProperty.call(g,h)&&null!==(g=ba(g)););if(g)return h=Object.getOwnPropertyDescriptor(g,h),h.get?h.get.call(b):h.value},Ea(ya,za,l||ya)}function N(ya){if(ya){for(var za in N.prototype)ya[za]=
...
N.prototype.emitReserved=N.prototype.emit;N.prototype.listeners=function(ya){return this._callbacks=this._callbacks||{},this._callbacks['$'+ya]||[]};N.prototype.hasListeners=function(ya){return!!this.listeners(ya).length};var Da='undefined'!=typeof self?self:'undefined'!=typeof window?window:Function('return this')(),Na=setTimeout,Ia=clearTimeout,Ja,Ua=function(ya){function za(g,h,b){var x;return P(this,za),(x=l.call(this,g)).description=h,x.context=b,x.type='TransportError',x}M(za,ya);var l=da(za);
return za}(G(Error));ma=function(ya){function za(g){var h;return P(this,za),(h=l.call(this)).writable=!1,D(r(h),g),h.opts=g,h.query=g.query,h.readyState='',h.socket=g.socket,h}M(za,ya);var l=da(za);return na(za,[{key:'onError',value:function(g,h,b){return Ea(ba(za.prototype),'emitReserved',this).call(this,'error',new Ua(g,h,b)),this}},{key:'open',value:function(){return'closed'!==this.readyState&&''!==this.readyState||(this.readyState='opening',this.doOpen()),this}},{key:'close',value:function(){return'opening'!==
...
za}(ma);var jb=function(ya){function za(g,h){var b;return P(this,za),D(r(b=l.call(this)),h),b.opts=h,b.method=h.method||'GET',b.uri=g,b.async=!1!==h.async,b.data=void 0!==h.data?h.data:null,b.create(),b}M(za,ya);var l=da(za);return na(za,[{key:'create',value:function(){var g=this,h=O(this.opts,'agent','pfx','key','passphrase','cert','ca','ciphers','rejectUnauthorized','autoUnref');h.xdomain=!!this.opts.xd;h.xscheme=!!this.opts.xs;var b=this.xhr=new H(h);try{b.open(this.method,this.uri,this.async);
...
Da?'pagehide':'unload',w,!1);var Db='function'==typeof Promise&&'function'==typeof Promise.resolve?function(ya){return Promise.resolve().then(ya)}:function(ya,za){return za(ya,0)},rb=Da.WebSocket||Da.MozWebSocket,xb='undefined'!=typeof navigator&&'string'==typeof navigator.product&&'reactnative'===navigator.product.toLowerCase(),Ka={websocket:function(ya){function za(g){var h;return P(this,za),(h=l.call(this,g)).supportsBinary=!g.forceBase64,h}M(za,ya);var l=da(za);return na(za,[{key:'doOpen',value:function(){if(this.check()){var g=
...
!1))),h.open(),h}M(za,ya);var l=da(za);return na(za,[{key:'createTransport',value:function(g){var h=U({},this.opts.query);h.EIO=4;h.transport=g;this.id&&(h.sid=this.id);h=U({},this.opts.transportOptions[g],this.opts,{query:h,socket:this,hostname:this.hostname,secure:this.secure,port:this.port});return new Ka[g](h)}},{key:'open',value:function(){var g=this;if(this.opts.rememberUpgrade&&za.priorWebsocketSuccess&&-1!==this.transports.indexOf('websocket'))var h='websocket';else{if(0===this.transports.length)return void this.setTimeoutFn(function(){g.emitReserved('error',
...
function Domain(A,P){var V='undefined'!==typeof module&&module.exports?!1:!0,na=!1;V&&(na=!!window.MSInputMethodContext&&!!document.documentMode);'function'==typeof A&&(P=A,A=void 0);var U={filename:'../dist/public_suffix_list.dat',url:'https://publicsuffix.org/list/public_suffix_list.dat',alternativeUrl:'https://raw.githubusercontent.com/publicsuffix/list/master/public_suffix_list.dat',isCachingRequired:!1,isUpdating:!1},M=null,ba=null,Q=function(r,da,Ea){if('undefined'==typeof da)da=U;else for(let N in U)'undefined'==
typeof da[N]&&(da[N]=U[N]);V||(da.filename=__dirname+'/'+da.filename);V&&da.isCachingRequired&&(console.warn('[DOMAIN] `options.isCachingRequired` is only available for backend'),da.isCachingRequired=!1);M=da;if(Ea)return T(da,function(N){N?Ea(N):(console.debug('[DOMAIN] PSL Loaded'),Ea(N,r))});T(da);console.debug('[DOMAIN] PSL Loaded');return r},T=async function(r,da){var Ea=V||r.isCachingRequired?r.url:r.filename,N='undefined'!=typeof r.isUpdating?r.isUpdating:!1,O=null;if(V)if(ba&&!N)da(!1);else if(window.fetch){O=
N=null;try{N=await fetch(Ea),ba=O=await N.text()}catch(C){O=Error('[DOMAIN] Could not load PSL\n'+(C.stack||C.message||C));da(O);return}r.isUpdating=!1;da(!1)}else O=Error('[DOMAIN] Fetch API not supported'),da(O);else{Ea=!1;if('undefined'!=typeof fs.accessSync)try{fs.accessSync(r.filename,fs.constants.F_OK),Ea=!0}catch(C){Ea=!1;try{fs.lstatSync(r.filename).isSymbolicLink()&&(Ea=!0)}catch(m){}}else Ea=fs.existsSync(r.filename);Ea||(r.isCachingRequired=!0);if(r.isCachingRequired){Ea='curl -o '+r.filename+
' '+r.url+' >/dev/null 2>&1';console.debug('[DOMAIN] Running: '+Ea);try{execSync(Ea)}catch(C){console.warn('[DOMAIN] could not fetch from `'+r.url+'`. Trying with `'+r.alternativeUrl+'`');Ea='curl -o '+r.filename+' '+r.alternativeUrl+' >/dev/null 2>&1';try{execSync(Ea)}catch(m){da(m);return}}var D=!1;nIntervId=setInterval(()=>{if('undefined'!=typeof fs.accessSync)try{fs.accessSync(r.filename,fs.constants.F_OK),D=!0}catch(C){D=!1;try{fs.lstatSync(r.filename).isSymbolicLink()&&(D=!0)}catch(m){}}else D=
fs.existsSync(r.filename);D&&(clearInterval(nIntervId),ba=fs.readFileSync(r.filename).toString(),da(!1))},200)}try{ba=fs.readFileSync(r.filename).toString(),da&&da(!1)}catch(C){console.warn('[DOMAIN] could not read from `'+r.filename+'`'),T(A,da)}}},u=function(r){M.isUpdating=!0;T(M,r)},G={getRootDomain:function(r,da){'undefined'==typeof da&&(da=!1);var Ea=!1,N=!1,O=r.replace(/^(.*):\/\/|\/(.*)/g,''),D=O.split(/\./g).reverse(),C=D.length?D.length-1:0,m=ba.replace(/\/\/\s*(.*)\n|^\s*\n/gm,'').split(/\n/).filter(function(z,
...
xa+'?version='+(new Date).getMilliseconds(),W[la].setAttribute('href',xa))}ia.isRedirecting?triggerEvent(gina,m.target,'loaded.'+ia.id,ia):triggerEvent(gina,m.target,'open.'+ia.id,ia);if(gina&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar)try{ginaToolbar.update('el-xhr',ia.id)}catch(ma){throw ma;}}}function r(W){var la=setupXhr();la.open('GET',W,!0);la.setRequestHeader('Content-Type','text/javascript');la.onload=function(){eval(la.response)};la.send()}function da(W){var la=setupXhr();
...
La);Ca<Qa;++Ca){if('undefined'==typeof xa[Ca].src||''==xa[Ca].src)continue;let Da=xa[Ca].src.replace(/(https|http|):\/\//,'').replace(La,'');-1<ia.indexOf(Da)||r(xa[Ca].src)}Ca=0;for(Qa=ua.length;Ca<Qa;++Ca)'undefined'!=typeof ua[Ca].href&&''!=ua[Ca].href&&(ia=ua[Ca].href.replace(/(https|http|):\/\//,'').replace(La,''),-1<ma.indexOf(ia)||da(ua[Ca].href));Q({target:W,type:'loaded.'+la.id},la);/gina-popin-is-active/.test(W.className)||(W.className+=' gina-popin-is-active');if(!C.options.useDialogMode||
