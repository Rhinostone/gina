...
(function(A,P){function V(Ia,Ja){return Ja||''}function na(Ia){return'[object Function]'===Fa.call(Ia)}function U(Ia){return'[object Array]'===Fa.call(Ia)}function M(Ia,Ja){if(Ia){var Ua;for(Ua=0;Ua<Ia.length&&(!Ia[Ua]||!Ja(Ia[Ua],Ua,Ia));Ua+=1);}}function ba(Ia,Ja){if(Ia){var Ua;for(Ua=Ia.length-1;-1<Ua&&(!Ia[Ua]||!Ja(Ia[Ua],Ua,Ia));--Ua);}}function Q(Ia,Ja){return W.call(Ia,Ja)}function T(Ia,Ja){return Q(Ia,Ja)&&Ia[Ja]}function u(Ia,Ja){for(var Ua in Ia)if(Q(Ia,Ua)&&Ja(Ia[Ua],Ua))break}function G(Ia,
Ja,Ua,pb){Ja&&u(Ja,function(ab,gb){if(Ua||!Q(Ia,gb))!pb||'object'!==typeof ab||!ab||U(ab)||na(ab)||ab instanceof RegExp?Ia[gb]=ab:(Ia[gb]||(Ia[gb]={}),G(Ia[gb],ab,Ua,pb))});return Ia}function r(Ia,Ja){return function(){return Ja.apply(Ia,arguments)}}function ca(Ia){throw Ia;}function Ea(Ia){if(!Ia)return Ia;var Ja=A;M(Ia.split('.'),function(Ua){Ja=Ja[Ua]});return Ja}function N(Ia,Ja,Ua,pb){Ja=Error(Ja+'\nhttps://requirejs.org/docs/errors.html#'+Ia);Ja.requireType=Ia;Ja.requireModules=pb;Ua&&(Ja.originalError=
Ua);return Ja}function O(){if(z&&'interactive'===z.readyState)return z;ba(document.getElementsByTagName('script'),function(Ia){if('interactive'===Ia.readyState)return z=Ia});return z}var D,C,m,z,y,H,v,w=/\/\*[\s\S]*?\*\/|([^:"'=]|^)\/\/.*$/mg,F=/[^.]\s*require\s*\(\s*["']([^'"\s]+)["']\s*\)/g,J=/\.js$/,S=/^\.\//;var ta=Object.prototype;var Fa=ta.toString,W=ta.hasOwnProperty,la=!('undefined'===typeof window||'undefined'===typeof navigator||!window.document),ia=!la&&'undefined'!==typeof importScripts,
...
(ab=gb.context);(pb=T(ua,ab))||(pb=ua[ab]=Da.s.newContext(ab));gb&&pb.configure(gb);return pb.require(Ia,Ja,Ua)};Da.config=function(Ia){return Da(Ia)};Da.nextTick='undefined'!==typeof P?function(Ia){P(Ia,4)}:function(Ia){Ia()};require||=Da;Da.version='2.3.6';Da.jsExtRegExp=/^\/|:|\?|\.js$/;Da.isBrowser=la;ta=Da.s={contexts:ua,newContext:function(Ia){function Ja(E,oa,ra){var ja;oa=oa&&oa.split('/');var Z=l.map,Ga=Z&&Z['*'];if(E){E=E.split('/');var Pa=E.length-1;l.nodeIdCompat&&J.test(E[Pa])&&(E[Pa]=
E[Pa].replace(J,''));'.'===E[0].charAt(0)&&oa&&(Pa=oa.slice(0,oa.length-1),E=Pa.concat(E));Pa=E;for(ja=0;ja<Pa.length;ja++){var $a=Pa[ja];'.'===$a?(Pa.splice(ja,1),--ja):'..'===$a&&0!==ja&&(1!==ja||'..'!==Pa[2])&&'..'!==Pa[ja-1]&&0<ja&&(Pa.splice(ja-1,2),ja-=2)}E=E.join('/')}if(ra&&Z&&(oa||Ga)){Pa=E.split('/');ja=Pa.length;a:for(;0<ja;--ja){var ib=Pa.slice(0,ja).join('/');if(oa)for($a=oa.length;0<$a;--$a)if(ra=T(Z,oa.slice(0,$a).join('/')))if(ra=T(ra,ib)){var Cb=ra;var zb=ja;break a}if(!qb&&Ga&&T(Ga,
ib)){var qb=T(Ga,ib);var Mb=ja}}!Cb&&qb&&(Cb=qb,zb=Mb);Cb&&(Pa.splice(0,zb,Cb),E=Pa.join('/'))}return(Cb=T(l.pkgs,E))?Cb:E}function Ua(E){la&&M(document.getElementsByTagName('script'),function(oa){if(oa.getAttribute('data-requiremodule')===E&&oa.getAttribute('data-requirecontext')===ea.contextName)return oa.parentNode.removeChild(oa),!0})}function pb(E){var oa=T(l.paths,E);if(oa&&U(oa)&&1<oa.length)return oa.shift(),ea.require.undef(E),ea.makeRequire(null,{skipMap:!0})([E]),!0}function ab(E){var oa=
E?E.indexOf('!'):-1;if(-1<oa){var ra=E.substring(0,oa);E=E.substring(oa+1,E.length)}return[ra,E]}function gb(E,oa,ra,ja){var Z=null,Ga=oa?oa.name:null,Pa=E,$a=!0,ib='';E||($a=!1,E='_@r'+(K+=1));E=ab(E);Z=E[0];E=E[1];if(Z){Z=Ja(Z,Ga,ja);var Cb=T(q,Z)}if(E)if(Z)ib=ra?E:Cb&&Cb.normalize?Cb.normalize(E,function(qb){return Ja(qb,Ga,ja)}):-1===E.indexOf('!')?Ja(E,Ga,ja):E;else{ib=Ja(E,Ga,ja);E=ab(ib);Z=E[0];ib=E[1];ra=!0;var zb=ea.nameToUrl(ib)}ra=!Z||Cb||ra?'':'_unnormalized'+(ha+=1);return{prefix:Z,name:ib,
parentMap:oa,unnormalized:!!ra,url:zb,originalName:Pa,isDefine:$a,id:(Z?Z+'!'+ib:ib)+ra}}function Ub(E){var oa=E.id,ra=T(g,oa);ra||=g[oa]=new ea.Module(E);return ra}function Zb(E,oa,ra){var ja=E.id,Z=T(g,ja);if(!Q(q,ja)||Z&&!Z.defineEmitComplete)if(Z=Ub(E),Z.error&&'error'===oa)ra(Z.error);else Z.on(oa,ra);else'defined'===oa&&ra(q[ja])}function jb(E,oa){var ra=E.requireModules,ja=!1;if(oa)oa(E);else if(M(ra,function(Z){if(Z=T(g,Z))Z.error=E,Z.events.error&&(ja=!0,Z.emit('error',E))}),!ja)Da.onError(E)}
function Db(){Qa.length&&(M(Qa,function(E){var oa=E[0];'string'===typeof oa&&(ea.defQueueMap[oa]=!0);x.push(E)}),Qa=[])}function rb(E){delete g[E];delete h[E]}function xb(E,oa,ra){var ja=E.map.id;E.error?E.emit('error',E.error):(oa[ja]=!0,M(E.depMaps,function(Z,Ga){Z=Z.id;var Pa=T(g,Z);!Pa||E.depMatched[Ga]||ra[Z]||(T(oa,Z)?(E.defineDep(Ga,q[Z]),E.check()):xb(Pa,oa,ra))}),ra[ja]=!0)}function Ka(){var E,oa,ra=(E=1E3*l.waitSeconds)&&ea.startTime+E<(new Date).getTime(),ja=[],Z=[],Ga=!1,Pa=!0;if(!ya){ya=
!0;u(h,function($a){var ib=$a.map,Cb=ib.id;if($a.enabled&&(ib.isDefine||Z.push($a),!$a.error))if(!$a.inited&&ra)pb(Cb)?Ga=oa=!0:(ja.push(Cb),Ua(Cb));else if(!$a.inited&&$a.fetched&&ib.isDefine&&(Ga=!0,!ib.prefix))return Pa=!1});if(ra&&ja.length)return E=N('timeout','Load timeout for modules: '+ja,null,ja),E.contextName=ea.contextName,jb(E);Pa&&M(Z,function($a){xb($a,{},{})});ra&&!oa||!Ga||!la&&!ia||za||(za=P(function(){za=0;Ka()},50));ya=!1}}function db(E){Q(q,E[0])||Ub(gb(E[0],null,!0)).init(E[1],
E[2])}function Lb(E){E=E.currentTarget||E.srcElement;var oa=ea.onScriptLoad;E.detachEvent&&!ma?E.detachEvent('onreadystatechange',oa):E.removeEventListener('load',oa,!1);oa=ea.onScriptError;E.detachEvent&&!ma||E.removeEventListener('error',oa,!1);return{node:E,id:E&&E.getAttribute('data-requiremodule')}}function Vb(){for(Db();x.length;){var E=x.shift();if(null===E[0])return jb(N('mismatch','Mismatched anonymous define() module: '+E[E.length-1]));db(E)}ea.defQueueMap={}}var ya,za,l={waitSeconds:7,
baseUrl:'./',paths:{},bundles:{},pkgs:{},shim:{},config:{}},g={},h={},b={},x=[],q={},p={},R={},K=1,ha=1;var Aa={require:function(E){return E.require?E.require:E.require=ea.makeRequire(E.map)},exports:function(E){E.usingExports=!0;if(E.map.isDefine)return E.exports?q[E.map.id]=E.exports:E.exports=q[E.map.id]={}},module:function(E){return E.module?E.module:E.module={id:E.map.id,uri:E.map.url,config:function(){return T(l.config,E.map.id)||{}},exports:E.exports||(E.exports={})}}};var fa=function(E){this.events=
T(b,E.id)||{};this.map=E;this.shim=T(l.shim,E.id);this.depExports=[];this.depMaps=[];this.depMatched=[];this.pluginMaps={};this.depCount=0};fa.prototype={init:function(E,oa,ra,ja){ja=ja||{};if(!this.inited){this.factory=oa;if(ra)this.on('error',ra);else this.events.error&&(ra=r(this,function(Z){this.emit('error',Z)}));this.depMaps=E&&E.slice(0);this.errback=ra;this.inited=!0;this.ignore=ja.ignore;ja.enabled||this.enabled?this.enable():this.check()}},defineDep:function(E,oa){this.depMatched[E]||(this.depMatched[E]=
...
E.id,ra=gb(E.prefix);this.depMaps.push(ra);Zb(ra,'defined',r(this,function(ja){var Z=T(R,this.map.id),Ga=this.map.name,Pa=this.map.parentMap?this.map.parentMap.name:null,$a=ea.makeRequire(E.parentMap,{enableBuildCallback:!0});if(this.map.unnormalized){ja.normalize&&(Ga=ja.normalize(Ga,function(zb){return Ja(zb,Pa,!0)})||'');var ib=gb(E.prefix+'!'+Ga,this.map.parentMap,!0);Zb(ib,'defined',r(this,function(zb){this.map.normalizedMap=ib;this.init([],function(){return zb},null,{enabled:!0,ignore:!0})}));
if(ja=T(g,ib.id)){this.depMaps.push(ib);if(this.events.error)ja.on('error',r(this,function(zb){this.emit('error',zb)}));ja.enable()}}else if(Z)this.map.url=ea.nameToUrl(Z),this.load();else{var Cb=r(this,function(zb){this.init([],function(){return zb},null,{enabled:!0})});Cb.error=r(this,function(zb){this.inited=!0;this.error=zb;zb.requireModules=[oa];u(g,function(qb){0===qb.map.id.indexOf(oa+'_unnormalized')&&rb(qb.map.id)});jb(zb)});Cb.fromText=r(this,function(zb,qb){var Mb=E.name,Ya=gb(Mb),cb=La;
qb&&(zb=qb);cb&&(La=!1);Ub(Ya);Q(l.config,oa)&&(l.config[Mb]=l.config[oa]);try{Da.exec(zb)}catch(da){return jb(N('fromtexteval','fromText eval for '+oa+' failed: '+da,da,[oa]))}cb&&(La=!0);this.depMaps.push(Ya);ea.completeLoad(Mb);$a([Mb],Cb)});ja.load(E.name,$a,Cb,l)}}));ea.enable(ra,this);this.pluginMaps[ra.id]=ra},enable:function(){h[this.map.id]=this;this.enabling=this.enabled=!0;M(this.depMaps,r(this,function(E,oa){var ra;if('string'===typeof E){E=gb(E,this.map.isDefine?this.map:this.map.parentMap,
!1,!this.skipMap);this.depMaps[oa]=E;if(ra=T(Aa,E.id)){this.depExports[oa]=ra(this);return}this.depCount+=1;Zb(E,'defined',r(this,function(Z){this.undefed||(this.defineDep(oa,Z),this.check())}));this.errback?Zb(E,'error',r(this,this.errback)):this.events.error&&Zb(E,'error',r(this,function(Z){this.emit('error',Z)}))}ra=E.id;var ja=g[ra];Q(Aa,ra)||!ja||ja.enabled||ea.enable(E,this)}));u(this.pluginMaps,r(this,function(E){var oa=T(g,E.id);oa&&!oa.enabled&&ea.enable(E,this)}));this.enabling=!1;this.check()},
on:function(E,oa){var ra=this.events[E];ra||=this.events[E]=[];ra.push(oa)},emit:function(E,oa){M(this.events[E],function(ra){ra(oa)});'error'===E&&delete this.events[E]}};var ea={config:l,contextName:Ia,registry:g,defined:q,urlFetched:p,defQueue:x,defQueueMap:{},Module:fa,makeModuleMap:gb,nextTick:Da.nextTick,onError:jb,configure:function(E){E.baseUrl&&'/'!==E.baseUrl.charAt(E.baseUrl.length-1)&&(E.baseUrl+='/');if('string'===typeof E.urlArgs){var oa=E.urlArgs;E.urlArgs=function(Z,Ga){return(-1===
Ga.indexOf('?')?'?':'&')+oa}}var ra=l.shim,ja={paths:!0,bundles:!0,config:!0,map:!0};u(E,function(Z,Ga){ja[Ga]?(l[Ga]||(l[Ga]={}),G(l[Ga],Z,!0,!0)):l[Ga]=Z});E.bundles&&u(E.bundles,function(Z,Ga){M(Z,function(Pa){Pa!==Ga&&(R[Pa]=Ga)})});E.shim&&(u(E.shim,function(Z,Ga){U(Z)&&(Z={deps:Z});!Z.exports&&!Z.init||Z.exportsFn||(Z.exportsFn=ea.makeShimExports(Z));ra[Ga]=Z}),l.shim=ra);E.packages&&M(E.packages,function(Z){Z='string'===typeof Z?{name:Z}:Z;var Ga=Z.name;Z.location&&(l.paths[Ga]=Z.location);
l.pkgs[Ga]=Z.name+'/'+(Z.main||'main').replace(S,'').replace(J,'')});u(g,function(Z,Ga){Z.inited||Z.map.unnormalized||(Z.map=gb(Ga,null,!0))});(E.deps||E.callback)&&ea.require(E.deps||[],E.callback)},makeShimExports:function(E){return function(){var oa;E.init&&(oa=E.init.apply(A,arguments));return oa||E.exports&&Ea(E.exports)}},makeRequire:function(E,oa){function ra(ja,Z,Ga){var Pa;oa.enableBuildCallback&&Z&&na(Z)&&(Z.__requireJsBuild=!0);if('string'===typeof ja){if(na(Z))return jb(N('requireargs',
'Invalid require call'),Ga);if(E&&Q(Aa,ja))return Aa[ja](g[E.id]);if(Da.get)return Da.get(ea,ja,E,ra);var $a=gb(ja,E,!1,!0);$a=$a.id;return Q(q,$a)?q[$a]:jb(N('notloaded','Module name "'+$a+'" has not been loaded yet for context: '+Ia+(E?'':'. Use require([])')))}Vb();ea.nextTick(function(){Vb();Pa=Ub(gb(null,E));Pa.skipMap=oa.skipMap;Pa.init(ja,Z,Ga,{enabled:!0});Ka()});return ra}oa=oa||{};G(ra,{isBrowser:la,toUrl:function(ja){var Z=ja.lastIndexOf('.'),Ga=ja.split('/')[0];if(-1!==Z&&('.'!==Ga&&'..'!==
Ga||1<Z)){var Pa=ja.substring(Z,ja.length);ja=ja.substring(0,Z)}return ea.nameToUrl(Ja(ja,E&&E.id,!0),Pa,!0)},defined:function(ja){return Q(q,gb(ja,E,!1,!0).id)},specified:function(ja){ja=gb(ja,E,!1,!0).id;return Q(q,ja)||Q(g,ja)}});E||(ra.undef=function(ja){Db();var Z=gb(ja,E,!0),Ga=T(g,ja);Ga.undefed=!0;Ua(ja);delete q[ja];delete p[Z.url];delete b[ja];ba(x,function(Pa,$a){Pa[0]===ja&&x.splice($a,1)});delete ea.defQueueMap[ja];Ga&&(Ga.events.defined&&(b[ja]=Ga.events),rb(ja))});return ra},enable:function(E){T(g,
E.id)&&Ub(E).enable()},completeLoad:function(E){var oa=T(l.shim,E)||{},ra=oa.exports;for(Db();x.length;){var ja=x.shift();if(null===ja[0]){ja[0]=E;if(Z)break;var Z=!0}else ja[0]===E&&(Z=!0);db(ja)}ea.defQueueMap={};ja=T(g,E);if(!Z&&!Q(q,E)&&ja&&!ja.inited)if(!l.enforceDefine||ra&&Ea(ra))db([E,oa.deps||[],oa.exportsFn]);else return pb(E)?void 0:jb(N('nodefine','No define call for '+E,null,[E]));Ka()},nameToUrl:function(E,oa,ra){var ja,Z;(ja=T(l.pkgs,E))&&(E=ja);if(ja=T(R,E))return ea.nameToUrl(ja,
oa,ra);if(Da.jsExtRegExp.test(E))ja=E+(oa||'');else{ja=l.paths;var Ga=E.split('/');for(Z=Ga.length;0<Z;--Z){var Pa=Ga.slice(0,Z).join('/');if(Pa=T(ja,Pa)){U(Pa)&&(Pa=Pa[0]);Ga.splice(0,Z,Pa);break}}ja=Ga.join('/');ja+=oa||(/^data:|^blob:|\?/.test(ja)||ra?'':'.js');ja=('/'===ja.charAt(0)||ja.match(/^[\w\+\.\-]+:/)?'':l.baseUrl)+ja}return l.urlArgs&&!/^blob:/.test(ja)?ja+l.urlArgs(E,ja):ja},load:function(E,oa){Da.load(ea,E,oa)},execCb:function(E,oa,ra,ja){return oa.apply(ja,ra)},onScriptLoad:function(E){if('load'===
E.type||xa.test((E.currentTarget||E.srcElement).readyState))z=null,E=Lb(E),ea.completeLoad(E.id)},onScriptError:function(E){var oa=Lb(E);if(!pb(oa.id)){var ra=[];u(g,function(ja,Z){0!==Z.indexOf('_@r')&&M(ja.depMaps,function(Ga){if(Ga.id===oa.id)return ra.push(Z),!0})});return jb(N('scripterror','Script error for "'+oa.id+(ra.length?'", needed by: '+ra.join(', '):'"'),E,[oa.id]))}}};ea.require=ea.makeRequire();return ea}};Da({});M(['toUrl','undef','defined','specified'],function(Ia){Da[Ia]=function(){var Ja=
ua._;return Ja.require[Ia].apply(Ja,arguments)}});if(la){var Na=ta.head=document.getElementsByTagName('head')[0];if(D=document.getElementsByTagName('base')[0])Na=ta.head=D.parentNode}Da.onError=ca;Da.createNode=function(Ia,Ja,Ua){Ja=Ia.xhtml?document.createElementNS('http://www.w3.org/1999/xhtml','html:script'):document.createElement('script');Ja.type=Ia.scriptType||'text/javascript';Ja.charset='utf-8';Ja.async=!0;return Ja};Da.load=function(Ia,Ja,Ua){var pb=Ia&&Ia.config||{};if(la){var ab=Da.createNode(pb,
...
y[m[z++]],y[m[z++]],y[m[z++]],y[m[z++]],y[m[z++]]].join('')}function na(m,z,y){var H=function(v,w,F,J){J=F&&J||0;if('string'==typeof v&&(v=function(S){S=unescape(encodeURIComponent(S));for(var ta=Array(S.length),Fa=0;Fa<S.length;Fa++)ta[Fa]=S.charCodeAt(Fa);return ta}(v)),'string'==typeof w&&(w=function(S){var ta=[];return S.replace(/[a-fA-F0-9]{2}/g,function(Fa){ta.push(parseInt(Fa,16))}),ta}(w)),!Array.isArray(v))throw TypeError('value must be an array of bytes');if(!Array.isArray(w)||16!==w.length)throw TypeError('namespace must be uuid string or an Array of 16 byte values');
v=y(w.concat(v));if(v[6]=15&v[6]|z,v[8]=63&v[8]|128,F)for(w=0;16>w;++w)F[J+w]=v[w];return F||V(v)};try{H.name=m}catch(v){}return H.DNS='6ba7b810-9dad-11d1-80b4-00c04fd430c8',H.URL='6ba7b811-9dad-11d1-80b4-00c04fd430c8',H}function U(m,z){var y=(65535&m)+(65535&z);return(m>>16)+(z>>16)+(y>>16)<<16|65535&y}function M(m,z,y,H,v,w){return U((F=U(U(z,m),U(H,w)))<<(J=v)|F>>>32-J,y);var F,J}function ba(m,z,y,H,v,w,F){return M(z&y|~z&H,m,z,v,w,F)}function Q(m,z,y,H,v,w,F){return M(z&H|y&~H,m,z,v,w,F)}function T(m,
z,y,H,v,w,F){return M(y^(z|~H),m,z,v,w,F)}for(var u='undefined'!=typeof crypto&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto)||'undefined'!=typeof msCrypto&&'function'==typeof msCrypto.getRandomValues&&msCrypto.getRandomValues.bind(msCrypto),G=new Uint8Array(16),r,ca,Ea=[],N=0;256>N;++N)Ea[N]=(N+256).toString(16).substr(1);var O=0,D=0;N=na('v3',48,function(m){if('string'==typeof m){var z=unescape(encodeURIComponent(m));m=Array(z.length);for(var y=0;y<z.length;y++)m[y]=z.charCodeAt(y)}return function(H){var v,
w=[],F=32*H.length;for(v=0;v<F;v+=8){var J=H[v>>5]>>>v%32&255;J=parseInt('0123456789abcdef'.charAt(J>>>4&15)+'0123456789abcdef'.charAt(15&J),16);w.push(J)}return w}(function(H,v){H[v>>5]|=128<<v%32;H[14+(v+64>>>9<<4)]=v;var w=1732584193,F=-271733879,J=-1732584194,S=271733878;for(v=0;v<H.length;v+=16){var ta=w;var Fa=F;var W=J;var la=S;w=ba(w,F,J,S,H[v],7,-680876936);S=ba(S,w,F,J,H[v+1],12,-389564586);J=ba(J,S,w,F,H[v+2],17,606105819);F=ba(F,J,S,w,H[v+3],22,-1044525330);w=ba(w,F,J,S,H[v+4],7,-176418897);
S=ba(S,w,F,J,H[v+5],12,1200080426);J=ba(J,S,w,F,H[v+6],17,-1473231341);F=ba(F,J,S,w,H[v+7],22,-45705983);w=ba(w,F,J,S,H[v+8],7,1770035416);S=ba(S,w,F,J,H[v+9],12,-1958414417);J=ba(J,S,w,F,H[v+10],17,-42063);F=ba(F,J,S,w,H[v+11],22,-1990404162);w=ba(w,F,J,S,H[v+12],7,1804603682);S=ba(S,w,F,J,H[v+13],12,-40341101);J=ba(J,S,w,F,H[v+14],17,-1502002290);F=ba(F,J,S,w,H[v+15],22,1236535329);w=Q(w,F,J,S,H[v+1],5,-165796510);S=Q(S,w,F,J,H[v+6],9,-1069501632);J=Q(J,S,w,F,H[v+11],14,643717713);F=Q(F,J,S,w,H[v],
20,-373897302);w=Q(w,F,J,S,H[v+5],5,-701558691);S=Q(S,w,F,J,H[v+10],9,38016083);J=Q(J,S,w,F,H[v+15],14,-660478335);F=Q(F,J,S,w,H[v+4],20,-405537848);w=Q(w,F,J,S,H[v+9],5,568446438);S=Q(S,w,F,J,H[v+14],9,-1019803690);J=Q(J,S,w,F,H[v+3],14,-187363961);F=Q(F,J,S,w,H[v+8],20,1163531501);w=Q(w,F,J,S,H[v+13],5,-1444681467);S=Q(S,w,F,J,H[v+2],9,-51403784);J=Q(J,S,w,F,H[v+7],14,1735328473);F=Q(F,J,S,w,H[v+12],20,-1926607734);w=M(F^J^S,w,F,H[v+5],4,-378558);S=M(w^F^J,S,w,H[v+8],11,-2022574463);J=M(S^w^F,J,
S,H[v+11],16,1839030562);F=M(J^S^w,F,J,H[v+14],23,-35309556);w=M(F^J^S,w,F,H[v+1],4,-1530992060);S=M(w^F^J,S,w,H[v+4],11,1272893353);J=M(S^w^F,J,S,H[v+7],16,-155497632);F=M(J^S^w,F,J,H[v+10],23,-1094730640);w=M(F^J^S,w,F,H[v+13],4,681279174);S=M(w^F^J,S,w,H[v],11,-358537222);J=M(S^w^F,J,S,H[v+3],16,-722521979);F=M(J^S^w,F,J,H[v+6],23,76029189);w=M(F^J^S,w,F,H[v+9],4,-640364487);S=M(w^F^J,S,w,H[v+12],11,-421815835);J=M(S^w^F,J,S,H[v+15],16,530742520);F=M(J^S^w,F,J,H[v+2],23,-995338651);w=T(w,F,J,S,
H[v],6,-198630844);S=T(S,w,F,J,H[v+7],10,1126891415);J=T(J,S,w,F,H[v+14],15,-1416354905);F=T(F,J,S,w,H[v+5],21,-57434055);w=T(w,F,J,S,H[v+12],6,1700485571);S=T(S,w,F,J,H[v+3],10,-1894986606);J=T(J,S,w,F,H[v+10],15,-1051523);F=T(F,J,S,w,H[v+1],21,-2054922799);w=T(w,F,J,S,H[v+8],6,1873313359);S=T(S,w,F,J,H[v+15],10,-30611744);J=T(J,S,w,F,H[v+6],15,-1560198380);F=T(F,J,S,w,H[v+13],21,1309151649);w=T(w,F,J,S,H[v+4],6,-145523070);S=T(S,w,F,J,H[v+11],10,-1120210379);J=T(J,S,w,F,H[v+2],15,718787259);F=T(F,
J,S,w,H[v+9],21,-343485551);w=U(w,ta);F=U(F,Fa);J=U(J,W);S=U(S,la)}return[w,F,J,S]}(function(H){var v,w=[];w[(H.length>>2)-1]=void 0;for(v=0;v<w.length;v+=1)w[v]=0;var F=8*H.length;for(v=0;v<F;v+=8)w[v>>5]|=(255&H[v/8])<<v%32;return w}(m),8*m.length))});var C=na('v5',80,function(m){var z=[1518500249,1859775393,2400959708,3395469782],y=[1732584193,4023233417,2562383102,271733878,3285377520];if('string'==typeof m){var H=unescape(encodeURIComponent(m));m=Array(H.length);for(var v=0;v<H.length;v++)m[v]=
H.charCodeAt(v)}m.push(128);H=Math.ceil((m.length/4+2)/16);var w=Array(H);for(v=0;v<H;v++){w[v]=Array(16);for(var F=0;16>F;F++)w[v][F]=m[64*v+4*F]<<24|m[64*v+4*F+1]<<16|m[64*v+4*F+2]<<8|m[64*v+4*F+3]}w[H-1][14]=8*(m.length-1)/Math.pow(2,32);w[H-1][14]=Math.floor(w[H-1][14]);w[H-1][15]=8*(m.length-1)&4294967295;for(v=0;v<H;v++){m=Array(80);for(F=0;16>F;F++)m[F]=w[v][F];for(F=16;80>F;F++){var J=m[F-3]^m[F-8]^m[F-14]^m[F-16];m[F]=J<<1|J>>>31}J=y[0];var S=y[1],ta=y[2],Fa=y[3],W=y[4];for(F=0;80>F;F++){var la=
Math.floor(F/20),ia=J<<5|J>>>27;a:{switch(la){case 0:var xa=S&ta^~S&Fa;break a;case 1:xa=S^ta^Fa;break a;case 2:xa=S&ta^S&Fa^ta&Fa;break a;case 3:xa=S^ta^Fa;break a}xa=void 0}la=ia+xa+W+z[la]+m[F]>>>0;W=Fa;Fa=ta;ta=(S<<30|S>>>2)>>>0;S=J;J=la}y[0]=y[0]+J>>>0;y[1]=y[1]+S>>>0;y[2]=y[2]+ta>>>0;y[3]=y[3]+Fa>>>0;y[4]=y[4]+W>>>0}return[y[0]>>24&255,y[0]>>16&255,y[0]>>8&255,255&y[0],y[1]>>24&255,y[1]>>16&255,y[1]>>8&255,255&y[1],y[2]>>24&255,y[2]>>16&255,y[2]>>8&255,255&y[2],y[3]>>24&255,y[3]>>16&255,y[3]>>
8&255,255&y[3],y[4]>>24&255,y[4]>>16&255,y[4]>>8&255,255&y[4]]});A.v1=function(m,z,y){y=z&&y||0;var H=z||[],v=(m=m||{}).node||r,w=void 0!==m.clockseq?m.clockseq:ca;if(null==v||null==w){var F=m.random||(m.rng||P)();null==v&&(v=r=[1|F[0],F[1],F[2],F[3],F[4],F[5]]);null==w&&(w=ca=16383&(F[6]<<8|F[7]))}F=void 0!==m.msecs?m.msecs:(new Date).getTime();var J=void 0!==m.nsecs?m.nsecs:D+1,S=F-O+(J-D)/1E4;if(0>S&&void 0===m.clockseq&&(w=w+1&16383),(0>S||F>O)&&void 0===m.nsecs&&(J=0),1E4<=J)throw Error("uuid.v1(): Can't create more than 10M uuids/sec");
O=F;D=J;ca=w;m=(1E4*(268435455&(F+=122192928E5))+J)%4294967296;H[y++]=m>>>24&255;H[y++]=m>>>16&255;H[y++]=m>>>8&255;H[y++]=255&m;m=F/4294967296*1E4&268435455;H[y++]=m>>>8&255;H[y++]=255&m;H[y++]=m>>>24&15|16;H[y++]=m>>>16&255;H[y++]=w>>>8|128;H[y++]=255&w;for(w=0;6>w;++w)H[y+w]=v[w];return z||V(H)};A.v3=N;A.v4=function(m,z,y){y=z&&y||0;'string'==typeof m&&(z='binary'===m?Array(16):null,m=null);var H=(m=m||{}).random||(m.rng||P)();if(H[6]=15&H[6]|64,H[8]=63&H[8]|128,z)for(m=0;16>m;++m)z[y+m]=H[m];
return z||V(H)};A.v5=C;Object.defineProperty(A,'__esModule',{value:!0})});
function Merge(){var A=[],P=!1,V=function(M,ba){var Q=M;P||('object'==typeof M&&Array.isArray(M),P=!0);'undefined'==typeof Q&&(Q='undefined'!=typeof ba&&Array.isArray(ba)?[]:{});var T=!1;'boolean'==typeof arguments[arguments.length-1]&&(T=arguments[arguments.length-1]);var u=1,G=arguments.length,r,ca;if('object'!==typeof Q&&'function'!==typeof Q)Q=T?'undefined'==typeof arguments[2]?arguments[1]:arguments[2]:'undefined'==typeof arguments[0]?arguments[1]:arguments[0];else for(;u<G;++u)if('boolean'!=
...
function handleXhr(A,P,V,na){if(!A)throw Error('No `xhr` object initiated');var U=null,M=null,ba=null,Q=null,T=null,u=V.$link||null,G=V.$form||null,r=null;delete V.$link;delete V.$form;G||u?u?(u.target=document.getElementById(u.id),r=gina.link.target,T=gina.link.id):(r=G.target,T=r.getAttribute('id')):(r=P,T=r.getAttribute('id'));var ca=u&&P.getAttribute('data-gina-link-event-on-success')||u&&P.getAttribute('data-gina-link-event-on-error')?!0:!1,Ea=G&&r.getAttribute('data-gina-form-event-on-submit-success')||
...
G&&(G.eventData.error=O);u&&(u.eventData.error=O);window.ginaToolbar.update('data-xhr',O,!0);triggerEvent(gina,r,'error.'+T,O);Ea&&triggerEvent(gina,r,'error.'+T+'.hform',O);ca&&triggerEvent(gina,r,'error.'+T+'.hlink',O)};A.onreadystatechange=function(O){O=/Google Inc/i.test(navigator.vendor)?50:0;2==A.readyState&&(M=/^attachment;/.test(A.getResponseHeader('Content-Disposition'))?!0:!1,!A.responseType&&M&&(A.responseType='blob'));if(4==A.readyState)if(U=null,ba=A.getResponseHeader('Content-Type'),
...
shortDate:'d/m/yy',shortDate2:'dd/mm/yyyy',mediumDate:'d mmm, yyyy',longDate:'d mmmm, yyyy',fullDate:'dddd, d mmmm, yyyy'}}};var ba=function(u,G){if(G instanceof Date)return u=u.getTime(),G=G.getTime(),Math.round(Math.abs(u-G)/864E5);throw Error('dateTo is not instance of Date() !');},Q=['us','eu','corporate'],T=function(u){d=new Date(u.getFullYear(),u.getMonth(),u.getDate());u=d.getDay()||7;d.setDate(d.getDate()+4-u);u=new Date(Date.parse(d.getFullYear(),0,1));return Math.ceil(((d-u)/864E5+1)/7)};
return{setCulture:function(u,G){/\-/.test(G)?(V=G,na=G.split(/\-/)[0]):na=G;return this},format:function(u,G,r){var ca=M[na]||M.en,Ea=null;try{Ea=P(ca.masks,U)}catch(S){P=(A='undefined'!==typeof module&&module.exports?!1:!0)?require('lib/merge'):require('./../lib/merge'),Ea=P(ca.masks,U)}'undefined'!=typeof M[V]&&(ca=M[V],'undefined'!=typeof M[V].mask&&(Ea=P(ca.masks,U)));var N=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,
O=/[^-+\dA-Z]/g,D=function(S,ta){S=String(S);for(ta=ta||2;S.length<ta;)S='0'+S;return S};1!=arguments.length||'[object String]'!=Object.prototype.toString.call(u)||/\d/.test(u)||(G=u,u=void 0);u=u?new Date(u):new Date;if(isNaN(u))throw SyntaxError('invalid date');G=String(Ea[G]||G||Ea['default']);'UTC:'==G.slice(0,4)&&(G=G.slice(4),r=!0);var C=r?'getUTC':'get';Ea=u[C+'Date']();var m=u[C+'Day'](),z=u[C+'Month'](),y=u[C+'FullYear'](),H=u[C+'Hours'](),v=u[C+'Minutes'](),w=u[C+'Seconds']();C=u[C+'Milliseconds']();
var F=r?0:u.getTimezoneOffset(),J={d:Ea,dd:D(Ea),ddd:ca.dayNames[m],dddd:ca.dayNames[m+7],m:z+1,mm:D(z+1),mmm:ca.monthNames[z],mmmm:ca.monthNames[z+12],yy:String(y).slice(2),yyyy:y,h:H%12||12,hh:D(H%12||12),H,HH:D(H),M:v,MM:D(v),s:w,ss:D(w),l:D(C,3),L:D(C),t:12>H?'a':'p',tt:12>H?'am':'pm',T:12>H?'A':'P',TT:12>H?'AM':'PM',Z:r?'UTC':(String(u).match(N)||['']).pop().replace(O,''),o:(0<F?'-':'+')+D(100*Math.floor(Math.abs(F)/60)+Math.abs(F)%60,4),S:['th','st','nd','rd'][3<Ea%10?0:(10!=Ea%100-Ea%10)*Ea%
10]};return G.replace(/d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g,function(S){return S in J?J[S]:S.slice(1,S.length-1)})},countDaysTo:ba,getDaysTo:function(u,G,r){if(G instanceof Date){G=ba(u,G);var ca=u.getMonth(),Ea=u.getFullYear();u=u.getDate()+1;u=new Date(Ea,ca,u);ca=[];for(Ea=0;Ea<G;++Ea)'undefined'!=typeof r?ca.push((new Date(u)).format(r)):ca.push(new Date(u)),u.setDate(u.getDate()+1);return ca||[]}throw Error('dateTo is not instance of Date() !');},getDaysInMonth:function(u){var G=
...
k;var n=b._data(a);a=b._data(c,n);var B=n.events;if(B)for(e in delete a.handle,a.events={},B)for(n=0,k=B[e].length;k>n;n++)b.event.add(c,e,B[e][n]);a.data&&(a.data=b.extend({},a.data))}}function S(a,c,e,k){c=Lb.apply([],c);var n,B,I,Y=0,qa=a.length,Ba=qa-1,sa=c[0],Sa=b.isFunction(sa);if(Sa||1<qa&&'string'==typeof sa&&!h.checkClone&&Ib.test(sa))return a.each(function(yb){var bb=a.eq(yb);Sa&&(c[0]=sa.call(this,yb,bb.html()));S(bb,c,e,k)});if(qa&&(I=C(c,a[0].ownerDocument,!1,a,k),n=I.firstChild,1===
...
c){var e,k,n,B=this[0],I=B&&B.attributes;if(void 0===a){if(this.length&&(n=b.data(B),1===B.nodeType&&!b._data(B,'parsedAttrs'))){for(e=I.length;e--;)I[e]&&(k=I[e].name,0===k.indexOf('data-')&&(k=b.camelCase(k.slice(5)),T(B,k,n[k])));b._data(B,'parsedAttrs',!0)}return n}return'object'==typeof a?this.each(function(){b.data(this,a)}):1<arguments.length?this.each(function(){b.data(this,a,c)}):B?T(B,a,b.data(B,a)):void 0},removeData:function(a){return this.each(function(){b.removeData(this,a)})}});b.extend({queue:function(a,
...
da=function(a,c,e,k,n,B,I){var Y=0,qa=a.length,Ba=null==e;if('object'===b.type(e))for(Y in n=!0,e)da(a,c,Y,e[Y],!0,B,I);else if(void 0!==k&&(n=!0,b.isFunction(k)||(I=!0),Ba&&(I?(c.call(a,k),c=null):(Ba=c,c=function(sa,Sa,Va){return Ba.call(b(sa),Va)})),c))for(;qa>Y;Y++)c(a[Y],e,I?k:k.call(a[Y],Y,c(a[Y],e)));return n?a:Ba?c.call(a):qa?c(a[0],e):B},X=/^(?:checkbox|radio)$/i,ka=/<([\w:-]+)/,va=/^$|\/(?:java|ecma)script/i,Ra=/^\s+/;!function(){var a=Ka.createElement('div'),c=Ka.createDocumentFragment(),
...
Ba=h.attributes,sa=b.event.special;null!=(e=a[I]);I++)if((c||ib(e))&&(n=e[Y],B=n&&qa[n])){if(B.events)for(k in B.events)sa[k]?b.event.remove(e,k):b.removeEvent(e,k,B.handle);qa[n]&&(delete qa[n],Ba||'undefined'==typeof e.removeAttribute?e[Y]=void 0:e.removeAttribute(Y),xb.push(n))}}});b.fn.extend({domManip:S,detach:function(a){return ta(this,a,!0)},remove:function(a){return ta(this,a)},text:function(a){return da(this,function(c){return void 0===c?b.text(this):this.empty().append((this[0]&&this[0].ownerDocument||
Ka).createTextNode(c))},null,a,arguments.length)},append:function(){return S(this,arguments,function(a){1!==this.nodeType&&11!==this.nodeType&&9!==this.nodeType||v(this,a).appendChild(a)})},prepend:function(){return S(this,arguments,function(a){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var c=v(this,a);c.insertBefore(a,c.firstChild)}})},before:function(){return S(this,arguments,function(a){this.parentNode&&this.parentNode.insertBefore(a,this)})},after:function(){return S(this,arguments,
function(a){this.parentNode&&this.parentNode.insertBefore(a,this.nextSibling)})},empty:function(){for(var a,c=0;null!=(a=this[c]);c++){for(1===a.nodeType&&b.cleanData(N(a,!1));a.firstChild;)a.removeChild(a.firstChild);a.options&&b.nodeName(a,'select')&&(a.options.length=0)}return this},clone:function(a,c){return a=null==a?!1:a,c=null==c?a:c,this.map(function(){return b.clone(this,a,c)})},html:function(a){return da(this,function(c){var e=this[0]||{},k=0,n=this.length;if(void 0===c)return 1===e.nodeType?
e.innerHTML.replace(mb,''):void 0;if(!('string'!=typeof c||Gb.test(c)||!h.htmlSerialize&&Kb.test(c)||!h.leadingWhitespace&&Ra.test(c)||Xa[(ka.exec(c)||['',''])[1].toLowerCase()])){c=b.htmlPrefilter(c);try{for(;n>k;k++)e=this[k]||{},1===e.nodeType&&(b.cleanData(N(e,!1)),e.innerHTML=c);e=0}catch(B){}}e&&this.empty().append(c)},null,a,arguments.length)},replaceWith:function(){var a=[];return S(this,arguments,function(c){var e=this.parentNode;0>b.inArray(this,a)&&(b.cleanData(N(this)),e&&e.replaceChild(c,
...
c,e,k){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var n,B,I,Y=b.camelCase(c),qa=a.style;if(c=b.cssProps[Y]||(b.cssProps[Y]=ia(Y)||Y),I=b.cssHooks[c]||b.cssHooks[Y],void 0===e)return I&&'get'in I&&void 0!==(n=I.get(a,!1,k))?n:qa[c];if(B=typeof e,'string'===B&&(n=Mb.exec(e))&&n[1]&&(e=ca(a,c,n),B='number'),null!=e&&e===e&&('number'===B&&(e+=n&&n[3]||(b.cssNumber[Y]?'':'px')),h.clearCloneStyle||''!==e||0!==c.indexOf('background')||(qa[c]='inherit'),!(I&&'set'in I&&void 0===(e=I.set(a,e,k)))))try{qa[c]=
...
c):void 0}};h.checkOn||(b.valHooks[this].get=function(a){return null===a.getAttribute('value')?'on':a.value})});var Ic,zc=b.expr.attrHandle,bd=/^(?:checked|selected)$/i,Ec=h.getSetAttribute,Sc=h.input;b.fn.extend({attr:function(a,c){return da(this,b.attr,a,c,1<arguments.length)},removeAttr:function(a){return this.each(function(){b.removeAttr(this,a)})}});b.extend({attr:function(a,c,e){var k,n,B=a.nodeType;if(3!==B&&8!==B&&2!==B)return'undefined'==typeof a.getAttribute?b.prop(a,c,e):(1===B&&b.isXMLDoc(a)||
...
Rd=/^(?:a|area)$/i;b.fn.extend({prop:function(a,c){return da(this,b.prop,a,c,1<arguments.length)},removeProp:function(a){return a=b.propFix[a]||a,this.each(function(){try{this[a]=void 0,delete this[a]}catch(c){}})}});b.extend({prop:function(a,c,e){var k,n,B=a.nodeType;if(3!==B&&8!==B&&2!==B)return 1===B&&b.isXMLDoc(a)||(c=b.propFix[c]||c,n=b.propHooks[c]),void 0!==e?n&&'set'in n&&void 0!==(k=n.set(a,e,c))?k:a[c]=e:n&&'get'in n&&null!==(k=n.get(a,c))?k:a[c]},propHooks:{tabIndex:{get:function(a){var c=
...
try{var C=Object.keys(D)[0],m={};m[C]='desc';return N.find(D).orderBy(m).limit(1)[0][C]}catch(z){throw z;}};var O=function(D,C){if('object'!=typeof D)throw Error('`filter` parametter must be an object or an array');var m={},z=null,y=null,H=z=null;z=[];if(0==D.count())return null;m.asc=function(v,w){var F=w.map(function(J,S){var ta={};ta.index=S;ta[v]=J[v];return ta});F.sort(function(J,S){var ta=function(Fa,W){/^(true|false)$/i.test(Fa)&&(Fa=/true/i.test(Fa)?1:0);/^(true|false)$/i.test(W)&&(W=/true/i.test(W)?
1:0);return'string'==typeof Fa&&''!=Fa||'string'==typeof W?('number'==typeof Fa&&(Fa=''+Fa),'number'==typeof W&&(W=''+W),Fa.localeCompare(W,void 0,{sensitivity:'case',caseFirst:'upper'})):Fa>W?1:Fa<W?-1:0};return'object'==typeof J?ta(J[v],S[v]):ta(J,S)});return F.map(function(J,S,ta){return w[J.index]})};m.desc=function(v,w){return m.asc(v,w).reverse()};z=function(v,w){var F=[],J=[];if(Array.isArray(w))for(var S=0,ta=w.length;S<ta;++S)F[S]=Object.keys(w[S])[0],J[S]=w[S][F[S]];else for(ta in S=0,w)F[S]=
ta,J[S]=w[ta],++S;y=function(Fa,W,la,ia,xa){var ma='desc'==ia[xa]?1:0,ua,Ca=ua=null;return'string'==typeof Fa[la[xa]]&&''!=Fa[la[xa]]?(ua=Fa[la[xa]].localeCompare(W[la[xa]]),0==ma&&0!=ua?0>ua?-1:1:0!=ua?0>ua?1:-1:la.length-1>xa?y(Fa,W,la,ia,xa+1):0):'number'==typeof Fa[la[xa]]||'number'==typeof W[la[xa]]?(ua=(''+Fa[la[xa]]).localeCompare(''+W[la[xa]],void 0,{numeric:!0}),0==ma&&0!=ua?0>ua?-1:1:0!=ua?0>ua?1:-1:la.length-1>xa?y(Fa,W,la,ia,xa+1):0):'boolean'==typeof Fa[la[xa]]||'boolean'==typeof W[la[xa]]?
...
z.replace=N.replace;z.delete=N.delete;z.orderBy=N.orderBy;z.max=N.max;z.toRaw=N.toRaw;z.filter=N.filter;return z};N.toRaw=function(){for(var D=Array.isArray(this)?this.slice():A.slice(),C=0,m=D.length;C<m;++C)D[C]._uuid&&delete D[C]._uuid;return D};N.filter=function(D){if('undefined'==typeof D)throw Error('`filter` parametter must be a string or an array.');var C=Array.isArray(this)?this:A;if(!C.length)return[];var m=0,z=C.length,y=[],H=0;if(Array.isArray(D))for(var v,w=D.length,F;m<z;++m){F=!1;for(v=
...
J=!0);y.query=C(this.error||z||T.errorLabels.query,this);console.debug('[2] potential cached error detected !! ',J,F,' vs ',y.query);J&&(this.errors=y,this.valid=!1);'undefined'!=typeof gina.events[H]&&triggerEvent(gina,this.target,H,u[this.name]);return u[this.name]}var S=null,ta=this;if(window.XMLHttpRequest)S=new XMLHttpRequest;else if(window.ActiveXObject)try{S=new ActiveXObject('Msxml2.XMLHTTP')}catch(xa){try{S=new ActiveXObject('Microsoft.XMLHTTP')}catch(ma){}}z={isSynchrone:!1,headers:{}};
v=m.data||null;y=null;H=/^true$/i.test(this.target.form.dataset.ginaFormLiveCheckEnabled)?!0:!1;y=JSON.stringify(v);if(/\$/.test(y)){v=y.match(/\$[-_\[\]a-z 0-9]+/g)||[];w=F=null;for(let xa=0,ma=v.length;xa<ma;xa++)w=v[xa].replace(/\$/g,''),re=new RegExp('\\'+v[xa].replace(/\[|\]/g,'\\$&'),'g'),F=T.data[w]||null,!F&&H&&(F=G(this.target.form,w).value),y=y.replace(re,F)}v=y.replace(/\\"/g,'');var Fa='undefined'==typeof m.validIf?!0:m.validIf;z=M(z,m,V);delete z.data;delete z.validIf;y=z.headers['Content-Type'];
var W=null;H=this.target.getAttribute('id');if(!/^http/.test(z.url)&&/@/.test(z.url))try{J=ba.getRoute(z.url),z.url=J.toUrl()}catch(xa){throw xa;}if(z.withCredentials){if('withCredentials'in S)z.isSynchrone?S.open(z.method,z.url,z.isSynchrone):S.open(z.method,z.url);else if('undefined'!=typeof XDomainRequest)S=new XDomainRequest,S.open(z.method,z.url);else throw S=null,W='CORS not supported: the server is missing the header `"Access-Control-Allow-Credentials": true` ',Error(W);S.responseType='undefined'!=
typeof z.responseType?z.responseType:'';S.withCredentials=!0}else z.isSynchrone?S.open(z.method,z.url,z.isSynchrone):S.open(z.method,z.url);for(var la in z.headers)'Content-Type'==la&&'undefined'!=typeof y&&null!=y&&''!=y||S.setRequestHeader(la,z.headers[la]);'undefined'!=typeof y&&null!=y&&''!=y&&S.setRequestHeader('Content-Type',y);var ia=function(xa){ta.value=T.data[ta.name]=ta.value?ta.value.toLowerCase():ta.value;var ma=xa.isValid||!1;ma=Fa!=ma?!1:!0;u[ta.name].valid=ma;var ua=u[ta.name].errors||
{},Ca='undefined'!=typeof xa.error&&'undefined'!=typeof xa.fields?xa.fields:{};if(0<Ca.count()&&!ma||!ma){if(!ma){var Qa=null;'undefined'!=typeof Ca[ta.name]?T.errorLabels.query=ca(Ca[ta.name],m.data):'undefined'!=typeof xa.error&&/^5/.test(xa.status)&&(Qa=xa.error);Ca='undefined'!=typeof m.error?m.error:null;ua.query=C(Qa||ta.error||Ca||T.errorLabels.query,ta);console.debug('[1] query error detected !! ',xa)}ua.query||''!=ta.value||(ma=!0)}ma&&'undefined'!=typeof ua.query&&delete ua.query;ta.valid=
...
ua&&''!=ua?ua+' query':'query')):'undefined'!=typeof xa[ta.name]&&'undefined'!=typeof xa[ta.name].query&&'undefined'!=typeof xa[ta.name].query[ta.value]&&delete xa[ta.name].query[ta.value];ua=ta.target.id||ta.target.getAttribute('id');console.debug('prematurely completed event `asyncCompleted.'+ua+'`');return triggerEvent(gina,ta.target,'asyncCompleted.'+ua,u[ta.name])};S&&(S.onerror=function(xa,ma){console.debug('query error [2] detected !! ',ma,'Transaction error: might be due to the server CORS settings.\nPlease, check the console for more details.');
isOnException=!0;xa=this.getResponseHeader('Content-Type');if(/\/json/.test(xa))xa=JSON.parse(this.responseText),'undefined'==typeof xa.status&&(xa.status=this.status);else if(xa={status:S.status,message:''},/^(\{|\[)/.test(S.responseText))try{xa=M(xa,JSON.parse(S.responseText))}catch(ua){xa=M(xa,ua)}return ia(xa)},S.onload=function(){try{W=this.responseText;var xa=this.getResponseHeader('Content-Type');if(/\/json/.test(xa))W=JSON.parse(this.responseText),'undefined'==typeof W.status&&(W.status=this.status);
else if(W={status:S.status,message:''},/^(\{|\[)/.test(S.responseText))try{W=M(W,JSON.parse(S.responseText))}catch(ma){W=M(W,ma)}return ia(W)}catch(ma){throw ma;}},A?S.send(v):S.send())}else console.debug('stopping on errors ...'),triggerEvent(gina,this.target,'asyncCompleted.'+H,u[this.name])},N=async function(m,z,y,H){var v=(new (require(_(GINA_FRAMEWORK_DIR+'/core/config.js',!0)))).getInstance(),w=null,F=null,J=null,S=getContext('bundle');if(/@/.test(m.url)){var ta=m.url.split(/@/);F=ta[0];J=ta[1];
getConfig(S,'app');try{v.bundle!==J&&(w=getConfig(S,'app').proxy[J])}catch(ia){throw Error('Could not retrieve `proxy` configuration for bundle `'+J+'`. Please check your `/config/app.json`.\n'+ia.stack);}ta=null}else throw Error('external url/domain not  handled at this moment, please contact us if you need support for it.');ta=JSON.clone(ba.getRoute(m.url,m.data));var Fa=v[J][v.env];w||(v.bundle==J&&(w=getConfig(S,'settings').server.credentials,m.ca=w.ca||null,m.hostname=Fa.server.scheme+'://'+
...
xa.message);}}}else if(v instanceof RegExp)J=v.test(this.value)?!0:!1;else if('boolean'==typeof v)J=v?!0:!1;else try{/\/(.*)\//.test(v)?(Fa=v.match(/\/(.*)\//).pop(),W=v.replace('/'+Fa+'/',''),J=(new RegExp(Fa,W)).test(this.value)):J=eval(v)}catch(xa){throw Error(xa.stack||xa.message);}}J?J&&'undefined'!=typeof ta[S]&&delete ta[S]:(ta[S]=C(this.error||w||T.errorLabels[S],this),'undefined'!=typeof F&&(ta.stack=F));this.valid=J;0<ta.count()&&(this.errors=ta);return u[this.name]};u[m].set=function(v){this.value=
T.data[this.name]=v;this.target.setAttribute('value',v);return u[this.name]};u[m].isEmail=function(){this.value=T.data[this.name]=this.value?this.value.toLowerCase():this.value;U&&this.target&&''!=this.target.value&&/[A-Z]+/.test(this.target.value)&&(this.target.value=this.value);var v=/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(this.value)?!0:!1,w=u[this.name].errors||{};w.isRequired||
''!=this.value||(v=!0);v?v&&'undefined'!=typeof w.isEmail&&delete w.isEmail:w.isEmail=C(this.error||T.errorLabels.isEmail,this);this.valid=v;0<w.count()&&(this.errors=w);return u[this.name]};u[m].isJsonWebToken=function(){this.value=T.data[this.name]=this.value?this.value.toLowerCase():this.value;U&&this.target&&''!=this.target.value&&/[A-Z]+/.test(this.target.value)&&(this.target.value=this.value);var v=/^[A-Za-z0-9-_=]+\.[A-Za-z0-9-_=]+\.?[A-Za-z0-9-_.+/=]*$/.test(this.value)?!0:!1,w=u[this.name].errors||
{};w.isRequired||''!=this.value||(v=!0);v?v&&'undefined'!=typeof w.isJsonWebToken&&delete w.isJsonWebToken:w.isJsonWebToken=C(this.error||T.errorLabels.isJsonWebToken,this);this.valid=v;0<w.count()&&(this.errors=w);return u[this.name]};u[m].isBoolean=function(){var v=null,w=u[this.name].errors||{};w.isRequired&&0==this.value&&(delete w.isRequired,this.errors=w);switch(this.value){case 'true':case !0:case 1:v=this.value=T.data[this.name]=!0;break;case 'false':case !1:case 0:v=this.value=T.data[this.name]=
!1}(v=null!==v?!0:!1)?v&&'undefined'!=typeof w.isBoolean&&delete w.isBoolean:w.isBoolean=C(this.error||T.errorLabels.isBoolean,this);this.valid=v;0<w.count()&&(this.errors=w);return u[this.name]};u[m].isNumber=function(v,w){var F=this.value,J=!1,S=!0,ta=!0,Fa=u[this.name].errors||{};try{'string'==typeof F&&/,|\./g.test(F)?F=T.data[this.name]=this.value=parseFloat(F.replace(/,/g,'.').replace(/\s+/g,'')):'string'==typeof F&&''!=F&&(F=T.data[this.name]=this.value=parseInt(F.replace(/\s+/g,'')))}catch(la){Fa.isNumber=
C(this.error||T.errorLabels.isNumber,this),this.valid=!1,0<Fa.count()&&(this.errors=Fa)}if(+F===+F&&(J=!0,!Fa.isRequired&&''!=F)){var W=F.toString().length;v&&'number'==typeof v&&W<v&&(S=!1,this.size=v);w&&'number'==typeof w&&W>w&&(ta=!1,this.size=w)}J&&S&&ta||(J||(Fa.isNumber=C(this.error||T.errorLabels.isNumber,this)),S&&ta||(S||(Fa.isNumberLength=C(this.error||T.errorLabels.isNumberMinLength,this)),ta||(Fa.isNumberLength=C(this.error||T.errorLabels.isNumberMaxLength,this)),v===w&&(Fa.isNumberLength=
C(this.error||T.errorLabels.isNumberLength,this))),J=!1);J&&'undefined'!=typeof Fa.isNumberLength&&delete Fa.isNumberLength;this.valid=J;this.value=T.data[this.name]=''!=F?Number(F):F;0<Fa.count()&&(this.errors=Fa);return u[this.name]};u[m].toInteger=function(){var v=this.value,w=u[this.name].errors||{};if(v)try{this.value=T.data[this.name]=Math.round(v)}catch(F){w.toInteger=C(this.error||T.errorLabels.toInteger,this),this.valid=!1,0<w.count()&&(this.errors=w)}return u[this.name]};u[m].isInteger=
function(v,w){var F=this.value,J=!1,S=!0,ta=!0,Fa=u[this.name].errors||{};+F===+F&&0===F%1&&(J=!0,Fa.isRequired||''==F||(v&&'number'==typeof v&&F.length<v&&(S=!1,this.size=v),w&&'number'==typeof w&&F.length>w&&(ta=!1,this.size=w)));J&&S&&ta||(J||(Fa.isInteger=C(this.error||T.errorLabels.isInteger,this)),S&&ta||(S||(Fa.isIntegerLength=C(this.error||T.errorLabels.isIntegerMinLength,this),J=!1),ta||(Fa.isIntegerLength=C(this.error||T.errorLabels.isIntegerMaxLength,this),J=!1),v===w&&(Fa.isIntegerLength=
C(this.error||T.errorLabels.isIntegerLength,this),J=!1)));this.valid=J;this.value=T.data[this.name]=Number(F);0<Fa.count()&&(this.errors=Fa);return u[this.name]};u[m].toFloat=function(v){'string'==typeof this.value&&(this.value=this.value.replace(/\s+/g,''),/,/.test(this.value)&&!/\./.test(this.value)?this.value=this.value.replace(/,/g,'.'):this.value=this.value.replace(/,/g,''));var w=T.data[this.name]=this.value,F=u[this.name].errors||{},J=!0;v?this.decimals=parseInt(v):'undefined'==typeof this.decimals&&
(this.decimals=2);if(w)if(this.isNumber().valid)try{Number.isFinite(w)||(w=this.value=T.data[this.name]=new Number(parseFloat(w.match(/[0-9.,]+/g).join('').replace(/,/,'.')))),U&&this.target.setAttribute('value',w)}catch(S){J=!1,F.toFloat=C(this.error||T.errorLabels.toFloat,this),this.valid=!1,0<F.count()&&(this.errors=F)}else J=!1,F.toFloat=C(this.error||T.errorLabels.toFloatNAN,this);else return u[this.name];this.decimals&&w&&!F.toFloat&&(this.value=T.data[this.name]=parseFloat(this.value.toFixed(this.decimals)));
this.valid=J;0<F.count()&&(this.errors=F);return u[this.name]};u[m].isFloat=function(v){'string'==typeof this.value&&(this.value=this.value.replace(/\s+/g,''));var w=T.data[this.name]=this.value;v=u[this.name].errors||{};'string'==typeof w&&/\./.test(w)&&Number.isFinite(Number(w));'string'==typeof w&&/,/g.test(w)&&(w=this.value=T.data[this.name]=Number(w.replace(/,/g,'.')));Number(w)===w&&0!==w%1?(this.value=T.data[this.name]=Number(w),w=!0):w=!1;v.isRequired||''!=this.value||(w=!0);w||(v.isFloat=
C(this.error||T.errorLabels.isFloat,this));this.valid=w;0<v.count()&&(this.errors=v);return u[this.name]};u[m].isRequired=function(v){if('boolean'==typeof v&&!v)return this.valid=!0,v=T.excluded.indexOf(this.name),-1<v&&T.excluded.splice(v,1),u[this.name];if(U&&this.target&&'INPUT'==this.target.tagName&&'undefined'!=typeof this.target.type&&'radio'==this.target.type){v=document.getElementsByName(this.name);for(var w=0,F=v.length;w<F;++w)if(v[w].checked){/true|false/.test(v[w].value)?this.value=T.data[this.name]=
/true/.test(v[w].value)?!0:!1:this.value=T.data[this.name]=v[w].value;this.valid=!0;break}}v='undefined'==typeof this.value||null==this.value||''==this.value||/^\s+/.test(this.value)?!1:!0;w=u[this.name].errors||{};v?v&&'undefined'!=typeof w.isRequired&&delete w.isRequired:w.isRequired=C(this.error||T.errorLabels.isRequired,this);this.valid=v;0<w.count()&&(this.errors=w);return u[this.name]};u[m].isString=function(v,w){var F=T.data[this.name]=this.value,J=!1,S=!0,ta=!0,Fa=u[this.name].errors||{};
'string'!=typeof F||Fa.isRequired||''==F||(J=!0,v&&'number'==typeof v&&F.length<v&&(S=!1,this.size=v),w&&'number'==typeof w&&F.length>w&&(ta=!1,this.size=w));J&&S&&ta||(!J&&Fa.isRequired&&''==F?(J=!1,Fa.isString=C(this.error||T.errorLabels.isString,this)):J||Fa.isRequired||(J=!0),S&&ta||(J=!1,S||(Fa.isStringLength=C(this.error||T.errorLabels.isStringMinLength,this)),ta||(Fa.isStringLength=C(this.error||T.errorLabels.isStringMaxLength,this)),v===w&&(Fa.isStringLength=C(this.error||T.errorLabels.isStringLength,
this))));this.valid=J;0<Fa.count()&&(this.errors=Fa);return u[this.name]};u[m].isDate=function(v){var w=this.value,F=!1,J=u[this.name].errors||{},S=null;if(!w||''==w||/NaN|Invalid Date/i.test(w))return/NaN|Invalid Date/i.test(w)&&(console.warn('[FormValidator::isDate] Provided value for field `'+this.name+'` is not allowed: `'+w+'`'),J.isDate=C(this.error||T.errorLabels.isDate,this)),this.valid=F,0<J.count()&&(this.errors=J),u[this.name];if('undefined'==typeof v||'undefined'!=typeof v&&/true/i.test(v))v=
'yyyy-mm-dd';if(w instanceof Date)w=w.format(v);else{try{S=v.match(/[^\/\- ]+/g)}catch(ia){throw Error('[FormValidator::isDate] Provided mask not allowed: `'+v+'`');}try{w=w.match(/[^\/\- ]+/g);var ta={},Fa;var W=0;for(Fa=S.length;W<Fa;++W)ta[S[W]]=w[W];for(var la in ta)v=v.replace(new RegExp(la,'g'),ta[la])}catch(ia){throw Error('[FormValidator::isDate] Provided value not allowed: `'+w+'`'+ia);}w=this.value=T.data[this.name]=new Date(v);if(/Invalid Date/i.test(w)||!1===w instanceof Date)return J.isRequired||
''!=this.value?J.isDate=C(this.error||T.errorLabels.isDate,this):F=!0,this.valid=F,0<J.count()&&(this.errors=J),u[this.name];F=!0}this.valid=F;return w};u[m].format=function(v,w){var F=this.value;return F?F.format(v,w):u[this.name]};u[m].setFlash=function(v,w){'undefined'!=typeof w&&''!=w&&(this.error=w);return u[this.name]};u[m].setLabel=function(v){'undefined'!=typeof v&&''!=v&&(this.label=v);return u[this.name]};u[m].trim=function(v){if('boolean'==typeof v&&v)return this.value=this.value.replace(/^\s+|\s+$/,
''),T.data[this.name]=T.data[this.name]=this.value,u[this.name]};u[m].exclude=function(v){if('boolean'==typeof v&&!v)return/^true|false$/i.test(this.value)&&(this.value=/^true$/i.test(this.value)?!0:!1,T.data[this.name]=this.value),u[this.name];this.isExcluded=!1;0>T.excluded.indexOf(this.name)&&(T.excluded.push(this.name),this.isExcluded=!0);return u[this.name]};u[m].query=O;u[m].getValidationContext=function(){return{isGFFCtx:U,self:u,local:T,replace:C}};if(Q()){y=z=null;try{for(let v in gina.forms.validators)y=
'/validators/'+v+'/main.js',T.errorLabels[v]='Condition not satisfied',U?(z=r(gina.forms.validators[v].data),z=z.replace(/(\)\s+\{|\)\{){1}/,'$&\n\tvar validationContext = this.getValidationContext(),isGFFCtx = validationContext.isGFFCtx,self = validationContext.self,local = validationContext.local,replace = validationContext.replace;')):z=gina.forms.validators[v].toString(),u[m][v]=eval('('+z+')\n//# sourceURL='+v+'.js')}catch(v){throw Error('[UserFormValidator] Could not evaluate: `'+y+'`\n'+v.stack);
...
getContext('gina').plugins,U=V.Validator);P.getUrlProps=function(u,G){var r={};if(A){var ca=window.gina.config;r.hostname=ca.hostname;'undefined'!=typeof u&&(u=routing.getRoute('webroot@'+u),r.hostname=u.hostname,r.host=u.host,r.webroot=u.webroot)}else ca=getContext('gina').config,'undefined'!=typeof getContext('argvFilename')&&(ca.getRouting=getContext('gina').Config.instance.getRouting),'undefined'==typeof u&&(u=ca.bundle),'undefined'==typeof G&&(G=ca.env),r.hostname=ca.envConf[u][G].hostname,r.host=
ca.envConf[u][G].host,r.webroot=ca.envConf[u][G].server.webroot;return r};P.compareUrls=async function(u,G,r,ca,Ea){'undefined'==typeof r&&(r={routing:{}});if(/,/.test(G)){var N=0;G=G.split(/,/g);for(var O=G.length,D={past:!1,request:r};N<O&&!D.past;)D=await M(u,G[N],r,ca,Ea),++N;return D}return await M(u,G,r,ca,Ea)};var M=async function(u,G,r,ca,Ea){var N=null;try{N=u.url.split(/\//)}catch(S){console.warn(S),N=['']}G=G.split(/\//);var O=0,D=0,C=G.length,m=0,z={},y=0,H=r.method.toLowerCase(),v='get';
try{v=u.method.toLowerCase()}catch(S){}var w=!1;if('undefined'!=typeof u.requirements&&/get|delete/i.test(H)&&'undefined'!=typeof r[H]||'undefined'!=typeof u.requirements&&/get/i.test(H)&&/delete/i.test(v)){/get/i.test(H)&&/delete/i.test(v)&&(H=v);if(/^(delete)$/i.test(H)&&N.length===G.length){'undefined'==typeof r[H]&&(r[H]={});for(let S=0,ta=G.length;S<ta;S++)if(N[S]===G[S])++m;else if(v=G[S].substr(1),'undefined'!=typeof u.requirements[v]){v=u.requirements[v];if(/^\//.test(v))v=v.substr(1,v.lastIndexOf('/')-
1);else if(/^validator::/.test(v)&&await ba(G[S],N[S],u,r,ca,Ea)){++m;continue}/^:/.test(G[S])&&'undefined'!=typeof v&&(new RegExp(v)).test(N[S])&&(++m,r[H][G[S].substr(1)]=N[S])}w=!0}for(var F in r[H])'undefined'!=typeof u.requirements[F]&&0>G.indexOf(':'+F)&&(G[D]=':'+F,++D,N[O]=r[H][F],++O,w||N.length!==G.length||++C)}if(!w&&N.length===G.length)for(;y<C;++y)N[y]===G[y]?++m:m==y&&/:/.test(G[y])&&await ba(G[y],N[y],u,r,ca,Ea)&&++m;if('undefined'!=typeof u.requirements&&H==u.method.toLowerCase()&&
!w&&m>=C)for(F=Object.getOwnPropertyNames(u.requirements),O=0,G.join(',').match(/:[-_a-z0-9]+/g);O<F.length;){D=F[O];if('undefined'==typeof u.param[D]&&/^validator::/i.test(u.requirements[D])){if(G.length!=N.length)break;var J=G.join(',').match(/:[-_a-z0-9]+/g);let S=u.requirements[D];y={};v={};w={};try{v=JSON.parse(S.split(/::/).splice(1)[0].replace(/([^:"\s+](\w+)):/g,'"$1":').replace(/([^:"\s+](\w+))\s+:/g,'"$1":'))}catch(ta){throw ta;}if('undefined'!=typeof v.query&&'undefined'!=typeof v.query.data){y=
v.query.data;for(let ta in y)0>J.indexOf(y[ta])&&delete y[ta];for(let ta=0,Fa=G.length;ta<Fa;ta++)/^:/.test(G[ta])&&(J=G[ta].replace(/^:/,''),''!=J&&'undefined'!=typeof N[ta]&&(y[J]=N[ta],'undefined'==typeof r.params[J]&&(r.params[J]=N[ta])))}y=na(y,JSON.clone(r[H])||{});'undefined'==typeof y[D]&&(y[D]=null);w[D]=v;_validator=A?new U(y):new U('routing',y,null,w);if(0==v.count()){console.error('Route validation failed '+u.rule);--m;O++;continue}for(let ta in v)if('undefined'!=typeof v[ta].data&&(v[ta].data=
y),w=Array.isArray(v[ta])?await _validator[D][ta].apply(_validator[D],v[ta]):await _validator[D][ta](v[ta],r,ca,Ea),!w.isValid&&(--m,'undefined'!=typeof w.error))throw w.error;}O++}z.past=m===C?!0:!1;z.past&&(r.routing=T(u,r[H]),z.request=r);return z},ba=async function(u,G,r,ca,Ea,N){var O=-1,D=u.match(/:\w+/g);O=new RegExp(u,'g');var C=null,m=null,z=null;C=!1;var y=C=m=m=null,H=null,v=ca.method.toLowerCase();if(!D.length)return!1;r.param.path&&O.test(r.param.path)&&(r.param.path=r.param.path.replace(O,
G));r.param.namespace&&O.test(r.param.namespace)&&(r.param.namespace=r.param.namespace.replace(O,G));'undefined'!=typeof r.param.file&&/:/.test(r.param.file)&&(C=new RegExp('(:'+u+'/|:'+u+'$)','g'),Q.variable=G,r.param.file=r.param.file.replace(C,Q),C=null);r.param.title&&O.test(r.param.title)&&(r.param.title=r.param.title.replace(O,G));if(1==D.length){C=new RegExp(D[0]);O=-1<D.indexOf(u)?D.indexOf(u):!1;!1===O&&u.match(C)&&(O=0);if(!1===O)return O;if(r.method.toLowerCase()!==v)return!1;'undefined'==
typeof ca[v]&&(ca[v]={});z=D[O].substr(1);O=r.requirements[z];if(/^\//.test(O))C=O.match(/\/(.*)\//).pop(),m=O.replace('/'+C+'/',''),C=(new RegExp(C,m)).test(G);else if(/^validator::/.test(O)&&G){m={};C={};y={};H='';u.replace(new RegExp('[^'+z+']','g'),function(ta){H+=ta});m[z]=G.replace(new RegExp(H,'g'),'');try{C=JSON.parse(O.split(/::/).splice(1)[0].replace(/([^:"\s+](\w+)):/g,'"$1":').replace(/([^:"\s+](\w+))\s+:/g,'"$1":'))}catch(ta){throw ta;}'undefined'!=typeof C.query&&'undefined'!=typeof C.query.data&&
u==C.query.data[Object.keys(C.query.data)[0]]&&(C.query.data[Object.keys(C.query.data)[0]]=m[z],ca.params[z]=m[z]);y[z]=C;m=new U('routing',m,null,y);if(0==C.count())return console.error('Route validation failed '+r.rule),!1;for(var w in C)Array.isArray(C[w])?await m[z][w].apply(m[z],C[w]):await m[z][w](C[w],ca,Ea,N);C=m.isValid()}else C=(new RegExp(r.requirements[z])).test(G);if('undefined'!=typeof r.param[z]&&'undefined'!=typeof r.requirements&&'undefined'!=typeof r.requirements[z]&&'undefined'!=
typeof ca.params&&C)return ca.params[z]=G,'undefined'==typeof ca[v][z]&&(ca[v][z]=G),!0}else{Ea=r.url;N=ca.url;v={};y='';var F=!1,J=0;w=0;for(var S=N.length;w<S;++w)if(N.charAt(w)!=Ea.charAt(J)||F){if(''==y)F=!0,y+=N.charAt(w);else if(w>Ea.indexOf(D[0])+D[0].length){O=r.requirements[D[0]];G=y.substr(0,y.length);if(/^\//.test(O))C=O.match(/\/(.*)\//).pop(),m=O.replace('/'+C+'/',''),C=(new RegExp(C,m)).test(G);else if(/^validator::/.test(O)){m={};C={};y={};H='';u.replace(new RegExp('[^'+z[0]+']','g'),
function(ta){H+=ta});m[z[0]]=G.replace(new RegExp(H,'g'),'');C=JSON.parse(O.split(/::/).splice(1)[0].replace(/([^\W+ true false])+(\w+)/g,'"$&"'));y[z[0]]=C;m=new U('routing',m,null,y);for(let ta in C)if(Array.isArray(C[ta]))m[z[0]][ta].apply(m[z[0]],C[ta]);else m[z[0]][ta](C[ta]);C=m.isValid()}else C=(new RegExp(r.requirements[z[0]])).test(G);if(C)v[D[0].substr(1)]=G;else return!1;y='';F=!1;J=Ea.indexOf(D[0])+D[0].length;--w;D.splice(0,1)}else y+=N.charAt(w),++J;if(w==S-1)if(O=r.requirements[D[0]],
G=y.substr(0,y.length),/^\//.test(O)?(C=O.match(/\/(.*)\//).pop(),m=O.replace('/'+C+'/',''),C=(new RegExp(C,m)).test(G)):C=(new RegExp(r.requirements[z])).test(G),C)v[D[0].substr(1)]=G;else return!1}else++J;if(v.count()==D.length){z=null;for(z in v)ca.params[z]=v[z];return!0}}return!1},Q=function(u){return/\/$/.test(u)?Q.variable+'/':Q.variable},T=function(u,G){var r=null,ca,Ea=u.url,N=null;for(N in u.param)if(('undefined'==typeof G||'undefined'!=typeof G[N])&&/^:/.test(u.param[N])){var O=u.param[N].substr(1);
if('undefined'!=typeof G&&'undefined'!=typeof G[O]){var D=new RegExp('(:'+O+'/|:'+O+'$)','g');'undefined'!=typeof u.param.path&&/:/.test(u.param.path)&&(u.param.path=u.param.path.replace(D,G[O]));'undefined'!=typeof u.param.title&&/:/.test(u.param.title)&&(u.param.title=u.param.title.replace(D,G[O]));'undefined'!=typeof u.param.namespace&&/:/.test(u.param.namespace)&&(u.param.namespace=u.param.namespace.replace(D,G[O]));'undefined'!=typeof u.param.file&&/:/.test(u.param.file)&&(Q.variable=G[O],u.param.file=
u.param.file.replace(D,Q));if(/,/.test(u.url)){r=u.url.split(/,/g);var C=0;for(ca=r.length;C<ca;++C)Q.variable=G[O],r[C]=r[C].replace(D,Q);u.url=r.join(',')}else Q.variable=G[O],u.url=u.url.replace(D,Q)}}if(r){C=0;ca=r.length;Ea=Ea.split(/,/g);var m=0;for(u.urlIndex=0;C<ca;++C)if(r=0,D=Ea[0].match(/:[-_a-z0-9]+/ig)){N=0;for(O=D.length;N<O;N++){var z=D[N].substr(1);'undefined'!=typeof G[z]&&G[z]&&r++}r>m&&(m=r,u.urlIndex=C)}}return u};P.getRoute=function(u,G,r){var ca=null;A?ca=window.gina.config:
(ca=getContext('gina').config,'undefined'!=typeof getContext('argvFilename')&&(ca.getRouting=getContext('gina').Config.instance.getRouting));var Ea=ca.env||GINA_ENV,N=null,O=ca.bundle;/@/.test(u)||'undefined'==typeof O||null==O||(u=u.toLowerCase(),u+='@'+O);if(/@/.test(u)){var D=u.replace(/(.*):\/\//,'').split(/@/);O=D[1];/\/(.*)$/.test(u)&&(N=u.replace(/(.*):\/\//,'').split(/\/(.*)$/)[1],O=O.replace(/\/(.*)$/,''),Ea=N||Ea);u=D[0].toLowerCase()+'@'+O}N=ca.getRouting(O,Ea);if('undefined'==typeof N[u])throw Error('[ RoutingHelper::getRouting(rule, params) ] : `'+
u+'` not found !');ca=JSON.clone(N[u]);O=null;ca=T(ca,G);/,/.test(ca.url)&&('undefined'!=typeof ca.urlIndex&&(r=ca.urlIndex,delete ca.urlIndex),r='undefined'!=typeof r?r:0,ca.url=ca.url.split(/,/g)[r]);/\/$/.test(ca.url)&&'/'!=ca.url&&(ca.url=ca.url.substr(0,ca.url.length-1));if(/GET/i.test(ca.method)&&'undefined'!=typeof G){r='?';N=N[u].url;O=[];D=0;for(let C in ca.param)-1<P.reservedParams.indexOf(C)||(new RegExp(ca.param[C])).test(N)||'undefined'==typeof G[C]||(r+=C+'='+encodeRFC5987ValueChars(G[C])+
'&',O[D]=G[C],++D);for(let C in G)-1<P.reservedParams.indexOf(C)||'undefined'!=typeof ca.requirements[C]||-1<O.indexOf(C)||(r='object'==typeof G[C]?r+(C+'='+encodeRFC5987ValueChars(JSON.stringify(G[C]))+'&'):r+(C+'='+G[C]+'&'));D=O=N=null;1<r.length&&(r=r.substring(0,r.length-1),ca.url+=r);r=null}ca.toUrl=function(C){var m=null;/^redirect$/i.test(this.param.control)&&(m=P.getUrlProps(this.bundle,Ea||GINA_ENV));var z=this.webroot||m.webroot;m=this.hostname||m.hostname;var y=this.url;this.url='undefined'!=
typeof C&&1==C?y.replace(z,'/'):y;return m+this.url};ca.request=function(C,m){var z=null,y=null;'function'==typeof arguments[arguments.length-1]&&(z=arguments[arguments.length-1]);'object'==typeof arguments[2]&&(y=arguments[2]);var H=this.webroot||y.webroot,v=this.hostname||y.hostname;y='undefined'!=typeof C&&1==C?path.replace(H,'/'):this.url||y.url;v=/^https/.test(v)?'https':'http';A?window.open(y,'undefined'!=typeof m&&'undefined'!=typeof m.target?m.target:'_self'):('undefined'==typeof m.agent&&
(m.agent=!1),v=require(''+v),H=function(w){var F='',J=!1;w.on('data',function(S){F+=S});w.on('error',function(S){J='Failed to get mail content';S&&'undefined'!=typeof S.stack?J+=S.stack:'string'==typeof S&&(J+='\n'+S)});w.on('end',function(){if(/^\{/.test(F))try{F=JSON.parse(F),'undefined'!=typeof F.error&&(J=JSON.clone(F),F=null)}catch(S){J=S}J?z(J):z(!1,F)})},z?v.get(y,m,H):v.get(y,m))};!/:/.test(ca.url)||/:d+\//.test(ca.url)||/:\/\//.test(ca.url)||(G=ca.url.match(/(:(.*)\/|:(.*)$)/g).map(function(C){return C.replace(/\//g,
'')}).join(', '),O='[ RoutingHelper::getRoute(rule[, bundle, method]) ] : route [ %r ] param placeholder not defined: `'+ca.url+'` !\n Check your route description to compare requirements against param variables [ '+G+']',O=O.replace(/%r/,u),u=Error(O),console.warn(u),O=u=G=null);return ca};P.getRouteByUrl=function(u,G,r,ca,Ea){2==arguments.length&&'undefined'!=typeof arguments[1]&&arguments[1]&&-1<P.allowedMethods.indexOf(arguments[1].toLowerCase())&&(r=arguments[1],G=void 0);var N=null,O=null,D=
null,C=null,m=null,z=null;if(/#/.test(u)&&1<u.length){var y=u.split(/#/);u=y[0];m='#'+y[1];y=null}1==arguments.length&&'undefined'!=typeof arguments[0]&&(/^(https|http)/i.test(u)||/^\//.test(u)||(u='/'+u),N='/'+u.split(/\//g)[1],A&&(C=gina.config.reverseRouting,D=gina.config.routing),'undefined'!=typeof C[N]&&(y=D[C[N]],G=y.bundle,N=y.webroot,z=y.hostname,y=null));Ea='boolean'!=typeof arguments[arguments.length-1]?!1:arguments[arguments.length-1];var H=!1,v=null,w=null,F=v=w=null;y='undefined'!=typeof r?
!0:!1;A?(v=window.gina.config,G='undefined'!=typeof G?G:v.bundle,w=v.env,D=D||v.getRouting(G),C=C||v.reverseRouting,isXMLRequest='undefined'!=typeof isXMLRequest?isXMLRequest:!1,z=z||v.hostname,N=N||v.webroot,ca={routing:{},method:r,params:{},url:u}):(v=getContext('gina').config,G='undefined'!=typeof G?G:v.bundle,w=v.env,D=v.getRouting(G),z=v.envConf[G][w].hostname,N=v.envConf[G][w].server.webroot,ca||={routing:{},isXMLRequest:!1,method:'undefined'!=typeof r?r.toLowerCase():'get',params:{},url:u},
Ea&&(ca.method=r),isXMLRequest=ca.isXMLRequest||!1);w=u.replace(new RegExp('^('+z+'|'+z.replace(/:\d+/,'')+')'),'');'undefined'==typeof ca.routing.path&&(ca.routing.path=decodeURI(w));r='undefined'!=typeof r?r.toLowerCase():'get';y&&(ca.originalMethod=ca.method,ca.method=r,ca.routing.path=decodeURI(w));ca.method||(ca.method=r);v={};N=new RegExp(r,'i');C=null;var J;for(J in D){if('undefined'==typeof D[J].param)break;if(D[J].bundle==G&&(C=D[J].method,/,/.test(C)&&N.test(C)&&(C=ca.method),'undefined'==
typeof D[J].method||N.test(C))){v={method:C,requirements:D[J].requirements,namespace:D[J].namespace||void 0,url:decodeURI(w),rule:D[J].originalRule||J,param:D[J].param,middleware:JSON.clone(D[J].middleware),bundle:D[J].bundle,isXMLRequest};try{if(F=P.compareUrls(v,D[J].url,ca),F.past){O=JSON.clone(D[J]);O.name=J;H=!0;F={};break}}catch(S){throw Error('Route [ '+J+' ] needs your attention.\n'+S.stack);}}}if(H)return/\/$/.test(u)&&'/'!=u&&(u=u.substr(0,u.length-1)),m&&(u+=m),O.url=u,O.toUrl=function(S){var ta=
this.webroot,Fa=this.hostname,W=this.url;this.url='undefined'!=typeof S&&1==S?W.replace(ta,'/'):W;return Fa+this.url},O;if(A){m=!1;if('#'==u&&/GET/i.test(r)&&y||/^404:/.test(u))u=location.pathname,m=!0;'undefined'==typeof P.notFound&&(P.notFound={});D=null;O='[ RoutingHelper::getRouteByUrl(rule[, bundle, method]) ] : route [ %r ] is called but not found inside your view: `'+u+'` !';if((D=(D=gina.hasPopinHandler&&gina.popinIsBinded?gina.popin.getActivePopin().target.innerHTML.match(/404:\[\w+\][a-z 0-9-_@]+/):
...
var U=U||require('vendor/uuid'),M=M||require('helpers/dateFormat'),ba={bucket:'default'},Q={},T=null,u={},G={},r=['not null'],ca={bucket:void 0,drop:function(){T.removeItem(ba.bucket);Q=null;for(var O in this)delete this[O];return Q},Collection:P},Ea={insert:function(O){O._id=U.v1();O._createdAt=(new Date).format('isoDateTime');O._updatedAt=(new Date).format('isoDateTime');G[this._collection][G[this._collection].length]=O;T.setItem(this._bucket,JSON.stringify(G))},find:function(O,D){if(!O)return G[this._collection];
...
(M=/^(\{|%7B)/.test(na)?!1:!0)?[]:{};U=/^(%7B|%5B)/.test(na)?JSON.parse(decodeURIComponent(na)):JSON.parse(na);if(Array.isArray(U)){M=0;for(var ba=U.length;M<ba;++M)V[M]=A(U[M],V);var Q=V}else Q=A(U,V);var T=Q;break a}catch(u){console.error('[365] could not parse body:\n'+na)}T=void 0}else{V={};T=na.split(/&/g);/("false"|"true"|"on")/.test(na)&&na.replace(/"false"/g,!1).replace(/"true"/g,!0).replace(/"on"/g,!0);na={};ba=0;for(U=T.length;ba<U;++ba)if(T[ba])if(T[ba]=decodeURIComponent(T[ba]),/^\{/.test(T[ba])||
/=\{/.test(T[ba])||/=\[/.test(T[ba]))try{if(/^\{/.test(T[ba])){V=JSON.parse(T[ba]);break}else na=T[ba].match(/=(.*)/),na[0]=T[ba].split(/=/)[0],V[na[0]]=JSON.parse(na[1])}catch(u){console.error('[parseBody#1] could not parse body:\n'+T[ba])}else{na=T[ba].split(/=/);if(/\{\}":/.test(na[1]))try{na[1]=JSON.parse(na[1])}catch(u){console.error('[parseBody#2] could not parse body:\n'+na[1])}'string'!=typeof na[1]||/\[object /.test(na[1])||(na[0]=decodeURIComponent(na[0]),na[1]=decodeURIComponent(na[1]),
/^(.*)\[(.*)\]/.test(na[0])?(Q=na[0].replace(/\]/g,'').split(/\[/g),V=P(V,Q,0,na[1])):V[na[0]]=na[1])}T=V}}return T};var A=function(V,na){var U=[];na||={};for(let ba in V)if(U[0]=ba,U[1]=V[ba],/^(.*)\[(.*)\]/.test(U[0])){var M=U[0].replace(/\]/g,'').split(/\[/g);na=P(na,M,0,U[1])}else na[U[0]]=U[1];return na},P=function(V,na,U,M){for(let ba=0,Q=na.length;ba<Q;ba++){let T=na[U];if(ba==U){if('undefined'==typeof V[na[U]]||'string'==typeof V[na[U]])Array.isArray(V)?(T=~~na[U],V[T]=/^\d+$/.test(na[U+1])?
[]:{}):V[na[U]]=/^\d+$/.test(na[U+1])?[]:{};if(U==na.length-1){M='undefined'!=typeof M?M:'';Array.isArray(V[na[U]])?V[na[U]].push(M):V[na[U]]=M;break}else/^\d+$/.test(na[U])&&!Array.isArray(V)&&(V=[]),'undefined'==typeof V[T]&&(V[T]=null),P(V[T],na,U+1,M)}}return V}}'undefined'!==typeof module&&module.exports?module.exports=DataHelper:'function'===typeof define&&define.amd&&define('utils/data',[],function(){return DataHelper()});
...
delete require.cache[require.resolve('../../../../../helpers/data')];require('../../../../../helpers/data')}var ba=U?require('vendor/uuid'):require('uuid'),Q=U?require('lib/merge'):require('../../../../../lib/merge'),T=U?require('lib/inherits'):require('../../../../../lib/inherits'),u=U?require('lib/form-validator'):require('./form-validator'),G=U?require('lib/routing'):require('../../../../../lib/routing'),r={id:'validator-'+ba.v4(),plugin:this.plugin,on:U?on:null,eventData:{},target:U?document:
null,errors:{},initialized:!1,isReady:!1,rules:{},$forms:{},getFormById:null,validateFormById:null,setOptions:null,resetErrorsDisplay:null,resetFields:null},ca={id:null,plugin:this.plugin,on:U?on:null,eventData:{},target:U?document:null,cachedErrors:{},binded:!1,unbinded:!1,withUserBindings:!1,rules:{},setOptions:null,send:null,isValidating:null,isSubmitting:null,submit:null,destroy:null,resetErrorsDisplay:null,resetFields:null},Ea={},N={},O=null,D={url:'',method:'GET',isSynchrone:!1,withCredentials:!1,
...
l=l.replace(/#/,'');if(null!=document.getElementById(l)&&'undefined'==typeof r.$forms[l]){var h=document.getElementById(l),b,x=typeof(0<Ea.count())?Ea:r.rules;h.getAttribute?(id=h.getAttribute('id')||'form.'+ba.v4(),id!==h.getAttribute('id')&&h.setAttribute('id',id)):(id='form.'+ba.v4(),h.setAttribute('id',id));h.id=ca.id=id;if('undefined'!=typeof h.id&&'null'!=h.id&&''!=h.id){ca.target=h;r.$forms[h.id]=Q({},ca);if(b=h.getAttribute('data-gina-form-rule')){b=b.replace(/\-|\//g,'.');if('undefined'==
typeof x[b])throw Error('['+h.id+'] no rule found with key: `null`');b=x[b]}'string'==typeof h.id&&'undefined'!=typeof x[h.id.replace(/\-/g,'.')]?$target=r.$forms[h.id].target:'object'==typeof h.id?(delete r.$forms[h.id],x=h.attributes.getNamedItem('id').nodeValue||'form.'+ba.v4(),h.setAttribute('id',x),h.id=x,ca.target=h,r.$forms[x]=Q({},ca),$target=r.$forms[x].target):$target=r.$forms[h.id].target;b?xb($target,b):xb($target)}}'undefined'!=typeof r.$forms[l]&&(r.$forms[l].withUserBindings=!0,g='undefined'!=
...
('undefined'!=typeof r.$forms&&'undefined'!=typeof r.$forms[p]&&'undefined'!=typeof r.$forms[p].errors&&0==r.$forms[p].errors.count()||'undefined'!=typeof r.$forms&&'undefined'!=typeof r.$forms[p]&&!r.$forms[p].errors)&&Ka(l,!0),'undefined'!=typeof w[p]&&0==w[p].count()?delete w[p]:g=w[p]}var R=null;p=l.getAttribute('id');h='undefined'!=typeof h?h:{};for(var K=0,ha=l.length;K<ha;++K){var Aa=l[K];if('undefined'==typeof b||b==Aa.name){if(/form\-item\-wrapper$/.test(Aa.parentNode.className)){var fa=
Aa.parentNode.parentNode;var ea=Aa.parentNode}else fa=Aa.parentNode,ea=Aa;var E=Aa.getAttribute('name');var oa=Aa.getAttribute('data-gina-form-errors');if(E){if('undefined'!=typeof g[E]&&!/(form\-item\-error|form\-item\-warning)/.test(fa.className)){fa.className=q?fa.className+(''==fa.className?'form-item-warning':' form-item-warning'):fa.className+(''==fa.className?'form-item-error':' form-item-error');R=document.createElement('div');R.className=q?'form-item-error-message hidden':'form-item-error-message';
for(var ra in g[E])'stack'!=ra&&(fa=document.createElement('p'),fa.appendChild(document.createTextNode(g[E][ra])),R.appendChild(fa)),M&&(x||={},x[E]||(x[E]={}),x[E][ra]=g[E][ra]);'hidden'!=ea.type&&insertAfter(ea,R)}else if('undefined'==typeof g[E]&&/(form\-item\-error|form\-item\-warning)/.test(fa.className)||'undefined'!=typeof g[E]&&0==g[E].count()&&/(form\-item\-error|form\-item\-warning)/.test(fa.className)){E=fa.getElementsByTagName('div');ea=0;for(oa=E.length;ea<oa;++ea)if(/form\-item\-error\-message/.test(E[ea].className)){E[ea].parentElement.removeChild(E[ea]);
break}fa.className=fa.className.replace(/(\s+form\-item\-error|form\-item\-error|\s+form\-item\-warning|form\-item\-warning)/,'')}else if('undefined'!=typeof g[E]&&oa){fa=fa.getElementsByTagName('div');oa=0;for(var ja=fa.length;oa<ja;++oa)if('form-item-error-message'==fa[oa].className){fa[oa].parentElement.removeChild(fa[oa]);R=document.createElement('div');R.setAttribute('class','form-item-error-message');for(ra in g[E])fa=document.createElement('p'),fa.appendChild(document.createTextNode(g[E][ra])),
R.appendChild(fa),M&&(x||={},x[E]||(x[E]={}),x[E][ra]=g[E][ra]);break}R&&'hidden'!=ea.type&&insertAfter(ea,R)}if('undefined'!=typeof b&&b===Aa.name)break}}}x?(triggerEvent(gina,l,'error.'+p,g),M&&U&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&(gina.forms.errors||(gina.forms.errors={}),l={id:p,errors:x},window.ginaToolbar.update('forms',l))):M&&U&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&(gina.forms.errors||(gina.forms.errors={}),l={id:p,errors:{}},U&&window.ginaToolbar.update('forms',
...
h,'error.'+b+'.hform',q)};l||(l=event.detail.data);if(l){g=!1;if('object'==typeof l){fa=[];Aa=0;var ea={};try{if(l instanceof FormData){var E=event.currentTarget.getAttribute('data-gina-form-upload-group')||'untagged',oa,ra;for([oa,ra]of l.entries())ra instanceof File?(g||=!0,fa[Aa]={key:oa,group:E,file:ra,bin:''},++Aa):ea[oa]=ra}else l=JSON.stringify(l);if(g&&0<fa.length){var ja='--ginaWKBoundary'+ba.v4().replace(/\-/g,'');return ia(fa,ja,'',0,function(Z,Ga,Pa){if(Z)/^gina\-upload/i.test(b)&&W(gina,
h,'error',b,Z),triggerEvent(gina,h,'error.'+b,Z),K&&triggerEvent(gina,h,'error.'+b+'.hform',Z);else return Pa&&(O.setRequestHeader('Content-Type','multipart/form-data; boundary='+ja),O.send(Ga),x.sent=!0,M&&U&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&(gina.forms.sent||(gina.forms.sent={}),window.ginaToolbar.update('forms',{id:b,sent:Ga}))),!1})}'undefined'!=typeof ea&&0<ea.count()&&(l=JSON.stringify(ea))}catch(Z){/^gina\-upload/i.test(b)&&W(gina,h,'error',b,Z),triggerEvent(gina,
...
b.appendChild(K);fadeIn(K)}K=l.uploadFields[h];for(var fa in K)if('name'==fa&&''!=K[fa].value||!q[h][fa]||'preview'==fa&&'undefined'==typeof q[h][fa]||/(height|width)/i.test(fa)&&!/^image/.test(q[h].mime))/(preview|height|width)/i.test(fa)&&(ha=document.getElementById(K[fa].id))&&ha.parentNode.removeChild(ha);else if(K[fa].value=q[h][fa],'preview'==fa)for(var ea in q[h][fa])if('undefined'!=typeof q[h][fa][ea]&&'undefined'!=typeof K[fa][ea]&&(K[fa][ea].value=q[h][fa][ea]),'tmpUri'==ea&&l.hasPreviewContainer){Aa=
document.createElement('IMG');Aa.src=q[h][fa].tmpUri;Aa.style.display='none';Aa.setAttribute('data-upload-original-filename',q[h].originalFilename);Aa.setAttribute('data-upload-preview-original-filename',q[h][fa].originalFilename);Aa.setAttribute('data-upload-reset-link-id',p.id);if(ha=b.getAttribute('data-preview-max-width')||null)Aa.width=ha;/ul/i.test(l.previewContainer.tagName)?(ha=document.createElement('LI'),ha.className='item',ha.appendChild(Aa),b.appendChild(ha)):b.appendChild(Aa);fadeIn(Aa)}l.hasPreviewContainer&&
...
(x=q[ha].getAttribute('data-upload-preview-original-filename'))&&K.push(x)):(b=q[ha].src.substr(q[ha].src.lastIndexOf('/')+1),K.push(b));for(let fa=0,ea=R.length;fa<ea;fa++)if(R[fa].name==b){p=h?document.getElementById(q[ha].getAttribute('data-upload-'+g+'-link-id')):document.getElementById(R[fa].deleteLinkId);p.style.display='none';q[ha].style.display='none';R.splice(fa,1);l.customFiles=R;h&&(l.value=R.join(', C:\\fakepath\\'));b=new RegExp('^'+(l.name+'['+fa+']').replace(/\-|\[|\]|\./g,'\\$&'));
...
typeof K&&(K=8);var Aa=K/8;switch(K){case 8:ha=new Uint8Array(R);break;case 16:ha=new Uint16Array(R);break;case 32:ha=new Uint32Array(R);break;default:ha=new Uint8Array(R)}var fa=ha.length,ea=Math.pow(2,8)+Aa;R=0;for(Aa=K=null;R<fa;R+=ea)K=Math.min(ea,fa-R),Aa=ha.subarray(R,R+K),p+=String.fromCharCode.apply(null,Aa);l[this.index].bin+=p;l[this.index].file.type||(l[this.index].file.type='application/octet-stream')}catch(E){return x(E,null,!0)}h+='--'+g+'\r\n';h+='Content-Disposition: form-data; name="'+
...
x),r.rules=JSON.parse(JSON.stringify(r.rules).replace(new RegExp(b[ha],'g'),'{}'))}catch(fa){throw fa;}}l={}}l=JSON.parse(g);La(l,'');try{ua()}catch(R){console.error(R.stack)}}return l},Qa=function(l){gina.hasValidator?(r=Q(r,gina.validator),r.on('init',function(g){r.isReady=!0;triggerEvent(gina,r.target,'ready.'+r.id,r)})):(r.target=document,r.setOptions=m,r.getFormById=z,r.validateFormById=H,r.resetErrorsDisplay=J,r.resetFields=S,r.handleErrorsDisplay=F,r.send=Fa,r.on('init',function(g){if('undefined'!=
typeof l&&l.count())try{La(l,''),l=Ca(l),gina.forms.rules='undefined'!=typeof gina.forms.rules&&gina.forms.rules?Q(gina.forms.rules,l,!0):l,r.rules=Q(r.rules,JSON.clone(gina.forms.rules),!0)}catch(R){throw R;}Ea.count()||(Ea=JSON.clone(r.rules));ca.setOptions=m;ca.getFormById=z;ca.validateFormById=H;ca.resetErrorsDisplay=J;ca.resetFields=S;ca.handleErrorsDisplay=F;ca.submit=ta;ca.send=Fa;ca.unbind=Db;ca.bind=xb;ca.reBind=jb;ca.destroy=ma;g=0;for(var h=document.getElementsByTagName('form'),b=0,x=h.length;b<
x;++b){if(h[b].getAttribute){var q=h[b].getAttribute('id')||'form.'+ba.v4();q!==h[b].getAttribute('id')&&h[b].setAttribute('id',q)}else q='form.'+ba.v4(),h[b].setAttribute('id',q);ca.id=q;ca.target=h[b];r.$forms[q]=Q({},ca);var p=h[b].getAttribute('data-gina-form-rule');if(p){p=p.replace(/\-|\//g,'.');'undefined'!=typeof l&&(r.$forms[q].rules[p]=r.rules[p]=Ea[p]=Q(JSON.clone(eval('gina.forms.rules.'+p)),r.rules[p]));if('undefined'==typeof Ea[p])throw Error('['+q+'] no rule found with key: `'+p+'`. Please check if json is not malformed @ /forms/rules/'+
p.replace(/\./g,'/')+'.json');p=r.rules[p]}'string'==typeof q&&'undefined'!=typeof Ea[q.replace(/\-/g,'.')]||'object'==typeof p?(q=r.$forms[q].target,p?xb(q,p):xb(q),++g):('object'==typeof h[b].id?(delete r.$forms[h[b].id],q=h[b].attributes.getNamedItem('id').nodeValue||'form.'+ba.v4(),h[b].setAttribute('id',q),h[b].id=q,ca.target=h[b],r.$forms[q]=Q({},ca),q=r.$forms[q].target):q=r.$forms[h[b].id].target,p?xb(q,p):xb(q))}if(window.XMLHttpRequest)O=new XMLHttpRequest;else if(window.ActiveXObject)try{O=
...
typeof r.rules[l]){if(La(Ea,''),Ea=Ca(Ea),g=Ea[l],!g)return{}}else g=r.rules[l];g=JSON.clone(g);var h=new RegExp('^'+l),b=new RegExp('^'+l+'.'),x=null,q=function(R,K,ha,Aa,fa,ea,E){if(K.length){var oa=Object.getOwnPropertyNames(R)[0],ra=K[0];ra=''==fa?fa+=ra:fa+'['+ra+']';1==K.length&&(R[oa]=Q(R[oa],ha,!0));K.splice(0,1);ra==oa?q(R[oa],K,ha,Aa,ra,ea,E):'undefined'!=typeof R[oa]?q(R[oa],K,ha,Aa,ra,ea,E):q(R,K,ha,Aa,fa,ea,E)}},p;for(p in r.rules)p!=l&&h.test(p)&&(x=p.replace(b,''),/\./.test(x)&&(x=
...
0!=Aa.count())F(K.target.form,Aa,null,K.target.name);else return F(K.target.form,{},null,K.target.name),cancelEvent(K)}Aa={};var fa={};Aa[K.target.name]=K.target.value;fa[K.target.name]=K.target;r.$forms[K.target.form.getAttribute('id')].isValidating=!0;za(K.target,Aa,fa,l.rules,function(ea){r.$forms[K.target.form.getAttribute('id')].isValidating=!1;ea.isValid()?F(K.target.form,{},ea.data,K.target.name):F(K.target.form,ea.error,ea.data,K.target.name);var E=K.target.form,oa=ea=null,ra=null;oa=db(E,
x);ea=oa.fields;oa=oa.$fields;var ja=E.getAttribute('id');ra=r.$forms[ja].rules;r.$forms[ja].isValidating=!0;za(E,ea,oa,ra,function(Z){r.$forms[ja].isValidating=!1;console.debug('['+ja+'] onSilentGlobalLiveValidation: '+Z.isValid(),Z);var Ga=Z.isValid();M&&U&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&(gina.forms.errors||(gina.forms.errors={}),window.ginaToolbar.update('forms',{id:ja,errors:Z.error||{}}));Ka(E,Ga);R=!1})})};if(/^changed\./i.test(K.type)||/^change\./i.test(K.type)&&
'radio'==K.target.type)return function(Aa,fa){if(!(0<fa))return++fa,setTimeout(()=>{console.debug(' changed .... '+g.id);ha()},0)}(R,0);/^focusin\./i.test(K.type)?/\-error/.test(g.parentNode.className)&&(console.debug('#1 you just focusin ....'+g.id,g.value),v(g)):/^focusout\./i.test(K.type)?/\-warning/.test(g.parentNode.className)&&(console.debug('#1 you just focusout ....'+g.id,g.value),v(g),F(g.form,r.$forms[g.form.getAttribute('id')].errors,null,g.name)):/^keyup\./i.test(K.type)?(g.ginaFormValidatorTestedValue=
...
{},fa=[],ea={},E=null,oa={},ra=null,ja=null;for(let da=0,X=ha.length;da<X;++da)rb(h.rules,ha[da]),ja=ha[da].getAttribute('id'),ja&&''!=ja||(ja='textareas.'+ba.v4(),ha[da].setAttribute('id',ja)),h.fieldsSet[ja]||(h.fieldsSet[ja]={id:ja,name:ha[da].name||null,value:ha[da].value||'',defaultValue:ha[da].value||''}),/^true$/i.test(h.target.dataset.ginaFormLiveCheckEnabled)&&gb(h,ha[da]);for(let da=0,X=g.length;da<X;++da){rb(h.rules,g[da]);ja=g[da].getAttribute('id');ja&&''!=ja||(ja='input.'+ba.v4(),g[da].setAttribute('id',
ja));h.fieldsSet[ja]||(E=g[da].value,/$(on|true|false)$/i.test(E)&&(E=/$(on|true)$/i.test(E)?!0:!1),h.fieldsSet[ja]={id:ja,name:g[da].name||null,value:E||!/^(checkbox|radio)$/i.test(g[da].type)?'':g[da].checked,defaultValue:/^(checkbox|radio)$/i.test(g[da].type)?g[da].checked:E},/^(checkbox|radio)$/i.test(g[da].type)&&'undefined'==typeof h.fieldsSet[ja].defaultChecked&&(h.fieldsSet[ja].defaultChecked=/^(true|on)$/i.test(g[da].checked)||/^(true|on)$/.test(E)&&/^(checkbox)$/i.test(g[da].type)?!0:!1,
/^radio$/i.test(g[da].type)&&(h.fieldsSet[ja].value=g[da].value,h.fieldsSet[ja].defaultValue=g[da].value)));/^true$/i.test(h.target.dataset.ginaFormLiveCheckEnabled)&&gb(h,g[da]);if(E=g[da].getAttribute('data-gina-form-element-group'))0>fa.indexOf(E)&&fa.push(E),ra=g[da].getAttribute('name')||ja,ra===ja&&g[da].setAttribute('name',ja),Aa[ja]={id:ja,name:ra,group:E,target:g[da]},ea[g[da].name]=new RegExp('^'+E.replace(/[.*+?^${}()|[\]\\]/g,'\\$&')),q&&('undefined'==typeof h.rules[g[da].name]&&(h.rules[g[da].name]=
{}),'undefined'!=typeof h.rules[g[da].name].isRequired&&h.rules[g[da].name].isRequired||(h.rules[g[da].name].exclude=!0));if(0<ea.count())for(var Z in ea)g[da].name!=Z&&(g[da].getAttribute('data-gina-form-element-group'),ea[Z].test(g[da].name)&&(g[da].disabled=!0,'undefined'==typeof oa[Z]&&(oa[Z]={}),oa[Z][g[da].name]=g[da]));if(/^file$/i.test(g[da].type)){ja=g[da].getAttribute('data-gina-form-upload-trigger');ja||(ja=g[da].id);E=null;ra=(new DOMParser).parseFromString(l.innerHTML,'text/html');ja&&
(E=document.getElementById(ja));ha=document.getElementById(g[da].id+'-error');Zb(g[da],ha);if((ha=ra.getElementById(ja+'-preview'))&&E&&!/none/i.test(window.getComputedStyle(ha).display)&&!/none/i.test(ha.parentElement.style.display)){ra=0;console.debug('preview is visible ...');E.customFiles=[];E.form=l;ha=ha.childNodes;for(let ka=0,va=ha.length;ka<va;ka++){var Ga=null;if(/ul/i.test(ha[ka].tagName))for(let Ra=0,Xa=ha[ka].length;Ra<Xa;Ra++){let eb=$$els[ka];for(let Oa=0,wb=eb.length;Oa<wb;Oa++)/img/i.test(eb[Oa])&&
(Ga=eb[Oa],Ga.setAttribute(''),ra++)}else/img/i.test(ha[ka].tagName)&&(Ga=ha[ka],deleteLinkId=ja+'-'+ra+'-delete-trigger',Ga=Ga.src.substr(Ga.src.lastIndexOf('/')+1),E.customFiles.push({name:Ga,deleteLinkId}),Ub('delete',E,ra),ra++)}}addListener(gina,g[da],'change',function(ka){ka.preventDefault();var va=ka.currentTarget;ka=va.files;va.customFiles=Array.from(ka);if(!ka.length)return!1;var Ra=va.getAttribute('data-gina-form-upload-action'),Xa=va.getAttribute('name'),eb='gina-upload-'+Xa.replace(/\[/g,
...
z(eb),rc=new FormData;va=null;eb=0;for(var sc=ka.length;eb<sc;++eb)va=ka[eb],rc.append(Xa,va,va.name);Qc.send(rc,{withCredentials:!0})}catch(Rc){throw Rc;}}})}}var Pa=function(da,X){da.setAttribute('data-value',da.value);if(/^(true)$/i.test(X.target.dataset.ginaFormLiveCheckEnabled&&0<X.rules.count())){var ka={},va={},Ra=null;Ra=da.form;ka[event.target.name]=event.target.value;va[event.target.name]=event.target;r.$forms[Ra.getAttribute('id')].isValidating=!0;za(event.target,ka,va,X.rules,function(Xa){r.$forms[Ra.getAttribute('id')].isValidating=
!1;Xa.isValid()?F(Ra,{},Xa.data,event.target.name):F(Ra,Xa.error,Xa.data,event.target.name);var eb=Ra,Oa=Xa=null,wb=null;Oa=db(eb,x);Xa=Oa.fields;Oa=Oa.$fields;var lb=eb.getAttribute('id');wb=r.$forms[lb].rules;r.$forms[lb].isValidating=!0;za(eb,Xa,Oa,wb,function(hb){r.$forms[lb].isValidating=!1;console.debug('[updateSelect]: onSilentGlobalLiveValidation: '+hb.isValid(),hb);hb=hb.isValid();Ka(eb,hb);once=!1})})}};E=oa=null;Z=0;for(ea=K.length;Z<ea;++Z)if(rb(h.rules,K[Z]),ja=K[Z].getAttribute('id'),
!ja||!/^gina\-toolbar/.test(ja)){ja&&''!=ja||(ja='select.'+ba.v4(),K[Z].setAttribute('id',ja));if(E=K[Z].getAttribute('data-gina-form-element-group'))oa=K[Z].getAttribute('name')||ja,oa===ja&&K[Z].setAttribute('name',ja),Aa[ja]={id:ja,name:oa,group:E,target:K[Z]};addListener(gina,K[Z],'change',function(da){da=da.target;/select/i.test(da.type)&&Pa(da,h)});if(K[Z].options&&!h.fieldsSet[ja]){oa=0;if(E=K[Z].getAttribute('data-value')||null)for(ra=0,ha=K[Z].options.length;ra<ha;++ra)if(K[Z].options[ra].value==
E){oa=ra;K[Z].selectedIndex=oa;break}'undefined'!=typeof K[Z].options[K[Z].selectedIndex]&&K[Z].options[K[Z].selectedIndex].index&&(oa=K[Z].options[K[Z].selectedIndex].index);0<K[Z].options.length&&'undefined'!=typeof K[Z].options[oa]&&(E=K[Z].options[oa].value);h.fieldsSet[ja]={id:ja,name:K[Z].name||null,value:E||null,selectedIndex:oa||0};'undefined'!=typeof K[Z].selectedIndex&&-1<K[Z].selectedIndex&&(K[Z].options[oa].selected=!0,K[Z].setAttribute('data-value',K[Z].options[oa].value))}}var $a=function(da,
X,ka,va){'undefined'==typeof va&&(va=!1);if('undefined'==typeof Aa[da])throw Error('Radio & Checkbox dependencies not met: you must use the ID attribue of the `master element` as the `data-gina-form-element-group`');var Ra=da.replace(/\-|_|@|#|\.|\[|\]/g,'\\$&');da=Aa[da].target.checked;for(let Oa in Aa)if(!/radio|checkbox/i.test(Aa[Oa].target.type)){var Xa=new RegExp(Ra);var eb=new RegExp(X);if(Xa.test(Aa[Oa].group)&&eb.test(Aa[Oa].group)||Xa.test(Aa[Oa].group))Aa[Oa].target.disabled=!0,'undefined'==
typeof h.rules[Aa[Oa].name]&&(h.rules[Aa[Oa].name]={}),h.rules[Aa[Oa].name].exclude=!0,va?(Aa[Oa].target.disabled=da?!1:!0,h.rules[Aa[Oa].name].exclude=da?!1:!0):(Aa[Oa].target.disabled=ka,h.rules[Aa[Oa].name].exclude=ka)}},ib=function(da,X,ka,va){'undefined'==typeof va&&(va=!1);if(va&&'undefined'!=typeof Aa[X.id])return da=/true/i.test(X.checked)?!1:!0,$a(X.id,Aa[X.id].group,da,va);ka=X.name;q&&'undefined'==typeof da.rules[ka]&&(da.rules[ka]={});/^true$/i.test(X.checked)?q&&(da.rules[ka].exclude=
!1,'undefined'!=typeof Aa[X.id]&&$a(X.id,Aa[X.id].group,!1,va)):q&&(da.rules[ka].exclude=!0,'undefined'!=typeof Aa[X.id]&&$a(X.id,Aa[X.id].group,!0,va))},Cb=function(da,X){'undefined'==typeof X&&(X=!1);var ka=function(Oa,wb,lb){if(wb)ib(h,Oa,wb);else for(let hb in Aa)if(eb.test(Aa[hb].group)||eb.test(Aa[hb].target.getAttribute('data-gina-form-element-group')))Aa[hb].target.disabled=lb};X&&/^(on)$/i.test(da.value)&&!da.checked&&(da.value=!1);var va=da.getAttribute('data-value')||da.getAttribute('value')||
da.value;va=/^(true|on)$/.test(va)?!0:va;''===va&&(va=!1);var Ra=/^(true|on|false)$/i.test(va)?!0:!1;X&&Ra&&(/^true$/i.test(va)&&!da.checked?da.checked=!0:/^false$/i.test(va)&&da.checked&&(da.checked=!1));va=da.checked;var Xa=da.getAttribute('data-gina-form-element-group')||null,eb=new RegExp(da.id.replace(/\-|_|@|#|\.|\[|\]/g,'\\$&'));va&&'null'!=va&&'false'!=va&&''!=va?(X?zb(da):(setTimeout(function(){da.checked=!0;ka(da,Xa,!1);zb(da)},0),da.setAttribute('checked','checked')),Ra&&(da.value=!0,da.setAttribute('value',
!0),typeof('undefined'!=da.getAttribute('data-value'))&&da.setAttribute('data-value',!0))):(X?zb(da):setTimeout(function(){da.checked=!1;ka(da,Xa,!0);zb(da)},0),da.removeAttribute('checked'),Ra&&(da.value=!1,da.setAttribute('value','false'),typeof('undefined'!=da.getAttribute('data-value'))&&da.setAttribute('data-value','false')))},zb=function(da){da=new RegExp(da.id.replace(/\-|_|@|#|\.|\[|\]/g,'\\$&'));for(let X in Aa)(/checkbox/i.test(Aa[X].target.type)&&da.test(Aa[X].group)||/checkbox/i.test(Aa[X].target.type)&&
da.test(Aa[X].target.getAttribute('data-gina-form-element-group')))&&ib(h,Aa[X].target,Aa[X].group,!0)},qb=function(da,X){X=da.id.replace(/\-|_|@|#|\.|\[|\]/g,'\\$&');X=new RegExp(X);for(let ka in Aa)if(/checkbox|radio/i.test(Aa[ka].target.type)||(Aa[ka].target.disabled=!0,'undefined'==typeof h.rules[Aa[ka].name]&&(h.rules[Aa[ka].name]={}),h.rules[Aa[ka].name].exclude=!0),X.test(Aa[ka].group)||X.test(Aa[ka].target.getAttribute('data-gina-form-element-group').replace(/\-|_|@|#|\.|\[|\]/g,'\\$&')))Aa[ka].target.disabled=
!0,'undefined'==typeof h.rules[Aa[ka].name]&&(h.rules[Aa[ka].name]={}),/^(true|on)$/i.test(da.checked)?(Aa[ka].target.disabled=!1,h.rules[Aa[ka].name].exclude=!1):(Aa[ka].target.disabled=!0,h.rules[Aa[ka].name].exclude=!0);zb(da)},Mb=null,Ya=function(da,X,ka){X='undefined'!=typeof X&&X?!0:!1;ka='undefined'!=typeof ka&&ka?!0:!1;var va=da.checked,Ra=/^(true|false)$/i.test(da.value);Mb=document.getElementsByName(da.name);for(let Xa=0,eb=Mb.length;Xa<eb;++Xa)Mb[Xa].id!==da.id&&va&&(Mb[Xa].checked=!1,
Mb[Xa].removeAttribute('checked'),qb(Mb[Xa],!0));X?qb(da):(va&&'null'!=va&&'false'!=va&&''!=va?setTimeout(function(){ka?qb(da):(da.checked=!1,da.removeAttribute('checked'))},0):setTimeout(function(){ka?qb(da):(da.checked=!0,da.setAttribute('checked','checked'))},0),Ra&&(da.value=/^true$/.test(da.value)?!0:!1))};Z=0;for(ea=g.length;Z<ea;++Z){K=g[Z].getAttribute('type');if('undefined'==typeof g[Z].id||''==g[Z].id)g[Z].id=K+'-'+ba.v4(),g[Z].setAttribute('id',g[Z].id);if('undefined'!=typeof K&&/^checkbox$/i.test(K)){if(g[Z].disabled&&
-1<fa.indexOf(g[Z].id)||!g[Z].checked&&-1<fa.indexOf(g[Z].id)){K=new RegExp(g[Z].id.replace(/\-|_|@|#|\.|\[|\]/g,'\\$&'));for(var cb in Aa)K.test(Aa[cb].group)&&(Aa[cb].target.disabled=!0)}R='change.'+g[Z].id;K=function(da,X){addListener(gina,da,X,function(ka){Cb(ka.target);triggerEvent(gina,ka.target,'changed.'+ka.target.id)});Cb(da,!0)};'undefined'!=typeof gina.events[R]&&gina.events[R]==g[Z].id&&removeListener(gina,g[Z],R);K(g[Z],R)}else'undefined'!=typeof K&&/^radio$/i.test(K)&&(R=g[Z].id,K=function(da,
X){addListener(gina,da,X,function(ka){Ya(ka.target);triggerEvent(gina,ka.target,'changed.'+ka.target.id)});Ya(da,!0)},'undefined'!=typeof gina.events[R]&&gina.events[R]==g[Z].id&&removeListener(gina,g[Z],R),K(g[Z],R))}R='click';K=function(){var da=null;da='reset.'+l.id;'undefined'==typeof gina.events[da]&&addListener(gina,l,da,function(X){X.preventDefault();var ka=r.$forms[X.currentTarget.id||X.target.id];ka.target.dataset.ginaFormIsResetting=!0;S(ka);X=db(ka.target,ka.rules,!0);za(ka.target,X.fields,
...
(gina.validator.getFormById(this.id).submit(),cancelEvent(X))}}})};K();R='validate.'+b;K=function(){addListener(gina,l,R,function(da){cancelEvent(da);var X=h.eventData.error||h.eventData.validation||da.detail;F(da.target,X.fields||X.error,X.data);da=da.target.getAttribute('id');if('undefined'!=typeof X.isValid&&X.isValid()){var ka=r.$forms[da].target.getAttribute('data-gina-form-inherits-data')||null;ka&&(X.data=Q(X.data,JSON.parse(decodeURIComponent(ka))));r.$forms[da]?r.$forms[da].send(X.data):
h&&h.send(X.data)}})};'undefined'!=typeof gina.events[R]&&gina.events[R]=='validate.'+b&&removeListener(gina,h,R,K);K();cb=function(da,X){/^submit\./i.test(da)||(da='submit.'+da);addListener(gina,X,da,function(ka){cancelEvent(ka);var va={};ka={_length:0};var Ra=l.getAttribute('id'),Xa='undefined'!=typeof r.$forms[Ra]?r.$forms[Ra].rules:null;r.$forms[Ra].sent||(va=db(l,Xa),ka=va.fields,va=va.$fields,Xa=r.$forms[Ra].rules,0==ka._length?(delete ka._length,ka={error:[],isValid:function(){return!0},data:Na(ka)},
triggerEvent(gina,l,'validate.'+b,ka)):(b=l.getAttribute('id'),p=(Xa=l.getAttribute('data-gina-form-rule'))?Da(Xa.replace(/\-|\//g,'.')):Da(b.replace(/\-/g,'.')),r.$forms[Ra].isSubmitting=!0,r.$forms[Ra].isSending=!1,za(l,ka,va,p,function(eb){triggerEvent(gina,l,'validate.'+b,eb)})))})};fa=null;g=[];fa=[];K=null;fa=l.getElementsByTagName('button');if(0<fa.length)for(let da=0,X=fa.length;da<X;++da)'submit'==fa[da].type&&g.push(fa[da]);fa=l.getElementsByTagName('a');if(0<fa.length)for(let da=0,X=fa.length;da<
X;++da)fa[da].attributes.getNamedItem('data-gina-form-submit')?g.push(fa[da]):fa[da].getAttribute('id')||/gina\-popin/.test(fa[da].className)||gina.popinIsBinded||/gina\-link/.test(fa[da].className)||(K='link.'+ba.v4(),fa[da].id=K);K=null;Z=!1;for(let da=0,X=g.length;da<X;++da){fa=g[da];if(/button/i.test(fa.tagName)&&'undefined'!=typeof fa.type&&/submit/i.test(fa.type)||/a/i.test(fa.tagName)&&'undefined'!=typeof fa.dataset.ginaFormSubmit&&/^true$/i.test(fa.dataset.ginaFormSubmit)||/a/i.test(fa.parentNode.tagName)&&
'undefined'!=typeof fa.parentNode.dataset.ginaFormSubmit&&/^true$/i.test(fa.parentNode.dataset.ginaFormSubmit)){/a/i.test(fa.parentNode.tagName)&&(fa=fa.parentNode);if('undefined'==typeof fa.id||'undefined'!=typeof fa.id&&''==fa.id)fa.id='click.'+ba.v4(),fa.setAttribute('id',fa.id);/a/i.test(fa.tagName)&&'undefined'==typeof fa.form&&(fa.form={id:h.id});'undefined'==typeof fa.dataset.ginaFormSubmitTriggerFor&&'undefined'!=typeof r.$forms[h.id]&&'undefined'==typeof r.$forms[h.id].submitTrigger&&'undefined'!=
typeof fa.form.id&&h.id==fa.form.id&&(console.debug('attching submitTrigger: '+fa.id,'  form id: '+h.id),r.$forms[h.id].submitTrigger=h.submitTrigger=fa.id||fa.getAttribute('id'),fa.dataset.ginaFormSubmitTriggerFor=h.id)}'A'==fa.tagName&&(K=fa.getAttribute('onclick'),Z=fa.getAttribute('data-gina-form-submit'),K||Z?/return false/i.test(K)||Z||(K=/;$/.test(K)?K+'return false;':K+'; return false;'):fa.setAttribute('onclick','return false;'));fa.id?R=fa.id:(R='click.'+ba.v4(),fa.id=R,fa.setAttribute('id',
R));'undefined'!=typeof gina.events[R]&&gina.events[R]==fa.id||cb(R,fa)}R='submit';addListener(gina,l,R,function(da){var X=da.target,ka=X.getAttribute('id'),va=r.$forms[ka],Ra=h.binded;(va=(new DOMParser).parseFromString(X.innerHTML,'text/html').getElementById(va.submitTrigger))&&va.disabled&&cancelEvent(da);if('undefined'!=typeof da.defaultPrevented&&da.defaultPrevented)return!1;(q||Ra)&&cancelEvent(da);da={};Ra={_length:0};va='undefined'!=typeof gina.validator.$forms[ka]?gina.validator.$forms[ka].rules:
...
!/^(true|false)$/.test(X[Oa].value)&&(Ra[Xa]=!1):Ra[Xa]=X[Oa].value,da[Xa]=X[Oa],da[Xa].setAttribute('data-gina-form-errors',''));Ra._length=Ra.count();0==Ra._length?(delete Ra._length,da={error:[],isValid:function(){return!0},data:Na(Ra)},'undefined'!=typeof gina.events['submit.'+ka]?triggerEvent(gina,X,'submit.'+ka,da):triggerEvent(gina,X,'validate.'+ka,da)):(p=(va=X.getAttribute('data-gina-form-rule'))?Da(va.replace(/\-|\//g,'.')):Da(ka.replace(/\-/g,'.')),r.$forms[ka].isValidating=!0,za(X,Ra,
da,p,function(lb){r.$forms[ka].isValidating=!1;'undefined'!=typeof gina.events['submit.'+ka]?triggerEvent(gina,X,'submit.'+ka,lb):triggerEvent(gina,X,'validate.'+ka,lb)}))});r.$forms[b].binded=!0;/^(true)$/i.test(h.target.dataset.ginaFormLiveCheckEnabled&&0<h.rules.count())?(console.debug('silent validation mode on'),cb=db(h.target,h.rules),za(h.target,cb.fields,cb.$fields,h.rules,function(da){console.debug('silent validation result[isValid:'+da.isValid()+']: ',da);M&&U&&'undefined'!=typeof window.ginaToolbar&&
window.ginaToolbar&&(gina.forms.errors||(gina.forms.errors={}),window.ginaToolbar.update('forms',{id:b,errors:da.error}));Ka(h,da.isValid())})):/^(true)$/i.test(h.target.dataset.ginaFormLiveCheckEnabled)||Ka(h,!0)},Ka=function(l,g){$formInstance=null;l instanceof HTMLFormElement?(l=l.getAttribute('id'),$formInstance=r.$forms[l]):$formInstance=l;'undefined'==typeof $formInstance.submitTrigger?console.warn('This might be normal, so do not worry if this form is handled by your javascript: `'+$formInstance.id+
...
1<ka.length&&ka[ka.length-1]!=Ya&&(lb=!0);lb&&za(ob,Cb,zb,cb,function(Kb){r.$forms[sb].isValidating=!1;mb=Kb.isValid();M&&U&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&(gina.forms.errors||(gina.forms.errors={}),window.ginaToolbar.update('forms',{id:sb,errors:Kb.error||{}}));F(ob,Kb.error,Kb.data,Ya);Ka(ob,mb)})}});Pa[Ya][Ra](cb[Ya][Ra]);continue}else Pa[Ya][Ra](cb[Ya][Ra]);delete da[Ya]}catch(lb){if('conditions'==Ra)throw Error('[ ginaFormValidator ] could not evaluate `'+Ya+'->'+
...
q,p,R,K){var ha='';p='undefined'!=typeof p&&null!=p?p.replace(/[^A-Za-z0-9_-]/g,'_'):'';var Aa='undefined'!=typeof K&&null!=K?K:'',fa='undefined'!=typeof R&&null!=R?'-xhr':'';if(x){x=xb(x);q=xb(q);for(var ea in x)if('object'!=typeof x[ea]||Array.isArray(x[ea])||null===x[ea])if(Array.isArray(x[ea])){p+='-'+ea.replace(/[^A-Za-z0-9_-]/g,'_');var E=0<x[ea].length||'undefined'!=typeof q[ea]&&0<q[ea].length?'':' is-empty';ha+='<li class="gina-toolbar-collection">';ha+='<a href="#" class="gina-toolbar-key gina-toolbar'+
fa+'-folding-state-'+Ka(Aa,ea.replace(/[^A-Za-z0-9_-]/g,'_'))+E+'">'+ea+' <span>['+x[ea].length+']</span></a>';ha+='<ul class="gina-toolbar-collection">'+Lb(x[ea],q[ea],p,R,K)+'</ul>';ha+='</li>';p=p.substr(0,p.length-ea.length)}else E=null===q[ea]?'null':typeof q[ea],'undefined'==E?(ha+='<li class="gina-toolbar-key-value">',ha+='<span class="gina-toolbar-key gina-toolbar-key-added">'+ea+':</span> <span class="gina-toolbar-value gina-toolbar-value-type-is-'+E+'">'+x[ea]+'</span>'):(x[ea]!==q[ea]&&
...
'<li class="gina-toolbar-object">',ha+='<a href="#" class="gina-toolbar-key gina-toolbar'+fa+'-folding-state-'+Ka(Aa,ea.replace(/[^A-Za-z0-9_-]/g,'_'))+E+'">'+ea+' <span>{ }</span></a>',ha+='<ul class="gina-toolbar-object">'+db(x[ea],q[ea],p,R,K)+'</ul>',ha+='</li>',p=p.substr(0,p.length-ea.length);return ha}},Lb=function(x,q,p,R,K){var ha='';p='undefined'!=typeof p&&null!=p?p:'';var Aa='undefined'!=typeof K&&null!=K?K:'',fa='undefined'!=typeof R&&null!=R?'-xhr':'';q||=[];for(var ea=0,E=x.length;ea<
E;++ea)'object'!=typeof x[ea]||Array.isArray(x[ea])?Array.isArray(x[ea])?(p+='-'+ea,''==Aa&&(Aa=p),ha+='<li class="gina-toolbar-collection">',ha+='<a href="#" class="gina-toolbar-key gina-toolbar'+fa+'-folding-state-'+Ka(Aa,ea)+'">'+ea+'<span>[ ]</span></a>',ha+='<ul class="gina-toolbar-collection">'+Lb(x[ea],q[ea],p,R,K)+'</ul>',ha+='</li>',p=p.substr(0,p.length-ea.toString().length)):ha+='<li class="gina-toolbar-key-value"><span class="gina-toolbar-key">'+ea+':</span> <span class="gina-toolbar-value">'+
x[ea]+'</span></li>':(q[ea]||(q[ea]=x[ea]),p+='-'+ea,''==Aa&&(Aa=p),ha+='<li class="gina-toolbar-object">',ha+='<a href="#" class="gina-toolbar-key gina-toolbar'+fa+'-folding-state-'+Ka(Aa,ea)+'">'+ea+' <span>{ }</span></a>',ha+='<ul class="gina-toolbar-object">'+db(x[ea],q[ea],p,R,K)+'</ul>',ha+='</li>',p=p.substr(0,p.length-ea.toString().length-1));return ha},Vb=function(x,q,p,R,K,ha){p=null!=p?p.replace(/[^A-Za-z0-9_-]/g,'_'):'';var Aa='undefined'!=typeof R&&null!=R?'-xhr':'';x=xb(x);q=xb(q);ha||=
K;for(var fa in x){var ea=fa;if('object'!=typeof x[fa]||Array.isArray(x[fa])||null===x[fa])if(Array.isArray(x[fa])){var E=P('#gina-toolbar-view-'+p.substr(0,p.length-1));var oa=E.length?!0:!1;!oa||/^html/.test(p)?(E=P('.'+p),oa=p+fa.replace(/[^A-Za-z0-9_-]/g,'_')+'-',E.append('<li class="gina-toolbar-collection"><a href="#" class="gina-toolbar-key gina-toolbar'+Aa+'-folding-state-'+Ka(fa.replace(/[^A-Za-z0-9_-]/g,'_'),oa.substr(0,oa.length-1))+'">'+fa+' <span>['+x[fa].length+']</span></a><ul> '+Lb(x[fa],
q[fa],oa,E.find('li ul.'+p.substr(0,p.length-1)),ea)+'</ul></li>')):(oa=p+fa.replace(/[^A-Za-z0-9_-]/g,'_')+'-',E.find('li.'+p.substr(0,p.length-1)+' ul').append('<li class="gina-toolbar-collection"><a class="gina-toolbar-key gina-toolbar'+Aa+'-folding-state-'+Ka(fa.replace(/[^A-Za-z0-9_-]/g,'_'),oa.substr(0,oa.length-1))+'">'+fa+' <span>['+x[fa].length+']</span></a><ul>'+Lb(x[fa],q[fa],oa,E.find('li ul.'+p.substr(0,p.length-1)),ea)+'</ul></li>'));p+=fa.replace(/[^A-Za-z0-9_-]/g,'_')+'-';p=p.substr(0,
p.length-fa.length-1)}else if(ea=null===q[fa]?'null':typeof q[fa],'undefined'==ea)/\-$/.test(p)&&(p=p.substr(0,p.length-1)),p&&K.find('ul.'+p).append('<li class="gina-toolbar-key-value"><span class="gina-toolbar-key gina-toolbar-key-added">'+fa+':</span> <span class="gina-toolbar-value gina-toolbar-value-type-is-'+ea+'">'+x[fa]+'</span></li>');else if(x[fa]!==q[fa]){p||(p+=fa.replace(/[^A-Za-z0-9_-]/g,'_')+'-');try{K.find('ul.'+p).append('<li class="gina-toolbar-key-value gina-toolbar-is-overridden"><span class="gina-toolbar-key">'+
fa+':</span> <span class="gina-toolbar-value">'+q[fa]+'</span></li>'),K.find('ul.'+p).append('<li class="gina-toolbar-key-value"><span class="gina-toolbar-key">'+fa+':</span> <span class="gina-toolbar-value gina-toolbar-value-type-is-'+ea+'">'+x[fa]+'</span></li>')}catch(ra){throw Error('GinaToolbarError: `ul.'+p+'` not found');}}else!p||/^html\-properties/.test(p)?ha.find('.gina-toolbar-properties').append('<li class="gina-toolbar-key-value"><span class="gina-toolbar-key">'+fa+':</span> <span class="gina-toolbar-value gina-toolbar-value-type-is-'+
ea+'">'+x[fa]+'</span></li>'):ha.find('ul.'+p.substr(0,p.length-1)).append('<li class="gina-toolbar-key-value"><span class="gina-toolbar-key">'+fa+':</span> <span class="gina-toolbar-value gina-toolbar-value-type-is-'+ea+'">'+x[fa]+'</span></li>');else E=P('#gina-toolbar-view-'+p.substr(0,p.length-1)),(oa=E.length?!0:!1)?(oa=p+fa.replace(/[^A-Za-z0-9_-]/g,'_')+'-',E.find('ul.'+p.substr(0,p.length-1)).append('<li class="gina-toolbar-object"><a href="#" class="gina-toolbar-key gina-toolbar'+Aa+'-folding-state-'+
Ka(fa.replace(/[^A-Za-z0-9_-]/g,'_'),oa.substr(0,oa.length-1))+'">'+fa+' <span>{ }</span></a><ul class="gina-toolbar-object '+oa.substr(0,oa.length-1)+'"></ul></li>'),Vb(x[fa],q[fa],oa,R,E.find('ul.'+p.substr(0,p.length-1)),ha),p+=fa.replace(/[^A-Za-z0-9_-]/g,'_')+'-'):(p+=fa.replace(/[^A-Za-z0-9_-]/g,'_')+'-','params'==fa?(ea='<div id="gina-toolbar-view-'+p.substr(0,p.length-1)+'" class="gina-toolbar-section"><h2 class="gina-toolbar-section-title">'+p.substr(0,p.length-1)+'</h2><ul class="'+p.substr(0,
p.length-1)+'"></ul></div>',P('#gina-toolbar-view-html-properties').before(ea)):/^html/.test(p)||(ea='<div id="gina-toolbar-view-'+p.substr(0,p.length-1)+'" class="gina-toolbar-section"><h2 class="gina-toolbar-section-title">'+p.substr(0,p.length-1)+'</h2><ul class="'+p.substr(0,p.length-1)+'"></ul></div>',K.append(ea)),Vb(x[fa],q[fa],p,R,K.find('ul.'+p.substr(0,p.length-1)),ha)),p=p.substr(0,p.length-fa.length-1)}return ha.html()},ya=function(x){x=gina.hasPopinHandler?gina.popin.getActivePopin():
null;var q,p=(gina.hasPopinHandler?P('#'+x.id):P('body')).html().match(/404:\[(.+)\](.+)@(.+)"/gm);if(p){var R=0;for(q=p.length;R<q;++R){x=p[R].replace(/"(.*)|"/g,'');var K=x.match(/\[(.*)\]/g,'')[0].replace(/\[|\]/g,'');V.getRouteByUrl(x,K)}}fLen=V.notFound.count();if(0<fLen)for(f in V.notFound)console.warn('(x'+V.notFound[f].count+') '+f+' => '+V.notFound[f].message)},za=function(x,q,p,R,K,ha,Aa){if(!ha)return!1;for(var fa=K[R].attributes,ea,E=K[R].getAttribute('id')||K[R].id,oa=P('<div id="gina-toolbar-form-'+
E+'" class="gina-toolbar-section"><h2 class="gina-toolbar-section-title">'+E+'</h2><ul class="gina-toolbar-section-content gina-toolbar-code" style="display: none;"><li class="gina-toolbar-form-attributes"><h3 class="gina-toolbar-sub-section-title">'+'gina-toolbar-form-attributes'.replace(/gina-toolbar-form-/,'')+'</h3><ul class="gina-toolbar-code"></ul></li></ul></div>'),ra,ja,Z=null,Ga=0,Pa=fa.length;Ga<Pa;++Ga)ra=fa[Ga].name,ja=fa[Ga].nodeValue,/^method$/.test(ra)&&(ja=ja.toUpperCase()),/^class$/.test(ra)&&
/\s+/.test(ja)&&(ja='<ul><li>'+ja.replace(/\s+/g,'</li><li>')+'</li></ul>'),/^action$/.test(ra)&&((ea='undefined'!=typeof fa.method?fa.method.nodeValue:null)||console.warn('[ ToolbarFormHelper::UndefinedMethod : form `'+(E||void 0)+'` method attribute cannot be left undefined !'),ea=V.getRouteByUrl(ja,ea),'undefined'!=typeof ea&&ea||(ea={name:'not found',namespace:'not found',param:{control:'not found',file:'not found'}}),ja='<ul><li><span class="gina-toolbar-key">url</span><span class="gina-toolbar-value">'+
(ja||'#')+'</span></li><li><span class="gina-toolbar-key">route</span><span class="gina-toolbar-value">'+ea.name+'</span></li><li><span class="gina-toolbar-key">namespace</span><span class="gina-toolbar-value">'+(ea.namespace||'root controller')+'</span></li><li><span class="gina-toolbar-key">control</span><span class="gina-toolbar-value">'+ea.param.control+'</span></li><li><span class="gina-toolbar-key">file</span><span class="gina-toolbar-value">'+ea.param.file+'</span></li><ul>',Z='<li><span class="gina-toolbar-key">'+
ra+':</span><span class="gina-toolbar-value">'+ja+'</span></li>'),/^data-gina-form-event/.test(ra)?(ea='events',Z=oa.find('.gina-toolbar-form-attributes').find('.gina-toolbar-key-events').length?!0:!1,ra=ra.replace(/^data-gina-form-event-/,''),Z||oa.find('ul.gina-toolbar-section-content').append('<li class="gina-toolbar-form-'+ea+'"><h3 class="gina-toolbar-sub-section-title">'+ea+'</h3><ul class="gina-toolbar-code"></ul></li>'),Z='<li><span class="gina-toolbar-key">'+ra+':</span><span class="gina-toolbar-value">'+
ja+'</span></li>',oa.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-'+ea+' > ul').append(Z)):(/^action$/.test(ra)||(Z='<li><span class="gina-toolbar-key">'+ra+':</span><span class="gina-toolbar-value">'+ja+'</span></li>'),oa.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-attributes > ul').append(Z));fa=null;try{var $a=K[R].getAttribute('data-gina-form-rule');fa='undefined'!=typeof $a&&null!=$a?eval('gina.forms.rules.'+$a.replace(/-/g,'.')):eval('gina.forms.rules.'+
E.replace(/-/g,'.'))}catch(ib){}fa&&(ea='rules',oa.find('ul.gina-toolbar-section-content').append('<li class="gina-toolbar-form-'+ea+'"><h3 class="gina-toolbar-sub-section-title">'+ea+'</h3><ul class="gina-toolbar-properties">'+db(fa,fa,E,Aa,ea)+'</ul></li>'));p.append(oa);++R;R<ha&&za(x,q,p,R,K,ha,Aa)},l=function(x,q,p,R){var K=P('#gina-toolbar-form-'+x);$section=K.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-'+q+'> ul');if(0<$section.length){if(0==p.count())return K.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-'+
...
return ya}function ca(ya){var za=T();return function(){var l=ba(ya);if(za){var g=ba(this).constructor;l=Reflect.construct(l,arguments,g)}else l=l.apply(this,arguments);return!l||'object'!=typeof l&&'function'!=typeof l?r(this):l}}function Ea(ya,za,l){return Ea='undefined'!=typeof Reflect&&Reflect.get?Reflect.get:function(g,h,b){for(;!Object.prototype.hasOwnProperty.call(g,h)&&null!==(g=ba(g)););if(g)return h=Object.getOwnPropertyDescriptor(g,h),h.get?h.get.call(b):h.value},Ea(ya,za,l||ya)}function N(ya){if(ya){for(var za in N.prototype)ya[za]=
...
':'),x.ipv6uri=!0),x.pathNames=function(p,R){p=R.replace(/\/{2,9}/g,'/').split('/');'/'!=R.substr(0,1)&&0!==R.length||p.splice(0,1);'/'==R.substr(R.length-1,1)&&p.splice(p.length-1,1);return p}(0,x.path),x.queryKey=(h=x.query,b={},h.replace(/(?:^|&)([^&=]*)=?([^&]*)/g,function(p,R,K){R&&(b[R]=K)}),b),x}var J=Object.create(null);J.open='0';J.close='1';J.ping='2';J.pong='3';J.message='4';J.upgrade='5';J.noop='6';var S=Object.create(null);Object.keys(J).forEach(function(ya){S[J[ya]]=ya});for(var ta=
...
2]&&g--);var b=new ArrayBuffer(g),x=new Uint8Array(b);for(g=0;g<l;g+=4){var q=xa[ya.charCodeAt(g)];var p=xa[ya.charCodeAt(g+1)];var R=xa[ya.charCodeAt(g+2)];var K=xa[ya.charCodeAt(g+3)];x[h++]=q<<2|p>>4;x[h++]=(15&p)<<4|R>>2;x[h++]=(3&R)<<6|63&K}za=Qa(b,za)}else za={base64:!0,data:ya};za={type:'message',data:za}}else za=S[l]?1<ya.length?{type:S[l],data:ya.substring(1)}:{type:S[l]}:ta;return za},Qa=function(ya,za){return'blob'===za&&ya instanceof ArrayBuffer?new Blob([ya]):ya},La=String.fromCharCode(30);
...
N.prototype.emitReserved=N.prototype.emit;N.prototype.listeners=function(ya){return this._callbacks=this._callbacks||{},this._callbacks['$'+ya]||[]};N.prototype.hasListeners=function(ya){return!!this.listeners(ya).length};var Da='undefined'!=typeof self?self:'undefined'!=typeof window?window:Function('return this')(),Na=setTimeout,Ia=clearTimeout,Ja,Ua=function(ya){function za(g,h,b){var x;return P(this,za),(x=l.call(this,g)).description=h,x.context=b,x.type='TransportError',x}M(za,ya);var l=ca(za);
return za}(G(Error));ma=function(ya){function za(g){var h;return P(this,za),(h=l.call(this)).writable=!1,D(r(h),g),h.opts=g,h.query=g.query,h.readyState='',h.socket=g.socket,h}M(za,ya);var l=ca(za);return na(za,[{key:'onError',value:function(g,h,b){return Ea(ba(za.prototype),'emitReserved',this).call(this,'error',new Ua(g,h,b)),this}},{key:'open',value:function(){return'closed'!==this.readyState&&''!==this.readyState||(this.readyState='opening',this.doOpen()),this}},{key:'close',value:function(){return'opening'!==
...
za}(ma);var jb=function(ya){function za(g,h){var b;return P(this,za),D(r(b=l.call(this)),h),b.opts=h,b.method=h.method||'GET',b.uri=g,b.async=!1!==h.async,b.data=void 0!==h.data?h.data:null,b.create(),b}M(za,ya);var l=ca(za);return na(za,[{key:'create',value:function(){var g=this,h=O(this.opts,'agent','pfx','key','passphrase','cert','ca','ciphers','rejectUnauthorized','autoUnref');h.xdomain=!!this.opts.xd;h.xscheme=!!this.opts.xs;var b=this.xhr=new H(h);try{b.open(this.method,this.uri,this.async);
...
Da?'pagehide':'unload',w,!1);var Db='function'==typeof Promise&&'function'==typeof Promise.resolve?function(ya){return Promise.resolve().then(ya)}:function(ya,za){return za(ya,0)},rb=Da.WebSocket||Da.MozWebSocket,xb='undefined'!=typeof navigator&&'string'==typeof navigator.product&&'reactnative'===navigator.product.toLowerCase(),Ka={websocket:function(ya){function za(g){var h;return P(this,za),(h=l.call(this,g)).supportsBinary=!g.forceBase64,h}M(za,ya);var l=ca(za);return na(za,[{key:'doOpen',value:function(){if(this.check()){var g=
...
!1))),h.open(),h}M(za,ya);var l=ca(za);return na(za,[{key:'createTransport',value:function(g){var h=U({},this.opts.query);h.EIO=4;h.transport=g;this.id&&(h.sid=this.id);h=U({},this.opts.transportOptions[g],this.opts,{query:h,socket:this,hostname:this.hostname,secure:this.secure,port:this.port});return new Ka[g](h)}},{key:'open',value:function(){var g=this;if(this.opts.rememberUpgrade&&za.priorWebsocketSuccess&&-1!==this.transports.indexOf('websocket'))var h='websocket';else{if(0===this.transports.length)return void this.setTimeoutFn(function(){g.emitReserved('error',
...
value:function(g){function h(){K||(K=!0,fa(),R.close(),R=null)}function b(){Aa('transport closed')}function x(){Aa('socket closed')}function q(ea){R&&ea.name!==R.name&&h()}var p=this,R=this.createTransport(g),K=!1;za.priorWebsocketSuccess=!1;var ha=function(){K||(R.send([{type:'ping',data:'probe'}]),R.once('packet',function(ea){if(!K)if('pong'===ea.type&&'probe'===ea.data){if(p.upgrading=!0,p.emitReserved('upgrading',R),R)za.priorWebsocketSuccess='websocket'===R.name,p.transport.pause(function(){K||
'closed'!==p.readyState&&(fa(),p.setTransport(R),R.send([{type:'upgrade'}]),p.emitReserved('upgrade',R),R=null,p.upgrading=!1,p.flush())})}else ea=Error('probe error'),ea.transport=R.name,p.emitReserved('upgradeError',ea)}))},Aa=function(ea){ea=Error('probe error: '+ea);ea.transport=R.name;h();p.emitReserved('upgradeError',ea)},fa=function(){R.removeListener('open',ha);R.removeListener('error',Aa);R.removeListener('close',b);p.off('close',x);p.off('upgrading',q)};R.once('open',ha);R.once('error',
...
M.handler+'` could not be reached. You must expose it to the `window` do object before any call.');var Q=M.handler;delete M.handler;window[Q].apply(this,Object.values(M));M.handler=Q}else P[ba].apply(this,Object.values(M));M.call=ba}catch(T){console.error('BindingHelper encountered error while trying to execute `'+ba+'`'+T.stack||T)}P.process(V,na,U+1)}};return P}define('helpers/binding',[],function(){return BindingHelper});
...
function Domain(A,P){var V='undefined'!==typeof module&&module.exports?!1:!0,na=!1;V&&(na=!!window.MSInputMethodContext&&!!document.documentMode);'function'==typeof A&&(P=A,A=void 0);var U={filename:'../dist/public_suffix_list.dat',url:'https://publicsuffix.org/list/public_suffix_list.dat',alternativeUrl:'https://raw.githubusercontent.com/publicsuffix/list/master/public_suffix_list.dat',isCachingRequired:!1,isUpdating:!1},M=null,ba=null,Q=function(r,ca,Ea){if('undefined'==typeof ca)ca=U;else for(let N in U)'undefined'==
typeof ca[N]&&(ca[N]=U[N]);V||(ca.filename=__dirname+'/'+ca.filename);V&&ca.isCachingRequired&&(console.warn('[DOMAIN] `options.isCachingRequired` is only available for backend'),ca.isCachingRequired=!1);M=ca;if(Ea)return T(ca,function(N){N?Ea(N):(console.debug('[DOMAIN] PSL Loaded'),Ea(N,r))});T(ca);console.debug('[DOMAIN] PSL Loaded');return r},T=async function(r,ca){var Ea=V||r.isCachingRequired?r.url:r.filename,N='undefined'!=typeof r.isUpdating?r.isUpdating:!1,O=null;if(V)if(ba&&!N)ca(!1);else if(window.fetch){O=
N=null;try{N=await fetch(Ea),ba=O=await N.text()}catch(C){O=Error('[DOMAIN] Could not load PSL\n'+(C.stack||C.message||C));ca(O);return}r.isUpdating=!1;ca(!1)}else O=Error('[DOMAIN] Fetch API not supported'),ca(O);else{Ea=!1;if('undefined'!=typeof fs.accessSync)try{fs.accessSync(r.filename,fs.constants.F_OK),Ea=!0}catch(C){Ea=!1;try{fs.lstatSync(r.filename).isSymbolicLink()&&(Ea=!0)}catch(m){}}else Ea=fs.existsSync(r.filename);Ea||(r.isCachingRequired=!0);if(r.isCachingRequired){Ea='curl -o '+r.filename+
' '+r.url+' >/dev/null 2>&1';console.debug('[DOMAIN] Running: '+Ea);try{execSync(Ea)}catch(C){console.warn('[DOMAIN] could not fetch from `'+r.url+'`. Trying with `'+r.alternativeUrl+'`');Ea='curl -o '+r.filename+' '+r.alternativeUrl+' >/dev/null 2>&1';try{execSync(Ea)}catch(m){ca(m);return}}var D=!1;nIntervId=setInterval(()=>{if('undefined'!=typeof fs.accessSync)try{fs.accessSync(r.filename,fs.constants.F_OK),D=!0}catch(C){D=!1;try{fs.lstatSync(r.filename).isSymbolicLink()&&(D=!0)}catch(m){}}else D=
fs.existsSync(r.filename);D&&(clearInterval(nIntervId),ba=fs.readFileSync(r.filename).toString(),ca(!1))},200)}try{ba=fs.readFileSync(r.filename).toString(),ca&&ca(!1)}catch(C){console.warn('[DOMAIN] could not read from `'+r.filename+'`'),T(A,ca)}}},u=function(r){M.isUpdating=!0;T(M,r)},G={getRootDomain:function(r,ca){'undefined'==typeof ca&&(ca=!1);var Ea=!1,N=!1,O=r.replace(/^(.*):\/\/|\/(.*)/g,''),D=O.split(/\./g).reverse(),C=D.length?D.length-1:0,m=ba.replace(/\/\/\s*(.*)\n|^\s*\n/gm,'').split(/\n/).filter(function(z,
...
'undefined'!=typeof ia.withCredentials?ia.withCredentials:!1;H.onerror=function(Na,Ia){Qa={status:H.status,error:'Transaction error: might be due to the server CORS settings.\nPlease, check the console for more details.'};La=!0;m.eventData.error=Qa+'\n'+Ia;T(Qa,La);triggerEvent(gina,ua,'error.'+ma,Qa)};for(var Da in ia.headers)H.setRequestHeader(Da,ia.headers[Da]);H.onreadystatechange=function(Na){if(4==H.readyState)if(Na=null,/^2/.test(H.status))try{Na=H.responseText;var Ia=H.getResponseHeader('Content-Type'),
...
return}if('undefined'!=typeof Na.reload){document.location.reload();return}'undefined'!=typeof Na.popin&&'undefined'!=typeof Na.popin.close&&(xa.isRedirecting=!1,O(xa.name))}if(!Ja){GINA_ENV_IS_DEV&&T(Na);triggerEvent(gina,ua,'loaded.'+ma,Na);return}GINA_ENV_IS_DEV&&T(Na);triggerEvent(gina,$forms[0],'success.'+ma,Na)}GINA_ENV_IS_DEV&&T(Na)}catch(ab){La=!1,Na={status:422,error:ab.description||ab.stack},/application\/json/.test(H.getResponseHeader('Content-Type'))&&(Na.error=JSON.parse(H.responseText),
La=!0),m.eventData.error=Na,GINA_ENV_IS_DEV&&T(Na,La),triggerEvent(gina,ua,'error.'+ma,Na)}else La=!1,Na={status:H.status,error:H.responseText},/application\/json/.test(H.getResponseHeader('Content-Type'))&&(Na.error=JSON.parse(H.responseText),La=!0),m.eventData.error=Na,GINA_ENV_IS_DEV&&T(Na,La),triggerEvent(gina,ua,'error.'+ma,Na)};H.send();return{open:function(){var Na=!1;addListener(gina,ua,'loaded.'+ma,function(Ia){Ia.preventDefault();Na||(Na=!0,m.activePopinId=xa.id,Q(Ia,xa),Ea(xa.name))})}}}}
...
xa+'?version='+(new Date).getMilliseconds(),W[la].setAttribute('href',xa))}ia.isRedirecting?triggerEvent(gina,m.target,'loaded.'+ia.id,ia):triggerEvent(gina,m.target,'open.'+ia.id,ia);if(gina&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar)try{ginaToolbar.update('el-xhr',ia.id)}catch(ma){throw ma;}}}function r(W){var la=setupXhr();la.open('GET',W,!0);la.setRequestHeader('Content-Type','text/javascript');la.onload=function(){eval(la.response)};la.send()}function ca(W){var la=setupXhr();
la.open('GET',W,!0);la.setRequestHeader('Content-Type','text/css');la.onload=function(){eval(la.response)};la.send()}function Ea(W){var la='undefined'!=typeof W?S(W):J(this.id);if(!la)throw Error('Popin name `'+W+'` not found !');W=document.getElementById(la.id);var ia=la.parentScripts,xa=W.getElementsByTagName('script'),ma=la.parentStyles,ua=W.getElementsByTagName('link'),Ca=0,Qa=xa.length,La=gina.config.hostname.replace(/(https|http|):\/\//,'').replace(/:\d+$/,'');for(La=new RegExp(La+':\\d+|'+
La);Ca<Qa;++Ca){if('undefined'==typeof xa[Ca].src||''==xa[Ca].src)continue;let Da=xa[Ca].src.replace(/(https|http|):\/\//,'').replace(La,'');-1<ia.indexOf(Da)||r(xa[Ca].src)}Ca=0;for(Qa=ua.length;Ca<Qa;++Ca)'undefined'!=typeof ua[Ca].href&&''!=ua[Ca].href&&(ia=ua[Ca].href.replace(/(https|http|):\/\//,'').replace(La,''),-1<ma.indexOf(ia)||ca(ua[Ca].href));Q({target:W,type:'loaded.'+la.id},la);/gina-popin-is-active/.test(W.className)||(W.className+=' gina-popin-is-active');if(!C.options.useDialogMode||
...
W.appendChild(la)}document.body.appendChild(W);m.target=W;m.on=on;gina.popinContainer=m.id},F=function(W,la,ia){addListener(gina,W,'click',function(xa){cancelEvent(xa);triggerEvent(gina,la,ia)})},J=function(W){return'undefined'!=typeof m.$popins[W]?m.$popins[W]:null},S=function(W){var la=null,ia;for(ia in m.$popins)if(m.$popins[ia].name===W){la=m.$popins[ia];break}return la},ta=function(W,la){la=getElementsByAttribute('data-gina-popin-name');var ia=null,xa=null,ma=null,ua=null,Ca=null,Qa=null;Ca=
