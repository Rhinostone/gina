...
E?E.indexOf('!'):-1;if(-1<oa){var ra=E.substring(0,oa);E=E.substring(oa+1,E.length)}return[ra,E]}function gb(E,oa,ra,ja){var Z=null,Ga=oa?oa.name:null,Pa=E,$a=!0,ib='';E||($a=!1,E='_@r'+(K+=1));E=ab(E);Z=E[0];E=E[1];if(Z){Z=Ja(Z,Ga,ja);var Cb=S(q,Z)}if(E)if(Z)ib=ra?E:Cb&&Cb.normalize?Cb.normalize(E,function(qb){return Ja(qb,Ga,ja)}):-1===E.indexOf('!')?Ja(E,Ga,ja):E;else{ib=Ja(E,Ga,ja);E=ab(ib);Z=E[0];ib=E[1];ra=!0;var zb=ea.nameToUrl(ib)}ra=!Z||Cb||ra?'':'_unnormalized'+(ha+=1);return{prefix:Z,name:ib,
parentMap:oa,unnormalized:!!ra,url:zb,originalName:Pa,isDefine:$a,id:(Z?Z+'!'+ib:ib)+ra}}function Ub(E){var oa=E.id,ra=S(g,oa);ra||=g[oa]=new ea.Module(E);return ra}function Zb(E,oa,ra){var ja=E.id,Z=S(g,ja);if(!Q(q,ja)||Z&&!Z.defineEmitComplete)if(Z=Ub(E),Z.error&&'error'===oa)ra(Z.error);else Z.on(oa,ra);else'defined'===oa&&ra(q[ja])}function jb(E,oa){var ra=E.requireModules,ja=!1;if(oa)oa(E);else if(M(ra,function(Z){if(Z=S(g,Z))Z.error=E,Z.events.error&&(ja=!0,Z.emit('error',E))}),!ja)Da.onError(E)}
function Db(){Qa.length&&(M(Qa,function(E){var oa=E[0];'string'===typeof oa&&(ea.defQueueMap[oa]=!0);x.push(E)}),Qa=[])}function rb(E){delete g[E];delete h[E]}function xb(E,oa,ra){var ja=E.map.id;E.error?E.emit('error',E.error):(oa[ja]=!0,M(E.depMaps,function(Z,Ga){Z=Z.id;var Pa=S(g,Z);!Pa||E.depMatched[Ga]||ra[Z]||(S(oa,Z)?(E.defineDep(Ga,q[Z]),E.check()):xb(Pa,oa,ra))}),ra[ja]=!0)}function Ka(){var E,oa,ra=(E=1E3*l.waitSeconds)&&ea.startTime+E<(new Date).getTime(),ja=[],Z=[],Ga=!1,Pa=!0;if(!ya){ya=
...
baseUrl:'./',paths:{},bundles:{},pkgs:{},shim:{},config:{}},g={},h={},b={},x=[],q={},p={},R={},K=1,ha=1;var Aa={require:function(E){return E.require?E.require:E.require=ea.makeRequire(E.map)},exports:function(E){E.usingExports=!0;if(E.map.isDefine)return E.exports?q[E.map.id]=E.exports:E.exports=q[E.map.id]={}},module:function(E){return E.module?E.module:E.module={id:E.map.id,uri:E.map.url,config:function(){return S(l.config,E.map.id)||{}},exports:E.exports||(E.exports={})}}};var fa=function(E){this.events=
S(b,E.id)||{};this.map=E;this.shim=S(l.shim,E.id);this.depExports=[];this.depMaps=[];this.depMatched=[];this.pluginMaps={};this.depCount=0};fa.prototype={init:function(E,oa,ra,ja){ja=ja||{};if(!this.inited){this.factory=oa;if(ra)this.on('error',ra);else this.events.error&&(ra=r(this,function(Z){this.emit('error',Z)}));this.depMaps=E&&E.slice(0);this.errback=ra;this.inited=!0;this.ignore=ja.ignore;ja.enabled||this.enabled?this.enable():this.check()}},defineDep:function(E,oa){this.depMatched[E]||(this.depMatched[E]=
...
!1,!this.skipMap);this.depMaps[oa]=E;if(ra=S(Aa,E.id)){this.depExports[oa]=ra(this);return}this.depCount+=1;Zb(E,'defined',r(this,function(Z){this.undefed||(this.defineDep(oa,Z),this.check())}));this.errback?Zb(E,'error',r(this,this.errback)):this.events.error&&Zb(E,'error',r(this,function(Z){this.emit('error',Z)}))}ra=E.id;var ja=g[ra];Q(Aa,ra)||!ja||ja.enabled||ea.enable(E,this)}));u(this.pluginMaps,r(this,function(E){var oa=S(g,E.id);oa&&!oa.enabled&&ea.enable(E,this)}));this.enabling=!1;this.check()},
...
Ga||1<Z)){var Pa=ja.substring(Z,ja.length);ja=ja.substring(0,Z)}return ea.nameToUrl(Ja(ja,E&&E.id,!0),Pa,!0)},defined:function(ja){return Q(q,gb(ja,E,!1,!0).id)},specified:function(ja){ja=gb(ja,E,!1,!0).id;return Q(q,ja)||Q(g,ja)}});E||(ra.undef=function(ja){Db();var Z=gb(ja,E,!0),Ga=S(g,ja);Ga.undefed=!0;Ua(ja);delete q[ja];delete p[Z.url];delete b[ja];ba(x,function(Pa,$a){Pa[0]===ja&&x.splice($a,1)});delete ea.defQueueMap[ja];Ga&&(Ga.events.defined&&(b[ja]=Ga.events),rb(ja))});return ra},enable:function(E){S(g,
E.id)&&Ub(E).enable()},completeLoad:function(E){var oa=S(l.shim,E)||{},ra=oa.exports;for(Db();x.length;){var ja=x.shift();if(null===ja[0]){ja[0]=E;if(Z)break;var Z=!0}else ja[0]===E&&(Z=!0);db(ja)}ea.defQueueMap={};ja=S(g,E);if(!Z&&!Q(q,E)&&ja&&!ja.inited)if(!l.enforceDefine||ra&&Ea(ra))db([E,oa.deps||[],oa.exportsFn]);else return pb(E)?void 0:jb(N('nodefine','No define call for '+E,null,[E]));Ka()},nameToUrl:function(E,oa,ra){var ja,Z;(ja=S(l.pkgs,E))&&(E=ja);if(ja=S(R,E))return ea.nameToUrl(ja,
...
typeof M[0]&&null!=M[0]&&'undefined'!=typeof M[0][u]&&'object'==typeof ba[0]&&'undefined'!=typeof ba[0][u]){A=Array.isArray(ba)?Array.from(ba):JSON.clone(ba);var G=0;for(Q=A.length;G<Q;++G)S.push(A[G][u]);Q=JSON.clone(M);var r=0;G=0;M=Q.length;for(var da=N||0,Ea=ba.length;da<Ea;++da)a:for(G=G||0;G<M;++G)if(Q[G][u]===ba[da][u]){-1<S.indexOf(Q[G][u])?(A[r]=Q[G],++r):-1==S.indexOf(Q[G][u])&&(S.push(Q[G][u]),A[r]=Q[G],++r);break a}else-1==S.indexOf(Q[G][u])&&(S.push(Q[G][u]),A.push(Q[G]));return A}return Array.isArray(M)&&
...
for(M=A.length;G<M;++G)S.push(A[G][u]);for(G=0;G<M;++G)a:for(da=N||0,Ea=Q.length;da<Ea;++da)if(null!=Q[da]&&'undefined'!=typeof Q[da][u]&&Q[da][u]!==A[G][u]){if(-1==S.indexOf(Q[da][u])){A.push(Q[da]);S.push(Q[da][u]);N=da+1;M<Ea&&++M;break a}}else if(null!=Q[da]&&'undefined'!=typeof Q[da][u]&&Q[da][u]===A[G][u])N=da+1;else break a;return A}for(G=0;G<M.length;++G)if(S=null,'undefined'==typeof M||'object'!=typeof M[G]||Array.isArray(M[G])||null==M[G]||(S=Object.getOwnPropertyNames(M[G])),'undefined'!=
...
function handleXhr(A,P,V,na){if(!A)throw Error('No `xhr` object initiated');var U=null,M=null,ba=null,Q=null,S=null,u=V.$link||null,G=V.$form||null,r=null;delete V.$link;delete V.$form;G||u?u?(u.target=document.getElementById(u.id),r=gina.link.target,S=gina.link.id):(r=G.target,S=r.getAttribute('id')):(r=P,S=r.getAttribute('id'));var da=u&&P.getAttribute('data-gina-link-event-on-success')||u&&P.getAttribute('data-gina-link-event-on-error')?!0:!1,Ea=G&&r.getAttribute('data-gina-form-event-on-submit-success')||
...
G&&(G.eventData.error=O);u&&(u.eventData.error=O);window.ginaToolbar.update('data-xhr',O,!0);triggerEvent(gina,r,'error.'+S,O);Ea&&triggerEvent(gina,r,'error.'+S+'.hform',O);da&&triggerEvent(gina,r,'error.'+S+'.hlink',O)};A.onreadystatechange=function(O){O=/Google Inc/i.test(navigator.vendor)?50:0;2==A.readyState&&(M=/^attachment;/.test(A.getResponseHeader('Content-Disposition'))?!0:!1,!A.responseType&&M&&(A.responseType='blob'));if(4==A.readyState)if(U=null,ba=A.getResponseHeader('Content-Type'),
...
10]};return G.replace(/d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g,function(T){return T in J?J[T]:T.slice(1,T.length-1)})},countDaysTo:ba,getDaysTo:function(u,G,r){if(G instanceof Date){G=ba(u,G);var da=u.getMonth(),Ea=u.getFullYear();u=u.getDate()+1;u=new Date(Ea,da,u);da=[];for(Ea=0;Ea<G;++Ea)'undefined'!=typeof r?da.push((new Date(u)).format(r)):da.push(new Date(u)),u.setDate(u.getDate()+1);return da||[]}throw Error('dateTo is not instance of Date() !');},getDaysInMonth:function(u){var G=
...
'Failed to get mail content';T&&'undefined'!=typeof T.stack?J+=T.stack:'string'==typeof T&&(J+='\n'+T)});w.on('end',function(){if(/^\{/.test(F))try{F=JSON.parse(F),'undefined'!=typeof F.error&&(J=JSON.clone(F),F=null)}catch(T){J=T}J?z(J):z(!1,F)})},z?v.get(y,m,H):v.get(y,m))};/:/.test(da.url)&&(G=da.url.match(/(:(.*)\/|:(.*)$)/g).map(function(C){return C.replace(/\//g,'')}).join(', '),O='[ RoutingHelper::getRoute(rule[, bundle, method]) ] : route [ %r ] param placeholder not defined: `'+da.url+'` !\n Check your route description to compare requirements against param variables [ '+
G+']',O=O.replace(/%r/,u),console.warn(Error(O)));return da};P.getRouteByUrl=function(u,G,r,da,Ea){2==arguments.length&&'undefined'!=typeof arguments[1]&&arguments[1]&&-1<P.allowedMethods.indexOf(arguments[1].toLowerCase())&&(r=arguments[1],G=void 0);var N=null,O=null,D=null,C=null,m=null,z=null;if(/#/.test(u)&&1<u.length){var y=u.split(/#/);u=y[0];m='#'+y[1];y=null}1==arguments.length&&'undefined'!=typeof arguments[0]&&(/^(https|http)/i.test(u)||/^\//.test(u)||(u='/'+u),N='/'+u.split(/\//g)[1],A&&
(C=gina.config.reverseRouting,D=gina.config.routing),'undefined'!=typeof C[N]&&(y=D[C[N]],G=y.bundle,N=y.webroot,z=y.hostname,y=null));Ea='boolean'!=typeof arguments[arguments.length-1]?!1:arguments[arguments.length-1];var H=!1,v=null,w=null,F=v=w=null;y='undefined'!=typeof r?!0:!1;A?(v=window.gina.config,G='undefined'!=typeof G?G:v.bundle,w=v.env,D=D||v.getRouting(G),C=C||v.reverseRouting,isXMLRequest='undefined'!=typeof isXMLRequest?isXMLRequest:!1,z=z||v.hostname,N=N||v.webroot,da={routing:{},
method:r,params:{},url:u}):(v=getContext('gina').config,G='undefined'!=typeof G?G:v.bundle,w=v.env,D=v.getRouting(G),z=v.envConf[G][w].hostname,N=v.envConf[G][w].server.webroot,da||={routing:{},isXMLRequest:!1,method:'undefined'!=typeof r?r.toLowerCase():'get',params:{},url:u},Ea&&(da.method=r),isXMLRequest=da.isXMLRequest||!1);w=u.replace(new RegExp('^('+z+'|'+z.replace(/:\d+/,'')+')'),'');'undefined'==typeof da.routing.path&&(da.routing.path=decodeURI(w));r='undefined'!=typeof r?r.toLowerCase():
'get';y&&(da.originalMethod=da.method,da.method=r,da.routing.path=decodeURI(w));da.method||(da.method=r);v={};N=new RegExp(r,'i');C=null;var J;for(J in D){if('undefined'==typeof D[J].param)break;if(D[J].bundle==G&&(C=D[J].method,/,/.test(C)&&N.test(C)&&(C=da.method),'undefined'==typeof D[J].method||N.test(C))){v={method:C,requirements:D[J].requirements,namespace:D[J].namespace||void 0,url:decodeURI(w),rule:D[J].originalRule||J,param:D[J].param,middleware:JSON.clone(D[J].middleware),bundle:D[J].bundle,
isXMLRequest};try{if(F=P.compareUrls(v,D[J].url,da),F.past){O=JSON.clone(D[J]);O.name=J;H=!0;F={};break}}catch(T){throw Error('Route [ '+J+' ] needs your attention.\n'+T.stack);}}}if(H)return/\/$/.test(u)&&'/'!=u&&(u=u.substr(0,u.length-1)),m&&(u+=m),O.url=u,O.toUrl=function(T){var ta=this.webroot,Fa=this.hostname,W=this.url;this.url='undefined'!=typeof T&&1==T?W.replace(ta,'/'):W;return Fa+this.url},O;if(A){m=!1;if('#'==u&&/GET/i.test(r)&&y||/^404:/.test(u))u=location.pathname,m=!0;'undefined'==
typeof P.notFound&&(P.notFound={});D=null;O='[ RoutingHelper::getRouteByUrl(rule[, bundle, method]) ] : route [ %r ] is called but not found inside your view: `'+u+'` !';if((D=(D=gina.hasPopinHandler&&gina.popinIsBinded?gina.popin.getActivePopin().target.innerHTML.match(/404:\[\w+\][a-z 0-9-_@]+/):document.body.innerHTML.match(/404:\[\w+\][a-z 0-9-_@]+/))&&0<D.length?D[0]:null)&&y&&m)return m=D.match(/\[\w+\]/)[0],D=D.replace('404:'+m,m.replace(/\[|\]/g,'')+'::'),O=O.replace(/%r/,D.replace(/404:\s+/,
'')),'undefined'==typeof P.notFound[D]?P.notFound[D]={count:1,message:O}:y&&'undefined'!=typeof P.notFound[D]&&++P.notFound[D].count,!1;if((m=gina.config.reverseRouting[u]||null)&&'undefined'!=typeof m&&m.split(/@(.+)$/)[1]==G)return D=m,'undefined'==typeof P.notFound[D]?(O=O.replace(/%r/,r.toUpperCase()+'::'+m),P.notFound[D]={count:1,message:O}):y&&'undefined'!=typeof P.notFound[D]&&++P.notFound[D].count,!1;D=P.compareUrls(v,u,da)||null;D.past&&y&&(D=r.toUpperCase()+'::'+D.request.routing.rule,'undefined'==
typeof P.notFound[D]?O=O.replace(/%r/,D):++P.notFound[D].count);return!1}console.warn(Error('[ RoutingHelper::getRouteByUrl(rule[, bundle, method, request]) ] : route not found for url: `'+u+'` !').stack);return!1};return P}'undefined'!==typeof module&&module.exports?module.exports=Routing():'function'===typeof define&&define.amd&&define('lib/routing',['require','lib/form-validator','lib/merge'],function(){return Routing()});
...
typeof O&&'undefined'!=typeof O)throw Error('`options` must be an object');'undefined'==typeof O&&(O={});ba=na(O,ba);S=window.localStorage;O=ba.bucket;if(!S.getItem(O)&&void 0!=O)S.setItem(O,JSON.stringify(G));else if(void 0==O)throw Error('`bucket` name cannot be undefined');Q.bucket=O;Q=na(Q,da)})(A);return Q}
...
return ya}function da(ya){var za=S();return function(){var l=ba(ya);if(za){var g=ba(this).constructor;l=Reflect.construct(l,arguments,g)}else l=l.apply(this,arguments);return!l||'object'!=typeof l&&'function'!=typeof l?r(this):l}}function Ea(ya,za,l){return Ea='undefined'!=typeof Reflect&&Reflect.get?Reflect.get:function(g,h,b){for(;!Object.prototype.hasOwnProperty.call(g,h)&&null!==(g=ba(g)););if(g)return h=Object.getOwnPropertyDescriptor(g,h),h.get?h.get.call(b):h.value},Ea(ya,za,l||ya)}function N(ya){if(ya){for(var za in N.prototype)ya[za]=
...
fs.existsSync(r.filename);D&&(clearInterval(nIntervId),ba=fs.readFileSync(r.filename).toString(),da(!1))},200)}try{ba=fs.readFileSync(r.filename).toString(),da&&da(!1)}catch(C){console.warn('[DOMAIN] could not read from `'+r.filename+'`'),S(A,da)}}},u=function(r){M.isUpdating=!0;S(M,r)},G={getRootDomain:function(r,da){'undefined'==typeof da&&(da=!1);var Ea=!1,N=!1,O=r.replace(/^(.*):\/\/|\/(.*)/g,''),D=O.split(/\./g).reverse(),C=D.length?D.length-1:0,m=ba.replace(/\/\/\s*(.*)\n|^\s*\n/gm,'').split(/\n/).filter(function(z,
