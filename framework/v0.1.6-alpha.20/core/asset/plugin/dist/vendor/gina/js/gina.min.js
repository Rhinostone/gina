...
Ja,Ua,pb){Ja&&r(Ja,function(ab,gb){if(Ua||!Q(Ia,gb))!pb||'object'!==typeof ab||!ab||U(ab)||ma(ab)||ab instanceof RegExp?Ia[gb]=ab:(Ia[gb]||(Ia[gb]={}),G(Ia[gb],ab,Ua,pb))});return Ia}function w(Ia,Ja){return function(){return Ja.apply(Ia,arguments)}}function va(Ia){throw Ia;}function za(Ia){if(!Ia)return Ia;var Ja=B;N(Ia.split('.'),function(Ua){Ja=Ja[Ua]});return Ja}function O(Ia,Ja,Ua,pb){Ja=Error(Ja+'\nhttps://requirejs.org/docs/errors.html#'+Ia);Ja.requireType=Ia;Ja.requireModules=pb;Ua&&(Ja.originalError=
Ua);return Ja}function M(){if(y&&'interactive'===y.readyState)return y;ba(document.getElementsByTagName('script'),function(Ia){if('interactive'===Ia.readyState)return y=Ia});return y}var A,D,l,y,z,F,u,v=/\/\*[\s\S]*?\*\/|([^:"'=]|^)\/\/.*$/mg,H=/[^.]\s*require\s*\(\s*["']([^'"\s]+)["']\s*\)/g,J=/\.js$/,T=/^\.\//;var qa=Object.prototype;var Fa=qa.toString,W=qa.hasOwnProperty,ka=!('undefined'===typeof window||'undefined'===typeof navigator||!window.document),ha=!ka&&'undefined'!==typeof importScripts,
...
(ab=gb.context);(pb=S(ta,ab))||(pb=ta[ab]=Ea.s.newContext(ab));gb&&pb.configure(gb);return pb.require(Ia,Ja,Ua)};Ea.config=function(Ia){return Ea(Ia)};Ea.nextTick='undefined'!==typeof P?function(Ia){P(Ia,4)}:function(Ia){Ia()};require||=Ea;Ea.version='2.3.6';Ea.jsExtRegExp=/^\/|:|\?|\.js$/;Ea.isBrowser=ka;qa=Ea.s={contexts:ta,newContext:function(Ia){function Ja(E,na,ra){var ia;na=na&&na.split('/');var Z=m.map,Ga=Z&&Z['*'];if(E){E=E.split('/');var Pa=E.length-1;m.nodeIdCompat&&J.test(E[Pa])&&(E[Pa]=
...
!0;r(h,function($a){var ib=$a.map,Cb=ib.id;if($a.enabled&&(ib.isDefine||Z.push($a),!$a.error))if(!$a.inited&&ra)pb(Cb)?Ga=na=!0:(ia.push(Cb),Ua(Cb));else if(!$a.inited&&$a.fetched&&ib.isDefine&&(Ga=!0,!ib.prefix))return Pa=!1});if(ra&&ia.length)return E=O('timeout','Load timeout for modules: '+ia,null,ia),E.contextName=da.contextName,jb(E);Pa&&N(Z,function($a){xb($a,{},{})});ra&&!na||!Ga||!ka&&!ha||Aa||(Aa=P(function(){Aa=0;Ka()},50));ya=!1}}function db(E){Q(q,E[0])||Ub(gb(E[0],null,!0)).init(E[1],
E[2])}function Lb(E){E=E.currentTarget||E.srcElement;var na=da.onScriptLoad;E.detachEvent&&!la?E.detachEvent('onreadystatechange',na):E.removeEventListener('load',na,!1);na=da.onScriptError;E.detachEvent&&!la||E.removeEventListener('error',na,!1);return{node:E,id:E&&E.getAttribute('data-requiremodule')}}function Vb(){for(Db();x.length;){var E=x.shift();if(null===E[0])return jb(O('mismatch','Mismatched anonymous define() module: '+E[E.length-1]));db(E)}da.defQueueMap={}}var ya,Aa,m={waitSeconds:7,
...
qb&&(zb=qb);cb&&(La=!1);Ub(Ya);Q(m.config,na)&&(m.config[Mb]=m.config[na]);try{Ea.exec(zb)}catch(ca){return jb(O('fromtexteval','fromText eval for '+na+' failed: '+ca,ca,[na]))}cb&&(La=!0);this.depMaps.push(Ya);da.completeLoad(Mb);$a([Mb],Cb)});ia.load(E.name,$a,Cb,m)}}));da.enable(ra,this);this.pluginMaps[ra.id]=ra},enable:function(){h[this.map.id]=this;this.enabling=this.enabled=!0;N(this.depMaps,w(this,function(E,na){var ra;if('string'===typeof E){E=gb(E,this.map.isDefine?this.map:this.map.parentMap,
...
m.pkgs[Ga]=Z.name+'/'+(Z.main||'main').replace(T,'').replace(J,'')});r(g,function(Z,Ga){Z.inited||Z.map.unnormalized||(Z.map=gb(Ga,null,!0))});(E.deps||E.callback)&&da.require(E.deps||[],E.callback)},makeShimExports:function(E){return function(){var na;E.init&&(na=E.init.apply(B,arguments));return na||E.exports&&za(E.exports)}},makeRequire:function(E,na){function ra(ia,Z,Ga){var Pa;na.enableBuildCallback&&Z&&ma(Z)&&(Z.__requireJsBuild=!0);if('string'===typeof ia){if(ma(Z))return jb(O('requireargs',
'Invalid require call'),Ga);if(E&&Q(Ba,ia))return Ba[ia](g[E.id]);if(Ea.get)return Ea.get(da,ia,E,ra);var $a=gb(ia,E,!1,!0);$a=$a.id;return Q(q,$a)?q[$a]:jb(O('notloaded','Module name "'+$a+'" has not been loaded yet for context: '+Ia+(E?'':'. Use require([])')))}Vb();da.nextTick(function(){Vb();Pa=Ub(gb(null,E));Pa.skipMap=na.skipMap;Pa.init(ia,Z,Ga,{enabled:!0});Ka()});return ra}na=na||{};G(ra,{isBrowser:ka,toUrl:function(ia){var Z=ia.lastIndexOf('.'),Ga=ia.split('/')[0];if(-1!==Z&&('.'!==Ga&&'..'!==
...
0),importScripts(Ua),Ia.completeLoad(Ja)}catch(gb){Ia.onError(O('importscripts','importScripts failed for '+Ja+' at '+Ua,gb,[Ja]))}};ka&&!Da.skipDataMain&&ba(document.getElementsByTagName('script'),function(Ia){Na||(Na=Ia.parentNode);if(D=Ia.getAttribute('data-main'))return F=D,Da.baseUrl||-1!==F.indexOf('!')||(l=F.split('/'),F=l.pop(),u=l.length?l.join('/')+'/':'./',Da.baseUrl=u),F=F.replace(J,''),Ea.jsExtRegExp.test(F)&&(F=D),Da.deps=Da.deps?Da.deps.concat(F):[F],!0});define=function(Ia,Ja,Ua){var pb;
'string'!==typeof Ia&&(Ua=Ja,Ja=Ia,Ia=null);U(Ja)||(Ua=Ja,Ja=null);!Ja&&ma(Ua)&&(Ja=[],Ua.length&&(Ua.toString().replace(v,V).replace(H,function(gb,Ub){Ja.push(Ub)}),Ja=(1===Ua.length?['require']:['require','exports','module']).concat(Ja)));if(La&&(pb=z||M())){Ia||=pb.getAttribute('data-requiremodule');var ab=ta[pb.getAttribute('data-requirecontext')]}ab?(ab.defQueue.push([Ia,Ja,Ua]),ab.defQueueMap[Ia]=!0):Qa.push([Ia,Ja,Ua])};define.amd={jQuery:!0};Ea.exec=function(Ia){return eval(Ia)};Ea(Da)}})(this,
'undefined'===typeof setTimeout?void 0:setTimeout);define('requireLib',function(){});
!function(B,P){'object'==typeof exports&&'undefined'!=typeof module?P(exports):'function'==typeof define&&define.amd?define('vendor/uuid',['exports'],P):P((B=B||self).uuid={})}(this,function(B){function P(){if(!r)throw Error('crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported');return r(G)}function V(l,y){y=y||0;var z=za;return[z[l[y++]],z[l[y++]],z[l[y++]],z[l[y++]],'-',z[l[y++]],z[l[y++]],'-',z[l[y++]],z[l[y++]],'-',z[l[y++]],z[l[y++]],'-',z[l[y++]],
z[l[y++]],z[l[y++]],z[l[y++]],z[l[y++]],z[l[y++]]].join('')}function ma(l,y,z){var F=function(u,v,H,J){J=H&&J||0;if('string'==typeof u&&(u=function(T){T=unescape(encodeURIComponent(T));for(var qa=Array(T.length),Fa=0;Fa<T.length;Fa++)qa[Fa]=T.charCodeAt(Fa);return qa}(u)),'string'==typeof v&&(v=function(T){var qa=[];return T.replace(/[a-fA-F0-9]{2}/g,function(Fa){qa.push(parseInt(Fa,16))}),qa}(v)),!Array.isArray(u))throw TypeError('value must be an array of bytes');if(!Array.isArray(v)||16!==v.length)throw TypeError('namespace must be uuid string or an Array of 16 byte values');
u=z(v.concat(u));if(u[6]=15&u[6]|y,u[8]=63&u[8]|128,H)for(v=0;16>v;++v)H[J+v]=u[v];return H||V(u)};try{F.name=l}catch(u){}return F.DNS='6ba7b810-9dad-11d1-80b4-00c04fd430c8',F.URL='6ba7b811-9dad-11d1-80b4-00c04fd430c8',F}function U(l,y){var z=(65535&l)+(65535&y);return(l>>16)+(y>>16)+(z>>16)<<16|65535&z}function N(l,y,z,F,u,v){return U((H=U(U(y,l),U(F,v)))<<(J=u)|H>>>32-J,z);var H,J}function ba(l,y,z,F,u,v,H){return N(y&z|~y&F,l,y,u,v,H)}function Q(l,y,z,F,u,v,H){return N(y&F|z&~F,l,y,u,v,H)}function S(l,
y,z,F,u,v,H){return N(z^(y|~F),l,y,u,v,H)}for(var r='undefined'!=typeof crypto&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto)||'undefined'!=typeof msCrypto&&'function'==typeof msCrypto.getRandomValues&&msCrypto.getRandomValues.bind(msCrypto),G=new Uint8Array(16),w,va,za=[],O=0;256>O;++O)za[O]=(O+256).toString(16).substr(1);var M=0,A=0;O=ma('v3',48,function(l){if('string'==typeof l){var y=unescape(encodeURIComponent(l));l=Array(y.length);for(var z=0;z<y.length;z++)l[z]=y.charCodeAt(z)}return function(F){var u,
v=[],H=32*F.length;for(u=0;u<H;u+=8){var J=F[u>>5]>>>u%32&255;J=parseInt('0123456789abcdef'.charAt(J>>>4&15)+'0123456789abcdef'.charAt(15&J),16);v.push(J)}return v}(function(F,u){F[u>>5]|=128<<u%32;F[14+(u+64>>>9<<4)]=u;var v=1732584193,H=-271733879,J=-1732584194,T=271733878;for(u=0;u<F.length;u+=16){var qa=v;var Fa=H;var W=J;var ka=T;v=ba(v,H,J,T,F[u],7,-680876936);T=ba(T,v,H,J,F[u+1],12,-389564586);J=ba(J,T,v,H,F[u+2],17,606105819);H=ba(H,J,T,v,F[u+3],22,-1044525330);v=ba(v,H,J,T,F[u+4],7,-176418897);
...
20,-373897302);v=Q(v,H,J,T,F[u+5],5,-701558691);T=Q(T,v,H,J,F[u+10],9,38016083);J=Q(J,T,v,H,F[u+15],14,-660478335);H=Q(H,J,T,v,F[u+4],20,-405537848);v=Q(v,H,J,T,F[u+9],5,568446438);T=Q(T,v,H,J,F[u+14],9,-1019803690);J=Q(J,T,v,H,F[u+3],14,-187363961);H=Q(H,J,T,v,F[u+8],20,1163531501);v=Q(v,H,J,T,F[u+13],5,-1444681467);T=Q(T,v,H,J,F[u+2],9,-51403784);J=Q(J,T,v,H,F[u+7],14,1735328473);H=Q(H,J,T,v,F[u+12],20,-1926607734);v=N(H^J^T,v,H,F[u+5],4,-378558);T=N(v^H^J,T,v,F[u+8],11,-2022574463);J=N(T^v^H,J,
T,F[u+11],16,1839030562);H=N(J^T^v,H,J,F[u+14],23,-35309556);v=N(H^J^T,v,H,F[u+1],4,-1530992060);T=N(v^H^J,T,v,F[u+4],11,1272893353);J=N(T^v^H,J,T,F[u+7],16,-155497632);H=N(J^T^v,H,J,F[u+10],23,-1094730640);v=N(H^J^T,v,H,F[u+13],4,681279174);T=N(v^H^J,T,v,F[u],11,-358537222);J=N(T^v^H,J,T,F[u+3],16,-722521979);H=N(J^T^v,H,J,F[u+6],23,76029189);v=N(H^J^T,v,H,F[u+9],4,-640364487);T=N(v^H^J,T,v,F[u+12],11,-421815835);J=N(T^v^H,J,T,F[u+15],16,530742520);H=N(J^T^v,H,J,F[u+2],23,-995338651);v=S(v,H,J,T,
...
J,T,v,F[u+9],21,-343485551);v=U(v,qa);H=U(H,Fa);J=U(J,W);T=U(T,ka)}return[v,H,J,T]}(function(F){var u,v=[];v[(F.length>>2)-1]=void 0;for(u=0;u<v.length;u+=1)v[u]=0;var H=8*F.length;for(u=0;u<H;u+=8)v[u>>5]|=(255&F[u/8])<<u%32;return v}(l),8*l.length))});var D=ma('v5',80,function(l){var y=[1518500249,1859775393,2400959708,3395469782],z=[1732584193,4023233417,2562383102,271733878,3285377520];if('string'==typeof l){var F=unescape(encodeURIComponent(l));l=Array(F.length);for(var u=0;u<F.length;u++)l[u]=
F.charCodeAt(u)}l.push(128);F=Math.ceil((l.length/4+2)/16);var v=Array(F);for(u=0;u<F;u++){v[u]=Array(16);for(var H=0;16>H;H++)v[u][H]=l[64*u+4*H]<<24|l[64*u+4*H+1]<<16|l[64*u+4*H+2]<<8|l[64*u+4*H+3]}v[F-1][14]=8*(l.length-1)/Math.pow(2,32);v[F-1][14]=Math.floor(v[F-1][14]);v[F-1][15]=8*(l.length-1)&4294967295;for(u=0;u<F;u++){l=Array(80);for(H=0;16>H;H++)l[H]=v[u][H];for(H=16;80>H;H++){var J=l[H-3]^l[H-8]^l[H-14]^l[H-16];l[H]=J<<1|J>>>31}J=z[0];var T=z[1],qa=z[2],Fa=z[3],W=z[4];for(H=0;80>H;H++){var ka=
Math.floor(H/20),ha=J<<5|J>>>27;a:{switch(ka){case 0:var xa=T&qa^~T&Fa;break a;case 1:xa=T^qa^Fa;break a;case 2:xa=T&qa^T&Fa^qa&Fa;break a;case 3:xa=T^qa^Fa;break a}xa=void 0}ka=ha+xa+W+y[ka]+l[H]>>>0;W=Fa;Fa=qa;qa=(T<<30|T>>>2)>>>0;T=J;J=ka}z[0]=z[0]+J>>>0;z[1]=z[1]+T>>>0;z[2]=z[2]+qa>>>0;z[3]=z[3]+Fa>>>0;z[4]=z[4]+W>>>0}return[z[0]>>24&255,z[0]>>16&255,z[0]>>8&255,255&z[0],z[1]>>24&255,z[1]>>16&255,z[1]>>8&255,255&z[1],z[2]>>24&255,z[2]>>16&255,z[2]>>8&255,255&z[2],z[3]>>24&255,z[3]>>16&255,z[3]>>
8&255,255&z[3],z[4]>>24&255,z[4]>>16&255,z[4]>>8&255,255&z[4]]});B.v1=function(l,y,z){z=y&&z||0;var F=y||[],u=(l=l||{}).node||w,v=void 0!==l.clockseq?l.clockseq:va;if(null==u||null==v){var H=l.random||(l.rng||P)();null==u&&(u=w=[1|H[0],H[1],H[2],H[3],H[4],H[5]]);null==v&&(v=va=16383&(H[6]<<8|H[7]))}H=void 0!==l.msecs?l.msecs:(new Date).getTime();var J=void 0!==l.nsecs?l.nsecs:A+1,T=H-M+(J-A)/1E4;if(0>T&&void 0===l.clockseq&&(v=v+1&16383),(0>T||H>M)&&void 0===l.nsecs&&(J=0),1E4<=J)throw Error("uuid.v1(): Can't create more than 10M uuids/sec");
M=H;A=J;va=v;l=(1E4*(268435455&(H+=122192928E5))+J)%4294967296;F[z++]=l>>>24&255;F[z++]=l>>>16&255;F[z++]=l>>>8&255;F[z++]=255&l;l=H/4294967296*1E4&268435455;F[z++]=l>>>8&255;F[z++]=255&l;F[z++]=l>>>24&15|16;F[z++]=l>>>16&255;F[z++]=v>>>8|128;F[z++]=255&v;for(v=0;6>v;++v)F[z+v]=u[v];return y||V(F)};B.v3=O;B.v4=function(l,y,z){z=y&&z||0;'string'==typeof l&&(y='binary'===l?Array(16):null,l=null);var F=(l=l||{}).random||(l.rng||P)();if(F[6]=15&F[6]|64,F[8]=63&F[8]|128,y)for(l=0;16>l;++l)y[z+l]=F[l];
...
typeof arguments[r]&&null!=(w=arguments[r])){if('object'!=typeof w){Q=w;break}if(Array.isArray(w)&&Array.isArray(Q))Q=ma(w,Q,S);else for(var za in w){Q||={name:null};var O=Q[za];var M=w[za];if(Q!==M)if(M&&(U(M)||(va=Array.isArray(M)))){var A=!1;if(va){va=!1;if(O&&Array.isArray(O))var D=O||[];else if(U(O)){D=O||{};Q[za]=D;continue}else D=[];B=D;D=ma(M,D,S);Q[za]=D}else{D=O&&U(O)?O:null;if(!D){A=!0;D={};for(var l in M)D[l]=M[l]}if(S){for(l in M)'undefined'!=typeof M[l]?Array.isArray(M[l])&&Array.isArray(D[l])?
D[l]=ma(M[l],D[l],S):D[l]=M[l]:Array.isArray(M[l])&&Array.isArray(D[l])&&(D[l]=ma(M[l],D[l],S));Q[za]=D}else{for(l in M)'undefined'==typeof D[l]?Array.isArray(M[l])&&Array.isArray(D[l])?D[l]=ma(M[l],D[l],S):D[l]=M[l]:Array.isArray(M[l])&&Array.isArray(D[l])&&(D[l]=ma(M[l],D[l],S));'boolean'==typeof O||A?A&&(Q[za]=D):Q[za]=V(D,M,S)}}}else void 0!==M&&(Q[za]='undefined'==typeof O||null==O||O===M||S?M:O)}}B=[];P=!1;return Q},ma=function(N,ba,Q){B=[];var S=[],r=V.getKeyComparison();if(/^true$/i.test(Q)){if('object'==
typeof N[0]&&null!=N[0]&&'undefined'!=typeof N[0][r]&&'object'==typeof ba[0]&&'undefined'!=typeof ba[0][r]){B=Array.isArray(ba)?Array.from(ba):JSON.clone(ba);var G=0;for(Q=B.length;G<Q;++G)S.push(B[G][r]);Q=JSON.clone(N);var w=0;G=0;N=Q.length;for(var va=O||0,za=ba.length;va<za;++va)a:for(G=G||0;G<N;++G)if(Q[G][r]===ba[va][r]){-1<S.indexOf(Q[G][r])?(B[w]=Q[G],++w):-1==S.indexOf(Q[G][r])&&(S.push(Q[G][r]),B[w]=Q[G],++w);break a}else-1==S.indexOf(Q[G][r])&&(S.push(Q[G][r]),B.push(Q[G]));return B}return Array.isArray(N)&&
...
var O=null;G=0;for(N=B.length;G<N;++G)S.push(B[G][r]);for(G=0;G<N;++G)a:for(va=O||0,za=Q.length;va<za;++va)if(null!=Q[va]&&'undefined'!=typeof Q[va][r]&&Q[va][r]!==B[G][r]){if(-1==S.indexOf(Q[va][r])){B.push(Q[va]);S.push(Q[va][r]);O=va+1;N<za&&++N;break a}}else if(null!=Q[va]&&'undefined'!=typeof Q[va][r]&&Q[va][r]===B[G][r])O=va+1;else break a;return B}for(G=0;G<N.length;++G)if(S=null,'undefined'==typeof N||'object'!=typeof N[G]||Array.isArray(N[G])||null==N[G]||(S=Object.getOwnPropertyNames(N[G])),
...
function handleXhr(B,P,V,ma){if(!B)throw Error('No `xhr` object initiated');var U=null,N=null,ba=null,Q=null,S=null,r=V.$link||null,G=V.$form||null,w=null;delete V.$link;delete V.$form;G||r?r?(r.target=document.getElementById(r.id),w=gina.link.target,S=gina.link.id):(w=G.target,S=w.getAttribute('id')):(w=P,S=w.getAttribute('id'));var va=r&&P.getAttribute('data-gina-link-event-on-success')||r&&P.getAttribute('data-gina-link-event-on-error')?!0:!1,za=G&&w.getAttribute('data-gina-form-event-on-submit-success')||
G&&w.getAttribute('data-gina-form-event-on-submit-error')?!0:!1;za&&G&&listenToXhrEvents(G,'form');P=P.getAttribute('enctype')||V.headers['Content-Type'];for(var O in V.headers)'Content-Type'==O&&'undefined'!=typeof P&&null!=P&&''!=P||B.setRequestHeader(O,V.headers[O]);B.withCredentials='undefined'!=typeof V.withCredentials?V.withCredentials:!1;B.onerror=function(M,A){M={status:B.status||500,error:'Transaction error: might be due to the server CORS settings.\nPlease, check the console for more details.'};
G&&(G.eventData.error=M);r&&(r.eventData.error=M);window.ginaToolbar.update('data-xhr',M,!0);triggerEvent(gina,w,'error.'+S,M);za&&triggerEvent(gina,w,'error.'+S+'.hform',M);va&&triggerEvent(gina,w,'error.'+S+'.hlink',M)};B.onreadystatechange=function(M){M=/Google Inc/i.test(navigator.vendor)?50:0;2==B.readyState&&(N=/^attachment;/.test(B.getResponseHeader('Content-Disposition'))?!0:!1,!B.responseType&&N&&(B.responseType='blob'));if(4==B.readyState)if(U=null,ba=B.getResponseHeader('Content-Type'),
...
'error.'+S+'.hlink',Q)}};B.onprogress=function(M){var A='0';M.lengthComputable&&(A=M.loaded/M.total,A=parseInt(100*A));M={status:100,progress:A};G&&(G.eventData.onprogress=M);triggerEvent(gina,w,'progress.'+S,M)};B.ontimeout=function(M){Q={status:408,error:'Request Timeout'};G&&(G.eventData.ontimeout=Q);triggerEvent(gina,w,'error.'+S,Q);za&&triggerEvent(gina,w,'error.'+S+'.hform',Q);va&&triggerEvent(gina,w,'error.'+S+'.hlink',Q)}}
...
return{setCulture:function(r,G){/\-/.test(G)?(V=G,ma=G.split(/\-/)[0]):ma=G;return this},format:function(r,G,w){var va=N[ma]||N.en,za=null;try{za=P(va.masks,U)}catch(T){P=(B='undefined'!==typeof module&&module.exports?!1:!0)?require('lib/merge'):require('./../lib/merge'),za=P(va.masks,U)}'undefined'!=typeof N[V]&&(va=N[V],'undefined'!=typeof N[V].mask&&(za=P(va.masks,U)));var O=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,
M=/[^-+\dA-Z]/g,A=function(T,qa){T=String(T);for(qa=qa||2;T.length<qa;)T='0'+T;return T};1!=arguments.length||'[object String]'!=Object.prototype.toString.call(r)||/\d/.test(r)||(G=r,r=void 0);r=r?new Date(r):new Date;if(isNaN(r))throw SyntaxError('invalid date');G=String(za[G]||G||za['default']);'UTC:'==G.slice(0,4)&&(G=G.slice(4),w=!0);var D=w?'getUTC':'get';za=r[D+'Date']();var l=r[D+'Day'](),y=r[D+'Month'](),z=r[D+'FullYear'](),F=r[D+'Hours'](),u=r[D+'Minutes'](),v=r[D+'Seconds']();D=r[D+'Milliseconds']();
var H=w?0:r.getTimezoneOffset(),J={d:za,dd:A(za),ddd:va.dayNames[l],dddd:va.dayNames[l+7],m:y+1,mm:A(y+1),mmm:va.monthNames[y],mmmm:va.monthNames[y+12],yy:String(z).slice(2),yyyy:z,h:F%12||12,hh:A(F%12||12),H:F,HH:A(F),M:u,MM:A(u),s:v,ss:A(v),l:A(D,3),L:A(D),t:12>F?'a':'p',tt:12>F?'am':'pm',T:12>F?'A':'P',TT:12>F?'AM':'PM',Z:w?'UTC':(String(r).match(O)||['']).pop().replace(M,''),o:(0<H?'-':'+')+A(100*Math.floor(Math.abs(H)/60)+Math.abs(H)%60,4),S:['th','st','nd','rd'][3<za%10?0:(10!=za%100-za%10)*
za%10]};return G.replace(/d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g,function(T){return T in J?J[T]:T.slice(1,T.length-1)})},countDaysTo:ba,getDaysTo:function(r,G,w){if(G instanceof Date){G=ba(r,G);var va=r.getMonth(),za=r.getFullYear();r=r.getDate()+1;r=new Date(za,va,r);va=[];for(za=0;za<G;++za)'undefined'!=typeof w?va.push((new Date(r)).format(w)):va.push(new Date(r)),r.setDate(r.getDate()+1);return va||[]}throw Error('dateTo is not instance of Date() !');},getDaysInMonth:function(r){var G=
...
c,e,k){if(ib(a)){var n,C,I=b.expando,Y=a.nodeType,pa=Y?b.cache:a,Ca=Y?a[I]:a[I]&&I;if(Ca&&pa[Ca]&&(k||pa[Ca].data)||void 0!==e||'string'!=typeof c)return Ca||=Y?a[I]=xb.pop()||b.guid++:I,pa[Ca]||(pa[Ca]=Y?{}:{toJSON:b.noop}),'object'!=typeof c&&'function'!=typeof c||(k?pa[Ca]=b.extend(pa[Ca],c):pa[Ca].data=b.extend(pa[Ca].data,c)),C=pa[Ca],k||(C.data||(C.data={}),C=C.data),void 0!==e&&(C[b.camelCase(c)]=e),'string'==typeof c?(n=C[c],null==n&&(n=C[b.camelCase(c)])):n=C,n}}function w(a,c,e){if(ib(a)){var k,
n,C=a.nodeType,I=C?b.cache:a,Y=C?a[b.expando]:b.expando;if(I[Y]){if(c&&(k=e?I[Y]:I[Y].data)){b.isArray(c)?c=c.concat(b.map(c,b.camelCase)):c in k?c=[c]:(c=b.camelCase(c),c=c in k?[c]:c.split(' '));for(n=c.length;n--;)delete k[c[n]];if(e?!r(k):!b.isEmptyObject(k))return}(e||(delete I[Y].data,r(I[Y])))&&(C?b.cleanData([a],!0):h.deleteExpando||I!=I.window?delete I[Y]:I[Y]=void 0)}}}function va(a,c,e,k){var n,C=1,I=20,Y=k?function(){return k.cur()}:function(){return b.css(a,c,'')},pa=Y(),Ca=e&&e[3]||
(b.cssNumber[c]?'':'px'),sa=(b.cssNumber[c]||'px'!==Ca&&+pa)&&Mb.exec(b.css(a,c));if(sa&&sa[3]!==Ca){Ca=Ca||sa[3];e=e||[];sa=+pa||1;do C=C||'.5',sa/=C,b.style(a,c,sa+Ca);while(C!==(C=Y()/pa)&&1!==C&&--I)}return e&&(sa=+sa||+pa||0,n=e[1]?sa+(e[1]+1)*e[2]:+e[2],k&&(k.unit=Ca,k.start=sa,k.end=n)),n}function za(a){var c='abbr article aside audio bdi canvas data datalist details dialog figcaption figure footer header hgroup main mark meter nav output picture progress section summary template time video'.split(' ');
a=a.createDocumentFragment();if(a.createElement)for(;c.length;)a.createElement(c.pop());return a}function O(a,c){var e,k,n=0,C='undefined'!=typeof a.getElementsByTagName?a.getElementsByTagName(c||'*'):'undefined'!=typeof a.querySelectorAll?a.querySelectorAll(c||'*'):void 0;if(!C)for(C=[],e=a.childNodes||a;null!=(k=e[n]);n++)!c||b.nodeName(k,c)?C.push(k):b.merge(C,O(k,c));return void 0===c||c&&b.nodeName(a,c)?b.merge([a],C):C}function M(a,c){for(var e,k=0;null!=(e=a[k]);k++)b._data(e,'globalEval',
!c||b._data(c[k],'globalEval'))}function A(a){X.test(a.type)&&(a.defaultChecked=a.checked)}function D(a,c,e,k,n){for(var C,I,Y,pa,Ca,sa,Sa,Va=a.length,yb=za(c),bb=[],Hb=0;Va>Hb;Hb++)if(I=a[Hb],I||0===I)if('object'===b.type(I))b.merge(bb,I.nodeType?[I]:I);else if(eb.test(I)){pa=pa||yb.appendChild(c.createElement('div'));Ca=(ja.exec(I)||['',''])[1].toLowerCase();Sa=Xa[Ca]||Xa._default;pa.innerHTML=Sa[1]+b.htmlPrefilter(I)+Sa[2];for(C=Sa[0];C--;)pa=pa.lastChild;if(!h.leadingWhitespace&&Ra.test(I)&&bb.push(c.createTextNode(Ra.exec(I)[0])),
!h.tbody)for(C=(I='table'!==Ca||Oa.test(I)?'<table>'!==Sa[1]||Oa.test(I)?0:pa:pa.firstChild)&&I.childNodes.length;C--;)b.nodeName(sa=I.childNodes[C],'tbody')&&!sa.childNodes.length&&I.removeChild(sa);b.merge(bb,pa.childNodes);for(pa.textContent='';pa.firstChild;)pa.removeChild(pa.firstChild);pa=yb.lastChild}else bb.push(c.createTextNode(I));pa&&yb.removeChild(pa);h.appendChecked||b.grep(O(bb,'input'),A);for(Hb=0;I=bb[Hb++];)if(k&&-1<b.inArray(I,k))n&&n.push(I);else if(Y=b.contains(I.ownerDocument,
I),pa=O(yb.appendChild(I),'script'),Y&&M(pa),e)for(C=0;I=pa[C++];)ua.test(I.type||'')&&e.push(I);return yb}function l(){return!0}function y(){return!1}function z(){try{return Ka.activeElement}catch(a){}}function F(a,c,e,k,n,C){var I,Y;if('object'==typeof c){'string'!=typeof e&&(k=k||e,e=void 0);for(Y in c)F(a,Y,e,k,c[Y],C);return a}if(null==k&&null==n?(n=e,k=e=void 0):null==n&&('string'==typeof e?(n=k,k=void 0):(n=k,k=e,e=void 0)),!1===n)n=y;else if(!n)return a;return 1===C&&(I=n,n=function(pa){return b().off(pa),
...
k;var n=b._data(a);a=b._data(c,n);var C=n.events;if(C)for(e in delete a.handle,a.events={},C)for(n=0,k=C[e].length;k>n;n++)b.event.add(c,e,C[e][n]);a.data&&(a.data=b.extend({},a.data))}}function T(a,c,e,k){c=Lb.apply([],c);var n,C,I,Y=0,pa=a.length,Ca=pa-1,sa=c[0],Sa=b.isFunction(sa);if(Sa||1<pa&&'string'==typeof sa&&!h.checkClone&&Ib.test(sa))return a.each(function(yb){var bb=a.eq(yb);Sa&&(c[0]=sa.call(this,yb,bb.html()));T(bb,c,e,k)});if(pa&&(I=D(c,a[0].ownerDocument,!1,a,k),n=I.firstChild,1===
I.childNodes.length&&(I=n),n||k)){var Va=b.map(O(I,'script'),v);for(C=Va.length;pa>Y;Y++)n=I,Y!==Ca&&(n=b.clone(n,!0,!0),C&&b.merge(Va,O(n,'script'))),e.call(a[Y],n,Y);if(C)for(I=Va[Va.length-1].ownerDocument,b.map(Va,H),Y=0;C>Y;Y++)n=Va[Y],ua.test(n.type||'')&&!b._data(n,'globalEval')&&b.contains(I,n)&&(n.src?b._evalUrl&&b._evalUrl(n.src):b.globalEval((n.text||n.textContent||n.innerHTML||'').replace(Xb,'')));I=n=null}return a}function qa(a,c,e){for(var k=c?b.filter(c,a):a,n=0;null!=(c=k[n]);n++)e||
1!==c.nodeType||b.cleanData(O(c)),c.parentNode&&(e&&b.contains(c.ownerDocument,c)&&M(O(c,'script')),c.parentNode.removeChild(c));return a}function Fa(a,c){a=b(c.createElement(a)).appendTo(c.body);c=b.css(a[0],'display');return a.detach(),c}function W(a){var c=Ka,e=Nb[a];return e||(e=Fa(a,c),'none'!==e&&e||(gc=(gc||b("<iframe frameborder='0' width='0' height='0'/>")).appendTo(c.documentElement),c=(gc[0].contentWindow||gc[0].contentDocument).document,c.write(),c.close(),e=Fa(a,c),gc.detach()),Nb[a]=
...
I)for(e in C=I.expand(C),delete a[k],C)e in a||(a[e]=C[e],c[e]=n);else c[k]=n}function Ja(a,c,e){var k,n=0,C=Ja.prefilters.length,I=b.Deferred().always(function(){delete Y.elem}),Y=function(){if(k)return!1;var Ca=Fc||La();Ca=Math.max(0,pa.startTime+pa.duration-Ca);for(var sa=1-(Ca/pa.duration||0),Sa=0,Va=pa.tweens.length;Va>Sa;Sa++)pa.tweens[Sa].run(sa);return I.notifyWith(a,[pa,sa,Ca]),1>sa&&Va?Ca:(I.resolveWith(a,[pa]),!1)},pa=I.promise({elem:a,props:b.extend({},c),opts:b.extend(!0,{specialEasing:{},
easing:b.easing._default},e),originalProperties:c,originalOptions:e,startTime:Fc||La(),duration:e.duration,tweens:[],createTween:function(Ca,sa){Ca=b.Tween(a,pa.opts,Ca,sa,pa.opts.specialEasing[Ca]||pa.opts.easing);return pa.tweens.push(Ca),Ca},stop:function(Ca){var sa=0,Sa=Ca?pa.tweens.length:0;if(k)return this;for(k=!0;Sa>sa;sa++)pa.tweens[sa].run(1);return Ca?(I.notifyWith(a,[pa,1,0]),I.resolveWith(a,[pa,Ca])):I.rejectWith(a,[pa,Ca]),this}});e=pa.props;for(Ia(e,pa.opts.specialEasing);C>n;n++)if(c=
...
function rb(a){return b.isWindow(a)?a:9===a.nodeType?a.defaultView||a.parentWindow:!1}var xb=[],Ka=B.document,db=xb.slice,Lb=xb.concat,Vb=xb.push,ya=xb.indexOf,Aa={},m=Aa.toString,g=Aa.hasOwnProperty,h={},b=function(a,c){return new b.fn.init(a,c)},x=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,q=/^-ms-/,p=/-([\da-z])/gi,R=function(a,c){return c.toUpperCase()};b.fn=b.prototype={jquery:'1.12.4',constructor:b,selector:'',length:0,toArray:function(){return db.call(this)},get:function(a){return null!=a?0>a?this[a+
...
isPlainObject:function(a){var c;if(!a||'object'!==b.type(a)||a.nodeType||b.isWindow(a))return!1;try{if(a.constructor&&!g.call(a,'constructor')&&!g.call(a.constructor.prototype,'isPrototypeOf'))return!1}catch(e){return!1}if(!h.ownFirst)for(c in a)return g.call(a,c);for(c in a);return void 0===c||g.call(a,c)},type:function(a){return null==a?a+'':'object'==typeof a||'function'==typeof a?Aa[m.call(a)]||'object':typeof a},globalEval:function(a){a&&b.trim(a)&&(B.execScript||function(c){B.eval.call(B,c)})(a)},
...
C)},guid:1,proxy:function(a,c){var e,k,n;return'string'==typeof c&&(n=a[c],c=a,a=n),b.isFunction(a)?(e=db.call(arguments,2),k=function(){return a.apply(c||this,e.concat(db.call(arguments)))},k.guid=a.guid=a.guid||b.guid++,k):void 0},now:function(){return+new Date},support:h});'function'==typeof Symbol&&(b.fn[Symbol.iterator]=xb[Symbol.iterator]);b.each('Boolean Number String Function Array Date RegExp Object Error Symbol'.split(' '),function(a,c){Aa['[object '+c+']']=c.toLowerCase()});var K=function(a){function c(L,
aa,oa,wa){var Ha,Ma,Ta,Za,Wa=aa&&aa.ownerDocument,kb=aa?aa.nodeType:9;if(oa=oa||[],'string'!=typeof L||!L||1!==kb&&9!==kb&&11!==kb)return oa;if(!wa&&((aa?aa.ownerDocument||aa:ac)!==tb&&Bc(aa),aa=aa||tb,fc)){if(11!==kb&&(Za=xd.exec(L)))if(Ha=Za[1])if(9===kb){if(!(Ma=aa.getElementById(Ha)))return oa;if(Ma.id===Ha)return oa.push(Ma),oa}else{if(Wa&&(Ma=Wa.getElementById(Ha))&&oc(aa,Ma)&&Ma.id===Ha)return oa.push(Ma),oa}else{if(Za[2])return Ac.apply(oa,aa.getElementsByTagName(L)),oa;if((Ha=Za[3])&&Pb.getElementsByClassName&&
aa.getElementsByClassName)return Ac.apply(oa,aa.getElementsByClassName(Ha)),oa}if(!(!Pb.qsa||bc[L+' ']||Tb&&Tb.test(L))){if(1!==kb){Wa=aa;var nb=L}else if('object'!==aa.nodeName.toLowerCase()){(Ta=aa.getAttribute('id'))?Ta=Ta.replace(yd,'\\$&'):aa.setAttribute('id',Ta=Ab);Za=Mc(L);Ha=Za.length;for(Ma=kd.test(Ta)?'#'+Ta:"[id='"+Ta+"']";Ha--;)Za[Ha]=Ma+' '+Va(Za[Ha]);nb=Za.join(',');Wa=Wc.test(L)&&sa(aa.parentNode)||aa}if(nb)try{return Ac.apply(oa,Wa.querySelectorAll(nb)),oa}catch(fb){}finally{Ta===
Ab&&aa.removeAttribute('id')}}}return hc(L.replace(Nc,'$1'),aa,oa,wa)}function e(){function L(oa,wa){return aa.push(oa+' ')>Fb.cacheLength&&delete L[aa.shift()],L[oa+' ']=wa}var aa=[];return L}function k(L){return L[Ab]=!0,L}function n(L){var aa=tb.createElement('div');try{return!!L(aa)}catch(oa){return!1}finally{aa.parentNode&&aa.parentNode.removeChild(aa)}}function C(L,aa){L=L.split('|');for(var oa=L.length;oa--;)Fb.attrHandle[L[oa]]=aa}function I(L,aa){var oa=aa&&L,wa=oa&&1===L.nodeType&&1===aa.nodeType&&
(~aa.sourceIndex||-2147483648)-(~L.sourceIndex||-2147483648);if(wa)return wa;if(oa)for(;oa=oa.nextSibling;)if(oa===aa)return-1;return L?1:-1}function Y(L){return function(aa){return'input'===aa.nodeName.toLowerCase()&&aa.type===L}}function pa(L){return function(aa){var oa=aa.nodeName.toLowerCase();return('input'===oa||'button'===oa)&&aa.type===L}}function Ca(L){return k(function(aa){return aa=+aa,k(function(oa,wa){for(var Ha,Ma=L([],oa.length,aa),Ta=Ma.length;Ta--;)oa[Ha=Ma[Ta]]&&(oa[Ha]=!(wa[Ha]=
oa[Ha]))})})}function sa(L){return L&&'undefined'!=typeof L.getElementsByTagName&&L}function Sa(){}function Va(L){for(var aa=0,oa=L.length,wa='';oa>aa;aa++)wa+=L[aa].value;return wa}function yb(L,aa,oa){var wa=aa.dir,Ha=oa&&'parentNode'===wa,Ma=Qb++;return aa.first?function(Ta,Za,Wa){for(;Ta=Ta[wa];)if(1===Ta.nodeType||Ha)return L(Ta,Za,Wa)}:function(Ta,Za,Wa){var kb,nb,fb,Jb=[Wb,Ma];if(Wa)for(;Ta=Ta[wa];){if((1===Ta.nodeType||Ha)&&L(Ta,Za,Wa))return!0}else for(;Ta=Ta[wa];)if(1===Ta.nodeType||Ha){if(fb=
Ta[Ab]||(Ta[Ab]={}),nb=fb[Ta.uniqueID]||(fb[Ta.uniqueID]={}),(kb=nb[wa])&&kb[0]===Wb&&kb[1]===Ma)return Jb[2]=kb[2];if(nb[wa]=Jb,Jb[2]=L(Ta,Za,Wa))return!0}}}function bb(L){return 1<L.length?function(aa,oa,wa){for(var Ha=L.length;Ha--;)if(!L[Ha](aa,oa,wa))return!1;return!0}:L[0]}function Hb(L,aa,oa,wa,Ha){for(var Ma,Ta=[],Za=0,Wa=L.length,kb=null!=aa;Wa>Za;Za++)(Ma=L[Za])&&(oa&&!oa(Ma,wa,Ha)||(Ta.push(Ma),kb&&aa.push(Za)));return Ta}function kc(L,aa,oa,wa,Ha,Ma){return wa&&!wa[Ab]&&(wa=kc(wa)),Ha&&
!Ha[Ab]&&(Ha=kc(Ha,Ma)),k(function(Ta,Za,Wa,kb){var nb,fb=[],Jb=[],cc=Za.length,Yb;if(!(Yb=Ta)){Yb=aa||'*';for(var ub=Wa.nodeType?[Wa]:Wa,tc=[],ic=0,qc=ub.length;qc>ic;ic++)c(Yb,ub[ic],tc);Yb=tc}Yb=!L||!Ta&&aa?Yb:Hb(Yb,fb,L,Wa,kb);ub=oa?Ha||(Ta?L:cc||wa)?[]:Za:Yb;if(oa&&oa(Yb,ub,Wa,kb),wa){var dc=Hb(ub,Jb);wa(dc,[],Wa,kb);for(Wa=dc.length;Wa--;)(nb=dc[Wa])&&(ub[Jb[Wa]]=!(Yb[Jb[Wa]]=nb))}if(Ta){if(Ha||L){if(Ha){dc=[];for(Wa=ub.length;Wa--;)(nb=ub[Wa])&&dc.push(Yb[Wa]=nb);Ha(null,ub=[],dc,kb)}for(Wa=
ub.length;Wa--;)(nb=ub[Wa])&&-1<(dc=Ha?Cc(Ta,nb):fb[Wa])&&(Ta[dc]=!(Za[dc]=nb))}}else ub=Hb(ub===Za?ub.splice(cc,ub.length):ub),Ha?Ha(null,Za,ub,kb):Ac.apply(Za,ub)})}function Gc(L){var aa,oa,wa=L.length,Ha=Fb.relative[L[0].type];var Ma=Ha||Fb.relative[' '];for(var Ta=Ha?1:0,Za=yb(function(nb){return nb===aa},Ma,!0),Wa=yb(function(nb){return-1<Cc(aa,nb)},Ma,!0),kb=[function(nb,fb,Jb){nb=!Ha&&(Jb||fb!==Bb)||((aa=fb).nodeType?Za(nb,fb,Jb):Wa(nb,fb,Jb));return aa=null,nb}];wa>Ta;Ta++)if(Ma=Fb.relative[L[Ta].type])kb=
[yb(bb(kb),Ma)];else{if(Ma=Fb.filter[L[Ta].type].apply(null,L[Ta].matches),Ma[Ab]){for(oa=++Ta;wa>oa&&!Fb.relative[L[oa].type];oa++);return kc(1<Ta&&bb(kb),1<Ta&&Va(L.slice(0,Ta-1).concat({value:' '===L[Ta-2].type?'*':''})).replace(Nc,'$1'),Ma,oa>Ta&&Gc(L.slice(Ta,oa)),wa>oa&&Gc(L=L.slice(oa)),wa>oa&&Va(L))}kb.push(Ma)}return bb(kb)}function lc(L,aa){var oa=0<aa.length,wa=0<L.length,Ha=function(Ma,Ta,Za,Wa,kb){var nb,fb,Jb=0,cc='0',Yb=Ma&&[],ub=[],tc=Bb,ic=Ma||wa&&Fb.find.TAG('*',kb),qc=Wb+=null==
tc?1:Math.random()||.1,dc=ic.length;for(kb&&(Bb=Ta===tb||Ta||kb);cc!==dc&&null!=(nb=ic[cc]);cc++){if(wa&&nb){var Xc=0;for(Ta||nb.ownerDocument===tb||(Bc(nb),Za=!fc);fb=L[Xc++];)if(fb(nb,Ta||tb,Za)){Wa.push(nb);break}kb&&(Wb=qc)}oa&&((nb=!fb&&nb)&&Jb--,Ma&&Yb.push(nb))}if(Jb+=cc,oa&&cc!==Jb){for(Xc=0;fb=aa[Xc++];)fb(Yb,ub,Ta,Za);if(Ma){if(0<Jb)for(;cc--;)Yb[cc]||ub[cc]||(ub[cc]=Yc.call(Wa));ub=Hb(ub)}Ac.apply(Wa,ub);kb&&!Ma&&0<ub.length&&1<Jb+aa.length&&c.uniqueSort(Wa)}return kb&&(Wb=qc,Bb=tc),Yb};
return oa?k(Ha):Ha}var wc,vb,hc,Bb,Ob,Rb,tb,jc,fc,Tb,ec,Sb,oc,Ab='sizzle'+1*new Date,ac=a.document,Wb=0,Qb=0,Hc=e(),pc=e(),bc=e(),uc=function(L,aa){return L===aa&&(Rb=!0),0},vc={}.hasOwnProperty,mc=[],Yc=mc.pop,zd=mc.push,Ac=mc.push,ld=mc.slice,Cc=function(L,aa){for(var oa=0,wa=L.length;wa>oa;oa++)if(L[oa]===aa)return oa;return-1},Ad=RegExp('[\\x20\\t\\r\\n\\f]+','g'),Nc=RegExp('^[\\x20\\t\\r\\n\\f]+|((?:^|[^\\\\])(?:\\\\.)*)[\\x20\\t\\r\\n\\f]+$','g'),Bd=RegExp('^[\\x20\\t\\r\\n\\f]*,[\\x20\\t\\r\\n\\f]*'),
...
'i')},Fd=/^(?:input|select|textarea|button)$/i,Gd=/^h\d$/i,Kc=/^[^{]+\{\s*\[native \w/,xd=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,Wc=/[+~]/,yd=/'|\\/g,xc=RegExp('\\\\([\\da-f]{1,6}[\\x20\\t\\r\\n\\f]?|([\\x20\\t\\r\\n\\f])|.)','ig'),yc=function(L,aa,oa){L='0x'+aa-65536;return L!==L||oa?aa:0>L?String.fromCharCode(L+65536):String.fromCharCode(L>>10|55296,1023&L|56320)},md=function(){Bc()};try{Ac.apply(mc=ld.call(ac.childNodes),ac.childNodes),mc[ac.childNodes.length].nodeType}catch(L){Ac={apply:mc.length?
function(aa,oa){zd.apply(aa,ld.call(oa))}:function(aa,oa){for(var wa=aa.length,Ha=0;aa[wa++]=oa[Ha++];);aa.length=wa-1}}}var Pb=c.support={};var Hd=c.isXML=function(L){return(L=L&&(L.ownerDocument||L).documentElement)?'HTML'!==L.nodeName:!1};var Bc=c.setDocument=function(L){var aa,oa;L=L?L.ownerDocument||L:ac;return L!==tb&&9===L.nodeType&&L.documentElement?(tb=L,jc=tb.documentElement,fc=!Hd(tb),(oa=tb.defaultView)&&oa.top!==oa&&(oa.addEventListener?oa.addEventListener('unload',md,!1):oa.attachEvent&&
...
Ha);for(;wa=wa.parentNode;)Wa.unshift(wa);for(wa=Ha;wa=wa.parentNode;)kb.unshift(wa);for(;Wa[Ma]===kb[Ma];)Ma++;return Ma?I(Wa[Ma],kb[Ma]):Wa[Ma]===ac?-1:kb[Ma]===ac?1:0},tb):tb};c.matches=function(L,aa){return c(L,null,null,aa)};c.matchesSelector=function(L,aa){if((L.ownerDocument||L)!==tb&&Bc(L),aa=aa.replace(Dd,"='$1']"),!(!Pb.matchesSelector||!fc||bc[aa+' ']||ec&&ec.test(aa)||Tb&&Tb.test(aa)))try{var oa=Sb.call(L,aa);if(oa||Pb.disconnectedMatch||L.document&&11!==L.document.nodeType)return oa}catch(wa){}return 0<
c(aa,tb,null,[L]).length};c.contains=function(L,aa){return(L.ownerDocument||L)!==tb&&Bc(L),oc(L,aa)};c.attr=function(L,aa){(L.ownerDocument||L)!==tb&&Bc(L);var oa=Fb.attrHandle[aa.toLowerCase()];oa=oa&&vc.call(Fb.attrHandle,aa.toLowerCase())?oa(L,aa,!fc):void 0;return void 0!==oa?oa:Pb.attributes||!fc?L.getAttribute(aa):(oa=L.getAttributeNode(aa))&&oa.specified?oa.value:null};c.error=function(L){throw Error('Syntax error, unrecognized expression: '+L);};c.uniqueSort=function(L){var aa,oa=[],wa=0,
Ha=0;if(Rb=!Pb.detectDuplicates,Ob=!Pb.sortStable&&L.slice(0),L.sort(uc),Rb){for(;aa=L[Ha++];)aa===L[Ha]&&(wa=oa.push(Ha));for(;wa--;)L.splice(oa[wa],1)}return Ob=null,L};var Zc=c.getText=function(L){var aa,oa='',wa=0;if(aa=L.nodeType)if(1===aa||9===aa||11===aa){if('string'==typeof L.textContent)return L.textContent;for(L=L.firstChild;L;L=L.nextSibling)oa+=Zc(L)}else{if(3===aa||4===aa)return L.nodeValue}else for(;aa=L[wa++];)oa+=Zc(aa);return oa};var Fb=c.selectors={cacheLength:50,createPseudo:k,
...
c.error(L[0]),L},PSEUDO:function(L){var aa,oa=!L[6]&&L[2];return Oc.CHILD.test(L[0])?null:(L[3]?L[2]=L[4]||L[5]||'':oa&&Ed.test(oa)&&(aa=Mc(oa,!0))&&(aa=oa.indexOf(')',oa.length-aa)-oa.length)&&(L[0]=L[0].slice(0,aa),L[2]=oa.slice(0,aa)),L.slice(0,3))}},filter:{TAG:function(L){var aa=L.replace(xc,yc).toLowerCase();return'*'===L?function(){return!0}:function(oa){return oa.nodeName&&oa.nodeName.toLowerCase()===aa}},CLASS:function(L){var aa=Hc[L+' '];return aa||(aa=new RegExp('(^|[\\x20\\t\\r\\n\\f])'+
L+'([\\x20\\t\\r\\n\\f]|$)'),Hc(L,function(oa){return aa.test('string'==typeof oa.className&&oa.className||'undefined'!=typeof oa.getAttribute&&oa.getAttribute('class')||'')}))},ATTR:function(L,aa,oa){return function(wa){wa=c.attr(wa,L);return null==wa?'!='===aa:aa?(wa+='','='===aa?wa===oa:'!='===aa?wa!==oa:'^='===aa?oa&&0===wa.indexOf(oa):'*='===aa?oa&&-1<wa.indexOf(oa):'$='===aa?oa&&wa.slice(-oa.length)===oa:'~='===aa?-1<(' '+wa.replace(Ad,' ')+' ').indexOf(oa):'|='===aa?wa===oa||wa.slice(0,oa.length+
1)===oa+'-':!1):!0}},CHILD:function(L,aa,oa,wa,Ha){var Ma='nth'!==L.slice(0,3),Ta='last'!==L.slice(-4),Za='of-type'===aa;return 1===wa&&0===Ha?function(Wa){return!!Wa.parentNode}:function(Wa,kb,nb){var fb,Jb;kb=Ma!==Ta?'nextSibling':'previousSibling';var cc=Wa.parentNode,Yb=Za&&Wa.nodeName.toLowerCase();nb=!nb&&!Za;var ub=!1;if(cc){if(Ma){for(;kb;){for(fb=Wa;fb=fb[kb];)if(Za?fb.nodeName.toLowerCase()===Yb:1===fb.nodeType)return!1;var tc=kb='only'===L&&!tc&&'nextSibling'}return!0}if(tc=[Ta?cc.firstChild:
...
fb.nodeType)||!++ub||(nb&&(ic=fb[Ab]||(fb[Ab]={}),qc=ic[fb.uniqueID]||(ic[fb.uniqueID]={}),qc[L]=[Wb,ub]),fb!==Wa)););return ub-=Ha,ub===wa||0===ub%wa&&0<=ub/wa}}},PSEUDO:function(L,aa){var oa,wa=Fb.pseudos[L]||Fb.setFilters[L.toLowerCase()]||c.error('unsupported pseudo: '+L);return wa[Ab]?wa(aa):1<wa.length?(oa=[L,L,'',aa],Fb.setFilters.hasOwnProperty(L.toLowerCase())?k(function(Ha,Ma){for(var Ta,Za=wa(Ha,aa),Wa=Za.length;Wa--;)Ta=Cc(Ha,Za[Wa]),Ha[Ta]=!(Ma[Ta]=Za[Wa])}):function(Ha){return wa(Ha,
0,oa)}):wa}},pseudos:{not:k(function(L){var aa=[],oa=[],wa=vb(L.replace(Nc,'$1'));return wa[Ab]?k(function(Ha,Ma,Ta,Za){var Wa;Ta=wa(Ha,null,Za,[]);for(Za=Ha.length;Za--;)(Wa=Ta[Za])&&(Ha[Za]=!(Ma[Za]=Wa))}):function(Ha,Ma,Ta){return aa[0]=Ha,wa(aa,null,Ta,oa),aa[0]=null,!oa.pop()}}),has:k(function(L){return function(aa){return 0<c(L,aa).length}}),contains:k(function(L){return L=L.replace(xc,yc),function(aa){return-1<(aa.textContent||aa.innerText||Zc(aa)).indexOf(L)}}),lang:k(function(L){return kd.test(L||
'')||c.error('unsupported lang: '+L),L=L.replace(xc,yc).toLowerCase(),function(aa){var oa;do if(oa=fc?aa.lang:aa.getAttribute('xml:lang')||aa.getAttribute('lang'))return oa=oa.toLowerCase(),oa===L||0===oa.indexOf(L+'-');while((aa=aa.parentNode)&&1===aa.nodeType);return!1}}),target:function(L){var aa=a.location&&a.location.hash;return aa&&aa.slice(1)===L.id},root:function(L){return L===jc},focus:function(L){return L===tb.activeElement&&(!tb.hasFocus||tb.hasFocus())&&!!(L.type||L.href||~L.tabIndex)},
...
button:function(L){var aa=L.nodeName.toLowerCase();return'input'===aa&&'button'===L.type||'button'===aa},text:function(L){var aa;return'input'===L.nodeName.toLowerCase()&&'text'===L.type&&(null==(aa=L.getAttribute('type'))||'text'===aa.toLowerCase())},first:Ca(function(){return[0]}),last:Ca(function(L,aa){return[aa-1]}),eq:Ca(function(L,aa,oa){return[0>oa?oa+aa:oa]}),even:Ca(function(L,aa){for(var oa=0;aa>oa;oa+=2)L.push(oa);return L}),odd:Ca(function(L,aa){for(var oa=1;aa>oa;oa+=2)L.push(oa);return L}),
lt:Ca(function(L,aa,oa){for(aa=0>oa?oa+aa:oa;0<=--aa;)L.push(aa);return L}),gt:Ca(function(L,aa,oa){for(oa=0>oa?oa+aa:oa;++oa<aa;)L.push(oa);return L})}};Fb.pseudos.nth=Fb.pseudos.eq;for(wc in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})Fb.pseudos[wc]=Y(wc);for(wc in{submit:!0,reset:!0})Fb.pseudos[wc]=pa(wc);Sa.prototype=Fb.filters=Fb.pseudos;Fb.setFilters=new Sa;var Mc=c.tokenize=function(L,aa){var oa,wa,Ha,Ma,Ta;if(Ma=pc[L+' '])return aa?0:Ma.slice(0);Ma=L;var Za=[];for(Ta=Fb.preFilter;Ma;){Wa&&
!(oa=Bd.exec(Ma))||(oa&&(Ma=Ma.slice(oa[0].length)||Ma),Za.push(wa=[]));var Wa=!1;(oa=Cd.exec(Ma))&&(Wa=oa.shift(),wa.push({value:Wa,type:oa[0].replace(Nc,' ')}),Ma=Ma.slice(Wa.length));for(Ha in Fb.filter)!(oa=Oc[Ha].exec(Ma))||Ta[Ha]&&!(oa=Ta[Ha](oa))||(Wa=oa.shift(),wa.push({value:Wa,type:Ha,matches:oa}),Ma=Ma.slice(Wa.length));if(!Wa)break}return aa?Ma.length:Ma?c.error(L):pc(L,Za).slice(0)};return vb=c.compile=function(L,aa){var oa,wa=[],Ha=[],Ma=bc[L+' '];if(!Ma){aa||=Mc(L);for(oa=aa.length;oa--;)Ma=
Gc(aa[oa]),Ma[Ab]?wa.push(Ma):Ha.push(Ma);Ma=bc(L,lc(Ha,wa));Ma.selector=L}return Ma},hc=c.select=function(L,aa,oa,wa){var Ha,Ma,Ta,Za,Wa,kb='function'==typeof L&&L,nb=!wa&&Mc(L=kb.selector||L);if(oa=oa||[],1===nb.length){if(Ma=nb[0]=nb[0].slice(0),2<Ma.length&&'ID'===(Ta=Ma[0]).type&&Pb.getById&&9===aa.nodeType&&fc&&Fb.relative[Ma[1].type]){if(aa=(Fb.find.ID(Ta.matches[0].replace(xc,yc),aa)||[])[0],!aa)return oa;kb&&(aa=aa.parentNode);L=L.slice(Ma.shift().value.length)}for(Ha=Oc.needsContext.test(L)?
0:Ma.length;Ha--&&(Ta=Ma[Ha],!Fb.relative[Za=Ta.type]);)if((Wa=Fb.find[Za])&&(wa=Wa(Ta.matches[0].replace(xc,yc),Wc.test(Ma[0].type)&&sa(aa.parentNode)||aa))){if(Ma.splice(Ha,1),L=wa.length&&Va(Ma),!L)return Ac.apply(oa,wa),oa;break}}return(kb||vb(L,nb))(wa,aa,!fc,oa,!aa||Wc.test(L)&&sa(aa.parentNode)||aa),oa},Pb.sortStable=Ab.split('').sort(uc).join('')===Ab,Pb.detectDuplicates=!!Rb,Bc(),Pb.sortDetached=n(function(L){return 1&L.compareDocumentPosition(tb.createElement('div'))}),n(function(L){return L.innerHTML=
"<a href='#'></a>",'#'===L.firstChild.getAttribute('href')})||C('type|href|height|width',function(L,aa,oa){return oa?void 0:L.getAttribute(aa,'type'===aa.toLowerCase()?1:2)}),Pb.attributes&&n(function(L){return L.innerHTML='<input/>',L.firstChild.setAttribute('value',''),''===L.firstChild.getAttribute('value')})||C('value',function(L,aa,oa){return oa||'input'!==L.nodeName.toLowerCase()?void 0:L.defaultValue}),n(function(L){return null==L.getAttribute('disabled')})||C('checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped',
function(L,aa,oa){var wa;return oa?void 0:!0===L[aa]?aa.toLowerCase():(wa=L.getAttributeNode(aa))&&wa.specified?wa.value:null}),c}(B);b.find=K;b.expr=K.selectors;b.expr[':']=b.expr.pseudos;b.uniqueSort=b.unique=K.uniqueSort;b.text=K.getText;b.isXMLDoc=K.isXML;b.contains=K.contains;var fa=function(a,c,e){for(var k=[],n=void 0!==e;(a=a[c])&&9!==a.nodeType;)if(1===a.nodeType){if(n&&b(a).is(e))break;k.push(a)}return k},Ba=function(a,c){for(var e=[];a;a=a.nextSibling)1===a.nodeType&&a!==c&&e.push(a);return e},
...
'string'==typeof a?N(a):b.extend({},a);var c,e,k,n,C=[],I=[],Y=-1,pa=function(){n=a.once;for(k=c=!0;I.length;Y=-1)for(e=I.shift();++Y<C.length;)!1===C[Y].apply(e[0],e[1])&&a.stopOnFalse&&(Y=C.length,e=!1);a.memory||(e=!1);c=!1;n&&(C=e?[]:'')},Ca={add:function(){return C&&(e&&!c&&(Y=C.length-1,I.push(e)),function Va(Sa){b.each(Sa,function(yb,bb){b.isFunction(bb)?a.unique&&Ca.has(bb)||C.push(bb):bb&&bb.length&&'string'!==b.type(bb)&&Va(bb)})}(arguments),e&&!c&&pa()),this},remove:function(){return b.each(arguments,
function(sa,Sa){for(var Va;-1<(Va=b.inArray(Sa,C,Va));)C.splice(Va,1),Y>=Va&&Y--}),this},has:function(sa){return sa?-1<b.inArray(sa,C):0<C.length},empty:function(){return C&&=[],this},disable:function(){return n=I=[],C=e='',this},disabled:function(){return!C},lock:function(){return n=!0,e||Ca.disable(),this},locked:function(){return!!n},fireWith:function(sa,Sa){return n||(Sa=Sa||[],Sa=[sa,Sa.slice?Sa.slice():Sa],I.push(Sa),c||pa()),this},fire:function(){return Ca.fireWith(this,arguments),this},fired:function(){return!!k}};
return Ca};b.extend({Deferred:function(a){var c=[['resolve','done',b.Callbacks('once memory'),'resolved'],['reject','fail',b.Callbacks('once memory'),'rejected'],['notify','progress',b.Callbacks('memory')]],e='pending',k={state:function(){return e},always:function(){return n.done(arguments).fail(arguments),this},then:function(){var C=arguments;return b.Deferred(function(I){b.each(c,function(Y,pa){var Ca=b.isFunction(C[Y])&&C[Y];n[pa[1]](function(){var sa=Ca&&Ca.apply(this,arguments);sa&&b.isFunction(sa.promise)?
sa.promise().progress(I.notify).done(I.resolve).fail(I.reject):I[pa[0]+'With'](this===k?I.promise():this,Ca?[sa]:arguments)})});C=null}).promise()},promise:function(C){return null!=C?b.extend(C,k):k}},n={};return k.pipe=k.then,b.each(c,function(C,I){var Y=I[2],pa=I[3];k[I[1]]=Y.add;pa&&Y.add(function(){e=pa},c[1^C][2].disable,c[2][2].lock);n[I[0]]=function(){return n[I[0]+'With'](this===n?k:this,arguments),this};n[I[0]+'With']=Y.fireWith}),k.promise(n),a&&a.call(n,n),n},when:function(a){var c=0,e=
db.call(arguments),k=e.length,n=1!==k||a&&b.isFunction(a.promise)?k:0,C=1===n?a:b.Deferred(),I=function(sa,Sa,Va){return function(yb){Sa[sa]=this;Va[sa]=1<arguments.length?db.call(arguments):yb;Va===pa?C.notifyWith(Sa,Va):--n||C.resolveWith(Sa,Va)}},Y;if(1<k){var pa=Array(k);var Ca=Array(k);for(Y=Array(k);k>c;c++)e[c]&&b.isFunction(e[c].promise)?e[c].promise().progress(I(c,Ca,pa)).done(I(c,Y,e)).fail(C.reject):--n}return n||C.resolveWith(Y,e),C.promise()}});var Pa;b.fn.ready=function(a){return b.ready.promise().done(a),
...
ca=function(a,c,e,k,n,C,I){var Y=0,pa=a.length,Ca=null==e;if('object'===b.type(e))for(Y in n=!0,e)ca(a,c,Y,e[Y],!0,C,I);else if(void 0!==k&&(n=!0,b.isFunction(k)||(I=!0),Ca&&(I?(c.call(a,k),c=null):(Ca=c,c=function(sa,Sa,Va){return Ca.call(b(sa),Va)})),c))for(;pa>Y;Y++)c(a[Y],e,I?k:k.call(a[Y],Y,c(a[Y],e)));return n?a:Ca?c.call(a):pa?c(a[0],e):C},X=/^(?:checkbox|radio)$/i,ja=/<([\w:-]+)/,ua=/^$|\/(?:java|ecma)script/i,Ra=/^\s+/;!function(){var a=Ka.createElement('div'),c=Ka.createDocumentFragment(),
...
var wb=/^(?:input|select|textarea)$/i,lb=/^key/,hb=/^(?:mouse|pointer|contextmenu|drag|drop)|click/,ob=/^(?:focusinfocus|focusoutblur)$/,sb=/^([^.]*)(?:\.(.+)|)/;b.event={global:{},add:function(a,c,e,k,n){var C,I,Y,pa,Ca,sa,Sa,Va;if(I=b._data(a)){e.handler&&(Y=e,e=Y.handler,n=Y.selector);e.guid||(e.guid=b.guid++);(C=I.events)||(C=I.events={});(Ca=I.handle)||(Ca=I.handle=function(Hb){return'undefined'==typeof b||Hb&&b.event.triggered===Hb.type?void 0:b.event.dispatch.apply(Ca.elem,arguments)},Ca.elem=
a);c=(c||'').match(Ga)||[''];for(I=c.length;I--;){var yb=sb.exec(c[I])||[];var bb=Va=yb[1];yb=(yb[2]||'').split('.').sort();bb&&(pa=b.event.special[bb]||{},bb=(n?pa.delegateType:pa.bindType)||bb,pa=b.event.special[bb]||{},sa=b.extend({type:bb,origType:Va,data:k,handler:e,guid:e.guid,selector:n,needsContext:n&&b.expr.match.needsContext.test(n),namespace:yb.join('.')},Y),(Sa=C[bb])||(Sa=C[bb]=[],Sa.delegateCount=0,pa.setup&&!1!==pa.setup.call(a,k,yb,Ca)||(a.addEventListener?a.addEventListener(bb,Ca,
!1):a.attachEvent&&a.attachEvent('on'+bb,Ca))),pa.add&&(pa.add.call(a,sa),sa.handler.guid||(sa.handler.guid=e.guid)),n?Sa.splice(Sa.delegateCount++,0,sa):Sa.push(sa),b.event.global[bb]=!0)}a=null}},remove:function(a,c,e,k,n){var C,I,Y,pa,Ca,sa,Sa,Va,yb=b.hasData(a)&&b._data(a);if(yb&&(Ca=yb.events)){c=(c||'').match(Ga)||[''];for(pa=c.length;pa--;)if(I=sb.exec(c[pa])||[],sa=Va=I[1],Sa=(I[2]||'').split('.').sort(),sa){var bb=b.event.special[sa]||{};sa=(k?bb.delegateType:bb.bindType)||sa;var Hb=Ca[sa]||
[];I=I[2]&&new RegExp('(^|\\.)'+Sa.join('\\.(?:.*\\.|)')+'(\\.|$)');for(Y=C=Hb.length;C--;){var kc=Hb[C];!n&&Va!==kc.origType||e&&e.guid!==kc.guid||I&&!I.test(kc.namespace)||k&&k!==kc.selector&&('**'!==k||!kc.selector)||(Hb.splice(C,1),kc.selector&&Hb.delegateCount--,bb.remove&&bb.remove.call(a,kc))}Y&&!Hb.length&&(bb.teardown&&!1!==bb.teardown.call(a,Sa,yb.handle)||b.removeEvent(a,sa,yb.handle),delete Ca[sa])}else for(sa in Ca)b.event.remove(a,sa+c[pa],e,k,!0);b.isEmptyObject(Ca)&&(delete yb.handle,
b._removeData(a,'events'))}},trigger:function(a,c,e,k){var n,C,I,Y,pa=[e||Ka],Ca=g.call(a,'type')?a.type:a;var sa=g.call(a,'namespace')?a.namespace.split('.'):[];if(I=n=e=e||Ka,3!==e.nodeType&&8!==e.nodeType&&!ob.test(Ca+b.event.triggered)&&(-1<Ca.indexOf('.')&&(sa=Ca.split('.'),Ca=sa.shift(),sa.sort()),C=0>Ca.indexOf(':')&&'on'+Ca,a=a[b.expando]?a:new b.Event(Ca,'object'==typeof a&&a),a.isTrigger=k?2:3,a.namespace=sa.join('.'),a.rnamespace=a.namespace?new RegExp('(^|\\.)'+sa.join('\\.(?:.*\\.|)')+
'(\\.|$)'):null,a.result=void 0,a.target||(a.target=e),c=null==c?[a]:b.makeArray(c,[a]),Y=b.event.special[Ca]||{},k||!Y.trigger||!1!==Y.trigger.apply(e,c))){if(!k&&!Y.noBubble&&!b.isWindow(e)){var Sa=Y.delegateType||Ca;for(ob.test(Sa+Ca)||(I=I.parentNode);I;I=I.parentNode)pa.push(I),n=I;n===(e.ownerDocument||Ka)&&pa.push(n.defaultView||n.parentWindow||B)}for(sa=0;(I=pa[sa++])&&!a.isPropagationStopped();)a.type=1<sa?Sa:Y.bindType||Ca,(n=(b._data(I,'events')||{})[a.type]&&b._data(I,'handle'))&&n.apply(I,
c),(n=C&&I[C])&&n.apply&&ib(I)&&(a.result=n.apply(I,c),!1===a.result&&a.preventDefault());if(a.type=Ca,!(k||a.isDefaultPrevented()||Y._default&&!1!==Y._default.apply(pa.pop(),c))&&ib(e)&&C&&e[Ca]&&!b.isWindow(e)){(n=e[C])&&(e[C]=null);b.event.triggered=Ca;try{e[Ca]()}catch(Va){}b.event.triggered=void 0;n&&(e[C]=n)}return a.result}},dispatch:function(a){a=b.event.fix(a);var c,e,k,n,C=db.call(arguments);var I=(b._data(this,'events')||{})[a.type]||[];var Y=b.event.special[a.type]||{};if(C[0]=a,a.delegateTarget=
this,!Y.preDispatch||!1!==Y.preDispatch.call(this,a)){var pa=b.event.handlers.call(this,a,I);for(I=0;(k=pa[I++])&&!a.isPropagationStopped();)for(a.currentTarget=k.elem,c=0;(n=k.handlers[c++])&&!a.isImmediatePropagationStopped();)a.rnamespace&&!a.rnamespace.test(n.namespace)||(a.handleObj=n,a.data=n.data,e=((b.event.special[n.origType]||{}).handle||n.handler).apply(k.elem,C),void 0!==e&&!1===(a.result=e)&&(a.preventDefault(),a.stopPropagation()));return Y.postDispatch&&Y.postDispatch.call(this,a),
a.result}},handlers:function(a,c){var e,k=[],n=c.delegateCount,C=a.target;if(n&&C.nodeType&&('click'!==a.type||isNaN(a.button)||1>a.button))for(;C!=this;C=C.parentNode||this)if(1===C.nodeType&&(!0!==C.disabled||'click'!==a.type)){var I=[];for(e=0;n>e;e++){var Y=c[e];var pa=Y.selector+' ';void 0===I[pa]&&(I[pa]=Y.needsContext?-1<b(pa,this).index(C):b.find(pa,this,null,[C]).length);I[pa]&&I.push(Y)}I.length&&k.push({elem:C,handlers:I})}return n<c.length&&k.push({elem:this,handlers:c.slice(n)}),k},fix:function(a){if(a[b.expando])return a;
...
function(a){this.parentNode&&this.parentNode.insertBefore(a,this.nextSibling)})},empty:function(){for(var a,c=0;null!=(a=this[c]);c++){for(1===a.nodeType&&b.cleanData(O(a,!1));a.firstChild;)a.removeChild(a.firstChild);a.options&&b.nodeName(a,'select')&&(a.options.length=0)}return this},clone:function(a,c){return a=null==a?!1:a,c=null==c?a:c,this.map(function(){return b.clone(this,a,c)})},html:function(a){return ca(this,function(c){var e=this[0]||{},k=0,n=this.length;if(void 0===c)return 1===e.nodeType?
e.innerHTML.replace(mb,''):void 0;if(!('string'!=typeof c||Gb.test(c)||!h.htmlSerialize&&Kb.test(c)||!h.leadingWhitespace&&Ra.test(c)||Xa[(ja.exec(c)||['',''])[1].toLowerCase()])){c=b.htmlPrefilter(c);try{for(;n>k;k++)e=this[k]||{},1===e.nodeType&&(b.cleanData(O(e,!1)),e.innerHTML=c);e=0}catch(C){}}e&&this.empty().append(c)},null,a,arguments.length)},replaceWith:function(){var a=[];return T(this,arguments,function(c){var e=this.parentNode;0>b.inArray(this,a)&&(b.cleanData(O(this)),e&&e.replaceChild(c,
...
c,e,k){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var n,C,I,Y=b.camelCase(c),pa=a.style;if(c=b.cssProps[Y]||(b.cssProps[Y]=ha(Y)||Y),I=b.cssHooks[c]||b.cssHooks[Y],void 0===e)return I&&'get'in I&&void 0!==(n=I.get(a,!1,k))?n:pa[c];if(C=typeof e,'string'===C&&(n=Mb.exec(e))&&n[1]&&(e=va(a,c,n),C='number'),null!=e&&e===e&&('number'===C&&(e+=n&&n[3]||(b.cssNumber[Y]?'':'px')),h.clearCloneStyle||''!==e||0!==c.indexOf('background')||(pa[c]='inherit'),!(I&&'set'in I&&void 0===(e=I.set(a,e,k)))))try{pa[c]=
...
1,Y&&Va.trigger('ajaxSend',[vb,sa]),2===lc)return vb;sa.async&&0<sa.timeout&&(I=B.setTimeout(function(){vb.abort('timeout')},sa.timeout));try{lc=1,pa.send(kc,e)}catch(Bb){if(!(2>lc))throw Bb;e(-1,Bb)}}else e(-1,'No Transport');return vb},getJSON:function(a,c,e){return b.get(a,c,e,'json')},getScript:function(a,c){return b.get(a,void 0,c,'script')}});b.each(['get','post'],function(a,c){b[c]=function(e,k,n,C){return b.isFunction(k)&&(C=C||n,n=k,k=void 0),b.ajax(b.extend({url:e,type:c,dataType:C,data:k,
...
k){var n,C=a.xhr(),I=++ae;if(C.open(a.type,a.url,a.async,a.username,a.password),a.xhrFields)for(n in a.xhrFields)C[n]=a.xhrFields[n];a.mimeType&&C.overrideMimeType&&C.overrideMimeType(a.mimeType);a.crossDomain||e['X-Requested-With']||(e['X-Requested-With']='XMLHttpRequest');for(n in e)void 0!==e[n]&&C.setRequestHeader(n,e[n]+'');C.send(a.hasContent&&a.data||null);c=function(Y,pa){if(c&&(pa||4===C.readyState))if(delete Tc[I],c=void 0,C.onreadystatechange=b.noop,pa)4!==C.readyState&&C.abort();else{var Ca=
...
''==B||null==B)B=[];if(!Array.isArray(B))throw Error('`new Collection([content] [, options] )`: `content` argument must be an Array !');B=B?JSON.clone(B):[];for(var w=[],va=V=0,za=B.length;va<za;++va)B[va]||(B[va]={}),B[va]._uuid=ma.v4(),w[V]=B[va]._uuid,++V;var O=B;O.setSearchOption=function(){if(!arguments.length)throw Error('searchOption cannot be left blank');if(3<arguments.length||3>arguments.length&&1<arguments.length)throw Error('argument length mismatch');var A=0,D=arguments.length;if(1==
...
ka=function(la,ta,Da,Qa,La){ta=ta.split(/\[\*\]/g);La=ta[0].replace(/\[\*\]/,'');Da=Da[La];ta=ta[1];/^\./.test(ta)&&(ta=ta.substr(1));La=0;if(Da)for(var Ea=0,Na=Da.length;Ea<Na&&!(qa=/\./.test(ta)?W(la,ta,Da[Ea],La):Fa(la,ta,Da[Ea],La,J),La=qa.matched,0<La);++Ea);return{matched:Qa+La}},ha;for(ha in z)if(z[ha]||(z[ha]={}),!/undefined|function/.test(typeof z[ha]))for(let la=0,ta=D.count();la<ta;++la){A=D[la];l=A.count();T=0;for(var xa in A){if('undefined'==typeof A[xa])throw Error('filter `'+xa+'` cannot be left undefined');
u=null===A[xa]||/(boolean|number)/.test(typeof A[xa])?A[xa]:A[xa].toLocaleLowerCase();qa=/\./.test(xa)?/\[\*\]/.test(xa)?ka(A[xa],xa,z[ha],T,0):W(A[xa],xa,z[ha],T):Fa(A[xa],xa,z[ha][xa],T,J);T=qa.matched}if(T==l)if(ba&&Q&&0>w.indexOf(z[ha]._uuid)||Q||!ba){if(!ba||ba&&0>F.indexOf(z[ha]._uuid)||Q)F[y]=z[ha],++y}else ba&&!Q&&0>F.indexOf(z[ha]._uuid)&&(F[y]=z[ha],++y)}}else F=B;S=null;F.insert=O.insert;F.notIn=O.notIn;F.find=this.find;F.update=O.update;F.replace=O.replace;F.or=O.or;F.findOne=O.findOne;
F.limit=O.limit;F.orderBy=O.orderBy;F.delete=O.delete;F.toRaw=O.toRaw;F.filter=O.filter;return F};O.findOne=function(){var A=null;'string'==typeof arguments[arguments.length-1]&&(delete arguments[arguments.length-1],--arguments.length);0<arguments.length&&(A=arguments);if('undefined'==typeof A||!A||'object'!=typeof A)throw Error('[ Collection ][ findOne ] `filters` argument must be defined: Array or Filter Object(s) expected');A=null;var D=Array.isArray(arguments[0])?arguments[0]:O.find.apply(this,
arguments)||[];0<D.length&&(A=D.limit(1).toRaw()[0]);return A};O.or=function(){arguments[arguments.length]=!0;++arguments.length;return O.find.apply(this,arguments)};O.limit=function(A){if('undefined'==typeof A||'number'!=typeof A)throw Error('[Collection::result->limit(resultLimit)] : `resultLimit` parametter must by a `number`');var D=Array.isArray(this)?this:JSON.clone(B);D=D.splice(0,A);D.insert=O.insert;D.update=O.update;D.replace=O.replace;D.notIn=O.notIn;D.findOne=O.findOne;D.orderBy=O.orderBy;
D.max=O.max;D.delete=O.delete;D.toRaw=O.toRaw;D.filter=O.filter;return D};O.notIn=function(){var A=null,D=null,l=!0;'string'==typeof arguments[arguments.length-1]&&(A=arguments[arguments.length-1],delete arguments[arguments.length-1],--arguments.length);'boolean'==typeof arguments[arguments.length-1]&&(l=arguments[arguments.length-1],delete arguments[arguments.length-1],--arguments.length);0<arguments.length&&(D=arguments);if('undefined'==typeof D||!D||'object'!=typeof D)throw Error('[ Collection ][ notIn ] `filters` argument must be defined: Array or Filter Object(s) expected');
var y=JSON.clone(Array.isArray(this)?this:B);if(Array.isArray(arguments[0]))var z=arguments[0];else Q=!0,z=O.find.apply(this,arguments)||[],Q=!1;if(0<z.length){if(l&&A&&'undefined'==typeof z[0]&&'undefined'==typeof z[0][A])throw Error('[ Collection ][ notIn ] `key` not valid');l&&!A&&'undefined'!=typeof z[0]._uuid?A='_uuid':'undefined'!=typeof z[0].id&&(A='id');if(!A||'undefined'==typeof z[0][A])throw Error('No comparison key defined !');var F=0,u=z.length,v=0,H,J=D.count(),T;if(l&&'undefined'!=typeof y[v]&&
...
++T}if(T){y.splice(v,1);break}}}A=y;A.notIn=O.notIn;A.limit=O.limit;A.find=O.find;A.findOne=O.findOne;A.insert=O.insert;A.replace=O.replace;A.update=O.update;A.orderBy=O.orderBy;A.max=O.max;A.delete=O.delete;A.toRaw=O.toRaw;A.filter=O.filter;return A};O.insert=function(A){if('object'!==typeof A)throw Error('filter must be an object');var D=Array.isArray(this)?this:B;A._uuid=ma.v4();D.push(A);D.limit=O.limit;D.find=O.find;D.findOne=O.findOne;D.update=O.update;D.replace=O.replace;D.orderBy=O.orderBy;
D.max=O.max;D.notIn=O.notIn;D.delete=O.delete;D.toRaw=O.toRaw;D.filter=O.filter;return D};O.update=function(){var A='_uuid',D,l=D=null;'string'==typeof arguments[arguments.length-1]&&(A=arguments[arguments.length-1],delete arguments[arguments.length-1],--arguments.length);'object'==typeof arguments[arguments.length-1]&&(l=arguments[arguments.length-1],delete arguments[arguments.length-1],--arguments.length);0<arguments.length&&(D=arguments);if('undefined'==typeof D||!D||'object'!=typeof D)throw Error('[ Collection ][ update ] `filters` argument must be defined: Array or Filter Object(s) expected');
if('undefined'==typeof l||!l||'object'!=typeof l)throw Error('[ Collection ][ update ] `set` argument must be defined: Object expected');var y=Array.isArray(arguments[0])?arguments[0]:O.find.apply(this,arguments)||[];D=Array.isArray(this)?this:JSON.clone(B);if(0<y.length){y=y.toRaw();for(var z=0,F=y.length;z<F;++z){y[z]=U(JSON.clone(l),y[z]);for(var u=0,v=D.length;u<v;++u)if('undefined'==typeof D[u][A]&&'_uuid'==A&&'undefined'!=typeof D[u].id&&(A='id'),D[u][A]==y[z][A]){D[u]=y[z];break}}}D.limit=
O.limit;D.find=O.find;D.findOne=O.findOne;D.insert=O.insert;D.update=O.update;D.replace=O.replace;D.orderBy=O.orderBy;D.max=O.max;D.notIn=O.notIn;D.delete=O.delete;D.toRaw=O.toRaw;D.filter=O.filter;return D};O.replace=function(){var A='_uuid',D,l=D=null;'string'==typeof arguments[arguments.length-1]&&(A=arguments[arguments.length-1],delete arguments[arguments.length-1],--arguments.length);'object'==typeof arguments[arguments.length-1]&&(l=arguments[arguments.length-1],delete arguments[arguments.length-
...
for(var z=0,F=y.length;z<F;++z){y[z]=JSON.clone(l);for(var u=0,v=D.length;u<v;++u){if('undefined'==typeof D[u][A]&&'_uuid'==A&&'undefined'!=typeof D[u].id)A='id';else if('undefined'==typeof D[u][A]&&'_uuid'==A)throw Error('No comparison key defined !');if(D[u][A]==y[z][A]){D[u]=y[z];break}}}}D.limit=O.limit;D.find=O.find;D.findOne=O.findOne;D.insert=O.insert;D.update=O.update;D.replace=O.replace;D.orderBy=O.orderBy;D.max=O.max;D.notIn=O.notIn;D.delete=O.delete;D.toRaw=O.toRaw;D.filter=O.filter;return D};
O['delete']=function(){var A=O.notIn.apply(this,arguments);A.limit=O.limit;A.find=O.find;A.findOne=O.findOne;A.insert=O.insert;A.update=O.update;A.replace=O.replace;A.orderBy=O.orderBy;A.max=O.max;A.notIn=O.notIn;A.toRaw=O.toRaw;A.filter=O.filter;A.delete=this.delete;return A};O.orderBy=function(){if('undefined'==typeof arguments||1>arguments.length)throw Error('[ Collection->orderBy(filter) ] where `filter` must not be empty or null');if(1==arguments.length)var A=arguments[0];else{A=Array(arguments.length);
for(var D=0,l=A.length;D<l;++D)A[D]=arguments[D]}D=Array.isArray(this)?this:JSON.clone(B);return M(A,D.toRaw())};O.max=function(){if('undefined'==typeof arguments||1>arguments.length)throw Error('[ Collection->max(filter) ] where `filter` must not be empty or null');if(1<arguments.length||Array.isArray(arguments[0])||'object'==typeof arguments[0]&&1<arguments[0].count())throw Error('[ Collection->max(filter) ] only accept one filter length, and fileter count must be equal to 1');var A=arguments[0];
try{var D=Object.keys(A)[0],l={};l[D]='desc';return O.find(A).orderBy(l).limit(1)[0][D]}catch(y){throw y;}};var M=function(A,D){if('object'!=typeof A)throw Error('`filter` parametter must be an object or an array');var l={},y=null,z=null,F=y=null;y=[];if(0==A.count())return null;l.asc=function(u,v){var H=v.map(function(J,T){var qa={};qa.index=T;qa[u]=J[u];return qa});H.sort(function(J,T){var qa=function(Fa,W){/^(true|false)$/i.test(Fa)&&(Fa=/true/i.test(Fa)?1:0);/^(true|false)$/i.test(W)&&(W=/true/i.test(W)?
1:0);return'string'==typeof Fa&&''!=Fa||'string'==typeof W?('number'==typeof Fa&&(Fa=''+Fa),'number'==typeof W&&(W=''+W),Fa.localeCompare(W,void 0,{sensitivity:'case',caseFirst:'upper'})):Fa>W?1:Fa<W?-1:0};return'object'==typeof J?qa(J[u],T[u]):qa(J,T)});return H.map(function(J,T,qa){return v[J.index]})};l.desc=function(u,v){return l.asc(u,v).reverse()};y=function(u,v){var H=[],J=[];if(Array.isArray(v))for(var T=0,qa=v.length;T<qa;++T)H[T]=Object.keys(v[T])[0],J[T]=v[T][H[T]];else for(qa in T=0,v)H[T]=
qa,J[T]=v[qa],++T;z=function(Fa,W,ka,ha,xa){var la='desc'==ha[xa]?1:0,ta,Da=ta=null;return'string'==typeof Fa[ka[xa]]&&''!=Fa[ka[xa]]?(ta=Fa[ka[xa]].localeCompare(W[ka[xa]]),0==la&&0!=ta?0>ta?-1:1:0!=ta?0>ta?1:-1:ka.length-1>xa?z(Fa,W,ka,ha,xa+1):0):'number'==typeof Fa[ka[xa]]||'number'==typeof W[ka[xa]]?(ta=(''+Fa[ka[xa]]).localeCompare(''+W[ka[xa]],void 0,{numeric:!0}),0==la&&0!=ta?0>ta?-1:1:0!=ta?0>ta?1:-1:ka.length-1>xa?z(Fa,W,ka,ha,xa+1):0):'boolean'==typeof Fa[ka[xa]]||'boolean'==typeof W[ka[xa]]?
('boolean'==typeof Fa[ka[xa]]&&(ta=Fa[ka[xa]]?1:0),'boolean'==typeof W[ka[xa]]&&(Da=W[ka[xa]]?1:0),ta>Da?0==la?1:-1:ta<Da?0==la?-1:1:ka.length-1>xa?z(Fa,W,ka,ha,xa+1):0):Fa[ka[xa]]>W[ka[xa]]?0==la?1:-1:Fa[ka[xa]]<W[ka[xa]]?0==la?-1:1:ka.length-1>xa?z(Fa,W,ka,ha,xa+1):0};return u.sort(function(Fa,W){return z(Fa,W,H,J,0)})};Array.isArray(A)||1<A.count()?y=y(D,A):(F=Object.keys(A)[0],y=A[F],y=l[y](F,D));y.find=O.find;y.findOne=O.findOne;y.limit=O.limit;y.notIn=O.notIn;y.insert=O.insert;y.update=O.update;
y.replace=O.replace;y.delete=O.delete;y.orderBy=O.orderBy;y.max=O.max;y.toRaw=O.toRaw;y.filter=O.filter;return y};O.toRaw=function(){for(var A=Array.isArray(this)?this.slice():B.slice(),D=0,l=A.length;D<l;++D)A[D]._uuid&&delete A[D]._uuid;return A};O.filter=function(A){if('undefined'==typeof A)throw Error('`filter` parametter must be a string or an array.');var D=Array.isArray(this)?this:B;if(!D.length)return[];var l=0,y=D.length,z=[],F=0;if(Array.isArray(A))for(var u,v=A.length,H;l<y;++l){H=!1;for(u=
0;u<v;++u)'undefined'!=typeof D[l][A[u]]&&('undefined'==typeof z[F]&&(z[F]={}),z[F][A[u]]=D[l][A[u]],H=!0);H&&++F}else for(;l<y;++l)'undefined'!=typeof D[l][A]&&('undefined'==typeof z[F]&&(z[F]={}),z[F][A]=D[l][A],++F);return JSON.clone(z)};return O}'undefined'!==typeof module&&module.exports?module.exports=Collection:'function'===typeof define&&define.amd&&define('lib/collection',[],function(){return Collection});
...
!1}(u=null!==u?!0:!1)?u&&'undefined'!=typeof v.isBoolean&&delete v.isBoolean:v.isBoolean=D(this.error||S.errorLabels.isBoolean,this);this.valid=u;0<v.count()&&(this.errors=v);return r[this.name]};r[l].isNumber=function(u,v){var H=this.value,J=!1,T=!0,qa=!0,Fa=r[this.name].errors||{};try{'string'==typeof H&&/,|\./g.test(H)?H=S.data[this.name]=this.value=parseFloat(H.replace(/,/g,'.').replace(/\s+/g,'')):'string'==typeof H&&''!=H&&(H=S.data[this.name]=this.value=parseInt(H.replace(/\s+/g,'')))}catch(ka){Fa.isNumber=
D(this.error||S.errorLabels.isNumber,this),this.valid=!1,0<Fa.count()&&(this.errors=Fa)}if(+H===+H&&(J=!0,!Fa.isRequired&&''!=H)){var W=H.toString().length;u&&'number'==typeof u&&W<u&&(T=!1,this.size=u);v&&'number'==typeof v&&W>v&&(qa=!1,this.size=v)}J&&T&&qa||(J||(Fa.isNumber=D(this.error||S.errorLabels.isNumber,this)),T&&qa||(T||(Fa.isNumberLength=D(this.error||S.errorLabels.isNumberMinLength,this)),qa||(Fa.isNumberLength=D(this.error||S.errorLabels.isNumberMaxLength,this)),u===v&&(Fa.isNumberLength=
...
function(u,v){var H=this.value,J=!1,T=!0,qa=!0,Fa=r[this.name].errors||{};+H===+H&&0===H%1&&(J=!0,Fa.isRequired||''==H||(u&&'number'==typeof u&&H.length<u&&(T=!1,this.size=u),v&&'number'==typeof v&&H.length>v&&(qa=!1,this.size=v)));J&&T&&qa||(J||(Fa.isInteger=D(this.error||S.errorLabels.isInteger,this)),T&&qa||(T||(Fa.isIntegerLength=D(this.error||S.errorLabels.isIntegerMinLength,this),J=!1),qa||(Fa.isIntegerLength=D(this.error||S.errorLabels.isIntegerMaxLength,this),J=!1),u===v&&(Fa.isIntegerLength=
...
/true/.test(u[v].value)?!0:!1:this.value=S.data[this.name]=u[v].value;this.valid=!0;break}}u='undefined'==typeof this.value||null==this.value||''==this.value||/^\s+/.test(this.value)?!1:!0;v=r[this.name].errors||{};u?u&&'undefined'!=typeof v.isRequired&&delete v.isRequired:v.isRequired=D(this.error||S.errorLabels.isRequired,this);this.valid=u;0<v.count()&&(this.errors=v);return r[this.name]};r[l].isString=function(u,v){var H=S.data[this.name]=this.value,J=!1,T=!0,qa=!0,Fa=r[this.name].errors||{};
'string'!=typeof H||Fa.isRequired||''==H||(J=!0,u&&'number'==typeof u&&H.length<u&&(T=!1,this.size=u),v&&'number'==typeof v&&H.length>v&&(qa=!1,this.size=v));J&&T&&qa||(!J&&Fa.isRequired&&''==H?(J=!1,Fa.isString=D(this.error||S.errorLabels.isString,this)):J||Fa.isRequired||(J=!0),T&&qa||(J=!1,T||(Fa.isStringLength=D(this.error||S.errorLabels.isStringMinLength,this)),qa||(Fa.isStringLength=D(this.error||S.errorLabels.isStringMaxLength,this)),u===v&&(Fa.isStringLength=D(this.error||S.errorLabels.isStringLength,
...
va.envConf[r][G].host,w.webroot=va.envConf[r][G].server.webroot;return w};P.compareUrls=async function(r,G,w,va,za){'undefined'==typeof w&&(w={routing:{}});if(/,/.test(G)){var O=0;G=G.split(/,/g);for(var M=G.length,A={past:!1,request:w};O<M&&!A.past;)A=await N(r,G[O],w,va,za),++O;return A}return await N(r,G,w,va,za)};var N=async function(r,G,w,va,za){var O=null;try{O=r.url.split(/\//)}catch(T){console.warn(T),O=['']}G=G.split(/\//);var M=0,A=0,D=G.length,l=0,y={},z=0,F=w.method.toLowerCase(),u='get';
try{u=r.method.toLowerCase()}catch(T){}var v=!1;if('undefined'!=typeof r.requirements&&/get|delete/i.test(F)&&'undefined'!=typeof w[F]||'undefined'!=typeof r.requirements&&/get/i.test(F)&&/delete/i.test(u)){/get/i.test(F)&&/delete/i.test(u)&&(F=u);if(/^(delete)$/i.test(F)&&O.length===G.length){'undefined'==typeof w[F]&&(w[F]={});for(let T=0,qa=G.length;T<qa;T++)if(O[T]===G[T])++l;else if(u=G[T].substr(1),'undefined'!=typeof r.requirements[u]){u=r.requirements[u];if(/^\//.test(u))u=u.substr(1,u.lastIndexOf('/')-
1);else if(/^validator::/.test(u)&&await ba(G[T],O[T],r,w,va,za)){++l;continue}/^:/.test(G[T])&&'undefined'!=typeof u&&(new RegExp(u)).test(O[T])&&(++l,w[F][G[T].substr(1)]=O[T])}v=!0}for(var H in w[F])'undefined'!=typeof r.requirements[H]&&0>G.indexOf(':'+H)&&(G[A]=':'+H,++A,O[M]=w[F][H],++M,v||O.length!==G.length||++D)}if(!v&&O.length===G.length)for(;z<D;++z)O[z]===G[z]?++l:l==z&&/:/.test(G[z])&&await ba(G[z],O[z],r,w,va,za)&&++l;if('undefined'!=typeof r.requirements&&F==r.method.toLowerCase()&&
!v&&l>=D)for(H=Object.getOwnPropertyNames(r.requirements),M=0,G.join(',').match(/:[-_a-z0-9]+/g);M<H.length;){A=H[M];if('undefined'==typeof r.param[A]&&/^validator::/i.test(r.requirements[A])){if(G.length!=O.length)break;var J=G.join(',').match(/:[-_a-z0-9]+/g);let T=r.requirements[A];z={};u={};v={};try{u=JSON.parse(T.split(/::/).splice(1)[0].replace(/([^:"\s+](\w+)):/g,'"$1":').replace(/([^:"\s+](\w+))\s+:/g,'"$1":'))}catch(qa){throw qa;}if('undefined'!=typeof u.query&&'undefined'!=typeof u.query.data){z=
u.query.data;for(let qa in z)0>J.indexOf(z[qa])&&delete z[qa];for(let qa=0,Fa=G.length;qa<Fa;qa++)/^:/.test(G[qa])&&(J=G[qa].replace(/^:/,''),''!=J&&'undefined'!=typeof O[qa]&&(z[J]=O[qa],'undefined'==typeof w.params[J]&&(w.params[J]=O[qa])))}z=ma(z,JSON.clone(w[F])||{});'undefined'==typeof z[A]&&(z[A]=null);v[A]=u;_validator=B?new U(z):new U('routing',z,null,v);if(0==u.count()){console.error('Route validation failed '+r.rule);--l;M++;continue}for(let qa in u)if('undefined'!=typeof u[qa].data&&(u[qa].data=
z),v=Array.isArray(u[qa])?await _validator[A][qa].apply(_validator[A],u[qa]):await _validator[A][qa](u[qa],w,va,za),!v.isValid&&(--l,'undefined'!=typeof v.error))throw v.error;}M++}y.past=l===D?!0:!1;y.past&&(w.routing=S(r,w[F]),y.request=w);return y},ba=async function(r,G,w,va,za,O){var M=-1,A=r.match(/:\w+/g);M=new RegExp(r,'g');var D=null,l=null,y=null;D=!1;var z=D=l=l=null,F=null,u=va.method.toLowerCase();if(!A.length)return!1;w.param.path&&M.test(w.param.path)&&(w.param.path=w.param.path.replace(M,
G));w.param.namespace&&M.test(w.param.namespace)&&(w.param.namespace=w.param.namespace.replace(M,G));'undefined'!=typeof w.param.file&&/:/.test(w.param.file)&&(D=new RegExp('(:'+r+'/|:'+r+'$)','g'),Q.variable=G,w.param.file=w.param.file.replace(D,Q),D=null);w.param.title&&M.test(w.param.title)&&(w.param.title=w.param.title.replace(M,G));if(1==A.length){D=new RegExp(A[0]);M=-1<A.indexOf(r)?A.indexOf(r):!1;!1===M&&r.match(D)&&(M=0);if(!1===M)return M;if(w.method.toLowerCase()!==u)return!1;'undefined'==
typeof va[u]&&(va[u]={});y=A[M].substr(1);M=w.requirements[y];if(/^\//.test(M))D=M.match(/\/(.*)\//).pop(),l=M.replace('/'+D+'/',''),D=(new RegExp(D,l)).test(G);else if(/^validator::/.test(M)&&G){l={};D={};z={};F='';r.replace(new RegExp('[^'+y+']','g'),function(qa){F+=qa});l[y]=G.replace(new RegExp(F,'g'),'');try{D=JSON.parse(M.split(/::/).splice(1)[0].replace(/([^:"\s+](\w+)):/g,'"$1":').replace(/([^:"\s+](\w+))\s+:/g,'"$1":'))}catch(qa){throw qa;}'undefined'!=typeof D.query&&'undefined'!=typeof D.query.data&&
r==D.query.data[Object.keys(D.query.data)[0]]&&(D.query.data[Object.keys(D.query.data)[0]]=l[y],va.params[y]=l[y]);z[y]=D;l=new U('routing',l,null,z);if(0==D.count())return console.error('Route validation failed '+w.rule),!1;for(var v in D)Array.isArray(D[v])?await l[y][v].apply(l[y],D[v]):await l[y][v](D[v],va,za,O);D=l.isValid()}else D=(new RegExp(w.requirements[y])).test(G);if('undefined'!=typeof w.param[y]&&'undefined'!=typeof w.requirements&&'undefined'!=typeof w.requirements[y]&&'undefined'!=
typeof va.params&&D)return va.params[y]=G,'undefined'==typeof va[u][y]&&(va[u][y]=G),!0}else{za=w.url;O=va.url;u={};z='';var H=!1,J=0;v=0;for(var T=O.length;v<T;++v)if(O.charAt(v)!=za.charAt(J)||H){if(''==z)H=!0,z+=O.charAt(v);else if(v>za.indexOf(A[0])+A[0].length){M=w.requirements[A[0]];G=z.substr(0,z.length);if(/^\//.test(M))D=M.match(/\/(.*)\//).pop(),l=M.replace('/'+D+'/',''),D=(new RegExp(D,l)).test(G);else if(/^validator::/.test(M)){l={};D={};z={};F='';r.replace(new RegExp('[^'+y[0]+']','g'),
function(qa){F+=qa});l[y[0]]=G.replace(new RegExp(F,'g'),'');D=JSON.parse(M.split(/::/).splice(1)[0].replace(/([^\W+ true false])+(\w+)/g,'"$&"'));z[y[0]]=D;l=new U('routing',l,null,z);for(let qa in D)if(Array.isArray(D[qa]))l[y[0]][qa].apply(l[y[0]],D[qa]);else l[y[0]][qa](D[qa]);D=l.isValid()}else D=(new RegExp(w.requirements[y[0]])).test(G);if(D)u[A[0].substr(1)]=G;else return!1;z='';H=!1;J=za.indexOf(A[0])+A[0].length;--v;A.splice(0,1)}else z+=O.charAt(v),++J;if(v==T-1)if(M=w.requirements[A[0]],
G=z.substr(0,z.length),/^\//.test(M)?(D=M.match(/\/(.*)\//).pop(),l=M.replace('/'+D+'/',''),D=(new RegExp(D,l)).test(G)):D=(new RegExp(w.requirements[y])).test(G),D)u[A[0].substr(1)]=G;else return!1}else++J;if(u.count()==A.length){y=null;for(y in u)va.params[y]=u[y];return!0}}return!1},Q=function(r){return/\/$/.test(r)?Q.variable+'/':Q.variable},S=function(r,G){var w=null,va,za=r.url,O=null;for(O in r.param)if(('undefined'==typeof G||'undefined'!=typeof G[O])&&/^:/.test(r.param[O])){var M=r.param[O].substr(1);
if('undefined'!=typeof G&&'undefined'!=typeof G[M]){var A=new RegExp('(:'+M+'/|:'+M+'$)','g');'undefined'!=typeof r.param.path&&/:/.test(r.param.path)&&(r.param.path=r.param.path.replace(A,G[M]));'undefined'!=typeof r.param.title&&/:/.test(r.param.title)&&(r.param.title=r.param.title.replace(A,G[M]));'undefined'!=typeof r.param.namespace&&/:/.test(r.param.namespace)&&(r.param.namespace=r.param.namespace.replace(A,G[M]));'undefined'!=typeof r.param.file&&/:/.test(r.param.file)&&(Q.variable=G[M],r.param.file=
r.param.file.replace(A,Q));if(/,/.test(r.url)){w=r.url.split(/,/g);var D=0;for(va=w.length;D<va;++D)Q.variable=G[M],w[D]=w[D].replace(A,Q);r.url=w.join(',')}else Q.variable=G[M],r.url=r.url.replace(A,Q)}}if(w){D=0;va=w.length;za=za.split(/,/g);var l=0;for(r.urlIndex=0;D<va;++D)if(w=0,A=za[0].match(/:[-_a-z0-9]+/ig)){O=0;for(M=A.length;O<M;O++){var y=A[O].substr(1);'undefined'!=typeof G[y]&&G[y]&&w++}w>l&&(l=w,r.urlIndex=D)}}return r};P.getRoute=function(r,G,w){var va=null,za=!1;if(B)window.location.port||
window.location.hostname!=window.gina.config.hostname.replace(/^(https|http|wss|ws):\/\//,'').replace(/:\d+$/,'')||(za=!0,window.gina.config.hostname=window.gina.config.hostname.replace(/^(https|http|wss|ws):\/\//,'').replace(/:\d+$/,'')),va=window.gina.config;else if(va=getContext('gina').config,'undefined'!=typeof getContext('argvFilename')&&(va.getRouting=getContext('gina').Config.instance.getRouting),za=getContext('isProxyHost'),!za&&'undefined'!=typeof process.env.PROXY_REQUEST_HOST&&process.env.PROXY_REQUEST_HOST===
process.env.PROXY_HOST||!za&&'undefined'==typeof process.env.PROXY_REQUEST_HOST&&'undefined'!=typeof process.env.PROXY_HOST)za=!0;var O=va.env||GINA_ENV,M=null,A=va.bundle;/@/.test(r)||'undefined'==typeof A||null==A||(r=r.toLowerCase(),r+='@'+A);if(/@/.test(r)){var D=r.replace(/(.*):\/\//,'').split(/@/);A=D[1];/\/(.*)$/.test(r)&&(M=r.replace(/(.*):\/\//,'').split(/\/(.*)$/)[1],A=A.replace(/\/(.*)$/,''),O=M||O);r=D[0].toLowerCase()+'@'+A}A=va.getRouting(A,O);if('undefined'==typeof A[r])throw Error('[ RoutingHelper::getRouting(rule, params) ] : `'+
r+'` not found !');M=JSON.clone(A[r]);D=null;M=S(M,G);if(M.isProxyHost=za)M.hostname=B?window.location.protocol+'//'+window.gina.config.hostname:va.envConf._proxyHostname||process.env.PROXY_HOSTNAME,M.host=M.hostname.replace(/^(https|http):\/\//,'');/,/.test(M.url)&&('undefined'!=typeof M.urlIndex&&(w=M.urlIndex,delete M.urlIndex),w='undefined'!=typeof w?w:0,M.url=M.url.split(/,/g)[w]);/\/$/.test(M.url)&&'/'!=M.url&&(M.url=M.url.substr(0,M.url.length-1));if(/GET/i.test(M.method)&&'undefined'!=typeof G){w=
'?';va=A[r].url;za=[];A=0;for(let l in M.param)-1<P.reservedParams.indexOf(l)||(new RegExp(M.param[l])).test(va)||'undefined'==typeof G[l]||(w+=l+'='+encodeRFC5987ValueChars(G[l])+'&',za[A]=G[l],++A);for(let l in G)-1<P.reservedParams.indexOf(l)||'undefined'!=typeof M.requirements[l]||-1<za.indexOf(l)||(w='object'==typeof G[l]?w+(l+'='+encodeRFC5987ValueChars(JSON.stringify(G[l]))+'&'):w+(l+'='+G[l]+'&'));A=za=va=null;1<w.length&&(w=w.substring(0,w.length-1),M.url+=w);w=null}M.toUrl=function(l){var y=
null;/^redirect$/i.test(this.param.control)&&(y=P.getUrlProps(this.bundle,O||GINA_ENV));var z=this.webroot||y.webroot;y=this.hostname||y.hostname;var F=this.url;this.url='undefined'!=typeof l&&/^true$/i.test(l)?F.replace(new RegExp('^'+z),'/'):F.replace(new RegExp('^('+z+'|/$)'),z);return y+this.url};M.request=function(l,y){var z=null,F=null;'function'==typeof arguments[arguments.length-1]&&(z=arguments[arguments.length-1]);'object'==typeof arguments[2]&&(F=arguments[2]);var u=this.webroot||F.webroot,
v=this.hostname||F.hostname;F='undefined'!=typeof l&&1==l?path.replace(u,'/'):this.url||F.url;v=/^https/.test(v)?'https':'http';B?window.open(F,'undefined'!=typeof y&&'undefined'!=typeof y.target?y.target:'_self'):('undefined'==typeof y.agent&&(y.agent=!1),v=require(''+v),u=function(H){var J='',T=!1;H.on('data',function(qa){J+=qa});H.on('error',function(qa){T='Failed to get mail content';qa&&'undefined'!=typeof qa.stack?T+=qa.stack:'string'==typeof qa&&(T+='\n'+qa)});H.on('end',function(){if(/^\{/.test(J))try{J=
JSON.parse(J),'undefined'!=typeof J.error&&(T=JSON.clone(J),J=null)}catch(qa){T=qa}T?z(T):z(!1,J)})},z?v.get(F,y,u):v.get(F,y))};!/:/.test(M.url)||/:d+\//.test(M.url)||/:\/\//.test(M.url)||(G=M.url.match(/(:(.*)\/|:(.*)$)/g).map(function(l){return l.replace(/\//g,'')}).join(', '),D='[ RoutingHelper::getRoute(rule[, bundle, method]) ] : route [ %r ] param placeholder not defined: `'+M.url+'` !\n Check your route description to compare requirements against param variables [ '+G+']',D=D.replace(/%r/,
r),r=Error(D),console.warn(r),D=r=G=null);return M};P.getRouteByUrl=function(r,G,w,va,za){2==arguments.length&&'undefined'!=typeof arguments[1]&&arguments[1]&&-1<P.allowedMethods.indexOf(arguments[1].toLowerCase())&&(w=arguments[1],G=void 0);var O=null,M=null,A=null,D=null,l=null,y=null;if(/#/.test(r)&&1<r.length){var z=r.split(/#/);r=z[0];l='#'+z[1];z=null}1==arguments.length&&'undefined'!=typeof arguments[0]&&(/^(https|http)/i.test(r)||/^\//.test(r)||(r='/'+r),O='/'+r.split(/\//g)[1],B&&(D=gina.config.reverseRouting,
A=gina.config.routing),'undefined'!=typeof D[O]&&(z=A[D[O]],G=z.bundle,O=z.webroot,y=z.hostname,z=null));za='boolean'!=typeof arguments[arguments.length-1]?!1:arguments[arguments.length-1];var F=!1,u=null,v=null,H=u=v=null;z='undefined'!=typeof w?!0:!1;B?(u=window.gina.config,G='undefined'!=typeof G?G:u.bundle,v=u.env,A=A||u.getRouting(G),D=D||u.reverseRouting,isXMLRequest='undefined'!=typeof isXMLRequest?isXMLRequest:!1,y=y||u.hostname,O=O||u.webroot,va={routing:{},method:w,params:{},url:r},G&&(va.bundle=
G)):(u=getContext('gina').config,G='undefined'!=typeof G?G:u.bundle,v=u.env,A=u.getRouting(G),y=u.envConf[G][v].hostname,O=u.envConf[G][v].server.webroot,va||={routing:{},isXMLRequest:!1,method:'undefined'!=typeof w?w.toLowerCase():'get',params:{},url:r},za&&(va.method=w),isXMLRequest=va.isXMLRequest||!1);v=r.replace(new RegExp('^('+y+'|'+y.replace(/:\d+/,'')+')'),'');'undefined'==typeof va.routing.path&&(va.routing.path=decodeURI(v));w='undefined'!=typeof w?w.toLowerCase():'get';z&&(va.originalMethod=
va.method,va.method=w,va.routing.path=decodeURI(v));va.method||(va.method=w);u={};O=new RegExp(w,'i');D=null;var J;for(J in A){if('undefined'==typeof A[J].param)break;if(A[J].bundle==G&&(D=A[J].method,/,/.test(D)&&O.test(D)&&(D=va.method),'undefined'==typeof A[J].method||O.test(D))){u={method:D,requirements:A[J].requirements,namespace:A[J].namespace||void 0,url:decodeURI(v),rule:A[J].originalRule||J,param:A[J].param,middleware:JSON.clone(A[J].middleware),bundle:A[J].bundle,isXMLRequest};try{if(H=
P.compareUrls(u,A[J].url,va),H.past){M=JSON.clone(A[J]);M.name=J;F=!0;H={};break}}catch(T){throw Error('Route [ '+J+' ] needs your attention.\n'+T.stack);}}}if(F)return/\/$/.test(r)&&'/'!=r&&(r=r.substr(0,r.length-1)),l&&(r+=l),M.url=r,M.toUrl=function(T){var qa=this.webroot,Fa=this.hostname,W=this.url;this.url='undefined'!=typeof T&&1==T?W.replace(qa,'/'):W;return Fa+this.url},M;if(B){l=!1;if('#'==r&&/GET/i.test(w)&&z||/^404:/.test(r))r=location.pathname,l=!0;'undefined'==typeof P.notFound&&(P.notFound=
{});A=null;M='[ RoutingHelper::getRouteByUrl(rule[, bundle, method]) ] : route [ %r ] is called but not found inside your view: `'+r+'` !';if((A=(A=gina.hasPopinHandler&&gina.popinIsBinded?gina.popin.getActivePopin().target.innerHTML.match(/404:\[\w+\][a-z 0-9-_@]+/):document.body.innerHTML.match(/404:\[\w+\][a-z 0-9-_@]+/))&&0<A.length?A[0]:null)&&z&&l)return l=A.match(/\[\w+\]/)[0],A=A.replace('404:'+l,l.replace(/\[|\]/g,'')+'::'),M=M.replace(/%r/,A.replace(/404:\s+/,'')),'undefined'==typeof P.notFound[A]?
P.notFound[A]={count:1,message:M}:z&&'undefined'!=typeof P.notFound[A]&&++P.notFound[A].count,!1;if((l=gina.config.reverseRouting[r]||null)&&'undefined'!=typeof l&&l.split(/@(.+)$/)[1]==G)return A=l,'undefined'==typeof P.notFound[A]?(M=M.replace(/%r/,w.toUpperCase()+'::'+l),P.notFound[A]={count:1,message:M}):z&&'undefined'!=typeof P.notFound[A]&&++P.notFound[A].count,!1;A=P.compareUrls(u,r,va)||null;A.past&&z&&(A=w.toUpperCase()+'::'+A.request.routing.rule,'undefined'==typeof P.notFound[A]?M=M.replace(/%r/,
A):++P.notFound[A].count);return!1}console.warn(Error('[ RoutingHelper::getRouteByUrl(rule[, bundle, method, request]) ] : route not found for url: `'+r+'` !').stack);return!1};return P}'undefined'!==typeof module&&module.exports?module.exports=Routing():'function'===typeof define&&define.amd&&define('lib/routing',['require','lib/form-validator','lib/merge'],function(){return Routing()});
function StoragePlugin(B){function P(M){G=JSON.parse(S.getItem(this.bucket));'undefined'==typeof G[M]&&(G[M]=[],S.setItem(this.bucket,JSON.stringify(G)),G=JSON.parse(S.getItem(this.bucket)));r[M]={_collection:M,_bucket:this.bucket};r[M]=ma(r[M],za);return r[M]}function V(M){if('object'!==typeof M)throw Error('filter must be an object');var A=G[this._collection],D=M.count(),l=0,y=null;if(0==D)return null;for(var z in A)for(var F in M){var u='boolean'!=typeof M[F]?M[F].toLocaleLowerCase():M[F];M[F]&&
-1<w.indexOf(u)&&'not null'==u&&'undefined'!=typeof A[z][F]&&'object'!==typeof A[z][F]&&A[z][F]===M[F]&&'null'!=A[z][F]&&'undefined'!=A[z][F]?0>y.indexOf(A[z][F])&&(++l,l===D&&(y=A[z],y._index=z,y._collection=this._collection,y._bucket=this._bucket)):'undefined'!=typeof A[z][F]&&'object'!==typeof A[z][F]&&A[z][F]===M[F]&&(++l,l===D&&(y=A[z],y._index=z,y._collection=this._collection,y._bucket=this._bucket,y._filter=M))}y&&(y.save=O);return y}var ma=ma||require('lib/merge');P=P||require('lib/collection');
var U=U||require('vendor/uuid'),N=N||require('helpers/dateFormat'),ba={bucket:'default'},Q={},S=null,r={},G={},w=['not null'],va={bucket:void 0,drop:function(){S.removeItem(ba.bucket);Q=null;for(var M in this)delete this[M];return Q},Collection:P},za={insert:function(M){M._id=U.v1();M._createdAt=(new Date).format('isoDateTime');M._updatedAt=(new Date).format('isoDateTime');G[this._collection][G[this._collection].length]=M;S.setItem(this._bucket,JSON.stringify(G))},find:function(M,A){if(!M)return G[this._collection];
if('object'!==typeof M)throw Error('filter must be an object');A=G[this._collection];M.count();var D=0,l=[],y;for(y in A)for(var z in M){var F='boolean'!=typeof M[z]?M[z].toLocaleLowerCase():M[z];M[z]&&-1<w.indexOf(F)&&'not null'==F&&'undefined'!=typeof A[y][z]&&'object'!==typeof A[y][z]&&'null'!=A[y][z]&&'undefined'!=A[y][z]?0>l.indexOf(A[y][z])&&(l[D]=A[y][z],++D):'undefined'!=typeof A[y][z]&&'object'!==typeof A[y][z]&&A[y][z]===M[z]&&(l[D]=A[y],++D)}return l},findOne:V,update:null,'delete':function(M){if('object'!==
typeof M)throw Error('filter must be an object');var A=JSON.clone(G[this._collection]),D=0,l=[],y;for(y in A)for(var z in M)M[z]&&-1<w.indexOf(M[z].toLocaleLowerCase())&&'not null'==M[z].toLowerCase()&&'undefined'!=typeof A[y][z]&&'object'!==typeof A[y][z]&&'null'!=A[y][z]&&'undefined'!=A[y][z]?0>l.indexOf(A[y][z])&&(l[D]=A[y][z],delete G[this._collection][y][z],++D):'undefined'!=typeof A[y][z]&&'object'!==typeof A[y][z]&&A[y][z]===M[z]&&(l[D]=A[y],G[this._collection].splice(y,1),++D);return 0<l.length?
(S.setItem(this._bucket,JSON.stringify(G)),!0):!1},drop:function(M){if('undefined'==typeof G[this._collection])throw Error('Collection `'+M+'` not found');delete r[this._collection];delete G[this._collection];S.setItem(this._bucket,JSON.stringify(G))}},O=function(M){M=M||!1;try{var A=JSON.clone(G),D=this._index,l=this._collection,y=this._bucket,z=this._filter;this._updatedAt=(new Date).format('isoDateTime');A[l][D]=ma(A[l][D],this,!0);delete A[l][D]._index;delete A[l][D]._collection;delete A[l][D]._bucket;
delete A[l][D].save;delete A[l][D]._filter;if(M&&'object'==typeof A[l][D]){var F=function(v,H){for(var J=0,T=v.length;J<T;++J)'object'!=typeof H[J]||'undefined'==typeof v[J]||Array.isArray(v[J])?Array.isArray(v[J])?F(v[J],H[J]):'undefined'==typeof v[J]&&delete H[J]:u(v[J],H[J]);return H},u=function(v,H){for(var J in H)'object'!=typeof H[J]||'undefined'==typeof v[J]||Array.isArray(v[J])?Array.isArray(v[J])?F(v[J],H[J]):'undefined'==typeof v[J]&&delete H[J]:u(v[J],H[J]);return H};Array.isArray(A[l][D])?
A[l][D]=F(this,A[l][D]):'object'==typeof A[l][D]?A[l][D]=u(this,A[l][D]):'undefined'==typeof this[prop]&&delete A[l][D]}G[l][D]=A[l][D];S.setItem(y,JSON.stringify(G));return V(z)}catch(v){throw v;}};(function(M){if(!window.localStorage||window.localStorage&&'undefined'==!typeof window.localStorage.setItem)throw Error('Make sure your browser supports `window.localStorage` to use Gina Storage. See: `https://developer.mozilla.org/en-US/docs/Web/API/Web_Storage_API#Browser_compatibility`');if('object'!=
typeof M&&'undefined'!=typeof M)throw Error('`options` must be an object');'undefined'==typeof M&&(M={});ba=ma(M,ba);S=window.localStorage;M=ba.bucket;if(!S.getItem(M)&&void 0!=M)S.setItem(M,JSON.stringify(G));else if(void 0==M)throw Error('`bucket` name cannot be undefined');Q.bucket=M;Q=ma(Q,va)})(B);return Q}
...
null,errors:{},initialized:!1,isReady:!1,rules:{},$forms:{},getFormById:null,validateFormById:null,setOptions:null,resetErrorsDisplay:null,resetFields:null},va={id:null,plugin:this.plugin,on:U?on:null,eventData:{},target:U?document:null,cachedErrors:{},binded:!1,unbinded:!1,withUserBindings:!1,rules:{},setOptions:null,send:null,isValidating:null,isSubmitting:null,submit:null,destroy:null,resetErrorsDisplay:null,resetFields:null},za={},O={},M=null,A={url:'',method:'GET',isSynchrone:!1,withCredentials:!1,
headers:{'Content-Type':'application/x-www-form-urlencoded; charset=UTF-8','X-Requested-With':'XMLHttpRequest'}},D=function(m,g,h){h='undefined'!=typeof h?{id:h}:null;var b={},x;for(x in g)b[x]=g[x];if('undefined'!=typeof m&&0<m.count()){try{La(m,''),Da(m)}catch(q){throw q;}return Aa(h,b,null,w.rules)}return new r(b)},l=function(m){A=m=Q(m,A)},y=function(m){var g=null;if(!w.$forms)throw Error('`$forms` collection not found');if('undefined'==typeof m)throw Error('[ FormValidator::getFormById(formId) ] `formId` is missing');
m=m.replace(/#/,'');if(null!=document.getElementById(m)&&'undefined'==typeof w.$forms[m]){var h=document.getElementById(m),b,x=typeof(0<za.count())?za:w.rules;h.getAttribute?(id=h.getAttribute('id')||'form.'+ba.v4(),id!==h.getAttribute('id')&&h.setAttribute('id',id)):(id='form.'+ba.v4(),h.setAttribute('id',id));h.id=va.id=id;if('undefined'!=typeof h.id&&'null'!=h.id&&''!=h.id){va.target=h;w.$forms[h.id]=Q({},va);if(b=h.getAttribute('data-gina-form-rule')){b=b.replace(/\-|\//g,'.');if('undefined'==
...
h.getAttribute('method')||g.method;Ba=Ba.toUpperCase();g.method=Ba;g.url=fa;M||=setupXhr(g);fa=h.getAttribute('enctype')||g.headers['Content-Type'];if(g.withCredentials){if('withCredentials'in M)g.isSynchrone?M.open(g.method,g.url,g.isSynchrone):M.open(g.method,g.url);else if('undefined'!=typeof XDomainRequest)M=new XDomainRequest,M.open(g.method,g.url);else{M=null;q='CORS not supported: the server is missing the header `"Access-Control-Allow-Credentials": true` ';triggerEvent(gina,h,'error.'+b,q);
return}M.responseType='undefined'!=typeof g.responseType?g.responseType:'';M.withCredentials=!0}else g.isSynchrone?M.open(g.method,g.url,g.isSynchrone):M.open(g.method,g.url);for(var ea in g.headers)'Content-Type'==ea&&'undefined'!=typeof fa&&null!=fa&&''!=fa||M.setRequestHeader(ea,g.headers[ea]);if(M){M.onreadystatechange=function(Z){x.isSubmitting=!1;x.isSending=!1;setTimeout(function(){x.sent=!1},1E3);Z=/Google Inc/i.test(navigator.vendor)?50:0;2==M.readyState&&(R=/^attachment;/.test(M.getResponseHeader('Content-Disposition'))?
!0:!1,!M.responseType&&R&&(M.responseType='blob'));if(4==M.readyState){var Ga=null,Pa=null,$a=M.getResponseHeader('Content-Type');if(/^2/.test(M.status)){try{if(/blob/.test(M.responseType)||R){if('undefined'==typeof $a||null==$a)$a='application/octet-stream';Pa=new Blob([this.response],{type:$a});var ib=document.createElement('a');ib.style='display: none';document.body.appendChild(ib);var Cb=window.URL.createObjectURL(Pa);ib.href=Cb;var zb=M.getResponseHeader('Content-Disposition');ib.download=zb.match('=(.*)')[0].substr(1);
ib.click();window.URL.revokeObjectURL(Cb);q={status:M.status,statusText:M.statusText,responseType:Pa.type,type:Pa.type,size:Pa.size}}else q=M.responseText;/\/json/.test($a)&&(q=JSON.parse(M.responseText),'undefined'==typeof q.status&&(q.status=M.status));if(/\/html/.test($a)&&(q={contentType:$a,content:M.responseText},'undefined'==typeof q.status&&(q.status=M.status),'undefined'!=typeof gina.popin&&gina.hasPopinHandler&&(Ga=gina.popin.getActivePopin()))){p={};try{p=(new DOMParser).parseFromString(q.content,
...
K.target;w.$forms[K.target.form.getAttribute('id')].isValidating=!0;Aa(K.target,Ba,ea,m.rules,function(da){w.$forms[K.target.form.getAttribute('id')].isValidating=!1;da.isValid()?H(K.target.form,{},da.data,K.target.name):H(K.target.form,da.error,da.data,K.target.name);var E=K.target.form,na=da=null,ra=null;na=db(E,x);da=na.fields;na=na.$fields;var ia=E.getAttribute('id');ra=w.$forms[ia].rules;w.$forms[ia].isValidating=!0;Aa(E,da,na,ra,function(Z){w.$forms[ia].isValidating=!1;console.debug('['+ia+
...
(console.debug('#1 you just focusin ....'+g.id,g.value),u(g)):/^focusout\./i.test(K.type)?/\-warning/.test(g.parentNode.className)&&(console.debug('#1 you just focusout ....'+g.id,g.value),u(g),H(g.form,w.$forms[g.form.getAttribute('id')].errors,null,g.name)):/^keyup\./i.test(K.type)?(g.ginaFormValidatorTestedValue=g.value,h=setTimeout(function(){-1<['91','17'].indexOf(''+K.keyCode)&&0==O.count()||(console.debug(' keyup ('+K.keyCode+') .... '+g.id,g.value,' VS ',g.ginaFormValidatorTestedValue+'(old)'),
...
setTimeout(()=>{R!=K?Ua(q,R):0==R?Ua(q,R):Ua(q,R-1)},0)},0);break;case 9:O[16]&&O[9]?pb(q,!0):pb(q);break;case 13:case 16:break;case 37:console.debug('moving left ',R-1);Ua(q,R-1);break;case 39:R+1<p.length+1&&Ua(q,R+1);break;case 17:case 91:console.debug('CMD hit');x.preventDefault();break;case 67:if(O[67]&&O[91]||O[67]&&O[17]){q.setSelectionRange(R,K);document.execCommand('copy');break}case 86:if(O[86]&&O[91]||O[86]&&O[17]){R!=K&&(q.value=q.value.replace(p.substring(R,K),''));Ua(q,R);document.execCommand('paste');
break}case 88:if(O[88]&&O[91]||O[88]&&O[17]){q.setSelectionRange(R,K);document.execCommand('cut');break}case 90:if(O[90]&&O[91]||O[90]&&O[17]){q.value=q.defaultValue;break}default:R!=K?(q.value=p.substr(0,R)+x.key,K-1<p.length&&(q.value+=p.substring(K))):q.value=0==R?x.key+p.substring(R):p.substr(0,R)+x.key+p.substr(K),x.currentTarget.setAttribute('readonly','readonly'),setTimeout(()=>{q.removeAttribute('readonly');setTimeout(()=>{Ua(q,R+1)},0)},0)}})})},gb=function(m,g){if(/^(input|textarea)$/i.test(g.tagName)&&
...
w.$forms[Ra.getAttribute('id')].isValidating=!0;Aa(event.target,ja,ua,X.rules,function(Xa){w.$forms[Ra.getAttribute('id')].isValidating=!1;Xa.isValid()?H(Ra,{},Xa.data,event.target.name):H(Ra,Xa.error,Xa.data,event.target.name);var eb=Ra,Oa=Xa=null,wb=null;Oa=db(eb,x);Xa=Oa.fields;Oa=Oa.$fields;var lb=eb.getAttribute('id');wb=w.$forms[lb].rules;w.$forms[lb].isValidating=!0;Aa(eb,Xa,Oa,wb,function(hb){w.$forms[lb].isValidating=!1;console.debug('[updateSelect]: onSilentGlobalLiveValidation: '+hb.isValid(),
...
var ja=w.$forms[X.currentTarget.id||X.target.id];ja.target.dataset.ginaFormIsResetting=!0;T(ja);X=db(ja.target,ja.rules,!0);Aa(ja.target,X.fields,X.$fields,ja.rules,function(ua){var Ra=ua.isValid();console.debug('silent reset validation result[isValid:'+Ra+']: ',ua);H(ja.target,{});Ka(ja.target,Ra);ja.target.dataset.ginaFormIsResetting=!1})});addListener(gina,m,'reset',function(X){var ja=X.target;if('undefined'!=typeof X.defaultPrevented&&X.defaultPrevented)return!1;X.preventDefault();var ua=ja.id;
if(!ua)return!1;/^reset\./.test(ua)||(ua='reset.'+ja.id);gina.events[ua]&&triggerEvent(gina,ja,ua,X.detail)});addListener(gina,m,'keydown',function(X){var ja=X.target;if('undefined'!=typeof X.defaultPrevented&&X.defaultPrevented)return!1;O[X.keyCode]='keydown'==X.type;var ua=ja.id;if(!ua)return!1;/^keydown\./.test(ua)||(ua='keydown.'+ja.id);gina.events[ua]&&(cancelEvent(X),triggerEvent(gina,ja,ua,X.detail,X))});addListener(gina,m,'keyup',function(X){var ja=X.target;if('undefined'!=typeof X.defaultPrevented&&
X.defaultPrevented)return!1;O[X.keyCode]&&delete O[X.keyCode];var ua=ja.id;if(!ua)return!1;/^keyup\./.test(ua)||(ua='keyup.'+ja.id);gina.events[ua]&&(cancelEvent(X),triggerEvent(gina,ja,ua,X.detail,X))});addListener(gina,m,'focusin',function(X){var ja=X.target;if('undefined'!=typeof X.defaultPrevented&&X.defaultPrevented)return!1;var ua=ja.id;if(!ua)return!1;/^focusin\./.test(ua)||(ua='focusin.'+ja.id);gina.events[ua]&&(cancelEvent(X),triggerEvent(gina,ja,ua,X.detail))});addListener(gina,m,'focusout',
...
(w.$forms[sb].errors=Q(x._errors,w.$forms[sb].errors),u(zb[Ya]),H(ob,x._errors,x._data,Ya),Ka(ob,mb)),triggerEvent(gina,ob,'validated.'+sb,x)):/^true$/i.test(w.$forms[sb].isValidating)&&1<ja.length&&ja[ja.length-1]!=Ya&&(lb=!0);lb&&Aa(ob,Cb,zb,cb,function(Kb){w.$forms[sb].isValidating=!1;mb=Kb.isValid();N&&U&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&(gina.forms.errors||(gina.forms.errors={}),window.ginaToolbar.update('forms',{id:sb,errors:Kb.error||{}}));H(ob,Kb.error,Kb.data,Ya);
...
Ub()},ab=function(x,q,p){var R=null,K=null;try{K=W?W.text():'',''==K||'null'==K?W.text('{}'):(la=JSON.parse(K),Da=JSON.parse(ka.text()),W.text(''),xa||(xa={jsonObject:JSON.clone(la),ginaJsonObject:JSON.clone(Da)},ta={}))}catch(na){console.error('Could not load'+(x?' [ '+x+' ] ':' ')+'json\n'+na.message+'\n'+na.stack)}if(la){q&&!p?(la[x]||(la[x]={}),la[x]=Da[x]=q):'data-xhr'==x&&!q&&la['data-xhr']?delete la['data-xhr']:p&&(la=q,Da=p);b(la,'');Da.environment&&(delete Da.environment.routing,delete Da.environment.reverseRouting,
...
ha.off('click').on('click',function(q){la&&window.open('','JSON RAW','width=400,height=100').document.write(JSON.stringify(la.data))});za.off('click').on('click',function(q){q.preventDefault();za.removeClass('gina-toolbar-active');A.removeClass('gina-toolbar-active');P(this).addClass('gina-toolbar-active');l=P(this).attr('href');D=P(l).addClass('gina-toolbar-active');w.panelId=l;w.save()});O.off('click').on('click',function(q){q.preventDefault();G.toggleClass('gina-toolbar-collapsed');va=G.hasClass('gina-toolbar-collapsed');
...
null;var q,p=(gina.hasPopinHandler?P('#'+x.id):P('body')).html().match(/404:\[(.+)\](.+)@(.+)"/gm);if(p){var R=0;for(q=p.length;R<q;++R){x=p[R].replace(/"(.*)|"/g,'');var K=x.match(/\[(.*)\]/g,'')[0].replace(/\[|\]/g,'');V.getRouteByUrl(x,K)}}fLen=V.notFound.count();if(0<fLen)for(f in V.notFound)console.warn('(x'+V.notFound[f].count+') '+f+' => '+V.notFound[f].message)},Aa=function(x,q,p,R,K,fa,Ba){if(!fa)return!1;for(var ea=K[R].attributes,da,E=K[R].getAttribute('id')||K[R].id,na=P('<div id="gina-toolbar-form-'+
...
E.replace(/-/g,'.'))}catch(ib){}ea&&(da='rules',na.find('ul.gina-toolbar-section-content').append('<li class="gina-toolbar-form-'+da+'"><h3 class="gina-toolbar-sub-section-title">'+da+'</h3><ul class="gina-toolbar-properties">'+db(ea,ea,E,Ba,da)+'</ul></li>'));p.append(na);++R;R<fa&&Aa(x,q,p,R,K,fa,Ba)},m=function(x,q,p,R){var K=P('#gina-toolbar-form-'+x);$section=K.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-'+q+'> ul');if(0<$section.length){if(0==p.count())return K.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-'+
...
!function(B,P){'object'==typeof exports&&'undefined'!=typeof module?module.exports=P():'function'==typeof define&&define.amd?define('vendor/engine.io',P):(B='undefined'!=typeof globalThis?globalThis:B||self).eio=P()}(this,function(){function B(ya){return B='function'==typeof Symbol&&'symbol'==typeof Symbol.iterator?function(Aa){return typeof Aa}:function(Aa){return Aa&&'function'==typeof Symbol&&Aa.constructor===Symbol&&Aa!==Symbol.prototype?'symbol':typeof Aa},B(ya)}function P(ya,Aa){if(!(ya instanceof
Aa))throw new TypeError('Cannot call a class as a function');}function V(ya,Aa){for(var m=0;m<Aa.length;m++){var g=Aa[m];g.enumerable=g.enumerable||!1;g.configurable=!0;'value'in g&&(g.writable=!0);Object.defineProperty(ya,g.key,g)}}function ma(ya,Aa,m){return Aa&&V(ya.prototype,Aa),m&&V(ya,m),ya}function U(){return U=Object.assign||function(ya){for(var Aa=1;Aa<arguments.length;Aa++){var m=arguments[Aa],g;for(g in m)Object.prototype.hasOwnProperty.call(m,g)&&(ya[g]=m[g])}return ya},U.apply(this,arguments)}
function N(ya,Aa){if('function'!=typeof Aa&&null!==Aa)throw new TypeError('Super expression must either be null or a function');ya.prototype=Object.create(Aa&&Aa.prototype,{constructor:{value:ya,writable:!0,configurable:!0}});Aa&&Q(ya,Aa)}function ba(ya){return ba=Object.setPrototypeOf?Object.getPrototypeOf:function(Aa){return Aa.__proto__||Object.getPrototypeOf(Aa)},ba(ya)}function Q(ya,Aa){return Q=Object.setPrototypeOf||function(m,g){return m.__proto__=g,m},Q(ya,Aa)}function S(){if('undefined'==
typeof Reflect||!Reflect.construct||Reflect.construct.sham)return!1;if('function'==typeof Proxy)return!0;try{return Date.prototype.toString.call(Reflect.construct(Date,[],function(){})),!0}catch(ya){return!1}}function r(ya,Aa,m){return r=S()?Reflect.construct:function(g,h,b){var x=[null];x.push.apply(x,h);g=new (Function.bind.apply(g,x));return b&&Q(g,b.prototype),g},r.apply(null,arguments)}function G(ya){var Aa='function'==typeof Map?new Map:void 0;return G=function(m){function g(){return r(m,arguments,
ba(this).constructor)}if(null===m||(h=m,-1===Function.toString.call(h).indexOf('[native code]')))return m;var h;if('function'!=typeof m)throw new TypeError('Super expression must either be null or a function');if(void 0!==Aa){if(Aa.has(m))return Aa.get(m);Aa.set(m,g)}return g.prototype=Object.create(m.prototype,{constructor:{value:g,enumerable:!1,writable:!0,configurable:!0}}),Q(g,m)},G(ya)}function w(ya){if(void 0===ya)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
return ya}function va(ya){var Aa=S();return function(){var m=ba(ya);if(Aa){var g=ba(this).constructor;m=Reflect.construct(m,arguments,g)}else m=m.apply(this,arguments);return!m||'object'!=typeof m&&'function'!=typeof m?w(this):m}}function za(ya,Aa,m){return za='undefined'!=typeof Reflect&&Reflect.get?Reflect.get:function(g,h,b){for(;!Object.prototype.hasOwnProperty.call(g,h)&&null!==(g=ba(g)););if(g)return h=Object.getOwnPropertyDescriptor(g,h),h.get?h.get.call(b):h.value},za(ya,Aa,m||ya)}function O(ya){if(ya){for(var Aa in O.prototype)ya[Aa]=
O.prototype[Aa];return ya}}function M(ya){for(var Aa=arguments.length,m=Array(1<Aa?Aa-1:0),g=1;g<Aa;g++)m[g-1]=arguments[g];return m.reduce(function(h,b){return ya.hasOwnProperty(b)&&(h[b]=ya[b]),h},{})}function A(ya,Aa){Aa.useNativeTimers?(ya.setTimeoutFn=Na.bind(Ea),ya.clearTimeoutFn=Ia.bind(Ea)):(ya.setTimeoutFn=setTimeout.bind(Ea),ya.clearTimeoutFn=clearTimeout.bind(Ea))}function D(ya){var Aa='';do Aa=pb[ya%64]+Aa,ya=Math.floor(ya/64);while(0<ya);return Aa}function l(){var ya=D(+new Date);return ya!==
Ja?(ab=0,Ja=ya):ya+'.'+D(ab++)}function y(ya){var Aa='',m;for(m in ya)ya.hasOwnProperty(m)&&(Aa.length&&(Aa+='&'),Aa+=encodeURIComponent(m)+'='+encodeURIComponent(ya[m]));return Aa}function z(ya){var Aa={};ya=ya.split('&');for(var m=0,g=ya.length;m<g;m++){var h=ya[m].split('=');Aa[decodeURIComponent(h[0])]=decodeURIComponent(h[1])}return Aa}function F(ya){ya=ya.xdomain;try{if('undefined'!=typeof XMLHttpRequest&&(!ya||Ub))return new XMLHttpRequest}catch(Aa){}if(!ya)try{return new (Ea[['Active'].concat('Object').join('X')])('Microsoft.XMLHTTP')}catch(Aa){}}
function u(){}function v(){for(var ya in jb.requests)jb.requests.hasOwnProperty(ya)&&jb.requests[ya].abort()}function H(ya){var Aa=ya,m=ya.indexOf('['),g=ya.indexOf(']');-1!=m&&-1!=g&&(ya=ya.substring(0,m)+ya.substring(m,g).replace(/:/g,';')+ya.substring(g,ya.length));var h,b;ya=db.exec(ya||'');for(var x={},q=14;q--;)x[Lb[q]]=ya[q]||'';return-1!=m&&-1!=g&&(x.source=Aa,x.host=x.host.substring(1,x.host.length-1).replace(/;/g,':'),x.authority=x.authority.replace('[','').replace(']','').replace(/;/g,
':'),x.ipv6uri=!0),x.pathNames=function(p,R){p=R.replace(/\/{2,9}/g,'/').split('/');'/'!=R.substr(0,1)&&0!==R.length||p.splice(0,1);'/'==R.substr(R.length-1,1)&&p.splice(p.length-1,1);return p}(0,x.path),x.queryKey=(h=x.query,b={},h.replace(/(?:^|&)([^&=]*)=?([^&]*)/g,function(p,R,K){R&&(b[R]=K)}),b),x}var J=Object.create(null);J.open='0';J.close='1';J.ping='2';J.pong='3';J.message='4';J.upgrade='5';J.noop='6';var T=Object.create(null);Object.keys(J).forEach(function(ya){T[J[ya]]=ya});for(var qa=
{type:'error',data:'parser error'},Fa='function'==typeof Blob||'undefined'!=typeof Blob&&'[object BlobConstructor]'===Object.prototype.toString.call(Blob),W='function'==typeof ArrayBuffer,ka=function(ya,Aa,m){var g=ya.type;ya=ya.data;return Fa&&ya instanceof Blob?Aa?m(ya):ha(ya,m):W&&(ya instanceof ArrayBuffer||('function'==typeof ArrayBuffer.isView?ArrayBuffer.isView(ya):ya&&ya.buffer instanceof ArrayBuffer))?Aa?m(ya):ha(new Blob([ya]),m):m(J[g]+(ya||''))},ha=function(ya,Aa){var m=new FileReader;
return m.onload=function(){var g=m.result.split(',')[1];Aa('b'+g)},m.readAsDataURL(ya)},xa='undefined'==typeof Uint8Array?[]:new Uint8Array(256),la=0;64>la;la++)xa['ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'.charCodeAt(la)]=la;var ta='function'==typeof ArrayBuffer,Da=function(ya,Aa){if('string'!=typeof ya)return{type:'message',data:Qa(ya,Aa)};var m=ya.charAt(0);if('b'===m){ya=ya.substring(1);if(ta){var g=.75*ya.length;m=ya.length;var h=0;'='===ya[ya.length-1]&&(g--,'='===ya[ya.length-
2]&&g--);var b=new ArrayBuffer(g),x=new Uint8Array(b);for(g=0;g<m;g+=4){var q=xa[ya.charCodeAt(g)];var p=xa[ya.charCodeAt(g+1)];var R=xa[ya.charCodeAt(g+2)];var K=xa[ya.charCodeAt(g+3)];x[h++]=q<<2|p>>4;x[h++]=(15&p)<<4|R>>2;x[h++]=(3&R)<<6|63&K}Aa=Qa(b,Aa)}else Aa={base64:!0,data:ya};Aa={type:'message',data:Aa}}else Aa=T[m]?1<ya.length?{type:T[m],data:ya.substring(1)}:{type:T[m]}:qa;return Aa},Qa=function(ya,Aa){return'blob'===Aa&&ya instanceof ArrayBuffer?new Blob([ya]):ya},La=String.fromCharCode(30);
O.prototype.on=O.prototype.addEventListener=function(ya,Aa){return this._callbacks=this._callbacks||{},(this._callbacks['$'+ya]=this._callbacks['$'+ya]||[]).push(Aa),this};O.prototype.once=function(ya,Aa){function m(){this.off(ya,m);Aa.apply(this,arguments)}return m.fn=Aa,this.on(ya,m),this};O.prototype.off=O.prototype.removeListener=O.prototype.removeAllListeners=O.prototype.removeEventListener=function(ya,Aa){if(this._callbacks=this._callbacks||{},0==arguments.length)return this._callbacks={},this;
var m,g=this._callbacks['$'+ya];if(!g)return this;if(1==arguments.length)return delete this._callbacks['$'+ya],this;for(var h=0;h<g.length;h++)if((m=g[h])===Aa||m.fn===Aa){g.splice(h,1);break}return 0===g.length&&delete this._callbacks['$'+ya],this};O.prototype.emit=function(ya){this._callbacks=this._callbacks||{};for(var Aa=Array(arguments.length-1),m=this._callbacks['$'+ya],g=1;g<arguments.length;g++)Aa[g-1]=arguments[g];if(m){g=0;for(var h=(m=m.slice(0)).length;g<h;++g)m[g].apply(this,Aa)}return this};
O.prototype.emitReserved=O.prototype.emit;O.prototype.listeners=function(ya){return this._callbacks=this._callbacks||{},this._callbacks['$'+ya]||[]};O.prototype.hasListeners=function(ya){return!!this.listeners(ya).length};var Ea='undefined'!=typeof self?self:'undefined'!=typeof window?window:Function('return this')(),Na=setTimeout,Ia=clearTimeout,Ja,Ua=function(ya){function Aa(g,h,b){var x;return P(this,Aa),(x=m.call(this,g)).description=h,x.context=b,x.type='TransportError',x}N(Aa,ya);var m=va(Aa);
return Aa}(G(Error));la=function(ya){function Aa(g){var h;return P(this,Aa),(h=m.call(this)).writable=!1,A(w(h),g),h.opts=g,h.query=g.query,h.readyState='',h.socket=g.socket,h}N(Aa,ya);var m=va(Aa);return ma(Aa,[{key:'onError',value:function(g,h,b){return za(ba(Aa.prototype),'emitReserved',this).call(this,'error',new Ua(g,h,b)),this}},{key:'open',value:function(){return'closed'!==this.readyState&&''!==this.readyState||(this.readyState='opening',this.doOpen()),this}},{key:'close',value:function(){return'opening'!==
this.readyState&&'open'!==this.readyState||(this.doClose(),this.onClose()),this}},{key:'send',value:function(g){'open'===this.readyState&&this.write(g)}},{key:'onOpen',value:function(){this.readyState='open';this.writable=!0;za(ba(Aa.prototype),'emitReserved',this).call(this,'open')}},{key:'onData',value:function(g){g=Da(g,this.socket.binaryType);this.onPacket(g)}},{key:'onPacket',value:function(g){za(ba(Aa.prototype),'emitReserved',this).call(this,'packet',g)}},{key:'onClose',value:function(g){this.readyState=
'closed';za(ba(Aa.prototype),'emitReserved',this).call(this,'close',g)}}]),Aa}(O);for(var pb='0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_'.split(''),ab=0,gb=0;64>gb;gb++);gb=!1;try{gb='undefined'!=typeof XMLHttpRequest&&'withCredentials'in new XMLHttpRequest}catch(ya){}var Ub=gb,Zb=null!=(new F({xdomain:!1})).responseType;gb=function(ya){function Aa(g){var h;if(P(this,Aa),(h=m.call(this,g)).polling=!1,'undefined'!=typeof location){var b='https:'===location.protocol,x=location.port;
x||=b?'443':'80';h.xd='undefined'!=typeof location&&g.hostname!==location.hostname||x!==g.port;h.xs=g.secure!==b}g=g&&g.forceBase64;return h.supportsBinary=Zb&&!g,h}N(Aa,ya);var m=va(Aa);return ma(Aa,[{key:'doOpen',value:function(){this.poll()}},{key:'pause',value:function(g){var h=this;this.readyState='pausing';var b=function(){h.readyState='paused';g()};if(this.polling||!this.writable){var x=0;this.polling&&(x++,this.once('pollComplete',function(){--x||b()}));this.writable||(x++,this.once('drain',
...
Aa}(la);var jb=function(ya){function Aa(g,h){var b;return P(this,Aa),A(w(b=m.call(this)),h),b.opts=h,b.method=h.method||'GET',b.uri=g,b.async=!1!==h.async,b.data=void 0!==h.data?h.data:null,b.create(),b}N(Aa,ya);var m=va(Aa);return ma(Aa,[{key:'create',value:function(){var g=this,h=M(this.opts,'agent','pfx','key','passphrase','cert','ca','ciphers','rejectUnauthorized','autoUnref');h.xdomain=!!this.opts.xd;h.xscheme=!!this.opts.xs;var b=this.xhr=new F(h);try{b.open(this.method,this.uri,this.async);
...
u,g)try{this.xhr.abort()}catch(h){}'undefined'!=typeof document&&delete Aa.requests[this.index];this.xhr=null}}},{key:'onLoad',value:function(){var g=this.xhr.responseText;null!==g&&(this.emitReserved('data',g),this.emitReserved('success'),this.cleanup())}},{key:'abort',value:function(){this.cleanup()}}]),Aa}(O);if(jb.requestsCount=0,jb.requests={},'undefined'!=typeof document)'function'==typeof attachEvent?attachEvent('onunload',v):'function'==typeof addEventListener&&addEventListener('onpagehide'in
Ea?'pagehide':'unload',v,!1);var Db='function'==typeof Promise&&'function'==typeof Promise.resolve?function(ya){return Promise.resolve().then(ya)}:function(ya,Aa){return Aa(ya,0)},rb=Ea.WebSocket||Ea.MozWebSocket,xb='undefined'!=typeof navigator&&'string'==typeof navigator.product&&'reactnative'===navigator.product.toLowerCase(),Ka={websocket:function(ya){function Aa(g){var h;return P(this,Aa),(h=m.call(this,g)).supportsBinary=!g.forceBase64,h}N(Aa,ya);var m=va(Aa);return ma(Aa,[{key:'doOpen',value:function(){if(this.check()){var g=
this.uri(),h=this.opts.protocols,b=xb?{}:M(this.opts,'agent','perMessageDeflate','pfx','key','passphrase','cert','ca','ciphers','rejectUnauthorized','localAddress','protocolVersion','origin','maxPayload','family','checkServerIdentity');this.opts.extraHeaders&&(b.headers=this.opts.extraHeaders);try{this.ws=xb?new rb(g,h,b):h?new rb(g,h):new rb(g)}catch(x){return this.emitReserved('error',x)}this.ws.binaryType=this.socket.binaryType||'arraybuffer';this.addEventListeners()}}},{key:'addEventListeners',
...
'['+this.opts.hostname+']':this.opts.hostname)+b+this.opts.path+(g.length?'?'+g:'')}},{key:'check',value:function(){return!!rb}},{key:'name',get:function(){return'websocket'}}]),Aa}(la),polling:gb},db=/^(?:(?![^:@]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/,Lb='source protocol authority userInfo user password host port relative path directory file query anchor'.split(' '),
Vb=function(ya){function Aa(g){var h,b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{};return P(this,Aa),h=m.call(this),g&&'object'===B(g)&&(b=g,g=null),g?(g=H(g),b.hostname=g.host,b.secure='https'===g.protocol||'wss'===g.protocol,b.port=g.port,g.query&&(b.query=g.query)):b.host&&(b.hostname=H(b.host).host),A(w(h),b),h.secure=null!=b.secure?b.secure:'undefined'!=typeof location&&'https:'===location.protocol,b.hostname&&!b.port&&(b.port=h.secure?'443':'80'),h.hostname=b.hostname||('undefined'!=
...
!1))),h.open(),h}N(Aa,ya);var m=va(Aa);return ma(Aa,[{key:'createTransport',value:function(g){var h=U({},this.opts.query);h.EIO=4;h.transport=g;this.id&&(h.sid=this.id);h=U({},this.opts.transportOptions[g],this.opts,{query:h,socket:this,hostname:this.hostname,secure:this.secure,port:this.port});return new Ka[g](h)}},{key:'open',value:function(){var g=this;if(this.opts.rememberUpgrade&&Aa.priorWebsocketSuccess&&-1!==this.transports.indexOf('websocket'))var h='websocket';else{if(0===this.transports.length)return void this.setTimeoutFn(function(){g.emitReserved('error',
...
function Domain(B,P){var V='undefined'!==typeof module&&module.exports?!1:!0,ma=!1;V&&(ma=!!window.MSInputMethodContext&&!!document.documentMode);'function'==typeof B&&(P=B,B=void 0);var U={filename:'../dist/public_suffix_list.dat',url:'https://publicsuffix.org/list/public_suffix_list.dat',alternativeUrl:'https://raw.githubusercontent.com/publicsuffix/list/master/public_suffix_list.dat',isCachingRequired:!1,isUpdating:!1},N=null,ba=null,Q=function(za,O,M){if('undefined'==typeof O)O=U;else for(let A in U)'undefined'==
typeof O[A]&&(O[A]=U[A]);V||(O.filename=__dirname+'/'+O.filename);V&&O.isCachingRequired&&(console.warn('[DOMAIN] `options.isCachingRequired` is only available for backend'),O.isCachingRequired=!1);N=O;if(M)return r(O,function(A){A?M(A):(console.debug('[DOMAIN] PSL Loaded'),M(A,za))});r(O);console.debug('[DOMAIN] PSL Loaded');return za},S=function(){},r=async function(za,O){var M=V||za.isCachingRequired?za.url:za.filename,A='undefined'!=typeof za.isUpdating?za.isUpdating:!1,D=null;if(V)if(ba&&!A)O(!1);
else if(window.fetch){D=A=null;try{A=await fetch(M),ba=D=await A.text()}catch(y){D=Error('[DOMAIN] Could not load PSL\n'+(y.stack||y.message||y));O(D);return}za.isUpdating=!1;O(!1)}else D=Error('[DOMAIN] Fetch API not supported'),O(D);else{M=!1;if('undefined'!=typeof fs.accessSync)try{fs.accessSync(za.filename,fs.constants.F_OK),M=!0}catch(y){M=!1;try{fs.lstatSync(za.filename).isSymbolicLink()&&(M=!0)}catch(z){}}else M=fs.existsSync(za.filename);M||(za.isCachingRequired=!0);if(za.isCachingRequired){M=
'curl -o '+za.filename+' '+za.url+' >/dev/null 2>&1';console.debug('[DOMAIN] Running: '+M);try{execSync(M)}catch(y){console.warn('[DOMAIN] could not fetch from `'+za.url+'`. Trying with `'+za.alternativeUrl+'`');M='curl -o '+za.filename+' '+za.alternativeUrl+' >/dev/null 2>&1';try{execSync(M)}catch(z){O(z);return}}var l=!1;nIntervId=setInterval(()=>{if('undefined'!=typeof fs.accessSync)try{fs.accessSync(za.filename,fs.constants.F_OK),l=!0}catch(y){l=!1;try{fs.lstatSync(za.filename).isSymbolicLink()&&
(l=!0)}catch(z){}}else l=fs.existsSync(za.filename);l&&(clearInterval(nIntervId),ba=fs.readFileSync(za.filename).toString(),O(!1))},200)}try{ba=fs.readFileSync(za.filename).toString(),O&&O(!1)}catch(y){console.warn('[DOMAIN] could not read from `'+za.filename+'`'),r(B,O)}}},G=function(za){N.isUpdating=!0;r(N,za)},w=async function(za){za='undefined'!=typeof za&&''!=za?za:os.hostname();if(/\./.test(za))return za;console.debug('[DOMAIN][getFQDN] UQDN: '+za);var O=null,M=null;O=await promisify(dns.lookup)(za,
{hints:dns.ADDRCONFIG||dns.V4MAPPED}).then(function(A){console.debug('[DOMAIN][getFQDN] IP: '+A.address);console.debug('[DOMAIN][getFQDN] FAMILY: '+A.family);return A}).catch(function(A){M=A});if(M)throw M;za=await promisify(dns.lookupService)(O.address,0).then(function(A){console.debug('[DOMAIN][getFQDN] FQDN: '+A.hostname);console.debug('[DOMAIN][getFQDN] Service: '+A.service);return A.hostname}).catch(function(A){});if(M)throw M;if(!/\./.test(za))throw Error('[DOMAIN][getFQDN] `'+za+'` is not a FQDN !');
return za},va={getRootDomain:function(za,O){'undefined'==typeof O&&(O=!1);var M=!1,A=!1,D=za.replace(/^(.*):\/\/|\/(.*)/g,''),l=D.split(/\./g).reverse(),y=l.length?l.length-1:0,z=ba.replace(/\/\/\s*(.*)\n|^\s*\n/gm,'').split(/\n/).filter(function(F,u,v){/[^a-z 0-9.]+/.test(F)&&(F=F.replace(/[^a-z 0-9.]+/g,'').replace(/^\./g,''));return/\./.test(F)&&!M&&(new RegExp('.'+F+'$')).test(D)?(M=!0,y=F.split(/\./g).length,v.splice(0,v.length),!1):F});D=l[y];0<y&&(l=l.splice(0,y),A=l[0],/:(.*)$/.test(A)&&(A=
A.replace(/:(.*)$/,'')),(A=M||!M&&-1<z.indexOf(A)?!0:!1)?1<y&&!M?(l.splice(2),D=l.reverse().join('.')):D+='.'+l.reverse().join('.'):1<y?(l.splice(2),D=l.reverse().join('.')):D+='.'+l.reverse().join('.'));/:(.*)$/.test(D)&&(D=D.replace(/:(.*)$/,''));console.debug('[DOMAIN] isSLD: '+M,za,' -> ',D);/^true$/i.test(O);return{value:D,isSLD:M,isRegisteredTldOrSld:A}}};V?va.onReady=S:(va.updatePSL=G,va.getFQDN=w);return V&&ma&&!window.fetch?(ma=document.createElement('script'),ma.type='text/javascript',ma.src=
...
jb.currentTarget.href+='?inheritedData='+encodeRFC5987ValueChars(JSON.stringify(pb)))}}),'undefined'!=typeof gina.events[Ea]&&gina.events[Ea]==Qa[la].id||W('link',Ea,Qa[la])));if(ka.hasForm)for(W=null,Qa=ha.getElementsByTagName('form'),la=0,Da=Qa.length;la<Da;++la)Qa[la].id&&'string'==typeof Qa[la]?W=Qa[la].id:(W=Qa[la].getAttribute('id')||'form.'+P.v4(),Qa[la].setAttribute('id',W),Qa[la].id=W),0>ka.$forms.indexOf(W)&&ka.$forms.push(W),Qa[la].close=M,z.isPopinContext=!0,z.validateFormById(Qa[la].getAttribute('id')),
