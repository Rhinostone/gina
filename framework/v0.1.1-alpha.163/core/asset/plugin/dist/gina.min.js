...
(function(D,R){function da(Ia,La){return La||''}function Ga(Ia){return'[object Function]'===T.call(Ia)}function L(Ia){return'[object Array]'===T.call(Ia)}function V(Ia,La){if(Ia){var Za;for(Za=0;Za<Ia.length&&(!Ia[Za]||!La(Ia[Za],Za,Ia));Za+=1);}}function pa(Ia,La){if(Ia){var Za;for(Za=Ia.length-1;-1<Za&&(!Ia[Za]||!La(Ia[Za],Za,Ia));--Za);}}function W(Ia,La){return sa.call(Ia,La)}function Y(Ia,La){return W(Ia,La)&&Ia[La]}function m(Ia,La){for(var Za in Ia)if(W(Ia,Za)&&La(Ia[Za],Za))break}function U(Ia,
La,Za,wb){La&&m(La,function(cb,Xa){if(Za||!W(Ia,Xa))!wb||'object'!==typeof cb||!cb||L(cb)||Ga(cb)||cb instanceof RegExp?Ia[Xa]=cb:(Ia[Xa]||(Ia[Xa]={}),U(Ia[Xa],cb,Za,wb))});return Ia}function x(Ia,La){return function(){return La.apply(Ia,arguments)}}function ma(Ia){throw Ia;}function Da(Ia){if(!Ia)return Ia;var La=D;V(Ia.split('.'),function(Za){La=La[Za]});return La}function S(Ia,La,Za,wb){La=Error(La+'\nhttps://requirejs.org/docs/errors.html#'+Ia);La.requireType=Ia;La.requireModules=wb;Za&&(La.originalError=
Za);return La}function I(){if(C&&'interactive'===C.readyState)return C;pa(document.getElementsByTagName('script'),function(Ia){if('interactive'===Ia.readyState)return C=Ia});return C}var y,F,p,C,E,N,u,r=/\/\*[\s\S]*?\*\/|([^:"'=]|^)\/\/.*$/mg,G=/[^.]\s*require\s*\(\s*["']([^'"\s]+)["']\s*\)/g,K=/\.js$/,A=/^\.\//;var O=Object.prototype;var T=O.toString,sa=O.hasOwnProperty,qa=!('undefined'===typeof window||'undefined'===typeof navigator||!window.document),Ea=!qa&&'undefined'!==typeof importScripts,
ua=qa&&'PLAYSTATION 3'===navigator.platform?/^complete$/:/^(complete|loaded)$/,za='undefined'!==typeof opera&&'[object Opera]'===opera.toString(),Ca={},na={},Ua=[],Na=!1;if('undefined'===typeof define){if('undefined'!==typeof requirejs){if(Ga(requirejs))return;na=requirejs;requirejs=void 0}'undefined'===typeof require||Ga(require)||(na=require,require=void 0);var Ra=requirejs=function(Ia,La,Za,wb){var cb='_';if(!L(Ia)&&'string'!==typeof Ia){var Xa=Ia;L(La)?(Ia=La,La=Za,Za=wb):Ia=[]}Xa&&Xa.context&&
(cb=Xa.context);(wb=Y(Ca,cb))||(wb=Ca[cb]=Ra.s.newContext(cb));Xa&&wb.configure(Xa);return wb.require(Ia,La,Za)};Ra.config=function(Ia){return Ra(Ia)};Ra.nextTick='undefined'!==typeof R?function(Ia){R(Ia,4)}:function(Ia){Ia()};require||=Ra;Ra.version='2.3.6';Ra.jsExtRegExp=/^\/|:|\?|\.js$/;Ra.isBrowser=qa;O=Ra.s={contexts:Ca,newContext:function(Ia){function La(v,fa,ta){var ka;fa=fa&&fa.split('/');var ia=Ha.map,Ba=ia&&ia['*'];if(v){v=v.split('/');var ya=v.length-1;Ha.nodeIdCompat&&K.test(v[ya])&&(v[ya]=
v[ya].replace(K,''));'.'===v[0].charAt(0)&&fa&&(ya=fa.slice(0,fa.length-1),v=ya.concat(v));ya=v;for(ka=0;ka<ya.length;ka++){var Ya=ya[ka];'.'===Ya?(ya.splice(ka,1),--ka):'..'===Ya&&0!==ka&&(1!==ka||'..'!==ya[2])&&'..'!==ya[ka-1]&&0<ka&&(ya.splice(ka-1,2),ka-=2)}v=v.join('/')}if(ta&&ia&&(fa||Ba)){ya=v.split('/');ka=ya.length;a:for(;0<ka;--ka){var Sa=ya.slice(0,ka).join('/');if(fa)for(Ya=fa.length;0<Ya;--Ya)if(ta=Y(ia,fa.slice(0,Ya).join('/')))if(ta=Y(ta,Sa)){var ob=ta;var xb=ka;break a}if(!Kb&&Ba&&
Y(Ba,Sa)){var Kb=Y(Ba,Sa);var eb=ka}}!ob&&Kb&&(ob=Kb,xb=eb);ob&&(ya.splice(0,xb,ob),v=ya.join('/'))}return(ob=Y(Ha.pkgs,v))?ob:v}function Za(v){qa&&V(document.getElementsByTagName('script'),function(fa){if(fa.getAttribute('data-requiremodule')===v&&fa.getAttribute('data-requirecontext')===Q.contextName)return fa.parentNode.removeChild(fa),!0})}function wb(v){var fa=Y(Ha.paths,v);if(fa&&L(fa)&&1<fa.length)return fa.shift(),Q.require.undef(v),Q.makeRequire(null,{skipMap:!0})([v]),!0}function cb(v){var fa=
v?v.indexOf('!'):-1;if(-1<fa){var ta=v.substring(0,fa);v=v.substring(fa+1,v.length)}return[ta,v]}function Xa(v,fa,ta,ka){var ia=null,Ba=fa?fa.name:null,ya=v,Ya=!0,Sa='';v||(Ya=!1,v='_@r'+(z+=1));v=cb(v);ia=v[0];v=v[1];if(ia){ia=La(ia,Ba,ka);var ob=Y(n,ia)}if(v)if(ia)Sa=ta?v:ob&&ob.normalize?ob.normalize(v,function(Kb){return La(Kb,Ba,ka)}):-1===v.indexOf('!')?La(v,Ba,ka):v;else{Sa=La(v,Ba,ka);v=cb(Sa);ia=v[0];Sa=v[1];ta=!0;var xb=Q.nameToUrl(Sa)}ta=!ia||ob||ta?'':'_unnormalized'+(X+=1);return{prefix:ia,
name:Sa,parentMap:fa,unnormalized:!!ta,url:xb,originalName:ya,isDefine:Ya,id:(ia?ia+'!'+Sa:Sa)+ta}}function Cb(v){var fa=v.id,ta=Y(M,fa);ta||=M[fa]=new Q.Module(v);return ta}function Db(v,fa,ta){var ka=v.id,ia=Y(M,ka);if(!W(n,ka)||ia&&!ia.defineEmitComplete)if(ia=Cb(v),ia.error&&'error'===fa)ta(ia.error);else ia.on(fa,ta);else'defined'===fa&&ta(n[ka])}function Eb(v,fa){var ta=v.requireModules,ka=!1;if(fa)fa(v);else if(V(ta,function(ia){if(ia=Y(M,ia))ia.error=v,ia.events.error&&(ka=!0,ia.emit('error',
v))}),!ka)Ra.onError(v)}function vb(){Ua.length&&(V(Ua,function(v){var fa=v[0];'string'===typeof fa&&(Q.defQueueMap[fa]=!0);h.push(v)}),Ua=[])}function yb(v){delete M[v];delete e[v]}function Fb(v,fa,ta){var ka=v.map.id;v.error?v.emit('error',v.error):(fa[ka]=!0,V(v.depMaps,function(ia,Ba){ia=ia.id;var ya=Y(M,ia);!ya||v.depMatched[Ba]||ta[ia]||(Y(fa,ia)?(v.defineDep(Ba,n[ia]),v.check()):Fb(ya,fa,ta))}),ta[ka]=!0)}function Qa(){var v,fa,ta=(v=1E3*Ha.waitSeconds)&&Q.startTime+v<(new Date).getTime(),
ka=[],ia=[],Ba=!1,ya=!0;if(!wa){wa=!0;m(e,function(Ya){var Sa=Ya.map,ob=Sa.id;if(Ya.enabled&&(Sa.isDefine||ia.push(Ya),!Ya.error))if(!Ya.inited&&ta)wb(ob)?Ba=fa=!0:(ka.push(ob),Za(ob));else if(!Ya.inited&&Ya.fetched&&Sa.isDefine&&(Ba=!0,!Sa.prefix))return ya=!1});if(ta&&ka.length)return v=S('timeout','Load timeout for modules: '+ka,null,ka),v.contextName=Q.contextName,Eb(v);ya&&V(ia,function(Ya){Fb(Ya,{},{})});ta&&!fa||!Ba||!qa&&!Ea||xa||(xa=R(function(){xa=0;Qa()},50));wa=!1}}function Gb(v){W(n,
v[0])||Cb(Xa(v[0],null,!0)).init(v[1],v[2])}function Yb(v){v=v.currentTarget||v.srcElement;var fa=Q.onScriptLoad;v.detachEvent&&!za?v.detachEvent('onreadystatechange',fa):v.removeEventListener('load',fa,!1);fa=Q.onScriptError;v.detachEvent&&!za||v.removeEventListener('error',fa,!1);return{node:v,id:v&&v.getAttribute('data-requiremodule')}}function Zb(){for(vb();h.length;){var v=h.shift();if(null===v[0])return Eb(S('mismatch','Mismatched anonymous define() module: '+v[v.length-1]));Gb(v)}Q.defQueueMap=
{}}var wa,xa,Ha={waitSeconds:7,baseUrl:'./',paths:{},bundles:{},pkgs:{},shim:{},config:{}},M={},e={},b={},h=[],n={},w={},q={},z=1,X=1;var P={require:function(v){return v.require?v.require:v.require=Q.makeRequire(v.map)},exports:function(v){v.usingExports=!0;if(v.map.isDefine)return v.exports?n[v.map.id]=v.exports:v.exports=n[v.map.id]={}},module:function(v){return v.module?v.module:v.module={id:v.map.id,uri:v.map.url,config:function(){return Y(Ha.config,v.map.id)||{}},exports:v.exports||(v.exports=
...
this.map.id;var fa=this.depExports;var ta=this.exports,ka=this.factory;if(!this.inited)W(Q.defQueueMap,v)||this.fetch();else if(this.error)this.emit('error',this.error);else if(!this.defining){this.defining=!0;if(1>this.depCount&&!this.defined){if(Ga(ka)){if(this.events.error&&this.map.isDefine||Ra.onError!==ma)try{ta=Q.execCb(v,ka,fa,ta)}catch(ya){var ia=ya}else ta=Q.execCb(v,ka,fa,ta);this.map.isDefine&&void 0===ta&&((fa=this.module)?ta=fa.exports:this.usingExports&&(ta=this.exports));if(ia)return ia.requireMap=
this.map,ia.requireModules=this.map.isDefine?[this.map.id]:null,ia.requireType=this.map.isDefine?'define':'require',Eb(this.error=ia)}else ta=ka;this.exports=ta;if(this.map.isDefine&&!this.ignore&&(n[v]=ta,Ra.onResourceLoad)){var Ba=[];V(this.depMaps,function(ya){Ba.push(ya.normalizedMap||ya)});Ra.onResourceLoad(Q,this.map,Ba)}yb(v);this.defined=!0}this.defining=!1;this.defined&&!this.defineEmitted&&(this.defineEmitted=!0,this.emit('defined',this.exports),this.defineEmitComplete=!0)}}},callPlugin:function(){var v=
this.map,fa=v.id,ta=Xa(v.prefix);this.depMaps.push(ta);Db(ta,'defined',x(this,function(ka){var ia=Y(q,this.map.id),Ba=this.map.name,ya=this.map.parentMap?this.map.parentMap.name:null,Ya=Q.makeRequire(v.parentMap,{enableBuildCallback:!0});if(this.map.unnormalized){ka.normalize&&(Ba=ka.normalize(Ba,function(xb){return La(xb,ya,!0)})||'');var Sa=Xa(v.prefix+'!'+Ba,this.map.parentMap,!0);Db(Sa,'defined',x(this,function(xb){this.map.normalizedMap=Sa;this.init([],function(){return xb},null,{enabled:!0,
ignore:!0})}));if(ka=Y(M,Sa.id)){this.depMaps.push(Sa);if(this.events.error)ka.on('error',x(this,function(xb){this.emit('error',xb)}));ka.enable()}}else if(ia)this.map.url=Q.nameToUrl(ia),this.load();else{var ob=x(this,function(xb){this.init([],function(){return xb},null,{enabled:!0})});ob.error=x(this,function(xb){this.inited=!0;this.error=xb;xb.requireModules=[fa];m(M,function(Kb){0===Kb.map.id.indexOf(fa+'_unnormalized')&&yb(Kb.map.id)});Eb(xb)});ob.fromText=x(this,function(xb,Kb){var eb=v.name,
zb=Xa(eb),Vb=Na;Kb&&(xb=Kb);Vb&&(Na=!1);Cb(zb);W(Ha.config,fa)&&(Ha.config[eb]=Ha.config[fa]);try{Ra.exec(xb)}catch(Wa){return Eb(S('fromtexteval','fromText eval for '+fa+' failed: '+Wa,Wa,[fa]))}Vb&&(Na=!0);this.depMaps.push(zb);Q.completeLoad(eb);Ya([eb],ob)});ka.load(v.name,Ya,ob,Ha)}}));Q.enable(ta,this);this.pluginMaps[ta.id]=ta},enable:function(){e[this.map.id]=this;this.enabling=this.enabled=!0;V(this.depMaps,x(this,function(v,fa){var ta;if('string'===typeof v){v=Xa(v,this.map.isDefine?this.map:
...
ia.location&&(Ha.paths[Ba]=ia.location);Ha.pkgs[Ba]=ia.name+'/'+(ia.main||'main').replace(A,'').replace(K,'')});m(M,function(ia,Ba){ia.inited||ia.map.unnormalized||(ia.map=Xa(Ba,null,!0))});(v.deps||v.callback)&&Q.require(v.deps||[],v.callback)},makeShimExports:function(v){return function(){var fa;v.init&&(fa=v.init.apply(D,arguments));return fa||v.exports&&Da(v.exports)}},makeRequire:function(v,fa){function ta(ka,ia,Ba){var ya;fa.enableBuildCallback&&ia&&Ga(ia)&&(ia.__requireJsBuild=!0);if('string'===
typeof ka){if(Ga(ia))return Eb(S('requireargs','Invalid require call'),Ba);if(v&&W(P,ka))return P[ka](M[v.id]);if(Ra.get)return Ra.get(Q,ka,v,ta);var Ya=Xa(ka,v,!1,!0);Ya=Ya.id;return W(n,Ya)?n[Ya]:Eb(S('notloaded','Module name "'+Ya+'" has not been loaded yet for context: '+Ia+(v?'':'. Use require([])')))}Zb();Q.nextTick(function(){Zb();ya=Cb(Xa(null,v));ya.skipMap=fa.skipMap;ya.init(ka,ia,Ba,{enabled:!0});Qa()});return ta}fa=fa||{};U(ta,{isBrowser:qa,toUrl:function(ka){var ia=ka.lastIndexOf('.'),
Ba=ka.split('/')[0];if(-1!==ia&&('.'!==Ba&&'..'!==Ba||1<ia)){var ya=ka.substring(ia,ka.length);ka=ka.substring(0,ia)}return Q.nameToUrl(La(ka,v&&v.id,!0),ya,!0)},defined:function(ka){return W(n,Xa(ka,v,!1,!0).id)},specified:function(ka){ka=Xa(ka,v,!1,!0).id;return W(n,ka)||W(M,ka)}});v||(ta.undef=function(ka){vb();var ia=Xa(ka,v,!0),Ba=Y(M,ka);Ba.undefed=!0;Za(ka);delete n[ka];delete w[ia.url];delete b[ka];pa(h,function(ya,Ya){ya[0]===ka&&h.splice(Ya,1)});delete Q.defQueueMap[ka];Ba&&(Ba.events.defined&&
(b[ka]=Ba.events),yb(ka))});return ta},enable:function(v){Y(M,v.id)&&Cb(v).enable()},completeLoad:function(v){var fa=Y(Ha.shim,v)||{},ta=fa.exports;for(vb();h.length;){var ka=h.shift();if(null===ka[0]){ka[0]=v;if(ia)break;var ia=!0}else ka[0]===v&&(ia=!0);Gb(ka)}Q.defQueueMap={};ka=Y(M,v);if(!ia&&!W(n,v)&&ka&&!ka.inited)if(!Ha.enforceDefine||ta&&Da(ta))Gb([v,fa.deps||[],fa.exportsFn]);else return wb(v)?void 0:Eb(S('nodefine','No define call for '+v,null,[v]));Qa()},nameToUrl:function(v,fa,ta){var ka,
ia;(ka=Y(Ha.pkgs,v))&&(v=ka);if(ka=Y(q,v))return Q.nameToUrl(ka,fa,ta);if(Ra.jsExtRegExp.test(v))ka=v+(fa||'');else{ka=Ha.paths;var Ba=v.split('/');for(ia=Ba.length;0<ia;--ia){var ya=Ba.slice(0,ia).join('/');if(ya=Y(ka,ya)){L(ya)&&(ya=ya[0]);Ba.splice(0,ia,ya);break}}ka=Ba.join('/');ka+=fa||(/^data:|^blob:|\?/.test(ka)||ta?'':'.js');ka=('/'===ka.charAt(0)||ka.match(/^[\w\+\.\-]+:/)?'':Ha.baseUrl)+ka}return Ha.urlArgs&&!/^blob:/.test(ka)?ka+Ha.urlArgs(v,ka):ka},load:function(v,fa){Ra.load(Q,v,fa)},
execCb:function(v,fa,ta,ka){return fa.apply(ka,ta)},onScriptLoad:function(v){if('load'===v.type||ua.test((v.currentTarget||v.srcElement).readyState))C=null,v=Yb(v),Q.completeLoad(v.id)},onScriptError:function(v){var fa=Yb(v);if(!wb(fa.id)){var ta=[];m(M,function(ka,ia){0!==ia.indexOf('_@r')&&V(ka.depMaps,function(Ba){if(Ba.id===fa.id)return ta.push(ia),!0})});return Eb(S('scripterror','Script error for "'+fa.id+(ta.length?'", needed by: '+ta.join(', '):'"'),v,[fa.id]))}}};Q.require=Q.makeRequire();
return Q}};Ra({});V(['toUrl','undef','defined','specified'],function(Ia){Ra[Ia]=function(){var La=Ca._;return La.require[Ia].apply(La,arguments)}});if(qa){var pb=O.head=document.getElementsByTagName('head')[0];if(y=document.getElementsByTagName('base')[0])pb=O.head=y.parentNode}Ra.onError=ma;Ra.createNode=function(Ia,La,Za){La=Ia.xhtml?document.createElementNS('http://www.w3.org/1999/xhtml','html:script'):document.createElement('script');La.type=Ia.scriptType||'text/javascript';La.charset='utf-8';
La.async=!0;return La};Ra.load=function(Ia,La,Za){var wb=Ia&&Ia.config||{};if(qa){var cb=Ra.createNode(wb,La,Za);cb.setAttribute('data-requirecontext',Ia.contextName);cb.setAttribute('data-requiremodule',La);!cb.attachEvent||cb.attachEvent.toString&&0>cb.attachEvent.toString().indexOf('[native code')||za?(cb.addEventListener('load',Ia.onScriptLoad,!1),cb.addEventListener('error',Ia.onScriptError,!1)):(Na=!0,cb.attachEvent('onreadystatechange',Ia.onScriptLoad));cb.src=Za;if(wb.onNodeCreated)wb.onNodeCreated(cb,
wb,La,Za);E=cb;y?pb.insertBefore(cb,y):pb.appendChild(cb);E=null;return cb}if(Ea)try{R(function(){},0),importScripts(Za),Ia.completeLoad(La)}catch(Xa){Ia.onError(S('importscripts','importScripts failed for '+La+' at '+Za,Xa,[La]))}};qa&&!na.skipDataMain&&pa(document.getElementsByTagName('script'),function(Ia){pb||(pb=Ia.parentNode);if(F=Ia.getAttribute('data-main'))return N=F,na.baseUrl||-1!==N.indexOf('!')||(p=N.split('/'),N=p.pop(),u=p.length?p.join('/')+'/':'./',na.baseUrl=u),N=N.replace(K,''),
Ra.jsExtRegExp.test(N)&&(N=F),na.deps=na.deps?na.deps.concat(N):[N],!0});define=function(Ia,La,Za){var wb;'string'!==typeof Ia&&(Za=La,La=Ia,Ia=null);L(La)||(Za=La,La=null);!La&&Ga(Za)&&(La=[],Za.length&&(Za.toString().replace(r,da).replace(G,function(Xa,Cb){La.push(Cb)}),La=(1===Za.length?['require']:['require','exports','module']).concat(La)));if(Na&&(wb=E||I())){Ia||=wb.getAttribute('data-requiremodule');var cb=Ca[wb.getAttribute('data-requirecontext')]}cb?(cb.defQueue.push([Ia,La,Za]),cb.defQueueMap[Ia]=
!0):Ua.push([Ia,La,Za])};define.amd={jQuery:!0};Ra.exec=function(Ia){return eval(Ia)};Ra(na)}})(this,'undefined'===typeof setTimeout?void 0:setTimeout);define('requireLib',function(){});
!function(D,R){'object'==typeof exports&&'undefined'!=typeof module?R(exports):'function'==typeof define&&define.amd?define('vendor/uuid',['exports'],R):R((D=D||self).uuid={})}(this,function(D){function R(){if(!m)throw Error('crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported');return m(U)}function da(p,C){C=C||0;var E=Da;return[E[p[C++]],E[p[C++]],E[p[C++]],E[p[C++]],'-',E[p[C++]],E[p[C++]],'-',E[p[C++]],E[p[C++]],'-',E[p[C++]],E[p[C++]],'-',
E[p[C++]],E[p[C++]],E[p[C++]],E[p[C++]],E[p[C++]],E[p[C++]]].join('')}function Ga(p,C,E){var N=function(u,r,G,K){K=G&&K||0;if('string'==typeof u&&(u=function(A){A=unescape(encodeURIComponent(A));for(var O=Array(A.length),T=0;T<A.length;T++)O[T]=A.charCodeAt(T);return O}(u)),'string'==typeof r&&(r=function(A){var O=[];return A.replace(/[a-fA-F0-9]{2}/g,function(T){O.push(parseInt(T,16))}),O}(r)),!Array.isArray(u))throw TypeError('value must be an array of bytes');if(!Array.isArray(r)||16!==r.length)throw TypeError('namespace must be uuid string or an Array of 16 byte values');
u=E(r.concat(u));if(u[6]=15&u[6]|C,u[8]=63&u[8]|128,G)for(r=0;16>r;++r)G[K+r]=u[r];return G||da(u)};try{N.name=p}catch(u){}return N.DNS='6ba7b810-9dad-11d1-80b4-00c04fd430c8',N.URL='6ba7b811-9dad-11d1-80b4-00c04fd430c8',N}function L(p,C){var E=(65535&p)+(65535&C);return(p>>16)+(C>>16)+(E>>16)<<16|65535&E}function V(p,C,E,N,u,r){return L((G=L(L(C,p),L(N,r)))<<(K=u)|G>>>32-K,E);var G,K}function pa(p,C,E,N,u,r,G){return V(C&E|~C&N,p,C,u,r,G)}function W(p,C,E,N,u,r,G){return V(C&N|E&~N,p,C,u,r,G)}function Y(p,
C,E,N,u,r,G){return V(E^(C|~N),p,C,u,r,G)}for(var m='undefined'!=typeof crypto&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto)||'undefined'!=typeof msCrypto&&'function'==typeof msCrypto.getRandomValues&&msCrypto.getRandomValues.bind(msCrypto),U=new Uint8Array(16),x,ma,Da=[],S=0;256>S;++S)Da[S]=(S+256).toString(16).substr(1);var I=0,y=0;S=Ga('v3',48,function(p){if('string'==typeof p){var C=unescape(encodeURIComponent(p));p=Array(C.length);for(var E=0;E<C.length;E++)p[E]=C.charCodeAt(E)}return function(N){var u,
r=[],G=32*N.length;for(u=0;u<G;u+=8){var K=N[u>>5]>>>u%32&255;K=parseInt('0123456789abcdef'.charAt(K>>>4&15)+'0123456789abcdef'.charAt(15&K),16);r.push(K)}return r}(function(N,u){N[u>>5]|=128<<u%32;N[14+(u+64>>>9<<4)]=u;var r=1732584193,G=-271733879,K=-1732584194,A=271733878;for(u=0;u<N.length;u+=16){var O=r;var T=G;var sa=K;var qa=A;r=pa(r,G,K,A,N[u],7,-680876936);A=pa(A,r,G,K,N[u+1],12,-389564586);K=pa(K,A,r,G,N[u+2],17,606105819);G=pa(G,K,A,r,N[u+3],22,-1044525330);r=pa(r,G,K,A,N[u+4],7,-176418897);
A=pa(A,r,G,K,N[u+5],12,1200080426);K=pa(K,A,r,G,N[u+6],17,-1473231341);G=pa(G,K,A,r,N[u+7],22,-45705983);r=pa(r,G,K,A,N[u+8],7,1770035416);A=pa(A,r,G,K,N[u+9],12,-1958414417);K=pa(K,A,r,G,N[u+10],17,-42063);G=pa(G,K,A,r,N[u+11],22,-1990404162);r=pa(r,G,K,A,N[u+12],7,1804603682);A=pa(A,r,G,K,N[u+13],12,-40341101);K=pa(K,A,r,G,N[u+14],17,-1502002290);G=pa(G,K,A,r,N[u+15],22,1236535329);r=W(r,G,K,A,N[u+1],5,-165796510);A=W(A,r,G,K,N[u+6],9,-1069501632);K=W(K,A,r,G,N[u+11],14,643717713);G=W(G,K,A,r,N[u],
...
K,A,r,N[u+9],21,-343485551);r=L(r,O);G=L(G,T);K=L(K,sa);A=L(A,qa)}return[r,G,K,A]}(function(N){var u,r=[];r[(N.length>>2)-1]=void 0;for(u=0;u<r.length;u+=1)r[u]=0;var G=8*N.length;for(u=0;u<G;u+=8)r[u>>5]|=(255&N[u/8])<<u%32;return r}(p),8*p.length))});var F=Ga('v5',80,function(p){var C=[1518500249,1859775393,2400959708,3395469782],E=[1732584193,4023233417,2562383102,271733878,3285377520];if('string'==typeof p){var N=unescape(encodeURIComponent(p));p=Array(N.length);for(var u=0;u<N.length;u++)p[u]=
N.charCodeAt(u)}p.push(128);N=Math.ceil((p.length/4+2)/16);var r=Array(N);for(u=0;u<N;u++){r[u]=Array(16);for(var G=0;16>G;G++)r[u][G]=p[64*u+4*G]<<24|p[64*u+4*G+1]<<16|p[64*u+4*G+2]<<8|p[64*u+4*G+3]}r[N-1][14]=8*(p.length-1)/Math.pow(2,32);r[N-1][14]=Math.floor(r[N-1][14]);r[N-1][15]=8*(p.length-1)&4294967295;for(u=0;u<N;u++){p=Array(80);for(G=0;16>G;G++)p[G]=r[u][G];for(G=16;80>G;G++){var K=p[G-3]^p[G-8]^p[G-14]^p[G-16];p[G]=K<<1|K>>>31}K=E[0];var A=E[1],O=E[2],T=E[3],sa=E[4];for(G=0;80>G;G++){var qa=
Math.floor(G/20),Ea=K<<5|K>>>27;a:{switch(qa){case 0:var ua=A&O^~A&T;break a;case 1:ua=A^O^T;break a;case 2:ua=A&O^A&T^O&T;break a;case 3:ua=A^O^T;break a}ua=void 0}qa=Ea+ua+sa+C[qa]+p[G]>>>0;sa=T;T=O;O=(A<<30|A>>>2)>>>0;A=K;K=qa}E[0]=E[0]+K>>>0;E[1]=E[1]+A>>>0;E[2]=E[2]+O>>>0;E[3]=E[3]+T>>>0;E[4]=E[4]+sa>>>0}return[E[0]>>24&255,E[0]>>16&255,E[0]>>8&255,255&E[0],E[1]>>24&255,E[1]>>16&255,E[1]>>8&255,255&E[1],E[2]>>24&255,E[2]>>16&255,E[2]>>8&255,255&E[2],E[3]>>24&255,E[3]>>16&255,E[3]>>8&255,255&
E[3],E[4]>>24&255,E[4]>>16&255,E[4]>>8&255,255&E[4]]});D.v1=function(p,C,E){E=C&&E||0;var N=C||[],u=(p=p||{}).node||x,r=void 0!==p.clockseq?p.clockseq:ma;if(null==u||null==r){var G=p.random||(p.rng||R)();null==u&&(u=x=[1|G[0],G[1],G[2],G[3],G[4],G[5]]);null==r&&(r=ma=16383&(G[6]<<8|G[7]))}G=void 0!==p.msecs?p.msecs:(new Date).getTime();var K=void 0!==p.nsecs?p.nsecs:y+1,A=G-I+(K-y)/1E4;if(0>A&&void 0===p.clockseq&&(r=r+1&16383),(0>A||G>I)&&void 0===p.nsecs&&(K=0),1E4<=K)throw Error("uuid.v1(): Can't create more than 10M uuids/sec");
I=G;y=K;ma=r;p=(1E4*(268435455&(G+=122192928E5))+K)%4294967296;N[E++]=p>>>24&255;N[E++]=p>>>16&255;N[E++]=p>>>8&255;N[E++]=255&p;p=G/4294967296*1E4&268435455;N[E++]=p>>>8&255;N[E++]=255&p;N[E++]=p>>>24&15|16;N[E++]=p>>>16&255;N[E++]=r>>>8|128;N[E++]=255&r;for(r=0;6>r;++r)N[E+r]=u[r];return C||da(N)};D.v3=S;D.v4=function(p,C,E){E=C&&E||0;'string'==typeof p&&(C='binary'===p?Array(16):null,p=null);var N=(p=p||{}).random||(p.rng||R)();if(N[6]=15&N[6]|64,N[8]=63&N[8]|128,C)for(p=0;16>p;++p)C[E+p]=N[p];
return C||da(N)};D.v5=F;Object.defineProperty(D,'__esModule',{value:!0})});
function Merge(){var D=[],R=function(L,V){'undefined'==typeof L&&(L='undefined'!=typeof V&&Array.isArray(V)?[]:{});var pa=!1;'boolean'==typeof arguments[arguments.length-1]&&(pa=arguments[arguments.length-1]);var W=1,Y=arguments.length,m,U;if('object'!==typeof L&&'function'!==typeof L)L=pa?'undefined'==typeof arguments[2]?arguments[1]:arguments[2]:'undefined'==typeof arguments[0]?arguments[1]:arguments[0];else for(;W<Y;++W)if('boolean'!=typeof arguments[W]&&null!=(m=arguments[W])){if('object'!=typeof m){L=
m;break}if(Array.isArray(m)&&Array.isArray(L))L=da(m,L,pa);else for(var x in m){L||={name:null};var ma=L[x];var Da=m[x];if(L!==Da)if(Da&&(Ga(Da)||(U=Array.isArray(Da)))){var S=!1;if(U){U=!1;if(ma&&Array.isArray(ma))var I=ma||[];else if(Ga(ma)){I=ma||{};L[x]=I;continue}else I=[];D=I;I=da(Da,I,pa);L[x]=I}else{I=ma&&Ga(ma)?ma:null;if(!I){S=!0;I={};for(var y in Da)I[y]=Da[y]}if(pa){for(y in Da)'undefined'!=typeof Da[y]?Array.isArray(Da[y])&&Array.isArray(I[y])?I[y]=da(Da[y],I[y],pa):I[y]=Da[y]:Array.isArray(Da[y])&&
Array.isArray(I[y])&&(I[y]=da(Da[y],I[y],pa));L[x]=I}else{for(y in Da)'undefined'==typeof I[y]?Array.isArray(Da[y])&&Array.isArray(I[y])?I[y]=da(Da[y],I[y],pa):I[y]=Da[y]:Array.isArray(Da[y])&&Array.isArray(I[y])&&(I[y]=da(Da[y],I[y],pa));'boolean'==typeof ma||S?S&&(L[x]=I):L[x]=R(I,Da,pa)}}}else void 0!==Da&&(L[x]='undefined'==typeof ma||null==ma||ma===Da||pa?Da:ma)}}D=[];return L},da=function(L,V,pa){D=[];var W=[],Y=R.getKeyComparison();if(/^true$/i.test(pa)){if('object'==typeof L[0]&&'undefined'!=
typeof L[0][Y]&&'object'==typeof V[0]&&'undefined'!=typeof V[0][Y]){D=Array.isArray(V)?Array.from(V):JSON.clone(V);var m=0;for(pa=D.length;m<pa;++m)W.push(D[m][Y]);pa=JSON.clone(L);var U=0;m=0;L=pa.length;for(var x=Da||0,ma=V.length;x<ma;++x)a:for(m=m||0;m<L;++m)if(pa[m][Y]===V[x][Y]){-1<W.indexOf(pa[m][Y])?(D[U]=pa[m],++U):-1==W.indexOf(pa[m][Y])&&(W.push(pa[m][Y]),D[U]=pa[m],++U);break a}else-1==W.indexOf(pa[m][Y])&&(W.push(pa[m][Y]),D.push(pa[m]));return D}return Array.isArray(L)&&0==L.length||
'undefined'==typeof L?V:L}if(0==L.length&&0<V.length)return D=V;if(0==V.length&&0<L.length)for(m=0;m<L.length;++m)V.push(L[m]);if(0==D.length&&0<V.length)for(m=0;m<V.length;++m)'object'!=typeof V[m]&&-1==D.indexOf(V[m])&&D.push(V[m]);if(0<V.length){if('undefined'!=typeof L[0]&&'object'==typeof L[0]&&null!=L[0]&&'undefined'!=typeof L[0][Y]&&'object'==typeof V[0]&&'undefined'!=typeof V[0][Y]){D=Array.isArray(V)?Array.from(V):JSON.clone(V);pa=JSON.clone(L);var Da=null;m=0;for(L=D.length;m<L;++m)W.push(D[m][Y]);
for(m=0;m<L;++m)a:for(x=Da||0,ma=pa.length;x<ma;++x)if(null!=pa[x]&&'undefined'!=typeof pa[x][Y]&&pa[x][Y]!==D[m][Y]){if(-1==W.indexOf(pa[x][Y])){D.push(pa[x]);W.push(pa[x][Y]);Da=x+1;L<ma&&++L;break a}}else if(null!=pa[x]&&'undefined'!=typeof pa[x][Y]&&pa[x][Y]===D[m][Y])Da=x+1;else break a;return D}for(m=0;m<L.length;++m)if(-1<V.indexOf(L[m])&&pa)V.splice(V.indexOf(L[m]),1,L[m]);else if('undefined'==typeof D[m]&&'object'==typeof L[m])for(U in D=V,'undefined'==typeof D[m]&&(D[m]={}),L[m])D[m].hasOwnProperty(U)||
(D[m][U]=L[m][U]);else!pa&&-1<D.indexOf(L[m])&&'number'==typeof L[m]&&L[m]!==D[m]?D.push(L[m]):'undefined'==typeof V[m]||/null/i.test(V[m])||'undefined'==typeof V[m][Y]||'undefined'==typeof L[m]||'undefined'==typeof L[m][Y]||V[m][Y]!=L[m][Y]?-1==D.indexOf(L[m])&&D.push(L[m]):D[m]=pa?L[m]:V[m]}if(0<D.length&&0<V.length||0==D.length&&0==V.length)return D};da.prototype.setKeyComparison=function(L){this.keyComparison=L};var Ga=function(L){if(!L||'[object Object]'!=={}.toString.call(L)||L.nodeType||L.setInterval)return!1;
var V={}.hasOwnProperty,pa=V.call(L,'constructor');V='undefined'!=typeof L.constructor?V.call(L.constructor.prototype,'isPrototypeOf'):!1;return!L.constructor||pa||V?!0:!1};R.setKeyComparison=function(L){da.keyComparison=L;return R};R.getKeyComparison=function(){var L=da.keyComparison||'id';da.keyComparison='id';return L};return R}
'undefined'!==typeof module&&module.exports?('undefined'==typeof JSON.clone&&require('../../../helpers'),module.exports=Merge()):'function'===typeof define&&define.amd&&define('utils/merge',[],function(){return Merge()});function registerEvents(D,R){'undefined'==typeof gina&&'undefined'!=typeof window.gina&&(gina=window.gina);gina.registeredEvents[D]=R}function mergeEventProps(D,R){for(let da in R)'undefined'==typeof D[da]&&(D[da]=R[da]);return D}
function addListener(D,R,da,Ga){var L=function(W,Y,m,U){'undefined'!=typeof W.event&&W.event.isTouchSupported&&/^(click|mouseout|mouseover)/.test(m)&&-1==W.event[m].indexOf(Y)&&(W.event[m][W.event[m].length]=Y);'undefined'!=typeof Y&&null!=Y?Y.addEventListener?Y.addEventListener(m,U,!1):Y.attachEvent&&Y.attachEvent('on'+m,U):W.customEvent.addListener(m,U);gina.events[m]='undefined'!=typeof Y.id&&'object'!=typeof Y.id?Y.id:Y.getAttribute('id')},V=0,pa=null;if(Array.isArray(da))for(pa=da.length;V<pa;V++)L(D,
R,da[V],Ga);else if(Array.isArray(R))for(V=0,pa=R.length;V<pa;V++){let W=/\.$/.test(da)?da+R[V].id:da;L(D,R[V],W,Ga)}else da=/\.$/.test(da)?da+R.id:da,L(D,R,da,Ga)}
function triggerEvent(D,R,da,Ga,L){if('undefined'!=typeof R&&null!=R){D=!1;if(jQuery){var V=jQuery.fn.jquery.split(/\./);V=2<V.length?V.splice(0,2).join('.'):V.join('.');V='1.7'>=V?jQuery(R).data('events'):jQuery._data(jQuery(R)[0],'events');if(V='undefined'!=typeof V&&'undefined'!=typeof V[da]?!0:!1)V=jQuery.Event(da),jQuery(R).trigger(V,Ga),D=V.isDefaultPrevented()}window.CustomEvent||document.createEvent?(window.CustomEvent?V=new CustomEvent(da,{detail:Ga,bubbles:!0,cancelable:!0,target:R}):(V=
document.createEvent('HTMLEvents'),V.detail=Ga,V.target=R,V.initEvent(da,!0,!0),V.eventName=da),L&&(V=mergeEventProps(V,L)),'undefined'!=typeof V.defaultPrevented&&V.defaultPrevented&&(D=V.defaultPrevented),D||R.dispatchEvent(V)):document.createEventObject&&(V=document.createEventObject(),V.srcElement.id=R.id,V.detail=Ga,V.target=R,L&&(V=mergeEventProps(V,L)),R.fireEvent('on'+da,V))}else D.customEvent.fire(da,Ga)}
...
function setupXhr(D){var R=null;if(window.XMLHttpRequest)R=new XMLHttpRequest;else if(window.ActiveXObject)try{R=new ActiveXObject('Msxml2.XMLHTTP')}catch(Ga){try{R=new ActiveXObject('Microsoft.XMLHTTP')}catch(L){}}if('undefined'!=typeof D){if(!D.url||'undefined'==typeof D.url)throw Error('Missing `options.url`');'undefined'==typeof D.method&&(D.method='GET');D.method=D.method.toUpperCase();if(D.withCredentials){if('withCredentials'in R)D.isSynchrone?R.open(D.method,D.url,D.isSynchrone):R.open(D.method,
D.url);else if('undefined'!=typeof XDomainRequest)R=new XDomainRequest,R.open(D.method,D.url);else{result='CORS not supported: the server is missing the header `"Access-Control-Allow-Credentials": true` ';triggerEvent(gina,$target,'error.'+id,result);return}R.responseType='undefined'!=typeof D.responseType?D.responseType:'';R.withCredentials=!0}else D.isSynchrone?R.open(D.method,D.url,D.isSynchrone):R.open(D.method,D.url);for(var da in D.headers)'Content-Type'==da&&'undefined'!=typeof enctype&&null!=
enctype&&''!=enctype||R.setRequestHeader(da,D.headers[da])}return R}
function handleXhr(D,R,da,Ga){if(!D)throw Error('No `xhr` object initiated');var L=null,V=null,pa=null,W=null,Y=null,m=da.$link||null,U=da.$form||null,x=null;delete da.$link;delete da.$form;U||m?m?(m.target=document.getElementById(m.id),x=gina.link.target,Y=gina.link.id):(x=U.target,Y=x.getAttribute('id')):(x=R,Y=x.getAttribute('id'));var ma=m&&R.getAttribute('data-gina-link-event-on-success')||m&&R.getAttribute('data-gina-link-event-on-error')?!0:!1,Da=U&&x.getAttribute('data-gina-form-event-on-submit-success')||
U&&x.getAttribute('data-gina-form-event-on-submit-error')?!0:!1;Da&&U&&listenToXhrEvents(U,'form');R=R.getAttribute('enctype')||da.headers['Content-Type'];for(var S in da.headers)'Content-Type'==S&&'undefined'!=typeof R&&null!=R&&''!=R||D.setRequestHeader(S,da.headers[S]);D.withCredentials='undefined'!=typeof da.withCredentials?da.withCredentials:!1;D.onerror=function(I,y){I={status:D.status||500,error:'Transaction error: might be due to the server CORS settings.\nPlease, check the console for more details.'};
U&&(U.eventData.error=I);m&&(m.eventData.error=I);window.ginaToolbar.update('data-xhr',I,!0);triggerEvent(gina,x,'error.'+Y,I);Da&&triggerEvent(gina,x,'error.'+Y+'.hform',I);ma&&triggerEvent(gina,x,'error.'+Y+'.hlink',I)};D.onreadystatechange=function(I){I=/Google Inc/i.test(navigator.vendor)?50:0;2==D.readyState&&(V=/^attachment;/.test(D.getResponseHeader('Content-Disposition'))?!0:!1,!D.responseType&&V&&(D.responseType='blob'));if(4==D.readyState)if(L=null,pa=D.getResponseHeader('Content-Type'),
/^2/.test(D.status)){try{if(/blob/.test(D.responseType)||V){if('undefined'==typeof pa||null==pa)pa='application/octet-stream';L=new Blob([this.response],{type:pa});var y=document.createElement('a');y.style='display: none';document.body.appendChild(y);var F=window.URL.createObjectURL(L);y.href=F;var p=D.getResponseHeader('Content-Disposition');y.download=p.match('=(.*)')[0].substr(1);y.click();window.URL.revokeObjectURL(F);W={status:D.status,statusText:D.statusText,responseType:L.type,type:L.type,
size:L.size}}!W&&/\/json/.test(pa)&&(W=JSON.parse(D.responseText),'undefined'==typeof W.status&&(W.status=D.status||200));if(!W&&/\/html/.test(pa)&&(W={contentType:pa,content:D.responseText},'undefined'==typeof W.status&&(W.status=D.status),'undefined'!=typeof gina.popin&&gina.hasPopinHandler)){var C=gina.popin.getActivePopin();if(C){XHRData={};try{XHRData=(new DOMParser).parseFromString(W.content,'text/html').getElementById('gina-without-layout-xhr-data'),XHRData=JSON.parse(decodeURIComponent(XHRData.value)),
XHRView=(new DOMParser).parseFromString(W.content,'text/html').getElementById('gina-without-layout-xhr-view'),XHRView=JSON.parse(decodeURIComponent(XHRView.value)),gina&&typeof window.ginaToolbar&&'undefined'!=typeof XHRData&&window.ginaToolbar.update('data-xhr',XHRData),gina&&typeof window.ginaToolbar&&'undefined'!=typeof XHRView&&window.ginaToolbar.update('view-xhr',XHRView)}catch(r){throw r;}C.loadContent(W.content);W=XHRData;triggerEvent(gina,x,'success.'+Y,W);return}}W||(W=D.responseText);U&&
(U.eventData.success=W);XHRData=W;if(gina&&'object'==typeof window.ginaToolbar&&XHRData)try{'undefined'!=typeof XHRData&&/\/html/.test(pa)&&window.ginaToolbar.update('data-xhr',XHRData)}catch(r){throw r;}triggerEvent(gina,x,'success.'+Y,W);Da&&triggerEvent(gina,x,'success.'+Y+'.hform',W);ma&&triggerEvent(gina,x,'success.'+Y+'.hlink',W)}catch(r){W={status:422,error:r.message,stack:r.stack};U&&(U.eventData.error=W);XHRData=W;if(gina&&'object'==typeof window.ginaToolbar&&XHRData)try{'undefined'!=typeof XHRData&&
window.ginaToolbar.update('data-xhr',XHRData)}catch(G){throw G;}triggerEvent(gina,x,'error.'+Y,W);Da&&triggerEvent(gina,x,'error.'+Y+'.hform',W);ma&&triggerEvent(gina,x,'error.'+Y+'.hlink',W)}if('undefined'!=typeof W&&'undefined'!=typeof W.location)return window.location.hash='',W.location=/^http/.test(W.location)||/^\//.test(W.location)?W.location:location.protocol+'//'+W.location,setTimeout(()=>{window.location.href=W.location},I)}else if(0!=D.status)if(W={status:D.status,message:''},/blob/.test(D.responseType)){L=
new Blob([this.response],{type:'text/plain'});var E=new FileReader,N='';E.addEventListener('loadend',r=>{/string/i.test(typeof r.srcElement.result)?N+=r.srcElement.result:'object'==typeof r.srcElement.result?W=merge(W,r.srcElement.result):W.message+=r.srcElement.result;if(/^2/.test(E.readyState)){if(/^(\{|\[)/.test(N))try{W=merge(W,JSON.parse(N))}catch(A){W=merge(W,A)}W.message||delete W.message;U&&(U.eventData.error=W);if('undefined'!=typeof W&&'undefined'!=typeof W.error&&W.error.fields&&'object'==
typeof W.error.fields){r={};var G=0,K;for(K in W.error.fields)++G,r[K]={isApplicationValidationError:W.error.fields[K]};0<G&&handleErrorsDisplay(U.target,r)}XHRData=W;if(gina&&'object'==typeof window.ginaToolbar&&XHRData)try{window.ginaToolbar.update('data-xhr',XHRData)}catch(A){throw A;}triggerEvent(gina,x,'error.'+Y,W);Da&&triggerEvent(gina,x,'error.'+Y+'.hform',W);ma&&triggerEvent(gina,x,'error.'+Y+'.hlink',W)}});E.readAsText(L)}else{try{W=merge(W,JSON.parse(D.responseText))}catch(r){W=merge(W,
...
'error.'+Y+'.hlink',W)}};D.onprogress=function(I){var y='0';I.lengthComputable&&(y=I.loaded/I.total,y=parseInt(100*y));I={status:100,progress:y};U&&(U.eventData.onprogress=I);triggerEvent(gina,x,'progress.'+Y,I)};D.ontimeout=function(I){W={status:408,error:'Request Timeout'};U&&(U.eventData.ontimeout=W);triggerEvent(gina,x,'error.'+Y,W);Da&&triggerEvent(gina,x,'error.'+Y+'.hform',W);ma&&triggerEvent(gina,x,'error.'+Y+'.hlink',W)}}
function removeListener(D,R,da,Ga){'undefined'!=typeof D.event&&D.event.isTouchSupported&&/^(click|mouseout|mouseover)/.test(da)&&-1!=D.event[da].indexOf(R)&&D.event[da].splice(D.event[da].indexOf(R),1);if('undefined'!=typeof R&&null!=R)if(R.removeEventListener)if(Array.isArray(R))for(i=0,len=R.length;i<len;i++)D=/\.$/.test(da)?da+R[i].id:da,R.removeEventListener(D,Ga,!1),'undefined'!=typeof gina.events[D]&&delete gina.events[D];else da=/\.$/.test(da)?da+R.id:da,R.removeEventListener(da,Ga,!1);else{if(R.attachEvent)if(Array.isArray(R))for(i=
0,len=R.length;i<len;i++)D=/\.$/.test(da)?da+R[i].id:da,R.detachEvent('on'+D,Ga),'undefined'!=typeof gina.events[D]&&delete gina.events[D];else da=/\.$/.test(da)?da+R.id:da,R.detachEvent('on'+da,Ga)}else if(Array.isArray(R))for(i=0,len=R.length;i<len;i++){let L=/\.$/.test(da)?da+R[i].id:da;D.customEvent.removeListener(L,Ga);'undefined'!=typeof gina.events[L]&&delete gina.events[L]}else da=/\.$/.test(da)?da+R.id:da,D.customEvent.removeListener(da,Ga);'undefined'!=typeof gina.events[da]&&delete gina.events[da];
'undefined'!=typeof Ga&&Ga()}
function on(D,R){if(!this.plugin)throw Error('No `plugin` reference found for this event: `'+D);if(0>gina.registeredEvents[this.plugin].indexOf(D)&&!/^init$/.test(D)&&!/\.hform$/.test(D)&&!/\.hlink$/.test(D))R(Error('Event `'+D+'` not handled by ginaEventHandler'));else{var da=null,Ga=null;'undefined'!=typeof this.id&&'object'!=typeof this.id?(da=this.target||this,Ga=this.id):'undefined'!=typeof this.target?((da=this.target)||(da=this),Ga='undefined'!=typeof da.getAttribute?da.getAttribute('id'):
this.id):(da=this.target,Ga=instance.id);this.eventData&&!da.eventData&&(da.eventData=this.eventData);D=/\.(hform|hlink)$/.test(D)?/\.hform$/.test(D)?D.replace(/\.hform$/,'.'+Ga+'.hform'):D.replace(/\.hlink$/,'.'+Ga+'.hlink'):D+('.'+Ga);gina.events[D]||(addListener(gina,da,D,function(L){cancelEvent(L);var V=null;L.detail?V=L.detail:'undefined'!=typeof this.eventData.submit?V=this.eventData.submit:'undefined'!=typeof this.eventData.error?V=this.eventData.error:'undefined'!=typeof this.eventData.success&&
...
function PrototypesHelper(D){var R='undefined'!==typeof module&&module.exports?!1:!0,da=D||null;D=null;if('undefined'==typeof GINA_DIR&&!R&&'undefined'!=typeof process&&3<process.argv.length)if(/^\{/.test(process.argv[2]))D=JSON.parse(process.argv[2]).envVars;else if(/\.ctx$/.test(process.argv[2])){D=require('fs');var Ga=process.argv[2].split(/\-\-argv\-filename=/)[1];D=JSON.parse(D.readFileSync(Ga).toString()).envVars}if(da&&'undefined'!=typeof da&&'undefined'!=typeof da.dateFormat)for(let L in da.dateFormat)'undefined'==
typeof Date[L]&&Object.defineProperty(Date.prototype,L,{writable:!1,enumerable:!1,configurable:!0,value:function(){var V={0:this},pa=1,W;for(W in arguments)V[pa]=arguments[W],++pa;V.length=pa;return da.dateFormat[L].apply(this,V)}});'undefined'==typeof Array.clone&&Object.defineProperty(Array.prototype,'clone',{writable:!1,enumerable:!1,configurable:!0,value:function(){return this.slice(0)}});'undefined'!=typeof JSON.clone||R||('undefined'!=typeof D&&null!=D?JSON.clone=require(D.GINA_DIR+'/utils/prototypes.json_clone'):
(D||(R=process.cwd().match(/.*\/gina/)[0],require(R+'/utils/helper'),setEnvVar('GINA_DIR',R,!0),D=getEnvVars()),JSON.clone=require(getEnvVar('GINA_DIR')+'/utils/prototypes.json_clone')));'undefined'==typeof JSON.escape&&(JSON.escape=function(L){try{return L.replace(/\n/g,'\\n').replace(/\r/g,'\\r').replace(/\t/g,'\\t')}catch(V){throw V;}});'undefined'==typeof Array.toString&&(Array.prototype.toString=function(){return this.join()});'undefined'==typeof Array.inArray&&Object.defineProperty(Array.prototype,
'inArray',{writable:!1,enumerable:!1,configurable:!0,value:function(L){return-1!=this.indexOf(L)}});'undefined'==typeof Array.from&&Object.defineProperty(Array.prototype,'from',{writable:!1,enumerable:!1,configurable:!0,value:function(L){for(var V={},pa=[],W=L.length,Y=0,m=0;m<W;m++){var U=L[m];1!==V[U]&&(V[U]=1,pa[Y++]=U)}return pa}});'undefined'==typeof Object.count&&Object.defineProperty(Object.prototype,'count',{writable:!0,enumerable:!1,configurable:!0,value:function(){var L=0;try{this instanceof
String&&JSON.parse(this);for(var V in this)this.hasOwnProperty(V)&&++L;return L}catch(pa){return L}}});'undefined'!=typeof global&&'undefined'==typeof global.__stack&&Object.defineProperty(global,'__stack',{configurable:!0,get:function(){var L=Error.prepareStackTrace;Error.prepareStackTrace=function(pa,W){return W};var V=Error();Error.captureStackTrace(V,arguments.callee);V=V.stack;Error.prepareStackTrace=L;return V}})}
...
!function(D,R){'object'==typeof module&&'object'==typeof module.exports?module.exports=D.document?R(D,!0):function(da){if(!da.document)throw Error('jQuery requires a window with a document');return R(da)}:R(D)}('undefined'!=typeof window?window:this,function(D,R){function da(a){var c=!!a&&'length'in a&&a.length,g=b.type(a);return'function'===g||b.isWindow(a)?!1:'array'===g||0===c||'number'==typeof c&&0<c&&c-1 in a}function Ga(a,c,g){if(b.isFunction(c))return b.grep(a,function(k,l){return!!c.call(k,
l,k)!==g});if(c.nodeType)return b.grep(a,function(k){return k===c!==g});if('string'==typeof c){if(v.test(c))return b.filter(c,a,g);c=b.filter(c,a)}return b.grep(a,function(k){return-1<b.inArray(k,c)!==g})}function L(a,c){do a=a[c];while(a&&1!==a.nodeType);return a}function V(a){var c={};return b.each(a.match(Ba)||[],function(g,k){c[k]=!0}),c}function pa(){Qa.addEventListener?(Qa.removeEventListener('DOMContentLoaded',W),D.removeEventListener('load',W)):(Qa.detachEvent('onreadystatechange',W),D.detachEvent('onload',
W))}function W(){(Qa.addEventListener||'load'===D.event.type||'complete'===Qa.readyState)&&(pa(),b.ready())}function Y(a,c,g){if(void 0===g&&1===a.nodeType){var k='data-'+c.replace(xb,'-$1').toLowerCase();if(g=a.getAttribute(k),'string'==typeof g){try{g='true'===g?!0:'false'===g?!1:'null'===g?null:+g+''===g?+g:ob.test(g)?b.parseJSON(g):g}catch(l){}b.data(a,c,g)}else g=void 0}return g}function m(a){for(var c in a)if(('data'!==c||!b.isEmptyObject(a[c]))&&'toJSON'!==c)return!1;return!0}function U(a,
c,g,k){if(Sa(a)){var l,B,H=b.expando,aa=a.nodeType,la=aa?b.cache:a,Aa=aa?a[H]:a[H]&&H;if(Aa&&la[Aa]&&(k||la[Aa].data)||void 0!==g||'string'!=typeof c)return Aa||=aa?a[H]=Fb.pop()||b.guid++:H,la[Aa]||(la[Aa]=aa?{}:{toJSON:b.noop}),'object'!=typeof c&&'function'!=typeof c||(k?la[Aa]=b.extend(la[Aa],c):la[Aa].data=b.extend(la[Aa].data,c)),B=la[Aa],k||(B.data||(B.data={}),B=B.data),void 0!==g&&(B[b.camelCase(c)]=g),'string'==typeof c?(l=B[c],null==l&&(l=B[b.camelCase(c)])):l=B,l}}function x(a,c,g){if(Sa(a)){var k,
...
!c||b._data(c[k],'globalEval'))}function y(a){fb.test(a.type)&&(a.defaultChecked=a.checked)}function F(a,c,g,k,l){for(var B,H,aa,la,Aa,ra,Oa,Ta=a.length,ub=Da(c),bb=[],Lb=0;Ta>Lb;Lb++)if(H=a[Lb],H||0===H)if('object'===b.type(H))b.merge(bb,H.nodeType?[H]:H);else if(Ma.test(H)){la=la||ub.appendChild(c.createElement('div'));Aa=(ea.exec(H)||['',''])[1].toLowerCase();Oa=oa[Aa]||oa._default;la.innerHTML=Oa[1]+b.htmlPrefilter(H)+Oa[2];for(B=Oa[0];B--;)la=la.lastChild;if(!e.leadingWhitespace&&ha.test(H)&&
bb.push(c.createTextNode(ha.exec(H)[0])),!e.tbody)for(B=(H='table'!==Aa||$a.test(H)?'<table>'!==Oa[1]||$a.test(H)?0:la:la.firstChild)&&H.childNodes.length;B--;)b.nodeName(ra=H.childNodes[B],'tbody')&&!ra.childNodes.length&&H.removeChild(ra);b.merge(bb,la.childNodes);for(la.textContent='';la.firstChild;)la.removeChild(la.firstChild);la=ub.lastChild}else bb.push(c.createTextNode(H));la&&ub.removeChild(la);e.appendChecked||b.grep(S(bb,'input'),y);for(Lb=0;H=bb[Lb++];)if(k&&-1<b.inArray(H,k))l&&l.push(H);
else if(aa=b.contains(H.ownerDocument,H),la=S(ub.appendChild(H),'script'),aa&&I(la),g)for(B=0;H=la[B++];)Z.test(H.type||'')&&g.push(H);return ub}function p(){return!0}function C(){return!1}function E(){try{return Qa.activeElement}catch(a){}}function N(a,c,g,k,l,B){var H,aa;if('object'==typeof c){'string'!=typeof g&&(k=k||g,g=void 0);for(aa in c)N(a,aa,g,k,c[aa],B);return a}if(null==k&&null==l?(l=g,k=g=void 0):null==l&&('string'==typeof g?(l=k,k=void 0):(l=k,k=g,g=void 0)),!1===l)l=C;else if(!l)return a;
...
function K(a,c){if(1===c.nodeType&&b.hasData(a)){var g,k;var l=b._data(a);a=b._data(c,l);var B=l.events;if(B)for(g in delete a.handle,a.events={},B)for(l=0,k=B[g].length;k>l;l++)b.event.add(c,g,B[g][l]);a.data&&(a.data=b.extend({},a.data))}}function A(a,c,g,k){c=Yb.apply([],c);var l,B,H,aa=0,la=a.length,Aa=la-1,ra=c[0],Oa=b.isFunction(ra);if(Oa||1<la&&'string'==typeof ra&&!e.checkClone&&Hb.test(ra))return a.each(function(ub){var bb=a.eq(ub);Oa&&(c[0]=ra.call(this,ub,bb.html()));A(bb,c,g,k)});if(la&&
(H=F(c,a[0].ownerDocument,!1,a,k),l=H.firstChild,1===H.childNodes.length&&(H=l),l||k)){var Ta=b.map(S(H,'script'),r);for(B=Ta.length;la>aa;aa++)l=H,aa!==Aa&&(l=b.clone(l,!0,!0),B&&b.merge(Ta,S(l,'script'))),g.call(a[aa],l,aa);if(B)for(H=Ta[Ta.length-1].ownerDocument,b.map(Ta,G),aa=0;B>aa;aa++)l=Ta[aa],Z.test(l.type||'')&&!b._data(l,'globalEval')&&b.contains(H,l)&&(l.src?b._evalUrl&&b._evalUrl(l.src):b.globalEval((l.text||l.textContent||l.innerHTML||'').replace(Mb,'')));H=l=null}return a}function O(a,
...
c.write(),c.close(),g=T(a,c),Wb.detach()),Gc[a]=g),g}function qa(a,c){return{get:function(){return a()?void delete this.get:(this.get=c).apply(this,arguments)}}}function Ea(a){if(a in jd)return a;for(var c=a.charAt(0).toUpperCase()+a.slice(1),g=kd.length;g--;)if(a=kd[g]+c,a in jd)return a}function ua(a,c){for(var g,k,l,B=[],H=0,aa=a.length;aa>H;H++)k=a[H],k.style&&(B[H]=b._data(k,'olddisplay'),g=k.style.display,c?(B[H]||'none'!==g||(k.style.display=''),''===k.style.display&&Vb(k)&&(B[H]=b._data(k,
'olddisplay',sa(k.nodeName)))):(l=Vb(k),(g&&'none'!==g||!l)&&b._data(k,'olddisplay',l?g:b.css(k,'display'))));for(H=0;aa>H;H++)k=a[H],k.style&&(c&&'none'!==k.style.display&&''!==k.style.display||(k.style.display=c?B[H]||'':'none'));return a}function za(a,c,g){return(a=wd.exec(c))?Math.max(0,a[1]-(g||0))+(a[2]||'px'):c}function Ca(a,c,g,k,l){c=g===(k?'border':'content')?4:'width'===c?1:0;for(var B=0;4>c;c+=2)'margin'===g&&(B+=b.css(a,g+zb[c],!0,l)),k?('content'===g&&(B-=b.css(a,'padding'+zb[c],!0,
l)),'margin'!==g&&(B-=b.css(a,'border'+zb[c]+'Width',!0,l))):(B+=b.css(a,'padding'+zb[c],!0,l),'padding'!==g&&(B+=b.css(a,'border'+zb[c]+'Width',!0,l)));return B}function na(a,c,g){var k=!0,l='width'===c?a.offsetWidth:a.offsetHeight,B=xc(a),H=e.boxSizing&&'border-box'===b.css(a,'boxSizing',!1,B);if(0>=l||null==l){if(l=sc(a,c,B),(0>l||null==l)&&(l=a.style[c]),Ob.test(l))return l;k=H&&(e.boxSizingReliable()||l===a.style[c]);l=parseFloat(l)||0}return l+Ca(a,c,g||(H?'border':'content'),k,B)+'px'}function Ua(a,
c,g,k,l){return new Ua.prototype.init(a,c,g,k,l)}function Na(){return D.setTimeout(function(){Hc=void 0}),Hc=b.now()}function Ra(a,c){var g={height:a},k=0;for(c=c?1:0;4>k;k+=2-c){var l=zb[k];g['margin'+l]=g['padding'+l]=a}return c&&(g.opacity=g.width=a),g}function pb(a,c,g){for(var k,l=(La.tweeners[c]||[]).concat(La.tweeners['*']),B=0,H=l.length;H>B;B++)if(k=l[B].call(g,c,a))return k}function Ia(a,c){var g,k,l,B,H;for(g in a)if(k=b.camelCase(g),l=c[k],B=a[g],b.isArray(B)&&(l=B[1],B=a[g]=B[0]),g!==
k&&(a[k]=B,delete a[g]),H=b.cssHooks[k],H&&'expand'in H)for(g in B=H.expand(B),delete a[k],B)g in a||(a[g]=B[g],c[g]=l);else c[k]=l}function La(a,c,g){var k,l=0,B=La.prefilters.length,H=b.Deferred().always(function(){delete aa.elem}),aa=function(){if(k)return!1;var Aa=Hc||Na();Aa=Math.max(0,la.startTime+la.duration-Aa);for(var ra=1-(Aa/la.duration||0),Oa=0,Ta=la.tweens.length;Ta>Oa;Oa++)la.tweens[Oa].run(ra);return H.notifyWith(a,[la,ra,Aa]),1>ra&&Ta?Aa:(H.resolveWith(a,[la]),!1)},la=H.promise({elem:a,
props:b.extend({},c),opts:b.extend(!0,{specialEasing:{},easing:b.easing._default},g),originalProperties:c,originalOptions:g,startTime:Hc||Na(),duration:g.duration,tweens:[],createTween:function(Aa,ra){Aa=b.Tween(a,la.opts,Aa,ra,la.opts.specialEasing[Aa]||la.opts.easing);return la.tweens.push(Aa),Aa},stop:function(Aa){var ra=0,Oa=Aa?la.tweens.length:0;if(k)return this;for(k=!0;Oa>ra;ra++)la.tweens[ra].run(1);return Aa?(H.notifyWith(a,[la,1,0]),H.resolveWith(a,[la,Aa])):H.rejectWith(a,[la,Aa]),this}});
g=la.props;for(Ia(g,la.opts.specialEasing);B>l;l++)if(c=La.prefilters[l].call(la,a,g,la.opts))return b.isFunction(c.stop)&&(b._queueHooks(la.elem,la.opts.queue).stop=b.proxy(c.stop,c)),c;return b.map(g,pb,la),b.isFunction(la.opts.start)&&la.opts.start.call(a,la),b.fx.timer(b.extend(aa,{elem:a,anim:la,queue:la.opts.queue})),la.progress(la.opts.progress).done(la.opts.done,la.opts.complete).fail(la.opts.fail).always(la.opts.always)}function Za(a){return b.attr(a,'class')||''}function wb(a){return function(c,
...
g,k)}function Eb(){try{return new D.XMLHttpRequest}catch(a){}}function vb(){try{return new D.ActiveXObject('Microsoft.XMLHTTP')}catch(a){}}function yb(a){return b.isWindow(a)?a:9===a.nodeType?a.defaultView||a.parentWindow:!1}var Fb=[],Qa=D.document,Gb=Fb.slice,Yb=Fb.concat,Zb=Fb.push,wa=Fb.indexOf,xa={},Ha=xa.toString,M=xa.hasOwnProperty,e={},b=function(a,c){return new b.fn.init(a,c)},h=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,n=/^-ms-/,w=/-([\da-z])/gi,q=function(a,c){return c.toUpperCase()};b.fn=b.prototype=
...
xa[Ha.call(a)]||'object':typeof a},globalEval:function(a){a&&b.trim(a)&&(D.execScript||function(c){D.eval.call(D,c)})(a)},camelCase:function(a){return a.replace(n,'ms-').replace(w,q)},nodeName:function(a,c){return a.nodeName&&a.nodeName.toLowerCase()===c.toLowerCase()},each:function(a,c){var g,k=0;if(da(a))for(g=a.length;g>k&&!1!==c.call(a[k],k,a[k]);k++);else for(k in a)if(!1===c.call(a[k],k,a[k]))break;return a},trim:function(a){return null==a?'':(a+'').replace(h,'')},makeArray:function(a,c){c=
c||[];return null!=a&&(da(Object(a))?b.merge(c,'string'==typeof a?[a]:a):Zb.call(c,a)),c},inArray:function(a,c,g){if(c){if(wa)return wa.call(c,a,g);var k=c.length;for(g=g?0>g?Math.max(0,k+g):g:0;k>g;g++)if(g in c&&c[g]===a)return g}return-1},merge:function(a,c){for(var g=+c.length,k=0,l=a.length;g>k;)a[l++]=c[k++];if(g!==g)for(;void 0!==c[k];)a[l++]=c[k++];return a.length=l,a},grep:function(a,c,g){for(var k=[],l=0,B=a.length,H=!g;B>l;l++)g=!c(a[l],l),g!==H&&k.push(a[l]);return k},map:function(a,c,
...
b.each('Boolean Number String Function Array Date RegExp Object Error Symbol'.split(' '),function(a,c){xa['[object '+c+']']=c.toLowerCase()});var z=function(a){function c(J,ca,ja,va){var Fa,Ja,Pa,ab,Va=ca&&ca.ownerDocument,ib=ca?ca.nodeType:9;if(ja=ja||[],'string'!=typeof J||!J||1!==ib&&9!==ib&&11!==ib)return ja;if(!va&&((ca?ca.ownerDocument||ca:cc)!==qb&&Dc(ca),ca=ca||qb,hc)){if(11!==ib&&(ab=yd.exec(J)))if(Fa=ab[1])if(9===ib){if(!(Ja=ca.getElementById(Fa)))return ja;if(Ja.id===Fa)return ja.push(Ja),
ja}else{if(Va&&(Ja=Va.getElementById(Fa))&&oc(ca,Ja)&&Ja.id===Fa)return ja.push(Ja),ja}else{if(ab[2])return Cc.apply(ja,ca.getElementsByTagName(J)),ja;if((Fa=ab[3])&&Rb.getElementsByClassName&&ca.getElementsByClassName)return Cc.apply(ja,ca.getElementsByClassName(Fa)),ja}if(!(!Rb.qsa||dc[J+' ']||Xb&&Xb.test(J))){if(1!==ib){Va=ca;var kb=J}else if('object'!==ca.nodeName.toLowerCase()){(Pa=ca.getAttribute('id'))?Pa=Pa.replace(zd,'\\$&'):ca.setAttribute('id',Pa=Ab);ab=Pc(J);Fa=ab.length;for(Ja=ld.test(Pa)?
'#'+Pa:"[id='"+Pa+"']";Fa--;)ab[Fa]=Ja+' '+Ta(ab[Fa]);kb=ab.join(',');Va=Yc.test(J)&&ra(ca.parentNode)||ca}if(kb)try{return Cc.apply(ja,Va.querySelectorAll(kb)),ja}catch(gb){}finally{Pa===Ab&&ca.removeAttribute('id')}}}return ic(J.replace(Qc,'$1'),ca,ja,va)}function g(){function J(ja,va){return ca.push(ja+' ')>Ib.cacheLength&&delete J[ca.shift()],J[ja+' ']=va}var ca=[];return J}function k(J){return J[Ab]=!0,J}function l(J){var ca=qb.createElement('div');try{return!!J(ca)}catch(ja){return!1}finally{ca.parentNode&&
ca.parentNode.removeChild(ca)}}function B(J,ca){J=J.split('|');for(var ja=J.length;ja--;)Ib.attrHandle[J[ja]]=ca}function H(J,ca){var ja=ca&&J,va=ja&&1===J.nodeType&&1===ca.nodeType&&(~ca.sourceIndex||-2147483648)-(~J.sourceIndex||-2147483648);if(va)return va;if(ja)for(;ja=ja.nextSibling;)if(ja===ca)return-1;return J?1:-1}function aa(J){return function(ca){return'input'===ca.nodeName.toLowerCase()&&ca.type===J}}function la(J){return function(ca){var ja=ca.nodeName.toLowerCase();return('input'===ja||
'button'===ja)&&ca.type===J}}function Aa(J){return k(function(ca){return ca=+ca,k(function(ja,va){for(var Fa,Ja=J([],ja.length,ca),Pa=Ja.length;Pa--;)ja[Fa=Ja[Pa]]&&(ja[Fa]=!(va[Fa]=ja[Fa]))})})}function ra(J){return J&&'undefined'!=typeof J.getElementsByTagName&&J}function Oa(){}function Ta(J){for(var ca=0,ja=J.length,va='';ja>ca;ca++)va+=J[ca].value;return va}function ub(J,ca,ja){var va=ca.dir,Fa=ja&&'parentNode'===va,Ja=Sb++;return ca.first?function(Pa,ab,Va){for(;Pa=Pa[va];)if(1===Pa.nodeType||
Fa)return J(Pa,ab,Va)}:function(Pa,ab,Va){var ib,kb,gb,Nb=[$b,Ja];if(Va)for(;Pa=Pa[va];){if((1===Pa.nodeType||Fa)&&J(Pa,ab,Va))return!0}else for(;Pa=Pa[va];)if(1===Pa.nodeType||Fa){if(gb=Pa[Ab]||(Pa[Ab]={}),kb=gb[Pa.uniqueID]||(gb[Pa.uniqueID]={}),(ib=kb[va])&&ib[0]===$b&&ib[1]===Ja)return Nb[2]=ib[2];if(kb[va]=Nb,Nb[2]=J(Pa,ab,Va))return!0}}}function bb(J){return 1<J.length?function(ca,ja,va){for(var Fa=J.length;Fa--;)if(!J[Fa](ca,ja,va))return!1;return!0}:J[0]}function Lb(J,ca,ja,va,Fa){for(var Ja,
Pa=[],ab=0,Va=J.length,ib=null!=ca;Va>ab;ab++)(Ja=J[ab])&&(ja&&!ja(Ja,va,Fa)||(Pa.push(Ja),ib&&ca.push(ab)));return Pa}function lc(J,ca,ja,va,Fa,Ja){return va&&!va[Ab]&&(va=lc(va)),Fa&&!Fa[Ab]&&(Fa=lc(Fa,Ja)),k(function(Pa,ab,Va,ib){var kb,gb=[],Nb=[],ec=ab.length,bc;if(!(bc=Pa)){bc=ca||'*';for(var rb=Va.nodeType?[Va]:Va,tc=[],jc=0,rc=rb.length;rc>jc;jc++)c(bc,rb[jc],tc);bc=tc}bc=!J||!Pa&&ca?bc:Lb(bc,gb,J,Va,ib);rb=ja?Fa||(Pa?J:ec||va)?[]:ab:bc;if(ja&&ja(bc,rb,Va,ib),va){var fc=Lb(rb,Nb);va(fc,[],
Va,ib);for(Va=fc.length;Va--;)(kb=fc[Va])&&(rb[Nb[Va]]=!(bc[Nb[Va]]=kb))}if(Pa){if(Fa||J){if(Fa){fc=[];for(Va=rb.length;Va--;)(kb=rb[Va])&&fc.push(bc[Va]=kb);Fa(null,rb=[],fc,ib)}for(Va=rb.length;Va--;)(kb=rb[Va])&&-1<(fc=Fa?Ec(Pa,kb):gb[Va])&&(Pa[fc]=!(ab[fc]=kb))}}else rb=Lb(rb===ab?rb.splice(ec,rb.length):rb),Fa?Fa(null,ab,rb,ib):Cc.apply(ab,rb)})}function Ic(J){var ca,ja,va=J.length,Fa=Ib.relative[J[0].type];var Ja=Fa||Ib.relative[' '];for(var Pa=Fa?1:0,ab=ub(function(kb){return kb===ca},Ja,!0),
Va=ub(function(kb){return-1<Ec(ca,kb)},Ja,!0),ib=[function(kb,gb,Nb){kb=!Fa&&(Nb||gb!==Bb)||((ca=gb).nodeType?ab(kb,gb,Nb):Va(kb,gb,Nb));return ca=null,kb}];va>Pa;Pa++)if(Ja=Ib.relative[J[Pa].type])ib=[ub(bb(ib),Ja)];else{if(Ja=Ib.filter[J[Pa].type].apply(null,J[Pa].matches),Ja[Ab]){for(ja=++Pa;va>ja&&!Ib.relative[J[ja].type];ja++);return lc(1<Pa&&bb(ib),1<Pa&&Ta(J.slice(0,Pa-1).concat({value:' '===J[Pa-2].type?'*':''})).replace(Qc,'$1'),Ja,ja>Pa&&Ic(J.slice(Pa,ja)),va>ja&&Ic(J=J.slice(ja)),va>ja&&
Ta(J))}ib.push(Ja)}return bb(ib)}function mc(J,ca){var ja=0<ca.length,va=0<J.length,Fa=function(Ja,Pa,ab,Va,ib){var kb,gb,Nb=0,ec='0',bc=Ja&&[],rb=[],tc=Bb,jc=Ja||va&&Ib.find.TAG('*',ib),rc=$b+=null==tc?1:Math.random()||.1,fc=jc.length;for(ib&&(Bb=Pa===qb||Pa||ib);ec!==fc&&null!=(kb=jc[ec]);ec++){if(va&&kb){var Zc=0;for(Pa||kb.ownerDocument===qb||(Dc(kb),ab=!hc);gb=J[Zc++];)if(gb(kb,Pa||qb,ab)){Va.push(kb);break}ib&&($b=rc)}ja&&((kb=!gb&&kb)&&Nb--,Ja&&bc.push(kb))}if(Nb+=ec,ja&&ec!==Nb){for(Zc=0;gb=
ca[Zc++];)gb(bc,rb,Pa,ab);if(Ja){if(0<Nb)for(;ec--;)bc[ec]||rb[ec]||(rb[ec]=$c.call(Va));rb=Lb(rb)}Cc.apply(Va,rb);ib&&!Ja&&0<rb.length&&1<Nb+ca.length&&c.uniqueSort(Va)}return ib&&($b=rc,Bb=tc),bc};return ja?k(Fa):Fa}var yc,sb,ic,Bb,Qb,Tb,qb,kc,hc,Xb,gc,Ub,oc,Ab='sizzle'+1*new Date,cc=a.document,$b=0,Sb=0,Jc=g(),pc=g(),dc=g(),uc=function(J,ca){return J===ca&&(Tb=!0),0},vc={}.hasOwnProperty,nc=[],$c=nc.pop,Ad=nc.push,Cc=nc.push,md=nc.slice,Ec=function(J,ca){for(var ja=0,va=J.length;va>ja;ja++)if(J[ja]===
...
function(ca,ja){Ad.apply(ca,md.call(ja))}:function(ca,ja){for(var va=ca.length,Fa=0;ca[va++]=ja[Fa++];);ca.length=va-1}}}var Rb=c.support={};var Id=c.isXML=function(J){return(J=J&&(J.ownerDocument||J).documentElement)?'HTML'!==J.nodeName:!1};var Dc=c.setDocument=function(J){var ca,ja;J=J?J.ownerDocument||J:cc;return J!==qb&&9===J.nodeType&&J.documentElement?(qb=J,kc=qb.documentElement,hc=!Id(qb),(ja=qb.defaultView)&&ja.top!==ja&&(ja.addEventListener?ja.addEventListener('unload',nd,!1):ja.attachEvent&&
ja.attachEvent('onunload',nd)),Rb.attributes=l(function(va){return va.className='i',!va.getAttribute('className')}),Rb.getElementsByTagName=l(function(va){return va.appendChild(qb.createComment('')),!va.getElementsByTagName('*').length}),Rb.getElementsByClassName=Mc.test(qb.getElementsByClassName),Rb.getById=l(function(va){return kc.appendChild(va).id=Ab,!qb.getElementsByName||!qb.getElementsByName(Ab).length}),Rb.getById?(Ib.find.ID=function(va,Fa){if('undefined'!=typeof Fa.getElementById&&hc)return(va=
Fa.getElementById(va))?[va]:[]},Ib.filter.ID=function(va){var Fa=va.replace(zc,Ac);return function(Ja){return Ja.getAttribute('id')===Fa}}):(delete Ib.find.ID,Ib.filter.ID=function(va){var Fa=va.replace(zc,Ac);return function(Ja){return(Ja='undefined'!=typeof Ja.getAttributeNode&&Ja.getAttributeNode('id'))&&Ja.value===Fa}}),Ib.find.TAG=Rb.getElementsByTagName?function(va,Fa){return'undefined'!=typeof Fa.getElementsByTagName?Fa.getElementsByTagName(va):Rb.qsa?Fa.querySelectorAll(va):void 0}:function(va,
Fa){var Ja=[],Pa=0;Fa=Fa.getElementsByTagName(va);if('*'===va){for(;va=Fa[Pa++];)1===va.nodeType&&Ja.push(va);return Ja}return Fa},Ib.find.CLASS=Rb.getElementsByClassName&&function(va,Fa){return'undefined'!=typeof Fa.getElementsByClassName&&hc?Fa.getElementsByClassName(va):void 0},gc=[],Xb=[],(Rb.qsa=Mc.test(qb.querySelectorAll))&&(l(function(va){kc.appendChild(va).innerHTML="<a id='"+Ab+"'></a><select id='"+Ab+"-\r\\' msallowcapture=''><option selected=''></option></select>";va.querySelectorAll("[msallowcapture^='']").length&&
Xb.push('[*^$]=[\\x20\\t\\r\\n\\f]*(?:\'\'|"")');va.querySelectorAll('[selected]').length||Xb.push('\\[[\\x20\\t\\r\\n\\f]*(?:value|checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)');va.querySelectorAll('[id~='+Ab+'-]').length||Xb.push('~=');va.querySelectorAll(':checked').length||Xb.push(':checked');va.querySelectorAll('a#'+Ab+'+*').length||Xb.push('.#.+[+~]')}),l(function(va){var Fa=qb.createElement('input');Fa.setAttribute('type',
'hidden');va.appendChild(Fa).setAttribute('name','D');va.querySelectorAll('[name=d]').length&&Xb.push('name[\\x20\\t\\r\\n\\f]*[*^$|!~]?=');va.querySelectorAll(':enabled').length||Xb.push(':enabled',':disabled');va.querySelectorAll('*,:x');Xb.push(',.*:')})),(Rb.matchesSelector=Mc.test(Ub=kc.matches||kc.webkitMatchesSelector||kc.mozMatchesSelector||kc.oMatchesSelector||kc.msMatchesSelector))&&l(function(va){Rb.disconnectedMatch=Ub.call(va,'div');Ub.call(va,"[s!='']:x");gc.push('!=',':((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:\\(((\'((?:\\\\.|[^\\\\\'])*)\'|"((?:\\\\.|[^\\\\"])*)")|((?:\\\\.|[^\\\\()[\\]]|\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:[\\x20\\t\\r\\n\\f]*([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:\'((?:\\\\.|[^\\\\\'])*)\'|"((?:\\\\.|[^\\\\"])*)"|((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+))|)[\\x20\\t\\r\\n\\f]*\\])*)|.*)\\)|)')}),
Xb=Xb.length&&new RegExp(Xb.join('|')),gc=gc.length&&new RegExp(gc.join('|')),ca=Mc.test(kc.compareDocumentPosition),oc=ca||Mc.test(kc.contains)?function(va,Fa){var Ja=9===va.nodeType?va.documentElement:va;Fa=Fa&&Fa.parentNode;return va===Fa||!(!Fa||1!==Fa.nodeType||!(Ja.contains?Ja.contains(Fa):va.compareDocumentPosition&&16&va.compareDocumentPosition(Fa)))}:function(va,Fa){if(Fa)for(;Fa=Fa.parentNode;)if(Fa===va)return!0;return!1},uc=ca?function(va,Fa){if(va===Fa)return Tb=!0,0;var Ja=!va.compareDocumentPosition-
!Fa.compareDocumentPosition;return Ja?Ja:(Ja=(va.ownerDocument||va)===(Fa.ownerDocument||Fa)?va.compareDocumentPosition(Fa):1,1&Ja||!Rb.sortDetached&&Fa.compareDocumentPosition(va)===Ja?va===qb||va.ownerDocument===cc&&oc(cc,va)?-1:Fa===qb||Fa.ownerDocument===cc&&oc(cc,Fa)?1:Qb?Ec(Qb,va)-Ec(Qb,Fa):0:4&Ja?-1:1)}:function(va,Fa){if(va===Fa)return Tb=!0,0;var Ja=0,Pa=va.parentNode,ab=Fa.parentNode,Va=[va],ib=[Fa];if(!Pa||!ab)return va===qb?-1:Fa===qb?1:Pa?-1:ab?1:Qb?Ec(Qb,va)-Ec(Qb,Fa):0;if(Pa===ab)return H(va,
Fa);for(;va=va.parentNode;)Va.unshift(va);for(va=Fa;va=va.parentNode;)ib.unshift(va);for(;Va[Ja]===ib[Ja];)Ja++;return Ja?H(Va[Ja],ib[Ja]):Va[Ja]===cc?-1:ib[Ja]===cc?1:0},qb):qb};c.matches=function(J,ca){return c(J,null,null,ca)};c.matchesSelector=function(J,ca){if((J.ownerDocument||J)!==qb&&Dc(J),ca=ca.replace(Ed,"='$1']"),!(!Rb.matchesSelector||!hc||dc[ca+' ']||gc&&gc.test(ca)||Xb&&Xb.test(ca)))try{var ja=Ub.call(J,ca);if(ja||Rb.disconnectedMatch||J.document&&11!==J.document.nodeType)return ja}catch(va){}return 0<
c(ca,qb,null,[J]).length};c.contains=function(J,ca){return(J.ownerDocument||J)!==qb&&Dc(J),oc(J,ca)};c.attr=function(J,ca){(J.ownerDocument||J)!==qb&&Dc(J);var ja=Ib.attrHandle[ca.toLowerCase()];ja=ja&&vc.call(Ib.attrHandle,ca.toLowerCase())?ja(J,ca,!hc):void 0;return void 0!==ja?ja:Rb.attributes||!hc?J.getAttribute(ca):(ja=J.getAttributeNode(ca))&&ja.specified?ja.value:null};c.error=function(J){throw Error('Syntax error, unrecognized expression: '+J);};c.uniqueSort=function(J){var ca,ja=[],va=0,
Fa=0;if(Tb=!Rb.detectDuplicates,Qb=!Rb.sortStable&&J.slice(0),J.sort(uc),Tb){for(;ca=J[Fa++];)ca===J[Fa]&&(va=ja.push(Fa));for(;va--;)J.splice(ja[va],1)}return Qb=null,J};var ad=c.getText=function(J){var ca,ja='',va=0;if(ca=J.nodeType)if(1===ca||9===ca||11===ca){if('string'==typeof J.textContent)return J.textContent;for(J=J.firstChild;J;J=J.nextSibling)ja+=ad(J)}else{if(3===ca||4===ca)return J.nodeValue}else for(;ca=J[va++];)ja+=ad(ca);return ja};var Ib=c.selectors={cacheLength:50,createPseudo:k,
...
J+'([\\x20\\t\\r\\n\\f]|$)'),Jc(J,function(ja){return ca.test('string'==typeof ja.className&&ja.className||'undefined'!=typeof ja.getAttribute&&ja.getAttribute('class')||'')}))},ATTR:function(J,ca,ja){return function(va){va=c.attr(va,J);return null==va?'!='===ca:ca?(va+='','='===ca?va===ja:'!='===ca?va!==ja:'^='===ca?ja&&0===va.indexOf(ja):'*='===ca?ja&&-1<va.indexOf(ja):'$='===ca?ja&&va.slice(-ja.length)===ja:'~='===ca?-1<(' '+va.replace(Bd,' ')+' ').indexOf(ja):'|='===ca?va===ja||va.slice(0,ja.length+
1)===ja+'-':!1):!0}},CHILD:function(J,ca,ja,va,Fa){var Ja='nth'!==J.slice(0,3),Pa='last'!==J.slice(-4),ab='of-type'===ca;return 1===va&&0===Fa?function(Va){return!!Va.parentNode}:function(Va,ib,kb){var gb,Nb;ib=Ja!==Pa?'nextSibling':'previousSibling';var ec=Va.parentNode,bc=ab&&Va.nodeName.toLowerCase();kb=!kb&&!ab;var rb=!1;if(ec){if(Ja){for(;ib;){for(gb=Va;gb=gb[ib];)if(ab?gb.nodeName.toLowerCase()===bc:1===gb.nodeType)return!1;var tc=ib='only'===J&&!tc&&'nextSibling'}return!0}if(tc=[Pa?ec.firstChild:
ec.lastChild],Pa&&kb){gb=ec;var jc=gb[Ab]||(gb[Ab]={});var rc=jc[gb.uniqueID]||(jc[gb.uniqueID]={});var fc=rc[J]||[];rb=(Nb=fc[0]===$b&&fc[1])&&fc[2];for(gb=Nb&&ec.childNodes[Nb];gb=++Nb&&gb&&gb[ib]||(rb=Nb=0)||tc.pop();)if(1===gb.nodeType&&++rb&&gb===Va){rc[J]=[$b,Nb,rb];break}}else if(kb&&(gb=Va,jc=gb[Ab]||(gb[Ab]={}),rc=jc[gb.uniqueID]||(jc[gb.uniqueID]={}),fc=rc[J]||[],Nb=fc[0]===$b&&fc[1],rb=Nb),!1===rb)for(;(gb=++Nb&&gb&&gb[ib]||(rb=Nb=0)||tc.pop())&&((ab?gb.nodeName.toLowerCase()!==bc:1!==
gb.nodeType)||!++rb||(kb&&(jc=gb[Ab]||(gb[Ab]={}),rc=jc[gb.uniqueID]||(jc[gb.uniqueID]={}),rc[J]=[$b,rb]),gb!==Va)););return rb-=Fa,rb===va||0===rb%va&&0<=rb/va}}},PSEUDO:function(J,ca){var ja,va=Ib.pseudos[J]||Ib.setFilters[J.toLowerCase()]||c.error('unsupported pseudo: '+J);return va[Ab]?va(ca):1<va.length?(ja=[J,J,'',ca],Ib.setFilters.hasOwnProperty(J.toLowerCase())?k(function(Fa,Ja){for(var Pa,ab=va(Fa,ca),Va=ab.length;Va--;)Pa=Ec(Fa,ab[Va]),Fa[Pa]=!(Ja[Pa]=ab[Va])}):function(Fa){return va(Fa,
0,ja)}):va}},pseudos:{not:k(function(J){var ca=[],ja=[],va=sb(J.replace(Qc,'$1'));return va[Ab]?k(function(Fa,Ja,Pa,ab){var Va;Pa=va(Fa,null,ab,[]);for(ab=Fa.length;ab--;)(Va=Pa[ab])&&(Fa[ab]=!(Ja[ab]=Va))}):function(Fa,Ja,Pa){return ca[0]=Fa,va(ca,null,Pa,ja),ca[0]=null,!ja.pop()}}),has:k(function(J){return function(ca){return 0<c(J,ca).length}}),contains:k(function(J){return J=J.replace(zc,Ac),function(ca){return-1<(ca.textContent||ca.innerText||ad(ca)).indexOf(J)}}),lang:k(function(J){return ld.test(J||
'')||c.error('unsupported lang: '+J),J=J.replace(zc,Ac).toLowerCase(),function(ca){var ja;do if(ja=hc?ca.lang:ca.getAttribute('xml:lang')||ca.getAttribute('lang'))return ja=ja.toLowerCase(),ja===J||0===ja.indexOf(J+'-');while((ca=ca.parentNode)&&1===ca.nodeType);return!1}}),target:function(J){var ca=a.location&&a.location.hash;return ca&&ca.slice(1)===J.id},root:function(J){return J===kc},focus:function(J){return J===qb.activeElement&&(!qb.hasFocus||qb.hasFocus())&&!!(J.type||J.href||~J.tabIndex)},
...
lt:Aa(function(J,ca,ja){for(ca=0>ja?ja+ca:ja;0<=--ca;)J.push(ca);return J}),gt:Aa(function(J,ca,ja){for(ja=0>ja?ja+ca:ja;++ja<ca;)J.push(ja);return J})}};Ib.pseudos.nth=Ib.pseudos.eq;for(yc in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})Ib.pseudos[yc]=aa(yc);for(yc in{submit:!0,reset:!0})Ib.pseudos[yc]=la(yc);Oa.prototype=Ib.filters=Ib.pseudos;Ib.setFilters=new Oa;var Pc=c.tokenize=function(J,ca){var ja,va,Fa,Ja,Pa;if(Ja=pc[J+' '])return ca?0:Ja.slice(0);Ja=J;var ab=[];for(Pa=Ib.preFilter;Ja;){Va&&
!(ja=Cd.exec(Ja))||(ja&&(Ja=Ja.slice(ja[0].length)||Ja),ab.push(va=[]));var Va=!1;(ja=Dd.exec(Ja))&&(Va=ja.shift(),va.push({value:Va,type:ja[0].replace(Qc,' ')}),Ja=Ja.slice(Va.length));for(Fa in Ib.filter)!(ja=Rc[Fa].exec(Ja))||Pa[Fa]&&!(ja=Pa[Fa](ja))||(Va=ja.shift(),va.push({value:Va,type:Fa,matches:ja}),Ja=Ja.slice(Va.length));if(!Va)break}return ca?Ja.length:Ja?c.error(J):pc(J,ab).slice(0)};return sb=c.compile=function(J,ca){var ja,va=[],Fa=[],Ja=dc[J+' '];if(!Ja){ca||=Pc(J);for(ja=ca.length;ja--;)Ja=
Ic(ca[ja]),Ja[Ab]?va.push(Ja):Fa.push(Ja);Ja=dc(J,mc(Fa,va));Ja.selector=J}return Ja},ic=c.select=function(J,ca,ja,va){var Fa,Ja,Pa,ab,Va,ib='function'==typeof J&&J,kb=!va&&Pc(J=ib.selector||J);if(ja=ja||[],1===kb.length){if(Ja=kb[0]=kb[0].slice(0),2<Ja.length&&'ID'===(Pa=Ja[0]).type&&Rb.getById&&9===ca.nodeType&&hc&&Ib.relative[Ja[1].type]){if(ca=(Ib.find.ID(Pa.matches[0].replace(zc,Ac),ca)||[])[0],!ca)return ja;ib&&(ca=ca.parentNode);J=J.slice(Ja.shift().value.length)}for(Fa=Rc.needsContext.test(J)?
0:Ja.length;Fa--&&(Pa=Ja[Fa],!Ib.relative[ab=Pa.type]);)if((Va=Ib.find[ab])&&(va=Va(Pa.matches[0].replace(zc,Ac),Yc.test(Ja[0].type)&&ra(ca.parentNode)||ca))){if(Ja.splice(Fa,1),J=va.length&&Ta(Ja),!J)return Cc.apply(ja,va),ja;break}}return(ib||sb(J,kb))(va,ca,!hc,ja,!ca||Yc.test(J)&&ra(ca.parentNode)||ca),ja},Rb.sortStable=Ab.split('').sort(uc).join('')===Ab,Rb.detectDuplicates=!!Tb,Dc(),Rb.sortDetached=l(function(J){return 1&J.compareDocumentPosition(qb.createElement('div'))}),l(function(J){return J.innerHTML=
...
'string'==typeof a?V(a):b.extend({},a);var c,g,k,l,B=[],H=[],aa=-1,la=function(){l=a.once;for(k=c=!0;H.length;aa=-1)for(g=H.shift();++aa<B.length;)!1===B[aa].apply(g[0],g[1])&&a.stopOnFalse&&(aa=B.length,g=!1);a.memory||(g=!1);c=!1;l&&(B=g?[]:'')},Aa={add:function(){return B&&(g&&!c&&(aa=B.length-1,H.push(g)),function Ta(Oa){b.each(Oa,function(ub,bb){b.isFunction(bb)?a.unique&&Aa.has(bb)||B.push(bb):bb&&bb.length&&'string'!==b.type(bb)&&Ta(bb)})}(arguments),g&&!c&&la()),this},remove:function(){return b.each(arguments,
function(ra,Oa){for(var Ta;-1<(Ta=b.inArray(Oa,B,Ta));)B.splice(Ta,1),aa>=Ta&&aa--}),this},has:function(ra){return ra?-1<b.inArray(ra,B):0<B.length},empty:function(){return B&&=[],this},disable:function(){return l=H=[],B=g='',this},disabled:function(){return!B},lock:function(){return l=!0,g||Aa.disable(),this},locked:function(){return!!l},fireWith:function(ra,Oa){return l||(Oa=Oa||[],Oa=[ra,Oa.slice?Oa.slice():Oa],H.push(Oa),c||la()),this},fire:function(){return Aa.fireWith(this,arguments),this},
...
a&&a.call(l,l),l},when:function(a){var c=0,g=Gb.call(arguments),k=g.length,l=1!==k||a&&b.isFunction(a.promise)?k:0,B=1===l?a:b.Deferred(),H=function(ra,Oa,Ta){return function(ub){Oa[ra]=this;Ta[ra]=1<arguments.length?Gb.call(arguments):ub;Ta===la?B.notifyWith(Oa,Ta):--l||B.resolveWith(Oa,Ta)}},aa;if(1<k){var la=Array(k);var Aa=Array(k);for(aa=Array(k);k>c;c++)g[c]&&b.isFunction(g[c].promise)?g[c].promise().progress(H(c,Aa,la)).done(H(c,aa,g)).fail(B.reject):--l}return l||B.resolveWith(aa,g),B.promise()}});
var ya;b.fn.ready=function(a){return b.ready.promise().done(a),this};b.extend({isReady:!1,readyWait:1,holdReady:function(a){a?b.readyWait++:b.ready(!0)},ready:function(a){(!0===a?--b.readyWait:b.isReady)||(b.isReady=!0,!0!==a&&0<--b.readyWait||(ya.resolveWith(Qa,[b]),b.fn.triggerHandler&&(b(Qa).triggerHandler('ready'),b(Qa).off('ready'))))}});b.ready.promise=function(a){if(!ya)if(ya=b.Deferred(),'complete'===Qa.readyState||'loading'!==Qa.readyState&&!Qa.documentElement.doScroll)D.setTimeout(b.ready);
else if(Qa.addEventListener)Qa.addEventListener('DOMContentLoaded',W),D.addEventListener('load',W);else{Qa.attachEvent('onreadystatechange',W);D.attachEvent('onload',W);var c=!1;try{c=null==D.frameElement&&Qa.documentElement}catch(g){}c&&c.doScroll&&!function k(){if(!b.isReady){try{c.doScroll('left')}catch(l){return D.setTimeout(k,50)}pa();b.ready()}}()}return ya.promise(a)};b.ready.promise();for(var Ya in b(e))break;e.ownFirst='0'===Ya;e.inlineBlockNeedsLayout=!1;b(function(){var a,c,g,k;(g=Qa.getElementsByTagName('body')[0])&&
g.style&&(c=Qa.createElement('div'),k=Qa.createElement('div'),k.style.cssText='position:absolute;border:0;width:0;height:0;top:0;left:-9999px',g.appendChild(k).appendChild(c),'undefined'!=typeof c.style.zoom&&(c.style.cssText='display:inline;margin:0;border:0;padding:1px;width:1px;zoom:1',e.inlineBlockNeedsLayout=a=3===c.offsetWidth,a&&(g.style.zoom=1)),g.removeChild(k))});(function(){var a=Qa.createElement('div');e.deleteExpando=!0;try{delete a.test}catch(c){e.deleteExpando=!1}})();var Sa=function(a){var c=
b.noData[(a.nodeName+' ').toLowerCase()],g=+a.nodeType||1;return 1!==g&&9!==g?!1:!c||!0!==c&&a.getAttribute('classid')===c},ob=/^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,xb=/([A-Z])/g;b.extend({cache:{},noData:{'applet ':!0,'embed ':!0,'object ':'clsid:D27CDB6E-AE6D-11cf-96B8-444553540000'},hasData:function(a){return a=a.nodeType?b.cache[a[b.expando]]:a[b.expando],!!a&&!m(a)},data:function(a,c,g){return U(a,c,g)},removeData:function(a,c){return x(a,c)},_data:function(a,c,g){return U(a,c,g,!0)},_removeData:function(a,
...
(c.style.cssText='-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:1px;width:1px;zoom:1',c.appendChild(Qa.createElement('div')).style.width='5px',a=3!==c.offsetWidth),g.removeChild(k),a):void 0}})();var Kb=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,eb=new RegExp('^(?:([+-])=|)('+Kb+')([a-z%]*)$','i'),zb=['Top','Right','Bottom','Left'],Vb=function(a,c){return a=c||a,'none'===b.css(a,'display')||!b.contains(a.ownerDocument,a)},
Wa=function(a,c,g,k,l,B,H){var aa=0,la=a.length,Aa=null==g;if('object'===b.type(g))for(aa in l=!0,g)Wa(a,c,aa,g[aa],!0,B,H);else if(void 0!==k&&(l=!0,b.isFunction(k)||(H=!0),Aa&&(H?(c.call(a,k),c=null):(Aa=c,c=function(ra,Oa,Ta){return Aa.call(b(ra),Ta)})),c))for(;la>aa;aa++)c(a[aa],g,H?k:k.call(a[aa],aa,c(a[aa],g)));return l?a:Aa?c.call(a):la?c(a[0],g):B},fb=/^(?:checkbox|radio)$/i,ea=/<([\w:-]+)/,Z=/^$|\/(?:java|ecma)script/i,ha=/^\s+/;!function(){var a=Qa.createElement('div'),c=Qa.createDocumentFragment(),
...
var db=/^(?:input|select|textarea)$/i,Ka=/^key/,tb=/^(?:mouse|pointer|contextmenu|drag|drop)|click/,hb=/^(?:focusinfocus|focusoutblur)$/,lb=/^([^.]*)(?:\.(.+)|)/;b.event={global:{},add:function(a,c,g,k,l){var B,H,aa,la,Aa,ra,Oa,Ta;if(H=b._data(a)){g.handler&&(aa=g,g=aa.handler,l=aa.selector);g.guid||(g.guid=b.guid++);(B=H.events)||(B=H.events={});(Aa=H.handle)||(Aa=H.handle=function(Lb){return'undefined'==typeof b||Lb&&b.event.triggered===Lb.type?void 0:b.event.dispatch.apply(Aa.elem,arguments)},
Aa.elem=a);c=(c||'').match(Ba)||[''];for(H=c.length;H--;){var ub=lb.exec(c[H])||[];var bb=Ta=ub[1];ub=(ub[2]||'').split('.').sort();bb&&(la=b.event.special[bb]||{},bb=(l?la.delegateType:la.bindType)||bb,la=b.event.special[bb]||{},ra=b.extend({type:bb,origType:Ta,data:k,handler:g,guid:g.guid,selector:l,needsContext:l&&b.expr.match.needsContext.test(l),namespace:ub.join('.')},aa),(Oa=B[bb])||(Oa=B[bb]=[],Oa.delegateCount=0,la.setup&&!1!==la.setup.call(a,k,ub,Aa)||(a.addEventListener?a.addEventListener(bb,
Aa,!1):a.attachEvent&&a.attachEvent('on'+bb,Aa))),la.add&&(la.add.call(a,ra),ra.handler.guid||(ra.handler.guid=g.guid)),l?Oa.splice(Oa.delegateCount++,0,ra):Oa.push(ra),b.event.global[bb]=!0)}a=null}},remove:function(a,c,g,k,l){var B,H,aa,la,Aa,ra,Oa,Ta,ub=b.hasData(a)&&b._data(a);if(ub&&(Aa=ub.events)){c=(c||'').match(Ba)||[''];for(la=c.length;la--;)if(H=lb.exec(c[la])||[],ra=Ta=H[1],Oa=(H[2]||'').split('.').sort(),ra){var bb=b.event.special[ra]||{};ra=(k?bb.delegateType:bb.bindType)||ra;var Lb=
Aa[ra]||[];H=H[2]&&new RegExp('(^|\\.)'+Oa.join('\\.(?:.*\\.|)')+'(\\.|$)');for(aa=B=Lb.length;B--;){var lc=Lb[B];!l&&Ta!==lc.origType||g&&g.guid!==lc.guid||H&&!H.test(lc.namespace)||k&&k!==lc.selector&&('**'!==k||!lc.selector)||(Lb.splice(B,1),lc.selector&&Lb.delegateCount--,bb.remove&&bb.remove.call(a,lc))}aa&&!Lb.length&&(bb.teardown&&!1!==bb.teardown.call(a,Oa,ub.handle)||b.removeEvent(a,ra,ub.handle),delete Aa[ra])}else for(ra in Aa)b.event.remove(a,ra+c[la],g,k,!0);b.isEmptyObject(Aa)&&(delete ub.handle,
...
'(\\.|$)'):null,a.result=void 0,a.target||(a.target=g),c=null==c?[a]:b.makeArray(c,[a]),aa=b.event.special[Aa]||{},k||!aa.trigger||!1!==aa.trigger.apply(g,c))){if(!k&&!aa.noBubble&&!b.isWindow(g)){var Oa=aa.delegateType||Aa;for(hb.test(Oa+Aa)||(H=H.parentNode);H;H=H.parentNode)la.push(H),l=H;l===(g.ownerDocument||Qa)&&la.push(l.defaultView||l.parentWindow||D)}for(ra=0;(H=la[ra++])&&!a.isPropagationStopped();)a.type=1<ra?Oa:aa.bindType||Aa,(l=(b._data(H,'events')||{})[a.type]&&b._data(H,'handle'))&&
l.apply(H,c),(l=B&&H[B])&&l.apply&&Sa(H)&&(a.result=l.apply(H,c),!1===a.result&&a.preventDefault());if(a.type=Aa,!(k||a.isDefaultPrevented()||aa._default&&!1!==aa._default.apply(la.pop(),c))&&Sa(g)&&B&&g[Aa]&&!b.isWindow(g)){(l=g[B])&&(g[B]=null);b.event.triggered=Aa;try{g[Aa]()}catch(Ta){}b.event.triggered=void 0;l&&(g[B]=l)}return a.result}},dispatch:function(a){a=b.event.fix(a);var c,g,k,l,B=Gb.call(arguments);var H=(b._data(this,'events')||{})[a.type]||[];var aa=b.event.special[a.type]||{};if(B[0]=
...
l.clientLeft||g&&g.clientLeft||0),a.pageY=c.clientY+(l&&l.scrollTop||g&&g.scrollTop||0)-(l&&l.clientTop||g&&g.clientTop||0)),!a.relatedTarget&&H&&(a.relatedTarget=H===a.target?c.toElement:H),a.which||void 0===B||(a.which=1&B?1:2&B?3:4&B?2:0),a}},special:{load:{noBubble:!0},focus:{trigger:function(){if(this!==E()&&this.focus)try{return this.focus(),!1}catch(a){}},delegateType:'focusin'},blur:{trigger:function(){return this===E()&&this.blur?(this.blur(),!1):void 0},delegateType:'focusout'},click:{trigger:function(){return b.nodeName(this,
...
ac.firstChild)),!(e.noCloneEvent&&e.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||b.isXMLDoc(a))){var aa=S(l);var la=S(a);for(B=0;null!=(k=la[B]);++B)if(aa[B]){var Aa=void 0,ra,Oa=k,Ta=aa[B];if(1===Ta.nodeType){if(ra=Ta.nodeName.toLowerCase(),!e.noCloneEvent&&Ta[b.expando]){k=b._data(Ta);for(Aa in k.events)b.removeEvent(Ta,Aa,k.handle);Ta.removeAttribute(b.expando)}'script'===ra&&Ta.text!==Oa.text?(r(Ta).text=Oa.text,G(Ta)):'object'===ra?(Ta.parentNode&&(Ta.outerHTML=Oa.outerHTML),e.html5Clone&&
Oa.innerHTML&&!b.trim(Ta.innerHTML)&&(Ta.innerHTML=Oa.innerHTML)):'input'===ra&&fb.test(Oa.type)?(Ta.defaultChecked=Ta.checked=Oa.checked,Ta.value!==Oa.value&&(Ta.value=Oa.value)):'option'===ra?Ta.defaultSelected=Ta.selected=Oa.defaultSelected:'input'!==ra&&'textarea'!==ra||(Ta.defaultValue=Oa.defaultValue)}}}if(c)if(g)for(la=la||S(a),aa=aa||S(l),B=0;null!=(k=la[B]);B++)K(k,aa[B]);else K(a,l);return aa=S(l,'script'),0<aa.length&&I(aa,!H&&S(a,'script')),l},cleanData:function(a,c){for(var g,k,l,B,H=
0,aa=b.expando,la=b.cache,Aa=e.attributes,ra=b.event.special;null!=(g=a[H]);H++)if((c||Sa(g))&&(l=g[aa],B=l&&la[l])){if(B.events)for(k in B.events)ra[k]?b.event.remove(g,k):b.removeEvent(g,k,B.handle);la[l]&&(delete la[l],Aa||'undefined'==typeof g.removeAttribute?g[aa]=void 0:g.removeAttribute(aa),Fb.push(l))}}});b.fn.extend({domManip:A,detach:function(a){return O(this,a,!0)},remove:function(a){return O(this,a)},text:function(a){return Wa(this,function(c){return void 0===c?b.text(this):this.empty().append((this[0]&&
...
aa.innerHTML='';H.appendChild(aa);e.boxSizing=''===aa.style.boxSizing||''===aa.style.MozBoxSizing||''===aa.style.WebkitBoxSizing;b.extend(e,{reliableHiddenOffsets:function(){return null==a&&la(),k},boxSizingReliable:function(){return null==a&&la(),g},pixelMarginRight:function(){return null==a&&la(),c},pixelPosition:function(){return null==a&&la(),a},reliableMarginRight:function(){return null==a&&la(),l},reliableMarginLeft:function(){return null==a&&la(),B}});function la(){var Aa,ra,Oa=Qa.documentElement;
Oa.appendChild(H);aa.style.cssText='-webkit-box-sizing:border-box;box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%';a=g=B=!1;c=l=!0;D.getComputedStyle&&(ra=D.getComputedStyle(aa),a='1%'!==(ra||{}).top,B='2px'===(ra||{}).marginLeft,g='4px'===(ra||{width:'4px'}).width,aa.style.marginRight='50%',c='4px'===(ra||{marginRight:'4px'}).marginRight,Aa=aa.appendChild(Qa.createElement('div')),Aa.style.cssText=aa.style.cssText='-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0',
Aa.style.marginRight=Aa.style.width='0',aa.style.width='1px',l=!parseFloat((D.getComputedStyle(Aa)||{}).marginRight),aa.removeChild(Aa));aa.style.display='none';(k=0===aa.getClientRects().length)&&(aa.style.display='',aa.innerHTML='<table><tr><td></td><td>t</td></tr></table>',aa.childNodes[0].style.borderCollapse='separate',Aa=aa.getElementsByTagName('td'),Aa[0].style.cssText='margin:0;border:0;padding:0;display:none',k=0===Aa[0].offsetHeight,k&&(Aa[0].style.display='',Aa[1].style.display='none',
k=0===Aa[0].offsetHeight));Oa.removeChild(H)}}}();var xc,sc,Sc=/^(top|right|bottom|left)$/;D.getComputedStyle?(xc=function(a){var c=a.ownerDocument.defaultView;return c&&c.opener||(c=D),c.getComputedStyle(a)},sc=function(a,c,g){var k,l,B,H,aa=a.style;return g=g||xc(a),H=g?g.getPropertyValue(c)||g[c]:void 0,''!==H&&void 0!==H||b.contains(a.ownerDocument,a)||(H=b.style(a,c)),g&&!e.pixelMarginRight()&&Ob.test(H)&&qc.test(c)&&(k=aa.width,l=aa.minWidth,B=aa.maxWidth,aa.minWidth=aa.maxWidth=aa.width=H,
...
!(H&&'set'in H&&void 0===(g=H.set(a,g,k)))))try{la[c]=g}catch(Aa){}}},css:function(a,c,g,k){var l,B,H,aa=b.camelCase(c);return c=b.cssProps[aa]||(b.cssProps[aa]=Ea(aa)||aa),H=b.cssHooks[c]||b.cssHooks[aa],H&&'get'in H&&(B=H.get(a,!0,g)),void 0===B&&(B=sc(a,c,k)),'normal'===B&&c in od&&(B=od[c]),''===g||g?(l=parseFloat(B),!0===g||isFinite(l)?l||0:B):B}});b.each(['height','width'],function(a,c){b.cssHooks[c]={get:function(g,k,l){return k?Jd.test(b.css(g,'display'))&&0===g.offsetWidth?Nc(g,Kd,function(){return na(g,
c,l)}):na(g,c,l):void 0},set:function(g,k,l){var B=l&&xc(g);return za(g,k,l?Ca(g,c,l,e.boxSizing&&'border-box'===b.css(g,'boxSizing',!1,B),B):0)}}});e.opacity||(b.cssHooks.opacity={get:function(a,c){return Tc.test((c&&a.currentStyle?a.currentStyle.filter:a.style.filter)||'')?.01*parseFloat(RegExp.$1)+'':c?'1':''},set:function(a,c){var g=a.style;a=a.currentStyle;var k=b.isNumeric(c)?'alpha(opacity='+100*c+')':'',l=a&&a.filter||g.filter||'';g.zoom=1;(1<=c||''===c)&&''===b.trim(l.replace(Oc,''))&&g.removeAttribute&&
...
padding:'',border:'Width'},function(a,c){b.cssHooks[a+c]={expand:function(g){var k=0,l={};for(g='string'==typeof g?g.split(' '):[g];4>k;k++)l[a+zb[k]+c]=g[k]||g[k-2]||g[0];return l}};qc.test(a)||(b.cssHooks[a+c].set=za)});b.fn.extend({css:function(a,c){return Wa(this,function(g,k,l){var B,H={},aa=0;if(b.isArray(k)){l=xc(g);for(B=k.length;B>aa;aa++)H[k[aa]]=b.css(g,k[aa],!1,l);return H}return void 0!==l?b.style(g,k,l):b.css(g,k)},a,c,1<arguments.length)},show:function(){return ua(this,!0)},hide:function(){return ua(this)},
toggle:function(a){return'boolean'==typeof a?a?this.show():this.hide():this.each(function(){Vb(this)?b(this).show():b(this).hide()})}});b.Tween=Ua;Ua.prototype={constructor:Ua,init:function(a,c,g,k,l,B){this.elem=a;this.prop=g;this.easing=l||b.easing._default;this.options=c;this.start=this.now=this.cur();this.end=k;this.unit=B||(b.cssNumber[g]?'':'px')},cur:function(){var a=Ua.propHooks[this.prop];return a&&a.get?a.get(this):Ua.propHooks._default.get(this)},run:function(a){var c,g=Ua.propHooks[this.prop];
return this.options.duration?this.pos=c=b.easing[this.easing](a,this.options.duration*a,0,1,this.options.duration):this.pos=c=a,this.now=(this.end-this.start)*c+this.start,this.options.step&&this.options.step.call(this.elem,this.now,this),g&&g.set?g.set(this):Ua.propHooks._default.set(this),this}};Ua.prototype.init.prototype=Ua.prototype;Ua.propHooks={_default:{get:function(a){var c;return 1!==a.elem.nodeType||null!=a.elem[a.prop]&&null==a.elem.style[a.prop]?a.elem[a.prop]:(c=b.css(a.elem,a.prop,
''),c&&'auto'!==c?c:0)},set:function(a){b.fx.step[a.prop]?b.fx.step[a.prop](a):1!==a.elem.nodeType||null==a.elem.style[b.cssProps[a.prop]]&&!b.cssHooks[a.prop]?a.elem[a.prop]=a.now:b.style(a.elem,a.prop,a.now+a.unit)}}};Ua.propHooks.scrollTop=Ua.propHooks.scrollLeft={set:function(a){a.elem.nodeType&&a.elem.parentNode&&(a.elem[a.prop]=a.now)}};b.easing={linear:function(a){return a},swing:function(a){return.5-Math.cos(a*Math.PI)/2},_default:'swing'};b.fx=Ua.prototype.init;b.fx.step={};var Hc,bd,Ld=
/^(?:toggle|show|hide)$/,Md=/queueHooks$/;b.Animation=b.extend(La,{tweeners:{'*':[function(a,c){var g=this.createTween(a,c);return ma(g.elem,a,eb.exec(c),g),g}]},tweener:function(a,c){b.isFunction(a)?(c=a,a=['*']):a=a.match(Ba);for(var g,k=0,l=a.length;l>k;k++)g=a[k],La.tweeners[g]=La.tweeners[g]||[],La.tweeners[g].unshift(c)},prefilters:[function(a,c,g){var k,l,B,H,aa,la,Aa,ra=this,Oa={},Ta=a.style,ub=a.nodeType&&Vb(a),bb=b._data(a,'fxshow');g.queue||(H=b._queueHooks(a,'fx'),null==H.unqueued&&(H.unqueued=
0,aa=H.empty.fire,H.empty.fire=function(){H.unqueued||aa()}),H.unqueued++,ra.always(function(){ra.always(function(){H.unqueued--;b.queue(a,'fx').length||H.empty.fire()})}));1===a.nodeType&&('height'in c||'width'in c)&&(g.overflow=[Ta.overflow,Ta.overflowX,Ta.overflowY],la=b.css(a,'display'),Aa='none'===la?b._data(a,'olddisplay')||sa(a.nodeName):la,'inline'===Aa&&'none'===b.css(a,'float')&&(e.inlineBlockNeedsLayout&&'inline'!==sa(a.nodeName)?Ta.zoom=1:Ta.display='inline-block'));g.overflow&&(Ta.overflow=
'hidden',e.shrinkWrapBlocks()||ra.always(function(){Ta.overflow=g.overflow[0];Ta.overflowX=g.overflow[1];Ta.overflowY=g.overflow[2]}));for(k in c)if(l=c[k],Ld.exec(l)){if(delete c[k],B=B||'toggle'===l,l===(ub?'hide':'show')){if('show'!==l||!bb||void 0===bb[k])continue;ub=!0}Oa[k]=bb&&bb[k]||b.style(a,k)}else la=void 0;if(b.isEmptyObject(Oa))'inline'===('none'===la?sa(a.nodeName):la)&&(Ta.display=la);else for(k in bb?'hidden'in bb&&(ub=bb.hidden):bb=b._data(a,'fxshow',{}),B&&(bb.hidden=!ub),ub?b(a).show():
ra.done(function(){b(a).hide()}),ra.done(function(){var Lb;b._removeData(a,'fxshow');for(Lb in Oa)b.style(a,Lb,Oa[Lb])}),Oa)c=pb(ub?bb[k]:0,k,ra),k in bb||(bb[k]=c.start,ub&&(c.end=c.start,c.start='width'===k||'height'===k?1:0))}],prefilter:function(a,c){c?La.prefilters.unshift(a):La.prefilters.push(a)}});b.speed=function(a,c,g){var k=a&&'object'==typeof a?b.extend({},a):{complete:g||!g&&c||b.isFunction(a)&&a,duration:a,easing:g&&c||c&&!b.isFunction(c)&&c};return k.duration=b.fx.off?0:'number'==typeof k.duration?
...
k||'boolean'==typeof k?g.apply(this,arguments):this.animate(Ra(c,!0),k,l,B)}});b.each({slideDown:Ra('show'),slideUp:Ra('hide'),slideToggle:Ra('toggle'),fadeIn:{opacity:'show'},fadeOut:{opacity:'hide'},fadeToggle:{opacity:'toggle'}},function(a,c){b.fn[a]=function(g,k,l){return this.animate(c,g,k,l)}});b.timers=[];b.fx.tick=function(){var a=b.timers,c=0;for(Hc=b.now();c<a.length;c++){var g=a[c];g()||a[c]!==g||a.splice(c--,1)}a.length||b.fx.stop();Hc=void 0};b.fx.timer=function(a){b.timers.push(a);a()?
b.fx.start():b.timers.pop()};b.fx.interval=13;b.fx.start=function(){bd||=D.setInterval(b.fx.tick,b.fx.interval)};b.fx.stop=function(){D.clearInterval(bd);bd=null};b.fx.speeds={slow:600,fast:200,_default:400};b.fn.delay=function(a,c){return a=b.fx?b.fx.speeds[a]||a:a,c=c||'fx',this.queue(c,function(g,k){var l=D.setTimeout(g,a);k.stop=function(){D.clearTimeout(l)}})};(function(){var a=Qa.createElement('input');Qa.createElement('div');var c=Qa.createElement('select'),g=c.appendChild(Qa.createElement('option'));
...
function(a,c){b.fn[c]=function(g,k){return 0<arguments.length?this.on(c,null,g,k):this.trigger(c)}});b.fn.extend({hover:function(a,c){return this.mouseenter(a).mouseleave(c||a)}});var Sd=D.location,ed=b.now(),fd=/\?/,Td=/(,)|(\[|{)|(}|])|"(?:[^"\\\r\n]|\\["\\\/bfnrt]|\\u[\da-fA-F]{4})*"\s*:?|true|false|null|-?(?!0\d)\d+(?:\.\d+|)(?:[eE][+-]?\d+|)/g;b.parseJSON=function(a){if(D.JSON&&D.JSON.parse)return D.JSON.parse(a+'');var c,g=null,k=b.trim(a+'');return k&&!b.trim(k.replace(Td,function(l,B,H,aa){return c&&
B&&(g=0),0===g?l:(c=H||B,g+=!aa-!H,'')}))?Function('return '+k)():b.error('Invalid JSON: '+a)};b.parseXML=function(a){var c,g;if(!a||'string'!=typeof a)return null;try{D.DOMParser?(g=new D.DOMParser,c=g.parseFromString(a,'text/xml')):(c=new D.ActiveXObject('Microsoft.XMLDOM'),c.async='false',c.loadXML(a))}catch(k){c=void 0}return c&&c.documentElement&&!c.getElementsByTagName('parsererror').length||b.error('Invalid XML: '+a),c};var Ud=/#.*$/,pd=/([?&])_=[^&]*/,Vd=/^(.*?):[ \t]*([^\r\n]*)\r?$/gm,Wd=
...
json:'application/json, text/javascript'},contents:{xml:/\bxml\b/,html:/\bhtml/,json:/\bjson\b/},responseFields:{xml:'responseXML',text:'responseText',json:'responseJSON'},converters:{'* text':String,'text html':!0,'text json':b.parseJSON,'text xml':b.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(a,c){return c?Xa(Xa(a,b.ajaxSettings),c):Xa(b.ajaxSettings,a)},ajaxPrefilter:wb(rd),ajaxTransport:wb(Xc),ajax:function(a,c){function g(Bb,Qb,Tb,qb){var kc,hc,Xb,gc=Qb;if(2!==mc){mc=2;H&&D.clearTimeout(H);
la=void 0;B=qb||'';sb.readyState=0<Bb?4:0;qb=200<=Bb&&300>Bb||304===Bb;if(Tb){var Ub=ra;for(var oc=sb,Ab,cc,$b,Sb,Jc=Ub.contents,pc=Ub.dataTypes;'*'===pc[0];)pc.shift(),void 0===cc&&(cc=Ub.mimeType||oc.getResponseHeader('Content-Type'));if(cc)for(Sb in Jc)if(Jc[Sb]&&Jc[Sb].test(cc)){pc.unshift(Sb);break}if(pc[0]in Tb)$b=pc[0];else{for(Sb in Tb){if(!pc[0]||Ub.converters[Sb+' '+pc[0]]){$b=Sb;break}Ab||=Sb}$b=$b||Ab}Ub=$b?($b!==pc[0]&&pc.unshift($b),Tb[$b]):void 0}a:{Tb=ra;Ab=Ub;cc=sb;$b=qb;var dc,uc,
...
dc)if(dc&&Tb['throws'])Ab=dc(Ab);else try{Ab=dc(Ab)}catch($c){var nc={state:'parsererror',error:dc?$c:'No conversion from '+vc+' to '+Sb};break a}}nc={state:'success',data:Ab}}Ub=nc;qb?(ra.ifModified&&(Xb=sb.getResponseHeader('Last-Modified'),Xb&&(b.lastModified[ic]=Xb),Xb=sb.getResponseHeader('etag'),Xb&&(b.etag[ic]=Xb)),204===Bb||'HEAD'===ra.type?gc='nocontent':304===Bb?gc='notmodified':(gc=Ub.state,kc=Ub.data,hc=Ub.error,qb=!hc)):(hc=gc,!Bb&&gc||(gc='error',0>Bb&&(Bb=0)));sb.status=Bb;sb.statusText=
(Qb||gc)+'';qb?ub.resolveWith(Oa,[kc,gc,sb]):ub.rejectWith(Oa,[sb,gc,hc]);sb.statusCode(Lb);Lb=void 0;aa&&Ta.trigger(qb?'ajaxSuccess':'ajaxError',[sb,ra,qb?kc:hc]);bb.fireWith(Oa,[sb,gc]);aa&&(Ta.trigger('ajaxComplete',[sb,ra]),--b.active||b.event.trigger('ajaxStop'))}}'object'==typeof a&&(c=a,a=void 0);c=c||{};var k,l,B,H,aa,la,Aa,ra=b.ajaxSetup({},c),Oa=ra.context||ra,Ta=ra.context&&(Oa.nodeType||Oa.jquery)?b(Oa):b.event,ub=b.Deferred(),bb=b.Callbacks('once memory'),Lb=ra.statusCode||{},lc={},Ic=
{},mc=0,yc='canceled',sb={readyState:0,getResponseHeader:function(Bb){var Qb;if(2===mc){if(!Aa)for(Aa={};Qb=Vd.exec(B);)Aa[Qb[1].toLowerCase()]=Qb[2];Qb=Aa[Bb.toLowerCase()]}return null==Qb?null:Qb},getAllResponseHeaders:function(){return 2===mc?B:null},setRequestHeader:function(Bb,Qb){var Tb=Bb.toLowerCase();return mc||(Bb=Ic[Tb]=Ic[Tb]||Bb,lc[Bb]=Qb),this},overrideMimeType:function(Bb){return mc||(ra.mimeType=Bb),this},statusCode:function(Bb){var Qb;if(Bb)if(2>mc)for(Qb in Bb)Lb[Qb]=[Lb[Qb],Bb[Qb]];
else sb.always(Bb[sb.status]);return this},abort:function(Bb){Bb=Bb||yc;return la&&la.abort(Bb),g(0,Bb),this}};if(ub.promise(sb).complete=bb.add,sb.success=sb.done,sb.error=sb.fail,ra.url=((a||ra.url||gd)+'').replace(Ud,'').replace(Xd,Lc[1]+'//'),ra.type=c.method||c.type||ra.method||ra.type,ra.dataTypes=b.trim(ra.dataType||'*').toLowerCase().match(Ba)||[''],null==ra.crossDomain&&(k=qd.exec(ra.url.toLowerCase()),ra.crossDomain=!(!k||k[1]===Lc[1]&&k[2]===Lc[2]&&(k[3]||('http:'===k[1]?'80':'443'))===
(Lc[3]||('http:'===Lc[1]?'80':'443')))),ra.data&&ra.processData&&'string'!=typeof ra.data&&(ra.data=b.param(ra.data,ra.traditional)),cb(rd,ra,c,sb),2===mc)return sb;(aa=b.event&&ra.global)&&0===b.active++&&b.event.trigger('ajaxStart');ra.type=ra.type.toUpperCase();ra.hasContent=!Wd.test(ra.type);var ic=ra.url;ra.hasContent||(ra.data&&(ic=ra.url+=(fd.test(ic)?'&':'?')+ra.data,delete ra.data),!1===ra.cache&&(ra.url=pd.test(ic)?ic.replace(pd,'$1_='+ed++):ic+(fd.test(ic)?'&':'?')+'_='+ed++));ra.ifModified&&
(b.lastModified[ic]&&sb.setRequestHeader('If-Modified-Since',b.lastModified[ic]),b.etag[ic]&&sb.setRequestHeader('If-None-Match',b.etag[ic]));(ra.data&&ra.hasContent&&!1!==ra.contentType||c.contentType)&&sb.setRequestHeader('Content-Type',ra.contentType);sb.setRequestHeader('Accept',ra.dataTypes[0]&&ra.accepts[ra.dataTypes[0]]?ra.accepts[ra.dataTypes[0]]+('*'!==ra.dataTypes[0]?', '+sd+'; q=0.01':''):ra.accepts['*']);for(l in ra.headers)sb.setRequestHeader(l,ra.headers[l]);if(ra.beforeSend&&(!1===
ra.beforeSend.call(Oa,sb,ra)||2===mc))return sb.abort();yc='abort';for(l in{success:1,error:1,complete:1})sb[l](ra[l]);if(la=cb(Xc,ra,c,sb)){if(sb.readyState=1,aa&&Ta.trigger('ajaxSend',[sb,ra]),2===mc)return sb;ra.async&&0<ra.timeout&&(H=D.setTimeout(function(){sb.abort('timeout')},ra.timeout));try{mc=1,la.send(lc,g)}catch(Bb){if(!(2>mc))throw Bb;g(-1,Bb)}}else g(-1,'No Transport');return sb},getJSON:function(a,c,g){return b.get(a,c,g,'json')},getScript:function(a,c){return b.get(a,void 0,c,'script')}});
...
$d.test(this.nodeName)&&!Zd.test(a)&&(this.checked||!fb.test(a))}).map(function(a,c){a=b(this).val();return null==a?null:b.isArray(a)?b.map(a,function(g){return{name:c.name,value:g.replace(td,'\r\n')}}):{name:c.name,value:a.replace(td,'\r\n')}}).get()}});b.ajaxSettings.xhr=void 0!==D.ActiveXObject?function(){return this.isLocal?vb():8<Qa.documentMode?Eb():/^(get|post|head|put|delete|options)$/i.test(this.type)&&Eb()||vb()}:Eb;var ae=0,Vc={},Wc=b.ajaxSettings.xhr();D.attachEvent&&D.attachEvent('onunload',
...
g[l]+'');B.send(a.hasContent&&a.data||null);c=function(aa,la){if(c&&(la||4===B.readyState))if(delete Vc[H],c=void 0,B.onreadystatechange=b.noop,la)4!==B.readyState&&B.abort();else{var Aa={};var ra=B.status;'string'==typeof B.responseText&&(Aa.text=B.responseText);try{var Oa=B.statusText}catch(Ta){Oa=''}ra||!a.isLocal||a.crossDomain?1223===ra&&(ra=204):ra=Aa.text?200:404}Aa&&k(ra,Oa,Aa,B.getAllResponseHeaders())};a.async?4===B.readyState?D.setTimeout(c):B.onreadystatechange=Vc[H]=c:c()},abort:function(){c&&
...
l=D[k],D[k]=function(){B=arguments},g.always(function(){void 0===l?b(D).removeProp(k):D[k]=l;a[k]&&(a.jsonpCallback=c.jsonpCallback,ud.push(k));B&&b.isFunction(l)&&l(B[0]);B=l=void 0}),'script'):void 0});b.parseHTML=function(a,c,g){if(!a||'string'!=typeof a)return null;'boolean'==typeof c&&(g=c,c=!1);c=c||Qa;var k=Q.exec(a);g=!g&&[];return k?[c.createElement(k[1])]:(k=F([a],c,g),g&&g.length&&b(g).remove(),b.merge([],k.childNodes))};var vd=b.fn.load;b.fn.load=function(a,c,g){if('string'!=typeof a&&
...
!0:!1:Y[arguments[0]][arguments[1]]=arguments[2]}return S};S.find=function(){pa=!1;'boolean'==typeof arguments[arguments.length-1]&&(pa=arguments[arguments.length-1],delete arguments[arguments.length-1],--arguments.length);var y=null,F=null,p=null;try{y=JSON.stringify(arguments),F=JSON.parse(y),p=F.count()}catch(za){throw Error('filter must be an object\n'+za.stack);}if('undefined'!=typeof F&&0<p){1<p&&(pa=!0);p=y=null;var C=0,E=Array.isArray(this)?this:JSON.clone(D),N=[],u='',r=null,G=Y,K=R.searchOptionRules,
A=null,O=[],T=function(za,Ca,na,Ua,Na){if(null===za&&null===na)++Ua;else if(za&&-1<m.indexOf(u)&&'not null'==u&&'undefined'!=typeof na&&'object'!==typeof na&&'null'!=na&&'undefined'!=na)0>N.indexOf(na)&&++Ua;else if('undefined'!=typeof na&&'object'!==typeof na&&/(<|>|=)/.test(za)&&!/undefined|function/.test(typeof na))Ca=za,Na=na+za,'string'==typeof za&&'string'==typeof na&&(Na=za.replace(/^(<=|>=|!==|!=|===|!==)/g,''),'string'!=typeof na||/^"(.*)"$/.test(Na)||(za=za.replace(Na,'"'+Na+'"')),Na='"'+
na+'"'+za,za=Ca),/(\d{4})\-(\d{2})\-(\d{2})(\s+|T)(\d{2}):(\d{2}):(\d{2})/.test(na)&&/(\d{4})\-(\d{2})\-(\d{2})(\s+|T)(\d{2}):(\d{2}):(\d{2})/.test(za)?U(na.replace(/(\d{4})\-(\d{2})\-(\d{2})(\s+|T)(\d{2}):(\d{2}):(\d{2})/,'new Date("$&")')+za.replace(/(\d{4})\-(\d{2})\-(\d{2})(\s+|T)(\d{2}):(\d{2}):(\d{2})/,'new Date("$&")'))&&++Ua:U(Na)&&++Ua;else if('undefined'!=typeof na&&'object'!==typeof na&&na===za&&!G||'undefined'!=typeof na&&'object'!==typeof na&&na===za&&'undefined'==typeof G[Ca])++Ua;else if('undefined'!=
typeof na&&'object'!==typeof na&&G&&'undefined'!=typeof G[Ca]){var Ra=0;var pb=G[Ca].count();for(var Ia in G[Ca])Na[Ia][G[Ca][Ia]].re=Na[Ia][G[Ca][Ia]].re.replace(/%s/,za),r=Na[Ia][G[Ca][Ia]].modifiers?new RegExp(Na[Ia][G[Ca][Ia]].re,Na[Ia][G[Ca][Ia]].modifiers):new RegExp(Na[Ia][G[Ca][Ia]].re),r.test(na)&&++Ra;Ra==pb&&++Ua}return{matched:Ua}},sa=function(za,Ca,na,Ua){var Na=Ca.split(/\./g);Na=Na[Na.length-1];r=new RegExp('("'+Na+'":\\w+)');Na=null;try{na&&(Na=eval('_content.'+Ca))}catch(Ra){}Na&&
(Array.isArray(Na)?Na=Na[1].split(/:/)[1]:'string'==typeof Na&&/:/.test(Na)&&(Na=Na.split(/:/)[1]),/(<|>|=)/.test(za)?/(\d{4})\-(\d{2})\-(\d{2})(\s+|T)(\d{2}):(\d{2}):(\d{2})/.test(Na)&&/(\d{4})\-(\d{2})\-(\d{2})(\s+|T)(\d{2}):(\d{2}):(\d{2})/.test(za)?U(Na.replace(/(\d{4})\-(\d{2})\-(\d{2})(\s+|T)(\d{2}):(\d{2}):(\d{2})/,'new Date("$&")')+za.replace(/(\d{4})\-(\d{2})\-(\d{2})(\s+|T)(\d{2}):(\d{2}):(\d{2})/,'new Date("$&")'))&&++Ua:U(Na+za)&&++Ua:Na==za&&++Ua);return{matched:Ua}},qa=function(za,Ca,
na,Ua,Na){Ca=Ca.split(/\[\*\]/g);Na=Ca[0].replace(/\[\*\]/,'');na=na[Na];Ca=Ca[1];/^\./.test(Ca)&&(Ca=Ca.substr(1));Na=0;if(na)for(var Ra=0,pb=na.length;Ra<pb&&!(O=/\./.test(Ca)?sa(za,Ca,na[Ra],Na):T(za,Ca,na[Ra],Na,K),Na=O.matched,0<Na);++Ra);return{matched:Ua+Na}},Ea;for(Ea in E)if(E[Ea]||(E[Ea]={}),!/undefined|function/.test(typeof E[Ea]))for(let za=0,Ca=F.count();za<Ca;++za){y=F[za];p=y.count();A=0;for(var ua in y){if('undefined'==typeof y[ua])throw Error('filter `'+ua+'` cannot be left undefined');
u=null===y[ua]||/(boolean|number)/.test(typeof y[ua])?y[ua]:y[ua].toLocaleLowerCase();O=/\./.test(ua)?/\[\*\]/.test(ua)?qa(y[ua],ua,E[Ea],A,0):sa(y[ua],ua,E[Ea],A):T(y[ua],ua,E[Ea][ua],A,K);A=O.matched}if(A==p)if(pa&&W&&0>x.indexOf(E[Ea]._uuid)||W||!pa){if(!pa||pa&&0>N.indexOf(E[Ea]._uuid)||W)N[C]=E[Ea],++C}else pa&&!W&&0>N.indexOf(E[Ea]._uuid)&&(N[C]=E[Ea],++C)}}else N=D;Y=null;N.insert=S.insert;N.notIn=S.notIn;N.find=this.find;N.update=S.update;N.replace=S.replace;N.or=S.or;N.findOne=S.findOne;
...
var C=JSON.clone(Array.isArray(this)?this:D);if(Array.isArray(arguments[0]))var E=arguments[0];else W=!0,E=S.find.apply(this,arguments)||[],W=!1;if(0<E.length){if(p&&y&&'undefined'==typeof E[0]&&'undefined'==typeof E[0][y])throw Error('[ Collection ][ notIn ] `key` not valid');p&&!y&&'undefined'!=typeof E[0]._uuid?y='_uuid':'undefined'!=typeof E[0].id&&(y='id');if(!y||'undefined'==typeof E[0][y])throw Error('No comparison key defined !');var N=0,u=E.length,r=0,G,K=F.count(),A;if(p&&'undefined'!=typeof C[r]&&
C[r].hasOwnProperty(y))for(;N<u&&C.length;++N)for(r=0,p=C.length;r<p;++r){if('undefined'!=typeof C[r]&&'undefined'!=typeof E[N]&&C[r][y]===E[N][y]){C.splice(r,1);break}}else if('undefined'==typeof C[r])C=JSON.clone(E);else for(;N<u&&C.length;++N)for(r=0,p=C.length;r<p;++r)if('undefined'!=typeof C[r]){for(G=A=0;G<K;++G){if('undefined'==typeof F[G])throw Error('filter `'+G+'` cannot be left undefined');var O=F[G].count();var T=0;for(y in F[G])C[r].hasOwnProperty(y)&&C[r][y]===E[N][y]&&++T;T==O&&++A}if(A){C.splice(r,
1);break}}}y=C;y.notIn=S.notIn;y.limit=S.limit;y.find=S.find;y.findOne=S.findOne;y.insert=S.insert;y.replace=S.replace;y.update=S.update;y.orderBy=S.orderBy;y.max=S.max;y.delete=S.delete;y.toRaw=S.toRaw;y.filter=S.filter;return y};S.insert=function(y){if('object'!==typeof y)throw Error('filter must be an object');var F=Array.isArray(this)?this:D;y._uuid=Ga.v4();F.push(y);F.limit=S.limit;F.find=S.find;F.findOne=S.findOne;F.update=S.update;F.replace=S.replace;F.orderBy=S.orderBy;F.max=S.max;F.notIn=
...
if('undefined'==typeof p||!p||'object'!=typeof p)throw Error('[ Collection ][ update ] `set` argument must be defined: Object expected');var C=Array.isArray(arguments[0])?arguments[0]:S.find.apply(this,arguments)||[];F=Array.isArray(this)?this:JSON.clone(D);if(0<C.length){C=C.toRaw();for(var E=0,N=C.length;E<N;++E){C[E]=L(JSON.clone(p),C[E]);for(var u=0,r=F.length;u<r;++u)if('undefined'==typeof F[u][y]&&'_uuid'==y&&'undefined'!=typeof F[u].id&&(y='id'),F[u][y]==C[E][y]){F[u]=C[E];break}}}F.limit=
...
K[A]=r[O],++A;E=function(T,sa,qa,Ea,ua){var za='desc'==Ea[ua]?1:0,Ca,na=Ca=null;return'string'==typeof T[qa[ua]]&&''!=T[qa[ua]]?(Ca=T[qa[ua]].localeCompare(sa[qa[ua]]),0==za&&0!=Ca?0>Ca?-1:1:0!=Ca?0>Ca?1:-1:qa.length-1>ua?E(T,sa,qa,Ea,ua+1):0):'number'==typeof T[qa[ua]]||'number'==typeof sa[qa[ua]]?(Ca=(''+T[qa[ua]]).localeCompare(''+sa[qa[ua]],void 0,{numeric:!0}),0==za&&0!=Ca?0>Ca?-1:1:0!=Ca?0>Ca?1:-1:qa.length-1>ua?E(T,sa,qa,Ea,ua+1):0):'boolean'==typeof T[qa[ua]]||'boolean'==typeof sa[qa[ua]]?
('boolean'==typeof T[qa[ua]]&&(Ca=T[qa[ua]]?1:0),'boolean'==typeof sa[qa[ua]]&&(na=sa[qa[ua]]?1:0),Ca>na?0==za?1:-1:Ca<na?0==za?-1:1:qa.length-1>ua?E(T,sa,qa,Ea,ua+1):0):T[qa[ua]]>sa[qa[ua]]?0==za?1:-1:T[qa[ua]]<sa[qa[ua]]?0==za?-1:1:qa.length-1>ua?E(T,sa,qa,Ea,ua+1):0};return u.sort(function(T,sa){return E(T,sa,G,K,0)})};Array.isArray(y)||1<y.count()?C=C(F,y):(N=Object.keys(y)[0],C=y[N],C=p[C](N,F));C.find=S.find;C.findOne=S.findOne;C.limit=S.limit;C.notIn=S.notIn;C.insert=S.insert;C.update=S.update;
C.replace=S.replace;C.delete=S.delete;C.orderBy=S.orderBy;C.max=S.max;C.toRaw=S.toRaw;C.filter=S.filter;return C};S.toRaw=function(){for(var y=Array.isArray(this)?this:D,F=0,p=y.length;F<p;++F)y[F]._uuid&&delete y[F]._uuid;return JSON.clone(y)};S.filter=function(y){if('undefined'==typeof y)throw Error('`filter` parametter must be a string or an array.');var F=Array.isArray(this)?this:D;if(!F.length)return[];var p=0,C=F.length,E=[],N=0;if(Array.isArray(y))for(var u,r=y.length,G;p<C;++p){G=!1;for(u=
0;u<r;++u)'undefined'!=typeof F[p][y[u]]&&('undefined'==typeof E[N]&&(E[N]={}),E[N][y[u]]=F[p][y[u]],G=!0);G&&++N}else for(;p<C;++p)'undefined'!=typeof F[p][y]&&('undefined'==typeof E[N]&&(E[N]={}),E[N][y]=F[p][y],++N);return JSON.clone(E)};return S}'undefined'!==typeof module&&module.exports?module.exports=Collection:'function'===typeof define&&define.amd&&define('utils/collection',[],function(){return Collection});
function FormValidatorUtil(D,R,da,Ga){var L='undefined'!==typeof module&&module.exports?!1:!0,V=L?require('utils/merge'):require('../../../../../lib/merge');L||require('../../../../../helpers');L&&require('helpers/dateFormat');var pa=L?require('utils/routing'):require('../../../../../lib/routing'),W=function(){var p=!1,C=null;L?L&&'undefined'!=typeof gina.forms&&(C=gina.forms):C=getContext('gina').forms||null;C&&'undefined'!=typeof C.validators&&(p=!0);return p},Y={errors:{},keys:{'%l':'label','%n':'name',
...
query:'Must be a valid response',isApiError:'Condition not satisfied'}},m=null;if(D)m=V(JSON.clone(D),m),Y.data=V(JSON.clone(D),Y.data);else throw Error('missing data param');var U=function(p,C){var E=null;for(let N in Ga)if(Ga[N].name===C){E=(new DOMParser).parseFromString(p.innerHTML,'text/html').getElementById(Ga[N].id);break}if(E)return E;throw Error('Field `'+C+'` not found in fieldsSet');},x=function(p){var C;var E='';var N=p.length;for(C=0;C<N;){var u=p[C++];switch(u>>4){case 0:case 1:case 2:case 3:case 4:case 5:case 6:case 7:E+=
String.fromCharCode(u);break;case 12:case 13:var r=p[C++];E+=String.fromCharCode((u&31)<<6|r&63);break;case 14:r=p[C++];var G=p[C++];E+=String.fromCharCode((u&15)<<12|(r&63)<<6|(G&63)<<0)}}return E},ma=function(p,C){C=p.match(/\{\{([^{{}}]+)\}\}/g);for(let E=0,N=C.length;E<N;E++){let u=C[E].replace(/\[/g,'["').replace(/\]/g,'"]').replace(/\{|\}/g,'').trim();try{u=eval('data.'+u).replace(/^"|"$/g,''),p=p.replace(new RegExp(C[E].replace(/\{|\[|\]|\}/g,'\\$&'),'g'),u)}catch(r){}}return p},Da=function(p,
C){var E=m[this.name].errors||{},N=this.target.id||this.target.getAttribute('id');if(m.isValid()){var u=this.target.dataset.ginaFormValidatorTestedValue;console.debug('[ '+this.name+' ]','TESTED VALUE -> '+this.value+' vs '+u);N='asyncCompleted.'+N;var r=this.target.form.getAttribute('id'),G='undefined'!=typeof gina.validator&&'undefined'!=typeof gina.validator.$forms[r]&&'undefined'!=typeof gina.validator.$forms[r].cachedErrors?gina.validator.$forms[r].cachedErrors:null;if(!u||'undefined'==typeof u||
...
K=!0);E.query=F(this.error||C||Y.errorLabels.query,this);console.debug('[2] potential cached error detected !! ',K,G,' vs ',E.query);K&&(this.errors=E,this.valid=!1);'undefined'!=typeof gina.events[N]&&triggerEvent(gina,this.target,N,m[this.name]);return m[this.name]}var A=null,O=this;if(window.XMLHttpRequest)A=new XMLHttpRequest;else if(window.ActiveXObject)try{A=new ActiveXObject('Msxml2.XMLHTTP')}catch(ua){try{A=new ActiveXObject('Microsoft.XMLHTTP')}catch(za){}}C={isSynchrone:!1,headers:{}};u=
p.data||null;E=null;N=/^true$/i.test(this.target.form.dataset.ginaFormLiveCheckEnabled)?!0:!1;E=JSON.stringify(u);if(/\$/.test(E)){u=E.match(/\$[-_\[\]a-z 0-9]+/g)||[];r=G=null;for(let ua=0,za=u.length;ua<za;ua++)r=u[ua].replace(/\$/g,''),re=new RegExp('\\'+u[ua].replace(/\[|\]/g,'\\$&'),'g'),G=Y.data[r]||null,!G&&N&&(G=U(this.target.form,r).value),E=E.replace(re,G)}u=E.replace(/\\"/g,'');var T='undefined'==typeof p.validIf?!0:p.validIf;C=V(C,p,da);delete C.data;delete C.validIf;E=C.headers['Content-Type'];
var sa=null;N=this.target.getAttribute('id');if(!/^http/.test(C.url)&&/@/.test(C.url))try{K=pa.getRoute(C.url),C.url=K.toUrl()}catch(ua){throw ua;}if(C.withCredentials){if('withCredentials'in A)C.isSynchrone?A.open(C.method,C.url,C.isSynchrone):A.open(C.method,C.url);else if('undefined'!=typeof XDomainRequest)A=new XDomainRequest,A.open(C.method,C.url);else throw A=null,sa='CORS not supported: the server is missing the header `"Access-Control-Allow-Credentials": true` ',Error(sa);A.responseType='undefined'!=
typeof C.responseType?C.responseType:'';A.withCredentials=!0}else C.isSynchrone?A.open(C.method,C.url,C.isSynchrone):A.open(C.method,C.url);for(var qa in C.headers)'Content-Type'==qa&&'undefined'!=typeof E&&null!=E&&''!=E||A.setRequestHeader(qa,C.headers[qa]);'undefined'!=typeof E&&null!=E&&''!=E&&A.setRequestHeader('Content-Type',E);var Ea=function(ua){O.value=Y.data[O.name]=O.value?O.value.toLowerCase():O.value;var za=ua.isValid||!1;za=T!=za?!1:!0;m[O.name].valid=za;var Ca=m[O.name].errors||{},
na='undefined'!=typeof ua.error&&'undefined'!=typeof ua.fields?ua.fields:{};if(0<na.count()&&!za||!za){if(!za){var Ua=null;'undefined'!=typeof na[O.name]?Y.errorLabels.query=ma(na[O.name],p.data):'undefined'!=typeof ua.error&&/^5/.test(ua.status)&&(Ua=ua.error);Ca.query=F(Ua||O.error||Y.errorLabels.query||p.error,O);console.debug('[1] query error detected !! ',ua)}Ca.query||''!=O.value||(za=!0)}za&&'undefined'!=typeof Ca.query&&delete Ca.query;O.valid=za;ua=gina.validator.$forms[O.target.form.getAttribute('id')].cachedErrors||
{};0<Ca.count()?(O.errors=Ca,'undefined'==typeof m[O.name].errors&&(m[O.name].errors={}),m[O.name].errors=V(m[O.name].errors,Ca),'undefined'!=typeof Ca.query&&Ca.query&&('undefined'==typeof ua[O.name]&&(ua[O.name]={}),'undefined'==typeof ua[O.name].query&&(ua[O.name].query={}),ua[O.name].query[O.value]=Ca.query.slice(0)),Ca=O.target.getAttribute('data-gina-form-errors'),/query/.test(Ca)||O.target.setAttribute('data-gina-form-errors',Ca&&''!=Ca?Ca+' query':'query')):'undefined'!=typeof ua[O.name]&&
'undefined'!=typeof ua[O.name].query&&'undefined'!=typeof ua[O.name].query[O.value]&&delete ua[O.name].query[O.value];Ca=O.target.id||O.target.getAttribute('id');console.debug('prematurely completed event `asyncCompleted.'+Ca+'`');return triggerEvent(gina,O.target,'asyncCompleted.'+Ca,m[O.name])};A&&(A.onerror=function(ua,za){console.debug('query error [2] detected !! ',za,'Transaction error: might be due to the server CORS settings.\nPlease, check the console for more details.');isOnException=!0;
ua=this.getResponseHeader('Content-Type');if(/\/json/.test(ua))ua=JSON.parse(this.responseText),'undefined'==typeof ua.status&&(ua.status=this.status);else if(ua={status:A.status,message:''},/^(\{|\[)/.test(A.responseText))try{ua=V(ua,JSON.parse(A.responseText))}catch(Ca){ua=V(ua,Ca)}return Ea(ua)},A.onload=function(){try{sa=this.responseText;var ua=this.getResponseHeader('Content-Type');if(/\/json/.test(ua))sa=JSON.parse(this.responseText),'undefined'==typeof sa.status&&(sa.status=this.status);else if(sa=
{status:A.status,message:''},/^(\{|\[)/.test(A.responseText))try{sa=V(sa,JSON.parse(A.responseText))}catch(za){sa=V(sa,za)}return Ea(sa)}catch(za){throw za;}},D?A.send(u):A.send())}else console.debug('stopping on errors ...'),triggerEvent(gina,this.target,'asyncCompleted.'+N,m[this.name])},S=async function(p,C,E,N){var u=(new (require(_(GINA_FRAMEWORK_DIR+'/core/config.js',!0)))).getInstance(),r=null,G=null,K=null,A=getContext('bundle');if(/@/.test(p.url)){var O=p.url.split(/@/);G=O[0];K=O[1];getConfig(A,
'app');try{u.bundle!==K&&(r=getConfig(A,'app').proxy[K])}catch(Ea){throw Error('Could not retrieve `proxy` configuration for bundle `'+K+'`. Please check your `/config/app.json`.\n'+Ea.stack);}O=null}else throw Error('external url/domain not  handled at this moment, please contact us if you need support for it.');O=JSON.clone(pa.getRoute(p.url,p.data));var T=u[K][u.env];r||(u.bundle==K&&(r=getConfig(A,'settings').server.credentials,p.ca=r.ca||null,p.hostname=T.server.scheme+'://'+T.host,p.port=T.port[T.server.protocol][T.server.scheme],
...
'/core/controller/controller.js'),!0))(K);T.name=O.param.control;T.setOptions(C,E,N,K);C='object'==typeof p.data&&0<p.data.count()?p.data:{};if(/^get|delete|put$/i.test(p.method)){E=0;for(let Ea in C)'object'==typeof C[Ea]&&encodeURIComponent(JSON.stringify(C[Ea])),E++}r.method=p.method;r.path=O.url;p=require('util').promisify;var sa={isValid:!1},qa=!1;await p(T.query)(r,C).then(function(Ea){sa=Ea}).catch(function(Ea){qa=Ea});qa&&(console.error(qa),sa.error=qa);return sa},I=null;I=L?Da:S;var y=function(p,
C){var E=null,N=null;'undefined'==typeof m[p]&&'undefined'!=typeof C&&(m[p]=E=C);if('object'==typeof m[p])try{E=JSON.parse(JSON.stringify(m[p]))}catch(u){E=m[p]}else E=m[p];N='';L&&'undefined'!=typeof R&&(N=R[p].getAttribute('data-gina-form-field-label')||'');m[p]={target:L&&'undefined'!=typeof R?R[p]:null,name:p,value:E,valid:!1,label:N,exclude:!1};m[p].is=function(u,r,G){var K=!1,A='undefined'!=typeof window&&'undefined'!=typeof window._currentValidatorAlias?window._currentValidatorAlias:'is';'undefined'!=
...
I.match(/\/(.*)\//).pop(),p=I.replace('/'+F+'/',''),F=(new RegExp(F,p)).test(U);else if(/^validator::/.test(I)&&U){p={};F={};E={};N='';m.replace(new RegExp('[^'+C+']','g'),function(O){N+=O});p[C]=U.replace(new RegExp(N,'g'),'');try{F=JSON.parse(I.split(/::/).splice(1)[0].replace(/([^:"\s+](\w+)):/g,'"$1":').replace(/([^:"\s+](\w+))\s+:/g,'"$1":'))}catch(O){throw O;}'undefined'!=typeof F.query&&'undefined'!=typeof F.query.data&&m==F.query.data[Object.keys(F.query.data)[0]]&&(F.query.data[Object.keys(F.query.data)[0]]=
p[C],ma.params[C]=p[C]);E[C]=F;p=new L('routing',p,null,E);if(0==F.count())return console.error('Route validation failed '+x.rule),!1;for(var r in F)Array.isArray(F[r])?await p[C][r].apply(p[C],F[r]):await p[C][r](F[r],ma,Da,S);F=p.isValid()}else F=(new RegExp(x.requirements[C])).test(U);if('undefined'!=typeof x.param[C]&&'undefined'!=typeof x.requirements&&'undefined'!=typeof x.requirements[C]&&'undefined'!=typeof ma.params&&F)return ma.params[C]=U,'undefined'==typeof ma[u][C]&&(ma[u][C]=U),!0}else{Da=
x.url;S=ma.url;u={};E='';var G=!1,K=0;r=0;for(var A=S.length;r<A;++r)if(S.charAt(r)!=Da.charAt(K)||G){if(''==E)G=!0,E+=S.charAt(r);else if(r>Da.indexOf(y[0])+y[0].length){I=x.requirements[y[0]];U=E.substr(0,E.length);if(/^\//.test(I))F=I.match(/\/(.*)\//).pop(),p=I.replace('/'+F+'/',''),F=(new RegExp(F,p)).test(U);else if(/^validator::/.test(I)){p={};F={};E={};N='';m.replace(new RegExp('[^'+C[0]+']','g'),function(O){N+=O});p[C[0]]=U.replace(new RegExp(N,'g'),'');F=JSON.parse(I.split(/::/).splice(1)[0].replace(/([^\W+ true false])+(\w+)/g,
'"$&"'));E[C[0]]=F;p=new L('routing',p,null,E);for(let O in F)if(Array.isArray(F[O]))p[C[0]][O].apply(p[C[0]],F[O]);else p[C[0]][O](F[O]);F=p.isValid()}else F=(new RegExp(x.requirements[C[0]])).test(U);if(F)u[y[0].substr(1)]=U;else return!1;E='';G=!1;K=Da.indexOf(y[0])+y[0].length;--r;y.splice(0,1)}else E+=S.charAt(r),++K;if(r==A-1)if(I=x.requirements[y[0]],U=E.substr(0,E.length),/^\//.test(I)?(F=I.match(/\/(.*)\//).pop(),p=I.replace('/'+F+'/',''),F=(new RegExp(F,p)).test(U)):F=(new RegExp(x.requirements[C])).test(U),
...
(p=R.getUrlProps(this.bundle,Da||GINA_ENV));var C=this.webroot||p.webroot;p=this.hostname||p.hostname;var E=this.url;this.url='undefined'!=typeof F&&1==F?E.replace(C,'/'):E;return p+this.url};ma.request=function(F,p){var C=null,E=null;'function'==typeof arguments[arguments.length-1]&&(C=arguments[arguments.length-1]);'object'==typeof arguments[2]&&(E=arguments[2]);var N=this.webroot||E.webroot,u=this.hostname||E.hostname;E='undefined'!=typeof F&&1==F?path.replace(N,'/'):this.url||E.url;u=/^https/.test(u)?
'https':'http';D?window.open(E,'undefined'!=typeof p&&'undefined'!=typeof p.target?p.target:'_self'):('undefined'==typeof p.agent&&(p.agent=!1),u=require(''+u),N=function(r){var G='',K=!1;r.on('data',function(A){G+=A});r.on('error',function(A){K='Failed to get mail content';A&&'undefined'!=typeof A.stack?K+=A.stack:'string'==typeof A&&(K+='\n'+A)});r.on('end',function(){if(/^\{/.test(G))try{G=JSON.parse(G),'undefined'!=typeof G.error&&(K=JSON.clone(G),G=null)}catch(A){K=A}K?C(K):C(!1,G)})},C?u.get(E,
p,N):u.get(E,p))};/:/.test(ma.url)&&(U=ma.url.match(/(:(.*)\/|:(.*)$)/g).map(function(F){return F.replace(/\//g,'')}).join(', '),I='[ RoutingHelper::getRoute(rule[, bundle, method]) ] : route [ %r ] param placeholder not defined: `'+ma.url+'` !\n Check your route description to compare requirements against param variables [ '+U+']',I=I.replace(/%r/,m),console.warn(Error(I)));return ma};R.getRouteByUrl=function(m,U,x,ma,Da){2==arguments.length&&'undefined'!=typeof arguments[1]&&-1<R.allowedMethods.indexOf(arguments[1].toLowerCase())&&
(x=arguments[1],U=void 0);var S=null,I=null,y=null,F=null,p=null,C=null;if(/#/.test(m)&&1<m.length){var E=m.split(/#/);m=E[0];p='#'+E[1];E=null}1==arguments.length&&'undefined'!=typeof arguments[0]&&(/^(https|http)/i.test(m)||/^\//.test(m)||(m='/'+m),S='/'+m.split(/\//g)[1],D&&(F=gina.config.reverseRouting,y=gina.config.routing),'undefined'!=typeof F[S]&&(E=y[F[S]],U=E.bundle,S=E.webroot,C=E.hostname,E=null));Da='boolean'!=typeof arguments[arguments.length-1]?!1:arguments[arguments.length-1];var N=
!1,u=null,r=null,G=u=r=null;E='undefined'!=typeof x?!0:!1;D?(u=window.gina.config,U='undefined'!=typeof U?U:u.bundle,r=u.env,y=y||u.getRouting(U),F=F||u.reverseRouting,isXMLRequest='undefined'!=typeof isXMLRequest?isXMLRequest:!1,C=C||u.hostname,S=S||u.webroot,ma={routing:{},method:x,params:{},url:m}):(u=getContext('gina').config,U='undefined'!=typeof U?U:u.bundle,r=u.env,y=u.getRouting(U),C=u.envConf[U][r].hostname,S=u.envConf[U][r].server.webroot,ma||={routing:{},isXMLRequest:!1,method:'undefined'!=
typeof x?x.toLowerCase():'get',params:{},url:m},Da&&(ma.method=x),isXMLRequest=ma.isXMLRequest||!1);r=m.replace(new RegExp('^('+C+'|'+C.replace(/:\d+/,'')+')'),'');'undefined'==typeof ma.routing.path&&(ma.routing.path=unescape(r));x='undefined'!=typeof x?x.toLowerCase():'get';E&&(ma.originalMethod=ma.method,ma.method=x,ma.routing.path=unescape(r));ma.method||(ma.method=x);u={};S=new RegExp(x,'i');F=null;var K;for(K in y){if('undefined'==typeof y[K].param)break;if(y[K].bundle==U&&(F=y[K].method,/,/.test(F)&&
...
function StoragePlugin(D){function R(I){U=JSON.parse(Y.getItem(this.bucket));'undefined'==typeof U[I]&&(U[I]=[],Y.setItem(this.bucket,JSON.stringify(U)),U=JSON.parse(Y.getItem(this.bucket)));m[I]={_collection:I,_bucket:this.bucket};m[I]=Ga(m[I],Da);return m[I]}function da(I){if('object'!==typeof I)throw Error('filter must be an object');var y=U[this._collection],F=I.count(),p=0,C=null;if(0==F)return null;for(var E in y)for(var N in I){var u='boolean'!=typeof I[N]?I[N].toLocaleLowerCase():I[N];I[N]&&
-1<x.indexOf(u)&&'not null'==u&&'undefined'!=typeof y[E][N]&&'object'!==typeof y[E][N]&&y[E][N]===I[N]&&'null'!=y[E][N]&&'undefined'!=y[E][N]?0>C.indexOf(y[E][N])&&(++p,p===F&&(C=y[E],C._index=E,C._collection=this._collection,C._bucket=this._bucket)):'undefined'!=typeof y[E][N]&&'object'!==typeof y[E][N]&&y[E][N]===I[N]&&(++p,p===F&&(C=y[E],C._index=E,C._collection=this._collection,C._bucket=this._bucket,C._filter=I))}C&&(C.save=S);return C}var Ga=Ga||require('utils/merge');R=R||require('utils/collection');
var L=L||require('vendor/uuid'),V=V||require('helpers/dateFormat'),pa={bucket:'default'},W={},Y=null,m={},U={},x=['not null'],ma={bucket:void 0,drop:function(){Y.removeItem(pa.bucket);W=null;for(var I in this)delete this[I];return W},Collection:R},Da={insert:function(I){I._id=L.v1();I._createdAt=(new Date).format('isoDateTime');I._updatedAt=(new Date).format('isoDateTime');U[this._collection][U[this._collection].length]=I;Y.setItem(this._bucket,JSON.stringify(U))},find:function(I,y){if(!I)return U[this._collection];
if('object'!==typeof I)throw Error('filter must be an object');y=U[this._collection];I.count();var F=0,p=[],C;for(C in y)for(var E in I){var N='boolean'!=typeof I[E]?I[E].toLocaleLowerCase():I[E];I[E]&&-1<x.indexOf(N)&&'not null'==N&&'undefined'!=typeof y[C][E]&&'object'!==typeof y[C][E]&&'null'!=y[C][E]&&'undefined'!=y[C][E]?0>p.indexOf(y[C][E])&&(p[F]=y[C][E],++F):'undefined'!=typeof y[C][E]&&'object'!==typeof y[C][E]&&y[C][E]===I[E]&&(p[F]=y[C],++F)}return p},findOne:da,update:null,'delete':function(I){if('object'!==
typeof I)throw Error('filter must be an object');var y=JSON.clone(U[this._collection]),F=0,p=[],C;for(C in y)for(var E in I)I[E]&&-1<x.indexOf(I[E].toLocaleLowerCase())&&'not null'==I[E].toLowerCase()&&'undefined'!=typeof y[C][E]&&'object'!==typeof y[C][E]&&'null'!=y[C][E]&&'undefined'!=y[C][E]?0>p.indexOf(y[C][E])&&(p[F]=y[C][E],delete U[this._collection][C][E],++F):'undefined'!=typeof y[C][E]&&'object'!==typeof y[C][E]&&y[C][E]===I[E]&&(p[F]=y[C],U[this._collection].splice(C,1),++F);return 0<p.length?
(Y.setItem(this._bucket,JSON.stringify(U)),!0):!1},drop:function(I){if('undefined'==typeof U[this._collection])throw Error('Collection `'+I+'` not found');delete m[this._collection];delete U[this._collection];Y.setItem(this._bucket,JSON.stringify(U))}},S=function(I){I=I||!1;try{var y=JSON.clone(U),F=this._index,p=this._collection,C=this._bucket,E=this._filter;this._updatedAt=(new Date).format('isoDateTime');Ga(y[p][F],this,!0);delete y[p][F]._index;delete y[p][F]._collection;delete y[p][F]._bucket;
...
y[p][F]=N(this,y[p][F]):'object'==typeof y[p][F]?y[p][F]=u(this,y[p][F]):'undefined'==typeof this[prop]&&delete y[p][F]}U[p][F]=y[p][F];Y.setItem(C,JSON.stringify(U));return da(E)}catch(r){throw r;}};(function(I){if(!window.localStorage||window.localStorage&&'undefined'==!typeof window.localStorage.setItem)throw Error('Make sure your browser supports `window.localStorage` to use Gina Storage. See: `https://developer.mozilla.org/en-US/docs/Web/API/Web_Storage_API#Browser_compatibility`');if('object'!=
typeof I&&'undefined'!=typeof I)throw Error('`options` must be an object');'undefined'==typeof I&&(I={});pa=Ga(I,pa);Y=window.localStorage;I=pa.bucket;if(!Y.getItem(I)&&void 0!=I)Y.setItem(I,JSON.stringify(U));else if(void 0==I)throw Error('`bucket` name cannot be undefined');W.bucket=I;W=Ga(W,ma)})(D);return W}
if('undefined'!==typeof module&&module.exports){var merge=require('utils/merge');Collection=require('utils/collection');var uuid=require('uuid');module.exports=StoragePlugin}else'function'===typeof define&&define.amd&&define('gina/storage',['helpers/dateFormat','helpers/prototypes'],function(){return StoragePlugin});function insertAfter(D,R){D.parentNode.insertBefore(R,D.nextSibling)}
function getElementsByAttribute(D){for(var R=[],da=0,Ga=document.getElementsByTagName('*'),L=0,V=Ga.length;L<V;++L)null!==Ga[L].getAttribute(D)&&(R[da]=Ga[L],++da);return R}
(function(D){var R=D.prototype,da=R.parseFromString;try{if((new D).parseFromString('','text/html'))return}catch(Ga){}R.parseFromString=function(Ga,L){if(/^\s*text\/html\s*(?:;|$)/i.test(L)){var V=document.implementation.createHTMLDocument('');-1<Ga.toLowerCase().indexOf('<!doctype')?V.documentElement.innerHTML=Ga:V.body.innerHTML=Ga;return V}return da.apply(this,arguments)}})(DOMParser);define('utils/dom',function(){});
function ValidatorPlugin(D,R,da){this.plugin='validator';var Ga='init ready registered success error progress submit reset change changed keydown keyup focusout focusin validate validated destroy asyncCompleted'.split(' '),L='undefined'!==typeof module&&module.exports?!1:!0,V=null;L?(require('utils/events'),registerEvents(this.plugin,Ga),require('utils/dom'),require('utils/effects'),V=gina.config.envIsDev):(V=/^true$/i.test(process.env.NODE_ENV_IS_DEV)?!0:!1)&&delete require.cache[require.resolve('./form-validator')];
var pa=L?require('vendor/uuid'):require('uuid'),W=L?require('utils/merge'):require('../../../../../lib/merge'),Y=L?require('utils/inherits'):require('../../../../../lib/inherits'),m=L?require('utils/form-validator'):require('./form-validator'),U=L?require('utils/routing'):require('../../../../../lib/routing'),x={id:'validator-'+pa.v4(),plugin:this.plugin,on:L?on:null,eventData:{},target:L?document:null,errors:{},initialized:!1,isReady:!1,rules:{},$forms:{},getFormById:null,validateFormById:null,setOptions:null,
...
!0:!1,!I.responseType&&X&&(I.responseType='blob'));if(4==I.readyState){var Ya=null,Sa=I.getResponseHeader('Content-Type');if(/^2/.test(I.status)){try{if(/blob/.test(I.responseType)||X){if('undefined'==typeof Sa||null==Sa)Sa='application/octet-stream';Ya=new Blob([this.response],{type:Sa});var ob=document.createElement('a');ob.style='display: none';document.body.appendChild(ob);var xb=window.URL.createObjectURL(Ya);ob.href=xb;var Kb=I.getResponseHeader('Content-Disposition');ob.download=Kb.match('=(.*)')[0].substr(1);
ob.click();window.URL.revokeObjectURL(xb);q={status:I.status,statusText:I.statusText,responseType:Ya.type,type:Ya.type,size:Ya.size}}else q=I.responseText;/\/json/.test(Sa)&&(q=JSON.parse(I.responseText),'undefined'==typeof q.status&&(q.status=I.status));if(/\/html/.test(Sa)&&(q={contentType:Sa,content:I.responseText},'undefined'==typeof q.status&&(q.status=I.status),'undefined'!=typeof gina.popin&&gina.hasPopinHandler)){var eb=gina.popin.getActivePopin();if(eb){z={};try{z=(new DOMParser).parseFromString(q.content,
...
FormData){var ta=event.currentTarget.getAttribute('data-gina-form-upload-group')||'untagged',ka,ia;for([ka,ia]of e.entries())ia instanceof File?(b||=!0,v[Q]={key:ka,group:ta,file:ia,bin:''},++Q):fa[ka]=ia}else e=JSON.stringify(e);if(b&&0<v.length){var Ba='--ginaWKBoundary'+pa.v4().replace(/\-/g,'');return Ea(v,Ba,'',0,function(ya,Ya,Sa){if(ya)/^gina\-upload/i.test(n)&&sa(gina,h,'error',n,ya),triggerEvent(gina,h,'error.'+n,ya),P&&triggerEvent(gina,h,'error.'+n+'.hform',ya);else return Sa&&(I.setRequestHeader('Content-Type',
...
b.target,'destroy.'+h,function(n){cancelEvent(n);delete x.$forms[h];removeListener(gina,n.currentTarget,n.type);removeListener(gina,n.currentTarget,'destroy')}),b=Fb(b),triggerEvent(gina,b.target,'destroy.'+h);else throw Error('[ FormValidator::destroy(formId) ] `'+h+'` not found');},Ca=function(e){e='undefined'!=typeof e?e:x.rules;for(let n in e){var b=Object.getOwnPropertyNames(e[n]),h=0;let w=b.length,q=!1,z=null;for(;h<w;){if(/^_case_/.test(b[h])){q=!0;z=b[h];break}h++}q||'object'!=typeof e[n]||
Ca(e[n]);if(z&&Array.isArray(e[n][z].conditions)&&0<e[n][z].conditions.length)for(b=0,h=e[n][z].conditions.length;b<h;)'undefined'!=typeof e[n][z].conditions[b].rules&&0==e[n][z].conditions[b].rules.count()&&(e[n][z].conditions.splice(b,1),h--,b--),b++}},na=function(e){var b=JSON.stringify(e),h=b.match(/("@import\s+[-_a-z A-Z 0-9/.]+")/g)||[],n=[];for(let X=0,P=h.length;X<P;X++)0>n.indexOf(h[X])&&n.push(h[X]);h=n;n=b.match(/("_merging(.*))(\s+:|:)(.*)(",|")/g);x.rules||(x.rules={});if(h&&0<h.length){e=
...
'g'),'{}'))):console.warn('[formValidator:rules] <@import error> on `'+h[X]+'`: rule `'+q[ba]+'` not found. Ignoring.')}q=new RegExp(h[X]);if(w=n&&q.test(n.join())?!0:!1)for(let ba=0,Q=n.length;ba<Q;ba++)if(q.test(n[ba])){w=JSON.stringify(e);w=w.substr(1,w.length-1);ba<Q-1&&(w+=',');try{b=b.replace(new RegExp(n[ba],'g'),w),x.rules=JSON.parse(JSON.stringify(x.rules).replace(new RegExp(n[ba],'g'),'{}'))}catch(v){throw v;}}e={}}e=JSON.parse(b);Na(e,'');try{Ca()}catch(X){console.error(X.stack)}}return e},
Ua=function(e){gina.hasValidator?(x=W(x,gina.validator),x.on('init',function(b){x.isReady=!0;triggerEvent(gina,x.target,'ready.'+x.id,x)})):(x.target=document,x.setOptions=p,x.getFormById=C,x.validateFormById=N,x.resetErrorsDisplay=K,x.resetFields=A,x.handleErrorsDisplay=G,x.send=T,x.on('init',function(b){if('undefined'!=typeof e&&e.count())try{Na(e,''),e=na(e),gina.forms.rules='undefined'!=typeof gina.forms.rules&&gina.forms.rules?W(gina.forms.rules,e,!0):e,x.rules=W(x.rules,JSON.clone(gina.forms.rules),
!0)}catch(X){throw X;}Da.count()||(Da=JSON.clone(x.rules));ma.setOptions=p;ma.getFormById=C;ma.validateFormById=N;ma.resetErrorsDisplay=K;ma.resetFields=A;ma.handleErrorsDisplay=G;ma.submit=O;ma.send=T;ma.unbind=Fb;ma.bind=Gb;ma.reBind=yb;ma.destroy=za;b=0;for(var h=document.getElementsByTagName('form'),n=0,w=h.length;n<w;++n){if(h[n].getAttribute){var q=h[n].getAttribute('id')||'form.'+pa.v4();q!==h[n].getAttribute('id')&&h[n].setAttribute('id',q)}else q='form.'+pa.v4(),h[n].setAttribute('id',q);
...
(q=x.$forms[q].target,z?Gb(q,z):Gb(q),++b):('object'==typeof h[n].id?(delete x.$forms[h[n].id],q=h[n].attributes.getNamedItem('id').nodeValue||'form.'+pa.v4(),h[n].setAttribute('id',q),h[n].id=q,ma.target=h[n],x.$forms[q]=W({},ma),q=x.$forms[q].target):q=x.$forms[h[n].id].target,z?Gb(q,z):Gb(q))}if(window.XMLHttpRequest)I=new XMLHttpRequest;else if(window.ActiveXObject)try{I=new ActiveXObject('Msxml2.XMLHTTP')}catch(X){try{I=new ActiveXObject('Microsoft.XMLHTTP')}catch(P){}}x.isReady=!0;gina.hasValidator=
!0;gina.validator=x;triggerEvent(gina,x.target,'ready.'+x.id,x)}));x.initialized=!0;return x},Na=function(e,b){var h;for(h in e)if('object'==typeof e[h]&&'undefined'==typeof x.rules[b+h]){var n=h;/\[|\]/.test(h)&&(n=h.replace(/\[/g,'.').replace(/\]/g,''));x.rules[b+n]=e[h];Na(e[h],b+n+'.')}},Ra=function(e){if('undefined'!=typeof Da[e])return Da[e];var b=null;if('undefined'==typeof x.rules[e]){if(Na(Da,''),Da=na(Da),b=Da[e],!b)return{}}else b=x.rules[e];b=JSON.clone(b);var h=new RegExp('^'+e),n=new RegExp('^'+
e+'.'),w=null,q=function(X,P,ba,Q,v,fa,ta){if(P.length){var ka=Object.getOwnPropertyNames(X)[0],ia=P[0];ia=''==v?v+=ia:v+'['+ia+']';1==P.length&&(X[ka]=W(X[ka],ba,!0));P.splice(0,1);ia==ka?q(X[ka],P,ba,Q,ia,fa,ta):'undefined'!=typeof X[ka]?q(X[ka],P,ba,Q,ia,fa,ta):q(X,P,ba,Q,v,fa,ta)}},z;for(z in x.rules)z!=e&&h.test(z)&&(w=z.replace(n,''),/\./.test(w)&&(w=w.split(/\./g),q(b,w,x.rules[z],b,'',0,b.count()-1)));return Da[e]=b},pb=function(e,b,h,n,w,q,z){var X=window.gina._global;X.register({root:e||
...
if('undefined'==typeof obj[e])return/^\d+$/.test(h)?obj[e]=[]:obj[e]={},++w,pb(root,b,obj[e],n,w,value,rootObj);++w;return pb(root,b,obj[e],n,w,value,rootObj)},Ia=function(e,b,h,n,w){if(w>=n)return!1;var q=h[w].replace(/^\[|\]$/g,''),z=w<n-1&&'undefined'!=typeof h[w+1]?h[w+1].replace(/^\[|\]$/g,''):null;'undefined'==typeof e[q]&&(z&&/^\d+$/.test(z)?(parseInt(z),e[q]=[]):e[q]={});Array.isArray(e[q])?(z=pb(q,h,e[q],h.length,1,b,null),e[q]=W(e[q],z)):w==n-1&&(e[q]=b);Ia(e[q],b,h,n,w+1)},La=function(e){var b=
...
'undefined'==typeof gina.events['registered.'+b.id]){/^file$/i.test(b.type)||Za(b);switch(b.tagName.toLowerCase()){case 'textarea':wb(e,b,null,!0);break;default:wb(e,b,null),e=b.getAttribute('autocomplete'),/safari/i.test(navigator.userAgent)&&e&&/^(off|false)/i.test(e)&&Cb(b,null)}gina.events['registered.'+b.id]=b.id}},Eb=function(e,b,h){var n=b.id+'-'+h+'-'+e+'-trigger',w=document.getElementById(n);w||(n=b.getAttribute('data-gina-form-upload--'+h+ +e+'-trigger'),w=document.getElementById(n));w&&
'undefined'==typeof w.isBinded||w&&'undefined'!=typeof w.isBinded&&!/true/i.test(w.isBinded)?(addListener(gina,w,'click',function(q){q.preventDefault();qa(b,e)}),w.isBinded=!0):console.warn('[FormValidator::bindForm][upload]['+b.id+'] : did not find `upload '+e+' trigger`.\nPlease, make sure that your delete element ID is `'+n+'-'+e+'-trigger`, or add to your file input ('+b.id+') -> `data-gina-form-upload-'+e+'-trigger="your-custom-id"` definition.')},vb=function(e,b){var h=function(n,w,q){var z=
...
X.toUrl())):(n='`'+w+'` needs to be defined to proceed for your `input[type=file]` with ID `'+n.id+'`\n'+P+'\n',q&&(q.innerHTML+=n.replace(/(\n|\r)/g,'<br>')),console.error(n))}};h(e,'data-gina-form-upload-action',b);h(e,'data-gina-form-upload-reset-action',b);h(e,'data-gina-form-upload-delete-action',b)},yb=function(e,b,h){e=Fb(e);Gb(e.target,b);return h?h(e):e},Fb=function(e){var b=null,h=null;try{if(e.getAttribute&&e.getAttribute('id'))if(h=e.getAttribute('id'),'undefined'!=typeof x.$forms[h])b=
...
b[ea].getAttribute('data-gina-form-upload-trigger');Ba||(Ba=b[ea].id);ta=null;ia=(new DOMParser).parseFromString(e.innerHTML,'text/html');Ba&&(ta=document.getElementById(Ba));ba=document.getElementById(b[ea].id+'-error');vb(b[ea],ba);if((ba=ia.getElementById(Ba+'-preview'))&&ta&&!/none/i.test(window.getComputedStyle(ba).display)&&!/none/i.test(ba.parentElement.style.display)){ia=0;console.debug('preview is visible ...');ta.customFiles=[];ta.form=e;ba=ba.childNodes;for(let ha=0,oa=ba.length;ha<oa;ha++){var Ya=
null;if(/ul/i.test(ba[ha].tagName))for(let Ma=0,$a=ba[ha].length;Ma<$a;Ma++){let db=$$els[ha];for(let Ka=0,tb=db.length;Ka<tb;Ka++)/img/i.test(db[Ka])&&(Ya=db[Ka],Ya.setAttribute(''),ia++)}else/img/i.test(ba[ha].tagName)&&(Ya=ba[ha],deleteLinkId=Ba+'-'+ia+'-delete-trigger',Ya=Ya.src.substr(Ya.src.lastIndexOf('/')+1),ta.customFiles.push({name:Ya,deleteLinkId}),Eb('delete',ta,ia),ia++)}}addListener(gina,b[ea],'change',function(ha){ha.preventDefault();var oa=ha.currentTarget;ha=oa.files;oa.customFiles=
Array.from(ha);if(!ha.length)return!1;var Ma=oa.getAttribute('data-gina-form-upload-action'),$a=oa.getAttribute('name'),db='gina-upload-'+$a.replace(/\[/g,'-').replace(/\]/g,'-'+h.id);oa.setAttribute('data-gina-form-virtual',db);var Ka=oa.getAttribute('data-gina-form-upload-on-success'),tb=oa.getAttribute('data-gina-form-upload-on-error'),hb=null;if(0<ha.length){var lb=null;if(E()){lb=gina.popin.getActivePopin();lb.$target=(new DOMParser).parseFromString(lb.target.outerHTML,'text/html');lb.$target.getElementById(lb.id).innerHTML=
document.getElementById(lb.id).innerHTML;var mb=lb.$target.getElementById(db)}else mb=document.getElementById(db);if(!mb){try{mb=C(db)||null}catch(Tc){}mb||=E()?lb.$target.createElement('form'):document.createElement('form');mb.id=db;mb.action=Ma;mb.enctype='multipart/form-data';mb.method='POST';if('undefined'!=typeof oa.form){Ma='files';var nb=oa.getAttribute('data-gina-form-upload-prefix')||oa.name||oa.getAttribute('name'),jb=oa.id||oa.getAttribute('id'),Pb=!1,Hb=oa.getAttribute('data-gina-form-upload-preview')||
jb+'-preview';Hb=E()?lb.$target.getElementById(Hb):document.getElementById(Hb);'undefined'!=typeof Hb&&(Pb=!0);nb&&(Ma=nb);nb=[];for(var Jb='name group originalFilename ext encoding size height width location mime preview'.split(' '),Mb=oa.form.getElementsByTagName('INPUT'),ac,Wb,Gc,qc,Ob=0,Nc=ha.length;Ob<Nc;++Ob){Eb('reset',oa,Ob);nb[Ob]=null;ac=Ma+'['+Ob+']';qc=new RegExp('^'+ac.replace(/\[/g,'\\[').replace(/\]/g,'\\]'));for(var wc=0,xc=Mb.length;wc<xc;++wc)ac=Mb[wc].getAttribute('type'),hb=Mb[wc].getAttribute('data-gina-form-upload-error')||
...
{id:oa.form.id||oa.getAttribute('id'),uploadTriggerId:oa.id,$form:oa.form,errorField:hb,mandatoryFields:Jb,uploadFields:nb,hasPreviewContainer:Pb,isPopinContext:E()};Pb&&(mb.uploadProperties.previewContainer=Hb)}Ka?mb.setAttribute('data-gina-form-event-on-submit-success',Ka):mb.setAttribute('data-gina-form-event-on-submit-success','onGenericXhrResponse');tb?mb.setAttribute('data-gina-form-event-on-submit-error',tb):mb.setAttribute('data-gina-form-event-on-submit-error','onGenericXhrResponse');E()?
document.getElementById(lb.id).appendChild(mb):document.body.appendChild(mb)}try{var sc=C(db),Sc=new FormData;oa=null;db=0;for(var Oc=ha.length;db<Oc;++db)oa=ha[db],Sc.append($a,oa,oa.name);sc.send(Sc,{withCredentials:!0})}catch(Tc){throw Tc;}}})}}var Sa=function(ea,Z){ea.setAttribute('data-value',ea.value);if(/^(true)$/i.test(Z.target.dataset.ginaFormLiveCheckEnabled&&0<Z.rules.count())){var ha={},oa={},Ma=null;Ma=ea.form;ha[event.target.name]=event.target.value;oa[event.target.name]=event.target;
x.$forms[Ma.getAttribute('id')].isValidating=!0;M(event.target,ha,oa,Z.rules,function($a){x.$forms[Ma.getAttribute('id')].isValidating=!1;$a.isValid()?G(Ma,{},$a.data,event.target.name):G(Ma,$a.error,$a.data,event.target.name);var db=Ma,Ka=$a=null,tb=null;Ka=Zb(db,w);$a=Ka.fields;Ka=Ka.$fields;var hb=db.getAttribute('id');tb=x.$forms[hb].rules;x.$forms[hb].isValidating=!0;M(db,$a,Ka,tb,function(lb){x.$forms[hb].isValidating=!1;console.debug('[updateSelect]: onSilentGlobalLiveValidation: '+lb.isValid(),
lb);lb=lb.isValid();Yb(db,lb);once=!1})})}};ta=ka=null;ya=0;for(fa=P.length;ya<fa;++ya)if(Qa(h.rules,P[ya]),Ba=P[ya].getAttribute('id'),!Ba||!/^gina\-toolbar/.test(Ba)){Ba&&''!=Ba||(Ba='select.'+pa.v4(),P[ya].setAttribute('id',Ba));if(ta=P[ya].getAttribute('data-gina-form-element-group'))ka=P[ya].getAttribute('name')||Ba,ka===Ba&&P[ya].setAttribute('name',Ba),Q[Ba]={id:Ba,name:ka,group:ta,target:P[ya]};addListener(gina,P[ya],'change',function(ea){ea=ea.target;/select/i.test(ea.type)&&Sa(ea,h)});if(P[ya].options&&
...
P[ya].setAttribute('data-value',P[ya].options[ka].value))}}var ob=function(ea,Z,ha,oa){'undefined'==typeof oa&&(oa=!1);if('undefined'==typeof Q[ea])throw Error('Radio & Checkbox dependencies not met: you must use the ID attribue of the `master element` as the `data-gina-form-element-group`');var Ma=ea.replace(/\-|_|@|#|\.|\[|\]/g,'\\$&');ea=Q[ea].target.checked;for(let Ka in Q)if(!/radio|checkbox/i.test(Q[Ka].target.type)){var $a=new RegExp(Ma);var db=new RegExp(Z);if($a.test(Q[Ka].group)&&db.test(Q[Ka].group)||
$a.test(Q[Ka].group))Q[Ka].target.disabled=!0,'undefined'==typeof h.rules[Q[Ka].name]&&(h.rules[Q[Ka].name]={}),h.rules[Q[Ka].name].exclude=!0,oa?(Q[Ka].target.disabled=ea?!1:!0,h.rules[Q[Ka].name].exclude=ea?!1:!0):(Q[Ka].target.disabled=ha,h.rules[Q[Ka].name].exclude=ha)}},xb=function(ea,Z,ha,oa){'undefined'==typeof oa&&(oa=!1);if(oa&&'undefined'!=typeof Q[Z.id])return ea=/true/i.test(Z.checked)?!1:!0,ob(Z.id,Q[Z.id].group,ea,oa);ha=Z.name;q&&'undefined'==typeof ea.rules[ha]&&(ea.rules[ha]={});
/^true$/i.test(Z.checked)?q&&(ea.rules[ha].exclude=!1,'undefined'!=typeof Q[Z.id]&&ob(Z.id,Q[Z.id].group,!1,oa)):q&&(ea.rules[ha].exclude=!0,'undefined'!=typeof Q[Z.id]&&ob(Z.id,Q[Z.id].group,!0,oa))},Kb=function(ea,Z){'undefined'==typeof Z&&(Z=!1);var ha=function(Ka,tb,hb){if(tb)xb(h,Ka,tb);else for(let lb in Q)if(db.test(Q[lb].group)||db.test(Q[lb].target.getAttribute('data-gina-form-element-group')))Q[lb].target.disabled=hb};Z&&/^(on)$/i.test(ea.value)&&!ea.checked&&(ea.value=!1);var oa=ea.getAttribute('data-value')||
...
ea.test(Q[Z].group)||/checkbox/i.test(Q[Z].target.type)&&ea.test(Q[Z].target.getAttribute('data-gina-form-element-group')))&&xb(h,Q[Z].target,Q[Z].group,!0)},zb=function(ea,Z){Z=ea.id.replace(/\-|_|@|#|\.|\[|\]/g,'\\$&');Z=new RegExp(Z);for(let ha in Q)if(/checkbox|radio/i.test(Q[ha].target.type)||(Q[ha].target.disabled=!0,'undefined'==typeof h.rules[Q[ha].name]&&(h.rules[Q[ha].name]={}),h.rules[Q[ha].name].exclude=!0),Z.test(Q[ha].group)||Z.test(Q[ha].target.getAttribute('data-gina-form-element-group').replace(/\-|_|@|#|\.|\[|\]/g,
...
oa&&(Vb[$a].checked=!1,Vb[$a].removeAttribute('checked'),zb(Vb[$a],!0));Z?zb(ea):(oa&&'null'!=oa&&'false'!=oa&&''!=oa?setTimeout(function(){ha?zb(ea):(ea.checked=!1,ea.removeAttribute('checked'))},0):setTimeout(function(){ha?zb(ea):(ea.checked=!0,ea.setAttribute('checked','checked'))},0),Ma&&(ea.value=/^true$/.test(ea.value)?!0:!1))};ya=0;for(fa=b.length;ya<fa;++ya){P=b[ya].getAttribute('type');if('undefined'==typeof b[ya].id||''==b[ya].id)b[ya].id=P+'-'+pa.v4(),b[ya].setAttribute('id',b[ya].id);
...
!0;A(ha);Z=Zb(ha.target,ha.rules,!0);M(ha.target,Z.fields,Z.$fields,ha.rules,function(oa){var Ma=oa.isValid();console.debug('silent reset validation result[isValid:'+Ma+']: ',oa);G(ha.target,{});Yb(ha.target,Ma);ha.target.dataset.ginaFormIsResetting=!1})});addListener(gina,e,'reset',function(Z){var ha=Z.target;if('undefined'!=typeof Z.defaultPrevented&&Z.defaultPrevented)return!1;Z.preventDefault();var oa=ha.id;if(!oa)return!1;/^reset\./.test(oa)||(oa='reset.'+ha.id);gina.events[oa]&&triggerEvent(gina,
ha,oa,Z.detail)});addListener(gina,e,'keydown',function(Z){var ha=Z.target;if('undefined'!=typeof Z.defaultPrevented&&Z.defaultPrevented)return!1;S[Z.keyCode]='keydown'==Z.type;var oa=ha.id;if(!oa)return!1;/^keydown\./.test(oa)||(oa='keydown.'+ha.id);gina.events[oa]&&(cancelEvent(Z),triggerEvent(gina,ha,oa,Z.detail,Z))});addListener(gina,e,'keyup',function(Z){var ha=Z.target;if('undefined'!=typeof Z.defaultPrevented&&Z.defaultPrevented)return!1;S[Z.keyCode]&&delete S[Z.keyCode];var oa=ha.id;if(!oa)return!1;
...
'undefined'!=typeof v.id&&''==v.id)v.id='click.'+pa.v4(),v.setAttribute('id',v.id);/a/i.test(v.tagName)&&'undefined'==typeof v.form&&(v.form={id:h.id});'undefined'==typeof v.dataset.ginaFormSubmitTriggerFor&&'undefined'!=typeof x.$forms[h.id]&&'undefined'==typeof x.$forms[h.id].submitTrigger&&'undefined'!=typeof v.form.id&&h.id==v.form.id&&(console.debug('attching submitTrigger: '+v.id,'  form id: '+h.id),x.$forms[h.id].submitTrigger=h.submitTrigger=v.id||v.getAttribute('id'),v.dataset.ginaFormSubmitTriggerFor=
h.id)}'A'==v.tagName&&(P=v.getAttribute('onclick'),ya=v.getAttribute('data-gina-form-submit'),P||ya?/return false/i.test(P)||ya||(P=/;$/.test(P)?P+'return false;':P+'; return false;'):v.setAttribute('onclick','return false;'));v.id?X=v.id:(X='click.'+pa.v4(),v.id=X,v.setAttribute('id',X));'undefined'!=typeof gina.events[X]&&gina.events[X]==v.id||fb(X,v)}X='submit';addListener(gina,e,X,function(ea){var Z=ea.target,ha=Z.getAttribute('id'),oa=x.$forms[ha],Ma=h.binded;(oa=(new DOMParser).parseFromString(Z.innerHTML,
'text/html').getElementById(oa.submitTrigger))&&oa.disabled&&cancelEvent(ea);if('undefined'!=typeof ea.defaultPrevented&&ea.defaultPrevented)return!1;(q||Ma)&&cancelEvent(ea);ea={};Ma={_length:0};oa='undefined'!=typeof gina.validator.$forms[ha]?gina.validator.$forms[ha].rules:null;for(var $a=null,db=null,Ka=0,tb=Z.length;Ka<tb;++Ka)$a=Z[Ka].getAttribute('name'),db=Z[Ka].disabled||Z[Ka].getAttribute('disabled'),db=/disabled|true/i.test(db)?!0:!1,$a&&!db&&('undefined'!=typeof Z[Ka].type&&'radio'==Z[Ka].type||
...
'undefined'!=typeof gina.events['submit.'+ha]?triggerEvent(gina,Z,'submit.'+ha,ea):triggerEvent(gina,Z,'validate.'+ha,ea)):(z=(oa=Z.getAttribute('data-gina-form-rule'))?Ra(oa.replace(/\-|\//g,'.')):Ra(ha.replace(/\-/g,'.')),x.$forms[ha].isValidating=!0,M(Z,Ma,ea,z,function(hb){x.$forms[ha].isValidating=!1;'undefined'!=typeof gina.events['submit.'+ha]?triggerEvent(gina,Z,'submit.'+ha,hb):triggerEvent(gina,Z,'validate.'+ha,hb)}))});x.$forms[n].binded=!0;/^(true)$/i.test(h.target.dataset.ginaFormLiveCheckEnabled&&
...
'\\]'),ia=new RegExp(ia,Ba),ia.test(Wa))){skipTest=!0;fb[Wa]=fb[Z];break}if('undefined'==typeof fb[Wa])return}var ha=Object.getOwnPropertyNames(fb)||[];Z=0;var oa=ha.length;if(0<oa)for(;Z<oa;)'undefined'!=typeof fb[ha[Z]].exclude&&/^true$/i.test(fb[ha[Z]].exclude)&&(ha.splice(Z,1),oa--,Z--),Z++;for(var Ma in fb[Wa])if('function'==typeof Sa[Wa][Ma]){/^((is)\d+|is$)/.test(Ma)&&'undefined'==typeof Sa[Wa][Ma]&&(Sa[Wa][Ma]=function(){},Sa[Wa][Ma]=Y(Sa[Wa][Ma],Sa[Wa][Ma.replace(/\d+/,'')]),Sa[Wa][Ma].setAlias=
function(hb){this._currentValidatorAlias=hb}(Ma));try{if(Array.isArray(fb[Wa][Ma])){ya=JSON.clone(fb[Wa][Ma]);if(/\$[\-\w\[\]]*/.test(ya[0])){var $a=ya[0].match(/\$[\-\w\[\]]*/g);Z=0;for(var db=$a.length;Z<db;++Z)ya[0]=ya[0].replace($a[Z],Sa[$a[Z].replace('$','')].value)}Sa[Wa][Ma].apply(Sa[Wa],ya)}else if(/^query$/.test(Ma)){v=h[Wa];fa=v.getAttribute('id');ta='asyncCompleted.'+fa;var Ka=0,tb=!1;if('undefined'!=typeof gina.events[ta]){console.debug('event `'+ta+'` already added');ka=0;break}++ka;
addListener(gina,v,ta,function(hb){hb.preventDefault();Ka++;--ka;var lb=Object.getOwnPropertyNames(fb[Wa]);lb[lb.length-1]==Ma&&(Q=!0);lb='asyncCompleted.'+hb.target.getAttribute('id');if(!/true/.test(tb)){Sa[Wa]=hb.detail;var mb=e;/^form$/i.test(e.tagName)||(mb=e.form);var nb=mb.getAttribute('id');if(Q&&0>=ka&&!tb&&(tb=!0,removeListener(gina,hb.target,lb),w._data=Sa.toData(),w._errors=Sa.getErrors(Wa),w._errors&&0<w._errors.count())){'undefined'==typeof x.$forms[nb].errors&&(x.$forms[nb].errors=
{});x.$forms[nb].errors[Wa]=w._errors[Wa];if(!jb&&/^true|false$/i.test(x.$forms[nb].isValidating)||''!=Sa[Wa].target.value)u(eb[Wa]),G(mb,w._errors,w._data,Wa),Yb(mb,jb);V&&L&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&(gina.forms.errors||(gina.forms.errors={}),window.ginaToolbar.update('forms',{id:nb,errors:x.$forms[nb].errors||{}}));triggerEvent(gina,mb,'validated.'+nb,w);return}hb=!1;var jb=null;1==ha.length||ha[ha.length-1]==Wa?(jb=0<w._errors.count()?!1:!0,!jb&&/^true|false$/i.test(x.$forms[nb].isValidating)&&
...
Yb(mb,jb)})}});Sa[Wa][Ma](fb[Wa][Ma]);continue}else Sa[Wa][Ma](fb[Wa][Ma]);delete ea[Wa]}catch(hb){if('conditions'==Ma)throw Error('[ ginaFormValidator ] could not evaluate `'+Wa+'->'+Ma+'()` where `conditions` must be a `collection` (Array)\nStack:\n'+hb);throw Error('[ ginaFormValidator ] could not evaluate `'+Wa+'->'+Ma+'()`\nStack:\n'+hb);}}},Sa=null,ob={},xb=!1;L?/^form$/i.test(e.tagName)?(z=e.getAttribute('id'),q='validated.'+z,x.$forms[z].fields=b,'undefined'!=typeof e.eventData&&'undefined'!=
typeof e.eventData.error&&delete e.eventData.error,Sa=new m(b,h,y)):(xb=!0,z=e.form.getAttribute('id')||e.form.target.getAttribute('id'),q='validated.'+z,x.$forms[z].fields=b,Sa=new m(b,h,y,x.$forms[z].fieldsSet)):Sa=new m(b,null,y);var Kb=null,eb=null;if(xb){xb=e.form.getAttribute('id');var zb=Zb(x.$forms[xb].target,x.$forms[xb].rules,!1);Kb=xa(JSON.stringify(x.$forms[xb].rules),JSON.clone(zb.fields));eb=zb.$fields}else Kb=JSON.clone(b),eb=h;xb='undefined'!=typeof n?JSON.clone(n):{};var Vb=function(Wa,
fb,ea,Z,ha,oa,Ma,$a){var db=null;if('undefined'!=typeof oa)for(var Ka in Z)if(L&&'undefined'==typeof ha[Ka])console.warn('field `'+Ka+'` found for your form rule ('+Wa.id+'), but not found in $field collection.\nPlease, check your HTML or remove `'+Ka+'` declaration from your rule if this is a mistake.');else{L&&ha[Ka].getAttribute('data-gina-form-element-group')&&'undefined'!=typeof oa[Ka]&&'undefined'!=typeof oa[Ka].exclude&&oa[Ka].exclude&&!ha[Ka].disabled&&(oa[Ka].exclude=!1);var tb='undefined'!=
...
lb)for(var jb in oa[hb].conditions[mb].rules)if(!/^_comment$/i.test(jb)&&jb!=db&&ha[jb])if(Ka==jb||/^\//.test(jb)||'undefined'!=typeof Z[jb]||'undefined'==typeof fb[jb])if(/^\//.test(jb)){if(ia=jb.match(/\/(.*)\//).pop(),Ba=jb.replace('/'+ia+'/',''),ia=ia.replace(/\[/g,'\\[').replace(/\]/g,'\\]'),ia=new RegExp(ia,Ba),ia.test(Ka)){if(oa[hb].conditions[mb].case==lb||/^\//.test(oa[hb].conditions[mb].case)&&(new RegExp(oa[hb].conditions[mb].case)).test(lb))Pb='undefined'!=typeof oa[jb]?oa[jb]:{},oa[jb]=
W(oa[hb].conditions[mb].rules[jb],Pb);db!=jb&&'undefined'!=typeof oa[jb]&&Ya(jb,oa,Z)}}else'undefined'!=typeof oa[hb].conditions[mb].rules[jb]&&(caseField=jb,lb=Z[caseField],'undefined'==typeof ha[caseField]?console.warn('ignoring case `'+caseField+'`: field `NaN'):(L&&/^(true|false)$/i.test(lb)&&'undefined'!=typeof oa[caseField]&&'undefined'!=typeof oa[caseField].isBoolean&&/^(true)$/i.test(oa[caseField].isBoolean)&&(lb=/^(true)$/i.test(lb)?!0:!1),'undefined'!=typeof oa[hb].conditions[mb].rules[jb]&&
(Pb='undefined'!=typeof oa[hb].conditions[mb].rules[jb]?oa[hb].conditions[mb].rules[jb]:{},oa[jb]=Pb),db!=jb&&'undefined'!=typeof oa[jb]&&'undefined'!=typeof Z[jb]&&Ya(jb,oa,Z)));else{Z[jb]=fb[jb];var Pb='undefined'!=typeof oa[jb]?oa[jb]:{};oa[jb]=W(oa[hb].conditions[mb].rules[jb],Pb);Ya(jb,oa,Z)}}if(db!=Ka&&('undefined'!=typeof oa[Ka]&&Ya(Ka,oa,fb),tb)){++$a;tb=oa['_case_'+Ka].conditions;if(!tb)throw Error('[ ginaFormValidator ] case `_case_'+Ka+'` found without `condition(s)` !\nPlease, check your delcaration for `_case_'+
Ka+'`');for(let Mb=0,ac=tb.length;Mb<ac;++Mb)if(lb=fb[Ka],L&&('true'==Z[Ka]?lb=!0:'false'==Z[Ka]&&(lb=!1)),tb[Mb]['case']===lb||Array.isArray(tb[Mb]['case'])&&-1<tb[Mb]['case'].indexOf(lb)||/^\//.test(tb[Mb]['case'])){Pb={};if('undefined'==typeof tb[Mb].rules[Ka]&&'undefined'==typeof fb[Ka]||ha[Ka].disabled)tb[Mb].rules[Ka]={exclude:!0};for(var Hb in tb[Mb].rules)if(!/^_comment$/i.test(Hb))if(/^\//.test(Hb)){ia=Hb.match(/\/(.*)\//).pop();Ba=Hb.replace('/'+ia+'/','');ia=ia.replace(/\[/g,'\\[').replace(/\]/g,
'\\]');ia=new RegExp(ia,Ba);for(var Jb in ha)ia.test(Jb)&&(/^\//.test(tb[Mb]['case'])?(ia=tb[Mb]['case'].match(/\/(.*)\//).pop(),Ba=tb[Mb]['case'].replace('/'+ia+'/',''),ia=new RegExp(ia,Ba),ia.test(lb)&&(Pb[Jb]=tb[Mb].rules[Hb])):Pb[Jb]=tb[Mb].rules[Hb],'undefined'==typeof Z[Jb]&&'undefined'!=typeof ha[Jb]&&'undefined'!=typeof ha[Jb].value&&(Z[Jb]=ha[Jb].value,L&&/(true|false)/i.test(Z[Jb])&&('true'==Z[Jb]?Z[Jb]=!0:'false'==Z[Jb]&&(Z[Jb]=!1)),Sa.addField(Jb,Z[Jb]),'undefined'!=typeof ea[Jb]&&(Pb[Jb]=
W(Pb[Jb],ea[Jb]))))}else/^\//.test(tb[Mb]['case'])?(ia=tb[Mb]['case'].match(/\/(.*)\//).pop(),Ba=tb[Mb]['case'].replace('/'+ia+'/',''),ia=ia.replace(/\[/g,'\\[').replace(/\]/g,'\\]'),ia=new RegExp(ia,Ba),ia.test(lb)&&(Pb[Hb]=tb[Mb].rules[Hb])):Pb[Hb]=tb[Mb].rules[Hb],'undefined'==typeof Z[Hb]&&'undefined'!=typeof ha[Hb]&&'undefined'!=typeof ha[Hb].value&&(Z[Hb]=ha[Hb].value,L&&/(true|false)/i.test(Z[Hb])&&('true'==Z[Hb]?Z[Hb]=!0:'false'==Z[Hb]&&(Z[Hb]=!1)),Sa.addField(Hb,Z[Hb]),'undefined'!=typeof ea[Hb]&&
(Pb[Hb]=W(Pb[Hb],ea[Hb])));++ba;if(L)Vb(Wa,fb,ea,Z,ha,Pb,Ma,$a);else return Vb(Wa,fb,ea,Z,ha,Pb,Ma,$a)}--$a}}--ba;if(0>=$a&&0>ba){fb=Sa.getErrors();for(Ka in fb){for(rule in fb[Ka])ob[Ka]||(ob[Ka]=''),0>ob[Ka].indexOf(rule)&&(ob[Ka]+=rule+' ');L&&ha[Ka].setAttribute('data-gina-form-errors',ob[Ka].substr(0,ob[Ka].length-1))}try{X=La(Sa.toData()),V&&L&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&(gina.forms.validated||(gina.forms.validated={}),gina.forms.validated[z]||(gina.forms.validated[z]=
{}),window.ginaToolbar.update('forms',{id:z,validated:X}))}catch(Mb){throw Mb;}Q=!0;if(!P&&0>=ka)if('undefined'!=typeof Ma&&'function'===typeof Ma)Ma._errors=Sa.getErrors(),Ma._data=Sa.toData(),triggerEvent(gina,Wa,'validated.'+z,Ma);else return P=!0,{isValid:Sa.isValid,error:fb,data:X}}};L&&addListener(gina,e,q,function(Wa){Wa.preventDefault();if(!P){P=!0;Q=!1;ka=0;var fb=Wa.detail,ea=fb._data||Sa.toData(),Z=fb._errors||Sa.getErrors()||null;console.debug('instance errors: ',x.$forms[z].errors,' VS cbErrors: ',
Z,Sa.isValid(),' VS d.getErrors(): ',Sa.getErrors());0<Z.count()&&Sa.isValid()&&(Sa.isValid=function(){return!1});fb({isValid:Sa.isValid,error:Z,data:La(ea)});removeListener(gina,Wa.target,'validated.'+Wa.target.id)}});if(L)Vb(e,Kb,xb,b,h,n,w,0);else return Vb(e,Kb,xb,b,h,n,w,0)};return L?Ua(D):F(D,R,da)}'undefined'!==typeof module&&module.exports?module.exports=ValidatorPlugin:'function'===typeof define&&define.amd&&define('gina/validator',['utils/events','utils/dom','utils/form-validator'],function(){return ValidatorPlugin});
define('gina/toolbar','require jquery vendor/uuid utils/collection utils/routing gina/storage gina/validator'.split(' '),function(D){var R=D('jquery');R.noConflict();var da=D('utils/routing');D('utils/collection');var Ga=D('gina/storage');return function(){var L=null,V=!1,pa=!1,W=!1,Y,m=(new Ga({bucket:'gina'})).Collection('plugin'),U=null,x=null,ma=!1,Da=null,S=null,I=null,y=null,F=null,p='',C=null,E=null,N=null,u='',r=null,G=0,K=0,A=0,O='',T={},sa=null,qa=null,Ea=null,ua=null,za=null,Ca=null,na=
null,Ua=null,Na=null,Ra=null,pb=null,Ia=null,La=null,Za=null,wb=function(){U=R('#gina-toolbar');if(!U.length)return!1;Da=U.find('.gina-toolbar-tab > a');S=R('#gina-toolbar-toggle');I=R('#gina-toolbar-panels');y=I.find('.gina-toolbar-panel');C=R('#gina-toolbar-vposition');E=R('#gina-toolbar-hposition');N=C.add(E);r=R('#gina-toolbar-width');U.find('.gina-toolbar-main');sa=R('#gina-toolbar-json');qa=R('#gina-toolbar-gina-json');Ea=R('#gina-toolbar-toggle-code-raw');$forms=R('form:not(.gina-toolbar-options, .gina-toolbar-content)');
Na=R('#gina-toolbar-data-html');Ra=R('#gina-toolbar-view-html');pb=R('#gina-toolbar-forms-html');Ua=R('#gina-toolbar-configuration-environment-html');Ia=R('#gina-toolbar-code-toggle');U.prepend('<textarea class="gina-toolbar-copy"></textarea>');La=U.find('.gina-toolbar-copy');x=m.findOne({_name:'toolbar'});x||(x={_name:'toolbar',_version:'1.0.3',_description:'Toolbar settings',_licence:'MIT',_author:[{name:'John Doe',company:'Acme'},{name:'Martin-Luther Etouman',company:'Rhinostone'}],
...
Cb()},cb=function(h,n,w){var q=null,z=null;try{z=sa?sa.text():'',''==z||'null'==z?sa.text('Empty'):(za=JSON.parse(z),na=JSON.parse(qa.text()),sa.text(''),ua||(ua={jsonObject:JSON.clone(za),ginaJsonObject:JSON.clone(na)},Ca={}))}catch(fa){if(z='Could not load'+(h?' [ '+h+' ] ':' ')+'json\n'+fa.message+'\n'+fa.stack,sa)sa.text(z);else throw z;}if(za){n&&!w?(za[h]||(za[h]={}),za[h]=na[h]=n):'data-xhr'==h&&!n&&za['data-xhr']?delete za['data-xhr']:w&&(za=n,na=w);b(za,'');delete za.environment.routing;
delete na.environment.routing;delete za.environment.reverseRouting;delete na.environment.reverseRouting;delete za.environment.forms;delete na.environment.forms;Ua.html(Gb(za.environment,na.environment));q=za.data;var X=za.view;w=za.forms;var P=na.data,ba=na.view;z=na.forms;pa=Y=!1;var Q=null,v=!1;/^(view-xhr)$/.test(h)&&(Q=!0,X=za[h],ba=na[h],q=za['data-xhr'],P=na['data-xhr']);if(!h||/^(data)$/.test(h))Na.html('<ul class="gina-toolbar-code">'+Gb(q,P,null,Q)+'</ul>'),Ra.html('<div id="gina-toolbar-view-html-properties" class="gina-toolbar-section">\n    <h2 class="gina-toolbar-section-title">properties</h2>\n    <ul class="gina-toolbar-properties"></ul>\n</div>'),
Ra.html(Zb(X,ba,null,Q,Ra)),q=$forms,pb.html(''),pb.html(xa(w,z,pb,0,q,q.length,Q)),pb.find('div.gina-toolbar-section > h2').off('click').on('click',function(fa){fa.preventDefault();R(this).parent().find('ul').first().slideToggle()});if(/^(data-xhr|view-xhr)$/.test(h)){if('undefined'==typeof za[h]||!za[h]||'null'==za[h])return!1;Q=!0;v='undefined'!=typeof za[h].isXHRViewData?!0:v;v||/^(view-xhr)$/.test(h)||'undefined'==typeof za['el-xhr']||(Ca.data=JSON.clone(za[h]));v&&delete za[h].isXHRViewData;
/^(data-xhr)$/.test(h)?Na.html('<ul class="gina-toolbar-code">'+Gb(za[h],na[h],null,Q)+'</ul>'):/^(view-xhr)$/.test(h)&&(Ra.html('<div id="gina-toolbar-view-html-properties" class="gina-toolbar-section">\n    <h2 class="gina-toolbar-section-title">properties</h2>\n    <ul class="gina-toolbar-properties"></ul>\n</div>'),Ra.html(Zb(za[h],na[h],null,Q,Ra)))}/^(el-xhr)$/.test(h)&&(Q=!0,q=R('#'+n).find('form:not(.gina-toolbar-options, .gina-toolbar-content)'),pb.html(''),pb.html(xa(w,z,pb,0,q,q.length,
Q)),pb.find('div.gina-toolbar-section > h2').off('click').on('click',function(fa){fa.preventDefault();R(this).parent().find('ul').first().slideToggle()}));/^(forms)$/.test(h)&&(pa=Q=!0,R('#gina-toolbar-form-'+n.id).length||(q=$forms,pb.html(''),pb.html(xa(w,z,pb,0,q,q.length,Q)),pb.find('div.gina-toolbar-section > h2').off('click').on('click',function(fa){fa.preventDefault();R(this).parent().find('ul').first().slideToggle()})),'undefined'!=typeof n.rules&&Ha(n.id,'rules',n.rules,Q),'undefined'!=typeof n.errors&&
0<n.errors.count()&&Ha(n.id,'errors',n.errors,Q),'undefined'!=typeof n.sent&&Ha(n.id,'sent',n.sent,Q));x.currentFile=za.file;x.currentFile||(x.currentFile=za.file);za.file==x.currentFile&&R(document).ready(function(){pa?(V=!0,0<x.isUnfolded.length&&!Y&&(Y=!0,setTimeout(function(){0<x.isUnfolded.length&&Xa(x.isUnfolded,x.isUnfolded.length,0)},200))):Q?(V=!0,0<x.isUnfolded.length&&!Y&&(Y=!0,Xa(x.isUnfolded,x.isUnfolded.length,0))):(V=!1,setTimeout(function(){0<x.isUnfolded.length&&Xa(x.isUnfolded,x.isUnfolded.length,
0)},200))})}if(!h||'el-xhr'==h&&!W)W=h&&'el-xhr'==h?!0:!1,wa(h)},Xa=function(h,n,w){if(w==n)return!1;var q=h[w],z=null;V&&/^xhr-/.test(q)?(q=q.replace(/^xhr-/,''),z=R('.gina-toolbar-xhr-folding-state-'+q)):z=R('.gina-toolbar-folding-state-'+q);yb(z,function(){w+=1;Xa(h,n,w)})},Cb=function(){Na.add(Ra).off('click','a').on('click','a',function(n){n.preventDefault();yb(R(this),null,!0)}).add(pb).off('click','a').on('click','a',function(n){n.preventDefault();yb(R(this),null,!0)});Ia.off('click').on('click',
function(n){n.preventDefault();yb('all',null,!0)});Na.add(Ra,pb).off('click','.gina-toolbar-value').on('click','.gina-toolbar-value',function(n){n.preventDefault();try{Za=R(this).text(),La.text(Za),La.select(),document.execCommand('copy',!1,null),La.blur()}catch(w){alert('Please press Ctrl/Cmd+C to copy the value')}});Ea.off('click').on('click',function(n){za&&window.open('','JSON RAW','width=400,height=100').document.write(JSON.stringify(za.data))});Da.off('click').on('click',function(n){n.preventDefault();
Da.removeClass('gina-toolbar-active');y.removeClass('gina-toolbar-active');R(this).addClass('gina-toolbar-active');p=R(this).attr('href');F=R(p).addClass('gina-toolbar-active');x.panelId=p;x.save()});S.off('click').on('click',function(n){n.preventDefault();U.toggleClass('gina-toolbar-collapsed');ma=U.hasClass('gina-toolbar-collapsed');x.isCollapsed=ma;x.save()});N.off('change').on('change',function(n){n.preventDefault();n=C.val();var w=E.val();u=n+'-'+w;Db(u);x.position=u;x.save()});r.off('change').on('change',
function(n){n.preventDefault();G=r.val();Eb(G);x.width=G;x.save()});R(window).off('resize').on('resize',function(){vb()});R('body').off('keypress').on('keypress',function(n){if(!/INPUT|TEXTAREA/.test(n.target.tagName)){O=n.keyCode?n.keyCode:n.which?n.which:n.charCode;n=new Date;if('undefined'!=typeof T.keynum&&T.keynum==O&&'undefined'!=typeof T.pressTime&&500>n.getTime()-T.pressTime)switch(O){case 103:U.toggle()}T.pressTime=n.getTime();T.keynum=O}});Da.filter('[href="'+p+'"]').trigger('click');ma||
R('#gina-toolbar-toggle').trigger('click');Db(u);var h=u.split('-');C.val(h[0]);E.val(h[1]);Eb(G);r.val(G);vb();h=sa?sa.text():'';/^\{\{ (.*) \}\}/.test(h)?e(h,cb):cb()},Db=function(h){U.removeClass('gina-toolbar-top-left gina-toolbar-top-right gina-toolbar-bottom-left gina-toolbar-bottom-right').addClass('gina-toolbar-'+h)},Eb=function(h){U.removeClass('gina-toolbar-auto gina-toolbar-100 gina-toolbar-80 gina-toolbar-60 gina-toolbar-50 gina-toolbar-40 gina-toolbar-30').addClass('gina-toolbar-'+h)},
vb=function(){K=window.innerHeight-32;U.find('.gina-toolbar-main').css('max-height',K+'px');var h=F.find('.gina-toolbar-main'),n=h.find('.gina-toolbar-content');A=h.height();A==K?n.addClass('gina-toolbar-content-end'):n.removeClass('gina-toolbar-content-end')},yb=function(h,n,w){'undefined'==typeof w&&(w=!1);if(void 0!=h&&h.length&&'all'!=h){L=h.attr('class');var q=!1;if(/(gina-toolbar-folding-state-[a-z 0-9_-]+|gina-toolbar-xhr-folding-state-[a-z 0-9_-]+)/i.test(L))if(/gina-toolbar-folding-state-[a-z0-9_-]+/i.test(L)?
...
L+')'),X=0,P=x.isUnfolded.length;X<P;++X)z.test(x.isUnfolded[X])&&(!pa&&w||pa&&q||w)&&(x.isUnfolded.splice(X,1),--X);x.save(!0);0>x.isUnfolded.indexOf(L)&&(h.removeClass('gina-toolbar-unfolded'),h.next('ul').slideToggle('fast'))}else h.addClass('gina-toolbar-unfolded'),h.next('ul').slideToggle('fast')}'undefined'!=typeof n&&null!=n&&n()},Fb=function(h){var n={},w=null,q=[],z=0;for(w in h)h.hasOwnProperty(w)&&(q[z]=w,++z);var X=q.length;q.sort();for(z=0;z<X;++z)w=q[z],n[w]=h[w];return n},Qa=function(h,
...
h.is(':visible')||h.slideToggle()},M=function(h,n){return h='<label class="gina-toolbar-input-file"><input type="file" multiple id="'+(h+'">')+n+'</label>'},e=function(h,n){h=M('mock','Select your JSON file');Na.html(h);sa.text('');Na.find('input').off('change').on('change',function(w){var q=R(this)[0].files,z=w=null;if(1==q.length)w=R(this)[0].files[0],z=new FileReader,z.addEventListener('load',function(){sa.text(z.result);qa.text(z.result);n()},!1),z.readAsBinaryString(w);else{var X=0;z=[];for(var P=
...
n)};this.restore=function(){Ca&&'undefined'!=typeof Ca.data&&(ua.jsonObject.data=Ca.data);cb('data',ua.jsonObject,ua.ginaJsonObject);W=!1;da.notFound={}};if('undefined'!=typeof gina.validator)gina.validator.on('initialized',function(){console.log('toolbar validator ready');wb()});else wb()}});
define('gina','require vendor/uuid utils/merge utils/events helpers/prototypes helpers/dateFormat gina/toolbar'.split(' '),function(D){D('utils/events');var R=D('utils/merge'),da=D('helpers/dateFormat')();D('helpers/prototypes')({dateFormat:da});var Ga=D('vendor/uuid');window.process||function(L,V,pa,W,Y,m,U){for(m=L[pa]||(L[pa]={});!U&&Y<W.length;)U=L[W[Y++]+'requestAnimationFrame'];m[V]=m[V]||U&&U.bind(L)||L.setImmediate||L.setTimeout}(window,'nextTick','process',['r','webkitR','mozR','msR','oR'],
0);window.getComputedStyle||(window.getComputedStyle=function(L,V){this.el=L;this.getPropertyValue=function(pa){var W=/(\-([a-z]){1})/g;'float'==pa&&(pa='styleFloat');W.test(pa)&&(pa=pa.replace(W,function(Y,m,U){return U.toUpperCase()}));return L.currentStyle[pa]?L.currentStyle[pa]:null};return this});return function(L){this.plugin='gina';var V='gina-'+Ga.v1(),pa=document,W;document.id=V;V={id:V,isFrameworkLoaded:!1,hasValidator:!1,hasPopinHandler:!1,config:{},registeredEvents:{},events:{},setOptions:function(Y){W=
R(W,Y,!0)}};'undefined'!=typeof parent.window.gina&&(window.gina=R(window.gina||{},parent.window.gina));V=R(window.gina||{},V);registerEvents(this.plugin,['ginaloaded','ready']);triggerEvent(L,pa,'ginaloaded',V)}});
!function(D,R){'object'==typeof exports&&'undefined'!=typeof module?module.exports=R():'function'==typeof define&&define.amd?define('vendor/engine.io',R):(D='undefined'!=typeof globalThis?globalThis:D||self).eio=R()}(this,function(){function D(wa){return D='function'==typeof Symbol&&'symbol'==typeof Symbol.iterator?function(xa){return typeof xa}:function(xa){return xa&&'function'==typeof Symbol&&xa.constructor===Symbol&&xa!==Symbol.prototype?'symbol':typeof xa},D(wa)}function R(wa,xa){if(!(wa instanceof
xa))throw new TypeError('Cannot call a class as a function');}function da(wa,xa){for(var Ha=0;Ha<xa.length;Ha++){var M=xa[Ha];M.enumerable=M.enumerable||!1;M.configurable=!0;'value'in M&&(M.writable=!0);Object.defineProperty(wa,M.key,M)}}function Ga(wa,xa,Ha){return xa&&da(wa.prototype,xa),Ha&&da(wa,Ha),wa}function L(){return L=Object.assign||function(wa){for(var xa=1;xa<arguments.length;xa++){var Ha=arguments[xa],M;for(M in Ha)Object.prototype.hasOwnProperty.call(Ha,M)&&(wa[M]=Ha[M])}return wa},
L.apply(this,arguments)}function V(wa,xa){if('function'!=typeof xa&&null!==xa)throw new TypeError('Super expression must either be null or a function');wa.prototype=Object.create(xa&&xa.prototype,{constructor:{value:wa,writable:!0,configurable:!0}});xa&&W(wa,xa)}function pa(wa){return pa=Object.setPrototypeOf?Object.getPrototypeOf:function(xa){return xa.__proto__||Object.getPrototypeOf(xa)},pa(wa)}function W(wa,xa){return W=Object.setPrototypeOf||function(Ha,M){return Ha.__proto__=M,Ha},W(wa,xa)}
function Y(){if('undefined'==typeof Reflect||!Reflect.construct||Reflect.construct.sham)return!1;if('function'==typeof Proxy)return!0;try{return Date.prototype.toString.call(Reflect.construct(Date,[],function(){})),!0}catch(wa){return!1}}function m(wa,xa,Ha){return m=Y()?Reflect.construct:function(M,e,b){var h=[null];h.push.apply(h,e);M=new (Function.bind.apply(M,h));return b&&W(M,b.prototype),M},m.apply(null,arguments)}function U(wa){var xa='function'==typeof Map?new Map:void 0;return U=function(Ha){function M(){return m(Ha,
arguments,pa(this).constructor)}if(null===Ha||(e=Ha,-1===Function.toString.call(e).indexOf('[native code]')))return Ha;var e;if('function'!=typeof Ha)throw new TypeError('Super expression must either be null or a function');if(void 0!==xa){if(xa.has(Ha))return xa.get(Ha);xa.set(Ha,M)}return M.prototype=Object.create(Ha.prototype,{constructor:{value:M,enumerable:!1,writable:!0,configurable:!0}}),W(M,Ha)},U(wa)}function x(wa){if(void 0===wa)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
return wa}function ma(wa){var xa=Y();return function(){var Ha=pa(wa);if(xa){var M=pa(this).constructor;Ha=Reflect.construct(Ha,arguments,M)}else Ha=Ha.apply(this,arguments);return!Ha||'object'!=typeof Ha&&'function'!=typeof Ha?x(this):Ha}}function Da(wa,xa,Ha){return Da='undefined'!=typeof Reflect&&Reflect.get?Reflect.get:function(M,e,b){for(;!Object.prototype.hasOwnProperty.call(M,e)&&null!==(M=pa(M)););if(M)return e=Object.getOwnPropertyDescriptor(M,e),e.get?e.get.call(b):e.value},Da(wa,xa,Ha||
wa)}function S(wa){if(wa){for(var xa in S.prototype)wa[xa]=S.prototype[xa];return wa}}function I(wa){for(var xa=arguments.length,Ha=Array(1<xa?xa-1:0),M=1;M<xa;M++)Ha[M-1]=arguments[M];return Ha.reduce(function(e,b){return wa.hasOwnProperty(b)&&(e[b]=wa[b]),e},{})}function y(wa,xa){xa.useNativeTimers?(wa.setTimeoutFn=pb.bind(Ra),wa.clearTimeoutFn=Ia.bind(Ra)):(wa.setTimeoutFn=setTimeout.bind(Ra),wa.clearTimeoutFn=clearTimeout.bind(Ra))}function F(wa){var xa='';do xa=wb[wa%64]+xa,wa=Math.floor(wa/
64);while(0<wa);return xa}function p(){var wa=F(+new Date);return wa!==La?(cb=0,La=wa):wa+'.'+F(cb++)}function C(wa){var xa='',Ha;for(Ha in wa)wa.hasOwnProperty(Ha)&&(xa.length&&(xa+='&'),xa+=encodeURIComponent(Ha)+'='+encodeURIComponent(wa[Ha]));return xa}function E(wa){var xa={};wa=wa.split('&');for(var Ha=0,M=wa.length;Ha<M;Ha++){var e=wa[Ha].split('=');xa[decodeURIComponent(e[0])]=decodeURIComponent(e[1])}return xa}function N(wa){wa=wa.xdomain;try{if('undefined'!=typeof XMLHttpRequest&&(!wa||
Cb))return new XMLHttpRequest}catch(xa){}if(!wa)try{return new (Ra[['Active'].concat('Object').join('X')])('Microsoft.XMLHTTP')}catch(xa){}}function u(){}function r(){for(var wa in Eb.requests)Eb.requests.hasOwnProperty(wa)&&Eb.requests[wa].abort()}function G(wa){var xa=wa,Ha=wa.indexOf('['),M=wa.indexOf(']');-1!=Ha&&-1!=M&&(wa=wa.substring(0,Ha)+wa.substring(Ha,M).replace(/:/g,';')+wa.substring(M,wa.length));var e,b;wa=Gb.exec(wa||'');for(var h={},n=14;n--;)h[Yb[n]]=wa[n]||'';return-1!=Ha&&-1!=M&&
...
'2';K.pong='3';K.message='4';K.upgrade='5';K.noop='6';var A=Object.create(null);Object.keys(K).forEach(function(wa){A[K[wa]]=wa});for(var O={type:'error',data:'parser error'},T='function'==typeof Blob||'undefined'!=typeof Blob&&'[object BlobConstructor]'===Object.prototype.toString.call(Blob),sa='function'==typeof ArrayBuffer,qa=function(wa,xa,Ha){var M=wa.type;wa=wa.data;return T&&wa instanceof Blob?xa?Ha(wa):Ea(wa,Ha):sa&&(wa instanceof ArrayBuffer||('function'==typeof ArrayBuffer.isView?ArrayBuffer.isView(wa):
wa&&wa.buffer instanceof ArrayBuffer))?xa?Ha(wa):Ea(new Blob([wa]),Ha):Ha(K[M]+(wa||''))},Ea=function(wa,xa){var Ha=new FileReader;return Ha.onload=function(){var M=Ha.result.split(',')[1];xa('b'+M)},Ha.readAsDataURL(wa)},ua='undefined'==typeof Uint8Array?[]:new Uint8Array(256),za=0;64>za;za++)ua['ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'.charCodeAt(za)]=za;var Ca='function'==typeof ArrayBuffer,na=function(wa,xa){if('string'!=typeof wa)return{type:'message',data:Ua(wa,xa)};
var Ha=wa.charAt(0);if('b'===Ha){wa=wa.substring(1);if(Ca){var M=.75*wa.length;Ha=wa.length;var e=0;'='===wa[wa.length-1]&&(M--,'='===wa[wa.length-2]&&M--);var b=new ArrayBuffer(M),h=new Uint8Array(b);for(M=0;M<Ha;M+=4){var n=ua[wa.charCodeAt(M)];var w=ua[wa.charCodeAt(M+1)];var q=ua[wa.charCodeAt(M+2)];var z=ua[wa.charCodeAt(M+3)];h[e++]=n<<2|w>>4;h[e++]=(15&w)<<4|q>>2;h[e++]=(3&q)<<6|63&z}xa=Ua(b,xa)}else xa={base64:!0,data:wa};xa={type:'message',data:xa}}else xa=A[Ha]?1<wa.length?{type:A[Ha],data:wa.substring(1)}:
{type:A[Ha]}:O;return xa},Ua=function(wa,xa){return'blob'===xa&&wa instanceof ArrayBuffer?new Blob([wa]):wa},Na=String.fromCharCode(30);S.prototype.on=S.prototype.addEventListener=function(wa,xa){return this._callbacks=this._callbacks||{},(this._callbacks['$'+wa]=this._callbacks['$'+wa]||[]).push(xa),this};S.prototype.once=function(wa,xa){function Ha(){this.off(wa,Ha);xa.apply(this,arguments)}return Ha.fn=xa,this.on(wa,Ha),this};S.prototype.off=S.prototype.removeListener=S.prototype.removeAllListeners=
S.prototype.removeEventListener=function(wa,xa){if(this._callbacks=this._callbacks||{},0==arguments.length)return this._callbacks={},this;var Ha,M=this._callbacks['$'+wa];if(!M)return this;if(1==arguments.length)return delete this._callbacks['$'+wa],this;for(var e=0;e<M.length;e++)if((Ha=M[e])===xa||Ha.fn===xa){M.splice(e,1);break}return 0===M.length&&delete this._callbacks['$'+wa],this};S.prototype.emit=function(wa){this._callbacks=this._callbacks||{};for(var xa=Array(arguments.length-1),Ha=this._callbacks['$'+
wa],M=1;M<arguments.length;M++)xa[M-1]=arguments[M];if(Ha){M=0;for(var e=(Ha=Ha.slice(0)).length;M<e;++M)Ha[M].apply(this,xa)}return this};S.prototype.emitReserved=S.prototype.emit;S.prototype.listeners=function(wa){return this._callbacks=this._callbacks||{},this._callbacks['$'+wa]||[]};S.prototype.hasListeners=function(wa){return!!this.listeners(wa).length};var Ra='undefined'!=typeof self?self:'undefined'!=typeof window?window:Function('return this')(),pb=setTimeout,Ia=clearTimeout,La,Za=function(wa){function xa(M,
e,b){var h;return R(this,xa),(h=Ha.call(this,M)).description=e,h.context=b,h.type='TransportError',h}V(xa,wa);var Ha=ma(xa);return xa}(U(Error));za=function(wa){function xa(M){var e;return R(this,xa),(e=Ha.call(this)).writable=!1,y(x(e),M),e.opts=M,e.query=M.query,e.readyState='',e.socket=M.socket,e}V(xa,wa);var Ha=ma(xa);return Ga(xa,[{key:'onError',value:function(M,e,b){return Da(pa(xa.prototype),'emitReserved',this).call(this,'error',new Za(M,e,b)),this}},{key:'open',value:function(){return'closed'!==
this.readyState&&''!==this.readyState||(this.readyState='opening',this.doOpen()),this}},{key:'close',value:function(){return'opening'!==this.readyState&&'open'!==this.readyState||(this.doClose(),this.onClose()),this}},{key:'send',value:function(M){'open'===this.readyState&&this.write(M)}},{key:'onOpen',value:function(){this.readyState='open';this.writable=!0;Da(pa(xa.prototype),'emitReserved',this).call(this,'open')}},{key:'onData',value:function(M){M=na(M,this.socket.binaryType);this.onPacket(M)}},
{key:'onPacket',value:function(M){Da(pa(xa.prototype),'emitReserved',this).call(this,'packet',M)}},{key:'onClose',value:function(M){this.readyState='closed';Da(pa(xa.prototype),'emitReserved',this).call(this,'close',M)}}]),xa}(S);for(var wb='0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_'.split(''),cb=0,Xa=0;64>Xa;Xa++);Xa=!1;try{Xa='undefined'!=typeof XMLHttpRequest&&'withCredentials'in new XMLHttpRequest}catch(wa){}var Cb=Xa,Db=null!=(new N({xdomain:!1})).responseType;Xa=function(wa){function xa(M){var e;
if(R(this,xa),(e=Ha.call(this,M)).polling=!1,'undefined'!=typeof location){var b='https:'===location.protocol,h=location.port;h||=b?'443':'80';e.xd='undefined'!=typeof location&&M.hostname!==location.hostname||h!==M.port;e.xs=M.secure!==b}M=M&&M.forceBase64;return e.supportsBinary=Db&&!M,e}V(xa,wa);var Ha=ma(xa);return Ga(xa,[{key:'doOpen',value:function(){this.poll()}},{key:'pause',value:function(M){var e=this;this.readyState='pausing';var b=function(){e.readyState='paused';M()};if(this.polling||
!this.writable){var h=0;this.polling&&(h++,this.once('pollComplete',function(){--h||b()}));this.writable||(h++,this.once('drain',function(){--h||b()}))}else b()}},{key:'poll',value:function(){this.polling=!0;this.doPoll();this.emitReserved('poll')}},{key:'onData',value:function(M){var e=this;(function(b,h){b=b.split(Na);for(var n=[],w=0;w<b.length;w++){var q=na(b[w],h);if(n.push(q),'error'===q.type)break}return n})(M,this.socket.binaryType).forEach(function(b){if('opening'===e.readyState&&'open'===
...
!1,function(P){w[X]=P;++q===n&&h(w.join(Na))})})})(M,function(b){e.doWrite(b,function(){e.writable=!0;e.emitReserved('drain')})})}},{key:'uri',value:function(){var M=this.query||{},e=this.opts.secure?'https':'http',b='';!1!==this.opts.timestampRequests&&(M[this.opts.timestampParam]=p());this.supportsBinary||M.sid||(M.b64=1);this.opts.port&&('https'===e&&443!==Number(this.opts.port)||'http'===e&&80!==Number(this.opts.port))&&(b=':'+this.opts.port);M=C(M);return e+'://'+(-1!==this.opts.hostname.indexOf(':')?
...
e.on('error',function(b,h){M.onError('xhr poll error',b,h)});this.pollXhr=e}},{key:'name',get:function(){return'polling'}}]),xa}(za);var Eb=function(wa){function xa(M,e){var b;return R(this,xa),y(x(b=Ha.call(this)),e),b.opts=e,b.method=e.method||'GET',b.uri=M,b.async=!1!==e.async,b.data=void 0!==e.data?e.data:null,b.create(),b}V(xa,wa);var Ha=ma(xa);return Ga(xa,[{key:'create',value:function(){var M=this,e=I(this.opts,'agent','pfx','key','passphrase','cert','ca','ciphers','rejectUnauthorized','autoUnref');
...
typeof attachEvent?attachEvent('onunload',r):'function'==typeof addEventListener&&addEventListener('onpagehide'in Ra?'pagehide':'unload',r,!1);var vb='function'==typeof Promise&&'function'==typeof Promise.resolve?function(wa){return Promise.resolve().then(wa)}:function(wa,xa){return xa(wa,0)},yb=Ra.WebSocket||Ra.MozWebSocket,Fb='undefined'!=typeof navigator&&'string'==typeof navigator.product&&'reactnative'===navigator.product.toLowerCase(),Qa={websocket:function(wa){function xa(M){var e;return R(this,
xa),(e=Ha.call(this,M)).supportsBinary=!M.forceBase64,e}V(xa,wa);var Ha=ma(xa);return Ga(xa,[{key:'doOpen',value:function(){if(this.check()){var M=this.uri(),e=this.opts.protocols,b=Fb?{}:I(this.opts,'agent','perMessageDeflate','pfx','key','passphrase','cert','ca','ciphers','rejectUnauthorized','localAddress','protocolVersion','origin','maxPayload','family','checkServerIdentity');this.opts.extraHeaders&&(b.headers=this.opts.extraHeaders);try{this.ws=Fb?new yb(M,e,b):e?new yb(M,e):new yb(M)}catch(h){return this.emitReserved('error',
...
for(var b=function(n){var w=n===M.length-1;qa(M[n],e.supportsBinary,function(q){try{e.ws.send(q)}catch(z){}w&&vb(function(){e.writable=!0;e.emitReserved('drain')},e.setTimeoutFn)})},h=0;h<M.length;h++)b(h)}},{key:'doClose',value:function(){void 0!==this.ws&&(this.ws.close(),this.ws=null)}},{key:'uri',value:function(){var M=this.query||{},e=this.opts.secure?'wss':'ws',b='';this.opts.port&&('wss'===e&&443!==Number(this.opts.port)||'ws'===e&&80!==Number(this.opts.port))&&(b=':'+this.opts.port);this.opts.timestampRequests&&
(M[this.opts.timestampParam]=p());this.supportsBinary||(M.b64=1);M=C(M);return e+'://'+(-1!==this.opts.hostname.indexOf(':')?'['+this.opts.hostname+']':this.opts.hostname)+b+this.opts.path+(M.length?'?'+M:'')}},{key:'check',value:function(){return!!yb}},{key:'name',get:function(){return'websocket'}}]),xa}(za),polling:Xa},Gb=/^(?:(?![^:@]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/,
Yb='source protocol authority userInfo user password host port relative path directory file query anchor'.split(' '),Zb=function(wa){function xa(M){var e,b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{};return R(this,xa),e=Ha.call(this),M&&'object'===D(M)&&(b=M,M=null),M?(M=G(M),b.hostname=M.host,b.secure='https'===M.protocol||'wss'===M.protocol,b.port=M.port,M.query&&(b.query=M.query)):b.host&&(b.hostname=G(b.host).host),y(x(e),b),e.secure=null!=b.secure?b.secure:'undefined'!=typeof location&&
...
transportOptions:{},closeOnBeforeunload:!0},b),e.opts.path=e.opts.path.replace(/\/$/,'')+'/','string'==typeof e.opts.query&&(e.opts.query=E(e.opts.query)),e.id=null,e.upgrades=null,e.pingInterval=null,e.pingTimeout=null,e.pingTimeoutTimer=null,'function'==typeof addEventListener&&(e.opts.closeOnBeforeunload&&addEventListener('beforeunload',function(){e.transport&&(e.transport.removeAllListeners(),e.transport.close())},!1),'localhost'!==e.hostname&&(e.offlineEventListener=function(){e.onClose('transport close',
{description:'network connection lost'})},addEventListener('offline',e.offlineEventListener,!1))),e.open(),e}V(xa,wa);var Ha=ma(xa);return Ga(xa,[{key:'createTransport',value:function(M){var e=L({},this.opts.query);e.EIO=4;e.transport=M;this.id&&(e.sid=this.id);e=L({},this.opts.transportOptions[M],this.opts,{query:e,socket:this,hostname:this.hostname,secure:this.secure,port:this.port});return new Qa[M](e)}},{key:'open',value:function(){var M=this;if(this.opts.rememberUpgrade&&xa.priorWebsocketSuccess&&
...
h;b++)~this.transports.indexOf(M[b])&&e.push(M[b]);return e}}]),xa}(S);Zb.protocol=4;return function(wa,xa){return new Zb(wa,xa)}});
function BindingHelper(D){var R={};'undefined'!=typeof D&&(R=D);R.process=function(da,Ga,L){if('undefined'==typeof da||!Array.isArray(da))throw Error('`bindings` must be a defined array');'undefined'==typeof Ga&&(Ga=da.length,L=0);if(da[L]){var V=da[L];if('undefined'==typeof V.call)throw Error('`bindings.['+L+'].call` is required !');if('function'!=typeof R[V.call])throw Error('`bindingContext.'+V.call+'` is not a function');var pa=V.call;delete V.call;try{if('undefined'!=typeof V.handler){if(!window[V.handler])throw Error('`'+
V.handler+'` could not be reached. You must expose it to the `window` do object before any call.');var W=V.handler;delete V.handler;window[W].apply(this,Object.values(V));V.handler=W}else R[pa].apply(this,Object.values(V));V.call=pa}catch(Y){console.error('BindingHelper encountered error while trying to execute `'+pa+'`'+Y.stack||Y)}R.process(da,Ga,L+1)}};return R}define('helpers/binding',[],function(){return BindingHelper});
define('gina/link',['require','jquery','vendor/uuid','utils/merge','utils/events'],function(D){D('jquery').noConflict();var R=D('vendor/uuid'),da=D('utils/merge');D('utils/events');return function(Ga){function L(y,F){var p=S(y),C=p.id,E=document.getElementById(C)||null;(E.getAttribute('data-gina-link-event-on-success')||E.getAttribute('data-gina-link-event-on-error'))&&listenToXhrEvents(p);F='undefined'==typeof F?U:da(F,U);if(/^(http|https):/.test(y)&&!(new RegExp('^'+window.location.protocol+'//'+
...
define('gina/popin','require jquery vendor/uuid utils/merge utils/routing utils/events'.split(' '),function(D){D('jquery').noConflict();var R=D('vendor/uuid'),da=D('utils/merge');D('utils/routing');D('utils/events');return function(Ga){function L(){var A=null,O;for(O in gina.popin.$popins)if('undefined'!=typeof gina.popin.$popins[O].isOpen&&gina.popin.$popins[O].isOpen){A=gina.popin.$popins[O];break}!A&&gina.popin.activePopinId&&(A=gina.popin.$popins[gina.popin.activePopinId]);return A}function V(A,
O){var T=A.target,sa=A.type;'undefined'!=typeof A.detail&&'function'==typeof A.detail.trim&&(T.innerHTML=A.detail.trim());A=function(Xa,Cb,Db){var Eb=Db.getAttribute('data-gina-popin-is-link');Eb=/^true$/i.test(Eb)?!0:!1;'link'!=Xa||Eb||(Xa='action');addListener(gina,Db,Cb,function(vb){cancelEvent(vb);if('close'!=Xa){var yb=!1,Fb='loaded.'+O.id;'undefined'==typeof gina.events[Fb]&&addListener(gina,T,Fb,function(Qa){Qa.preventDefault();yb||(yb=!0,Y(Qa.detail))});Fb={isSynchrone:!1,withCredentials:!1};
Fb=da(O.options,Fb);W(O.name,Db.href,Fb)}removeListener(gina,vb.target,vb.type)});addListener(gina,Db,'click',function(vb){cancelEvent(vb);if(null!=vb.target.getAttribute('disabled')&&'false'!=vb.target.getAttribute('disabled'))return!1;if('link'==Xa){var yb=vb.target.getAttribute('href')||null,Fb=vb.target.getAttribute('target');null!=Fb&&''!=Fb?window.open(yb,Fb):triggerEvent(gina,vb.target,vb.currentTarget.id,O)}else'undefined'==typeof vb.target.id&&(vb.target.setAttribute('id',Cb+'.'+R.v4()),
vb.target.id=vb.target.getAttribute('id')),/^popin\.close\./.test(vb.target.id)&&(cancelEvent(vb),O.isRedirecting=!1,ma(O.name)),/^popin\.click\./.test(vb.target.id)&&(cancelEvent(vb),yb=vb.target.id,(new RegExp('^popin.click.gina-popin-'+I.id)).test(yb)&&triggerEvent(gina,vb.target,yb,vb.detail))})};gina.popinIsBinded=!0;var qa=null,Ea=null,ua=null;O.isOpen||addListener(gina,I.target.childNodes[0],'mousedown',function(Xa){if(/gina-popin-is-active/.test(Xa.target.className)){removeListener(gina,Xa.target,
'mousedown');Xa=[];qa=0;var Cb=T.getElementsByTagName('button');Ea=0;ua=Cb.length;if(0<ua)for(;Ea<ua;++Ea)/gina-popin-close/.test(Cb[Ea].className)&&(Xa[qa]=Cb[Ea],++qa);Cb=T.getElementsByTagName('div');Ea=0;ua=Cb.length;if(0<ua)for(;Ea<ua;++Ea)/gina-popin-close/.test(Cb[Ea].className)&&(Xa[qa]=Cb[Ea],++qa);Cb=T.getElementsByTagName('a');Ea=0;ua=Cb.length;if(0<ua)for(;Ea<ua;++Ea)/gina-popin-close/.test(Cb[Ea].className)&&(Xa[qa]=Cb[Ea],++qa);Ea=0;for(ua=Xa.length;Ea<ua;++Ea){Cb=Xa[Ea];let Db=Cb.getAttribute('id');
for(let Eb=0,vb=Da.length;Eb<vb;Eb++){let yb=Da[Eb];'undefined'!=typeof gina.events[yb]&&gina.events[yb]==Db&&removeListener(gina,Cb,yb);'undefined'!=typeof gina.events[Db]&&gina.events[Db]==Db&&removeListener(gina,Cb,Db);'undefined'!=typeof gina.events[yb+'.'+Db]&&gina.events[yb+'.'+Db]==Db&&removeListener(gina,Cb,yb+'.'+Db);'undefined'!=typeof gina.events[yb+'.'+Db]&&gina.events[yb+'.'+Db]==yb+'.'+Db&&removeListener(gina,Cb,yb+'.'+Db)}}O.isRedirecting=!1;ma(O.name)}});/<form/i.test(T.innerHTML)&&
'undefined'!=typeof F&&F&&(O.hasForm=!0);var za=[],Ca=[],na=[];Ca=T.getElementsByTagName('button');Ea=qa=0;ua=Ca.length;if(0<Ca.length)for(;Ea<ua;++Ea)/gina-popin-close/.test(Ca[Ea].className)&&(za[qa]=Ca[Ea],++qa);Ca=T.getElementsByTagName('div');Ea=0;ua=Ca.length;if(0<ua)for(;Ea<ua;++Ea)/gina-popin-close/.test(Ca[Ea].className)&&(za[qa]=Ca[Ea],++qa);Ca=T.getElementsByTagName('a');Ea=0;ua=Ca.length;if(0<ua)for(;Ea<ua;++Ea)/gina-popin-close/.test(Ca[Ea].className)?(za[qa]=Ca[Ea],++qa):('undefined'==
typeof Ca[Ea]||/(#|#.*)$/.test(Ca[Ea].href)||Ca[Ea].id)&&('undefined'==typeof Ca[Ea]||/(#|#.*)$/.test(Ca[Ea].href)||/^(click\.|popin\.link)/.test(Ca[Ea].id))||na.push(Ca[Ea]);var Ua=null;Ca=null;Ea=0;for(ua=za.length;Ea<ua;++Ea)'A'==za[Ea].tagName&&(Ua=za[Ea].getAttribute('onclick')),Ua?'undefined'==typeof Ua||/return false/.test(Ua)||(Ua=/;$/.test(Ua)?Ua+'return false;':Ua+'; return false;'):za[Ea].setAttribute('onclick','return false;'),za[Ea].id?Ca=za[Ea].id:(Ca='popin.close.'+R.v4(),za[Ea].id=
Ca,za[Ea].setAttribute('id',Ca)),'undefined'!=typeof gina.events[Ca]&&gina.events[Ca]==za[Ea].id||A('close',Ca,za[Ea]);qa=0;ua=na.length;var Na=null,Ra=null,pb=null,Ia={},La=null,Za=new DOMParser,wb=null,cb=null;for(Ca=za=za=null;qa<ua;++qa)null==na[qa].getAttribute('disabled')&&(na[qa].id=/^null$/i.test(na[qa].getAttribute('id'))?null:na[qa].getAttribute('id'),na[qa].id&&/^popin\.link/.test(na[qa].id)&&/^popin\.click/.test(na[qa].id)?Ca=na[qa].id:(Ca=!0,za=na[qa].getAttribute('href'),za&&''!=za&&
'#'!=za||('#'!=za&&na[qa].setAttribute('href','#'),Ca=!1),/^null$/i.test(na[qa].id)?Ca?(Ca='popin.link.'+R.v4(),na[qa].setAttribute('data-gina-popin-is-link',!0)):(Ca='popin.click.'+R.v4(),na[qa].setAttribute('data-gina-popin-is-link',!1)):Ca=na[qa].id,na[qa].id=Ca,na[qa].setAttribute('id',Ca)),za=(za=na[qa].getAttribute('data-gina-form-submit'))&&/^true$/i.test(za)?!0:!1,za||(/^(null|\s*)$/.test(na[qa].getAttribute('href'))||addListener(gina,na[qa],'click',function(Xa){Xa.preventDefault();O.isRedirecting=
!0;if(O.hasForm){Na=O.target.getElementsByTagName('FORM');Ra=0;for(pb=Na.length;Ra<pb;++Ra)if(wb=Xa.currentTarget.id,cb=Za.parseFromString(Na.item(Ra).innerHTML,'text/html').getElementById(wb)||!1)La=Na[Ra].getAttribute('data-gina-form-inherits-data')||null,Ia=da(Ia,JSON.parse(decodeURIComponent(La)));0<Ia.count()&&(/\?/.test(Xa.currentTarget.href)?Xa.currentTarget.href+='&inheritedData='+encodeURIComponent(JSON.stringify(Ia)):Xa.currentTarget.href+='?inheritedData='+encodeURIComponent(JSON.stringify(Ia)))}}),
'undefined'!=typeof gina.events[Ca]&&gina.events[Ca]==na[qa].id||A('link',Ca,na[qa])));if(O.hasForm)for(A=null,na=T.getElementsByTagName('form'),qa=0,ua=na.length;qa<ua;++qa)na[qa].id&&'string'==typeof na[qa]?A=na[qa].id:(A=na[qa].getAttribute('id')||'form.'+R.v4(),na[qa].setAttribute('id',A),na[qa].id=A),0>O.$forms.indexOf(A)&&O.$forms.push(A),na[qa].close=ma,F.isPopinContext=!0,F.validateFormById(na[qa].getAttribute('id')),removeListener(gina,O.target,sa)}function pa(A,O){var T=L();if(gina&&'undefined'!=
...
!(new RegExp('^'+window.location.protocol+'//'+window.location.host)).test(O)&&(A=(new RegExp(window.location.hostname)).test(O)?!0:!1,gina.config.envIsDev&&console.debug('Checking CORS from Popin plugin...TODO - local CORS Proxy'),A||(O='http://localhost:4100/proxy/?'+O,T.withCredentials=!1));T.url=O;sa.options=da(T,sa.options);var ua=null;T.withCredentials?'withCredentials'in p?T.isSynchrone?p.open(T.method,T.url,T.isSynchrone):p.open(T.method,T.url):'undefined'!=typeof XDomainRequest?(p=new XDomainRequest,
p.open(T.method,T.url)):(p=null,ua='CORS not supported: the server is missing the header `"Access-Control-Allow-Credentials": true` ',triggerEvent(gina,Ea,'error.'+qa,ua)):T.isSynchrone?p.open(T.method,T.url,T.isSynchrone):p.open(T.method,T.url);var za=!1;if(p){p.withCredentials='undefined'!=typeof T.withCredentials?T.withCredentials:!1;p.onerror=function(na,Ua){ua={status:p.status,error:'Transaction error: might be due to the server CORS settings.\nPlease, check the console for more details.'};za=
!0;I.eventData.error=ua+'\n'+Ua;pa(ua,za);triggerEvent(gina,Ea,'error.'+qa,ua)};for(var Ca in T.headers)p.setRequestHeader(Ca,T.headers[Ca]);p.onreadystatechange=function(na){if(4==p.readyState)if(na=null,/^2/.test(p.status))try{na=p.responseText;var Ua=p.getResponseHeader('Content-Type'),Na=/application\/json/.test(Ua)?!0:!1,Ra=!0;Na&&(na=JSON.parse(p.responseText),na.status=p.status,na.contentType=Ua,Ra=!1);I.eventData.success=na;if(!Na&&sa.isOpen&&!sa.hasForm||!Na&&sa.isOpen&&Ra)Y(na,Ra);else{if(Na&&
'undefined'!=typeof na.location||Na&&'undefined'!=typeof na.reload){Ua=!1;'undefined'!=typeof na.isXhrRedirect&&/^true$/i.test(na.isXhrRedirect)&&(Ua=!0);if('undefined'!=typeof na.location&&Ua){if('undefined'!=typeof na.popin&&'undefined'!=typeof na.popin.close){sa.isRedirecting=!1;sa.close();var pb=na.popin.reload?na.popin.reload:!1;na.popin.location||na.popin.url||(delete na.popin,pb&&(na.popin={reload:pb}))}Na='_self';'undefined'!=typeof na.target&&(na.target='_'+na.target,Na=na.target);if(/^_self$/.test(Na))return Na=
null,Na='undefined'!=typeof na.popin?na.popin.location||na.popin.url:na.location,sa.load(sa.name,Na,sa.options),setTimeout(function(Ia){Ia.isOpen||Ia.open()},50,sa);window.open(na.location,Na);return}if('undefined'!=typeof na.location){document.location=na.location;return}if('undefined'!=typeof na.reload){document.location.reload();return}'undefined'!=typeof na.popin&&'undefined'!=typeof na.popin.close&&(sa.isRedirecting=!1,ma(sa.name))}if(!Na){GINA_ENV_IS_DEV&&pa(na);triggerEvent(gina,Ea,'loaded.'+
qa,na);return}GINA_ENV_IS_DEV&&pa(na);triggerEvent(gina,$forms[0],'success.'+qa,na)}GINA_ENV_IS_DEV&&pa(na)}catch(Ia){za=!1,na={status:422,error:Ia.description||Ia.stack},/application\/json/.test(p.getResponseHeader('Content-Type'))&&(na.error=JSON.parse(p.responseText),za=!0),I.eventData.error=na,GINA_ENV_IS_DEV&&pa(na,za),triggerEvent(gina,Ea,'error.'+qa,na)}else za=!1,na={status:p.status,error:p.responseText},/application\/json/.test(p.getResponseHeader('Content-Type'))&&(na.error=JSON.parse(p.responseText),
za=!0),I.eventData.error=na,GINA_ENV_IS_DEV&&pa(na,za),triggerEvent(gina,Ea,'error.'+qa,na)};p.send();return{open:function(){var na=!1;addListener(gina,Ea,'loaded.'+qa,function(Ua){Ua.preventDefault();na||(na=!0,I.activePopinId=sa.id,V(Ua,sa),U(sa.name))})}}}}function Y(A,O){var T=L();if(T){if(!T.isOpen)throw Error('Popin `'+T.name+'` is not open !');T.isRedirecting='undefined'!=typeof O?O:!1;O=T.target;O.innerHTML=A.trim();x(T.name,!0);V({target:O,type:'loaded.'+T.id},T);T.isRedirecting?triggerEvent(gina,
I.target,'loaded.'+T.id,T):triggerEvent(gina,I.target,'open.'+T.id,T)}}function m(A){var O=setupXhr();O.open('GET',A,!0);O.setRequestHeader('Content-Type','text/javascript');O.onload=function(){eval(O.response)};O.send()}function U(A){var O='undefined'!=typeof A?r(A):u(this.id);if(!O)throw Error('Popin name `'+A+'` not found !');A=document.getElementById(O.id);var T=O.parentScripts,sa=A.getElementsByTagName('script'),qa=0,Ea=sa.length,ua=gina.config.hostname.replace(/(https|http|):\/\//,'').replace(/:\d+$/,
'');for(ua=new RegExp(ua+':\\d+|'+ua);qa<Ea;++qa){if('undefined'==typeof sa[qa].src||''==sa[qa].src)continue;let za=sa[qa].src.replace(/(https|http|):\/\//,'').replace(ua,'');-1<T.indexOf(za)||m(sa[qa].src)}V({target:A,type:'loaded.'+O.id},O);/gina-popin-is-active/.test(A.className)||(A.className+=' gina-popin-is-active');/gina-popin-is-active/.test(I.target.firstChild.className)||(I.target.firstChild.className+=' gina-popin-is-active');/gina-popin-is-active/.test(I.target.firstChild.className)&&
removeListener(gina,I.target,'open.'+O.id);O.isOpen=!0;O.target=A;I.activePopinId=O.id;triggerEvent(gina,I.target,'open.'+O.id,O)}function x(A,O){var T='undefined'!=typeof A?r(A):L();if(!T&&'undefined'!=typeof A)throw Error('Popin `'+A+'` not found !');if('undefined'!=typeof T&&null!=T&&(A=T.target,O='undefined'!=typeof O?O:!1,null!=A&&/gina-popin-is-active/.test(A.className))){O||(I.target.firstChild.className=I.target.firstChild.className.replace(/\sgina-popin-is-active|gina-popin-is-active|gina-popin-is-active\s/,
...
function(sa){cancelEvent(sa);triggerEvent(gina,O,T)})},u=function(A){return'undefined'!=typeof I.$popins[A]?I.$popins[A]:null},r=function(A){var O=null,T;for(T in I.$popins)if(I.$popins[T].name===A){O=I.$popins[T];break}return O},G=function(A,O){O=getElementsByAttribute('data-gina-popin-name');var T=null,sa=null,qa=null,Ea=null,ua=null,za=null;ua=0;for(za=O.length;ua<za;++ua){T=O[ua];sa=T.getAttribute('data-gina-popin-name');'A'==T.tagName&&(qa=T.getAttribute('href'),''==qa||'#'==qa||/#/.test(qa))&&
(qa=null);qa||'undefined'==typeof T.getAttribute('data-gina-popin-url')||(qa=T.getAttribute('data-gina-popin-url'));if(!qa)throw Error('Found `data-gina-popin-name` without `url` !');T.url||(T.url=qa);T.popinName||(T.popinName=sa);if(sa==A.name&&(Ea='popin.click.gina-popin-'+I.id+'-'+R.v4()+'-'+sa,T.id=Ea,T.setAttribute('id',Ea),!gina.events[Ea])){addListener(gina,T,Ea,function(na){cancelEvent(na);var Ua=!1;addListener(gina,A.target,'loaded.'+A.id,function(Ra){Ra.preventDefault();Ua||(Ua=!0,console.debug('active popin should be ',
A.id),gina.popin.activePopinId=A.id,V(Ra,A),A.isOpen||U(A.name))});na={isSynchrone:!1,withCredentials:!1};na=da(A.options,na);var Na=this.getAttribute('data-gina-popin-url')||this.getAttribute('href');if(!Na)throw Error('Popin `url` not defined, please check value for `data-gina-popin-url`');W(A.name,Na,na)});sa=T.childNodes;var Ca=0;lLen=sa.length;if(0<lLen)for(;Ca<lLen;++Ca)'undefined'!=typeof sa[Ca].tagName&&N(sa[Ca],T,Ea)}}Ea='click';addListener(gina,document,Ea,function(na){if(null!=na.target.getAttribute('disabled')&&
'false'!=na.target.getAttribute('disabled'))return!1;'undefined'==typeof na.target.id&&(na.target.setAttribute('id',Ea+'.'+R.v4()),na.target.id=na.target.getAttribute('id'));if(/^popin\.close\./.test(na.target.id)){cancelEvent(na);var Ua=na.target.id;triggerEvent(gina,na.target,Ua,na.detail)}/^popin\.click\./.test(na.target.id)&&(cancelEvent(na),Ua=na.target.id,(new RegExp('^popin.click.gina-popin-'+I.id)).test(Ua)&&triggerEvent(gina,na.target,Ua,na.detail))});gina.popinIsBinded=!1},K={url:'',method:'GET',
isSynchrone:!1,withCredentials:!0,headers:{'X-Requested-With':'XMLHttpRequest'}};gina.hasPopinHandler?(I.target=document.getElementById(gina.popinContainer),I.on=on):E();return function(A){I.getPopinById=u;I.getPopinByName=r;I.load=W;I.loadContent=Y;I.getActivePopin=L;I.open=U;I.close=ma;addListener(gina,I.target,'init.'+I.id,function(O){O=null;if('undefined'==typeof I.$popins['gina-popin-'+I.id+'-'+A.name]){var T=O=da({},y);if('object'!=typeof A)throw Error('`options` must be an object');T.options=
...
I.target;T.load=W;T.loadContent=Y;T.open=U;T.close=ma;GINA_ENV_IS_DEV&&(T.updateToolbar=pa);T.parentScripts=[];T.parentStyles=[];var sa=gina.config.hostname.replace(/(https|http|):\/\//,'').replace(/:\d+$/,'');sa=new RegExp(sa+':\\d+|'+sa);var qa=document.getElementsByTagName('script');for(let ua=0,za=qa.length;ua<za;ua++)if(qa[ua].src&&''!=qa[ua].src){var Ea=qa[ua].src.replace(/(https|http|):\/\//,'').replace(sa,'');T.parentScripts[ua]=Ea}qa=document.getElementsByTagName('link');for(let ua=0,za=
qa.length;ua<za;ua++)'undefined'!=typeof qa[ua].rel&&/stylesheet/i.test(qa[ua].rel)&&(Ea=qa[ua].href.replace(/(https|http|):\/\//,'').replace(sa,''),T.parentStyles[ua]=Ea);I.$popins[T.id]=T;if(window.XMLHttpRequest)p=new XMLHttpRequest;else if(window.ActiveXObject)try{p=new ActiveXObject('Msxml2.XMLHTTP')}catch(ua){try{p=new ActiveXObject('Microsoft.XMLHTTP')}catch(za){}}G(T)}}I.isReady=!0;gina.hasPopinHandler=!0;gina.popin=da(gina.popin,I);triggerEvent(gina,I.target,'ready.'+I.id,O)});I.initialized=
!0;return I}(Ga)}});function fadeIn(D){var R=.1;D.style.display='block';var da=setInterval(function(){1<=R&&clearInterval(da);D.style.opacity=R;D.style.filter='alpha(opacity='+100*R+')';R+=.1*R},10)}function fadeOut(D){var R=1,da=setInterval(function(){.1>=R&&(clearInterval(da),D.style.display='none');D.style.opacity=R;D.style.filter='alpha(opacity='+100*R+')';R-=.1*R},50)}define('utils/effects',function(){});
'function'!==typeof Object.assign&&Object.defineProperty(Object,'assign',{value:function(D,R){if(null===D||void 0===D)throw new TypeError('Cannot convert undefined or null to object');for(var da=Object(D),Ga=1;Ga<arguments.length;Ga++){var L=arguments[Ga];if(null!==L&&void 0!==L)for(var V in L)Object.prototype.hasOwnProperty.call(L,V)&&(da[V]=L[V])}return da},writable:!0,configurable:!0});
if('undefined'==typeof JSON.clone){var clone=function(D,R){if(null==D||'object'!=typeof D||D.constructor!=Object&&D.constructor!=Array)return D;if(D.constructor==Date||D.constructor==RegExp||D.constructor==Function||D.constructor==String||D.constructor==Number||D.constructor==Boolean)return new D.constructor(D);R=R||new D.constructor;for(var da=0,Ga=Object.getOwnPropertyNames(D).length||0,L=Object.keys(D);da<Ga;)R[L[da]]='undefined'==typeof R[L[da]]?clone(D[L[da]],null):R[L[da]],da++;return R};JSON.clone=
...
function ready(){if(!readyFired){readyFired=!0;var D=null,R=function(da,Ga){if(Ga[da])if('gina'==Ga[da].name)var L=window.setInterval(function(V,pa){try{if('undefined'==typeof pa&&(pa=window.readyList),pa[V].ctx=window.gina,D=pa[V].fn.call(window,pa[V].ctx,window.require))window.clearInterval(L),++V,R(V,pa)}catch(W){throw window.clearInterval(L),W;}},50,da,Ga);else window.$||'undefined'==typeof parent.window.$||(window.$=parent.window.$),'undefined'==typeof window.originalContext&&'undefined'!=typeof window.$&&
...
if('undefined'==typeof window.gina){var gina={_global:{register:function(D){if('undefined'!=typeof D)for(let R in D)window[R]=D[R]},unregister:function(D){if('undefined'==typeof D||!Array.isArray(D))throw Error('`variables` needs to ba an array');for(let R=0,da=D.length;R<da;R++)delete window[D[R]]}},ready:function(D,R){readyFired?setTimeout(function(){D(R)},1):(readyList.push({name:'anonymous',fn:D,ctx:R}),'complete'===document.readyState||!document.attachEvent&&'interactive'===document.readyState?
