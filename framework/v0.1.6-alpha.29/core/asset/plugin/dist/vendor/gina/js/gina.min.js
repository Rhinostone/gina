...
(function(B,P){function V(Ia,Ja){return Ja||''}function na(Ia){return'[object Function]'===Fa.call(Ia)}function U(Ia){return'[object Array]'===Fa.call(Ia)}function M(Ia,Ja){if(Ia){var Ua;for(Ua=0;Ua<Ia.length&&(!Ia[Ua]||!Ja(Ia[Ua],Ua,Ia));Ua+=1);}}function ba(Ia,Ja){if(Ia){var Ua;for(Ua=Ia.length-1;-1<Ua&&(!Ia[Ua]||!Ja(Ia[Ua],Ua,Ia));--Ua);}}function Q(Ia,Ja){return W.call(Ia,Ja)}function S(Ia,Ja){return Q(Ia,Ja)&&Ia[Ja]}function r(Ia,Ja){for(var Ua in Ia)if(Q(Ia,Ua)&&Ja(Ia[Ua],Ua))break}function G(Ia,
Ja,Ua,pb){Ja&&r(Ja,function(ab,gb){if(Ua||!Q(Ia,gb))!pb||'object'!==typeof ab||!ab||U(ab)||na(ab)||ab instanceof RegExp?Ia[gb]=ab:(Ia[gb]||(Ia[gb]={}),G(Ia[gb],ab,Ua,pb))});return Ia}function w(Ia,Ja){return function(){return Ja.apply(Ia,arguments)}}function ma(Ia){throw Ia;}function Aa(Ia){if(!Ia)return Ia;var Ja=B;M(Ia.split('.'),function(Ua){Ja=Ja[Ua]});return Ja}function N(Ia,Ja,Ua,pb){Ja=Error(Ja+'\nhttps://requirejs.org/docs/errors.html#'+Ia);Ja.requireType=Ia;Ja.requireModules=pb;Ua&&(Ja.originalError=
Ua);return Ja}function O(){if(y&&'interactive'===y.readyState)return y;ba(document.getElementsByTagName('script'),function(Ia){if('interactive'===Ia.readyState)return y=Ia});return y}var A,D,l,y,z,F,u,v=/\/\*[\s\S]*?\*\/|([^:"'=]|^)\/\/.*$/mg,H=/[^.]\s*require\s*\(\s*["']([^'"\s]+)["']\s*\)/g,J=/\.js$/,T=/^\.\//;var ra=Object.prototype;var Fa=ra.toString,W=ra.hasOwnProperty,ka=!('undefined'===typeof window||'undefined'===typeof navigator||!window.document),ha=!ka&&'undefined'!==typeof importScripts,
xa=ka&&'PLAYSTATION 3'===navigator.platform?/^complete$/:/^(complete|loaded)$/,la='undefined'!==typeof opera&&'[object Opera]'===opera.toString(),ua={},Da={},Qa=[],La=!1;if('undefined'===typeof define){if('undefined'!==typeof requirejs){if(na(requirejs))return;Da=requirejs;requirejs=void 0}'undefined'===typeof require||na(require)||(Da=require,require=void 0);var Ea=requirejs=function(Ia,Ja,Ua,pb){var ab='_';if(!U(Ia)&&'string'!==typeof Ia){var gb=Ia;U(Ja)?(Ia=Ja,Ja=Ua,Ua=pb):Ia=[]}gb&&gb.context&&
(ab=gb.context);(pb=S(ua,ab))||(pb=ua[ab]=Ea.s.newContext(ab));gb&&pb.configure(gb);return pb.require(Ia,Ja,Ua)};Ea.config=function(Ia){return Ea(Ia)};Ea.nextTick='undefined'!==typeof P?function(Ia){P(Ia,4)}:function(Ia){Ia()};require||=Ea;Ea.version='2.3.6';Ea.jsExtRegExp=/^\/|:|\?|\.js$/;Ea.isBrowser=ka;ra=Ea.s={contexts:ua,newContext:function(Ia){function Ja(E,oa,sa){var ia;oa=oa&&oa.split('/');var Z=m.map,Ga=Z&&Z['*'];if(E){E=E.split('/');var Pa=E.length-1;m.nodeIdCompat&&J.test(E[Pa])&&(E[Pa]=
E[Pa].replace(J,''));'.'===E[0].charAt(0)&&oa&&(Pa=oa.slice(0,oa.length-1),E=Pa.concat(E));Pa=E;for(ia=0;ia<Pa.length;ia++){var $a=Pa[ia];'.'===$a?(Pa.splice(ia,1),--ia):'..'===$a&&0!==ia&&(1!==ia||'..'!==Pa[2])&&'..'!==Pa[ia-1]&&0<ia&&(Pa.splice(ia-1,2),ia-=2)}E=E.join('/')}if(sa&&Z&&(oa||Ga)){Pa=E.split('/');ia=Pa.length;a:for(;0<ia;--ia){var ib=Pa.slice(0,ia).join('/');if(oa)for($a=oa.length;0<$a;--$a)if(sa=S(Z,oa.slice(0,$a).join('/')))if(sa=S(sa,ib)){var Cb=sa;var zb=ia;break a}if(!qb&&Ga&&S(Ga,
ib)){var qb=S(Ga,ib);var Mb=ia}}!Cb&&qb&&(Cb=qb,zb=Mb);Cb&&(Pa.splice(0,zb,Cb),E=Pa.join('/'))}return(Cb=S(m.pkgs,E))?Cb:E}function Ua(E){ka&&M(document.getElementsByTagName('script'),function(oa){if(oa.getAttribute('data-requiremodule')===E&&oa.getAttribute('data-requirecontext')===da.contextName)return oa.parentNode.removeChild(oa),!0})}function pb(E){var oa=S(m.paths,E);if(oa&&U(oa)&&1<oa.length)return oa.shift(),da.require.undef(E),da.makeRequire(null,{skipMap:!0})([E]),!0}function ab(E){var oa=
E?E.indexOf('!'):-1;if(-1<oa){var sa=E.substring(0,oa);E=E.substring(oa+1,E.length)}return[sa,E]}function gb(E,oa,sa,ia){var Z=null,Ga=oa?oa.name:null,Pa=E,$a=!0,ib='';E||($a=!1,E='_@r'+(K+=1));E=ab(E);Z=E[0];E=E[1];if(Z){Z=Ja(Z,Ga,ia);var Cb=S(q,Z)}if(E)if(Z)ib=sa?E:Cb&&Cb.normalize?Cb.normalize(E,function(qb){return Ja(qb,Ga,ia)}):-1===E.indexOf('!')?Ja(E,Ga,ia):E;else{ib=Ja(E,Ga,ia);E=ab(ib);Z=E[0];ib=E[1];sa=!0;var zb=da.nameToUrl(ib)}sa=!Z||Cb||sa?'':'_unnormalized'+(fa+=1);return{prefix:Z,name:ib,
parentMap:oa,unnormalized:!!sa,url:zb,originalName:Pa,isDefine:$a,id:(Z?Z+'!'+ib:ib)+sa}}function Ub(E){var oa=E.id,sa=S(g,oa);sa||=g[oa]=new da.Module(E);return sa}function Zb(E,oa,sa){var ia=E.id,Z=S(g,ia);if(!Q(q,ia)||Z&&!Z.defineEmitComplete)if(Z=Ub(E),Z.error&&'error'===oa)sa(Z.error);else Z.on(oa,sa);else'defined'===oa&&sa(q[ia])}function jb(E,oa){var sa=E.requireModules,ia=!1;if(oa)oa(E);else if(M(sa,function(Z){if(Z=S(g,Z))Z.error=E,Z.events.error&&(ia=!0,Z.emit('error',E))}),!ia)Ea.onError(E)}
function Db(){Qa.length&&(M(Qa,function(E){var oa=E[0];'string'===typeof oa&&(da.defQueueMap[oa]=!0);x.push(E)}),Qa=[])}function rb(E){delete g[E];delete h[E]}function xb(E,oa,sa){var ia=E.map.id;E.error?E.emit('error',E.error):(oa[ia]=!0,M(E.depMaps,function(Z,Ga){Z=Z.id;var Pa=S(g,Z);!Pa||E.depMatched[Ga]||sa[Z]||(S(oa,Z)?(E.defineDep(Ga,q[Z]),E.check()):xb(Pa,oa,sa))}),sa[ia]=!0)}function Ka(){var E,oa,sa=(E=1E3*m.waitSeconds)&&da.startTime+E<(new Date).getTime(),ia=[],Z=[],Ga=!1,Pa=!0;if(!ya){ya=
!0;r(h,function($a){var ib=$a.map,Cb=ib.id;if($a.enabled&&(ib.isDefine||Z.push($a),!$a.error))if(!$a.inited&&sa)pb(Cb)?Ga=oa=!0:(ia.push(Cb),Ua(Cb));else if(!$a.inited&&$a.fetched&&ib.isDefine&&(Ga=!0,!ib.prefix))return Pa=!1});if(sa&&ia.length)return E=N('timeout','Load timeout for modules: '+ia,null,ia),E.contextName=da.contextName,jb(E);Pa&&M(Z,function($a){xb($a,{},{})});sa&&!oa||!Ga||!ka&&!ha||za||(za=P(function(){za=0;Ka()},50));ya=!1}}function db(E){Q(q,E[0])||Ub(gb(E[0],null,!0)).init(E[1],
E[2])}function Lb(E){E=E.currentTarget||E.srcElement;var oa=da.onScriptLoad;E.detachEvent&&!la?E.detachEvent('onreadystatechange',oa):E.removeEventListener('load',oa,!1);oa=da.onScriptError;E.detachEvent&&!la||E.removeEventListener('error',oa,!1);return{node:E,id:E&&E.getAttribute('data-requiremodule')}}function Vb(){for(Db();x.length;){var E=x.shift();if(null===E[0])return jb(N('mismatch','Mismatched anonymous define() module: '+E[E.length-1]));db(E)}da.defQueueMap={}}var ya,za,m={waitSeconds:7,
...
S(b,E.id)||{};this.map=E;this.shim=S(m.shim,E.id);this.depExports=[];this.depMaps=[];this.depMatched=[];this.pluginMaps={};this.depCount=0};ea.prototype={init:function(E,oa,sa,ia){ia=ia||{};if(!this.inited){this.factory=oa;if(sa)this.on('error',sa);else this.events.error&&(sa=w(this,function(Z){this.emit('error',Z)}));this.depMaps=E&&E.slice(0);this.errback=sa;this.inited=!0;this.ignore=ia.ignore;ia.enabled||this.enabled?this.enable():this.check()}},defineDep:function(E,oa){this.depMatched[E]||(this.depMatched[E]=
...
var sa=this.exports,ia=this.factory;if(!this.inited)Q(da.defQueueMap,E)||this.fetch();else if(this.error)this.emit('error',this.error);else if(!this.defining){this.defining=!0;if(1>this.depCount&&!this.defined){if(na(ia)){if(this.events.error&&this.map.isDefine||Ea.onError!==ma)try{sa=da.execCb(E,ia,oa,sa)}catch(Pa){var Z=Pa}else sa=da.execCb(E,ia,oa,sa);this.map.isDefine&&void 0===sa&&((oa=this.module)?sa=oa.exports:this.usingExports&&(sa=this.exports));if(Z)return Z.requireMap=this.map,Z.requireModules=
this.map.isDefine?[this.map.id]:null,Z.requireType=this.map.isDefine?'define':'require',jb(this.error=Z)}else sa=ia;this.exports=sa;if(this.map.isDefine&&!this.ignore&&(q[E]=sa,Ea.onResourceLoad)){var Ga=[];M(this.depMaps,function(Pa){Ga.push(Pa.normalizedMap||Pa)});Ea.onResourceLoad(da,this.map,Ga)}rb(E);this.defined=!0}this.defining=!1;this.defined&&!this.defineEmitted&&(this.defineEmitted=!0,this.emit('defined',this.exports),this.defineEmitComplete=!0)}}},callPlugin:function(){var E=this.map,oa=
E.id,sa=gb(E.prefix);this.depMaps.push(sa);Zb(sa,'defined',w(this,function(ia){var Z=S(R,this.map.id),Ga=this.map.name,Pa=this.map.parentMap?this.map.parentMap.name:null,$a=da.makeRequire(E.parentMap,{enableBuildCallback:!0});if(this.map.unnormalized){ia.normalize&&(Ga=ia.normalize(Ga,function(zb){return Ja(zb,Pa,!0)})||'');var ib=gb(E.prefix+'!'+Ga,this.map.parentMap,!0);Zb(ib,'defined',w(this,function(zb){this.map.normalizedMap=ib;this.init([],function(){return zb},null,{enabled:!0,ignore:!0})}));
if(ia=S(g,ib.id)){this.depMaps.push(ib);if(this.events.error)ia.on('error',w(this,function(zb){this.emit('error',zb)}));ia.enable()}}else if(Z)this.map.url=da.nameToUrl(Z),this.load();else{var Cb=w(this,function(zb){this.init([],function(){return zb},null,{enabled:!0})});Cb.error=w(this,function(zb){this.inited=!0;this.error=zb;zb.requireModules=[oa];r(g,function(qb){0===qb.map.id.indexOf(oa+'_unnormalized')&&rb(qb.map.id)});jb(zb)});Cb.fromText=w(this,function(zb,qb){var Mb=E.name,Ya=gb(Mb),cb=La;
qb&&(zb=qb);cb&&(La=!1);Ub(Ya);Q(m.config,oa)&&(m.config[Mb]=m.config[oa]);try{Ea.exec(zb)}catch(ca){return jb(N('fromtexteval','fromText eval for '+oa+' failed: '+ca,ca,[oa]))}cb&&(La=!0);this.depMaps.push(Ya);da.completeLoad(Mb);$a([Mb],Cb)});ia.load(E.name,$a,Cb,m)}}));da.enable(sa,this);this.pluginMaps[sa.id]=sa},enable:function(){h[this.map.id]=this;this.enabling=this.enabled=!0;M(this.depMaps,w(this,function(E,oa){var sa;if('string'===typeof E){E=gb(E,this.map.isDefine?this.map:this.map.parentMap,
!1,!this.skipMap);this.depMaps[oa]=E;if(sa=S(Ba,E.id)){this.depExports[oa]=sa(this);return}this.depCount+=1;Zb(E,'defined',w(this,function(Z){this.undefed||(this.defineDep(oa,Z),this.check())}));this.errback?Zb(E,'error',w(this,this.errback)):this.events.error&&Zb(E,'error',w(this,function(Z){this.emit('error',Z)}))}sa=E.id;var ia=g[sa];Q(Ba,sa)||!ia||ia.enabled||da.enable(E,this)}));r(this.pluginMaps,w(this,function(E){var oa=S(g,E.id);oa&&!oa.enabled&&da.enable(E,this)}));this.enabling=!1;this.check()},
on:function(E,oa){var sa=this.events[E];sa||=this.events[E]=[];sa.push(oa)},emit:function(E,oa){M(this.events[E],function(sa){sa(oa)});'error'===E&&delete this.events[E]}};var da={config:m,contextName:Ia,registry:g,defined:q,urlFetched:p,defQueue:x,defQueueMap:{},Module:ea,makeModuleMap:gb,nextTick:Ea.nextTick,onError:jb,configure:function(E){E.baseUrl&&'/'!==E.baseUrl.charAt(E.baseUrl.length-1)&&(E.baseUrl+='/');if('string'===typeof E.urlArgs){var oa=E.urlArgs;E.urlArgs=function(Z,Ga){return(-1===
Ga.indexOf('?')?'?':'&')+oa}}var sa=m.shim,ia={paths:!0,bundles:!0,config:!0,map:!0};r(E,function(Z,Ga){ia[Ga]?(m[Ga]||(m[Ga]={}),G(m[Ga],Z,!0,!0)):m[Ga]=Z});E.bundles&&r(E.bundles,function(Z,Ga){M(Z,function(Pa){Pa!==Ga&&(R[Pa]=Ga)})});E.shim&&(r(E.shim,function(Z,Ga){U(Z)&&(Z={deps:Z});!Z.exports&&!Z.init||Z.exportsFn||(Z.exportsFn=da.makeShimExports(Z));sa[Ga]=Z}),m.shim=sa);E.packages&&M(E.packages,function(Z){Z='string'===typeof Z?{name:Z}:Z;var Ga=Z.name;Z.location&&(m.paths[Ga]=Z.location);
m.pkgs[Ga]=Z.name+'/'+(Z.main||'main').replace(T,'').replace(J,'')});r(g,function(Z,Ga){Z.inited||Z.map.unnormalized||(Z.map=gb(Ga,null,!0))});(E.deps||E.callback)&&da.require(E.deps||[],E.callback)},makeShimExports:function(E){return function(){var oa;E.init&&(oa=E.init.apply(B,arguments));return oa||E.exports&&Aa(E.exports)}},makeRequire:function(E,oa){function sa(ia,Z,Ga){var Pa;oa.enableBuildCallback&&Z&&na(Z)&&(Z.__requireJsBuild=!0);if('string'===typeof ia){if(na(Z))return jb(N('requireargs',
'Invalid require call'),Ga);if(E&&Q(Ba,ia))return Ba[ia](g[E.id]);if(Ea.get)return Ea.get(da,ia,E,sa);var $a=gb(ia,E,!1,!0);$a=$a.id;return Q(q,$a)?q[$a]:jb(N('notloaded','Module name "'+$a+'" has not been loaded yet for context: '+Ia+(E?'':'. Use require([])')))}Vb();da.nextTick(function(){Vb();Pa=Ub(gb(null,E));Pa.skipMap=oa.skipMap;Pa.init(ia,Z,Ga,{enabled:!0});Ka()});return sa}oa=oa||{};G(sa,{isBrowser:ka,toUrl:function(ia){var Z=ia.lastIndexOf('.'),Ga=ia.split('/')[0];if(-1!==Z&&('.'!==Ga&&'..'!==
Ga||1<Z)){var Pa=ia.substring(Z,ia.length);ia=ia.substring(0,Z)}return da.nameToUrl(Ja(ia,E&&E.id,!0),Pa,!0)},defined:function(ia){return Q(q,gb(ia,E,!1,!0).id)},specified:function(ia){ia=gb(ia,E,!1,!0).id;return Q(q,ia)||Q(g,ia)}});E||(sa.undef=function(ia){Db();var Z=gb(ia,E,!0),Ga=S(g,ia);Ga.undefed=!0;Ua(ia);delete q[ia];delete p[Z.url];delete b[ia];ba(x,function(Pa,$a){Pa[0]===ia&&x.splice($a,1)});delete da.defQueueMap[ia];Ga&&(Ga.events.defined&&(b[ia]=Ga.events),rb(ia))});return sa},enable:function(E){S(g,
E.id)&&Ub(E).enable()},completeLoad:function(E){var oa=S(m.shim,E)||{},sa=oa.exports;for(Db();x.length;){var ia=x.shift();if(null===ia[0]){ia[0]=E;if(Z)break;var Z=!0}else ia[0]===E&&(Z=!0);db(ia)}da.defQueueMap={};ia=S(g,E);if(!Z&&!Q(q,E)&&ia&&!ia.inited)if(!m.enforceDefine||sa&&Aa(sa))db([E,oa.deps||[],oa.exportsFn]);else return pb(E)?void 0:jb(N('nodefine','No define call for '+E,null,[E]));Ka()},nameToUrl:function(E,oa,sa){var ia,Z;(ia=S(m.pkgs,E))&&(E=ia);if(ia=S(R,E))return da.nameToUrl(ia,
oa,sa);if(Ea.jsExtRegExp.test(E))ia=E+(oa||'');else{ia=m.paths;var Ga=E.split('/');for(Z=Ga.length;0<Z;--Z){var Pa=Ga.slice(0,Z).join('/');if(Pa=S(ia,Pa)){U(Pa)&&(Pa=Pa[0]);Ga.splice(0,Z,Pa);break}}ia=Ga.join('/');ia+=oa||(/^data:|^blob:|\?/.test(ia)||sa?'':'.js');ia=('/'===ia.charAt(0)||ia.match(/^[\w\+\.\-]+:/)?'':m.baseUrl)+ia}return m.urlArgs&&!/^blob:/.test(ia)?ia+m.urlArgs(E,ia):ia},load:function(E,oa){Ea.load(da,E,oa)},execCb:function(E,oa,sa,ia){return oa.apply(ia,sa)},onScriptLoad:function(E){if('load'===
E.type||xa.test((E.currentTarget||E.srcElement).readyState))y=null,E=Lb(E),da.completeLoad(E.id)},onScriptError:function(E){var oa=Lb(E);if(!pb(oa.id)){var sa=[];r(g,function(ia,Z){0!==Z.indexOf('_@r')&&M(ia.depMaps,function(Ga){if(Ga.id===oa.id)return sa.push(Z),!0})});return jb(N('scripterror','Script error for "'+oa.id+(sa.length?'", needed by: '+sa.join(', '):'"'),E,[oa.id]))}}};da.require=da.makeRequire();return da}};Ea({});M(['toUrl','undef','defined','specified'],function(Ia){Ea[Ia]=function(){var Ja=
ua._;return Ja.require[Ia].apply(Ja,arguments)}});if(ka){var Na=ra.head=document.getElementsByTagName('head')[0];if(A=document.getElementsByTagName('base')[0])Na=ra.head=A.parentNode}Ea.onError=ma;Ea.createNode=function(Ia,Ja,Ua){Ja=Ia.xhtml?document.createElementNS('http://www.w3.org/1999/xhtml','html:script'):document.createElement('script');Ja.type=Ia.scriptType||'text/javascript';Ja.charset='utf-8';Ja.async=!0;return Ja};Ea.load=function(Ia,Ja,Ua){var pb=Ia&&Ia.config||{};if(ka){var ab=Ea.createNode(pb,
...
0),importScripts(Ua),Ia.completeLoad(Ja)}catch(gb){Ia.onError(N('importscripts','importScripts failed for '+Ja+' at '+Ua,gb,[Ja]))}};ka&&!Da.skipDataMain&&ba(document.getElementsByTagName('script'),function(Ia){Na||(Na=Ia.parentNode);if(D=Ia.getAttribute('data-main'))return F=D,Da.baseUrl||-1!==F.indexOf('!')||(l=F.split('/'),F=l.pop(),u=l.length?l.join('/')+'/':'./',Da.baseUrl=u),F=F.replace(J,''),Ea.jsExtRegExp.test(F)&&(F=D),Da.deps=Da.deps?Da.deps.concat(F):[F],!0});define=function(Ia,Ja,Ua){var pb;
'string'!==typeof Ia&&(Ua=Ja,Ja=Ia,Ia=null);U(Ja)||(Ua=Ja,Ja=null);!Ja&&na(Ua)&&(Ja=[],Ua.length&&(Ua.toString().replace(v,V).replace(H,function(gb,Ub){Ja.push(Ub)}),Ja=(1===Ua.length?['require']:['require','exports','module']).concat(Ja)));if(La&&(pb=z||O())){Ia||=pb.getAttribute('data-requiremodule');var ab=ua[pb.getAttribute('data-requirecontext')]}ab?(ab.defQueue.push([Ia,Ja,Ua]),ab.defQueueMap[Ia]=!0):Qa.push([Ia,Ja,Ua])};define.amd={jQuery:!0};Ea.exec=function(Ia){return eval(Ia)};Ea(Da)}})(this,
...
z[l[y++]],z[l[y++]],z[l[y++]],z[l[y++]],z[l[y++]]].join('')}function na(l,y,z){var F=function(u,v,H,J){J=H&&J||0;if('string'==typeof u&&(u=function(T){T=unescape(encodeURIComponent(T));for(var ra=Array(T.length),Fa=0;Fa<T.length;Fa++)ra[Fa]=T.charCodeAt(Fa);return ra}(u)),'string'==typeof v&&(v=function(T){var ra=[];return T.replace(/[a-fA-F0-9]{2}/g,function(Fa){ra.push(parseInt(Fa,16))}),ra}(v)),!Array.isArray(u))throw TypeError('value must be an array of bytes');if(!Array.isArray(v)||16!==v.length)throw TypeError('namespace must be uuid string or an Array of 16 byte values');
u=z(v.concat(u));if(u[6]=15&u[6]|y,u[8]=63&u[8]|128,H)for(v=0;16>v;++v)H[J+v]=u[v];return H||V(u)};try{F.name=l}catch(u){}return F.DNS='6ba7b810-9dad-11d1-80b4-00c04fd430c8',F.URL='6ba7b811-9dad-11d1-80b4-00c04fd430c8',F}function U(l,y){var z=(65535&l)+(65535&y);return(l>>16)+(y>>16)+(z>>16)<<16|65535&z}function M(l,y,z,F,u,v){return U((H=U(U(y,l),U(F,v)))<<(J=u)|H>>>32-J,z);var H,J}function ba(l,y,z,F,u,v,H){return M(y&z|~y&F,l,y,u,v,H)}function Q(l,y,z,F,u,v,H){return M(y&F|z&~F,l,y,u,v,H)}function S(l,
y,z,F,u,v,H){return M(z^(y|~F),l,y,u,v,H)}for(var r='undefined'!=typeof crypto&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto)||'undefined'!=typeof msCrypto&&'function'==typeof msCrypto.getRandomValues&&msCrypto.getRandomValues.bind(msCrypto),G=new Uint8Array(16),w,ma,Aa=[],N=0;256>N;++N)Aa[N]=(N+256).toString(16).substr(1);var O=0,A=0;N=na('v3',48,function(l){if('string'==typeof l){var y=unescape(encodeURIComponent(l));l=Array(y.length);for(var z=0;z<y.length;z++)l[z]=y.charCodeAt(z)}return function(F){var u,
v=[],H=32*F.length;for(u=0;u<H;u+=8){var J=F[u>>5]>>>u%32&255;J=parseInt('0123456789abcdef'.charAt(J>>>4&15)+'0123456789abcdef'.charAt(15&J),16);v.push(J)}return v}(function(F,u){F[u>>5]|=128<<u%32;F[14+(u+64>>>9<<4)]=u;var v=1732584193,H=-271733879,J=-1732584194,T=271733878;for(u=0;u<F.length;u+=16){var ra=v;var Fa=H;var W=J;var ka=T;v=ba(v,H,J,T,F[u],7,-680876936);T=ba(T,v,H,J,F[u+1],12,-389564586);J=ba(J,T,v,H,F[u+2],17,606105819);H=ba(H,J,T,v,F[u+3],22,-1044525330);v=ba(v,H,J,T,F[u+4],7,-176418897);
T=ba(T,v,H,J,F[u+5],12,1200080426);J=ba(J,T,v,H,F[u+6],17,-1473231341);H=ba(H,J,T,v,F[u+7],22,-45705983);v=ba(v,H,J,T,F[u+8],7,1770035416);T=ba(T,v,H,J,F[u+9],12,-1958414417);J=ba(J,T,v,H,F[u+10],17,-42063);H=ba(H,J,T,v,F[u+11],22,-1990404162);v=ba(v,H,J,T,F[u+12],7,1804603682);T=ba(T,v,H,J,F[u+13],12,-40341101);J=ba(J,T,v,H,F[u+14],17,-1502002290);H=ba(H,J,T,v,F[u+15],22,1236535329);v=Q(v,H,J,T,F[u+1],5,-165796510);T=Q(T,v,H,J,F[u+6],9,-1069501632);J=Q(J,T,v,H,F[u+11],14,643717713);H=Q(H,J,T,v,F[u],
20,-373897302);v=Q(v,H,J,T,F[u+5],5,-701558691);T=Q(T,v,H,J,F[u+10],9,38016083);J=Q(J,T,v,H,F[u+15],14,-660478335);H=Q(H,J,T,v,F[u+4],20,-405537848);v=Q(v,H,J,T,F[u+9],5,568446438);T=Q(T,v,H,J,F[u+14],9,-1019803690);J=Q(J,T,v,H,F[u+3],14,-187363961);H=Q(H,J,T,v,F[u+8],20,1163531501);v=Q(v,H,J,T,F[u+13],5,-1444681467);T=Q(T,v,H,J,F[u+2],9,-51403784);J=Q(J,T,v,H,F[u+7],14,1735328473);H=Q(H,J,T,v,F[u+12],20,-1926607734);v=M(H^J^T,v,H,F[u+5],4,-378558);T=M(v^H^J,T,v,F[u+8],11,-2022574463);J=M(T^v^H,J,
T,F[u+11],16,1839030562);H=M(J^T^v,H,J,F[u+14],23,-35309556);v=M(H^J^T,v,H,F[u+1],4,-1530992060);T=M(v^H^J,T,v,F[u+4],11,1272893353);J=M(T^v^H,J,T,F[u+7],16,-155497632);H=M(J^T^v,H,J,F[u+10],23,-1094730640);v=M(H^J^T,v,H,F[u+13],4,681279174);T=M(v^H^J,T,v,F[u],11,-358537222);J=M(T^v^H,J,T,F[u+3],16,-722521979);H=M(J^T^v,H,J,F[u+6],23,76029189);v=M(H^J^T,v,H,F[u+9],4,-640364487);T=M(v^H^J,T,v,F[u+12],11,-421815835);J=M(T^v^H,J,T,F[u+15],16,530742520);H=M(J^T^v,H,J,F[u+2],23,-995338651);v=S(v,H,J,T,
F[u],6,-198630844);T=S(T,v,H,J,F[u+7],10,1126891415);J=S(J,T,v,H,F[u+14],15,-1416354905);H=S(H,J,T,v,F[u+5],21,-57434055);v=S(v,H,J,T,F[u+12],6,1700485571);T=S(T,v,H,J,F[u+3],10,-1894986606);J=S(J,T,v,H,F[u+10],15,-1051523);H=S(H,J,T,v,F[u+1],21,-2054922799);v=S(v,H,J,T,F[u+8],6,1873313359);T=S(T,v,H,J,F[u+15],10,-30611744);J=S(J,T,v,H,F[u+6],15,-1560198380);H=S(H,J,T,v,F[u+13],21,1309151649);v=S(v,H,J,T,F[u+4],6,-145523070);T=S(T,v,H,J,F[u+11],10,-1120210379);J=S(J,T,v,H,F[u+2],15,718787259);H=S(H,
J,T,v,F[u+9],21,-343485551);v=U(v,ra);H=U(H,Fa);J=U(J,W);T=U(T,ka)}return[v,H,J,T]}(function(F){var u,v=[];v[(F.length>>2)-1]=void 0;for(u=0;u<v.length;u+=1)v[u]=0;var H=8*F.length;for(u=0;u<H;u+=8)v[u>>5]|=(255&F[u/8])<<u%32;return v}(l),8*l.length))});var D=na('v5',80,function(l){var y=[1518500249,1859775393,2400959708,3395469782],z=[1732584193,4023233417,2562383102,271733878,3285377520];if('string'==typeof l){var F=unescape(encodeURIComponent(l));l=Array(F.length);for(var u=0;u<F.length;u++)l[u]=
F.charCodeAt(u)}l.push(128);F=Math.ceil((l.length/4+2)/16);var v=Array(F);for(u=0;u<F;u++){v[u]=Array(16);for(var H=0;16>H;H++)v[u][H]=l[64*u+4*H]<<24|l[64*u+4*H+1]<<16|l[64*u+4*H+2]<<8|l[64*u+4*H+3]}v[F-1][14]=8*(l.length-1)/Math.pow(2,32);v[F-1][14]=Math.floor(v[F-1][14]);v[F-1][15]=8*(l.length-1)&4294967295;for(u=0;u<F;u++){l=Array(80);for(H=0;16>H;H++)l[H]=v[u][H];for(H=16;80>H;H++){var J=l[H-3]^l[H-8]^l[H-14]^l[H-16];l[H]=J<<1|J>>>31}J=z[0];var T=z[1],ra=z[2],Fa=z[3],W=z[4];for(H=0;80>H;H++){var ka=
Math.floor(H/20),ha=J<<5|J>>>27;a:{switch(ka){case 0:var xa=T&ra^~T&Fa;break a;case 1:xa=T^ra^Fa;break a;case 2:xa=T&ra^T&Fa^ra&Fa;break a;case 3:xa=T^ra^Fa;break a}xa=void 0}ka=ha+xa+W+y[ka]+l[H]>>>0;W=Fa;Fa=ra;ra=(T<<30|T>>>2)>>>0;T=J;J=ka}z[0]=z[0]+J>>>0;z[1]=z[1]+T>>>0;z[2]=z[2]+ra>>>0;z[3]=z[3]+Fa>>>0;z[4]=z[4]+W>>>0}return[z[0]>>24&255,z[0]>>16&255,z[0]>>8&255,255&z[0],z[1]>>24&255,z[1]>>16&255,z[1]>>8&255,255&z[1],z[2]>>24&255,z[2]>>16&255,z[2]>>8&255,255&z[2],z[3]>>24&255,z[3]>>16&255,z[3]>>
8&255,255&z[3],z[4]>>24&255,z[4]>>16&255,z[4]>>8&255,255&z[4]]});B.v1=function(l,y,z){z=y&&z||0;var F=y||[],u=(l=l||{}).node||w,v=void 0!==l.clockseq?l.clockseq:ma;if(null==u||null==v){var H=l.random||(l.rng||P)();null==u&&(u=w=[1|H[0],H[1],H[2],H[3],H[4],H[5]]);null==v&&(v=ma=16383&(H[6]<<8|H[7]))}H=void 0!==l.msecs?l.msecs:(new Date).getTime();var J=void 0!==l.nsecs?l.nsecs:A+1,T=H-O+(J-A)/1E4;if(0>T&&void 0===l.clockseq&&(v=v+1&16383),(0>T||H>O)&&void 0===l.nsecs&&(J=0),1E4<=J)throw Error("uuid.v1(): Can't create more than 10M uuids/sec");
O=H;A=J;ma=v;l=(1E4*(268435455&(H+=122192928E5))+J)%4294967296;F[z++]=l>>>24&255;F[z++]=l>>>16&255;F[z++]=l>>>8&255;F[z++]=255&l;l=H/4294967296*1E4&268435455;F[z++]=l>>>8&255;F[z++]=255&l;F[z++]=l>>>24&15|16;F[z++]=l>>>16&255;F[z++]=v>>>8|128;F[z++]=255&v;for(v=0;6>v;++v)F[z+v]=u[v];return y||V(F)};B.v3=N;B.v4=function(l,y,z){z=y&&z||0;'string'==typeof l&&(y='binary'===l?Array(16):null,l=null);var F=(l=l||{}).random||(l.rng||P)();if(F[6]=15&F[6]|64,F[8]=63&F[8]|128,y)for(l=0;16>l;++l)y[z+l]=F[l];
return y||V(F)};B.v5=D;Object.defineProperty(B,'__esModule',{value:!0})});
function Merge(){var B=[],P=!1,V=function(M,ba){var Q=M;P||('object'==typeof M&&Array.isArray(M),P=!0);'undefined'==typeof Q&&(Q='undefined'!=typeof ba&&Array.isArray(ba)?[]:{});var S=!1;'boolean'==typeof arguments[arguments.length-1]&&(S=arguments[arguments.length-1]);var r=1,G=arguments.length,w,ma;if('object'!==typeof Q&&'function'!==typeof Q)Q=S?'undefined'==typeof arguments[2]?arguments[1]:arguments[2]:'undefined'==typeof arguments[0]?arguments[1]:arguments[0];else for(;r<G;++r)if('boolean'!=
typeof arguments[r]&&null!=(w=arguments[r])){if('object'!=typeof w){Q=w;break}if(Array.isArray(w)&&Array.isArray(Q))Q=na(w,Q,S);else for(var Aa in w){Q||={name:null};var N=Q[Aa];var O=w[Aa];if(Q!==O)if(O&&(U(O)||(ma=Array.isArray(O)))){var A=!1;if(ma){ma=!1;if(N&&Array.isArray(N))var D=N||[];else if(U(N)){D=N||{};Q[Aa]=D;continue}else D=[];B=D;D=na(O,D,S);Q[Aa]=D}else{D=N&&U(N)?N:null;if(!D){A=!0;D={};for(var l in O)D[l]=O[l]}if(S){for(l in O)'undefined'!=typeof O[l]?Array.isArray(O[l])&&Array.isArray(D[l])?
D[l]=na(O[l],D[l],S):D[l]=O[l]:Array.isArray(O[l])&&Array.isArray(D[l])&&(D[l]=na(O[l],D[l],S));Q[Aa]=D}else{for(l in O)'undefined'==typeof D[l]?Array.isArray(O[l])&&Array.isArray(D[l])?D[l]=na(O[l],D[l],S):D[l]=O[l]:Array.isArray(O[l])&&Array.isArray(D[l])&&(D[l]=na(O[l],D[l],S));'boolean'==typeof N||A?A&&(Q[Aa]=D):Q[Aa]=V(D,O,S)}}}else void 0!==O&&(Q[Aa]='undefined'==typeof N||null==N||N===O||S?O:N)}}B=[];P=!1;return Q},na=function(M,ba,Q){B=[];var S=[],r=V.getKeyComparison();if(/^true$/i.test(Q)){if('object'==
typeof M[0]&&null!=M[0]&&'undefined'!=typeof M[0][r]&&'object'==typeof ba[0]&&'undefined'!=typeof ba[0][r]){B=Array.isArray(ba)?Array.from(ba):JSON.clone(ba);var G=0;for(Q=B.length;G<Q;++G)S.push(B[G][r]);Q=JSON.clone(M);var w=0;G=0;M=Q.length;for(var ma=N||0,Aa=ba.length;ma<Aa;++ma)a:for(G=G||0;G<M;++G)if(Q[G][r]===ba[ma][r]){-1<S.indexOf(Q[G][r])?(B[w]=Q[G],++w):-1==S.indexOf(Q[G][r])&&(S.push(Q[G][r]),B[w]=Q[G],++w);break a}else-1==S.indexOf(Q[G][r])&&(S.push(Q[G][r]),B.push(Q[G]));return B}return Array.isArray(M)&&
0==M.length||'undefined'==typeof M?/^true$/i.test(Q)?M:ba:M}if(0==M.length&&0<ba.length)return B=ba;if(0==ba.length&&0<M.length)for(G=0;G<M.length;++G)ba.push(M[G]);if(0==B.length&&0<ba.length)for(G=0;G<ba.length;++G)'object'!=typeof ba[G]&&-1==B.indexOf(ba[G])&&B.push(ba[G]);if(0<ba.length){if('undefined'!=typeof M[0]&&'object'==typeof M[0]&&null!=M[0]&&'undefined'!=typeof M[0][r]&&'object'==typeof ba[0]&&'undefined'!=typeof ba[0][r]){B=Array.isArray(ba)?Array.from(ba):JSON.clone(ba);Q=JSON.clone(M);
var N=null;G=0;for(M=B.length;G<M;++G)S.push(B[G][r]);for(G=0;G<M;++G)a:for(ma=N||0,Aa=Q.length;ma<Aa;++ma)if(null!=Q[ma]&&'undefined'!=typeof Q[ma][r]&&Q[ma][r]!==B[G][r]){if(-1==S.indexOf(Q[ma][r])){B.push(Q[ma]);S.push(Q[ma][r]);N=ma+1;M<Aa&&++M;break a}}else if(null!=Q[ma]&&'undefined'!=typeof Q[ma][r]&&Q[ma][r]===B[G][r])N=ma+1;else break a;return B}for(G=0;G<M.length;++G)if(S=null,'undefined'==typeof M||'object'!=typeof M[G]||Array.isArray(M[G])||null==M[G]||(S=Object.getOwnPropertyNames(M[G])),
'undefined'!=typeof S&&null!=S&&(S=S[0]||null),-1<ba.indexOf(M[G])&&Q)ba.splice(ba.indexOf(M[G]),1,M[G]);else if('undefined'==typeof B[G]&&'object'==typeof M[G])for(w in B=ba,'undefined'==typeof B[G]&&(B[G]={}),M[G])B[G].hasOwnProperty(w)||(B[G][w]=M[G][w]);else!Q&&-1<B.indexOf(M[G])&&/number/i.test(typeof M[G])&&M[G]!==B[G]?B.push(M[G]):'undefined'==typeof ba[G]||/null/i.test(ba[G])||'undefined'==typeof ba[G][r]||'undefined'==typeof M[G]||'undefined'==typeof M[G][r]||ba[G][r]!=M[G][r]?-1==B.indexOf(M[G])&&
'object'!=typeof M[G]?B.push(M[G]):'undefined'==typeof ba[G]||/null/i.test(ba[G])||'undefined'==typeof ba[G][S]||'undefined'==typeof M[G]||'undefined'==typeof M[G][S]||ba[G][S]!=M[G][S]||(B[G]=Q?M[G]:ba[G]):B[G]=Q?M[G]:ba[G]}if(0<B.length&&0<ba.length||0==B.length&&0==ba.length)return B};na.prototype.setKeyComparison=function(M){this.keyComparison=M};var U=function(M){if(!M||'[object Object]'!=={}.toString.call(M)||M.nodeType||M.setInterval)return!1;var ba={}.hasOwnProperty,Q=ba.call(M,'constructor');
...
function addListener(B,P,V,na){var U=function(Q,S,r,G){'undefined'!=typeof Q.event&&Q.event.isTouchSupported&&/^(click|mouseout|mouseover)/.test(r)&&-1==Q.event[r].indexOf(S)&&(Q.event[r][Q.event[r].length]=S);'undefined'!=typeof S&&null!=S?S.addEventListener?S.addEventListener(r,G,!1):S.attachEvent&&S.attachEvent('on'+r,G):Q.customEvent.addListener(r,G);gina.events[r]='undefined'!=typeof S.id&&'object'!=typeof S.id?S.id:S.getAttribute('id')},M=0,ba=null;if(Array.isArray(V))for(ba=V.length;M<ba;M++)U(B,
P,V[M],na);else if(Array.isArray(P))for(M=0,ba=P.length;M<ba;M++){let Q=/\.$/.test(V)?V+P[M].id:V;U(B,P[M],Q,na)}else V=/\.$/.test(V)?V+P.id:V,U(B,P,V,na)}
function triggerEvent(B,P,V,na,U){if('undefined'!=typeof P&&null!=P){B=!1;if(jQuery){var M=jQuery.fn.jquery.split(/\./);M=2<M.length?M.splice(0,2).join('.'):M.join('.');M='1.7'>=M?jQuery(P).data('events'):jQuery._data(jQuery(P)[0],'events');if(M='undefined'!=typeof M&&'undefined'!=typeof M[V]?!0:!1)M=jQuery.Event(V),jQuery(P).trigger(M,na),B=M.isDefaultPrevented()}window.CustomEvent||document.createEvent?(window.CustomEvent?M=new CustomEvent(V,{detail:na,bubbles:!0,cancelable:!0,target:P}):(M=document.createEvent('HTMLEvents'),
M.detail=na,M.target=P,M.initEvent(V,!0,!0),M.eventName=V),U&&(M=mergeEventProps(M,U)),'undefined'!=typeof M.defaultPrevented&&M.defaultPrevented&&(B=M.defaultPrevented),B||P.dispatchEvent(M)):document.createEventObject&&(M=document.createEventObject(),M.srcElement.id=P.id,M.detail=na,M.target=P,U&&(M=mergeEventProps(M,U)),P.fireEvent('on'+V,M))}else B.customEvent.fire(V,na)}
...
function handleXhr(B,P,V,na){if(!B)throw Error('No `xhr` object initiated');var U=null,M=null,ba=null,Q=null,S=null,r=V.$link||null,G=V.$form||null,w=null;delete V.$link;delete V.$form;G||r?r?(r.target=document.getElementById(r.id),w=gina.link.target,S=gina.link.id):(w=G.target,S=w.getAttribute('id')):(w=P,S=w.getAttribute('id'));var ma=r&&P.getAttribute('data-gina-link-event-on-success')||r&&P.getAttribute('data-gina-link-event-on-error')?!0:!1,Aa=G&&w.getAttribute('data-gina-form-event-on-submit-success')||
G&&w.getAttribute('data-gina-form-event-on-submit-error')?!0:!1;Aa&&G&&listenToXhrEvents(G,'form');P=P.getAttribute('enctype')||V.headers['Content-Type'];for(var N in V.headers)'Content-Type'==N&&'undefined'!=typeof P&&null!=P&&''!=P||B.setRequestHeader(N,V.headers[N]);B.withCredentials='undefined'!=typeof V.withCredentials?V.withCredentials:!1;B.onerror=function(O,A){O={status:B.status||500,error:'Transaction error: might be due to the server CORS settings.\nPlease, check the console for more details.'};
G&&(G.eventData.error=O);r&&(r.eventData.error=O);window.ginaToolbar.update('data-xhr',O,!0);triggerEvent(gina,w,'error.'+S,O);Aa&&triggerEvent(gina,w,'error.'+S+'.hform',O);ma&&triggerEvent(gina,w,'error.'+S+'.hlink',O)};B.onreadystatechange=function(O){O=/Google Inc/i.test(navigator.vendor)?50:0;2==B.readyState&&(M=/^attachment;/.test(B.getResponseHeader('Content-Disposition'))?!0:!1,!B.responseType&&M&&(B.responseType='blob'));if(4==B.readyState)if(U=null,ba=B.getResponseHeader('Content-Type'),
/^2/.test(B.status)){try{if(/blob/.test(B.responseType)||M){if('undefined'==typeof ba||null==ba)ba='application/octet-stream';U=new Blob([this.response],{type:ba});var A=document.createElement('a');A.style='display: none';document.body.appendChild(A);var D=window.URL.createObjectURL(U);A.href=D;var l=B.getResponseHeader('Content-Disposition');A.download=l.match('=(.*)')[0].substr(1);A.click();window.URL.revokeObjectURL(D);Q={status:B.status,statusText:B.statusText,responseType:U.type,type:U.type,
...
function removeListener(B,P,V,na){'undefined'!=typeof B.event&&B.event.isTouchSupported&&/^(click|mouseout|mouseover)/.test(V)&&-1!=B.event[V].indexOf(P)&&B.event[V].splice(B.event[V].indexOf(P),1);if('undefined'!=typeof P&&null!=P)if(P.removeEventListener)if(Array.isArray(P))for(i=0,len=P.length;i<len;i++)B=/\.$/.test(V)?V+P[i].id:V,P.removeEventListener(B,na,!1),'undefined'!=typeof gina.events[B]&&delete gina.events[B];else V=/\.$/.test(V)?V+P.id:V,P.removeEventListener(V,na,!1);else{if(P.attachEvent)if(Array.isArray(P))for(i=
0,len=P.length;i<len;i++)B=/\.$/.test(V)?V+P[i].id:V,P.detachEvent('on'+B,na),'undefined'!=typeof gina.events[B]&&delete gina.events[B];else V=/\.$/.test(V)?V+P.id:V,P.detachEvent('on'+V,na)}else if(Array.isArray(P))for(i=0,len=P.length;i<len;i++){let U=/\.$/.test(V)?V+P[i].id:V;B.customEvent.removeListener(U,na);'undefined'!=typeof gina.events[U]&&delete gina.events[U]}else V=/\.$/.test(V)?V+P.id:V,B.customEvent.removeListener(V,na);'undefined'!=typeof gina.events[V]&&delete gina.events[V];'undefined'!=
typeof na&&na()}
function on(B,P){if(!this.plugin)throw Error('No `plugin` reference found for this event: `'+B);if(0>gina.registeredEvents[this.plugin].indexOf(B)&&!/^init$/.test(B)&&!/\.hform$/.test(B)&&!/\.hlink$/.test(B))P(Error('Event `'+B+'` not handled by ginaEventHandler'));else{var V=null,na=null;'undefined'!=typeof this.id&&'object'!=typeof this.id?(V=this.target||this,na=this.id):'undefined'!=typeof this.target?((V=this.target)||(V=this),na='undefined'!=typeof V.getAttribute?V.getAttribute('id'):this.id):
(V=this.target,na=instance.id);this.eventData&&!V.eventData&&(V.eventData=this.eventData);B=/\.(hform|hlink)$/.test(B)?/\.hform$/.test(B)?B.replace(/\.hform$/,'.'+na+'.hform'):B.replace(/\.hlink$/,'.'+na+'.hlink'):B+('.'+na);gina.events[B]||(addListener(gina,V,B,function(U){cancelEvent(U);var M=null;U.detail?M=U.detail:'undefined'!=typeof this.eventData.submit?M=this.eventData.submit:'undefined'!=typeof this.eventData.error?M=this.eventData.error:'undefined'!=typeof this.eventData.success&&(M=this.eventData.success);
P&&P(U,M)}),this.initialized&&!this.isReady&&triggerEvent(gina,V,'init.'+na));return this}}define('utils/events',function(){});
function PrototypesHelper(B){var P='undefined'!==typeof module&&module.exports?!1:!0,V=B||null;B=null;if('undefined'==typeof GINA_DIR&&!P&&'undefined'!=typeof process&&3<process.argv.length)if(/^\{/.test(process.argv[2]))B=JSON.parse(process.argv[2]).envVars;else if(/\.ctx$/.test(process.argv[2])){B=require('fs');var na=process.argv[2].split(/\-\-argv\-filename=/)[1];B=JSON.parse(B.readFileSync(na).toString()).envVars}if(V&&'undefined'!=typeof V&&'undefined'!=typeof V.dateFormat)for(let U in V.dateFormat)'undefined'==
...
return{setCulture:function(r,G){/\-/.test(G)?(V=G,na=G.split(/\-/)[0]):na=G;return this},format:function(r,G,w){var ma=M[na]||M.en,Aa=null;try{Aa=P(ma.masks,U)}catch(T){P=(B='undefined'!==typeof module&&module.exports?!1:!0)?require('lib/merge'):require('./../lib/merge'),Aa=P(ma.masks,U)}'undefined'!=typeof M[V]&&(ma=M[V],'undefined'!=typeof M[V].mask&&(Aa=P(ma.masks,U)));var N=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,
O=/[^-+\dA-Z]/g,A=function(T,ra){T=String(T);for(ra=ra||2;T.length<ra;)T='0'+T;return T};1!=arguments.length||'[object String]'!=Object.prototype.toString.call(r)||/\d/.test(r)||(G=r,r=void 0);r=r?new Date(r):new Date;if(isNaN(r))throw SyntaxError('invalid date');G=String(Aa[G]||G||Aa['default']);'UTC:'==G.slice(0,4)&&(G=G.slice(4),w=!0);var D=w?'getUTC':'get';Aa=r[D+'Date']();var l=r[D+'Day'](),y=r[D+'Month'](),z=r[D+'FullYear'](),F=r[D+'Hours'](),u=r[D+'Minutes'](),v=r[D+'Seconds']();D=r[D+'Milliseconds']();
var H=w?0:r.getTimezoneOffset(),J={d:Aa,dd:A(Aa),ddd:ma.dayNames[l],dddd:ma.dayNames[l+7],m:y+1,mm:A(y+1),mmm:ma.monthNames[y],mmmm:ma.monthNames[y+12],yy:String(z).slice(2),yyyy:z,h:F%12||12,hh:A(F%12||12),H:F,HH:A(F),M:u,MM:A(u),s:v,ss:A(v),l:A(D,3),L:A(D),t:12>F?'a':'p',tt:12>F?'am':'pm',T:12>F?'A':'P',TT:12>F?'AM':'PM',Z:w?'UTC':(String(r).match(N)||['']).pop().replace(O,''),o:(0<H?'-':'+')+A(100*Math.floor(Math.abs(H)/60)+Math.abs(H)%60,4),S:['th','st','nd','rd'][3<Aa%10?0:(10!=Aa%100-Aa%10)*
Aa%10]};return G.replace(/d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g,function(T){return T in J?J[T]:T.slice(1,T.length-1)})},countDaysTo:ba,getDaysTo:function(r,G,w){if(G instanceof Date){G=ba(r,G);var ma=r.getMonth(),Aa=r.getFullYear();r=r.getDate()+1;r=new Date(Aa,ma,r);ma=[];for(Aa=0;Aa<G;++Aa)'undefined'!=typeof w?ma.push((new Date(r)).format(w)):ma.push(new Date(r)),r.setDate(r.getDate()+1);return ma||[]}throw Error('dateTo is not instance of Date() !');},getDaysInMonth:function(r){var G=
...
n,C=a.nodeType,I=C?b.cache:a,Y=C?a[b.expando]:b.expando;if(I[Y]){if(c&&(k=e?I[Y]:I[Y].data)){b.isArray(c)?c=c.concat(b.map(c,b.camelCase)):c in k?c=[c]:(c=b.camelCase(c),c=c in k?[c]:c.split(' '));for(n=c.length;n--;)delete k[c[n]];if(e?!r(k):!b.isEmptyObject(k))return}(e||(delete I[Y].data,r(I[Y])))&&(C?b.cleanData([a],!0):h.deleteExpando||I!=I.window?delete I[Y]:I[Y]=void 0)}}}function ma(a,c,e,k){var n,C=1,I=20,Y=k?function(){return k.cur()}:function(){return b.css(a,c,'')},qa=Y(),Ca=e&&e[3]||
(b.cssNumber[c]?'':'px'),ta=(b.cssNumber[c]||'px'!==Ca&&+qa)&&Mb.exec(b.css(a,c));if(ta&&ta[3]!==Ca){Ca=Ca||ta[3];e=e||[];ta=+qa||1;do C=C||'.5',ta/=C,b.style(a,c,ta+Ca);while(C!==(C=Y()/qa)&&1!==C&&--I)}return e&&(ta=+ta||+qa||0,n=e[1]?ta+(e[1]+1)*e[2]:+e[2],k&&(k.unit=Ca,k.start=ta,k.end=n)),n}function Aa(a){var c='abbr article aside audio bdi canvas data datalist details dialog figcaption figure footer header hgroup main mark meter nav output picture progress section summary template time video'.split(' ');
a=a.createDocumentFragment();if(a.createElement)for(;c.length;)a.createElement(c.pop());return a}function N(a,c){var e,k,n=0,C='undefined'!=typeof a.getElementsByTagName?a.getElementsByTagName(c||'*'):'undefined'!=typeof a.querySelectorAll?a.querySelectorAll(c||'*'):void 0;if(!C)for(C=[],e=a.childNodes||a;null!=(k=e[n]);n++)!c||b.nodeName(k,c)?C.push(k):b.merge(C,N(k,c));return void 0===c||c&&b.nodeName(a,c)?b.merge([a],C):C}function O(a,c){for(var e,k=0;null!=(e=a[k]);k++)b._data(e,'globalEval',
!c||b._data(c[k],'globalEval'))}function A(a){X.test(a.type)&&(a.defaultChecked=a.checked)}function D(a,c,e,k,n){for(var C,I,Y,qa,Ca,ta,Sa,Va=a.length,yb=Aa(c),bb=[],Hb=0;Va>Hb;Hb++)if(I=a[Hb],I||0===I)if('object'===b.type(I))b.merge(bb,I.nodeType?[I]:I);else if(eb.test(I)){qa=qa||yb.appendChild(c.createElement('div'));Ca=(ja.exec(I)||['',''])[1].toLowerCase();Sa=Xa[Ca]||Xa._default;qa.innerHTML=Sa[1]+b.htmlPrefilter(I)+Sa[2];for(C=Sa[0];C--;)qa=qa.lastChild;if(!h.leadingWhitespace&&Ra.test(I)&&bb.push(c.createTextNode(Ra.exec(I)[0])),
!h.tbody)for(C=(I='table'!==Ca||Oa.test(I)?'<table>'!==Sa[1]||Oa.test(I)?0:qa:qa.firstChild)&&I.childNodes.length;C--;)b.nodeName(ta=I.childNodes[C],'tbody')&&!ta.childNodes.length&&I.removeChild(ta);b.merge(bb,qa.childNodes);for(qa.textContent='';qa.firstChild;)qa.removeChild(qa.firstChild);qa=yb.lastChild}else bb.push(c.createTextNode(I));qa&&yb.removeChild(qa);h.appendChecked||b.grep(N(bb,'input'),A);for(Hb=0;I=bb[Hb++];)if(k&&-1<b.inArray(I,k))n&&n.push(I);else if(Y=b.contains(I.ownerDocument,
I),qa=N(yb.appendChild(I),'script'),Y&&O(qa),e)for(C=0;I=qa[C++];)va.test(I.type||'')&&e.push(I);return yb}function l(){return!0}function y(){return!1}function z(){try{return Ka.activeElement}catch(a){}}function F(a,c,e,k,n,C){var I,Y;if('object'==typeof c){'string'!=typeof e&&(k=k||e,e=void 0);for(Y in c)F(a,Y,e,k,c[Y],C);return a}if(null==k&&null==n?(n=e,k=e=void 0):null==n&&('string'==typeof e?(n=k,k=void 0):(n=k,k=e,e=void 0)),!1===n)n=y;else if(!n)return a;return 1===C&&(I=n,n=function(qa){return b().off(qa),
...
k;var n=b._data(a);a=b._data(c,n);var C=n.events;if(C)for(e in delete a.handle,a.events={},C)for(n=0,k=C[e].length;k>n;n++)b.event.add(c,e,C[e][n]);a.data&&(a.data=b.extend({},a.data))}}function T(a,c,e,k){c=Lb.apply([],c);var n,C,I,Y=0,qa=a.length,Ca=qa-1,ta=c[0],Sa=b.isFunction(ta);if(Sa||1<qa&&'string'==typeof ta&&!h.checkClone&&Ib.test(ta))return a.each(function(yb){var bb=a.eq(yb);Sa&&(c[0]=ta.call(this,yb,bb.html()));T(bb,c,e,k)});if(qa&&(I=D(c,a[0].ownerDocument,!1,a,k),n=I.firstChild,1===
I.childNodes.length&&(I=n),n||k)){var Va=b.map(N(I,'script'),v);for(C=Va.length;qa>Y;Y++)n=I,Y!==Ca&&(n=b.clone(n,!0,!0),C&&b.merge(Va,N(n,'script'))),e.call(a[Y],n,Y);if(C)for(I=Va[Va.length-1].ownerDocument,b.map(Va,H),Y=0;C>Y;Y++)n=Va[Y],va.test(n.type||'')&&!b._data(n,'globalEval')&&b.contains(I,n)&&(n.src?b._evalUrl&&b._evalUrl(n.src):b.globalEval((n.text||n.textContent||n.innerHTML||'').replace(Xb,'')));I=n=null}return a}function ra(a,c,e){for(var k=c?b.filter(c,a):a,n=0;null!=(c=k[n]);n++)e||
...
I)for(e in C=I.expand(C),delete a[k],C)e in a||(a[e]=C[e],c[e]=n);else c[k]=n}function Ja(a,c,e){var k,n=0,C=Ja.prefilters.length,I=b.Deferred().always(function(){delete Y.elem}),Y=function(){if(k)return!1;var Ca=Fc||La();Ca=Math.max(0,qa.startTime+qa.duration-Ca);for(var ta=1-(Ca/qa.duration||0),Sa=0,Va=qa.tweens.length;Va>Sa;Sa++)qa.tweens[Sa].run(ta);return I.notifyWith(a,[qa,ta,Ca]),1>ta&&Va?Ca:(I.resolveWith(a,[qa]),!1)},qa=I.promise({elem:a,props:b.extend({},c),opts:b.extend(!0,{specialEasing:{},
easing:b.easing._default},e),originalProperties:c,originalOptions:e,startTime:Fc||La(),duration:e.duration,tweens:[],createTween:function(Ca,ta){Ca=b.Tween(a,qa.opts,Ca,ta,qa.opts.specialEasing[Ca]||qa.opts.easing);return qa.tweens.push(Ca),Ca},stop:function(Ca){var ta=0,Sa=Ca?qa.tweens.length:0;if(k)return this;for(k=!0;Sa>ta;ta++)qa.tweens[ta].run(1);return Ca?(I.notifyWith(a,[qa,1,0]),I.resolveWith(a,[qa,Ca])):I.rejectWith(a,[qa,Ca]),this}});e=qa.props;for(Ia(e,qa.opts.specialEasing);C>n;n++)if(c=
...
0:Ma.length;Ha--&&(Ta=Ma[Ha],!Fb.relative[Za=Ta.type]);)if((Wa=Fb.find[Za])&&(wa=Wa(Ta.matches[0].replace(xc,yc),Wc.test(Ma[0].type)&&ta(aa.parentNode)||aa))){if(Ma.splice(Ha,1),L=wa.length&&Va(Ma),!L)return Ac.apply(pa,wa),pa;break}}return(kb||vb(L,nb))(wa,aa,!fc,pa,!aa||Wc.test(L)&&ta(aa.parentNode)||aa),pa},Pb.sortStable=Ab.split('').sort(uc).join('')===Ab,Pb.detectDuplicates=!!Rb,Bc(),Pb.sortDetached=n(function(L){return 1&L.compareDocumentPosition(tb.createElement('div'))}),n(function(L){return L.innerHTML=
...
n?b.unique(e):e),e.selector=this.selector?this.selector+' '+a:a,e},filter:function(a){return this.pushStack(na(this,a||[],!1))},not:function(a){return this.pushStack(na(this,a||[],!0))},is:function(a){return!!na(this,'string'==typeof a&&ea.test(a)?b(a):a||[],!1).length}});var oa=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;(b.fn.init=function(a,c,e){var k,n;if(!a)return this;if(e=e||sa,'string'==typeof a){if(k='<'===a.charAt(0)&&'>'===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:oa.exec(a),!k||!k[1]&&
c)return!c||c.jquery?(c||e).find(a):this.constructor(c).find(a);if(k[1]){if(c=c instanceof b?c[0]:c,b.merge(this,b.parseHTML(k[1],c&&c.nodeType?c.ownerDocument||c:Ka,!0)),da.test(k[1])&&b.isPlainObject(c))for(k in c)b.isFunction(this[k])?this[k](c[k]):this.attr(k,c[k]);return this}if(n=Ka.getElementById(k[2]),n&&n.parentNode){if(n.id!==k[2])return sa.find(a);this.length=1;this[0]=n}return this.context=Ka,this.selector=a,this}return a.nodeType?(this.context=this[0]=a,this.length=1,this):b.isFunction(a)?
'undefined'!=typeof e.ready?e.ready(a):a(b):(void 0!==a.selector&&(this.selector=a.selector,this.context=a.context),b.makeArray(a,this))}).prototype=b.fn;var sa=b(Ka);var ia=/^(?:parents|prev(?:Until|All))/,Z={children:!0,contents:!0,next:!0,prev:!0};b.fn.extend({has:function(a){var c,e=b(a,this),k=e.length;return this.filter(function(){for(c=0;k>c;c++)if(b.contains(this,e[c]))return!0})},closest:function(a,c){for(var e,k=0,n=this.length,C=[],I=ea.test(a)||'string'!=typeof a?b(a,c||this.context):
...
function(ta,Sa){for(var Va;-1<(Va=b.inArray(Sa,C,Va));)C.splice(Va,1),Y>=Va&&Y--}),this},has:function(ta){return ta?-1<b.inArray(ta,C):0<C.length},empty:function(){return C&&=[],this},disable:function(){return n=I=[],C=e='',this},disabled:function(){return!C},lock:function(){return n=!0,e||Ca.disable(),this},locked:function(){return!!n},fireWith:function(ta,Sa){return n||(Sa=Sa||[],Sa=[ta,Sa.slice?Sa.slice():Sa],I.push(Sa),c||qa()),this},fire:function(){return Ca.fireWith(this,arguments),this},fired:function(){return!!k}};
return Ca};b.extend({Deferred:function(a){var c=[['resolve','done',b.Callbacks('once memory'),'resolved'],['reject','fail',b.Callbacks('once memory'),'rejected'],['notify','progress',b.Callbacks('memory')]],e='pending',k={state:function(){return e},always:function(){return n.done(arguments).fail(arguments),this},then:function(){var C=arguments;return b.Deferred(function(I){b.each(c,function(Y,qa){var Ca=b.isFunction(C[Y])&&C[Y];n[qa[1]](function(){var ta=Ca&&Ca.apply(this,arguments);ta&&b.isFunction(ta.promise)?
ta.promise().progress(I.notify).done(I.resolve).fail(I.reject):I[qa[0]+'With'](this===k?I.promise():this,Ca?[ta]:arguments)})});C=null}).promise()},promise:function(C){return null!=C?b.extend(C,k):k}},n={};return k.pipe=k.then,b.each(c,function(C,I){var Y=I[2],qa=I[3];k[I[1]]=Y.add;qa&&Y.add(function(){e=qa},c[1^C][2].disable,c[2][2].lock);n[I[0]]=function(){return n[I[0]+'With'](this===n?k:this,arguments),this};n[I[0]+'With']=Y.fireWith}),k.promise(n),a&&a.call(n,n),n},when:function(a){var c=0,e=
db.call(arguments),k=e.length,n=1!==k||a&&b.isFunction(a.promise)?k:0,C=1===n?a:b.Deferred(),I=function(ta,Sa,Va){return function(yb){Sa[ta]=this;Va[ta]=1<arguments.length?db.call(arguments):yb;Va===qa?C.notifyWith(Sa,Va):--n||C.resolveWith(Sa,Va)}},Y;if(1<k){var qa=Array(k);var Ca=Array(k);for(Y=Array(k);k>c;c++)e[c]&&b.isFunction(e[c].promise)?e[c].promise().progress(I(c,Ca,qa)).done(I(c,Y,e)).fail(C.reject):--n}return n||C.resolveWith(Y,e),C.promise()}});var Pa;b.fn.ready=function(a){return b.ready.promise().done(a),
...
ca=function(a,c,e,k,n,C,I){var Y=0,qa=a.length,Ca=null==e;if('object'===b.type(e))for(Y in n=!0,e)ca(a,c,Y,e[Y],!0,C,I);else if(void 0!==k&&(n=!0,b.isFunction(k)||(I=!0),Ca&&(I?(c.call(a,k),c=null):(Ca=c,c=function(ta,Sa,Va){return Ca.call(b(ta),Va)})),c))for(;qa>Y;Y++)c(a[Y],e,I?k:k.call(a[Y],Y,c(a[Y],e)));return n?a:Ca?c.call(a):qa?c(a[0],e):C},X=/^(?:checkbox|radio)$/i,ja=/<([\w:-]+)/,va=/^$|\/(?:java|ecma)script/i,Ra=/^\s+/;!function(){var a=Ka.createElement('div'),c=Ka.createDocumentFragment(),
...
var wb=/^(?:input|select|textarea)$/i,lb=/^key/,hb=/^(?:mouse|pointer|contextmenu|drag|drop)|click/,ob=/^(?:focusinfocus|focusoutblur)$/,sb=/^([^.]*)(?:\.(.+)|)/;b.event={global:{},add:function(a,c,e,k,n){var C,I,Y,qa,Ca,ta,Sa,Va;if(I=b._data(a)){e.handler&&(Y=e,e=Y.handler,n=Y.selector);e.guid||(e.guid=b.guid++);(C=I.events)||(C=I.events={});(Ca=I.handle)||(Ca=I.handle=function(Hb){return'undefined'==typeof b||Hb&&b.event.triggered===Hb.type?void 0:b.event.dispatch.apply(Ca.elem,arguments)},Ca.elem=
a);c=(c||'').match(Ga)||[''];for(I=c.length;I--;){var yb=sb.exec(c[I])||[];var bb=Va=yb[1];yb=(yb[2]||'').split('.').sort();bb&&(qa=b.event.special[bb]||{},bb=(n?qa.delegateType:qa.bindType)||bb,qa=b.event.special[bb]||{},ta=b.extend({type:bb,origType:Va,data:k,handler:e,guid:e.guid,selector:n,needsContext:n&&b.expr.match.needsContext.test(n),namespace:yb.join('.')},Y),(Sa=C[bb])||(Sa=C[bb]=[],Sa.delegateCount=0,qa.setup&&!1!==qa.setup.call(a,k,yb,Ca)||(a.addEventListener?a.addEventListener(bb,Ca,
!1):a.attachEvent&&a.attachEvent('on'+bb,Ca))),qa.add&&(qa.add.call(a,ta),ta.handler.guid||(ta.handler.guid=e.guid)),n?Sa.splice(Sa.delegateCount++,0,ta):Sa.push(ta),b.event.global[bb]=!0)}a=null}},remove:function(a,c,e,k,n){var C,I,Y,qa,Ca,ta,Sa,Va,yb=b.hasData(a)&&b._data(a);if(yb&&(Ca=yb.events)){c=(c||'').match(Ga)||[''];for(qa=c.length;qa--;)if(I=sb.exec(c[qa])||[],ta=Va=I[1],Sa=(I[2]||'').split('.').sort(),ta){var bb=b.event.special[ta]||{};ta=(k?bb.delegateType:bb.bindType)||ta;var Hb=Ca[ta]||
[];I=I[2]&&new RegExp('(^|\\.)'+Sa.join('\\.(?:.*\\.|)')+'(\\.|$)');for(Y=C=Hb.length;C--;){var kc=Hb[C];!n&&Va!==kc.origType||e&&e.guid!==kc.guid||I&&!I.test(kc.namespace)||k&&k!==kc.selector&&('**'!==k||!kc.selector)||(Hb.splice(C,1),kc.selector&&Hb.delegateCount--,bb.remove&&bb.remove.call(a,kc))}Y&&!Hb.length&&(bb.teardown&&!1!==bb.teardown.call(a,Sa,yb.handle)||b.removeEvent(a,ta,yb.handle),delete Ca[ta])}else for(ta in Ca)b.event.remove(a,ta+c[qa],e,k,!0);b.isEmptyObject(Ca)&&(delete yb.handle,
b._removeData(a,'events'))}},trigger:function(a,c,e,k){var n,C,I,Y,qa=[e||Ka],Ca=g.call(a,'type')?a.type:a;var ta=g.call(a,'namespace')?a.namespace.split('.'):[];if(I=n=e=e||Ka,3!==e.nodeType&&8!==e.nodeType&&!ob.test(Ca+b.event.triggered)&&(-1<Ca.indexOf('.')&&(ta=Ca.split('.'),Ca=ta.shift(),ta.sort()),C=0>Ca.indexOf(':')&&'on'+Ca,a=a[b.expando]?a:new b.Event(Ca,'object'==typeof a&&a),a.isTrigger=k?2:3,a.namespace=ta.join('.'),a.rnamespace=a.namespace?new RegExp('(^|\\.)'+ta.join('\\.(?:.*\\.|)')+
'(\\.|$)'):null,a.result=void 0,a.target||(a.target=e),c=null==c?[a]:b.makeArray(c,[a]),Y=b.event.special[Ca]||{},k||!Y.trigger||!1!==Y.trigger.apply(e,c))){if(!k&&!Y.noBubble&&!b.isWindow(e)){var Sa=Y.delegateType||Ca;for(ob.test(Sa+Ca)||(I=I.parentNode);I;I=I.parentNode)qa.push(I),n=I;n===(e.ownerDocument||Ka)&&qa.push(n.defaultView||n.parentWindow||B)}for(ta=0;(I=qa[ta++])&&!a.isPropagationStopped();)a.type=1<ta?Sa:Y.bindType||Ca,(n=(b._data(I,'events')||{})[a.type]&&b._data(I,'handle'))&&n.apply(I,
...
n.clientLeft||e&&e.clientLeft||0),a.pageY=c.clientY+(n&&n.scrollTop||e&&e.scrollTop||0)-(n&&n.clientTop||e&&e.clientTop||0)),!a.relatedTarget&&I&&(a.relatedTarget=I===a.target?c.toElement:I),a.which||void 0===C||(a.which=1&C?1:2&C?3:4&C?2:0),a}},special:{load:{noBubble:!0},focus:{trigger:function(){if(this!==z()&&this.focus)try{return this.focus(),!1}catch(a){}},delegateType:'focusin'},blur:{trigger:function(){return this===z()&&this.blur?(this.blur(),!1):void 0},delegateType:'focusout'},click:{trigger:function(){return b.nodeName(this,
...
Dc.firstChild)),!(h.noCloneEvent&&h.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||b.isXMLDoc(a))){var Y=N(n);var qa=N(a);for(C=0;null!=(k=qa[C]);++C)if(Y[C]){var Ca=void 0,ta,Sa=k,Va=Y[C];if(1===Va.nodeType){if(ta=Va.nodeName.toLowerCase(),!h.noCloneEvent&&Va[b.expando]){k=b._data(Va);for(Ca in k.events)b.removeEvent(Va,Ca,k.handle);Va.removeAttribute(b.expando)}'script'===ta&&Va.text!==Sa.text?(v(Va).text=Sa.text,H(Va)):'object'===ta?(Va.parentNode&&(Va.outerHTML=Sa.outerHTML),h.html5Clone&&Sa.innerHTML&&
!b.trim(Va.innerHTML)&&(Va.innerHTML=Sa.innerHTML)):'input'===ta&&X.test(Sa.type)?(Va.defaultChecked=Va.checked=Sa.checked,Va.value!==Sa.value&&(Va.value=Sa.value)):'option'===ta?Va.defaultSelected=Va.selected=Sa.defaultSelected:'input'!==ta&&'textarea'!==ta||(Va.defaultValue=Sa.defaultValue)}}}if(c)if(e)for(qa=qa||N(a),Y=Y||N(n),C=0;null!=(k=qa[C]);C++)J(k,Y[C]);else J(a,n);return Y=N(n,'script'),0<Y.length&&O(Y,!I&&N(a,'script')),n},cleanData:function(a,c){for(var e,k,n,C,I=0,Y=b.expando,qa=b.cache,
Ca=h.attributes,ta=b.event.special;null!=(e=a[I]);I++)if((c||ib(e))&&(n=e[Y],C=n&&qa[n])){if(C.events)for(k in C.events)ta[k]?b.event.remove(e,k):b.removeEvent(e,k,C.handle);qa[n]&&(delete qa[n],Ca||'undefined'==typeof e.removeAttribute?e[Y]=void 0:e.removeAttribute(Y),xb.push(n))}}});b.fn.extend({domManip:T,detach:function(a){return ra(this,a,!0)},remove:function(a){return ra(this,a)},text:function(a){return ca(this,function(c){return void 0===c?b.text(this):this.empty().append((this[0]&&this[0].ownerDocument||
...
e.innerHTML.replace(mb,''):void 0;if(!('string'!=typeof c||Gb.test(c)||!h.htmlSerialize&&Kb.test(c)||!h.leadingWhitespace&&Ra.test(c)||Xa[(ja.exec(c)||['',''])[1].toLowerCase()])){c=b.htmlPrefilter(c);try{for(;n>k;k++)e=this[k]||{},1===e.nodeType&&(b.cleanData(N(e,!1)),e.innerHTML=c);e=0}catch(C){}}e&&this.empty().append(c)},null,a,arguments.length)},replaceWith:function(){var a=[];return T(this,arguments,function(c){var e=this.parentNode;0>b.inArray(this,a)&&(b.cleanData(N(this)),e&&e.replaceChild(c,
...
c,e,k){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var n,C,I,Y=b.camelCase(c),qa=a.style;if(c=b.cssProps[Y]||(b.cssProps[Y]=ha(Y)||Y),I=b.cssHooks[c]||b.cssHooks[Y],void 0===e)return I&&'get'in I&&void 0!==(n=I.get(a,!1,k))?n:qa[c];if(C=typeof e,'string'===C&&(n=Mb.exec(e))&&n[1]&&(e=ma(a,c,n),C='number'),null!=e&&e===e&&('number'===C&&(e+=n&&n[3]||(b.cssNumber[Y]?'':'px')),h.clearCloneStyle||''!==e||0!==c.indexOf('background')||(qa[c]='inherit'),!(I&&'set'in I&&void 0===(e=I.set(a,e,k)))))try{qa[c]=
...
{tweeners:{'*':[function(a,c){var e=this.createTween(a,c);return ma(e.elem,a,Mb.exec(c),e),e}]},tweener:function(a,c){b.isFunction(a)?(c=a,a=['*']):a=a.match(Ga);for(var e,k=0,n=a.length;n>k;k++)e=a[k],Ja.tweeners[e]=Ja.tweeners[e]||[],Ja.tweeners[e].unshift(c)},prefilters:[function(a,c,e){var k,n,C,I,Y,qa,Ca,ta=this,Sa={},Va=a.style,yb=a.nodeType&&cb(a),bb=b._data(a,'fxshow');e.queue||(I=b._queueHooks(a,'fx'),null==I.unqueued&&(I.unqueued=0,Y=I.empty.fire,I.empty.fire=function(){I.unqueued||Y()}),
I.unqueued++,ta.always(function(){ta.always(function(){I.unqueued--;b.queue(a,'fx').length||I.empty.fire()})}));1===a.nodeType&&('height'in c||'width'in c)&&(e.overflow=[Va.overflow,Va.overflowX,Va.overflowY],qa=b.css(a,'display'),Ca='none'===qa?b._data(a,'olddisplay')||W(a.nodeName):qa,'inline'===Ca&&'none'===b.css(a,'float')&&(h.inlineBlockNeedsLayout&&'inline'!==W(a.nodeName)?Va.zoom=1:Va.display='inline-block'));e.overflow&&(Va.overflow='hidden',h.shrinkWrapBlocks()||ta.always(function(){Va.overflow=
e.overflow[0];Va.overflowX=e.overflow[1];Va.overflowY=e.overflow[2]}));for(k in c)if(n=c[k],Ld.exec(n)){if(delete c[k],C=C||'toggle'===n,n===(yb?'hide':'show')){if('show'!==n||!bb||void 0===bb[k])continue;yb=!0}Sa[k]=bb&&bb[k]||b.style(a,k)}else qa=void 0;if(b.isEmptyObject(Sa))'inline'===('none'===qa?W(a.nodeName):qa)&&(Va.display=qa);else for(k in bb?'hidden'in bb&&(yb=bb.hidden):bb=b._data(a,'fxshow',{}),C&&(bb.hidden=!yb),yb?b(a).show():ta.done(function(){b(a).hide()}),ta.done(function(){var Hb;
b._removeData(a,'fxshow');for(Hb in Sa)b.style(a,Hb,Sa[Hb])}),Sa)c=Na(yb?bb[k]:0,k,ta),k in bb||(bb[k]=c.start,yb&&(c.end=c.start,c.start='width'===k||'height'===k?1:0))}],prefilter:function(a,c){c?Ja.prefilters.unshift(a):Ja.prefilters.push(a)}});b.speed=function(a,c,e){var k=a&&'object'==typeof a?b.extend({},a):{complete:e||!e&&c||b.isFunction(a)&&a,duration:a,easing:e&&c||c&&!b.isFunction(c)&&c};return k.duration=b.fx.off?0:'number'==typeof k.duration?k.duration:k.duration in b.fx.speeds?b.fx.speeds[k.duration]:
...
text:'responseText',json:'responseJSON'},converters:{'* text':String,'text html':!0,'text json':b.parseJSON,'text xml':b.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(a,c){return c?gb(gb(a,b.ajaxSettings),c):gb(b.ajaxSettings,a)},ajaxPrefilter:pb(qd),ajaxTransport:pb(Vc),ajax:function(a,c){function e(Bb,Ob,Rb,tb){var jc,fc,Tb,ec=Ob;if(2!==lc){lc=2;I&&B.clearTimeout(I);qa=void 0;C=tb||'';vb.readyState=0<Bb?4:0;tb=200<=Bb&&300>Bb||304===Bb;if(Rb){var Sb=ta;for(var oc=vb,Ab,ac,Wb,Qb,
Hc=Sb.contents,pc=Sb.dataTypes;'*'===pc[0];)pc.shift(),void 0===ac&&(ac=Sb.mimeType||oc.getResponseHeader('Content-Type'));if(ac)for(Qb in Hc)if(Hc[Qb]&&Hc[Qb].test(ac)){pc.unshift(Qb);break}if(pc[0]in Rb)Wb=pc[0];else{for(Qb in Rb){if(!pc[0]||Sb.converters[Qb+' '+pc[0]]){Wb=Qb;break}Ab||=Qb}Wb=Wb||Ab}Sb=Wb?(Wb!==pc[0]&&pc.unshift(Wb),Rb[Wb]):void 0}a:{Rb=ta;Ab=Sb;ac=vb;Wb=tb;var bc,uc,vc;Sb={};oc=Rb.dataTypes.slice();if(oc[1])for(bc in Rb.converters)Sb[bc.toLowerCase()]=Rb.converters[bc];for(Qb=
...
vc+' to '+Qb};break a}}mc={state:'success',data:Ab}}Sb=mc;tb?(ta.ifModified&&(Tb=vb.getResponseHeader('Last-Modified'),Tb&&(b.lastModified[hc]=Tb),Tb=vb.getResponseHeader('etag'),Tb&&(b.etag[hc]=Tb)),204===Bb||'HEAD'===ta.type?ec='nocontent':304===Bb?ec='notmodified':(ec=Sb.state,jc=Sb.data,fc=Sb.error,tb=!fc)):(fc=ec,!Bb&&ec||(ec='error',0>Bb&&(Bb=0)));vb.status=Bb;vb.statusText=(Ob||ec)+'';tb?yb.resolveWith(Sa,[jc,ec,vb]):yb.rejectWith(Sa,[vb,ec,fc]);vb.statusCode(Hb);Hb=void 0;Y&&Va.trigger(tb?
'ajaxSuccess':'ajaxError',[vb,ta,tb?jc:fc]);bb.fireWith(Sa,[vb,ec]);Y&&(Va.trigger('ajaxComplete',[vb,ta]),--b.active||b.event.trigger('ajaxStop'))}}'object'==typeof a&&(c=a,a=void 0);c=c||{};var k,n,C,I,Y,qa,Ca,ta=b.ajaxSetup({},c),Sa=ta.context||ta,Va=ta.context&&(Sa.nodeType||Sa.jquery)?b(Sa):b.event,yb=b.Deferred(),bb=b.Callbacks('once memory'),Hb=ta.statusCode||{},kc={},Gc={},lc=0,wc='canceled',vb={readyState:0,getResponseHeader:function(Bb){var Ob;if(2===lc){if(!Ca)for(Ca={};Ob=Vd.exec(C);)Ca[Ob[1].toLowerCase()]=
Ob[2];Ob=Ca[Bb.toLowerCase()]}return null==Ob?null:Ob},getAllResponseHeaders:function(){return 2===lc?C:null},setRequestHeader:function(Bb,Ob){var Rb=Bb.toLowerCase();return lc||(Bb=Gc[Rb]=Gc[Rb]||Bb,kc[Bb]=Ob),this},overrideMimeType:function(Bb){return lc||(ta.mimeType=Bb),this},statusCode:function(Bb){var Ob;if(Bb)if(2>lc)for(Ob in Bb)Hb[Ob]=[Hb[Ob],Bb[Ob]];else vb.always(Bb[vb.status]);return this},abort:function(Bb){Bb=Bb||wc;return qa&&qa.abort(Bb),e(0,Bb),this}};if(yb.promise(vb).complete=bb.add,
vb.success=vb.done,vb.error=vb.fail,ta.url=((a||ta.url||fd)+'').replace(Ud,'').replace(Xd,Jc[1]+'//'),ta.type=c.method||c.type||ta.method||ta.type,ta.dataTypes=b.trim(ta.dataType||'*').toLowerCase().match(Ga)||[''],null==ta.crossDomain&&(k=pd.exec(ta.url.toLowerCase()),ta.crossDomain=!(!k||k[1]===Jc[1]&&k[2]===Jc[2]&&(k[3]||('http:'===k[1]?'80':'443'))===(Jc[3]||('http:'===Jc[1]?'80':'443')))),ta.data&&ta.processData&&'string'!=typeof ta.data&&(ta.data=b.param(ta.data,ta.traditional)),ab(qd,ta,c,
vb),2===lc)return vb;(Y=b.event&&ta.global)&&0===b.active++&&b.event.trigger('ajaxStart');ta.type=ta.type.toUpperCase();ta.hasContent=!Wd.test(ta.type);var hc=ta.url;ta.hasContent||(ta.data&&(hc=ta.url+=(ed.test(hc)?'&':'?')+ta.data,delete ta.data),!1===ta.cache&&(ta.url=od.test(hc)?hc.replace(od,'$1_='+dd++):hc+(ed.test(hc)?'&':'?')+'_='+dd++));ta.ifModified&&(b.lastModified[hc]&&vb.setRequestHeader('If-Modified-Since',b.lastModified[hc]),b.etag[hc]&&vb.setRequestHeader('If-None-Match',b.etag[hc]));
(ta.data&&ta.hasContent&&!1!==ta.contentType||c.contentType)&&vb.setRequestHeader('Content-Type',ta.contentType);vb.setRequestHeader('Accept',ta.dataTypes[0]&&ta.accepts[ta.dataTypes[0]]?ta.accepts[ta.dataTypes[0]]+('*'!==ta.dataTypes[0]?', '+rd+'; q=0.01':''):ta.accepts['*']);for(n in ta.headers)vb.setRequestHeader(n,ta.headers[n]);if(ta.beforeSend&&(!1===ta.beforeSend.call(Sa,vb,ta)||2===lc))return vb.abort();wc='abort';for(n in{success:1,error:1,complete:1})vb[n](ta[n]);if(qa=ab(Vc,ta,c,vb)){if(vb.readyState=
1,Y&&Va.trigger('ajaxSend',[vb,ta]),2===lc)return vb;ta.async&&0<ta.timeout&&(I=B.setTimeout(function(){vb.abort('timeout')},ta.timeout));try{lc=1,qa.send(kc,e)}catch(Bb){if(!(2>lc))throw Bb;e(-1,Bb)}}else e(-1,'No Transport');return vb},getJSON:function(a,c,e){return b.get(a,c,e,'json')},getScript:function(a,c){return b.get(a,void 0,c,'script')}});b.each(['get','post'],function(a,c){b[c]=function(e,k,n,C){return b.isFunction(k)&&(C=C||n,n=k,k=void 0),b.ajax(b.extend({url:e,type:c,dataType:C,data:k,
...
{};var ta=C.status;'string'==typeof C.responseText&&(Ca.text=C.responseText);try{var Sa=C.statusText}catch(Va){Sa=''}ta||!a.isLocal||a.crossDomain?1223===ta&&(ta=204):ta=Ca.text?200:404}Ca&&k(ta,Sa,Ca,C.getAllResponseHeaders())};a.async?4===C.readyState?B.setTimeout(c):C.onreadystatechange=Tc[I]=c:c()},abort:function(){c&&c(void 0,!0)}}}});b.ajaxSetup({accepts:{script:'text/javascript, application/javascript, application/ecmascript, application/x-ecmascript'},contents:{script:/\b(?:java|ecma)script\b/},
...
a,content:c,'':'outer'+a},function(e,k){b.fn[k]=function(n,C){var I=arguments.length&&(e||'boolean'!=typeof n),Y=e||(!0===n||!0===C?'margin':'border');return ca(this,function(qa,Ca,ta){var Sa;return b.isWindow(qa)?qa.document.documentElement['client'+a]:9===qa.nodeType?(Sa=qa.documentElement,Math.max(qa.body['scroll'+a],Sa['scroll'+a],qa.body['offset'+a],Sa['offset'+a],Sa['client'+a])):void 0===ta?b.css(qa,Ca,Y):b.style(qa,Ca,ta,Y)},c,I?n:void 0,I,null)}})});b.fn.extend({bind:function(a,c,e){return this.on(a,
...
else if('undefined'!=typeof Da&&'object'!==typeof Da&&H&&'undefined'!=typeof H[ua]){var Ea=0;var Na=H[ua].count();for(var Ia in H[ua])La[Ia][H[ua][Ia]].re=La[Ia][H[ua][Ia]].re.replace(/%s/,la),v=La[Ia][H[ua][Ia]].modifiers?new RegExp(La[Ia][H[ua][Ia]].re,La[Ia][H[ua][Ia]].modifiers):new RegExp(La[Ia][H[ua][Ia]].re),v.test(Da)&&++Ea;Ea==Na&&++Qa}return{matched:Qa}},W=function(la,ua,Da,Qa){var La=ua.split(/\./g);La=La[La.length-1];v=new RegExp('("'+La+'":\\w+)');La=null;try{Da&&(La=eval('_content.'+
...
ka=function(la,ua,Da,Qa,La){ua=ua.split(/\[\*\]/g);La=ua[0].replace(/\[\*\]/,'');Da=Da[La];ua=ua[1];/^\./.test(ua)&&(ua=ua.substr(1));La=0;if(Da)for(var Ea=0,Na=Da.length;Ea<Na&&!(ra=/\./.test(ua)?W(la,ua,Da[Ea],La):Fa(la,ua,Da[Ea],La,J),La=ra.matched,0<La);++Ea);return{matched:Qa+La}},ha;for(ha in z)if(z[ha]||(z[ha]={}),!/undefined|function/.test(typeof z[ha]))for(let la=0,ua=D.count();la<ua;++la){A=D[la];l=A.count();T=0;for(var xa in A){if('undefined'==typeof A[xa])throw Error('filter `'+xa+'` cannot be left undefined');
u=null===A[xa]||/(boolean|number)/.test(typeof A[xa])?A[xa]:A[xa].toLocaleLowerCase();ra=/\./.test(xa)?/\[\*\]/.test(xa)?ka(A[xa],xa,z[ha],T,0):W(A[xa],xa,z[ha],T):Fa(A[xa],xa,z[ha][xa],T,J);T=ra.matched}if(T==l)if(ba&&Q&&0>w.indexOf(z[ha]._uuid)||Q||!ba){if(!ba||ba&&0>F.indexOf(z[ha]._uuid)||Q)F[y]=z[ha],++y}else ba&&!Q&&0>F.indexOf(z[ha]._uuid)&&(F[y]=z[ha],++y)}}else F=B;S=null;F.insert=N.insert;F.notIn=N.notIn;F.find=this.find;F.update=N.update;F.replace=N.replace;F.or=N.or;F.findOne=N.findOne;
F.limit=N.limit;F.orderBy=N.orderBy;F.delete=N.delete;F.toRaw=N.toRaw;F.filter=N.filter;return F};N.findOne=function(){var A=null;'string'==typeof arguments[arguments.length-1]&&(delete arguments[arguments.length-1],--arguments.length);0<arguments.length&&(A=arguments);if('undefined'==typeof A||!A||'object'!=typeof A)throw Error('[ Collection ][ findOne ] `filters` argument must be defined: Array or Filter Object(s) expected');A=null;var D=Array.isArray(arguments[0])?arguments[0]:N.find.apply(this,
arguments)||[];0<D.length&&(A=D.limit(1).toRaw()[0]);return A};N.or=function(){arguments[arguments.length]=!0;++arguments.length;return N.find.apply(this,arguments)};N.limit=function(A){if('undefined'==typeof A||'number'!=typeof A)throw Error('[Collection::result->limit(resultLimit)] : `resultLimit` parametter must by a `number`');var D=Array.isArray(this)?this:JSON.clone(B);D=D.splice(0,A);D.insert=N.insert;D.update=N.update;D.replace=N.replace;D.notIn=N.notIn;D.findOne=N.findOne;D.orderBy=N.orderBy;
D.max=N.max;D.delete=N.delete;D.toRaw=N.toRaw;D.filter=N.filter;return D};N.notIn=function(){var A=null,D=null,l=!0;'string'==typeof arguments[arguments.length-1]&&(A=arguments[arguments.length-1],delete arguments[arguments.length-1],--arguments.length);'boolean'==typeof arguments[arguments.length-1]&&(l=arguments[arguments.length-1],delete arguments[arguments.length-1],--arguments.length);0<arguments.length&&(D=arguments);if('undefined'==typeof D||!D||'object'!=typeof D)throw Error('[ Collection ][ notIn ] `filters` argument must be defined: Array or Filter Object(s) expected');
var y=JSON.clone(Array.isArray(this)?this:B);if(Array.isArray(arguments[0]))var z=arguments[0];else Q=!0,z=N.find.apply(this,arguments)||[],Q=!1;if(0<z.length){if(l&&A&&'undefined'==typeof z[0]&&'undefined'==typeof z[0][A])throw Error('[ Collection ][ notIn ] `key` not valid');l&&!A&&'undefined'!=typeof z[0]._uuid?A='_uuid':'undefined'!=typeof z[0].id&&(A='id');if(!A||'undefined'==typeof z[0][A])throw Error('No comparison key defined !');var F=0,u=z.length,v=0,H,J=D.count(),T;if(l&&'undefined'!=typeof y[v]&&
y[v].hasOwnProperty(A))for(;F<u&&y.length;++F)for(v=0,l=y.length;v<l;++v){if('undefined'!=typeof y[v]&&'undefined'!=typeof z[F]&&y[v][A]===z[F][A]){y.splice(v,1);break}}else if('undefined'==typeof y[v])y=JSON.clone(z);else for(;F<u&&y.length;++F)for(v=0,l=y.length;v<l;++v)if('undefined'!=typeof y[v]){for(H=T=0;H<J;++H){if('undefined'==typeof D[H])throw Error('filter `'+H+'` cannot be left undefined');var ra=D[H].count();var Fa=0;for(A in D[H])y[v].hasOwnProperty(A)&&y[v][A]===z[F][A]&&++Fa;Fa==ra&&
++T}if(T){y.splice(v,1);break}}}A=y;A.notIn=N.notIn;A.limit=N.limit;A.find=N.find;A.findOne=N.findOne;A.insert=N.insert;A.replace=N.replace;A.update=N.update;A.orderBy=N.orderBy;A.max=N.max;A.delete=N.delete;A.toRaw=N.toRaw;A.filter=N.filter;return A};N.insert=function(A){if('object'!==typeof A)throw Error('filter must be an object');var D=Array.isArray(this)?this:B;A._uuid=na.v4();D.push(A);D.limit=N.limit;D.find=N.find;D.findOne=N.findOne;D.update=N.update;D.replace=N.replace;D.orderBy=N.orderBy;
D.max=N.max;D.notIn=N.notIn;D.delete=N.delete;D.toRaw=N.toRaw;D.filter=N.filter;return D};N.update=function(){var A='_uuid',D,l=D=null;'string'==typeof arguments[arguments.length-1]&&(A=arguments[arguments.length-1],delete arguments[arguments.length-1],--arguments.length);'object'==typeof arguments[arguments.length-1]&&(l=arguments[arguments.length-1],delete arguments[arguments.length-1],--arguments.length);0<arguments.length&&(D=arguments);if('undefined'==typeof D||!D||'object'!=typeof D)throw Error('[ Collection ][ update ] `filters` argument must be defined: Array or Filter Object(s) expected');
if('undefined'==typeof l||!l||'object'!=typeof l)throw Error('[ Collection ][ update ] `set` argument must be defined: Object expected');var y=Array.isArray(arguments[0])?arguments[0]:N.find.apply(this,arguments)||[];D=Array.isArray(this)?this:JSON.clone(B);if(0<y.length){y=y.toRaw();for(var z=0,F=y.length;z<F;++z){y[z]=U(JSON.clone(l),y[z]);for(var u=0,v=D.length;u<v;++u)if('undefined'==typeof D[u][A]&&'_uuid'==A&&'undefined'!=typeof D[u].id&&(A='id'),D[u][A]==y[z][A]){D[u]=y[z];break}}}D.limit=
N.limit;D.find=N.find;D.findOne=N.findOne;D.insert=N.insert;D.update=N.update;D.replace=N.replace;D.orderBy=N.orderBy;D.max=N.max;D.notIn=N.notIn;D.delete=N.delete;D.toRaw=N.toRaw;D.filter=N.filter;return D};N.replace=function(){var A='_uuid',D,l=D=null;'string'==typeof arguments[arguments.length-1]&&(A=arguments[arguments.length-1],delete arguments[arguments.length-1],--arguments.length);'object'==typeof arguments[arguments.length-1]&&(l=arguments[arguments.length-1],delete arguments[arguments.length-
...
for(var z=0,F=y.length;z<F;++z){y[z]=JSON.clone(l);for(var u=0,v=D.length;u<v;++u){if('undefined'==typeof D[u][A]&&'_uuid'==A&&'undefined'!=typeof D[u].id)A='id';else if('undefined'==typeof D[u][A]&&'_uuid'==A)throw Error('No comparison key defined !');if(D[u][A]==y[z][A]){D[u]=y[z];break}}}}D.limit=N.limit;D.find=N.find;D.findOne=N.findOne;D.insert=N.insert;D.update=N.update;D.replace=N.replace;D.orderBy=N.orderBy;D.max=N.max;D.notIn=N.notIn;D.delete=N.delete;D.toRaw=N.toRaw;D.filter=N.filter;return D};
N['delete']=function(){var A=N.notIn.apply(this,arguments);A.limit=N.limit;A.find=N.find;A.findOne=N.findOne;A.insert=N.insert;A.update=N.update;A.replace=N.replace;A.orderBy=N.orderBy;A.max=N.max;A.notIn=N.notIn;A.toRaw=N.toRaw;A.filter=N.filter;A.delete=this.delete;return A};N.orderBy=function(){if('undefined'==typeof arguments||1>arguments.length)throw Error('[ Collection->orderBy(filter) ] where `filter` must not be empty or null');if(1==arguments.length)var A=arguments[0];else{A=Array(arguments.length);
for(var D=0,l=A.length;D<l;++D)A[D]=arguments[D]}D=Array.isArray(this)?this:JSON.clone(B);return O(A,D.toRaw())};N.max=function(){if('undefined'==typeof arguments||1>arguments.length)throw Error('[ Collection->max(filter) ] where `filter` must not be empty or null');if(1<arguments.length||Array.isArray(arguments[0])||'object'==typeof arguments[0]&&1<arguments[0].count())throw Error('[ Collection->max(filter) ] only accept one filter length, and fileter count must be equal to 1');var A=arguments[0];
try{var D=Object.keys(A)[0],l={};l[D]='desc';return N.find(A).orderBy(l).limit(1)[0][D]}catch(y){throw y;}};var O=function(A,D){if('object'!=typeof A)throw Error('`filter` parametter must be an object or an array');var l={},y=null,z=null,F=y=null;y=[];if(0==A.count())return null;l.asc=function(u,v){var H=v.map(function(J,T){var ra={};ra.index=T;ra[u]=J[u];return ra});H.sort(function(J,T){var ra=function(Fa,W){/^(true|false)$/i.test(Fa)&&(Fa=/true/i.test(Fa)?1:0);/^(true|false)$/i.test(W)&&(W=/true/i.test(W)?
1:0);return'string'==typeof Fa&&''!=Fa||'string'==typeof W?('number'==typeof Fa&&(Fa=''+Fa),'number'==typeof W&&(W=''+W),Fa.localeCompare(W,void 0,{sensitivity:'case',caseFirst:'upper'})):Fa>W?1:Fa<W?-1:0};return'object'==typeof J?ra(J[u],T[u]):ra(J,T)});return H.map(function(J,T,ra){return v[J.index]})};l.desc=function(u,v){return l.asc(u,v).reverse()};y=function(u,v){var H=[],J=[];if(Array.isArray(v))for(var T=0,ra=v.length;T<ra;++T)H[T]=Object.keys(v[T])[0],J[T]=v[T][H[T]];else for(ra in T=0,v)H[T]=
ra,J[T]=v[ra],++T;z=function(Fa,W,ka,ha,xa){var la='desc'==ha[xa]?1:0,ua,Da=ua=null;return'string'==typeof Fa[ka[xa]]&&''!=Fa[ka[xa]]?(ua=Fa[ka[xa]].localeCompare(W[ka[xa]]),0==la&&0!=ua?0>ua?-1:1:0!=ua?0>ua?1:-1:ka.length-1>xa?z(Fa,W,ka,ha,xa+1):0):'number'==typeof Fa[ka[xa]]||'number'==typeof W[ka[xa]]?(ua=(''+Fa[ka[xa]]).localeCompare(''+W[ka[xa]],void 0,{numeric:!0}),0==la&&0!=ua?0>ua?-1:1:0!=ua?0>ua?1:-1:ka.length-1>xa?z(Fa,W,ka,ha,xa+1):0):'boolean'==typeof Fa[ka[xa]]||'boolean'==typeof W[ka[xa]]?
('boolean'==typeof Fa[ka[xa]]&&(ua=Fa[ka[xa]]?1:0),'boolean'==typeof W[ka[xa]]&&(Da=W[ka[xa]]?1:0),ua>Da?0==la?1:-1:ua<Da?0==la?-1:1:ka.length-1>xa?z(Fa,W,ka,ha,xa+1):0):Fa[ka[xa]]>W[ka[xa]]?0==la?1:-1:Fa[ka[xa]]<W[ka[xa]]?0==la?-1:1:ka.length-1>xa?z(Fa,W,ka,ha,xa+1):0};return u.sort(function(Fa,W){return z(Fa,W,H,J,0)})};Array.isArray(A)||1<A.count()?y=y(D,A):(F=Object.keys(A)[0],y=A[F],y=l[y](F,D));y.find=N.find;y.findOne=N.findOne;y.limit=N.limit;y.notIn=N.notIn;y.insert=N.insert;y.update=N.update;
y.replace=N.replace;y.delete=N.delete;y.orderBy=N.orderBy;y.max=N.max;y.toRaw=N.toRaw;y.filter=N.filter;return y};N.toRaw=function(){for(var A=Array.isArray(this)?this.slice():B.slice(),D=0,l=A.length;D<l;++D)A[D]._uuid&&delete A[D]._uuid;return A};N.filter=function(A){if('undefined'==typeof A)throw Error('`filter` parametter must be a string or an array.');var D=Array.isArray(this)?this:B;if(!D.length)return[];var l=0,y=D.length,z=[],F=0;if(Array.isArray(A))for(var u,v=A.length,H;l<y;++l){H=!1;for(u=
0;u<v;++u)'undefined'!=typeof D[l][A[u]]&&('undefined'==typeof z[F]&&(z[F]={}),z[F][A[u]]=D[l][A[u]],H=!0);H&&++F}else for(;l<y;++l)'undefined'!=typeof D[l][A]&&('undefined'==typeof z[F]&&(z[F]={}),z[F][A]=D[l][A],++F);return JSON.clone(z)};return N}'undefined'!==typeof module&&module.exports?module.exports=Collection:'function'===typeof define&&define.amd&&define('lib/collection',[],function(){return Collection});
function FormValidatorUtil(B,P,V,na){var U='undefined'!==typeof module&&module.exports?!1:!0,M=U?require('lib/merge'):require('../../../../../lib/merge');U||require('../../../../../helpers');U&&require('helpers/dateFormat');var ba=U?require('lib/routing'):require('../../../../../lib/routing'),Q=function(){var l=!1,y=null;U?U&&'undefined'!=typeof gina.forms&&(y=gina.forms):y=getContext('gina').forms||null;y&&'undefined'!=typeof y.validators&&(l=!0);return l},S={errors:{},keys:{'%l':'label','%n':'name',
...
query:'Must be a valid response',isApiError:'Condition not satisfied'}},r=null;if(B)r=M(JSON.clone(B),r),S.data=M(JSON.clone(B),S.data);else throw Error('missing data param');var G=function(l,y){var z=null;for(let F in na)if(na[F].name===y){z=(new DOMParser).parseFromString(l.innerHTML,'text/html').getElementById(na[F].id);break}if(z)return z;throw Error('Field `'+y+'` not found in fieldsSet');},w=function(l){var y;var z='';var F=l.length;for(y=0;y<F;){var u=l[y++];switch(u>>4){case 0:case 1:case 2:case 3:case 4:case 5:case 6:case 7:z+=
String.fromCharCode(u);break;case 12:case 13:var v=l[y++];z+=String.fromCharCode((u&31)<<6|v&63);break;case 14:v=l[y++];var H=l[y++];z+=String.fromCharCode((u&15)<<12|(v&63)<<6|(H&63)<<0)}}return z},ma=function(l,y){y=l.match(/\{\{([^{{}}]+)\}\}/g);for(let z=0,F=y.length;z<F;z++){let u=y[z].replace(/\[/g,'["').replace(/\]/g,'"]').replace(/\{|\}/g,'').trim();try{u=eval('data.'+u).replace(/^"|"$/g,''),l=l.replace(new RegExp(y[z].replace(/\{|\[|\]|\}/g,'\\$&'),'g'),u)}catch(v){}}return l},Aa=function(l,
...
u!==this.value)this.target.dataset.ginaFormValidatorTestedValue=this.value,H&&'undefined'!=typeof H[this.name]&&'undefined'!=typeof H[this.name].query&&(delete H[this.name].query,'undefined'!=typeof gina.validator.$forms[v]&&'undefined'!=typeof gina.validator.$forms[v].errors&&delete gina.validator.$forms[v].errors.query);else if(u===this.value){var J=!1;H&&'undefined'!=typeof H[this.name]&&'undefined'!=typeof H[this.name].query&&'undefined'!=typeof H[this.name].query[this.value]&&(this.error=y=H[this.name].query[this.value].slice(0),
J=!0);z.query=D(this.error||y||S.errorLabels.query,this);console.debug('[2] potential cached error detected !! ',J,H,' vs ',z.query);J&&(this.errors=z,this.valid=!1);'undefined'!=typeof gina.events[F]&&triggerEvent(gina,this.target,F,r[this.name]);return r[this.name]}var T=null,ra=this;if(window.XMLHttpRequest)T=new XMLHttpRequest;else if(window.ActiveXObject)try{T=new ActiveXObject('Msxml2.XMLHTTP')}catch(xa){try{T=new ActiveXObject('Microsoft.XMLHTTP')}catch(la){}}y={isSynchrone:!1,headers:{}};
u=l.data||null;z=null;F=/^true$/i.test(this.target.form.dataset.ginaFormLiveCheckEnabled)?!0:!1;z=JSON.stringify(u);if(/\$/.test(z)){u=z.match(/\$[-_\[\]a-z 0-9]+/g)||[];v=H=null;for(let xa=0,la=u.length;xa<la;xa++)v=u[xa].replace(/\$/g,''),re=new RegExp('\\'+u[xa].replace(/\[|\]/g,'\\$&'),'g'),H=S.data[v]||null,!H&&F&&(H=G(this.target.form,v).value),z=z.replace(re,H)}u=z.replace(/\\"/g,'');var Fa='undefined'==typeof l.validIf?!0:l.validIf;y=M(y,l,V);delete y.data;delete y.validIf;z=y.headers['Content-Type'];
var W=null;F=this.target.getAttribute('id');if(!/^http/.test(y.url)&&/@/.test(y.url))try{J=ba.getRoute(y.url),y.url=J.toUrl()}catch(xa){throw xa;}if(y.withCredentials){if('withCredentials'in T)y.isSynchrone?T.open(y.method,y.url,y.isSynchrone):T.open(y.method,y.url);else if('undefined'!=typeof XDomainRequest)T=new XDomainRequest,T.open(y.method,y.url);else throw T=null,W='CORS not supported: the server is missing the header `"Access-Control-Allow-Credentials": true` ',Error(W);T.responseType='undefined'!=
typeof y.responseType?y.responseType:'';T.withCredentials=!0}else y.isSynchrone?T.open(y.method,y.url,y.isSynchrone):T.open(y.method,y.url);for(var ka in y.headers)'Content-Type'==ka&&'undefined'!=typeof z&&null!=z&&''!=z||T.setRequestHeader(ka,y.headers[ka]);'undefined'!=typeof z&&null!=z&&''!=z&&T.setRequestHeader('Content-Type',z);var ha=function(xa){ra.value=S.data[ra.name]=ra.value?ra.value.toLowerCase():ra.value;var la=xa.isValid||!1;la=Fa!=la?!1:!0;r[ra.name].valid=la;var ua=r[ra.name].errors||
{},Da='undefined'!=typeof xa.error&&'undefined'!=typeof xa.fields?xa.fields:{};if(0<Da.count()&&!la||!la){if(!la){var Qa=null;'undefined'!=typeof Da[ra.name]?S.errorLabels.query=ma(Da[ra.name],l.data):'undefined'!=typeof xa.error&&/^5/.test(xa.status)&&(Qa=xa.error);Da='undefined'!=typeof l.error?l.error:null;ua.query=D(Qa||ra.error||Da||S.errorLabels.query,ra);console.debug('[1] query error detected !! ',xa)}ua.query||''!=ra.value||(la=!0)}la&&'undefined'!=typeof ua.query&&delete ua.query;ra.valid=
la;xa=gina.validator.$forms[ra.target.form.getAttribute('id')].cachedErrors||{};0<ua.count()?(ra.errors=ua,'undefined'==typeof r[ra.name].errors&&(r[ra.name].errors={}),r[ra.name].errors=M(r[ra.name].errors,ua),'undefined'!=typeof ua.query&&ua.query&&('undefined'==typeof xa[ra.name]&&(xa[ra.name]={}),'undefined'==typeof xa[ra.name].query&&(xa[ra.name].query={}),xa[ra.name].query[ra.value]=ua.query.slice(0)),ua=ra.target.getAttribute('data-gina-form-errors'),/query/.test(ua)||ra.target.setAttribute('data-gina-form-errors',
ua&&''!=ua?ua+' query':'query')):'undefined'!=typeof xa[ra.name]&&'undefined'!=typeof xa[ra.name].query&&'undefined'!=typeof xa[ra.name].query[ra.value]&&delete xa[ra.name].query[ra.value];ua=ra.target.id||ra.target.getAttribute('id');console.debug('prematurely completed event `asyncCompleted.'+ua+'`');return triggerEvent(gina,ra.target,'asyncCompleted.'+ua,r[ra.name])};T&&(T.onerror=function(xa,la){console.debug('query error [2] detected !! ',la,'Transaction error: might be due to the server CORS settings.\nPlease, check the console for more details.');
isOnException=!0;xa=this.getResponseHeader('Content-Type');if(/\/json/.test(xa))xa=JSON.parse(this.responseText),'undefined'==typeof xa.status&&(xa.status=this.status);else if(xa={status:T.status,message:''},/^(\{|\[)/.test(T.responseText))try{xa=M(xa,JSON.parse(T.responseText))}catch(ua){xa=M(xa,ua)}return ha(xa)},T.onload=function(){try{W=this.responseText;var xa=this.getResponseHeader('Content-Type');if(/\/json/.test(xa))W=JSON.parse(this.responseText),'undefined'==typeof W.status&&(W.status=this.status);
else if(W={status:T.status,message:''},/^(\{|\[)/.test(T.responseText))try{W=M(W,JSON.parse(T.responseText))}catch(la){W=M(W,la)}return ha(W)}catch(la){throw la;}},B?T.send(u):T.send())}else console.debug('stopping on errors ...'),triggerEvent(gina,this.target,'asyncCompleted.'+F,r[this.name])},N=async function(l,y,z,F){var u=(new (require(_(GINA_FRAMEWORK_DIR+'/core/config.js',!0)))).getInstance(),v=null,H=null,J=null,T=getContext('bundle');if(/@/.test(l.url)){var ra=l.url.split(/@/);H=ra[0];J=ra[1];
getConfig(T,'app');try{u.bundle!==J&&(v=getConfig(T,'app').proxy[J])}catch(ha){throw Error('Could not retrieve `proxy` configuration for bundle `'+J+'`. Please check your `/config/app.json`.\n'+ha.stack);}ra=null}else throw Error('external url/domain not  handled at this moment, please contact us if you need support for it.');ra=JSON.clone(ba.getRoute(l.url,l.data));var Fa=u[J][u.env];v||(u.bundle==J&&(v=getConfig(T,'settings').server.credentials,l.ca=v.ca||null,l.hostname=Fa.server.scheme+'://'+
Fa.host,l.port=Fa.port[Fa.server.protocol][Fa.server.scheme],l.protocol=Fa.server.protocol,l.rejectUnauthorized=!1),v={ca:l.ca,hostname:l.hostname,port:l.port,path:l.path},'undefined'!=typeof l.protocol&&(v.protocol=l.protocol),'undefined'!=typeof l.rejectUnauthorized&&(v.rejectUnauthorized=l.rejectUnauthorized));H={method:ra.method,requirements:ra.requirements,namespace:ra.namespace||void 0,url:decodeURI(ra.url),rule:H+'@'+J,param:JSON.clone(ra.param),middleware:JSON.clone(ra.middleware),bundle:ra.bundle,
isXMLRequest:y.isXMLRequest,isWithCredentials:y.isWithCredentials};J=H.rule.replace('@'+J,'')||'_common';J={template:'undefined'!=typeof Fa.content.templates?Fa.content.templates[J]||Fa.content.templates._common:void 0,cacheless:Fa.cacheless};J=M(J,H);Fa=JSON.clone(Fa);J.conf=Fa;J.conf.content.routing[J.rule].param=H.param;J.template&&'undefined'==typeof J.template.ginaLoader&&(J.template.ginaLoader=J.conf.content.templates._common.ginaLoader);J.conf.content.routing[J.rule].param=H.param;delete J.middleware;
delete J.param;delete J.requirements;Fa=new (require(_(GINA_FRAMEWORK_DIR+'/core/controller/controller.js'),!0))(J);Fa.name=ra.param.control;Fa.setOptions(y,z,F,J);y='object'==typeof l.data&&0<l.data.count()?l.data:{};if(/^get|delete|put$/i.test(l.method)){z=0;for(let ha in y)'object'==typeof y[ha]&&encodeRFC5987ValueChars(JSON.stringify(y[ha])),z++}v.method=l.method;v.path=ra.url;l=require('util').promisify;var W={isValid:!1},ka=!1;await l(Fa.query)(v,y).then(function(ha){W=ha}).catch(function(ha){ka=
ha});ka&&(console.error(ka),W.error=ka);return W},O=null;O=U?Aa:N;var A=function(l,y){var z=null,F=null;'undefined'==typeof r[l]&&'undefined'!=typeof y&&(r[l]=z=y);if('object'==typeof r[l])try{z=JSON.parse(JSON.stringify(r[l]))}catch(u){z=r[l]}else z=r[l];F='';U&&'undefined'!=typeof P&&(F=P[l].getAttribute('data-gina-form-field-label')||'');r[l]={target:U&&'undefined'!=typeof P?P[l]:null,name:l,value:z,valid:!1,label:F,exclude:!1};r[l].is=function(u,v,H){var J=!1,T='undefined'!=typeof window&&'undefined'!=
typeof window._currentValidatorAlias?window._currentValidatorAlias:'is';'undefined'!=typeof window&&window._currentValidatorAlias&&delete window._currentValidatorAlias;var ra=r[this.name].errors||{};S.data[this.name]=r[this.name].value;'undefined'==typeof ra.isRequired&&''==this.value&&!/^false$/i.test(this.value)&&0!=this.value||!ra.isRequired&&''==this.value&&!/^false$/i.test(this.value)&&0!=this.value?J=!0:ra.isRequired||'string'!=typeof this.value||''!=this.value||(J=!0);if(!J&&/^(true|false)$/i.test(u))J=
...
!1}(u=null!==u?!0:!1)?u&&'undefined'!=typeof v.isBoolean&&delete v.isBoolean:v.isBoolean=D(this.error||S.errorLabels.isBoolean,this);this.valid=u;0<v.count()&&(this.errors=v);return r[this.name]};r[l].isNumber=function(u,v){var H=this.value,J=!1,T=!0,ra=!0,Fa=r[this.name].errors||{};try{'string'==typeof H&&/,|\./g.test(H)?H=S.data[this.name]=this.value=parseFloat(H.replace(/,/g,'.').replace(/\s+/g,'')):'string'==typeof H&&''!=H&&(H=S.data[this.name]=this.value=parseInt(H.replace(/\s+/g,'')))}catch(ka){Fa.isNumber=
D(this.error||S.errorLabels.isNumber,this),this.valid=!1,0<Fa.count()&&(this.errors=Fa)}if(+H===+H&&(J=!0,!Fa.isRequired&&''!=H)){var W=H.toString().length;u&&'number'==typeof u&&W<u&&(T=!1,this.size=u);v&&'number'==typeof v&&W>v&&(ra=!1,this.size=v)}J&&T&&ra||(J||(Fa.isNumber=D(this.error||S.errorLabels.isNumber,this)),T&&ra||(T||(Fa.isNumberLength=D(this.error||S.errorLabels.isNumberMinLength,this)),ra||(Fa.isNumberLength=D(this.error||S.errorLabels.isNumberMaxLength,this)),u===v&&(Fa.isNumberLength=
D(this.error||S.errorLabels.isNumberLength,this))),J=!1);J&&'undefined'!=typeof Fa.isNumberLength&&delete Fa.isNumberLength;this.valid=J;this.value=S.data[this.name]=''!=H?Number(H):H;0<Fa.count()&&(this.errors=Fa);return r[this.name]};r[l].toInteger=function(){var u=this.value,v=r[this.name].errors||{};if(u)try{this.value=S.data[this.name]=Math.round(u)}catch(H){v.toInteger=D(this.error||S.errorLabels.toInteger,this),this.valid=!1,0<v.count()&&(this.errors=v)}return r[this.name]};r[l].isInteger=
function(u,v){var H=this.value,J=!1,T=!0,ra=!0,Fa=r[this.name].errors||{};+H===+H&&0===H%1&&(J=!0,Fa.isRequired||''==H||(u&&'number'==typeof u&&H.length<u&&(T=!1,this.size=u),v&&'number'==typeof v&&H.length>v&&(ra=!1,this.size=v)));J&&T&&ra||(J||(Fa.isInteger=D(this.error||S.errorLabels.isInteger,this)),T&&ra||(T||(Fa.isIntegerLength=D(this.error||S.errorLabels.isIntegerMinLength,this),J=!1),ra||(Fa.isIntegerLength=D(this.error||S.errorLabels.isIntegerMaxLength,this),J=!1),u===v&&(Fa.isIntegerLength=
D(this.error||S.errorLabels.isIntegerLength,this),J=!1)));this.valid=J;this.value=S.data[this.name]=Number(H);0<Fa.count()&&(this.errors=Fa);return r[this.name]};r[l].toFloat=function(u){'string'==typeof this.value&&(this.value=this.value.replace(/\s+/g,''),/,/.test(this.value)&&!/\./.test(this.value)?this.value=this.value.replace(/,/g,'.'):this.value=this.value.replace(/,/g,''));var v=S.data[this.name]=this.value,H=r[this.name].errors||{},J=!0;u?this.decimals=parseInt(u):'undefined'==typeof this.decimals&&
(this.decimals=2);if(v)if(this.isNumber().valid)try{Number.isFinite(v)||(v=this.value=S.data[this.name]=new Number(parseFloat(v.match(/[0-9.,]+/g).join('').replace(/,/,'.')))),U&&this.target.setAttribute('value',v)}catch(T){J=!1,H.toFloat=D(this.error||S.errorLabels.toFloat,this),this.valid=!1,0<H.count()&&(this.errors=H)}else J=!1,H.toFloat=D(this.error||S.errorLabels.toFloatNAN,this);else return r[this.name];this.decimals&&v&&!H.toFloat&&(this.value=S.data[this.name]=parseFloat(this.value.toFixed(this.decimals)));
this.valid=J;0<H.count()&&(this.errors=H);return r[this.name]};r[l].isFloat=function(u){'string'==typeof this.value&&(this.value=this.value.replace(/\s+/g,''));var v=S.data[this.name]=this.value;u=r[this.name].errors||{};'string'==typeof v&&/\./.test(v)&&Number.isFinite(Number(v));'string'==typeof v&&/,/g.test(v)&&(v=this.value=S.data[this.name]=Number(v.replace(/,/g,'.')));Number(v)===v&&0!==v%1?(this.value=S.data[this.name]=Number(v),v=!0):v=!1;u.isRequired||''!=this.value||(v=!0);v||(u.isFloat=
...
/true/.test(u[v].value)?!0:!1:this.value=S.data[this.name]=u[v].value;this.valid=!0;break}}u='undefined'==typeof this.value||null==this.value||''==this.value||/^\s+/.test(this.value)?!1:!0;v=r[this.name].errors||{};u?u&&'undefined'!=typeof v.isRequired&&delete v.isRequired:v.isRequired=D(this.error||S.errorLabels.isRequired,this);this.valid=u;0<v.count()&&(this.errors=v);return r[this.name]};r[l].isString=function(u,v){var H=S.data[this.name]=this.value,J=!1,T=!0,ra=!0,Fa=r[this.name].errors||{};
'string'!=typeof H||Fa.isRequired||''==H||(J=!0,u&&'number'==typeof u&&H.length<u&&(T=!1,this.size=u),v&&'number'==typeof v&&H.length>v&&(ra=!1,this.size=v));J&&T&&ra||(!J&&Fa.isRequired&&''==H?(J=!1,Fa.isString=D(this.error||S.errorLabels.isString,this)):J||Fa.isRequired||(J=!0),T&&ra||(J=!1,T||(Fa.isStringLength=D(this.error||S.errorLabels.isStringMinLength,this)),ra||(Fa.isStringLength=D(this.error||S.errorLabels.isStringMaxLength,this)),u===v&&(Fa.isStringLength=D(this.error||S.errorLabels.isStringLength,
this))));this.valid=J;0<Fa.count()&&(this.errors=Fa);return r[this.name]};r[l].isDate=function(u){var v=this.value,H=!1,J=r[this.name].errors||{},T=null;if(!v||''==v||/NaN|Invalid Date/i.test(v))return/NaN|Invalid Date/i.test(v)&&(console.warn('[FormValidator::isDate] Provided value for field `'+this.name+'` is not allowed: `'+v+'`'),J.isDate=D(this.error||S.errorLabels.isDate,this)),this.valid=H,0<J.count()&&(this.errors=J),r[this.name];if('undefined'==typeof u||'undefined'!=typeof u&&/true/i.test(u))u=
'yyyy-mm-dd';if(v instanceof Date)v=v.format(u);else{try{T=u.match(/[^\/\- ]+/g)}catch(ha){throw Error('[FormValidator::isDate] Provided mask not allowed: `'+u+'`');}try{v=v.match(/[^\/\- ]+/g);var ra={},Fa;var W=0;for(Fa=T.length;W<Fa;++W)ra[T[W]]=v[W];for(var ka in ra)u=u.replace(new RegExp(ka,'g'),ra[ka])}catch(ha){throw Error('[FormValidator::isDate] Provided value not allowed: `'+v+'`'+ha);}v=this.value=S.data[this.name]=new Date(u);if(/Invalid Date/i.test(v)||!1===v instanceof Date)return J.isRequired||
''!=this.value?J.isDate=D(this.error||S.errorLabels.isDate,this):H=!0,this.valid=H,0<J.count()&&(this.errors=J),r[this.name];H=!0}this.valid=H;return v};r[l].format=function(u,v){var H=this.value;return H?H.format(u,v):r[this.name]};r[l].setFlash=function(u,v){'undefined'!=typeof v&&''!=v&&(this.error=v);return r[this.name]};r[l].setLabel=function(u){'undefined'!=typeof u&&''!=u&&(this.label=u);return r[this.name]};r[l].trim=function(u){if('boolean'==typeof u&&u)return this.value=this.value.replace(/^\s+|\s+$/,
...
delete S.data[S.excluded[l]];return S.data};var D=function(l,y){var z=l.match(/%[a-z]+/gi);if(z)for(var F=0,u=z.length;F<u;++F)l=l.replace(new RegExp(z[F],'g'),y[S.keys[z[F]]]);return l};r.setErrorLabels=function(l){'undefined'!=typeof l&&(S.errorLabels=M(l,S.errorLabels))};return r}'undefined'!==typeof module&&module.exports?module.exports=FormValidatorUtil:'function'===typeof define&&define.amd&&define('lib/form-validator',[],function(){return FormValidatorUtil});
function Routing(){var B='undefined'!==typeof module&&module.exports?!1:!0,P={allowedMethods:['get','post','put','delete'],reservedParams:['controle','file','title','namespace','path'],notFound:{}};P.allowedMethodsString=P.allowedMethods.join(',');var V=null,na=null,U=null;B?(na&&'function'==typeof na||(na=require('lib/merge')),U&&'function'==typeof U||(U=require('lib/form-validator'))):(require('fs'),require('util'),require('../../inherits'),na=require('../../merge'),V=require(__dirname+'/../../../core/plugins')||
getContext('gina').plugins,U=V.Validator);P.getUrlProps=function(r,G){var w={};if(B){var ma=window.gina.config;w.hostname=ma.hostname;'undefined'!=typeof r&&(r=this.getRoute('webroot@'+r),w.hostname=r.hostname,w.host=r.host,w.webroot=r.webroot)}else ma=getContext('gina').config,'undefined'!=typeof getContext('argvFilename')&&(ma.getRouting=getContext('gina').Config.instance.getRouting),'undefined'==typeof r&&(r=ma.bundle),'undefined'==typeof G&&(G=ma.env),w.hostname=ma.envConf[r][G].hostname,w.host=
ma.envConf[r][G].host,w.webroot=ma.envConf[r][G].server.webroot;return w};P.compareUrls=async function(r,G,w,ma,Aa){'undefined'==typeof w&&(w={routing:{}});if(/,/.test(G)){var N=0;G=G.split(/,/g);for(var O=G.length,A={past:!1,request:w};N<O&&!A.past;)A=await M(r,G[N],w,ma,Aa),++N;return A}return await M(r,G,w,ma,Aa)};var M=async function(r,G,w,ma,Aa){var N=null;try{N=r.url.split(/\//)}catch(T){console.warn(T),N=['']}G=G.split(/\//);var O=0,A=0,D=G.length,l=0,y={},z=0,F=w.method.toLowerCase(),u='get';
try{u=r.method.toLowerCase()}catch(T){}var v=!1;if('undefined'!=typeof r.requirements&&/get|delete/i.test(F)&&'undefined'!=typeof w[F]||'undefined'!=typeof r.requirements&&/get/i.test(F)&&/delete/i.test(u)){/get/i.test(F)&&/delete/i.test(u)&&(F=u);if(/^(delete)$/i.test(F)&&N.length===G.length){'undefined'==typeof w[F]&&(w[F]={});for(let T=0,ra=G.length;T<ra;T++)if(N[T]===G[T])++l;else if(u=G[T].substr(1),'undefined'!=typeof r.requirements[u]){u=r.requirements[u];if(/^\//.test(u))u=u.substr(1,u.lastIndexOf('/')-
1);else if(/^validator::/.test(u)&&await ba(G[T],N[T],r,w,ma,Aa)){++l;continue}/^:/.test(G[T])&&'undefined'!=typeof u&&(new RegExp(u)).test(N[T])&&(++l,w[F][G[T].substr(1)]=N[T])}v=!0}for(var H in w[F])'undefined'!=typeof r.requirements[H]&&0>G.indexOf(':'+H)&&(G[A]=':'+H,++A,N[O]=w[F][H],++O,v||N.length!==G.length||++D)}if(!v&&N.length===G.length)for(;z<D;++z)N[z]===G[z]?++l:l==z&&/:/.test(G[z])&&await ba(G[z],N[z],r,w,ma,Aa)&&++l;if('undefined'!=typeof r.requirements&&F==r.method.toLowerCase()&&
!v&&l>=D)for(H=Object.getOwnPropertyNames(r.requirements),O=0,G.join(',').match(/:[-_a-z0-9]+/g);O<H.length;){A=H[O];if('undefined'==typeof r.param[A]&&/^validator::/i.test(r.requirements[A])){if(G.length!=N.length)break;var J=G.join(',').match(/:[-_a-z0-9]+/g);let T=r.requirements[A];z={};u={};v={};try{u=JSON.parse(T.split(/::/).splice(1)[0].replace(/([^:"\s+](\w+)):/g,'"$1":').replace(/([^:"\s+](\w+))\s+:/g,'"$1":'))}catch(ra){throw ra;}if('undefined'!=typeof u.query&&'undefined'!=typeof u.query.data){z=
u.query.data;for(let ra in z)0>J.indexOf(z[ra])&&delete z[ra];for(let ra=0,Fa=G.length;ra<Fa;ra++)/^:/.test(G[ra])&&(J=G[ra].replace(/^:/,''),''!=J&&'undefined'!=typeof N[ra]&&(z[J]=N[ra],'undefined'==typeof w.params[J]&&(w.params[J]=N[ra])))}z=na(z,JSON.clone(w[F])||{});'undefined'==typeof z[A]&&(z[A]=null);v[A]=u;_validator=B?new U(z):new U('routing',z,null,v);if(0==u.count()){console.error('Route validation failed '+r.rule);--l;O++;continue}for(let ra in u)if('undefined'!=typeof u[ra].data&&(u[ra].data=
z),v=Array.isArray(u[ra])?await _validator[A][ra].apply(_validator[A],u[ra]):await _validator[A][ra](u[ra],w,ma,Aa),!v.isValid&&(--l,'undefined'!=typeof v.error))throw v.error;}O++}y.past=l===D?!0:!1;y.past&&(w.routing=S(r,w[F]),y.request=w);return y},ba=async function(r,G,w,ma,Aa,N){var O=-1,A=r.match(/:\w+/g);O=new RegExp(r,'g');var D=null,l=null,y=null;D=!1;var z=D=l=l=null,F=null,u=ma.method.toLowerCase();if(!A.length)return!1;w.param.path&&O.test(w.param.path)&&(w.param.path=w.param.path.replace(O,
...
typeof ma[u]&&(ma[u]={});y=A[O].substr(1);O=w.requirements[y];if(/^\//.test(O))D=O.match(/\/(.*)\//).pop(),l=O.replace('/'+D+'/',''),D=(new RegExp(D,l)).test(G);else if(/^validator::/.test(O)&&G){l={};D={};z={};F='';r.replace(new RegExp('[^'+y+']','g'),function(ra){F+=ra});l[y]=G.replace(new RegExp(F,'g'),'');try{D=JSON.parse(O.split(/::/).splice(1)[0].replace(/([^:"\s+](\w+)):/g,'"$1":').replace(/([^:"\s+](\w+))\s+:/g,'"$1":'))}catch(ra){throw ra;}'undefined'!=typeof D.query&&'undefined'!=typeof D.query.data&&
r==D.query.data[Object.keys(D.query.data)[0]]&&(D.query.data[Object.keys(D.query.data)[0]]=l[y],ma.params[y]=l[y]);z[y]=D;l=new U('routing',l,null,z);if(0==D.count())return console.error('Route validation failed '+w.rule),!1;for(var v in D)Array.isArray(D[v])?await l[y][v].apply(l[y],D[v]):await l[y][v](D[v],ma,Aa,N);D=l.isValid()}else D=(new RegExp(w.requirements[y])).test(G);if('undefined'!=typeof w.param[y]&&'undefined'!=typeof w.requirements&&'undefined'!=typeof w.requirements[y]&&'undefined'!=
typeof ma.params&&D)return ma.params[y]=G,'undefined'==typeof ma[u][y]&&(ma[u][y]=G),!0}else{Aa=w.url;N=ma.url;u={};z='';var H=!1,J=0;v=0;for(var T=N.length;v<T;++v)if(N.charAt(v)!=Aa.charAt(J)||H){if(''==z)H=!0,z+=N.charAt(v);else if(v>Aa.indexOf(A[0])+A[0].length){O=w.requirements[A[0]];G=z.substr(0,z.length);if(/^\//.test(O))D=O.match(/\/(.*)\//).pop(),l=O.replace('/'+D+'/',''),D=(new RegExp(D,l)).test(G);else if(/^validator::/.test(O)){l={};D={};z={};F='';r.replace(new RegExp('[^'+y[0]+']','g'),
function(ra){F+=ra});l[y[0]]=G.replace(new RegExp(F,'g'),'');D=JSON.parse(O.split(/::/).splice(1)[0].replace(/([^\W+ true false])+(\w+)/g,'"$&"'));z[y[0]]=D;l=new U('routing',l,null,z);for(let ra in D)if(Array.isArray(D[ra]))l[y[0]][ra].apply(l[y[0]],D[ra]);else l[y[0]][ra](D[ra]);D=l.isValid()}else D=(new RegExp(w.requirements[y[0]])).test(G);if(D)u[A[0].substr(1)]=G;else return!1;z='';H=!1;J=Aa.indexOf(A[0])+A[0].length;--v;A.splice(0,1)}else z+=N.charAt(v),++J;if(v==T-1)if(O=w.requirements[A[0]],
G=z.substr(0,z.length),/^\//.test(O)?(D=O.match(/\/(.*)\//).pop(),l=O.replace('/'+D+'/',''),D=(new RegExp(D,l)).test(G)):D=(new RegExp(w.requirements[y])).test(G),D)u[A[0].substr(1)]=G;else return!1}else++J;if(u.count()==A.length){y=null;for(y in u)ma.params[y]=u[y];return!0}}return!1},Q=function(r){return/\/$/.test(r)?Q.variable+'/':Q.variable},S=function(r,G){var w=null,ma,Aa=r.url,N=null;for(N in r.param)if(('undefined'==typeof G||'undefined'!=typeof G[N])&&/^:/.test(r.param[N])){var O=r.param[N].substr(1);
...
r.param.file.replace(A,Q));if(/,/.test(r.url)){w=r.url.split(/,/g);var D=0;for(ma=w.length;D<ma;++D)Q.variable=G[O],w[D]=w[D].replace(A,Q);r.url=w.join(',')}else Q.variable=G[O],r.url=r.url.replace(A,Q)}}if(w){D=0;ma=w.length;Aa=Aa.split(/,/g);var l=0;for(r.urlIndex=0;D<ma;++D)if(w=0,A=Aa[0].match(/:[-_a-z0-9]+/ig)){N=0;for(O=A.length;N<O;N++){var y=A[N].substr(1);'undefined'!=typeof G[y]&&G[y]&&w++}w>l&&(l=w,r.urlIndex=D)}}return r};P.getRoute=function(r,G,w){var ma=null,Aa=!1;B?(window.location.port||
window.location.hostname!=window.gina.config.hostname.replace(/^(https|http|wss|ws):\/\//,'').replace(/:\d+$/,'')||(Aa=!0,window.gina.config.hostname=window.gina.config.hostname.replace(/^(https|http|wss|ws):\/\//,'').replace(/:\d+$/,'')),ma=window.gina.config):(ma=getContext('gina').config,'undefined'!=typeof getContext('argvFilename')&&(ma.getRouting=getContext('gina').Config.instance.getRouting),Aa=getContext('isProxyHost'));var N=ma.env||GINA_ENV,O=null,A=ma.bundle;/@/.test(r)||'undefined'==typeof A||
null==A||(r=r.toLowerCase(),r+='@'+A);if(/@/.test(r)){var D=r.replace(/(.*):\/\//,'').split(/@/);A=D[1];/\/(.*)$/.test(r)&&(O=r.replace(/(.*):\/\//,'').split(/\/(.*)$/)[1],A=A.replace(/\/(.*)$/,''),N=O||N);r=D[0].toLowerCase()+'@'+A}O=ma.getRouting(A,N);if('undefined'==typeof O[r])throw Error('[ RoutingHelper::getRouting(rule, params) ] : `'+r+'` not found !');ma=JSON.clone(O[r]);A=null;ma=S(ma,G);(ma.isProxyHost=Aa)&&ma.hostname&&(ma.hostname=B?window.location.protocol+'//'+window.gina.config.hostname:
process.gina.PROXY_HOSTNAME,ma.host=ma.hostname.replace(/^(https|http):\/\//,''));/,/.test(ma.url)&&('undefined'!=typeof ma.urlIndex&&(w=ma.urlIndex,delete ma.urlIndex),w='undefined'!=typeof w?w:0,ma.url=ma.url.split(/,/g)[w]);/\/$/.test(ma.url)&&'/'!=ma.url&&(ma.url=ma.url.substr(0,ma.url.length-1));if(/GET/i.test(ma.method)&&'undefined'!=typeof G){w='?';Aa=O[r].url;O=[];A=0;for(let l in ma.param)-1<P.reservedParams.indexOf(l)||(new RegExp(ma.param[l])).test(Aa)||'undefined'==typeof G[l]||(w+=l+
'='+encodeRFC5987ValueChars(G[l])+'&',O[A]=G[l],++A);for(let l in G)-1<P.reservedParams.indexOf(l)||'undefined'!=typeof ma.requirements[l]||-1<O.indexOf(l)||(w='object'==typeof G[l]?w+(l+'='+encodeRFC5987ValueChars(JSON.stringify(G[l]))+'&'):w+(l+'='+G[l]+'&'));A=O=Aa=null;1<w.length&&(w=w.substring(0,w.length-1),ma.url+=w);w=null}ma.toUrl=function(l){var y=null;/^redirect$/i.test(this.param.control)&&(y=P.getUrlProps(this.bundle,N||GINA_ENV));var z=this.webroot||y.webroot;y=this.hostname||y.hostname;
var F=this.url;this.url='undefined'!=typeof l&&/^true$/i.test(l)?F.replace(new RegExp('^'+z),'/'):F.replace(new RegExp('^('+z+'|/$)'),z);return y+this.url};ma.request=function(l,y){var z=null,F=null;'function'==typeof arguments[arguments.length-1]&&(z=arguments[arguments.length-1]);'object'==typeof arguments[2]&&(F=arguments[2]);var u=this.webroot||F.webroot,v=this.hostname||F.hostname;F='undefined'!=typeof l&&1==l?path.replace(u,'/'):this.url||F.url;v=/^https/.test(v)?'https':'http';B?window.open(F,
'undefined'!=typeof y&&'undefined'!=typeof y.target?y.target:'_self'):('undefined'==typeof y.agent&&(y.agent=!1),v=require(''+v),u=function(H){var J='',T=!1;H.on('data',function(ra){J+=ra});H.on('error',function(ra){T='Failed to get mail content';ra&&'undefined'!=typeof ra.stack?T+=ra.stack:'string'==typeof ra&&(T+='\n'+ra)});H.on('end',function(){if(/^\{/.test(J))try{J=JSON.parse(J),'undefined'!=typeof J.error&&(T=JSON.clone(J),J=null)}catch(ra){T=ra}T?z(T):z(!1,J)})},z?v.get(F,y,u):v.get(F,y))};
!/:/.test(ma.url)||/:d+\//.test(ma.url)||/:\/\//.test(ma.url)||(G=ma.url.match(/(:(.*)\/|:(.*)$)/g).map(function(l){return l.replace(/\//g,'')}).join(', '),A='[ RoutingHelper::getRoute(rule[, bundle, method]) ] : route [ %r ] param placeholder not defined: `'+ma.url+'` !\n Check your route description to compare requirements against param variables [ '+G+']',A=A.replace(/%r/,r),r=Error(A),console.warn(r),A=r=G=null);return ma};P.getRouteByUrl=function(r,G,w,ma,Aa){2==arguments.length&&'undefined'!=
typeof arguments[1]&&arguments[1]&&-1<P.allowedMethods.indexOf(arguments[1].toLowerCase())&&(w=arguments[1],G=void 0);var N=null,O=null,A=null,D=null,l=null,y=null;if(/#/.test(r)&&1<r.length){var z=r.split(/#/);r=z[0];l='#'+z[1];z=null}1==arguments.length&&'undefined'!=typeof arguments[0]&&(/^(https|http)/i.test(r)||/^\//.test(r)||(r='/'+r),N='/'+r.split(/\//g)[1],B&&(D=gina.config.reverseRouting,A=gina.config.routing),'undefined'!=typeof D[N]&&(z=A[D[N]],G=z.bundle,N=z.webroot,y=z.hostname,z=null));
Aa='boolean'!=typeof arguments[arguments.length-1]?!1:arguments[arguments.length-1];var F=!1,u=null,v=null,H=u=v=null;z='undefined'!=typeof w?!0:!1;B?(u=window.gina.config,G='undefined'!=typeof G?G:u.bundle,v=u.env,A=A||u.getRouting(G),D=D||u.reverseRouting,isXMLRequest='undefined'!=typeof isXMLRequest?isXMLRequest:!1,y=y||u.hostname,N=N||u.webroot,ma={routing:{},method:w,params:{},url:r},G&&(ma.bundle=G)):(u=getContext('gina').config,G='undefined'!=typeof G?G:u.bundle,v=u.env,A=u.getRouting(G),y=
u.envConf[G][v].hostname,N=u.envConf[G][v].server.webroot,ma||={routing:{},isXMLRequest:!1,method:'undefined'!=typeof w?w.toLowerCase():'get',params:{},url:r},Aa&&(ma.method=w),isXMLRequest=ma.isXMLRequest||!1);v=r.replace(new RegExp('^('+y+'|'+y.replace(/:\d+/,'')+')'),'');'undefined'==typeof ma.routing.path&&(ma.routing.path=decodeURI(v));w='undefined'!=typeof w?w.toLowerCase():'get';z&&(ma.originalMethod=ma.method,ma.method=w,ma.routing.path=decodeURI(v));ma.method||(ma.method=w);u={};N=new RegExp(w,
'i');D=null;var J;for(J in A){if('undefined'==typeof A[J].param)break;if(A[J].bundle==G&&(D=A[J].method,/,/.test(D)&&N.test(D)&&(D=ma.method),'undefined'==typeof A[J].method||N.test(D))){u={method:D,requirements:A[J].requirements,namespace:A[J].namespace||void 0,url:decodeURI(v),rule:A[J].originalRule||J,param:A[J].param,middleware:JSON.clone(A[J].middleware),bundle:A[J].bundle,isXMLRequest};try{if(H=P.compareUrls(u,A[J].url,ma),H.past){O=JSON.clone(A[J]);O.name=J;F=!0;H={};break}}catch(T){throw Error('Route [ '+
J+' ] needs your attention.\n'+T.stack);}}}if(F)return/\/$/.test(r)&&'/'!=r&&(r=r.substr(0,r.length-1)),l&&(r+=l),O.url=r,O.toUrl=function(T){var ra=this.webroot,Fa=this.hostname,W=this.url;this.url='undefined'!=typeof T&&1==T?W.replace(ra,'/'):W;return Fa+this.url},O;if(B){l=!1;if('#'==r&&/GET/i.test(w)&&z||/^404:/.test(r))r=location.pathname,l=!0;'undefined'==typeof P.notFound&&(P.notFound={});A=null;O='[ RoutingHelper::getRouteByUrl(rule[, bundle, method]) ] : route [ %r ] is called but not found inside your view: `'+
...
(S.setItem(this._bucket,JSON.stringify(G)),!0):!1},drop:function(O){if('undefined'==typeof G[this._collection])throw Error('Collection `'+O+'` not found');delete r[this._collection];delete G[this._collection];S.setItem(this._bucket,JSON.stringify(G))}},N=function(O){O=O||!1;try{var A=JSON.clone(G),D=this._index,l=this._collection,y=this._bucket,z=this._filter;this._updatedAt=(new Date).format('isoDateTime');A[l][D]=na(A[l][D],this,!0);delete A[l][D]._index;delete A[l][D]._collection;delete A[l][D]._bucket;
delete A[l][D].save;delete A[l][D]._filter;if(O&&'object'==typeof A[l][D]){var F=function(v,H){for(var J=0,T=v.length;J<T;++J)'object'!=typeof H[J]||'undefined'==typeof v[J]||Array.isArray(v[J])?Array.isArray(v[J])?F(v[J],H[J]):'undefined'==typeof v[J]&&delete H[J]:u(v[J],H[J]);return H},u=function(v,H){for(var J in H)'object'!=typeof H[J]||'undefined'==typeof v[J]||Array.isArray(v[J])?Array.isArray(v[J])?F(v[J],H[J]):'undefined'==typeof v[J]&&delete H[J]:u(v[J],H[J]);return H};Array.isArray(A[l][D])?
...
typeof O&&'undefined'!=typeof O)throw Error('`options` must be an object');'undefined'==typeof O&&(O={});ba=na(O,ba);S=window.localStorage;O=ba.bucket;if(!S.getItem(O)&&void 0!=O)S.setItem(O,JSON.stringify(G));else if(void 0==O)throw Error('`bucket` name cannot be undefined');Q.bucket=O;Q=na(Q,ma)})(B);return Q}
...
function DataHelper(){encodeRFC5987ValueChars=function(V){return encodeURIComponent(V).replace(/['()]/g,escape).replace(/\*/g,'%2A').replace(/%(?:7C|60|5E)/g,unescape)};formatDataFromString=function(V){'object'==typeof V&&(V=JSON.stringify(V));try{V=decodeURIComponent(V)}catch(r){}/("false"|"true"|"on")/.test(V)&&(V=V.replace(/"false"/g,!1).replace(/"true"/g,!0).replace(/"on"/g,!0));/("null")/i.test(V)&&(V=V.replace(/"null"/ig,null));a:{var na=V,U=V=null,M=null;if(/^(\{|\[|%7B|%5B)/.test(na)){try{V=
(M=/^(\{|%7B)/.test(na)?!1:!0)?[]:{};U=/^(%7B|%5B)/.test(na)?JSON.parse(decodeURIComponent(na)):JSON.parse(na);if(Array.isArray(U)){M=0;for(var ba=U.length;M<ba;++M)V[M]=B(U[M],V);var Q=V}else Q=B(U,V);var S=Q;break a}catch(r){console.error('[365] could not parse body:\n'+na)}S=void 0}else{V={};S=na.split(/&/g);/("false"|"true"|"on")/.test(na)&&na.replace(/"false"/g,!1).replace(/"true"/g,!0).replace(/"on"/g,!0);na={};ba=0;for(U=S.length;ba<U;++ba)if(S[ba])if(S[ba]=decodeURIComponent(S[ba]),/^\{/.test(S[ba])||
/=\{/.test(S[ba])||/=\[/.test(S[ba]))try{if(/^\{/.test(S[ba])){V=JSON.parse(S[ba]);break}else na=S[ba].match(/=(.*)/),na[0]=S[ba].split(/=/)[0],V[na[0]]=JSON.parse(na[1])}catch(r){console.error('[parseBody#1] could not parse body:\n'+S[ba])}else{na=S[ba].split(/=/);if(/\{\}":/.test(na[1]))try{na[1]=JSON.parse(na[1])}catch(r){console.error('[parseBody#2] could not parse body:\n'+na[1])}'string'!=typeof na[1]||/\[object /.test(na[1])||(na[0]=decodeURIComponent(na[0]),na[1]=decodeURIComponent(na[1]),
/^(.*)\[(.*)\]/.test(na[0])?(Q=na[0].replace(/\]/g,'').split(/\[/g),V=P(V,Q,0,na[1])):V[na[0]]=na[1])}S=V}}return S};var B=function(V,na){var U=[];na||={};for(let ba in V)if(U[0]=ba,U[1]=V[ba],/^(.*)\[(.*)\]/.test(U[0])){var M=U[0].replace(/\]/g,'').split(/\[/g);na=P(na,M,0,U[1])}else na[U[0]]=U[1];return na},P=function(V,na,U,M){for(let ba=0,Q=na.length;ba<Q;ba++){let S=na[U];if(ba==U){if('undefined'==typeof V[na[U]]||'string'==typeof V[na[U]])Array.isArray(V)?(S=~~na[U],V[S]=/^\d+$/.test(na[U+1])?
...
null,errors:{},initialized:!1,isReady:!1,rules:{},$forms:{},getFormById:null,validateFormById:null,setOptions:null,resetErrorsDisplay:null,resetFields:null},ma={id:null,plugin:this.plugin,on:U?on:null,eventData:{},target:U?document:null,cachedErrors:{},binded:!1,unbinded:!1,withUserBindings:!1,rules:{},setOptions:null,send:null,isValidating:null,isSubmitting:null,submit:null,destroy:null,resetErrorsDisplay:null,resetFields:null},Aa={},N={},O=null,A={url:'',method:'GET',isSynchrone:!1,withCredentials:!1,
...
m=m.replace(/#/,'');if(null!=document.getElementById(m)&&'undefined'==typeof w.$forms[m]){var h=document.getElementById(m),b,x=typeof(0<Aa.count())?Aa:w.rules;h.getAttribute?(id=h.getAttribute('id')||'form.'+ba.v4(),id!==h.getAttribute('id')&&h.setAttribute('id',id)):(id='form.'+ba.v4(),h.setAttribute('id',id));h.id=ma.id=id;if('undefined'!=typeof h.id&&'null'!=h.id&&''!=h.id){ma.target=h;w.$forms[h.id]=Q({},ma);if(b=h.getAttribute('data-gina-form-rule')){b=b.replace(/\-|\//g,'.');if('undefined'==
typeof x[b])throw Error('['+h.id+'] no rule found with key: `null`');b=x[b]}'string'==typeof h.id&&'undefined'!=typeof x[h.id.replace(/\-/g,'.')]?$target=w.$forms[h.id].target:'object'==typeof h.id?(delete w.$forms[h.id],x=h.attributes.getNamedItem('id').nodeValue||'form.'+ba.v4(),h.setAttribute('id',x),h.id=x,ma.target=h,w.$forms[x]=Q({},ma),$target=w.$forms[x].target):$target=w.$forms[h.id].target;b?xb($target,b):xb($target)}}'undefined'!=typeof w.$forms[m]&&(w.$forms[m].withUserBindings=!0,g='undefined'!=
typeof this.$forms&&'undefined'==typeof this.$forms[m]?this.$forms[m]=w.$forms[m]:w.$forms[m]);if(!g)throw Error('Validator::getFormById(...) exception: could not retrieve form `'+m+'`');g.binded||(xb(g.target),g=w.$forms[m]);M&&U&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&(gina.forms.errors||(gina.forms.errors={}),h={id:m,rules:w.$forms[m].rules},'undefined'!=typeof w.$forms[m].errors&&(h.errors=w.$forms[m].errors),window.ginaToolbar.update('forms',h));return g},z=function(){var m=
...
('undefined'!=typeof w.$forms&&'undefined'!=typeof w.$forms[p]&&'undefined'!=typeof w.$forms[p].errors&&0==w.$forms[p].errors.count()||'undefined'!=typeof w.$forms&&'undefined'!=typeof w.$forms[p]&&!w.$forms[p].errors)&&Ka(m,!0),'undefined'!=typeof v[p]&&0==v[p].count()?delete v[p]:g=v[p]}var R=null;p=m.getAttribute('id');h='undefined'!=typeof h?h:{};for(var K=0,fa=m.length;K<fa;++K){var Ba=m[K];if('undefined'==typeof b||b==Ba.name){if(/form\-item\-wrapper$/.test(Ba.parentNode.className)){var ea=
Ba.parentNode.parentNode;var da=Ba.parentNode}else ea=Ba.parentNode,da=Ba;var E=Ba.getAttribute('name');var oa=Ba.getAttribute('data-gina-form-errors');if(E){if('undefined'!=typeof g[E]&&!/(form\-item\-error|form\-item\-warning)/.test(ea.className)){ea.className=q?ea.className+(''==ea.className?'form-item-warning':' form-item-warning'):ea.className+(''==ea.className?'form-item-error':' form-item-error');R=document.createElement('div');R.className=q?'form-item-error-message hidden':'form-item-error-message';
for(var sa in g[E])'stack'!=sa&&(ea=document.createElement('p'),ea.appendChild(document.createTextNode(g[E][sa])),R.appendChild(ea)),M&&(x||={},x[E]||(x[E]={}),x[E][sa]=g[E][sa]);'hidden'!=da.type&&insertAfter(da,R)}else if('undefined'==typeof g[E]&&/(form\-item\-error|form\-item\-warning)/.test(ea.className)||'undefined'!=typeof g[E]&&0==g[E].count()&&/(form\-item\-error|form\-item\-warning)/.test(ea.className)){E=ea.getElementsByTagName('div');da=0;for(oa=E.length;da<oa;++da)if(/form\-item\-error\-message/.test(E[da].className)){E[da].parentElement.removeChild(E[da]);
break}ea.className=ea.className.replace(/(\s+form\-item\-error|form\-item\-error|\s+form\-item\-warning|form\-item\-warning)/,'')}else if('undefined'!=typeof g[E]&&oa){ea=ea.getElementsByTagName('div');oa=0;for(var ia=ea.length;oa<ia;++oa)if('form-item-error-message'==ea[oa].className){ea[oa].parentElement.removeChild(ea[oa]);R=document.createElement('div');R.setAttribute('class','form-item-error-message');for(sa in g[E])ea=document.createElement('p'),ea.appendChild(document.createTextNode(g[E][sa])),
R.appendChild(ea),M&&(x||={},x[E]||(x[E]={}),x[E][sa]=g[E][sa]);break}R&&'hidden'!=da.type&&insertAfter(da,R)}if('undefined'!=typeof b&&b===Ba.name)break}}}x?(triggerEvent(gina,m,'error.'+p,g),M&&U&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&(gina.forms.errors||(gina.forms.errors={}),m={id:p,errors:x},window.ginaToolbar.update('forms',m))):M&&U&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&(gina.forms.errors||(gina.forms.errors={}),m={id:p,errors:{}},U&&window.ginaToolbar.update('forms',
m));if(gina&&U&&M&&w.$forms[p].isSubmitting&&/^true$/i.test(w.$forms[p].isSubmitting)&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&h)try{window.ginaToolbar.update('data-xhr',h)}catch(Z){throw Z;}},J=function(m){var g=null;'undefined'==typeof m&&'undefined'!=typeof this.id&&(m=this.id);/^string$/i.test(typeof m)?(g=m.replace(/#/,''),g=document.getElementById(g)):m instanceof HTMLFormElement?g=m:/^object$/i.test(typeof m)&&(g=m.target);if(!g)throw Error('[ FormValidator::resetErrorsDisplay([ formId | <form> ]) ] `'+
...
W(gina,h,'error',b,q);triggerEvent(gina,h,'error.'+b,q);K&&triggerEvent(gina,h,'error.'+b+'.hform',q)}});cb.readAsText(Pa)}else{if(/^(\{|\[)/.test(O.responseText))try{q=Q(JSON.parse(O.responseText),q)}catch(X){q=Q(X,q)}else'object'==typeof O.responseText?q=Q(O.responseText,q):q.message=O.responseText;if('undefined'!=typeof q&&'undefined'!=typeof q.error&&q.fields&&'object'==typeof q.fields){Ya='undefined'!=typeof q.message?q.message:null;Z={};for(qb in q.fields)Ga={},Ga[qb]={},Ga[qb].isApiError=q.fields[qb],
Ya&&!Ga[qb].isApiError&&(Ga[qb].isApiError=q.error),Z[qb]=Ga[qb],H(x.target,Ga,m,qb);q.fields=Z}p=x.eventData.error=q;if(gina&&M&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&p)try{window.ginaToolbar.update('data-xhr',p)}catch(X){throw X;}/^gina\-upload/i.test(b)&&W(gina,h,'error',b,q);triggerEvent(gina,h,'error.'+b,q);K&&triggerEvent(gina,h,'error.'+b+'.hform',q)}}};O.onprogress=function(Z){var Ga='0';Z.lengthComputable&&(Ga=Z.loaded/Z.total,Ga=parseInt(100*Ga));Z={status:100,progress:Ga};
x.eventData.onprogress=Z;triggerEvent(gina,h,'progress.'+b,Z)};O.ontimeout=function(Z){q={status:408,error:'Request Timeout'};x.eventData.ontimeout=q;/^gina\-upload/i.test(b)&&W(gina,h,'error',b,q);triggerEvent(gina,h,'error.'+b,q);K&&triggerEvent(gina,h,'error.'+b+'.hform',q)};m||(m=event.detail.data);if(m){g=!1;if('object'==typeof m){ea=[];Ba=0;var da={};try{if(m instanceof FormData){var E=event.currentTarget.getAttribute('data-gina-form-upload-group')||'untagged',oa,sa;for([oa,sa]of m.entries())sa instanceof
File?(g||=!0,ea[Ba]={key:oa,group:E,file:sa,bin:''},++Ba):da[oa]=sa}else m=JSON.stringify(m);if(g&&0<ea.length){var ia='--ginaWKBoundary'+ba.v4().replace(/\-/g,'');return ha(ea,ia,'',0,function(Z,Ga,Pa){if(Z)/^gina\-upload/i.test(b)&&W(gina,h,'error',b,Z),triggerEvent(gina,h,'error.'+b,Z),K&&triggerEvent(gina,h,'error.'+b+'.hform',Z);else return Pa&&(O.setRequestHeader('Content-Type','multipart/form-data; boundary='+ia),O.send(Ga),x.sent=!0,M&&U&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&
(gina.forms.sent||(gina.forms.sent={}),window.ginaToolbar.update('forms',{id:b,sent:Ga}))),!1})}'undefined'!=typeof da&&0<da.count()&&(m=JSON.stringify(da))}catch(Z){/^gina\-upload/i.test(b)&&W(gina,h,'error',b,Z),triggerEvent(gina,h,'error.'+b,Z),K&&triggerEvent(gina,h,'error.'+b+'.hform',Z)}}g||('undefined'!=typeof fa&&null!=fa&&''!=fa&&O.setRequestHeader('Content-Type',fa),O.send(m))}else'undefined'!=typeof fa&&null!=fa&&''!=fa&&O.setRequestHeader('Content-Type',fa),O.send();x.sent=!0;M&&U&&'undefined'!=
...
(p.style.display='none');if(p&&'success'!=h){var R=x.message||x.error;p.innerHTML='<p>'+R+'</p>';fadeIn(p)}else if(p||'success'==h)for(h=0,x=q.length;h<x;++h){var K=b.id.replace(/\-preview/,'-'+h+'-reset-trigger');R=!1;p=document.getElementById(K);var fa=['reset','js-upload-reset'];p?(/a/i.test(p.tagName)&&(p.href='#'),p.innerHTML&&''!=p.innerHTML||(p.innerHTML=g.getAttribute('data-gina-form-upload-reset-label')||'Reset'),'undefined'==typeof p.className&&(p.className=''),K=Q(p.className.split(/\s+/g),
fa),p.className=K.join(' ')):(R=!0,p=document.createElement('A'),p.href='#',p.innerHTML=g.getAttribute('data-gina-form-upload-reset-label')||'Reset',p.className=fa.join(' '),p.id=K);p.style.display='none';if('undefined'==typeof q[h].preview&&m.hasPreviewContainer&&/^image/.test(q[h].mime)&&''!=q[h].location){K=document.createElement('IMG');K.src=q[h].tmpUri;K.style.display='none';K.setAttribute('data-upload-original-filename',q[h].originalFilename);K.setAttribute('data-upload-reset-link-id',p.id);
fa=b.getAttribute('data-preview-max-width')||null;if(K.width&&fa&&K.width>fa){var Ba=K.width/fa;K.width=fa;K.height/=Ba}else!K.width&&fa&&(K.width=fa);/ul/i.test(m.previewContainer.tagName)?(fa=document.createElement('LI'),fa.className='item',fa.appendChild(K),b.appendChild(fa)):b.appendChild(K);fadeIn(K)}K=m.uploadFields[h];for(var ea in K)if('name'==ea&&''!=K[ea].value||!q[h][ea]||'preview'==ea&&'undefined'==typeof q[h][ea]||/(height|width)/i.test(ea)&&!/^image/.test(q[h].mime))/(preview|height|width)/i.test(ea)&&
(fa=document.getElementById(K[ea].id))&&fa.parentNode.removeChild(fa);else if(K[ea].value=q[h][ea],'preview'==ea)for(var da in q[h][ea])if('undefined'!=typeof q[h][ea][da]&&'undefined'!=typeof K[ea][da]&&(K[ea][da].value=q[h][ea][da]),'tmpUri'==da&&m.hasPreviewContainer){Ba=document.createElement('IMG');Ba.src=q[h][ea].tmpUri;Ba.style.display='none';Ba.setAttribute('data-upload-original-filename',q[h].originalFilename);Ba.setAttribute('data-upload-preview-original-filename',q[h][ea].originalFilename);
...
g.target,'destroy.'+h,function(b){cancelEvent(b);delete w.$forms[h];removeListener(gina,b.currentTarget,b.type);removeListener(gina,b.currentTarget,'destroy')}),g=Db(g),triggerEvent(gina,g.target,'destroy.'+h);else throw Error('[ FormValidator::destroy(formId) ] `'+h+'` not found');},ua=function(m){m='undefined'!=typeof m?m:w.rules;for(let b in m){var g=Object.getOwnPropertyNames(m[b]),h=0;let x=g.length,q=!1,p=null;for(;h<x;){if(/^_case_/.test(g[h])){q=!0;p=g[h];break}h++}q||'object'!=typeof m[b]||
ua(m[b]);if(p&&Array.isArray(m[b][p].conditions)&&0<m[b][p].conditions.length)for(g=0,h=m[b][p].conditions.length;g<h;)'undefined'!=typeof m[b][p].conditions[g].rules&&0==m[b][p].conditions[g].rules.count()&&(m[b][p].conditions.splice(g,1),h--,g--),g++}},Da=function(m){var g=JSON.stringify(m),h=g.match(/("@import\s+[-_a-z A-Z 0-9/.]+")/g)||[],b=[];for(let R=0,K=h.length;R<K;R++)0>b.indexOf(h[R])&&b.push(h[R]);h=b;b=g.match(/("_merging(.*))(\s+:|:)(.*)(",|")/g);w.rules||(w.rules={});if(h&&0<h.length){m=
{};for(let R=0,K=h.length;R<K;++R){var x=h[R].replace(/(@import\s+|"|')/g,'');var q=x.replace(/(@import\s+|"|')/g,'').split(/\s/g);for(let fa=0,Ba=q.length;fa<Ba;++fa){var p=q[fa].replace(/\//g,'.').replace(/\-/g,'.');'undefined'!=typeof w.rules[p]?(p=JSON.stringify(w.rules[p]),p=JSON.parse(p),p._comment='undefined'!=typeof p._comment?p._comment+'\n':'',p._comment+='Imported from `'+x+'`',p=JSON.stringify(p),g=g.replace(new RegExp(h[R],'g'),p),w.rules=JSON.parse(JSON.stringify(w.rules).replace(new RegExp(h[R],
'g'),'{}'))):console.warn('[formValidator:rules] <@import error> on `'+h[R]+'`: rule `'+q[fa]+'` not found. Ignoring.')}q=new RegExp(h[R]);if(x=b&&q.test(b.join())?!0:!1)for(let fa=0,Ba=b.length;fa<Ba;fa++)if(q.test(b[fa])){x=JSON.stringify(m);x=x.substr(1,x.length-1);fa<Ba-1&&(x+=',');try{g=g.replace(new RegExp(b[fa],'g'),x),w.rules=JSON.parse(JSON.stringify(w.rules).replace(new RegExp(b[fa],'g'),'{}'))}catch(ea){throw ea;}}m={}}m=JSON.parse(g);La(m,'');try{ua()}catch(R){console.error(R.stack)}}return m},
Qa=function(m){gina.hasValidator?(w=Q(w,gina.validator),w.on('init',function(g){w.isReady=!0;triggerEvent(gina,w.target,'ready.'+w.id,w)})):(w.target=document,w.setOptions=l,w.getFormById=y,w.validateFormById=F,w.resetErrorsDisplay=J,w.resetFields=T,w.handleErrorsDisplay=H,w.send=Fa,w.on('init',function(g){if('undefined'!=typeof m&&m.count())try{La(m,''),m=Da(m),gina.forms.rules='undefined'!=typeof gina.forms.rules&&gina.forms.rules?Q(gina.forms.rules,m,!0):m,w.rules=Q(w.rules,JSON.clone(gina.forms.rules),
!0)}catch(R){throw R;}Aa.count()||(Aa=JSON.clone(w.rules));ma.setOptions=l;ma.getFormById=y;ma.validateFormById=F;ma.resetErrorsDisplay=J;ma.resetFields=T;ma.handleErrorsDisplay=H;ma.submit=ra;ma.send=Fa;ma.unbind=Db;ma.bind=xb;ma.reBind=jb;ma.destroy=la;g=0;for(var h=document.getElementsByTagName('form'),b=0,x=h.length;b<x;++b){if(h[b].getAttribute){var q=h[b].getAttribute('id')||'form.'+ba.v4();q!==h[b].getAttribute('id')&&h[b].setAttribute('id',q)}else q='form.'+ba.v4(),h[b].setAttribute('id',
q);ma.id=q;ma.target=h[b];w.$forms[q]=Q({},ma);var p=h[b].getAttribute('data-gina-form-rule');if(p){p=p.replace(/\-|\//g,'.');'undefined'!=typeof m&&(w.$forms[q].rules[p]=w.rules[p]=Aa[p]=Q(JSON.clone(eval('gina.forms.rules.'+p)),w.rules[p]));if('undefined'==typeof Aa[p])throw Error('['+q+'] no rule found with key: `'+p+'`. Please check if json is not malformed @ /forms/rules/'+p.replace(/\./g,'/')+'.json');p=w.rules[p]}'string'==typeof q&&'undefined'!=typeof Aa[q.replace(/\-/g,'.')]||'object'==typeof p?
(q=w.$forms[q].target,p?xb(q,p):xb(q),++g):('object'==typeof h[b].id?(delete w.$forms[h[b].id],q=h[b].attributes.getNamedItem('id').nodeValue||'form.'+ba.v4(),h[b].setAttribute('id',q),h[b].id=q,ma.target=h[b],w.$forms[q]=Q({},ma),q=w.$forms[q].target):q=w.$forms[h[b].id].target,p?xb(q,p):xb(q))}if(window.XMLHttpRequest)O=new XMLHttpRequest;else if(window.ActiveXObject)try{O=new ActiveXObject('Msxml2.XMLHTTP')}catch(R){try{O=new ActiveXObject('Microsoft.XMLHTTP')}catch(K){}}w.isReady=!0;gina.hasValidator=
...
m+'.'),x=null,q=function(R,K,fa,Ba,ea,da,E){if(K.length){var oa=Object.getOwnPropertyNames(R)[0],sa=K[0];sa=''==ea?ea+=sa:ea+'['+sa+']';1==K.length&&(R[oa]=Q(R[oa],fa,!0));K.splice(0,1);sa==oa?q(R[oa],K,fa,Ba,sa,da,E):'undefined'!=typeof R[oa]?q(R[oa],K,fa,Ba,sa,da,E):q(R,K,fa,Ba,ea,da,E)}},p;for(p in w.rules)p!=m&&h.test(p)&&(x=p.replace(b,''),/\./.test(x)&&(x=x.split(/\./g),q(g,x,w.rules[p],g,'',0,g.count()-1)));return Aa[m]=g},Na=formatDataFromString,Ia=function(m){var g=w.$forms[m.form.getAttribute('id')],
...
(p=!1);if(/^(radio|checkbox|text|hidden|password|number|date|email)$/i.test(g.type)&&!p||b&&!p){b=g.name;q=x[b]||null;if(!q&&(rb(x,g),'undefined'==typeof x[b]))return;if(m.target.dataset.ginaFormLiveCheckEnabled&&q&&(b=[],q=null,p=0,/^(radio|checkbox)$/i.test(g.type)?q=/^(radio|checkbox)$/i.test(g.type)?'changed.'+g.id:'change.'+g.id:(addEventListener(gina,g,'focusout.'+g.id,function(K){K.preventDefault();clearTimeout(h)}),q='change.'+g.id,'undefined'==typeof gina.events[q]&&(b[p]=q,++p),q='keyup.'+
g.id,'undefined'==typeof gina.events[q]&&(b[p]=q,++p),q='focusin.'+g.id,'undefined'==typeof gina.events[q]&&(b[p]=q,++p),q='focusout.'+g.id),'undefined'==typeof gina.events[q]&&(b[p]=q,++p),0<b.length)){var R=!1;addListener(gina,g,b,function(K){K.preventDefault();clearTimeout(h);if(!R&&/^changed\./i.test(K.type)||!R&&/^(radio|checkbox)$/i.test(K.target.type))R=!0;else if(R&&/^changed\./i.test(K.type)||R&&/^(radio|checkbox)$/i.test(K.target.type))return!1;if('undefined'!=typeof w.$forms[K.target.form.getAttribute('id')].isSubmitting&&
/true/i.test(w.$forms[K.target.form.getAttribute('id')].isSubmitting))return!1;var fa=function(){console.debug('processing: '+K.target.name+'/'+K.target.id);if(!/^(radio|checkbox)$/i.test(K.target.type)&&K.target.value===K.target.defaultValue&&''!=K.target.value){var Ba=w.$forms[K.target.form.getAttribute('id')].errors;if(Ba&&0!=Ba.count())H(K.target.form,Ba,null,K.target.name);else return H(K.target.form,{},null,K.target.name),cancelEvent(K)}Ba={};var ea={};Ba[K.target.name]=K.target.value;ea[K.target.name]=
K.target;w.$forms[K.target.form.getAttribute('id')].isValidating=!0;za(K.target,Ba,ea,m.rules,function(da){w.$forms[K.target.form.getAttribute('id')].isValidating=!1;da.isValid()?H(K.target.form,{},da.data,K.target.name):H(K.target.form,da.error,da.data,K.target.name);var E=K.target.form,oa=da=null,sa=null;oa=db(E,x);da=oa.fields;oa=oa.$fields;var ia=E.getAttribute('id');sa=w.$forms[ia].rules;w.$forms[ia].isValidating=!0;za(E,da,oa,sa,function(Z){w.$forms[ia].isValidating=!1;console.debug('['+ia+
'] onSilentGlobalLiveValidation: '+Z.isValid(),Z);var Ga=Z.isValid();M&&U&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&(gina.forms.errors||(gina.forms.errors={}),window.ginaToolbar.update('forms',{id:ia,errors:Z.error||{}}));Ka(E,Ga);R=!1})})};if(/^changed\./i.test(K.type)||/^change\./i.test(K.type)&&'radio'==K.target.type)return function(Ba,ea){if(!(0<ea))return++ea,setTimeout(()=>{console.debug(' changed .... '+g.id);fa()},0)}(R,0);/^focusin\./i.test(K.type)?/\-error/.test(g.parentNode.className)&&
(console.debug('#1 you just focusin ....'+g.id,g.value),u(g)):/^focusout\./i.test(K.type)?/\-warning/.test(g.parentNode.className)&&(console.debug('#1 you just focusout ....'+g.id,g.value),u(g),H(g.form,w.$forms[g.form.getAttribute('id')].errors,null,g.name)):/^keyup\./i.test(K.type)?(g.ginaFormValidatorTestedValue=g.value,h=setTimeout(function(){-1<['91','17'].indexOf(''+K.keyCode)&&0==N.count()||(console.debug(' keyup ('+K.keyCode+') .... '+g.id,g.value,' VS ',g.ginaFormValidatorTestedValue+'(old)'),
fa())},1E3)):/^change\./i.test(K.type)&&!/^(checkbox)$/i.test(K.target.type)&&(console.debug(' change .... '+g.id),fa())})}}},Ua=function(m,g){m.setSelectionRange?(m.focus(),m.setSelectionRange(g,g)):m.createTextRange&&(m=m.createTextRange(),m.collapse(!0),m.moveEnd('character',g),m.moveStart('character',g),m.select())},pb=function(m,g){if(document.activeElement&&document.activeElement.form){m=Array.prototype.filter.call(document.activeElement.form.querySelectorAll('a:not([disabled]), button:not([disabled]), input[type=text]:not([disabled]), select:not([disabled]), [tabindex]:not([disabled]):not([tabindex="-1"])'),
...
var b='keydown.'+h.currentTarget.id;'undefined'==typeof gina.events[b]&&addListener(gina,h.currentTarget,b,function(x){x.preventDefault();clearTimeout(g);var q=x.currentTarget,p=x.currentTarget.value,R=q.selectionStart,K=q.selectionEnd;q.removeAttribute('readonly');switch(x.keyCode){case 46:case 8:R!=K?(q.value=p.substr(0,R)+p.substr(K),0==R&&(q.value=p.substr(K))):q.value=0==R?p.substring(R+1):p.substr(0,R-1)+p.substr(K);x.currentTarget.setAttribute('readonly','readonly');setTimeout(()=>{q.removeAttribute('readonly');
setTimeout(()=>{R!=K?Ua(q,R):0==R?Ua(q,R):Ua(q,R-1)},0)},0);break;case 9:N[16]&&N[9]?pb(q,!0):pb(q);break;case 13:case 16:break;case 37:console.debug('moving left ',R-1);Ua(q,R-1);break;case 39:R+1<p.length+1&&Ua(q,R+1);break;case 17:case 91:console.debug('CMD hit');x.preventDefault();break;case 67:if(N[67]&&N[91]||N[67]&&N[17]){q.setSelectionRange(R,K);document.execCommand('copy');break}case 86:if(N[86]&&N[91]||N[86]&&N[17]){R!=K&&(q.value=q.value.replace(p.substring(R,K),''));Ua(q,R);document.execCommand('paste');
break}case 88:if(N[88]&&N[91]||N[88]&&N[17]){q.setSelectionRange(R,K);document.execCommand('cut');break}case 90:if(N[90]&&N[91]||N[90]&&N[17]){q.value=q.defaultValue;break}default:R!=K?(q.value=p.substr(0,R)+x.key,K-1<p.length&&(q.value+=p.substring(K))):q.value=0==R?x.key+p.substring(R):p.substr(0,R)+x.key+p.substr(K),x.currentTarget.setAttribute('readonly','readonly'),setTimeout(()=>{q.removeAttribute('readonly');setTimeout(()=>{Ua(q,R+1)},0)},0)}})})},gb=function(m,g){if(/^(input|textarea)$/i.test(g.tagName)&&
...
(h.fieldsSet[ia].defaultChecked=/^(true|on)$/i.test(g[ca].checked)||/^(true|on)$/.test(E)&&/^(checkbox)$/i.test(g[ca].type)?!0:!1,/^radio$/i.test(g[ca].type)&&(h.fieldsSet[ia].value=g[ca].value,h.fieldsSet[ia].defaultValue=g[ca].value)));/^true$/i.test(h.target.dataset.ginaFormLiveCheckEnabled)&&gb(h,g[ca]);if(E=g[ca].getAttribute('data-gina-form-element-group'))0>ea.indexOf(E)&&ea.push(E),sa=g[ca].getAttribute('name')||ia,sa===ia&&g[ca].setAttribute('name',ia),Ba[ia]={id:ia,name:sa,group:E,target:g[ca]},
da[g[ca].name]=new RegExp('^'+E.replace(/[.*+?^${}()|[\]\\]/g,'\\$&')),q&&('undefined'==typeof h.rules[g[ca].name]&&(h.rules[g[ca].name]={}),'undefined'!=typeof h.rules[g[ca].name].isRequired&&h.rules[g[ca].name].isRequired||(h.rules[g[ca].name].exclude=!0));if(0<da.count())for(var Z in da)g[ca].name!=Z&&(g[ca].getAttribute('data-gina-form-element-group'),da[Z].test(g[ca].name)&&(g[ca].disabled=!0,'undefined'==typeof oa[Z]&&(oa[Z]={}),oa[Z][g[ca].name]=g[ca]));if(/^file$/i.test(g[ca].type)){ia=g[ca].getAttribute('data-gina-form-upload-trigger');
ia||(ia=g[ca].id);E=null;sa=(new DOMParser).parseFromString(m.innerHTML,'text/html');ia&&(E=document.getElementById(ia));fa=document.getElementById(g[ca].id+'-error');Zb(g[ca],fa);if((fa=sa.getElementById(ia+'-preview'))&&E&&!/none/i.test(window.getComputedStyle(fa).display)&&!/none/i.test(fa.parentElement.style.display)){sa=0;console.debug('preview is visible ...');E.customFiles=[];E.form=m;fa=fa.childNodes;for(let ja=0,va=fa.length;ja<va;ja++){var Ga=null;if(/ul/i.test(fa[ja].tagName))for(let Ra=
0,Xa=fa[ja].length;Ra<Xa;Ra++){let eb=$$els[ja];for(let Oa=0,wb=eb.length;Oa<wb;Oa++)/img/i.test(eb[Oa])&&(Ga=eb[Oa],Ga.setAttribute(''),sa++)}else/img/i.test(fa[ja].tagName)&&(Ga=fa[ja],deleteLinkId=ia+'-'+sa+'-delete-trigger',Ga=Ga.src.substr(Ga.src.lastIndexOf('/')+1),E.customFiles.push({name:Ga,deleteLinkId}),Ub('delete',E,sa),sa++)}}addListener(gina,g[ca],'change',function(ja){ja.preventDefault();var va=ja.currentTarget;ja=va.files;va.customFiles=Array.from(ja);if(!ja.length)return!1;var Ra=
va.getAttribute('data-gina-form-upload-action'),Xa=va.getAttribute('name'),eb='gina-upload-'+Xa.replace(/\[/g,'-').replace(/\]/g,'-'+h.id);va.setAttribute('data-gina-form-virtual',eb);var Oa=va.getAttribute('data-gina-form-upload-on-success'),wb=va.getAttribute('data-gina-form-upload-on-error'),lb=null;if(0<ja.length){var hb=null;if(z()){hb=gina.popin.getActivePopin();hb.$target=(new DOMParser).parseFromString(hb.target.outerHTML,'text/html');hb.$target.getElementById(hb.id).innerHTML=document.getElementById(hb.id).innerHTML;
var ob=hb.$target.getElementById(eb)}else ob=document.getElementById(eb);if(!ob){try{ob=y(eb)||null}catch(Rc){}ob||=z()?hb.$target.createElement('form'):document.createElement('form');ob.id=eb;ob.action=Ra;ob.enctype='multipart/form-data';ob.method='POST';if('undefined'!=typeof va.form){Ra='files';var sb=va.getAttribute('data-gina-form-upload-prefix')||va.name||va.getAttribute('name'),mb=va.id||va.getAttribute('id'),Kb=!1,Eb=va.getAttribute('data-gina-form-upload-preview')||mb+'-preview';Eb=z()?hb.$target.getElementById(Eb):
...
{id:va.form.id||va.getAttribute('id'),uploadTriggerId:va.id,$form:va.form,errorField:lb,mandatoryFields:Gb,uploadFields:sb,hasPreviewContainer:Kb,isPopinContext:z()};Kb&&(ob.uploadProperties.previewContainer=Eb)}Oa?ob.setAttribute('data-gina-form-event-on-submit-success',Oa):ob.setAttribute('data-gina-form-event-on-submit-success','onGenericXhrResponse');wb?ob.setAttribute('data-gina-form-event-on-submit-error',wb):ob.setAttribute('data-gina-form-event-on-submit-error','onGenericXhrResponse');z()?
document.getElementById(hb.id).appendChild(ob):document.body.appendChild(ob)}try{var Qc=y(eb),rc=new FormData;va=null;eb=0;for(var sc=ja.length;eb<sc;++eb)va=ja[eb],rc.append(Xa,va,va.name);Qc.send(rc,{withCredentials:!0})}catch(Rc){throw Rc;}}})}}var Pa=function(ca,X){ca.setAttribute('data-value',ca.value);if(/^(true)$/i.test(X.target.dataset.ginaFormLiveCheckEnabled&&0<X.rules.count())){var ja={},va={},Ra=null;Ra=ca.form;ja[event.target.name]=event.target.value;va[event.target.name]=event.target;
w.$forms[Ra.getAttribute('id')].isValidating=!0;za(event.target,ja,va,X.rules,function(Xa){w.$forms[Ra.getAttribute('id')].isValidating=!1;Xa.isValid()?H(Ra,{},Xa.data,event.target.name):H(Ra,Xa.error,Xa.data,event.target.name);var eb=Ra,Oa=Xa=null,wb=null;Oa=db(eb,x);Xa=Oa.fields;Oa=Oa.$fields;var lb=eb.getAttribute('id');wb=w.$forms[lb].rules;w.$forms[lb].isValidating=!0;za(eb,Xa,Oa,wb,function(hb){w.$forms[lb].isValidating=!1;console.debug('[updateSelect]: onSilentGlobalLiveValidation: '+hb.isValid(),
hb);hb=hb.isValid();Ka(eb,hb);once=!1})})}};E=oa=null;Z=0;for(da=K.length;Z<da;++Z)if(rb(h.rules,K[Z]),ia=K[Z].getAttribute('id'),!ia||!/^gina\-toolbar/.test(ia)){ia&&''!=ia||(ia='select.'+ba.v4(),K[Z].setAttribute('id',ia));if(E=K[Z].getAttribute('data-gina-form-element-group'))oa=K[Z].getAttribute('name')||ia,oa===ia&&K[Z].setAttribute('name',ia),Ba[ia]={id:ia,name:oa,group:E,target:K[Z]};addListener(gina,K[Z],'change',function(ca){ca=ca.target;/select/i.test(ca.type)&&Pa(ca,h)});if(K[Z].options&&
!h.fieldsSet[ia]){oa=0;if(E=K[Z].getAttribute('data-value')||null)for(sa=0,fa=K[Z].options.length;sa<fa;++sa)if(K[Z].options[sa].value==E){oa=sa;K[Z].selectedIndex=oa;break}'undefined'!=typeof K[Z].options[K[Z].selectedIndex]&&K[Z].options[K[Z].selectedIndex].index&&(oa=K[Z].options[K[Z].selectedIndex].index);0<K[Z].options.length&&'undefined'!=typeof K[Z].options[oa]&&(E=K[Z].options[oa].value);h.fieldsSet[ia]={id:ia,name:K[Z].name||null,value:E||null,selectedIndex:oa||0};'undefined'!=typeof K[Z].selectedIndex&&
-1<K[Z].selectedIndex&&(K[Z].options[oa].selected=!0,K[Z].setAttribute('data-value',K[Z].options[oa].value))}}var $a=function(ca,X,ja,va){'undefined'==typeof va&&(va=!1);if('undefined'==typeof Ba[ca])throw Error('Radio & Checkbox dependencies not met: you must use the ID attribue of the `master element` as the `data-gina-form-element-group`');var Ra=ca.replace(/\-|_|@|#|\.|\[|\]/g,'\\$&');ca=Ba[ca].target.checked;for(let Oa in Ba)if(!/radio|checkbox/i.test(Ba[Oa].target.type)){var Xa=new RegExp(Ra);
var eb=new RegExp(X);if(Xa.test(Ba[Oa].group)&&eb.test(Ba[Oa].group)||Xa.test(Ba[Oa].group))Ba[Oa].target.disabled=!0,'undefined'==typeof h.rules[Ba[Oa].name]&&(h.rules[Ba[Oa].name]={}),h.rules[Ba[Oa].name].exclude=!0,va?(Ba[Oa].target.disabled=ca?!1:!0,h.rules[Ba[Oa].name].exclude=ca?!1:!0):(Ba[Oa].target.disabled=ja,h.rules[Ba[Oa].name].exclude=ja)}},ib=function(ca,X,ja,va){'undefined'==typeof va&&(va=!1);if(va&&'undefined'!=typeof Ba[X.id])return ca=/true/i.test(X.checked)?!1:!0,$a(X.id,Ba[X.id].group,
ca,va);ja=X.name;q&&'undefined'==typeof ca.rules[ja]&&(ca.rules[ja]={});/^true$/i.test(X.checked)?q&&(ca.rules[ja].exclude=!1,'undefined'!=typeof Ba[X.id]&&$a(X.id,Ba[X.id].group,!1,va)):q&&(ca.rules[ja].exclude=!0,'undefined'!=typeof Ba[X.id]&&$a(X.id,Ba[X.id].group,!0,va))},Cb=function(ca,X){'undefined'==typeof X&&(X=!1);var ja=function(Oa,wb,lb){if(wb)ib(h,Oa,wb);else for(let hb in Ba)if(eb.test(Ba[hb].group)||eb.test(Ba[hb].target.getAttribute('data-gina-form-element-group')))Ba[hb].target.disabled=
lb};X&&/^(on)$/i.test(ca.value)&&!ca.checked&&(ca.value=!1);var va=ca.getAttribute('data-value')||ca.getAttribute('value')||ca.value;va=/^(true|on)$/.test(va)?!0:va;''===va&&(va=!1);var Ra=/^(true|on|false)$/i.test(va)?!0:!1;X&&Ra&&(/^true$/i.test(va)&&!ca.checked?ca.checked=!0:/^false$/i.test(va)&&ca.checked&&(ca.checked=!1));va=ca.checked;var Xa=ca.getAttribute('data-gina-form-element-group')||null,eb=new RegExp(ca.id.replace(/\-|_|@|#|\.|\[|\]/g,'\\$&'));va&&'null'!=va&&'false'!=va&&''!=va?(X?
...
Mb=document.getElementsByName(ca.name);for(let Xa=0,eb=Mb.length;Xa<eb;++Xa)Mb[Xa].id!==ca.id&&va&&(Mb[Xa].checked=!1,Mb[Xa].removeAttribute('checked'),qb(Mb[Xa],!0));X?qb(ca):(va&&'null'!=va&&'false'!=va&&''!=va?setTimeout(function(){ja?qb(ca):(ca.checked=!1,ca.removeAttribute('checked'))},0):setTimeout(function(){ja?qb(ca):(ca.checked=!0,ca.setAttribute('checked','checked'))},0),Ra&&(ca.value=/^true$/.test(ca.value)?!0:!1))};Z=0;for(da=g.length;Z<da;++Z){K=g[Z].getAttribute('type');if('undefined'==
typeof g[Z].id||''==g[Z].id)g[Z].id=K+'-'+ba.v4(),g[Z].setAttribute('id',g[Z].id);if('undefined'!=typeof K&&/^checkbox$/i.test(K)){if(g[Z].disabled&&-1<ea.indexOf(g[Z].id)||!g[Z].checked&&-1<ea.indexOf(g[Z].id)){K=new RegExp(g[Z].id.replace(/\-|_|@|#|\.|\[|\]/g,'\\$&'));for(var cb in Ba)K.test(Ba[cb].group)&&(Ba[cb].target.disabled=!0)}R='change.'+g[Z].id;K=function(ca,X){addListener(gina,ca,X,function(ja){Cb(ja.target);triggerEvent(gina,ja.target,'changed.'+ja.target.id)});Cb(ca,!0)};'undefined'!=
typeof gina.events[R]&&gina.events[R]==g[Z].id&&removeListener(gina,g[Z],R);K(g[Z],R)}else'undefined'!=typeof K&&/^radio$/i.test(K)&&(R=g[Z].id,K=function(ca,X){addListener(gina,ca,X,function(ja){Ya(ja.target);triggerEvent(gina,ja.target,'changed.'+ja.target.id)});Ya(ca,!0)},'undefined'!=typeof gina.events[R]&&gina.events[R]==g[Z].id&&removeListener(gina,g[Z],R),K(g[Z],R))}R='click';K=function(){var ca=null;ca='reset.'+m.id;'undefined'==typeof gina.events[ca]&&addListener(gina,m,ca,function(X){X.preventDefault();
var ja=w.$forms[X.currentTarget.id||X.target.id];ja.target.dataset.ginaFormIsResetting=!0;T(ja);X=db(ja.target,ja.rules,!0);za(ja.target,X.fields,X.$fields,ja.rules,function(va){var Ra=va.isValid();console.debug('silent reset validation result[isValid:'+Ra+']: ',va);H(ja.target,{});Ka(ja.target,Ra);ja.target.dataset.ginaFormIsResetting=!1})});addListener(gina,m,'reset',function(X){var ja=X.target;if('undefined'!=typeof X.defaultPrevented&&X.defaultPrevented)return!1;X.preventDefault();var va=ja.id;
if(!va)return!1;/^reset\./.test(va)||(va='reset.'+ja.id);gina.events[va]&&triggerEvent(gina,ja,va,X.detail)});addListener(gina,m,'keydown',function(X){var ja=X.target;if('undefined'!=typeof X.defaultPrevented&&X.defaultPrevented)return!1;N[X.keyCode]='keydown'==X.type;var va=ja.id;if(!va)return!1;/^keydown\./.test(va)||(va='keydown.'+ja.id);gina.events[va]&&(cancelEvent(X),triggerEvent(gina,ja,va,X.detail,X))});addListener(gina,m,'keyup',function(X){var ja=X.target;if('undefined'!=typeof X.defaultPrevented&&
X.defaultPrevented)return!1;N[X.keyCode]&&delete N[X.keyCode];var va=ja.id;if(!va)return!1;/^keyup\./.test(va)||(va='keyup.'+ja.id);gina.events[va]&&(cancelEvent(X),triggerEvent(gina,ja,va,X.detail,X))});addListener(gina,m,'focusin',function(X){var ja=X.target;if('undefined'!=typeof X.defaultPrevented&&X.defaultPrevented)return!1;var va=ja.id;if(!va)return!1;/^focusin\./.test(va)||(va='focusin.'+ja.id);gina.events[va]&&(cancelEvent(X),triggerEvent(gina,ja,va,X.detail))});addListener(gina,m,'focusout',
function(X){var ja=X.target;if('undefined'!=typeof X.defaultPrevented&&X.defaultPrevented)return!1;var va=ja.id;if(!va)return!1;/^focusout\./.test(va)||(va='focusout.'+ja.id);gina.events[va]&&(cancelEvent(X),triggerEvent(gina,ja,va,X.detail))});addListener(gina,m,'change',function(X){var ja=X.target;if('undefined'!=typeof X.defaultPrevented&&X.defaultPrevented)return!1;var va=ja.id;if(!va)return!1;/^change\./.test(va)||(va='change.'+ja.id);gina.events[va]&&(cancelEvent(X),triggerEvent(gina,ja,va,
X.detail))});addListener(gina,m,'click',function(X){var ja=X.target,va=!1,Ra=!1;if(/(label)/i.test(X.target.tagName)&&'undefined'!=typeof X.target.control&&null!=X.target.control&&/(checkbox|radio)/i.test(X.target.control.type)||/(label)/i.test(X.target.parentNode.tagName)&&'undefined'!=typeof X.target.parentNode.control&&null!=X.target.parentNode.control&&/(checkbox|radio)/i.test(X.target.parentNode.control.type))Ra=X.target.getAttribute('for')||X.target.parentNode.getAttribute('for')?!0:!1,ja=X.target.control||
...
(ea.form={id:h.id});'undefined'==typeof ea.dataset.ginaFormSubmitTriggerFor&&'undefined'!=typeof w.$forms[h.id]&&'undefined'==typeof w.$forms[h.id].submitTrigger&&'undefined'!=typeof ea.form.id&&h.id==ea.form.id&&(console.debug('attching submitTrigger: '+ea.id,'  form id: '+h.id),w.$forms[h.id].submitTrigger=h.submitTrigger=ea.id||ea.getAttribute('id'),ea.dataset.ginaFormSubmitTriggerFor=h.id)}'A'==ea.tagName&&(K=ea.getAttribute('onclick'),Z=ea.getAttribute('data-gina-form-submit'),K||Z?/return false/i.test(K)||
Z||(K=/;$/.test(K)?K+'return false;':K+'; return false;'):ea.setAttribute('onclick','return false;'));ea.id?R=ea.id:(R='click.'+ba.v4(),ea.id=R,ea.setAttribute('id',R));'undefined'!=typeof gina.events[R]&&gina.events[R]==ea.id||cb(R,ea)}R='submit';addListener(gina,m,R,function(ca){var X=ca.target,ja=X.getAttribute('id'),va=w.$forms[ja],Ra=h.binded;(va=(new DOMParser).parseFromString(X.innerHTML,'text/html').getElementById(va.submitTrigger))&&va.disabled&&cancelEvent(ca);if('undefined'!=typeof ca.defaultPrevented&&
...
(w.$forms[q].submitTrigger=m[p].id||m[p].getAttribute('id'),m[p].dataset.ginaFormSubmitTriggerFor=q);var K=m[p].getAttribute('name');var fa=m[p].disabled||m[p].getAttribute('disabled');fa=/disabled|true/i.test(fa)?!0:!1;if(K&&!fa){if('undefined'!=typeof m[p].type&&'radio'==m[p].type||'undefined'!=typeof m[p].type&&'checkbox'==m[p].type)if(m[p].checked||'undefined'==typeof g[K]&&'undefined'!=m[p].value&&/^(true|false)$/.test(m[p].value)||!m[p].checked&&'undefined'!=typeof g[K]&&'undefined'!=typeof g[K].isBoolean&&
/^(true|false)$/.test(m[p].value))if(/^(true|false)$/.test(m[p].value))if('undefined'==typeof g[K]?g[K]={isBoolean:!0}:'undefined'!=typeof g[K]&&'undefined'==typeof g[K].isBoolean&&(g[K].isBoolean=!0,g[K].isRequired=!0),'radio'==m[p].type){if('undefined'==typeof g[K])throw Error('rule '+K+' is not defined');/^true$/.test(g[K].isBoolean)&&m[p].checked&&(x[K]=/^true$/.test(m[p].value)?!0:!1)}else x[K]=m[p].value=/^true$/.test(m[p].value)?!0:!1;else x[K]=m[p].value;else g&&'undefined'!=typeof g[K]&&
'undefined'!=typeof g[K].isBoolean&&'undefined'!=typeof g[K].isRequired&&!/^(true|false)$/.test(m[p].value)&&(x[K]=!1);else x[K]=m[p].value;'undefined'==typeof b[K]&&(b[K]=m[p],b[K].setAttribute('data-gina-form-errors',''))}}x._length=x.count()||0;return{$fields:b,fields:x,rules:g}},Lb=function(m,g,h,b){return'undefined'==typeof m[h]||/^(null|NaN|undefined|\s*)$/i.test(g[h])?g[h]:'undefined'!=typeof m[h].isNumber||'undefined'!=typeof m[h].isInteger||'undefined'!=typeof m[h].isFloat||'undefined'!=
...
cb,ca,X,ja,va,Ra,Xa){var eb=null;if('undefined'!=typeof va)for(var Oa in X){var wb=ja[Oa].getAttribute('type');if(U&&'undefined'==typeof ja[Oa])console.warn('field `'+Oa+'` found for your form rule ('+Ya.id+'), but not found in $field collection.\nPlease, check your HTML or remove `'+Oa+'` declaration from your rule if this is a mistake.');else{U&&ja[Oa].getAttribute('data-gina-form-element-group')&&'undefined'!=typeof va[Oa]&&'undefined'!=typeof va[Oa].exclude&&va[Oa].exclude&&!ja[Oa].disabled&&
(va[Oa].exclude=!1);var lb='undefined'!=typeof va['_case_'+Oa]?!0:!1;if(U&&'input'==ja[Oa].tagName.toLowerCase()&&/^(checkbox)$/i.test(wb))if(!ja[Oa].checked&&'undefined'!=typeof va[Oa]&&'undefined'!=typeof va[Oa].isRequired&&/^(false)$/i.test(va[Oa].isRequired)||ja[Oa].disabled)va[Oa]={exclude:!0};else{if(!ja[Oa].checked&&'undefined'==typeof va[Oa])continue}else U&&'input'==ja[Oa].tagName.toLowerCase()&&/^(radio)$/i.test(wb)&&console.debug('Radio: ',ja[Oa].id,ja[Oa].checked,ja[Oa].value);for(var hb in va)if(/^_case_/.test(hb)&&
'undefined'!=typeof va[hb].conditions&&(!Array.isArray(va[hb].conditions)||va[hb].conditions.length)&&'undefined'!=typeof va[hb].conditions[0].rules&&'undefined'!=typeof va[hb].conditions&&Array.isArray(va[hb].conditions))if(eb=hb.replace('_case_',''),'undefined'==typeof zb[eb])console.warn('Found case `'+hb+'` but field `'+eb+'` is misssing in the dom.\n You should add `'+eb+'` element to your form in order to allow Validator to process this case.');else{'undefined'==typeof cb[eb]&&(cb[eb]=zb[eb].value);
wb=cb[eb];U&&('true'==X[Oa]?wb=!0:'false'==X[Oa]&&(wb=!1));for(var ob=0,sb=va[hb].conditions.length;ob<sb;++ob)if(va[hb].conditions[ob].case==wb)for(var mb in va[hb].conditions[ob].rules)if(!/^_comment$/i.test(mb)&&mb!=eb&&ja[mb])if(Oa==mb||/^\//.test(mb)||'undefined'!=typeof X[mb]||'undefined'==typeof cb[mb])if(/^\//.test(mb)){if(sa=mb.match(/\/(.*)\//).pop(),ia=mb.replace('/'+sa+'/',''),sa=sa.replace(/\[/g,'\\[').replace(/\]/g,'\\]'),sa=new RegExp(sa,ia),sa.test(Oa)){if(va[hb].conditions[ob].case==
wb||/^\//.test(va[hb].conditions[ob].case)&&(new RegExp(va[hb].conditions[ob].case)).test(wb))Kb='undefined'!=typeof va[mb]?va[mb]:{},va[mb]=Q(va[hb].conditions[ob].rules[mb],Kb);eb!=mb&&'undefined'!=typeof va[mb]&&Ga(mb,va,X)}}else'undefined'!=typeof va[hb].conditions[ob].rules[mb]&&(caseField=mb,wb=X[caseField],'undefined'==typeof ja[caseField]?console.warn('ignoring case `'+caseField+'`: field `NaN'):(U&&/^(true|false)$/i.test(wb)&&'undefined'!=typeof va[caseField]&&'undefined'!=typeof va[caseField].isBoolean&&
...
Oa].conditions;if(!lb)throw Error('[ ginaFormValidator ] case `_case_'+Oa+'` found without `condition(s)` !\nPlease, check your delcaration for `_case_'+Oa+'`');for(let Ib=0,$b=lb.length;Ib<$b;++Ib)if(wb=cb[Oa],U&&('true'==X[Oa]?wb=!0:'false'==X[Oa]&&(wb=!1)),lb[Ib]['case']===wb||Array.isArray(lb[Ib]['case'])&&-1<lb[Ib]['case'].indexOf(wb)||/^\//.test(lb[Ib]['case'])){Kb={};if('undefined'==typeof lb[Ib].rules[Oa]&&'undefined'==typeof cb[Oa]||ja[Oa].disabled)lb[Ib].rules[Oa]={exclude:!0};for(var Eb in lb[Ib].rules)if(!/^_comment$/i.test(Eb))if(/^\//.test(Eb)){sa=
Eb.match(/\/(.*)\//).pop();ia=Eb.replace('/'+sa+'/','');sa=sa.replace(/\[/g,'\\[').replace(/\]/g,'\\]');sa=new RegExp(sa,ia);for(var Gb in ja)sa.test(Gb)&&(/^\//.test(lb[Ib]['case'])?(sa=lb[Ib]['case'].match(/\/(.*)\//).pop(),ia=lb[Ib]['case'].replace('/'+sa+'/',''),sa=new RegExp(sa,ia),sa.test(wb)&&(Kb[Gb]=lb[Ib].rules[Eb])):Kb[Gb]=lb[Ib].rules[Eb],'undefined'==typeof X[Gb]&&'undefined'!=typeof ja[Gb]&&'undefined'!=typeof ja[Gb].value&&(X[Gb]=ja[Gb].value,U&&/(true|false)/i.test(X[Gb])&&('true'==
X[Gb]?X[Gb]=!0:'false'==X[Gb]&&(X[Gb]=!1)),Pa.addField(Gb,X[Gb]),'undefined'!=typeof ca[Gb]&&(Kb[Gb]=Q(Kb[Gb],ca[Gb]))))}else/^\//.test(lb[Ib]['case'])?(sa=lb[Ib]['case'].match(/\/(.*)\//).pop(),ia=lb[Ib]['case'].replace('/'+sa+'/',''),sa=sa.replace(/\[/g,'\\[').replace(/\]/g,'\\]'),sa=new RegExp(sa,ia),sa.test(wb)&&(Kb[Eb]=lb[Ib].rules[Eb])):Kb[Eb]=lb[Ib].rules[Eb],'undefined'==typeof X[Eb]&&'undefined'!=typeof ja[Eb]&&'undefined'!=typeof ja[Eb].value&&(X[Eb]=ja[Eb].value,U&&/(true|false)/i.test(X[Eb])&&
('true'==X[Eb]?X[Eb]=!0:'false'==X[Eb]&&(X[Eb]=!1)),Pa.addField(Eb,X[Eb]),'undefined'!=typeof ca[Eb]&&(Kb[Eb]=Q(Kb[Eb],ca[Eb])));++fa;if(U)Mb(Ya,cb,ca,X,ja,Kb,Ra,Xa);else return Mb(Ya,cb,ca,X,ja,Kb,Ra,Xa)}--Xa}}}--fa;if(0>=Xa&&0>fa){cb=Pa.getErrors();for(Oa in cb){for(rule in cb[Oa])$a[Oa]||($a[Oa]=''),0>$a[Oa].indexOf(rule)&&($a[Oa]+=rule+' ');U&&ja[Oa].setAttribute('data-gina-form-errors',$a[Oa].substr(0,$a[Oa].length-1))}try{R=Na(Pa.toData()),M&&U&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&
(gina.forms.validated||(gina.forms.validated={}),gina.forms.validated[p]||(gina.forms.validated[p]={}),window.ginaToolbar.update('forms',{id:p,validated:R}))}catch(Ib){throw Ib;}Ba=!0;if(!K&&0>=oa)if('undefined'!=typeof Ra&&'function'===typeof Ra)Ra._errors=Pa.getErrors(),Ra._data=Pa.toData(),triggerEvent(gina,Ya,'validated.'+p,Ra);else return K=!0,{isValid:Pa.isValid,error:cb,data:R}}};U&&addListener(gina,m,q,function(Ya){Ya.preventDefault();if(!K){K=!0;Ba=!1;oa=0;var cb=Ya.detail,ca=cb._data||Pa.toData(),
...
define('gina/toolbar','require jquery vendor/uuid lib/collection lib/routing gina/storage gina/validator'.split(' '),function(B){var P=B('jquery');P.noConflict();var V=B('lib/routing');B('lib/collection');var na=B('gina/storage');return function(){var U=null,M=!1,ba=!1,Q=!1,S,r=(new na({bucket:'gina'})).Collection('plugin'),G=null,w=null,ma=!1,Aa=null,N=null,O=null,A=null,D=null,l='',y=null,z=null,F=null,u='',v=null,H=0,J=0,T=0,ra='',Fa={},W=null,ka=null,ha=null,xa=null,la=null,ua=null,Da=null,Qa=
null,La=null,Ea=null,Na=null,Ia=null,Ja=null,Ua=null,pb=function(){G=P('#gina-toolbar');if(!G.length)return!1;Aa=G.find('.gina-toolbar-tab > a');N=P('#gina-toolbar-toggle');O=P('#gina-toolbar-panels');A=O.find('.gina-toolbar-panel');y=P('#gina-toolbar-vposition');z=P('#gina-toolbar-hposition');F=y.add(z);v=P('#gina-toolbar-width');G.find('.gina-toolbar-main');W=P('#gina-toolbar-json');ka=P('#gina-toolbar-gina-json');ha=P('#gina-toolbar-toggle-code-raw');$forms=P('form:not(.gina-toolbar-options, .gina-toolbar-content)');
La=P('#gina-toolbar-data-html');Ea=P('#gina-toolbar-view-html');Na=P('#gina-toolbar-forms-html');Qa=P('#gina-toolbar-configuration-environment-html');Ia=P('#gina-toolbar-code-toggle');G.prepend('<textarea class="gina-toolbar-copy"></textarea>');Ja=G.find('.gina-toolbar-copy');w=r.findOne({_name:'toolbar'});w||(w={_name:'toolbar',_version:'1.0.3',_description:'Toolbar settings',_licence:'MIT',_author:[{name:'John Doe',company:'Acme'},{name:'Martin-Luther Etouman',company:'Rhinostone'}],
position:'top-right',width:'30',panelId:'#gina-toolbar-data',isCollapsed:!0,isUnfolded:[],debug:{forms:{active:!1,strategy:'frontend'}}},r.insert(w),w=r.findOne({_name:'toolbar'}));'1.0.3'!=w._version&&('1.0.1'>w._version&&(w.isUnfolded||(w.isUnfolded=[]),void 0!=w.codeFolding&&delete w.codeFolding),'undefined'==typeof w.isUnfolded||Array.isArray(w.isUnfolded)||(w.isUnfolded=[]),w._version='1.0.3',w.save(!0));u=w.position;H=w.width;l=w.panelId;ma=w.isCollapsed;G.removeClass('gina-toolbar-hidden');
Ub()},ab=function(x,q,p){var R=null,K=null;try{K=W?W.text():'',''==K||'null'==K?W.text('{}'):(la=JSON.parse(K),Da=JSON.parse(ka.text()),W.text(''),xa||(xa={jsonObject:JSON.clone(la),ginaJsonObject:JSON.clone(Da)},ua={}))}catch(oa){console.error('Could not load'+(x?' [ '+x+' ] ':' ')+'json\n'+oa.message+'\n'+oa.stack)}if(la){q&&!p?(la[x]||(la[x]={}),la[x]=Da[x]=q):'data-xhr'==x&&!q&&la['data-xhr']?delete la['data-xhr']:p&&(la=q,Da=p);b(la,'');Da.environment&&(delete Da.environment.routing,delete Da.environment.reverseRouting,
...
da)),Na.find('div.gina-toolbar-section > h2').off('click').on('click',function(oa){oa.preventDefault();P(this).parent().find('ul').first().slideToggle()}));/^(forms)$/.test(x)&&(ba=da=!0,P('#gina-toolbar-form-'+q.id).length||(R=$forms,Na.html(''),Na.html(za(p,K,Na,0,R,R.length,da)),Na.find('div.gina-toolbar-section > h2').off('click').on('click',function(oa){oa.preventDefault();P(this).parent().find('ul').first().slideToggle()})),'undefined'!=typeof q.rules&&m(q.id,'rules',q.rules,da),'undefined'!=
typeof q.errors&&0<q.errors.count()&&m(q.id,'errors',q.errors,da),'undefined'!=typeof q.sent&&m(q.id,'sent',q.sent,da));w.currentFile=la.file;w.currentFile||(w.currentFile=la.file);la.file==w.currentFile&&P(document).ready(function(){ba?(M=!0,0<w.isUnfolded.length&&!S&&(S=!0,setTimeout(function(){0<w.isUnfolded.length&&gb(w.isUnfolded,w.isUnfolded.length,0)},200))):da?(M=!0,0<w.isUnfolded.length&&!S&&(S=!0,gb(w.isUnfolded,w.isUnfolded.length,0))):(M=!1,setTimeout(function(){0<w.isUnfolded.length&&
...
ha.off('click').on('click',function(q){la&&window.open('','JSON RAW','width=400,height=100').document.write(JSON.stringify(la.data))});Aa.off('click').on('click',function(q){q.preventDefault();Aa.removeClass('gina-toolbar-active');A.removeClass('gina-toolbar-active');P(this).addClass('gina-toolbar-active');l=P(this).attr('href');D=P(l).addClass('gina-toolbar-active');w.panelId=l;w.save()});N.off('click').on('click',function(q){q.preventDefault();G.toggleClass('gina-toolbar-collapsed');ma=G.hasClass('gina-toolbar-collapsed');
w.isCollapsed=ma;w.save()});F.off('change').on('change',function(q){q.preventDefault();q=y.val();var p=z.val();u=q+'-'+p;Zb(u);w.position=u;w.save()});v.off('change').on('change',function(q){q.preventDefault();H=v.val();jb(H);w.width=H;w.save()});P(window).off('resize').on('resize',function(){Db()});P('body').off('keypress').on('keypress',function(q){if(!/INPUT|TEXTAREA/.test(q.target.tagName)){ra=q.keyCode?q.keyCode:q.which?q.which:q.charCode;q=new Date;if('undefined'!=typeof Fa.keynum&&Fa.keynum==
ra&&'undefined'!=typeof Fa.pressTime&&500>q.getTime()-Fa.pressTime)switch(ra){case 103:G.toggle()}Fa.pressTime=q.getTime();Fa.keynum=ra}});Aa.filter('[href="'+l+'"]').trigger('click');ma||P('#gina-toolbar-toggle').trigger('click');Zb(u);var x=u.split('-');y.val(x[0]);z.val(x[1]);jb(H);v.val(H);Db();x=W?W.text():'';/^\{\{ (.*) \}\}/.test(x)?h(x,ab):ab()},Zb=function(x){G.removeClass('gina-toolbar-top-left gina-toolbar-top-right gina-toolbar-bottom-left gina-toolbar-bottom-right').addClass('gina-toolbar-'+
x)},jb=function(x){G.removeClass('gina-toolbar-auto gina-toolbar-100 gina-toolbar-80 gina-toolbar-60 gina-toolbar-50 gina-toolbar-40 gina-toolbar-30').addClass('gina-toolbar-'+x)},Db=function(){J=window.innerHeight-32;G.find('.gina-toolbar-main').css('max-height',J+'px');var x=D.find('.gina-toolbar-main'),q=x.find('.gina-toolbar-content');T=x.height();T==J?q.addClass('gina-toolbar-content-end'):q.removeClass('gina-toolbar-content-end')},rb=function(x,q,p){'undefined'==typeof p&&(p=!1);if(void 0!=
...
K;for(var ea in x){var da=ea;if('object'!=typeof x[ea]||Array.isArray(x[ea])||null===x[ea])if(Array.isArray(x[ea])){var E=P('#gina-toolbar-view-'+p.substr(0,p.length-1));var oa=E.length?!0:!1;!oa||/^html/.test(p)?(E=P('.'+p),oa=p+ea.replace(/[^A-Za-z0-9_-]/g,'_')+'-',E.append('<li class="gina-toolbar-collection"><a href="#" class="gina-toolbar-key gina-toolbar'+Ba+'-folding-state-'+Ka(ea.replace(/[^A-Za-z0-9_-]/g,'_'),oa.substr(0,oa.length-1))+'">'+ea+' <span>['+x[ea].length+']</span></a><ul> '+Lb(x[ea],
q[ea],oa,E.find('li ul.'+p.substr(0,p.length-1)),da)+'</ul></li>')):(oa=p+ea.replace(/[^A-Za-z0-9_-]/g,'_')+'-',E.find('li.'+p.substr(0,p.length-1)+' ul').append('<li class="gina-toolbar-collection"><a class="gina-toolbar-key gina-toolbar'+Ba+'-folding-state-'+Ka(ea.replace(/[^A-Za-z0-9_-]/g,'_'),oa.substr(0,oa.length-1))+'">'+ea+' <span>['+x[ea].length+']</span></a><ul>'+Lb(x[ea],q[ea],oa,E.find('li ul.'+p.substr(0,p.length-1)),da)+'</ul></li>'));p+=ea.replace(/[^A-Za-z0-9_-]/g,'_')+'-';p=p.substr(0,
...
ea+':</span> <span class="gina-toolbar-value">'+q[ea]+'</span></li>'),K.find('ul.'+p).append('<li class="gina-toolbar-key-value"><span class="gina-toolbar-key">'+ea+':</span> <span class="gina-toolbar-value gina-toolbar-value-type-is-'+da+'">'+x[ea]+'</span></li>')}catch(sa){throw Error('GinaToolbarError: `ul.'+p+'` not found');}}else!p||/^html\-properties/.test(p)?fa.find('.gina-toolbar-properties').append('<li class="gina-toolbar-key-value"><span class="gina-toolbar-key">'+ea+':</span> <span class="gina-toolbar-value gina-toolbar-value-type-is-'+
da+'">'+x[ea]+'</span></li>'):fa.find('ul.'+p.substr(0,p.length-1)).append('<li class="gina-toolbar-key-value"><span class="gina-toolbar-key">'+ea+':</span> <span class="gina-toolbar-value gina-toolbar-value-type-is-'+da+'">'+x[ea]+'</span></li>');else E=P('#gina-toolbar-view-'+p.substr(0,p.length-1)),(oa=E.length?!0:!1)?(oa=p+ea.replace(/[^A-Za-z0-9_-]/g,'_')+'-',E.find('ul.'+p.substr(0,p.length-1)).append('<li class="gina-toolbar-object"><a href="#" class="gina-toolbar-key gina-toolbar'+Ba+'-folding-state-'+
Ka(ea.replace(/[^A-Za-z0-9_-]/g,'_'),oa.substr(0,oa.length-1))+'">'+ea+' <span>{ }</span></a><ul class="gina-toolbar-object '+oa.substr(0,oa.length-1)+'"></ul></li>'),Vb(x[ea],q[ea],oa,R,E.find('ul.'+p.substr(0,p.length-1)),fa),p+=ea.replace(/[^A-Za-z0-9_-]/g,'_')+'-'):(p+=ea.replace(/[^A-Za-z0-9_-]/g,'_')+'-','params'==ea?(da='<div id="gina-toolbar-view-'+p.substr(0,p.length-1)+'" class="gina-toolbar-section"><h2 class="gina-toolbar-section-title">'+p.substr(0,p.length-1)+'</h2><ul class="'+p.substr(0,
...
sa+':</span><span class="gina-toolbar-value">'+ia+'</span></li>'),/^data-gina-form-event/.test(sa)?(da='events',Z=oa.find('.gina-toolbar-form-attributes').find('.gina-toolbar-key-events').length?!0:!1,sa=sa.replace(/^data-gina-form-event-/,''),Z||oa.find('ul.gina-toolbar-section-content').append('<li class="gina-toolbar-form-'+da+'"><h3 class="gina-toolbar-sub-section-title">'+da+'</h3><ul class="gina-toolbar-code"></ul></li>'),Z='<li><span class="gina-toolbar-key">'+sa+':</span><span class="gina-toolbar-value">'+
ia+'</span></li>',oa.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-'+da+' > ul').append(Z)):(/^action$/.test(sa)||(Z='<li><span class="gina-toolbar-key">'+sa+':</span><span class="gina-toolbar-value">'+ia+'</span></li>'),oa.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-attributes > ul').append(Z));ea=null;try{var $a=K[R].getAttribute('data-gina-form-rule');ea='undefined'!=typeof $a&&null!=$a?eval('gina.forms.rules.'+$a.replace(/-/g,'.')):eval('gina.forms.rules.'+
E.replace(/-/g,'.'))}catch(ib){}ea&&(da='rules',oa.find('ul.gina-toolbar-section-content').append('<li class="gina-toolbar-form-'+da+'"><h3 class="gina-toolbar-sub-section-title">'+da+'</h3><ul class="gina-toolbar-properties">'+db(ea,ea,E,Ba,da)+'</ul></li>'));p.append(oa);++R;R<fa&&za(x,q,p,R,K,fa,Ba)},m=function(x,q,p,R){var K=P('#gina-toolbar-form-'+x);$section=K.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-'+q+'> ul');if(0<$section.length){if(0==p.count())return K.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-'+
...
define('gina','require vendor/uuid lib/merge utils/events helpers/prototypes helpers/dateFormat gina/toolbar'.split(' '),function(B){B('utils/events');var P=B('lib/merge'),V=B('helpers/dateFormat')();B('helpers/prototypes')({dateFormat:V});var na=B('vendor/uuid');window.process||function(U,M,ba,Q,S,r,G){for(r=U[ba]||(U[ba]={});!G&&S<Q.length;)G=U[Q[S++]+'requestAnimationFrame'];r[M]=r[M]||G&&G.bind(U)||U.setImmediate||U.setTimeout}(window,'nextTick','process',['r','webkitR','mozR','msR','oR'],0);
window.getComputedStyle||(window.getComputedStyle=function(U,M){this.el=U;this.getPropertyValue=function(ba){var Q=/(\-([a-z]){1})/g;'float'==ba&&(ba='styleFloat');Q.test(ba)&&(ba=ba.replace(Q,function(S,r,G){return G.toUpperCase()}));return U.currentStyle[ba]?U.currentStyle[ba]:null};return this});return function(U){this.plugin='gina';var M='gina-'+na.v1(),ba=document,Q;document.id=M;M={id:M,isFrameworkLoaded:!1,hasValidator:!1,hasPopinHandler:!1,config:{},session:null,registeredEvents:{},events:{},
setOptions:function(S){Q=P(Q,S,!0)}};'undefined'!=typeof parent.window.gina&&(window.gina=P(window.gina||{},parent.window.gina));M=P(window.gina||{},M);registerEvents(this.plugin,['ginaloaded','ready']);triggerEvent(U,ba,'ginaloaded',M)}});
...
return ya}function ma(ya){var za=S();return function(){var m=ba(ya);if(za){var g=ba(this).constructor;m=Reflect.construct(m,arguments,g)}else m=m.apply(this,arguments);return!m||'object'!=typeof m&&'function'!=typeof m?w(this):m}}function Aa(ya,za,m){return Aa='undefined'!=typeof Reflect&&Reflect.get?Reflect.get:function(g,h,b){for(;!Object.prototype.hasOwnProperty.call(g,h)&&null!==(g=ba(g)););if(g)return h=Object.getOwnPropertyDescriptor(g,h),h.get?h.get.call(b):h.value},Aa(ya,za,m||ya)}function N(ya){if(ya){for(var za in N.prototype)ya[za]=
N.prototype[za];return ya}}function O(ya){for(var za=arguments.length,m=Array(1<za?za-1:0),g=1;g<za;g++)m[g-1]=arguments[g];return m.reduce(function(h,b){return ya.hasOwnProperty(b)&&(h[b]=ya[b]),h},{})}function A(ya,za){za.useNativeTimers?(ya.setTimeoutFn=Na.bind(Ea),ya.clearTimeoutFn=Ia.bind(Ea)):(ya.setTimeoutFn=setTimeout.bind(Ea),ya.clearTimeoutFn=clearTimeout.bind(Ea))}function D(ya){var za='';do za=pb[ya%64]+za,ya=Math.floor(ya/64);while(0<ya);return za}function l(){var ya=D(+new Date);return ya!==
...
':'),x.ipv6uri=!0),x.pathNames=function(p,R){p=R.replace(/\/{2,9}/g,'/').split('/');'/'!=R.substr(0,1)&&0!==R.length||p.splice(0,1);'/'==R.substr(R.length-1,1)&&p.splice(p.length-1,1);return p}(0,x.path),x.queryKey=(h=x.query,b={},h.replace(/(?:^|&)([^&=]*)=?([^&]*)/g,function(p,R,K){R&&(b[R]=K)}),b),x}var J=Object.create(null);J.open='0';J.close='1';J.ping='2';J.pong='3';J.message='4';J.upgrade='5';J.noop='6';var T=Object.create(null);Object.keys(J).forEach(function(ya){T[J[ya]]=ya});for(var ra=
{type:'error',data:'parser error'},Fa='function'==typeof Blob||'undefined'!=typeof Blob&&'[object BlobConstructor]'===Object.prototype.toString.call(Blob),W='function'==typeof ArrayBuffer,ka=function(ya,za,m){var g=ya.type;ya=ya.data;return Fa&&ya instanceof Blob?za?m(ya):ha(ya,m):W&&(ya instanceof ArrayBuffer||('function'==typeof ArrayBuffer.isView?ArrayBuffer.isView(ya):ya&&ya.buffer instanceof ArrayBuffer))?za?m(ya):ha(new Blob([ya]),m):m(J[g]+(ya||''))},ha=function(ya,za){var m=new FileReader;
return m.onload=function(){var g=m.result.split(',')[1];za('b'+g)},m.readAsDataURL(ya)},xa='undefined'==typeof Uint8Array?[]:new Uint8Array(256),la=0;64>la;la++)xa['ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'.charCodeAt(la)]=la;var ua='function'==typeof ArrayBuffer,Da=function(ya,za){if('string'!=typeof ya)return{type:'message',data:Qa(ya,za)};var m=ya.charAt(0);if('b'===m){ya=ya.substring(1);if(ua){var g=.75*ya.length;m=ya.length;var h=0;'='===ya[ya.length-1]&&(g--,'='===ya[ya.length-
2]&&g--);var b=new ArrayBuffer(g),x=new Uint8Array(b);for(g=0;g<m;g+=4){var q=xa[ya.charCodeAt(g)];var p=xa[ya.charCodeAt(g+1)];var R=xa[ya.charCodeAt(g+2)];var K=xa[ya.charCodeAt(g+3)];x[h++]=q<<2|p>>4;x[h++]=(15&p)<<4|R>>2;x[h++]=(3&R)<<6|63&K}za=Qa(b,za)}else za={base64:!0,data:ya};za={type:'message',data:za}}else za=T[m]?1<ya.length?{type:T[m],data:ya.substring(1)}:{type:T[m]}:ra;return za},Qa=function(ya,za){return'blob'===za&&ya instanceof ArrayBuffer?new Blob([ya]):ya},La=String.fromCharCode(30);
N.prototype.on=N.prototype.addEventListener=function(ya,za){return this._callbacks=this._callbacks||{},(this._callbacks['$'+ya]=this._callbacks['$'+ya]||[]).push(za),this};N.prototype.once=function(ya,za){function m(){this.off(ya,m);za.apply(this,arguments)}return m.fn=za,this.on(ya,m),this};N.prototype.off=N.prototype.removeListener=N.prototype.removeAllListeners=N.prototype.removeEventListener=function(ya,za){if(this._callbacks=this._callbacks||{},0==arguments.length)return this._callbacks={},this;
...
N.prototype.emitReserved=N.prototype.emit;N.prototype.listeners=function(ya){return this._callbacks=this._callbacks||{},this._callbacks['$'+ya]||[]};N.prototype.hasListeners=function(ya){return!!this.listeners(ya).length};var Ea='undefined'!=typeof self?self:'undefined'!=typeof window?window:Function('return this')(),Na=setTimeout,Ia=clearTimeout,Ja,Ua=function(ya){function za(g,h,b){var x;return P(this,za),(x=m.call(this,g)).description=h,x.context=b,x.type='TransportError',x}M(za,ya);var m=ma(za);
return za}(G(Error));la=function(ya){function za(g){var h;return P(this,za),(h=m.call(this)).writable=!1,A(w(h),g),h.opts=g,h.query=g.query,h.readyState='',h.socket=g.socket,h}M(za,ya);var m=ma(za);return na(za,[{key:'onError',value:function(g,h,b){return Aa(ba(za.prototype),'emitReserved',this).call(this,'error',new Ua(g,h,b)),this}},{key:'open',value:function(){return'closed'!==this.readyState&&''!==this.readyState||(this.readyState='opening',this.doOpen()),this}},{key:'close',value:function(){return'opening'!==
...
za}(la);var jb=function(ya){function za(g,h){var b;return P(this,za),A(w(b=m.call(this)),h),b.opts=h,b.method=h.method||'GET',b.uri=g,b.async=!1!==h.async,b.data=void 0!==h.data?h.data:null,b.create(),b}M(za,ya);var m=ma(za);return na(za,[{key:'create',value:function(){var g=this,h=O(this.opts,'agent','pfx','key','passphrase','cert','ca','ciphers','rejectUnauthorized','autoUnref');h.xdomain=!!this.opts.xd;h.xscheme=!!this.opts.xs;var b=this.xhr=new F(h);try{b.open(this.method,this.uri,this.async);
...
Ea?'pagehide':'unload',v,!1);var Db='function'==typeof Promise&&'function'==typeof Promise.resolve?function(ya){return Promise.resolve().then(ya)}:function(ya,za){return za(ya,0)},rb=Ea.WebSocket||Ea.MozWebSocket,xb='undefined'!=typeof navigator&&'string'==typeof navigator.product&&'reactnative'===navigator.product.toLowerCase(),Ka={websocket:function(ya){function za(g){var h;return P(this,za),(h=m.call(this,g)).supportsBinary=!g.forceBase64,h}M(za,ya);var m=ma(za);return na(za,[{key:'doOpen',value:function(){if(this.check()){var g=
...
!1))),h.open(),h}M(za,ya);var m=ma(za);return na(za,[{key:'createTransport',value:function(g){var h=U({},this.opts.query);h.EIO=4;h.transport=g;this.id&&(h.sid=this.id);h=U({},this.opts.transportOptions[g],this.opts,{query:h,socket:this,hostname:this.hostname,secure:this.secure,port:this.port});return new Ka[g](h)}},{key:'open',value:function(){var g=this;if(this.opts.rememberUpgrade&&za.priorWebsocketSuccess&&-1!==this.transports.indexOf('websocket'))var h='websocket';else{if(0===this.transports.length)return void this.setTimeoutFn(function(){g.emitReserved('error',
...
function Domain(B,P){var V='undefined'!==typeof module&&module.exports?!1:!0,na=!1;V&&(na=!!window.MSInputMethodContext&&!!document.documentMode);'function'==typeof B&&(P=B,B=void 0);var U={filename:'../dist/public_suffix_list.dat',url:'https://publicsuffix.org/list/public_suffix_list.dat',alternativeUrl:'https://raw.githubusercontent.com/publicsuffix/list/master/public_suffix_list.dat',isCachingRequired:!1,isUpdating:!1},M=null,ba=null,Q=function(Aa,N,O){if('undefined'==typeof N)N=U;else for(let A in U)'undefined'==
typeof N[A]&&(N[A]=U[A]);V||(N.filename=__dirname+'/'+N.filename);V&&N.isCachingRequired&&(console.warn('[DOMAIN] `options.isCachingRequired` is only available for backend'),N.isCachingRequired=!1);M=N;if(O)return r(N,function(A){A?O(A):(console.debug('[DOMAIN] PSL Loaded'),O(A,Aa))});r(N);console.debug('[DOMAIN] PSL Loaded');return Aa},S=function(){},r=async function(Aa,N){var O=V||Aa.isCachingRequired?Aa.url:Aa.filename,A='undefined'!=typeof Aa.isUpdating?Aa.isUpdating:!1,D=null;if(V)if(ba&&!A)N(!1);
else if(window.fetch){D=A=null;try{A=await fetch(O),ba=D=await A.text()}catch(y){D=Error('[DOMAIN] Could not load PSL\n'+(y.stack||y.message||y));N(D);return}Aa.isUpdating=!1;N(!1)}else D=Error('[DOMAIN] Fetch API not supported'),N(D);else{O=!1;if('undefined'!=typeof fs.accessSync)try{fs.accessSync(Aa.filename,fs.constants.F_OK),O=!0}catch(y){O=!1;try{fs.lstatSync(Aa.filename).isSymbolicLink()&&(O=!0)}catch(z){}}else O=fs.existsSync(Aa.filename);O||(Aa.isCachingRequired=!0);if(Aa.isCachingRequired){O=
'curl -o '+Aa.filename+' '+Aa.url+' >/dev/null 2>&1';console.debug('[DOMAIN] Running: '+O);try{execSync(O)}catch(y){console.warn('[DOMAIN] could not fetch from `'+Aa.url+'`. Trying with `'+Aa.alternativeUrl+'`');O='curl -o '+Aa.filename+' '+Aa.alternativeUrl+' >/dev/null 2>&1';try{execSync(O)}catch(z){N(z);return}}var l=!1;nIntervId=setInterval(()=>{if('undefined'!=typeof fs.accessSync)try{fs.accessSync(Aa.filename,fs.constants.F_OK),l=!0}catch(y){l=!1;try{fs.lstatSync(Aa.filename).isSymbolicLink()&&
(l=!0)}catch(z){}}else l=fs.existsSync(Aa.filename);l&&(clearInterval(nIntervId),ba=fs.readFileSync(Aa.filename).toString(),N(!1))},200)}try{ba=fs.readFileSync(Aa.filename).toString(),N&&N(!1)}catch(y){console.warn('[DOMAIN] could not read from `'+Aa.filename+'`'),r(B,N)}}},G=function(Aa){M.isUpdating=!0;r(M,Aa)},w=async function(Aa){Aa='undefined'!=typeof Aa&&''!=Aa?Aa:os.hostname();if(/\./.test(Aa))return Aa;console.debug('[DOMAIN][getFQDN] FQDN: '+Aa);var N=null,O=null;N=await promisify(dns.lookup)(Aa,
{hints:dns.ADDRCONFIG||dns.V4MAPPED}).then(function(A){console.debug('[DOMAIN][getFQDN] IP: '+A.address);console.debug('[DOMAIN][getFQDN] FAMILY: '+A.family);return A}).catch(function(A){O=A});if(O)throw O;Aa=await promisify(dns.lookupService)(N.address,0).then(function(A){console.debug('[DOMAIN][getFQDN] FQDN: '+A.hostname);console.debug('[DOMAIN][getFQDN] Service: '+A.service);return A.hostname}).catch(function(A){});if(O)throw O;if(!/\./.test(Aa))throw Error('[DOMAIN][getFQDN] `'+Aa+'` is not a FQDN !');
return Aa},ma={getRootDomain:function(Aa,N){'undefined'==typeof N&&(N=!1);Aa=Aa.trim();var O=!1,A=!1,D=Aa.replace(/^(.*):\/\/|\/(.*)/g,''),l=D.split(/\./g).reverse(),y=l.length?l.length-1:0,z=ba.replace(/\/\/\s*(.*)\n|^\s*\n/gm,'').split(/\n/).filter(function(F,u,v){/[^a-z 0-9.]+/.test(F)&&(F=F.replace(/[^a-z 0-9.]+/g,'').replace(/^\./g,''));return/\./.test(F)&&!O&&(new RegExp('.'+F+'$')).test(D)?(O=!0,y=F.split(/\./g).length,v.splice(0,v.length),!1):F});D=l[y];0<y&&(l=l.splice(0,y),A=l[0],/:(.*)$/.test(A)&&
(A=A.replace(/:(.*)$/,'')),(A=O||!O&&-1<z.indexOf(A)?!0:!1)?1<y&&!O?(l.splice(2),D=l.reverse().join('.')):D+='.'+l.reverse().join('.'):1<y?(l.splice(2),D=l.reverse().join('.')):D+='.'+l.reverse().join('.'));/:(.*)$/.test(D)&&(D=D.replace(/:(.*)$/,''));console.debug('[DOMAIN] isSLD: '+O,Aa,' -> ',D);/^true$/i.test(N);return{value:D,isSLD:O,isRegisteredTldOrSld:A}}};V?ma.onReady=S:(ma.updatePSL=G,ma.getFQDN=w);return V&&na&&!window.fetch?(na=document.createElement('script'),na.type='text/javascript',
na.src='https://cdn.jsdelivr.net/npm/promise-polyfill@8.1.3/dist/polyfill.min.js',S=document.createElement('script'),S.type='text/javascript',S.src='https://cdn.jsdelivr.net/npm/whatwg-fetch@3.4.0/dist/fetch.umd.min.js',document.head.appendChild(na),document.head.appendChild(S),setTimeout(()=>Q(ma,B,P),500)):Q(ma,B,P)}'undefined'!==typeof module&&module.exports?module.exports=Domain:'function'===typeof define&&define.amd&&define('lib/domain',[],function(){return Domain});
define('gina/link','require jquery vendor/uuid lib/domain lib/merge utils/events'.split(' '),function(B){B('jquery').noConflict();var P=B('vendor/uuid'),V=B('lib/domain'),na=null,U=B('lib/merge');B('utils/events');return function(M){function ba(l,y){var z=A(l),F=z.id,u=document.getElementById(F)||null;(u.getAttribute('data-gina-link-event-on-success')||u.getAttribute('data-gina-link-event-on-error'))&&listenToXhrEvents(z);y='undefined'==typeof y?ma:U(y,ma);if(/^(http|https):/.test(l)&&!(new RegExp('^'+
window.location.protocol+'//'+window.location.host)).test(l)){var v=na.getRootDomain(window.location.hostname).value,H=na.getRootDomain(l).value;v=v===H?!0:!1;gina.config.envIsDev&&(console.debug('Checking CORS from Popin plugin...TODO - local CORS Proxy'),console.debug('Is request from same domain ? ',v));v||(l=l.match(/^(https|http):/)[0]+'//corsacme.herokuapp.com/?'+l)}y.url=l;z&&'undefined'!=typeof z.options&&(y=U(z.options,y));y.withCredentials?'withCredentials'in w?y.isSynchrone?w.open(y.method,
...
typeof z[F].tagName&&N(z[F],y,evt)}l.request=ba;l.getLinkById=O;l.getLinkByUrl=A;r.$links[l.id]=l}}this.plugin='link';registerEvents(this.plugin,'loaded ready open close destroy success error progress'.split(' '));var S={options:{url:void 0,'class':'gina-link-default'},authorizedEvents:['ready','success','error'],events:{}},r={plugin:this.plugin,id:'gina-links-'+P.v4(),on,eventData:{},$links:{},target:document,isReady:!1,initialized:!1},G={plugin:this.plugin,on,eventData:{},target:document,url:null,
request:null,$forms:[]},w=null,ma={url:'',method:'GET',isSynchrone:!1,withCredentials:!0,headers:{'X-Requested-With':'XMLHttpRequest'}},Aa=[],N=function(l,y,z){addListener(gina,l,'click',function(F){cancelEvent(F);triggerEvent(gina,y,z)})},O=function(l){return'undefined'!=typeof r.$links[l]?r.$links[l]:null},A=function(l){var y=null,z;for(z in gina.link.$links)if('undefined'!=typeof gina.link.$links[z].url&&gina.link.$links[z].url==l){y=gina.link.$links[z];break}return y},D=function(l,y){'undefined'==
typeof l&&(l=r.target);var z,F=null;l=l.getElementsByTagName('a');for(var u=0,v=l.length;u<v;++u)if(((z=l[u].getAttribute('data-gina-link'))||''==z)&&!/^false$/i.test(z)){z=l[u];var H={type:'a',method:'GET'};var J=z.getAttribute('data-gina-link-url');H.url='undefined'!=typeof J&&null!=J?J:z.getAttribute('href');J=z.getAttribute('id');if('undefined'==typeof J||null==J||''==J||/popin\.link/.test(J))J='link.click.gina-link-'+r.id+'-'+P.v4();z.id=J;evt=H.id=J;z.setAttribute('id',evt);'A'==z.tagName&&
(F=z.getAttribute('onclick'));F?'undefined'==typeof F||/return false/.test(F)||(F=/;$/.test(F)?F+'return false;':F+'; return false;',z.setAttribute('onclick',F)):z.setAttribute('onclick','return false;');'undefined'==typeof r.$links[H.id]&&(H.target=z,z=U(H,G),Q(z,y))}};new V(function(l,y){if(l)throw l;na=y});return function(l){r.bindLinks=D;r.request=ba;r.getLinkById=O;r.getLinkByUrl=A;r.on('init',function(y){if(window.XMLHttpRequest)w=new XMLHttpRequest;else if(window.ActiveXObject)try{w=new ActiveXObject('Msxml2.XMLHTTP')}catch(z){try{w=
...
gina.link=U(gina.link,r);triggerEvent(gina,r.target,'ready.'+r.id,r)});r.initialized=!0;return r}(M)}});
...
Ka.target.id=Ka.target.getAttribute('id')),/^popin\.close\./.test(Ka.target.id)&&(cancelEvent(Ka),ka.isRedirecting=!1,O(ka.name)),/^popin\.click\./.test(Ka.target.id)&&(cancelEvent(Ka),db=Ka.target.id,(new RegExp('^popin.click.gina-popin-'+l.id)).test(db)&&triggerEvent(gina,Ka.target,db,Ka.detail))})};gina.popinIsBinded=!0;var la=null,ua=null,Da=null;if(!ka.isOpen&&D.options.cancelOnOverlayClick){var Qa=ka.target;if(!D.options.useDialogMode||gina.config.envIsDev)Qa=l.target.childNodes[0];addListener(gina,
...
(jb[la]=Db[ua],++la);ua=0;for(Da=jb.length;ua<Da;++ua){Db=jb[ua];let rb=Db.getAttribute('id');for(let xb=0,Ka=A.length;xb<Ka;xb++){let db=A[xb];'undefined'!=typeof gina.events[db]&&gina.events[db]==rb&&removeListener(gina,Db,db);'undefined'!=typeof gina.events[rb]&&gina.events[rb]==rb&&removeListener(gina,Db,rb);'undefined'!=typeof gina.events[db+'.'+rb]&&gina.events[db+'.'+rb]==rb&&removeListener(gina,Db,db+'.'+rb);'undefined'!=typeof gina.events[db+'.'+rb]&&gina.events[db+'.'+rb]==db+'.'+rb&&removeListener(gina,
Db,db+'.'+rb)}}ka.isRedirecting=!1;O(ka.name)}})}/<form/i.test(ha.innerHTML)&&'undefined'!=typeof z&&z&&(ka.hasForm=!0);var La=[],Ea=[];Qa=[];Ea=ha.getElementsByTagName('button');ua=la=0;Da=Ea.length;if(0<Ea.length)for(;ua<Da;++ua)/gina-popin-close/.test(Ea[ua].className)&&(La[la]=Ea[ua],++la);Ea=ha.getElementsByTagName('div');ua=0;Da=Ea.length;if(0<Da)for(;ua<Da;++ua)/gina-popin-close/.test(Ea[ua].className)&&(La[la]=Ea[ua],++la);Ea=ha.getElementsByTagName('a');ua=0;Da=Ea.length;if(0<Da)for(;ua<
...
null;if(null==ua){var Da=null;D.options.useDialogMode?(Da=xa.options.class+' '+la,ua=document.createElement('dialog'),ua.setAttribute('id',la),ua.setAttribute('class',Da),ua.setAttribute('data-type','modal'),ua.setAttribute('aria-labelledby',W),($overlay=document.getElementById('gina-popins-overlay'))?$overlay.appendChild(ua):l.target.appendChild(ua)):(Da=xa.options.class+' '+la,ua=document.createElement('div'),ua.setAttribute('id',la),ua.setAttribute('class',Da),l.target.firstChild.appendChild(ua))}'undefined'==
typeof ha?ha=Fa:(W=Fa.withCredentials,ha=U(ha,Fa),ha.withCredentials=W);/^(http|https):/.test(ka)&&!(new RegExp('^'+window.location.protocol+'//'+window.location.host)).test(ka)&&(W=na.getRootDomain(window.location.hostname).value,Da=na.getRootDomain(ka).value,W=W===Da?!0:!1,gina.config.envIsDev&&(console.debug('Checking CORS from Popin plugin...TODO - local CORS Proxy'),console.debug('Is request from same domain ? ',W)),W||(ka=ka.match(/^(https|http):/)[0]+'//corsacme.herokuapp.com/?'+ka,ha.withCredentials=
!1));ha.url=ka;xa.options=U(ha,xa.options);var Qa=null;ha.withCredentials?'withCredentials'in F?ha.isSynchrone?F.open(ha.method,ha.url,ha.isSynchrone):F.open(ha.method,ha.url):'undefined'!=typeof XDomainRequest?(F=new XDomainRequest,F.open(ha.method,ha.url)):(F=null,Qa='CORS not supported: the server is missing the header `"Access-Control-Allow-Credentials": true` ',triggerEvent(gina,ua,'error.'+la,Qa)):ha.isSynchrone?F.open(ha.method,ha.url,ha.isSynchrone):F.open(ha.method,ha.url);var La=!1;if(F){F.withCredentials=
'undefined'!=typeof ha.withCredentials?ha.withCredentials:!1;F.onerror=function(Na,Ia){Qa={status:F.status,error:'Transaction error: might be due to the server CORS settings.\nPlease, check the console for more details.'};La=!0;l.eventData.error=Qa+'\n'+Ia;S(Qa,La);triggerEvent(gina,ua,'error.'+la,Qa)};for(var Ea in ha.headers)F.setRequestHeader(Ea,ha.headers[Ea]);F.onreadystatechange=function(Na){if(4==F.readyState)if(Na=null,/^2/.test(F.status))try{Na=F.responseText;var Ia=F.getResponseHeader('Content-Type'),
...
La=!0),l.eventData.error=Na,GINA_ENV_IS_DEV&&S(Na,La),triggerEvent(gina,ua,'error.'+la,Na)}else La=!1,Na={status:F.status,error:F.responseText},/application\/json/.test(F.getResponseHeader('Content-Type'))&&(Na.error=JSON.parse(F.responseText),La=!0),l.eventData.error=Na,GINA_ENV_IS_DEV&&S(Na,La),triggerEvent(gina,ua,'error.'+la,Na)};F.send();return{open:function(){var Na=!1;addListener(gina,ua,'loaded.'+la,function(Ia){Ia.preventDefault();Na||(Na=!0,l.activePopinId=xa.id,Q(Ia,xa),Aa(xa.name))})}}}}
function G(W,ka){var ha=ba();if(ha){if(!ha.isOpen)throw Error('Popin `'+ha.name+'` is not open !');ha.isRedirecting='undefined'!=typeof ka?ka:!1;ka=ha.target;ka.innerHTML=W.trim();N(ha.name,!0);Q({target:ka,type:'loaded.'+ha.id},ha);if(!D.options.useDialogMode&&/safari/i.test(window.navigator.userAgent))for(W=document.getElementsByTagName('link'),ka=0;ka<W.length;ka++)if('stylesheet'==W[ka].getAttribute('rel')){var xa=W[ka].getAttribute('href').split('?')[0];/gina\.min\.css|gina\.css/.test(xa)&&(xa=
xa+'?version='+(new Date).getMilliseconds(),W[ka].setAttribute('href',xa))}ha.isRedirecting?triggerEvent(gina,l.target,'loaded.'+ha.id,ha):triggerEvent(gina,l.target,'open.'+ha.id,ha);if(gina&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar)try{ginaToolbar.update('el-xhr',ha.id)}catch(la){throw la;}}}function w(W){var ka=setupXhr();ka.open('GET',W,!0);ka.setRequestHeader('Content-Type','text/javascript');ka.onload=function(){eval(ka.response)};ka.send()}function ma(W){var ka=setupXhr();
...
La);Da<Qa;++Da){if('undefined'==typeof xa[Da].src||''==xa[Da].src)continue;let Ea=xa[Da].src.replace(/(https|http|):\/\//,'').replace(La,'');-1<ha.indexOf(Ea)||w(xa[Da].src)}Da=0;for(Qa=ua.length;Da<Qa;++Da)'undefined'!=typeof ua[Da].href&&''!=ua[Da].href&&(ha=ua[Da].href.replace(/(https|http|):\/\//,'').replace(La,''),-1<la.indexOf(ha)||ma(ua[Da].href));Q({target:W,type:'loaded.'+ka.id},ka);/gina-popin-is-active/.test(W.className)||(W.className+=' gina-popin-is-active');if(!D.options.useDialogMode||
...
W.appendChild(ka)}document.body.appendChild(W);l.target=W;l.on=on;gina.popinContainer=l.id},H=function(W,ka,ha){addListener(gina,W,'click',function(xa){cancelEvent(xa);triggerEvent(gina,ka,ha)})},J=function(W){return'undefined'!=typeof l.$popins[W]?l.$popins[W]:null},T=function(W){var ka=null,ha;for(ha in l.$popins)if(l.$popins[ha].name===W){ka=l.$popins[ha];break}return ka},ra=function(W,ka){ka=getElementsByAttribute('data-gina-popin-name');var ha=null,xa=null,la=null,ua=null,Da=null,Qa=null;Da=
0;for(Qa=ka.length;Da<Qa;++Da){ha=ka[Da];xa=ha.getAttribute('data-gina-popin-name');'A'==ha.tagName&&(la=ha.getAttribute('href'),''==la||'#'==la||/#/.test(la))&&(la=null);la||'undefined'==typeof ha.getAttribute('data-gina-popin-url')||(la=ha.getAttribute('data-gina-popin-url'));if(!la)throw Error('Found `data-gina-popin-name` without `url` !');ha.url||(ha.url=la);ha.popinName||(ha.popinName=xa);if(xa==W.name&&(ua='popin.click.gina-popin-'+l.id+'-'+P.v4()+'-'+xa,ha.id=ua,ha.setAttribute('id',ua),!gina.events[ua])){addListener(gina,
...
for(let Da=0,Qa=la.length;Da<Qa;Da++)if(la[Da].src&&''!=la[Da].src){var ua=la[Da].src.replace(/(https|http|):\/\//,'').replace(xa,'');ha.parentScripts[Da]=ua}la=document.getElementsByTagName('link');for(let Da=0,Qa=la.length;Da<Qa;Da++)'undefined'!=typeof la[Da].rel&&/stylesheet/i.test(la[Da].rel)&&(ua=la[Da].href.replace(/(https|http|):\/\//,'').replace(xa,''),ha.parentStyles[Da]=ua);l.$popins[ha.id]=ha;if(window.XMLHttpRequest)F=new XMLHttpRequest;else if(window.ActiveXObject)try{F=new ActiveXObject('Msxml2.XMLHTTP')}catch(Da){try{F=
new ActiveXObject('Microsoft.XMLHTTP')}catch(Qa){}}ra(ha)}}l.isReady=!0;gina.hasPopinHandler=!0;gina.popin=U(gina.popin,l);triggerEvent(gina,l.target,'ready.'+l.id,ka)});l.initialized=!0;return l}(M)}});
'function'!==typeof Object.assign&&Object.defineProperty(Object,'assign',{value:function(B,P){if(null===B||void 0===B)throw new TypeError('Cannot convert undefined or null to object');for(var V=Object(B),na=1;na<arguments.length;na++){var U=arguments[na];if(null!==U&&void 0!==U)for(var M in U)Object.prototype.hasOwnProperty.call(U,M)&&(V[M]=U[M])}return V},writable:!0,configurable:!0});
if('undefined'==typeof JSON.clone){var clone=function(B,P){if(null==B||'object'!=typeof B||B.constructor!=Object&&B.constructor!=Array)return B;if(B.constructor==Date||B.constructor==RegExp||B.constructor==Function||B.constructor==String||B.constructor==Number||B.constructor==Boolean)return new B.constructor(B);P=P||new B.constructor;for(var V=0,na=Object.getOwnPropertyNames(B).length||0,U=Object.keys(B);V<na;)P[U[V]]='undefined'==typeof P[U[V]]?clone(B[U[V]],null):P[U[V]],V++;return P};JSON.clone=
