...
(function(A,P){function V(Ia,Ja){return Ja||''}function na(Ia){return'[object Function]'===Fa.call(Ia)}function U(Ia){return'[object Array]'===Fa.call(Ia)}function M(Ia,Ja){if(Ia){var Ua;for(Ua=0;Ua<Ia.length&&(!Ia[Ua]||!Ja(Ia[Ua],Ua,Ia));Ua+=1);}}function aa(Ia,Ja){if(Ia){var Ua;for(Ua=Ia.length-1;-1<Ua&&(!Ia[Ua]||!Ja(Ia[Ua],Ua,Ia));--Ua);}}function Q(Ia,Ja){return W.call(Ia,Ja)}function S(Ia,Ja){return Q(Ia,Ja)&&Ia[Ja]}function u(Ia,Ja){for(var Ua in Ia)if(Q(Ia,Ua)&&Ja(Ia[Ua],Ua))break}function G(Ia,
...
Ua);return Ja}function O(){if(z&&'interactive'===z.readyState)return z;aa(document.getElementsByTagName('script'),function(Ia){if('interactive'===Ia.readyState)return z=Ia});return z}var D,C,m,z,y,H,v,w=/\/\*[\s\S]*?\*\/|([^:"'=]|^)\/\/.*$/mg,F=/[^.]\s*require\s*\(\s*["']([^'"\s]+)["']\s*\)/g,J=/\.js$/,T=/^\.\//;var ta=Object.prototype;var Fa=ta.toString,W=ta.hasOwnProperty,la=!('undefined'===typeof window||'undefined'===typeof navigator||!window.document),ia=!la&&'undefined'!==typeof importScripts,
...
E?E.indexOf('!'):-1;if(-1<oa){var ra=E.substring(0,oa);E=E.substring(oa+1,E.length)}return[ra,E]}function gb(E,oa,ra,ja){var ba=null,Ga=oa?oa.name:null,Pa=E,$a=!0,ib='';E||($a=!1,E='_@r'+(L+=1));E=ab(E);ba=E[0];E=E[1];if(ba){ba=Ja(ba,Ga,ja);var Cb=S(q,ba)}if(E)if(ba)ib=ra?E:Cb&&Cb.normalize?Cb.normalize(E,function(qb){return Ja(qb,Ga,ja)}):-1===E.indexOf('!')?Ja(E,Ga,ja):E;else{ib=Ja(E,Ga,ja);E=ab(ib);ba=E[0];ib=E[1];ra=!0;var zb=fa.nameToUrl(ib)}ra=!ba||Cb||ra?'':'_unnormalized'+(ha+=1);return{prefix:ba,
name:ib,parentMap:oa,unnormalized:!!ra,url:zb,originalName:Pa,isDefine:$a,id:(ba?ba+'!'+ib:ib)+ra}}function Ub(E){var oa=E.id,ra=S(g,oa);ra||=g[oa]=new fa.Module(E);return ra}function Zb(E,oa,ra){var ja=E.id,ba=S(g,ja);if(!Q(q,ja)||ba&&!ba.defineEmitComplete)if(ba=Ub(E),ba.error&&'error'===oa)ra(ba.error);else ba.on(oa,ra);else'defined'===oa&&ra(q[ja])}function jb(E,oa){var ra=E.requireModules,ja=!1;if(oa)oa(E);else if(M(ra,function(ba){if(ba=S(g,ba))ba.error=E,ba.events.error&&(ja=!0,ba.emit('error',
E))}),!ja)Da.onError(E)}function Db(){Qa.length&&(M(Qa,function(E){var oa=E[0];'string'===typeof oa&&(fa.defQueueMap[oa]=!0);x.push(E)}),Qa=[])}function rb(E){delete g[E];delete h[E]}function xb(E,oa,ra){var ja=E.map.id;E.error?E.emit('error',E.error):(oa[ja]=!0,M(E.depMaps,function(ba,Ga){ba=ba.id;var Pa=S(g,ba);!Pa||E.depMatched[Ga]||ra[ba]||(S(oa,ba)?(E.defineDep(Ga,q[ba]),E.check()):xb(Pa,oa,ra))}),ra[ja]=!0)}function Ka(){var E,oa,ra=(E=1E3*l.waitSeconds)&&fa.startTime+E<(new Date).getTime(),
ja=[],ba=[],Ga=!1,Pa=!0;if(!ya){ya=!0;u(h,function($a){var ib=$a.map,Cb=ib.id;if($a.enabled&&(ib.isDefine||ba.push($a),!$a.error))if(!$a.inited&&ra)pb(Cb)?Ga=oa=!0:(ja.push(Cb),Ua(Cb));else if(!$a.inited&&$a.fetched&&ib.isDefine&&(Ga=!0,!ib.prefix))return Pa=!1});if(ra&&ja.length)return E=N('timeout','Load timeout for modules: '+ja,null,ja),E.contextName=fa.contextName,jb(E);Pa&&M(ba,function($a){xb($a,{},{})});ra&&!oa||!Ga||!la&&!ia||za||(za=P(function(){za=0;Ka()},50));ya=!1}}function db(E){Q(q,
E[0])||Ub(gb(E[0],null,!0)).init(E[1],E[2])}function Lb(E){E=E.currentTarget||E.srcElement;var oa=fa.onScriptLoad;E.detachEvent&&!ma?E.detachEvent('onreadystatechange',oa):E.removeEventListener('load',oa,!1);oa=fa.onScriptError;E.detachEvent&&!ma||E.removeEventListener('error',oa,!1);return{node:E,id:E&&E.getAttribute('data-requiremodule')}}function Vb(){for(Db();x.length;){var E=x.shift();if(null===E[0])return jb(N('mismatch','Mismatched anonymous define() module: '+E[E.length-1]));db(E)}fa.defQueueMap=
...
function(ba,Ga){return(-1===Ga.indexOf('?')?'?':'&')+oa}}var ra=l.shim,ja={paths:!0,bundles:!0,config:!0,map:!0};u(E,function(ba,Ga){ja[Ga]?(l[Ga]||(l[Ga]={}),G(l[Ga],ba,!0,!0)):l[Ga]=ba});E.bundles&&u(E.bundles,function(ba,Ga){M(ba,function(Pa){Pa!==Ga&&(R[Pa]=Ga)})});E.shim&&(u(E.shim,function(ba,Ga){U(ba)&&(ba={deps:ba});!ba.exports&&!ba.init||ba.exportsFn||(ba.exportsFn=fa.makeShimExports(ba));ra[Ga]=ba}),l.shim=ra);E.packages&&M(E.packages,function(ba){ba='string'===typeof ba?{name:ba}:ba;var Ga=
ba.name;ba.location&&(l.paths[Ga]=ba.location);l.pkgs[Ga]=ba.name+'/'+(ba.main||'main').replace(T,'').replace(J,'')});u(g,function(ba,Ga){ba.inited||ba.map.unnormalized||(ba.map=gb(Ga,null,!0))});(E.deps||E.callback)&&fa.require(E.deps||[],E.callback)},makeShimExports:function(E){return function(){var oa;E.init&&(oa=E.init.apply(A,arguments));return oa||E.exports&&Ea(E.exports)}},makeRequire:function(E,oa){function ra(ja,ba,Ga){var Pa;oa.enableBuildCallback&&ba&&na(ba)&&(ba.__requireJsBuild=!0);if('string'===
typeof ja){if(na(ba))return jb(N('requireargs','Invalid require call'),Ga);if(E&&Q(Aa,ja))return Aa[ja](g[E.id]);if(Da.get)return Da.get(fa,ja,E,ra);var $a=gb(ja,E,!1,!0);$a=$a.id;return Q(q,$a)?q[$a]:jb(N('notloaded','Module name "'+$a+'" has not been loaded yet for context: '+Ia+(E?'':'. Use require([])')))}Vb();fa.nextTick(function(){Vb();Pa=Ub(gb(null,E));Pa.skipMap=oa.skipMap;Pa.init(ja,ba,Ga,{enabled:!0});Ka()});return ra}oa=oa||{};G(ra,{isBrowser:la,toUrl:function(ja){var ba=ja.lastIndexOf('.'),
Ga=ja.split('/')[0];if(-1!==ba&&('.'!==Ga&&'..'!==Ga||1<ba)){var Pa=ja.substring(ba,ja.length);ja=ja.substring(0,ba)}return fa.nameToUrl(Ja(ja,E&&E.id,!0),Pa,!0)},defined:function(ja){return Q(q,gb(ja,E,!1,!0).id)},specified:function(ja){ja=gb(ja,E,!1,!0).id;return Q(q,ja)||Q(g,ja)}});E||(ra.undef=function(ja){Db();var ba=gb(ja,E,!0),Ga=S(g,ja);Ga.undefed=!0;Ua(ja);delete q[ja];delete p[ba.url];delete b[ja];aa(x,function(Pa,$a){Pa[0]===ja&&x.splice($a,1)});delete fa.defQueueMap[ja];Ga&&(Ga.events.defined&&
(b[ja]=Ga.events),rb(ja))});return ra},enable:function(E){S(g,E.id)&&Ub(E).enable()},completeLoad:function(E){var oa=S(l.shim,E)||{},ra=oa.exports;for(Db();x.length;){var ja=x.shift();if(null===ja[0]){ja[0]=E;if(ba)break;var ba=!0}else ja[0]===E&&(ba=!0);db(ja)}fa.defQueueMap={};ja=S(g,E);if(!ba&&!Q(q,E)&&ja&&!ja.inited)if(!l.enforceDefine||ra&&Ea(ra))db([E,oa.deps||[],oa.exportsFn]);else return pb(E)?void 0:jb(N('nodefine','No define call for '+E,null,[E]));Ka()},nameToUrl:function(E,oa,ra){var ja,
ba;(ja=S(l.pkgs,E))&&(E=ja);if(ja=S(R,E))return fa.nameToUrl(ja,oa,ra);if(Da.jsExtRegExp.test(E))ja=E+(oa||'');else{ja=l.paths;var Ga=E.split('/');for(ba=Ga.length;0<ba;--ba){var Pa=Ga.slice(0,ba).join('/');if(Pa=S(ja,Pa)){U(Pa)&&(Pa=Pa[0]);Ga.splice(0,ba,Pa);break}}ja=Ga.join('/');ja+=oa||(/^data:|^blob:|\?/.test(ja)||ra?'':'.js');ja=('/'===ja.charAt(0)||ja.match(/^[\w\+\.\-]+:/)?'':l.baseUrl)+ja}return l.urlArgs&&!/^blob:/.test(ja)?ja+l.urlArgs(E,ja):ja},load:function(E,oa){Da.load(fa,E,oa)},execCb:function(E,
oa,ra,ja){return oa.apply(ja,ra)},onScriptLoad:function(E){if('load'===E.type||xa.test((E.currentTarget||E.srcElement).readyState))z=null,E=Lb(E),fa.completeLoad(E.id)},onScriptError:function(E){var oa=Lb(E);if(!pb(oa.id)){var ra=[];u(g,function(ja,ba){0!==ba.indexOf('_@r')&&M(ja.depMaps,function(Ga){if(Ga.id===oa.id)return ra.push(ba),!0})});return jb(N('scripterror','Script error for "'+oa.id+(ra.length?'", needed by: '+ra.join(', '):'"'),E,[oa.id]))}}};fa.require=fa.makeRequire();return fa}};Da({});
...
y=ab;D?Na.insertBefore(ab,D):Na.appendChild(ab);y=null;return ab}if(ia)try{P(function(){},0),importScripts(Ua),Ia.completeLoad(Ja)}catch(gb){Ia.onError(N('importscripts','importScripts failed for '+Ja+' at '+Ua,gb,[Ja]))}};la&&!Ca.skipDataMain&&aa(document.getElementsByTagName('script'),function(Ia){Na||(Na=Ia.parentNode);if(C=Ia.getAttribute('data-main'))return H=C,Ca.baseUrl||-1!==H.indexOf('!')||(m=H.split('/'),H=m.pop(),v=m.length?m.join('/')+'/':'./',Ca.baseUrl=v),H=H.replace(J,''),Da.jsExtRegExp.test(H)&&
(H=C),Ca.deps=Ca.deps?Ca.deps.concat(H):[H],!0});define=function(Ia,Ja,Ua){var pb;'string'!==typeof Ia&&(Ua=Ja,Ja=Ia,Ia=null);U(Ja)||(Ua=Ja,Ja=null);!Ja&&na(Ua)&&(Ja=[],Ua.length&&(Ua.toString().replace(w,V).replace(F,function(gb,Ub){Ja.push(Ub)}),Ja=(1===Ua.length?['require']:['require','exports','module']).concat(Ja)));if(La&&(pb=y||O())){Ia||=pb.getAttribute('data-requiremodule');var ab=ua[pb.getAttribute('data-requirecontext')]}ab?(ab.defQueue.push([Ia,Ja,Ua]),ab.defQueueMap[Ia]=!0):Qa.push([Ia,
...
v=y(w.concat(v));if(v[6]=15&v[6]|z,v[8]=63&v[8]|128,F)for(w=0;16>w;++w)F[J+w]=v[w];return F||V(v)};try{H.name=m}catch(v){}return H.DNS='6ba7b810-9dad-11d1-80b4-00c04fd430c8',H.URL='6ba7b811-9dad-11d1-80b4-00c04fd430c8',H}function U(m,z){var y=(65535&m)+(65535&z);return(m>>16)+(z>>16)+(y>>16)<<16|65535&y}function M(m,z,y,H,v,w){return U((F=U(U(z,m),U(H,w)))<<(J=v)|F>>>32-J,y);var F,J}function aa(m,z,y,H,v,w,F){return M(z&y|~z&H,m,z,v,w,F)}function Q(m,z,y,H,v,w,F){return M(z&H|y&~H,m,z,v,w,F)}function S(m,
...
w=[],F=32*H.length;for(v=0;v<F;v+=8){var J=H[v>>5]>>>v%32&255;J=parseInt('0123456789abcdef'.charAt(J>>>4&15)+'0123456789abcdef'.charAt(15&J),16);w.push(J)}return w}(function(H,v){H[v>>5]|=128<<v%32;H[14+(v+64>>>9<<4)]=v;var w=1732584193,F=-271733879,J=-1732584194,T=271733878;for(v=0;v<H.length;v+=16){var ta=w;var Fa=F;var W=J;var la=T;w=aa(w,F,J,T,H[v],7,-680876936);T=aa(T,w,F,J,H[v+1],12,-389564586);J=aa(J,T,w,F,H[v+2],17,606105819);F=aa(F,J,T,w,H[v+3],22,-1044525330);w=aa(w,F,J,T,H[v+4],7,-176418897);
T=aa(T,w,F,J,H[v+5],12,1200080426);J=aa(J,T,w,F,H[v+6],17,-1473231341);F=aa(F,J,T,w,H[v+7],22,-45705983);w=aa(w,F,J,T,H[v+8],7,1770035416);T=aa(T,w,F,J,H[v+9],12,-1958414417);J=aa(J,T,w,F,H[v+10],17,-42063);F=aa(F,J,T,w,H[v+11],22,-1990404162);w=aa(w,F,J,T,H[v+12],7,1804603682);T=aa(T,w,F,J,H[v+13],12,-40341101);J=aa(J,T,w,F,H[v+14],17,-1502002290);F=aa(F,J,T,w,H[v+15],22,1236535329);w=Q(w,F,J,T,H[v+1],5,-165796510);T=Q(T,w,F,J,H[v+6],9,-1069501632);J=Q(J,T,w,F,H[v+11],14,643717713);F=Q(F,J,T,w,H[v],
...
typeof M[0]&&null!=M[0]&&'undefined'!=typeof M[0][u]&&'object'==typeof aa[0]&&'undefined'!=typeof aa[0][u]){A=Array.isArray(aa)?Array.from(aa):JSON.clone(aa);var G=0;for(Q=A.length;G<Q;++G)S.push(A[G][u]);Q=JSON.clone(M);var r=0;G=0;M=Q.length;for(var ea=N||0,Ea=aa.length;ea<Ea;++ea)a:for(G=G||0;G<M;++G)if(Q[G][u]===aa[ea][u]){-1<S.indexOf(Q[G][u])?(A[r]=Q[G],++r):-1==S.indexOf(Q[G][u])&&(S.push(Q[G][u]),A[r]=Q[G],++r);break a}else-1==S.indexOf(Q[G][u])&&(S.push(Q[G][u]),A.push(Q[G]));return A}return Array.isArray(M)&&
0==M.length||'undefined'==typeof M?aa:M}if(0==M.length&&0<aa.length)return A=aa;if(0==aa.length&&0<M.length)for(G=0;G<M.length;++G)aa.push(M[G]);if(0==A.length&&0<aa.length)for(G=0;G<aa.length;++G)'object'!=typeof aa[G]&&-1==A.indexOf(aa[G])&&A.push(aa[G]);if(0<aa.length){if('undefined'!=typeof M[0]&&'object'==typeof M[0]&&null!=M[0]&&'undefined'!=typeof M[0][u]&&'object'==typeof aa[0]&&'undefined'!=typeof aa[0][u]){A=Array.isArray(aa)?Array.from(aa):JSON.clone(aa);Q=JSON.clone(M);var N=null;G=0;
...
typeof S&&null!=S&&(S=S[0]||null),-1<aa.indexOf(M[G])&&Q)aa.splice(aa.indexOf(M[G]),1,M[G]);else if('undefined'==typeof A[G]&&'object'==typeof M[G])for(r in A=aa,'undefined'==typeof A[G]&&(A[G]={}),M[G])A[G].hasOwnProperty(r)||(A[G][r]=M[G][r]);else!Q&&-1<A.indexOf(M[G])&&/number/i.test(typeof M[G])&&M[G]!==A[G]?A.push(M[G]):'undefined'==typeof aa[G]||/null/i.test(aa[G])||'undefined'==typeof aa[G][u]||'undefined'==typeof M[G]||'undefined'==typeof M[G][u]||aa[G][u]!=M[G][u]?-1==A.indexOf(M[G])&&'object'!=
typeof M[G]?A.push(M[G]):'undefined'==typeof aa[G]||/null/i.test(aa[G])||'undefined'==typeof aa[G][S]||'undefined'==typeof M[G]||'undefined'==typeof M[G][S]||aa[G][S]!=M[G][S]||(A[G]=Q?M[G]:aa[G]):A[G]=Q?M[G]:aa[G]}if(0<A.length&&0<aa.length||0==A.length&&0==aa.length)return A};na.prototype.setKeyComparison=function(M){this.keyComparison=M};var U=function(M){if(!M||'[object Object]'!=={}.toString.call(M)||M.nodeType||M.setInterval)return!1;var aa={}.hasOwnProperty,Q=aa.call(M,'constructor');aa='undefined'!=
...
function handleXhr(A,P,V,na){if(!A)throw Error('No `xhr` object initiated');var U=null,M=null,aa=null,Q=null,S=null,u=V.$link||null,G=V.$form||null,r=null;delete V.$link;delete V.$form;G||u?u?(u.target=document.getElementById(u.id),r=gina.link.target,S=gina.link.id):(r=G.target,S=r.getAttribute('id')):(r=P,S=r.getAttribute('id'));var ea=u&&P.getAttribute('data-gina-link-event-on-success')||u&&P.getAttribute('data-gina-link-event-on-error')?!0:!1,Ea=G&&r.getAttribute('data-gina-form-event-on-submit-success')||
...
G&&(G.eventData.error=O);u&&(u.eventData.error=O);window.ginaToolbar.update('data-xhr',O,!0);triggerEvent(gina,r,'error.'+S,O);Ea&&triggerEvent(gina,r,'error.'+S+'.hform',O);ea&&triggerEvent(gina,r,'error.'+S+'.hlink',O)};A.onreadystatechange=function(O){O=/Google Inc/i.test(navigator.vendor)?50:0;2==A.readyState&&(M=/^attachment;/.test(A.getResponseHeader('Content-Disposition'))?!0:!1,!A.responseType&&M&&(A.responseType='blob'));if(4==A.readyState)if(U=null,aa=A.getResponseHeader('Content-Type'),
...
10]};return G.replace(/d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g,function(T){return T in J?J[T]:T.slice(1,T.length-1)})},countDaysTo:aa,getDaysTo:function(u,G,r){if(G instanceof Date){G=aa(u,G);var ea=u.getMonth(),Ea=u.getFullYear();u=u.getDate()+1;u=new Date(Ea,ea,u);ea=[];for(Ea=0;Ea<G;++Ea)'undefined'!=typeof r?ea.push((new Date(u)).format(r)):ea.push(new Date(u)),u.setDate(u.getDate()+1);return ea||[]}throw Error('dateTo is not instance of Date() !');},getDaysInMonth:function(u){var G=
...
'$1'),Z,pa,wa)}function e(){function K(pa,wa){return Z.push(pa+' ')>Fb.cacheLength&&delete K[Z.shift()],K[pa+' ']=wa}var Z=[];return K}function k(K){return K[Ab]=!0,K}function n(K){var Z=tb.createElement('div');try{return!!K(Z)}catch(pa){return!1}finally{Z.parentNode&&Z.parentNode.removeChild(Z)}}function B(K,Z){K=K.split('|');for(var pa=K.length;pa--;)Fb.attrHandle[K[pa]]=Z}function I(K,Z){var pa=Z&&K,wa=pa&&1===K.nodeType&&1===Z.nodeType&&(~Z.sourceIndex||-2147483648)-(~K.sourceIndex||-2147483648);
...
Ha);for(;wa=wa.parentNode;)Wa.unshift(wa);for(wa=Ha;wa=wa.parentNode;)kb.unshift(wa);for(;Wa[Ma]===kb[Ma];)Ma++;return Ma?I(Wa[Ma],kb[Ma]):Wa[Ma]===ac?-1:kb[Ma]===ac?1:0},tb):tb};c.matches=function(K,Z){return c(K,null,null,Z)};c.matchesSelector=function(K,Z){if((K.ownerDocument||K)!==tb&&Bc(K),Z=Z.replace(Dd,"='$1']"),!(!Pb.matchesSelector||!fc||bc[Z+' ']||ec&&ec.test(Z)||Tb&&Tb.test(Z)))try{var pa=Sb.call(K,Z);if(pa||Pb.disconnectedMatch||K.document&&11!==K.document.nodeType)return pa}catch(wa){}return 0<
...
{status:T.status,message:''},/^(\{|\[)/.test(T.responseText))try{W=M(W,JSON.parse(T.responseText))}catch(ma){W=M(W,ma)}return ia(W)}catch(ma){throw ma;}},A?T.send(v):T.send())}else console.debug('stopping on errors ...'),triggerEvent(gina,this.target,'asyncCompleted.'+H,u[this.name])},N=async function(m,z,y,H){var v=(new (require(_(GINA_FRAMEWORK_DIR+'/core/config.js',!0)))).getInstance(),w=null,F=null,J=null,T=getContext('bundle');if(/@/.test(m.url)){var ta=m.url.split(/@/);F=ta[0];J=ta[1];getConfig(T,
...
r,ea,Ea),!w.isValid&&(--m,'undefined'!=typeof w.error))throw w.error;}O++}z.past=m===C?!0:!1;z.past&&(r.routing=S(u,r[H]),z.request=r);return z},aa=async function(u,G,r,ea,Ea,N){var O=-1,D=u.match(/:\w+/g);O=new RegExp(u,'g');var C=null,m=null,z=null;C=!1;var y=C=m=m=null,H=null,v=ea.method.toLowerCase();if(!D.length)return!1;r.param.path&&O.test(r.param.path)&&(r.param.path=r.param.path.replace(O,G));r.param.namespace&&O.test(r.param.namespace)&&(r.param.namespace=r.param.namespace.replace(O,G));
...
typeof O&&'undefined'!=typeof O)throw Error('`options` must be an object');'undefined'==typeof O&&(O={});aa=na(O,aa);S=window.localStorage;O=aa.bucket;if(!S.getItem(O)&&void 0!=O)S.setItem(O,JSON.stringify(G));else if(void 0==O)throw Error('`bucket` name cannot be undefined');Q.bucket=O;Q=na(Q,ea)})(A);return Q}
...
delete require.cache[require.resolve('../../../../../helpers/data')];require('../../../../../helpers/data')}var aa=U?require('vendor/uuid'):require('uuid'),Q=U?require('lib/merge'):require('../../../../../lib/merge'),S=U?require('lib/inherits'):require('../../../../../lib/inherits'),u=U?require('lib/form-validator'):require('./form-validator'),G=U?require('lib/routing'):require('../../../../../lib/routing'),r={id:'validator-'+aa.v4(),plugin:this.plugin,on:U?on:null,eventData:{},target:U?document:
...
l=l.replace(/#/,'');if(null!=document.getElementById(l)&&'undefined'==typeof r.$forms[l]){var h=document.getElementById(l),b,x=typeof(0<Ea.count())?Ea:r.rules;h.getAttribute?(id=h.getAttribute('id')||'form.'+aa.v4(),id!==h.getAttribute('id')&&h.setAttribute('id',id)):(id='form.'+aa.v4(),h.setAttribute('id',id));h.id=ea.id=id;if('undefined'!=typeof h.id&&'null'!=h.id&&''!=h.id){ea.target=h;r.$forms[h.id]=Q({},ea);if(b=h.getAttribute('data-gina-form-rule')){b=b.replace(/\-|\//g,'.');if('undefined'==
typeof x[b])throw Error('['+h.id+'] no rule found with key: `null`');b=x[b]}'string'==typeof h.id&&'undefined'!=typeof x[h.id.replace(/\-/g,'.')]?$target=r.$forms[h.id].target:'object'==typeof h.id?(delete r.$forms[h.id],x=h.attributes.getNamedItem('id').nodeValue||'form.'+aa.v4(),h.setAttribute('id',x),h.id=x,ea.target=h,r.$forms[x]=Q({},ea),$target=r.$forms[x].target):$target=r.$forms[h.id].target;b?xb($target,b):xb($target)}}'undefined'!=typeof r.$forms[l]&&(r.$forms[l].withUserBindings=!0,g='undefined'!=
...
ha.parentNode.removeChild(ha);else if(L[da].value=q[h][da],'preview'==da)for(var fa in q[h][da])if('undefined'!=typeof q[h][da][fa]&&'undefined'!=typeof L[da][fa]&&(L[da][fa].value=q[h][da][fa]),'tmpUri'==fa&&l.hasPreviewContainer){Aa=document.createElement('IMG');Aa.src=q[h][da].tmpUri;Aa.style.display='none';Aa.setAttribute('data-upload-original-filename',q[h].originalFilename);Aa.setAttribute('data-upload-preview-original-filename',q[h][da].originalFilename);Aa.setAttribute('data-upload-reset-link-id',
...
'block'}removeListener(gina,$uploadResetTrigger,'click',function(){p.remove();q[ha].remove()});Aa--;ha--;break}}},ia=function(l,g,h,b,x){var q=new FileReader;q.addEventListener('load',function(p){p.preventDefault();try{var R=this.result,L=void 0;p='';var ha=null;'undefined'==typeof L&&(L=8);var Aa=L/8;switch(L){case 8:ha=new Uint8Array(R);break;case 16:ha=new Uint16Array(R);break;case 32:ha=new Uint32Array(R);break;default:ha=new Uint8Array(R)}var da=ha.length,fa=Math.pow(2,8)+Aa;R=0;for(Aa=L=null;R<
da;R+=fa)L=Math.min(fa,da-R),Aa=ha.subarray(R,R+L),p+=String.fromCharCode.apply(null,Aa);l[this.index].bin+=p;l[this.index].file.type||(l[this.index].file.type='application/octet-stream')}catch(E){return x(E,null,!0)}h+='--'+g+'\r\n';h+='Content-Disposition: form-data; name="'+l[this.index].key+'"; group="'+l[this.index].group+'"; filename="'+l[this.index].file.name+'"\r\nContent-Type: '+l[this.index].file.type+'\r\nContent-Length: '+l[this.index].bin.length+'\r\n\r\n';h+=l[this.index].bin+'\r\n';
...
Qa=function(l){gina.hasValidator?(r=Q(r,gina.validator),r.on('init',function(g){r.isReady=!0;triggerEvent(gina,r.target,'ready.'+r.id,r)})):(r.target=document,r.setOptions=m,r.getFormById=z,r.validateFormById=H,r.resetErrorsDisplay=J,r.resetFields=T,r.handleErrorsDisplay=F,r.send=Fa,r.on('init',function(g){if('undefined'!=typeof l&&l.count())try{La(l,''),l=Ca(l),gina.forms.rules='undefined'!=typeof gina.forms.rules&&gina.forms.rules?Q(gina.forms.rules,l,!0):l,r.rules=Q(r.rules,JSON.clone(gina.forms.rules),
!0)}catch(R){throw R;}Ea.count()||(Ea=JSON.clone(r.rules));ea.setOptions=m;ea.getFormById=z;ea.validateFormById=H;ea.resetErrorsDisplay=J;ea.resetFields=T;ea.handleErrorsDisplay=F;ea.submit=ta;ea.send=Fa;ea.unbind=Db;ea.bind=xb;ea.reBind=jb;ea.destroy=ma;g=0;for(var h=document.getElementsByTagName('form'),b=0,x=h.length;b<x;++b){if(h[b].getAttribute){var q=h[b].getAttribute('id')||'form.'+aa.v4();q!==h[b].getAttribute('id')&&h[b].setAttribute('id',q)}else q='form.'+aa.v4(),h[b].setAttribute('id',
q);ea.id=q;ea.target=h[b];r.$forms[q]=Q({},ea);var p=h[b].getAttribute('data-gina-form-rule');if(p){p=p.replace(/\-|\//g,'.');'undefined'!=typeof l&&(r.$forms[q].rules[p]=r.rules[p]=Ea[p]=Q(JSON.clone(eval('gina.forms.rules.'+p)),r.rules[p]));if('undefined'==typeof Ea[p])throw Error('['+q+'] no rule found with key: `'+p+'`. Please check if json is not malformed @ /forms/rules/'+p.replace(/\./g,'/')+'.json');p=r.rules[p]}'string'==typeof q&&'undefined'!=typeof Ea[q.replace(/\-/g,'.')]||'object'==typeof p?
...
l+'.'),x=null,q=function(R,L,ha,Aa,da,fa,E){if(L.length){var oa=Object.getOwnPropertyNames(R)[0],ra=L[0];ra=''==da?da+=ra:da+'['+ra+']';1==L.length&&(R[oa]=Q(R[oa],ha,!0));L.splice(0,1);ra==oa?q(R[oa],L,ha,Aa,ra,fa,E):'undefined'!=typeof R[oa]?q(R[oa],L,ha,Aa,ra,fa,E):q(R,L,ha,Aa,da,fa,E)}},p;for(p in r.rules)p!=l&&h.test(p)&&(x=p.replace(b,''),/\./.test(x)&&(x=x.split(/\./g),q(g,x,r.rules[p],g,'',0,g.count()-1)));return Ea[l]=g},Na=formatDataFromString,Ia=function(l){var g=r.$forms[l.form.getAttribute('id')],
...
L.target;r.$forms[L.target.form.getAttribute('id')].isValidating=!0;za(L.target,Aa,da,l.rules,function(fa){r.$forms[L.target.form.getAttribute('id')].isValidating=!1;fa.isValid()?F(L.target.form,{},fa.data,L.target.name):F(L.target.form,fa.error,fa.data,L.target.name);var E=L.target.form,oa=fa=null,ra=null;oa=db(E,x);fa=oa.fields;oa=oa.$fields;var ja=E.getAttribute('id');ra=r.$forms[ja].rules;r.$forms[ja].isValidating=!0;za(E,fa,oa,ra,function(ba){r.$forms[ja].isValidating=!1;console.debug('['+ja+
...
fa[g[ca].name]=new RegExp('^'+E.replace(/[.*+?^${}()|[\]\\]/g,'\\$&')),q&&('undefined'==typeof h.rules[g[ca].name]&&(h.rules[g[ca].name]={}),'undefined'!=typeof h.rules[g[ca].name].isRequired&&h.rules[g[ca].name].isRequired||(h.rules[g[ca].name].exclude=!0));if(0<fa.count())for(var ba in fa)g[ca].name!=ba&&(g[ca].getAttribute('data-gina-form-element-group'),fa[ba].test(g[ca].name)&&(g[ca].disabled=!0,'undefined'==typeof oa[ba]&&(oa[ba]={}),oa[ba][g[ca].name]=g[ca]));if(/^file$/i.test(g[ca].type)){ja=
...
da+'-folding-state-'+Ka(Aa,fa.replace(/[^A-Za-z0-9_-]/g,'_'))+E+'">'+fa+' <span>['+x[fa].length+']</span></a>';ha+='<ul class="gina-toolbar-collection">'+Lb(x[fa],q[fa],p,R,L)+'</ul>';ha+='</li>';p=p.substr(0,p.length-fa.length)}else E=null===q[fa]?'null':typeof q[fa],'undefined'==E?(ha+='<li class="gina-toolbar-key-value">',ha+='<span class="gina-toolbar-key gina-toolbar-key-added">'+fa+':</span> <span class="gina-toolbar-value gina-toolbar-value-type-is-'+E+'">'+x[fa]+'</span>'):(x[fa]!==q[fa]&&
...
'<li class="gina-toolbar-object">',ha+='<a href="#" class="gina-toolbar-key gina-toolbar'+da+'-folding-state-'+Ka(Aa,fa.replace(/[^A-Za-z0-9_-]/g,'_'))+E+'">'+fa+' <span>{ }</span></a>',ha+='<ul class="gina-toolbar-object">'+db(x[fa],q[fa],p,R,L)+'</ul>',ha+='</li>',p=p.substr(0,p.length-fa.length);return ha}},Lb=function(x,q,p,R,L){var ha='';p='undefined'!=typeof p&&null!=p?p:'';var Aa='undefined'!=typeof L&&null!=L?L:'',da='undefined'!=typeof R&&null!=R?'-xhr':'';q||=[];for(var fa=0,E=x.length;fa<
E;++fa)'object'!=typeof x[fa]||Array.isArray(x[fa])?Array.isArray(x[fa])?(p+='-'+fa,''==Aa&&(Aa=p),ha+='<li class="gina-toolbar-collection">',ha+='<a href="#" class="gina-toolbar-key gina-toolbar'+da+'-folding-state-'+Ka(Aa,fa)+'">'+fa+'<span>[ ]</span></a>',ha+='<ul class="gina-toolbar-collection">'+Lb(x[fa],q[fa],p,R,L)+'</ul>',ha+='</li>',p=p.substr(0,p.length-fa.toString().length)):ha+='<li class="gina-toolbar-key-value"><span class="gina-toolbar-key">'+fa+':</span> <span class="gina-toolbar-value">'+
x[fa]+'</span></li>':(q[fa]||(q[fa]=x[fa]),p+='-'+fa,''==Aa&&(Aa=p),ha+='<li class="gina-toolbar-object">',ha+='<a href="#" class="gina-toolbar-key gina-toolbar'+da+'-folding-state-'+Ka(Aa,fa)+'">'+fa+' <span>{ }</span></a>',ha+='<ul class="gina-toolbar-object">'+db(x[fa],q[fa],p,R,L)+'</ul>',ha+='</li>',p=p.substr(0,p.length-fa.toString().length-1));return ha},Vb=function(x,q,p,R,L,ha){p=null!=p?p.replace(/[^A-Za-z0-9_-]/g,'_'):'';var Aa='undefined'!=typeof R&&null!=R?'-xhr':'';x=xb(x);q=xb(q);ha||=
L;for(var da in x){var fa=da;if('object'!=typeof x[da]||Array.isArray(x[da])||null===x[da])if(Array.isArray(x[da])){var E=P('#gina-toolbar-view-'+p.substr(0,p.length-1));var oa=E.length?!0:!1;!oa||/^html/.test(p)?(E=P('.'+p),oa=p+da.replace(/[^A-Za-z0-9_-]/g,'_')+'-',E.append('<li class="gina-toolbar-collection"><a href="#" class="gina-toolbar-key gina-toolbar'+Aa+'-folding-state-'+Ka(da.replace(/[^A-Za-z0-9_-]/g,'_'),oa.substr(0,oa.length-1))+'">'+da+' <span>['+x[da].length+']</span></a><ul> '+Lb(x[da],
...
p.length-da.length-1)}else if(fa=null===q[da]?'null':typeof q[da],'undefined'==fa)/\-$/.test(p)&&(p=p.substr(0,p.length-1)),p&&L.find('ul.'+p).append('<li class="gina-toolbar-key-value"><span class="gina-toolbar-key gina-toolbar-key-added">'+da+':</span> <span class="gina-toolbar-value gina-toolbar-value-type-is-'+fa+'">'+x[da]+'</span></li>');else if(x[da]!==q[da]){p||(p+=da.replace(/[^A-Za-z0-9_-]/g,'_')+'-');try{L.find('ul.'+p).append('<li class="gina-toolbar-key-value gina-toolbar-is-overridden"><span class="gina-toolbar-key">'+
da+':</span> <span class="gina-toolbar-value">'+q[da]+'</span></li>'),L.find('ul.'+p).append('<li class="gina-toolbar-key-value"><span class="gina-toolbar-key">'+da+':</span> <span class="gina-toolbar-value gina-toolbar-value-type-is-'+fa+'">'+x[da]+'</span></li>')}catch(ra){throw Error('GinaToolbarError: `ul.'+p+'` not found');}}else!p||/^html\-properties/.test(p)?ha.find('.gina-toolbar-properties').append('<li class="gina-toolbar-key-value"><span class="gina-toolbar-key">'+da+':</span> <span class="gina-toolbar-value gina-toolbar-value-type-is-'+
...
p.length-1)+'"></ul></div>',P('#gina-toolbar-view-html-properties').before(fa)):/^html/.test(p)||(fa='<div id="gina-toolbar-view-'+p.substr(0,p.length-1)+'" class="gina-toolbar-section"><h2 class="gina-toolbar-section-title">'+p.substr(0,p.length-1)+'</h2><ul class="'+p.substr(0,p.length-1)+'"></ul></div>',L.append(fa)),Vb(x[da],q[da],p,R,L.find('ul.'+p.substr(0,p.length-1)),ha)),p=p.substr(0,p.length-da.length-1)}return ha.html()},ya=function(x){x=gina.hasPopinHandler?gina.popin.getActivePopin():
null;var q,p=(gina.hasPopinHandler?P('#'+x.id):P('body')).html().match(/404:\[(.+)\](.+)@(.+)"/gm);if(p){var R=0;for(q=p.length;R<q;++R){x=p[R].replace(/"(.*)|"/g,'');var L=x.match(/\[(.*)\]/g,'')[0].replace(/\[|\]/g,'');V.getRouteByUrl(x,L)}}fLen=V.notFound.count();if(0<fLen)for(f in V.notFound)console.warn('(x'+V.notFound[f].count+') '+f+' => '+V.notFound[f].message)},za=function(x,q,p,R,L,ha,Aa){if(!ha)return!1;for(var da=L[R].attributes,fa,E=L[R].getAttribute('id')||L[R].id,oa=P('<div id="gina-toolbar-form-'+
...
(ja||'#')+'</span></li><li><span class="gina-toolbar-key">route</span><span class="gina-toolbar-value">'+fa.name+'</span></li><li><span class="gina-toolbar-key">namespace</span><span class="gina-toolbar-value">'+(fa.namespace||'root controller')+'</span></li><li><span class="gina-toolbar-key">control</span><span class="gina-toolbar-value">'+fa.param.control+'</span></li><li><span class="gina-toolbar-key">file</span><span class="gina-toolbar-value">'+fa.param.file+'</span></li><ul>',ba='<li><span class="gina-toolbar-key">'+
ra+':</span><span class="gina-toolbar-value">'+ja+'</span></li>'),/^data-gina-form-event/.test(ra)?(fa='events',ba=oa.find('.gina-toolbar-form-attributes').find('.gina-toolbar-key-events').length?!0:!1,ra=ra.replace(/^data-gina-form-event-/,''),ba||oa.find('ul.gina-toolbar-section-content').append('<li class="gina-toolbar-form-'+fa+'"><h3 class="gina-toolbar-sub-section-title">'+fa+'</h3><ul class="gina-toolbar-code"></ul></li>'),ba='<li><span class="gina-toolbar-key">'+ra+':</span><span class="gina-toolbar-value">'+
ja+'</span></li>',oa.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-'+fa+' > ul').append(ba)):(/^action$/.test(ra)||(ba='<li><span class="gina-toolbar-key">'+ra+':</span><span class="gina-toolbar-value">'+ja+'</span></li>'),oa.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-attributes > ul').append(ba));da=null;try{var $a=L[R].getAttribute('data-gina-form-rule');da='undefined'!=typeof $a&&null!=$a?eval('gina.forms.rules.'+$a.replace(/-/g,'.')):eval('gina.forms.rules.'+
E.replace(/-/g,'.'))}catch(ib){}da&&(fa='rules',oa.find('ul.gina-toolbar-section-content').append('<li class="gina-toolbar-form-'+fa+'"><h3 class="gina-toolbar-sub-section-title">'+fa+'</h3><ul class="gina-toolbar-properties">'+db(da,da,E,Aa,fa)+'</ul></li>'));p.append(oa);++R;R<ha&&za(x,q,p,R,L,ha,Aa)},l=function(x,q,p,R){var L=P('#gina-toolbar-form-'+x);$section=L.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-'+q+'> ul');if(0<$section.length){if(0==p.count())return L.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-'+
...
aa(this).constructor)}if(null===l||(h=l,-1===Function.toString.call(h).indexOf('[native code]')))return l;var h;if('function'!=typeof l)throw new TypeError('Super expression must either be null or a function');if(void 0!==za){if(za.has(l))return za.get(l);za.set(l,g)}return g.prototype=Object.create(l.prototype,{constructor:{value:g,enumerable:!1,writable:!0,configurable:!0}}),Q(g,l)},G(ya)}function r(ya){if(void 0===ya)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
return ya}function ea(ya){var za=S();return function(){var l=aa(ya);if(za){var g=aa(this).constructor;l=Reflect.construct(l,arguments,g)}else l=l.apply(this,arguments);return!l||'object'!=typeof l&&'function'!=typeof l?r(this):l}}function Ea(ya,za,l){return Ea='undefined'!=typeof Reflect&&Reflect.get?Reflect.get:function(g,h,b){for(;!Object.prototype.hasOwnProperty.call(g,h)&&null!==(g=aa(g)););if(g)return h=Object.getOwnPropertyDescriptor(g,h),h.get?h.get.call(b):h.value},Ea(ya,za,l||ya)}function N(ya){if(ya){for(var za in N.prototype)ya[za]=
...
return za}(G(Error));ma=function(ya){function za(g){var h;return P(this,za),(h=l.call(this)).writable=!1,D(r(h),g),h.opts=g,h.query=g.query,h.readyState='',h.socket=g.socket,h}M(za,ya);var l=ea(za);return na(za,[{key:'onError',value:function(g,h,b){return Ea(aa(za.prototype),'emitReserved',this).call(this,'error',new Ua(g,h,b)),this}},{key:'open',value:function(){return'closed'!==this.readyState&&''!==this.readyState||(this.readyState='opening',this.doOpen()),this}},{key:'close',value:function(){return'opening'!==
...
function Domain(A,P){var V='undefined'!==typeof module&&module.exports?!1:!0,na=!1;V&&(na=!!window.MSInputMethodContext&&!!document.documentMode);'function'==typeof A&&(P=A,A=void 0);var U={filename:'../dist/public_suffix_list.dat',url:'https://publicsuffix.org/list/public_suffix_list.dat',alternativeUrl:'https://raw.githubusercontent.com/publicsuffix/list/master/public_suffix_list.dat',isCachingRrequired:!1,isUpdating:!1},M=null,aa=null,Q=function(r,ea,Ea){if('undefined'==typeof ea)ea=U;else for(let N in U)'undefined'==
typeof ea[N]&&(ea[N]=U[N]);V||(ea.filename=__dirname+'/'+ea.filename);V&&ea.isCachingRrequired&&(console.warn('[DOMAIN] `options.isCachingRrequired` is only available for backend'),ea.isCachingRrequired=!1);M=ea;if(Ea)return S(ea,function(N){N?Ea(N):(console.debug('[DOMAIN] PSL Loaded'),Ea(N,r))});S(ea);console.debug('[DOMAIN] PSL Loaded');return r},S=async function(r,ea){var Ea=V||r.isCachingRrequired?r.url:r.filename,N='undefined'!=typeof r.isUpdating?r.isUpdating:!1,O=null;if(V)if(aa&&!N)ea(!1);
...
'curl -o '+r.filename+' '+r.url+' >/dev/null 2>&1';console.debug('[DOMAIN] Running: '+Ea);try{execSync(Ea)}catch(C){console.warn('[DOMAIN] could not fetch from `'+r.url+'`. Trying with `'+r.alternativeUrl+'`');Ea='curl -o '+r.filename+' '+r.alternativeUrl+' >/dev/null 2>&1';try{execSync(Ea)}catch(m){ea(m);return}}var D=!1;nIntervId=setInterval(()=>{if('undefined'!=typeof fs.accessSync)try{fs.accessSync(r.filename,fs.constants.F_OK),D=!0}catch(C){D=!1;try{fs.lstatSync(r.filename).isSymbolicLink()&&
(D=!0)}catch(m){}}else D=fs.existsSync(r.filename);D&&(clearInterval(nIntervId),aa=fs.readFileSync(r.filename).toString(),ea(!1))},200)}try{aa=fs.readFileSync(r.filename).toString(),ea&&ea(!1)}catch(C){console.warn('[DOMAIN] could not read from `'+r.filename+'`'),S(A,ea)}}},u=function(r){M.isUpdating=!0;S(M,r)},G={getRootDomain:function(r,ea){'undefined'==typeof ea&&(ea=!1);var Ea=!1,N=!1,O=r.replace(/^(.*):\/\/|\/(.*)/g,''),D=O.split(/\./g).reverse(),C=D.length?D.length-1:0,m=aa.replace(/\/\/\s*(.*)\n|^\s*\n/gm,
'').split(/\n/).filter(function(z,y,H){/[^a-z 0-9.]+/.test(z)&&(z=z.replace(/[^a-z 0-9.]+/g,'').replace(/^\./g,''));return/\./.test(z)&&!Ea&&(new RegExp('.'+z+'$')).test(O)?(Ea=!0,C=z.split(/\./g).length,H.splice(0,H.length),!1):z});O=D[C];0<C&&(D=D.splice(0,C),N=D[0],/:(.*)$/.test(N)&&(N=N.replace(/:(.*)$/,'')),(N=Ea||!Ea&&-1<m.indexOf(N)?!0:!1)?1<C&&!Ea?(D.splice(2),O=D.reverse().join('.')):O+='.'+D.reverse().join('.'):1<C?(D.splice(2),O=D.reverse().join('.')):O+='.'+D.reverse().join('.'));/:(.*)$/.test(O)&&
(O=O.replace(/:(.*)$/,''));console.debug('[DOMAIN] isSLD: '+Ea,r,' -> ',O);/^true$/i.test(ea);return{value:O,isSLD:Ea,isRegisteredTldOrSld:N}}};V?G.onReady=function(){}:G.updatePSL=u;return V&&na&&!window.fetch?(na=document.createElement('script'),na.type='text/javascript',na.src='https://cdn.jsdelivr.net/npm/promise-polyfill@8.1.3/dist/polyfill.min.js',u=document.createElement('script'),u.type='text/javascript',u.src='https://cdn.jsdelivr.net/npm/whatwg-fetch@3.4.0/dist/fetch.umd.min.js',document.head.appendChild(na),
...
define('gina/link','require jquery vendor/uuid lib/domain lib/merge utils/events'.split(' '),function(A){A('jquery').noConflict();var P=A('vendor/uuid'),V=A('lib/domain'),na=null,U=A('lib/merge');A('utils/events');return function(M){function aa(m,z){var y=D(m),H=y.id,v=document.getElementById(H)||null;(v.getAttribute('data-gina-link-event-on-success')||v.getAttribute('data-gina-link-event-on-error'))&&listenToXhrEvents(y);z='undefined'==typeof z?ea:U(z,ea);if(/^(http|https):/.test(m)&&!(new RegExp('^'+
...
(H=y.getAttribute('onclick'));H?'undefined'==typeof H||/return false/.test(H)||(H=/;$/.test(H)?H+'return false;':H+'; return false;',y.setAttribute('onclick',H)):y.setAttribute('onclick','return false;');'undefined'==typeof u.$links[F.id]&&(F.target=y,y=U(F,G),Q(y,z))}};new V(function(m,z){if(m)throw m;na=z});return function(m){u.bindLinks=C;u.request=aa;u.getLinkById=O;u.getLinkByUrl=D;u.on('init',function(z){if(window.XMLHttpRequest)r=new XMLHttpRequest;else if(window.ActiveXObject)try{r=new ActiveXObject('Msxml2.XMLHTTP')}catch(y){try{r=
