...
da){typeof da!='undefined'&&da!=''&&(this.error=da);return l[this.name]};l[C].setLabel=function(H){typeof H!='undefined'&&H!=''&&(this.label=H);return l[this.name]};l[C].trim=function(H){if(typeof H=='boolean'&&H)return this.value=this.value.replace(/^\s+|\s+$/g,''),w.data[this.name]=w.data[this.name]=this.value,l[this.name]};l[C].exclude=function(H){if(typeof H=='boolean'&&!H)return/^true|false$/i.test(this.value)&&(this.value=/^true$/i.test(this.value)?!0:!1,w.data[this.name]=this.value),l[this.name];
