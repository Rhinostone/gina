...
function Routing() {
    ...
    self.getBundleHostname = function(bundle, env) {
        var config = null, hostname = null;
        if (isGFFCtx) {
            ...
            if ( typeof(bundle) != 'undefined' ) {
                // get from webroot
                hostname = routing.getRoute('webroot@'+ bundle).hostname;
            }            
        } else {
    ...
    self.getRoute = function(rule, params, urlIndex) {
        ...
        route.toUrl = function (ignoreWebRoot) {
            ...
            var wroot       = this.webroot
                , hostname  = this.hostname || self.getBundleHostname()
                , path      = this.url
            ;
