...
createdAt:'{{ page.data.session.createdAt }}',lastModified:'{{ page.data.session.lastModified }}',expiresAt:null};b.session.__defineGetter__('timeout',function(){if(this.lastModified){this.lastModified&&typeof this.lastModified=='string'&&(this.lastModified=new Date(this.lastModified));this.createdAt&&typeof this.createdAt=='string'&&(this.createdAt=new Date(this.createdAt));this.originalTimeout&&typeof this.originalTimeout=='string'&&(this.originalTimeout=parseInt(this.originalTimeout));this.expiresAt=
new Date((new Date(this.lastModified)).getTime()+this.originalTimeout);var c=this.expiresAt-new Date}else c=null;return c});b.session.timeout;b.config.getRouting=function(c){var k={},l=b.config.routing;if(typeof c=='undefined')return l;c=new RegExp('\\@'+c+String.fromCharCode(36));for(var m in l)c.test(m)&&(k[m]=l[m]);return k.count()>0?k:null};window.GINA_ENV='{{ page.environment.env }}';window.GINA_ENV_IS_DEV=/^true$/i.test('{{ page.environment.envIsDev }}')?!0:!1;if(typeof location.search!='undefined'&&
/debug=/i.test(location.search)||!location.search&&/\?/.test(location.href))a=(' '+location.search).slice(1),!a&&/\?/.test(location.href)&&(a=location.href.match(/\?.*/),Array.isArray(a)&&a.length>0&&(a=a[0])),(a=a.match(/debug=(true|false)/))&&(window.GINA_ENV_IS_DEV=b.config.envIsDev=/^true$/i.test(a[0].split(/=/)[1])?!0:!1),a=a=null;b.isFrameworkLoaded=!0;b.setOptions(e);try{b.forms=JSON.parse(decodeURIComponent('{{ page.environment.forms }}'))}catch(c){throw c;}a=null;a=document.head.getElementsByTagName('link');
d=0;f=a.length;h=!1;for(g=RegExp('css/vendor/gina/gina.min.css');d<f;++d)if(g.test(a[d].href)){h=!0;break}g=f=d=a=null;h||(a=document.createElement('link'),a.href=e.webroot+'css/vendor/gina/gina.min.css',a.media='screen',a.rel='stylesheet',a.type='text/css',e=document.getElementsByTagName('head')[0],(d=e.getElementsByTagName('link'))&&typeof d.length!='undefined'&&d.length>0?e.insertBefore(a,d[0]):e.appendChild(a),e=d=null);return!0};
