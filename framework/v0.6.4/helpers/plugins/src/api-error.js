            ...
            try {
                ...
                if ( re.test(filename) ) {
                    ...
                    if ( /model/i.test(filename) ) {
                        path = paths.models.substring(paths.models.lastIndexOf(bundleName)) +'/'+ filename.substring(filename.lastIndexOf(bundleName+'\/models'));
                        error.tag += 'model:'
                    }
                    // controller
                    else {
                        path = paths.controllers.substring(paths.controllers.lastIndexOf(bundleName)) +'/'+ filename.substring(filename.lastIndexOf(bundleName+'\/controllers'));
