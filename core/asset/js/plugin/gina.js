    ...
    instance['Validator'] = function(rules) {
        ...
        var destroy = function(formId) {
            ...
            if ($form) {
                ...
                // submit
                var $submit = null, evt = null, $buttons = $form.target.getElementsByTagName('button');
                for (var b=0, len=$buttons.length; b<len; ++b) {
                    if ($buttons[b].type == 'submit') {
                        $submit = $buttons[b];
        ...
        var bindForm = function($form, customRule) {
            ...
            if (withRules) {
                ...
                var $submit = null, $buttons = $form.getElementsByTagName('button'), buttonId = null;
