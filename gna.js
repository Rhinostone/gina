...
var _gna = require('./framework/v0.3.14-alpha.2/core/gna');

// SuperController and EntitySuper — loaded from their source modules
var SuperController = require('./framework/v0.3.14-alpha.2/core/controller');
var EntitySuper     = require('./framework/v0.3.14-alpha.2/core/model/entity');

// uuid — from the lib registry
var uuid = require('./framework/v0.3.14-alpha.2/lib/uuid');
