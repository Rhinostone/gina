...
var _gna = require('./framework/v0.5.16/core/gna');

// SuperController and EntitySuper — loaded from their source modules
var SuperController = require('./framework/v0.5.16/core/controller');
var EntitySuper     = require('./framework/v0.5.16/core/model/entity');

// uuid — from the lib registry
var uuid = require('./framework/v0.5.16/lib/uuid');
