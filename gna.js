...
var _gna = require('./framework/v0.6.9-alpha.1/core/gna');

// SuperController and EntitySuper — loaded from their source modules
var SuperController = require('./framework/v0.6.9-alpha.1/core/controller');
var EntitySuper     = require('./framework/v0.6.9-alpha.1/core/model/entity');

// uuid — from the lib registry
var uuid = require('./framework/v0.6.9-alpha.1/lib/uuid');
