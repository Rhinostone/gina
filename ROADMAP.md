...
| 📋 | **Async controller actions** — Controller actions can be declared `async`. The router attaches `.catch()` to any thenable returned by an action; rejections are routed to `throwError(response, 500, ...)`. | `0.3.0` | Q3 2026 |
...
*Last updated: 2026-03-29 (Per-bundle framework version shipped in 0.2.1) · To suggest a feature, [open an issue](https://github.com/gina-io/gina/issues).*
